...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  for (const l of locales) alternates[l] = `${BASE_URL}/${l}/calendars`;
  alternates['x-default'] = `${BASE_URL}/en/calendars`;

  return {
    title,
    description,
    alternates: { canonical: `${BASE_URL}/${locale}/calendars`, languages: alternates },
    keywords: ['tithi calendar', 'panchang calendar', 'hindu calendar', 'nakshatra calendar', 'moon phase calendar', 'tithi today'],
  };
}
