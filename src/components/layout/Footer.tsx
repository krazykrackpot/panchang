...
const SECTIONS = [
  {
    ...
    links: [
      { href: '/kundali', label: { en: 'Kundali', hi: 'कुण्डली', ta: 'குண்டலி', bn: 'কুণ্ডলি', te: 'కుండలి', gu: 'કુંડળી', kn: 'ಜಾತಕ', mr: 'कुंडली', mai: 'कुण्डली' } },
      { href: '/matching', label: { en: 'Matching', hi: 'गुण मिलान', ta: 'பொருத்தம்', bn: 'গুণ মিলন', te: 'గుణ మిలాన్', gu: 'ગુણ મેળાપ', kn: 'ಗುಣ ಮಿಲನ', mr: 'गुण मिलान', mai: 'गुण मिलान' } },
      ...
      { href: '/muhurta-ai', label: { en: 'Muhurta Finder', hi: 'मुहूर्त खोजक', ta: 'முகூர்த்தம் கண்டுபிடி', bn: 'মুহূর্ত খোঁজক', te: 'ముహూర్తం వెతుకు', gu: 'મુહૂર્ત શોધક', kn: 'ಮುಹೂರ್ತ ಹುಡುಕಾಟ', mr: 'मुहूर्त शोधक', mai: 'मुहूर्त खोजक' } },
      { href: '/varshaphal', label: { en: 'Varshaphal', hi: 'वर्षफल', ta: 'வர்ஷபலன்', bn: 'বর্ষফল', te: 'వర్షఫలం', gu: 'વર્ષફળ', kn: 'ವರ್ಷಫಲ', mr: 'वर्षफळ', mai: 'वर्षफल' } },
      { href: '/kp-system', label: { en: 'KP System', hi: 'KP पद्धति', ta: 'KP முறை', bn: 'KP পদ্ধতি', te: 'KP పద్ధతి', gu: 'KP પદ્ધતિ', kn: 'KP ಪದ್ಧತಿ', mr: 'KP पद्धती', mai: 'KP पद्धति' } },
      { href: '/prashna', label: { en: 'Prashna', hi: 'प्रश्न', ta: 'பிரச்சினை', bn: 'প্রশ্ন', te: 'ప్రశ్న', gu: 'પ્રશ્ન', kn: 'ಪ್ರಶ್ನೆ', mr: 'प्रश्न', mai: 'प्रश्न' } },
      ...
      { href: '/sade-sati', label: { en: 'Sade Sati', hi: 'साढ़े साती', ta: 'சனிப்பெயர்ச்சி', bn: 'সাড়ে সাতি', te: 'సాడే సాతి', gu: 'સાડે સાતી', kn: 'ಸಾಡೆ ಸಾತಿ', mr: 'साडेसाती', mai: 'साढ़े साती' } },
      { href: '/cosmic-blueprint', label: { en: 'Cosmic Blueprint', hi: 'ब्रह्मांडीय नक्शा', ta: 'கோள வரைபடம்', bn: 'মহাজাগতিক ব্লুপ্রিন্ট', te: 'విశ్వ నక్షా', gu: 'બ્રહ્માંડ નકશા', kn: 'ಬ್ರಹ್ಮಾಂಡ ನಕ್ಷೆ', mr: 'ब्रह्मांडीय नकाशा', mai: 'ब्रह्माण्ड चित्र' } },
      { href: '/tropical-compare', label: { en: 'Vedic vs Tropical', hi: 'वैदिक vs उष्णकटिबंधीय', ta: 'வேதம் vs வெப்பமண்டலம்', bn: 'বৈদিক vs ট্রপিক্যাল', te: 'వేద vs ఉష్ణ', gu: 'વૈદિક vs ઉષ્ણ', kn: 'ವೈದಿಕ vs ಉಷ್ಣ', mr: 'वैदिक vs उष्ण', mai: 'वैदिक vs उष्ण' } },
      { href: '/sign-shift', label: { en: 'Sign Shift', hi: 'राशि परिवर्तन', ta: 'ராசி மாற்றம்', bn: 'রাশি পরিবর্তন', te: 'రాశి మార్పు', gu: 'રાશિ પરિવર્તન', kn: 'ರಾಶಿ ಬದಲಾವಣೆ', mr: 'राशी बदल', mai: 'राशि परिवर्तन' } },
      // Audit 2026-05-25 §D4 — high-traffic hubs/legal that were absent.
      { href: '/charts', label: { en: 'Charts Hub', hi: 'चार्ट केंद्र', ta: 'அட்டவணை மையம்', bn: 'চার্ট হাব', te: 'చార్ట్ కేంద్రం', gu: 'ચાર્ટ કેન્દ્ર', kn: 'ಚಾರ್ಟ್ ಕೇಂದ್ರ', mr: 'चार्ट केंद्र', mai: 'चार्ट केन्द्र' } },
    ],
  },
  {
    ...
    links: [
      { href: '/panchang', label: { en: 'Daily Panchang', hi: 'दैनिक पंचांग', ta: 'தினசரி பஞ்சாங்கம்', bn: 'দৈনিক পঞ্জিকা', te: 'రోజువారీ పంచాంగం', gu: 'દૈનિક પંચાંગ', kn: 'ದೈನಂದಿನ ಪಂಚಾಂಗ', mr: 'दैनिक पंचांग', mai: 'दैनिक पंचांग' } },
      ...
      { href: '/ekadashi', label: { en: 'Ekadashi', hi: 'एकादशी', ta: 'ஏகாதசி', bn: 'একাদশী', te: 'ఏకాదశి', gu: 'એકાદશી', kn: 'ಏಕಾದಶಿ', mr: 'एकादशी', mai: 'एकादशी' } },
      ...
      { href: '/events', label: { en: 'Celestial Events', hi: 'खगोलीय घटनाएँ', ta: 'வான் நிகழ்வுகள்', bn: 'জ্যোতির্বিদ্যা ঘটনা', te: 'ఖగోళ ఘటనలు', gu: 'ખગોળ ઘટનાઓ', kn: 'ಖಗೋಳ ಘಟನೆಗಳು', mr: 'खगोलीय घटना', mai: 'खगोलीय घटना' } },
      ...
      { href: '/choghadiya', label: { en: 'Choghadiya', hi: 'चौघड़िया', ta: 'சோகடியா', bn: 'চৌঘড়িয়া', te: 'చౌఘడియా', gu: 'ચોઘડિયું', kn: 'ಚೌಘಡಿಯ', mr: 'चौघडिया', mai: 'चौघड़िया' } },
      { href: '/gauri-panchang', label: { en: 'Gauri Panchang', hi: 'गौरी पंचांग', ta: 'கௌரி பஞ்சாங்கம்', bn: 'গৌরী পঞ্চাঙ্গ', te: 'గౌరి పంచాంగం', gu: 'ગૌરી પંચાંગ', kn: 'ಗೌರಿ ಪಂಚಾಂಗ', mr: 'गौरी पंचांग', mai: 'गौरी पंचांग' } },
      { href: '/career-muhurta', label: { en: 'Career Muhurta', hi: 'करियर मुहूर्त', ta: 'தொழில் முகூர்த்தம்', bn: 'কেরিয়ার মুহূর্ত', te: 'వృత్తి ముహూర్తం', gu: 'કારકિર્દી મુહૂર્ત', kn: 'ವೃತ್ತಿ ಮುಹೂರ್ತ', mr: 'करिअर मुहूर्त', mai: 'करियर मुहूर्त' } },
      { href: '/rahu-kaal', label: { en: 'Rahu Kaal', hi: 'राहु काल', ta: 'ராகு காலம்', bn: 'রাহু কাল', te: 'రాహు కాలం', gu: 'રાહુ કાળ', kn: 'ರಾಹು ಕಾಲ', mr: 'राहु काळ', mai: 'राहु काल' } },
      ...
      { href: '/daily', label: { en: 'Daily Articles', hi: 'दैनिक लेख', ta: 'தினசரி கட்டுரைகள்', bn: 'দৈনিক প্রবন্ধ', te: 'రోజువారీ వ్యాసాలు', gu: 'દૈનિક લેખો', kn: 'ದೈನಂದಿನ ಲೇಖನಗಳು', mr: 'दैनिक लेख', mai: 'दैनिक लेख' } },
      // Audit 2026-05-25 §B — rescue these orphan SEO landings from the dead-page bucket.
      { href: '/muhurat', label: { en: 'Muhurat Hub', hi: 'मुहूर्त केंद्र', ta: 'முகூர்த்த மையம்', bn: 'মুহূর্ত হাব', te: 'ముహూర్త కేంద్రం', gu: 'મુહૂર્ત કેન્દ્ર', kn: 'ಮುಹೂರ್ತ ಕೇಂದ್ರ', mr: 'मुहूर्त केंद्र', mai: 'मुहूर्त केन्द्र' } },
      ...
      { href: '/rituals', label: { en: 'Rituals', hi: 'अनुष्ठान', ta: 'சடங்குகள்', bn: 'অনুষ্ঠান', te: 'అనుష్ఠానాలు', gu: 'વિધિ', kn: 'ಆಚರಣೆಗಳು', mr: 'विधी', mai: 'अनुष्ठान' } },
    ],
  },
  {
    ...
    links: [
      ...
      { href: '/learn/grahas', label: { en: 'Grahas', hi: 'ग्रह', ta: 'கிரகங்கள்', bn: 'গ্রহ', te: 'గ్రహాలు', gu: 'ગ્રહો', kn: 'ಗ್ರಹಗಳು', mr: 'ग्रह', mai: 'ग्रह' } },
      { href: '/learn/rashis', label: { en: 'Rashis', hi: 'राशियाँ', ta: 'ராசிகள்', bn: 'রাশি', te: 'రాశులు', gu: 'રાશિઓ', kn: 'ರಾಶಿಗಳು', mr: 'राशी', mai: 'राशि' } },
      { href: '/learn/nakshatras', label: { en: 'Nakshatras', hi: 'नक्षत्र', ta: 'நட்சத்திரங்கள்', bn: 'নক্ষত্র', te: 'నక్షత్రాలు', gu: 'નક્ષત્રો', kn: 'ನಕ್ಷತ್ರಗಳು', mr: 'नक्षत्रे', mai: 'नक्षत्र' } },
      { href: '/learn/tithis', label: { en: 'Tithis', hi: 'तिथियाँ', ta: 'திதிகள்', bn: 'তিথি', te: 'తిథులు', gu: 'તિથિઓ', kn: 'ತಿಥಿಗಳು', mr: 'तिथी', mai: 'तिथि' } },
      { href: '/learn/yoga', label: { en: 'Yogas', hi: 'योग', ta: 'யோகங்கள்', bn: 'যোগ', te: 'యోగాలు', gu: 'યોગો', kn: 'ಯೋಗಗಳು', mr: 'योग', mai: 'योग' } },
      { href: '/learn/karanas', label: { en: 'Karanas', hi: 'करण', ta: 'கரணங்கள்', bn: 'করণ', te: 'కరణాలు', gu: 'કરણો', kn: 'ಕರಣಗಳು', mr: 'करण', mai: 'करण' } },
      { href: '/learn/kundali', label: { en: 'Kundali Reading', hi: 'कुण्डली पठन', ta: 'குண்டலி படிப்பு', bn: 'কুণ্ডলি পাঠ', te: 'కుండలి అధ్యయనం', gu: 'કુંડળી વાંચન', kn: 'ಜಾತಕ ಓದುವಿಕೆ', mr: 'कुंडली वाचन', mai: 'कुण्डली पठन' } },
      { href: '/glossary', label: { en: 'Glossary', hi: 'शब्दकोश', ta: 'சொற்பொருள்', bn: 'শব্দকোষ', te: 'పదకోశం', gu: 'શબ્દકોશ', kn: 'ಪದಕೋಶ', mr: 'शब्दकोश', mai: 'शब्दावली' } },
      { href: '/accuracy', label: { en: 'Accuracy', hi: 'सटीकता', ta: 'துல்லியம்', bn: 'নির্ভুলতা', te: 'ఖచ్చితత్వం', gu: 'ચોકસાઈ', kn: 'ನಿಖರತೆ', mr: 'अचूकता', mai: 'सटीकता' } },
      { href: '/videos', label: { en: 'Videos', hi: 'वीडियो', ta: 'காணொளிகள்', bn: 'ভিডিও', te: 'వీడియోలు', gu: 'વિડિઓ', kn: 'ವೀಡಿಯೊಗಳು', mr: 'व्हिडिओ', mai: 'वीडियो' } },
    ],
  },
  {
    ...
    links: [
      { href: '/panchang/tithi', label: { en: 'Tithi', hi: 'तिथि', ta: 'திதி', bn: 'তিথি', te: 'తిథి', gu: 'તિથિ', kn: 'ತಿಥಿ', mr: 'तिथी', mai: 'तिथि' } },
      { href: '/panchang/nakshatra', label: { en: 'Nakshatra', hi: 'नक्षत्र', ta: 'நட்சத்திரம்', bn: 'নক্ষত্র', te: 'నక్షత్రం', gu: 'નક્ષત્ર', kn: 'ನಕ್ಷತ್ರ', mr: 'नक्षत्र', mai: 'नक्षत्र' } },
      { href: '/panchang/yoga', label: { en: 'Yoga', hi: 'योग', ta: 'யோகம்', bn: 'যোগ', te: 'యోగం', gu: 'યોગ', kn: 'ಯೋಗ', mr: 'योग', mai: 'योग' } },
      { href: '/panchang/karana', label: { en: 'Karana', hi: 'करण', ta: 'கரணம்', bn: 'করণ', te: 'కరణం', gu: 'કરણ', kn: 'ಕರಣ', mr: 'करण', mai: 'करण' } },
      { href: '/panchang/muhurta', label: { en: 'Muhurta', hi: 'मुहूर्त', ta: 'முகூர்த்தம்', bn: 'মুহূর্ত', te: 'ముహూర్తం', gu: 'મુહૂર્ત', kn: 'ಮುಹೂರ್ತ', mr: 'मुहूर्त', mai: 'मुहूर्त' } },
      { href: '/panchang/rashi', label: { en: 'Rashi', hi: 'राशि', ta: 'ராசி', bn: 'রাশি', te: 'రాశి', gu: 'રાશિ', kn: 'ರಾಶಿ', mr: 'राशी', mai: 'राशि' } },
      { href: '/panchang/masa', label: { en: 'Masa', hi: 'मास', ta: 'மாதம்', bn: 'মাস', te: 'మాసం', gu: 'માસ', kn: 'ಮಾಸ', mr: 'मास', mai: 'मास' } },
      { href: '/panchang/grahan', label: { en: 'Grahan', hi: 'ग्रहण', ta: 'கிரகணம்', bn: 'গ্রহণ', te: 'గ్రహణం', gu: 'ગ્રહણ', kn: 'ಗ್ರಹಣ', mr: 'ग्रहण', mai: 'ग्रहण' } },
      { href: '/panchang/samvatsara', label: { en: 'Samvatsara', hi: 'संवत्सर', ta: 'சம்வத்சரம்', bn: 'সংবৎসর', te: 'సంవత్సరం', gu: 'સંવત્સર', kn: 'ಸಂವತ್ಸರ', mr: 'संवत्सर', mai: 'संवत्सर' } },
    ],
  },
];
