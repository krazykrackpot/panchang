    ...
    <div>
      ...
      <LessonSection number={1} title={L.whatTitle[locale]}>
        ...
        <div className="mt-4 p-4 bg-bg-primary/50 rounded-lg border border-gold-primary/10">
          ...
          <p className="text-gold-light/60 font-mono text-xs">
            {locale === 'en' ? 'Higher weight → higher importance: Nadi (8) > Bhakoot (7) > Gana (6) > ...' : 'अधिक भार → अधिक महत्व: नाड़ी (8) > भकूट (7) > गण (6) > ...'}
          </p>
        </div>
      </LessonSection>
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                ...
                <div className="flex items-center gap-2 flex-1">
                  ...
                  <span className="ml-auto text-gold-primary font-mono text-sm font-bold">{k.points} {locale === 'en' ? 'pts' : 'अंक'}</span>
                </div>
              </div>
      ...
      <LessonSection number={3} title={L.calcTitle[locale]}>
        ...
        <div className="mt-4 p-4 bg-bg-primary/50 rounded-lg border border-gold-primary/10">
          ...
          <p className="text-gold-light/80 font-mono text-xs">1. {locale === 'en' ? 'Input: Birth Moon Nakshatra and Rashi of both partners' : 'इनपुट: दोनों साथियों का जन्म चन्द्र नक्षत्र और राशि'}</p>
          ...
          <p className="text-gold-light/80 font-mono text-xs">4. {locale === 'en' ? 'Check for Doshas (Nadi, Bhakoot, Mangal)' : 'दोषों की जाँच (नाड़ी, भकूट, मांगलिक)'}</p>
          ...
          <p className="text-gold-light/80 font-mono text-xs">6. {locale === 'en' ? 'Assess Mangal Dosha separately from Lagna, Moon, and Venus' : 'मांगलिक दोष का लग्न, चन्द्र और शुक्र से अलग मूल्यांकन'}</p>
          <p className="text-gold-light/80 font-mono text-xs">7. {locale === 'en' ? 'Generate detailed compatibility report with Kuta-wise breakdown' : 'कूट-अनुसार विस्तृत अनुकूलता रिपोर्ट तैयार करें'}</p>
        </div>
      </LessonSection>
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-red-400/60 text-xs font-mono">
                  {locale === 'en' ? 'position pair' : 'स्थिति जोड़ा'}
                </span>
              </div>
              ...
              <div className="p-2 rounded bg-emerald-400/5 border border-emerald-400/10">
                <p className="text-emerald-400/80 text-xs">
                  {locale === 'en' ? 'Cancellation: ' : 'निरसन: '}{bp.cancel[locale]}
                </p>
              </div>
            </motion.div>
          ))}
      ...
      <LessonSection number={7} title={L.mangalTitle[locale]}>
        ...
        <div className="mt-4 p-4 bg-bg-primary/50 rounded-lg border border-gold-primary/10 mb-4">
          <p className="text-gold-light font-mono text-sm mb-2">
            {locale === 'en' ? 'Mars in houses 1, 4, 7, 8, 12 from:' : 'भाव 1, 4, 7, 8, 12 में मंगल — इनसे:'}
          </p>
          <p className="text-gold-light/80 font-mono text-xs">
            {locale === 'en' ? '• Lagna (Ascendant) — checked in all traditions' : '• लग्न — सभी परम्पराओं में जाँचा जाता है'}
          </p>
          <p className="text-gold-light/80 font-mono text-xs">
            {locale === 'en' ? '• Moon — checked in most North Indian traditions' : '• चन्द्र — अधिकांश उत्तर भारतीय परम्पराओं में'}
          </p>
          <p className="text-gold-light/80 font-mono text-xs">
            {locale === 'en' ? '• Venus — checked in South Indian traditions (Kalathra Dosha)' : '• शुक्र — दक्षिण भारतीय परम्पराओं में (कलत्र दोष)'}
          </p>
        </div>
        <h4 className="text-gold-light font-semibold text-sm mb-3">
          {locale === 'en' ? 'Mangal Dosha Cancellation Conditions:' : 'मांगलिक दोष निरसन शर्तें:'}
        </h4>
