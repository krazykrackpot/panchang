    ...
    <div className="space-y-6">
      ...
      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        ...
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Example:</span> A person born on 15 March 1990 with Moon at 18°40&apos; Taurus (Rohini nakshatra, Moon-ruled). Rohini spans 10°00&apos; to 23°20&apos; Taurus. Moon is at 18°40&apos;, so it has traversed 8°40&apos; of 13°20&apos; = 65% of the nakshatra. This means 65% of Moon dasha (10 years) is elapsed: 6.5 years already gone. Balance at birth: 3.5 years of Moon dasha remain. The sequence then proceeds: Mars (7 years from ~age 3.5), Rahu (18 years from ~age 10.5), Jupiter (16 years from ~age 28.5), Saturn (19 years from ~age 44.5), and so on.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">उदाहरण:</span> 15 मार्च 1990 को चन्द्रमा वृषभ 18°40&apos; (रोहिणी नक्षत्र, चन्द्र शासित) पर जन्मा व्यक्ति। रोहिणी वृषभ 10°00&apos; से 23°20&apos; तक फैला है। चन्द्रमा 18°40&apos; पर है, अतः 13°20&apos; में से 8°40&apos; = 65% नक्षत्र पार कर चुका है। अर्थात् चन्द्र दशा (10 वर्ष) का 65% = 6.5 वर्ष व्यतीत। जन्म पर शेष: चन्द्र दशा के 3.5 वर्ष। फिर क्रम: मंगल (लगभग 3.5 वर्ष की आयु से 7 वर्ष), राहु (लगभग 10.5 वर्ष से 18 वर्ष), गुरु (लगभग 28.5 वर्ष से 16 वर्ष), शनि (लगभग 44.5 वर्ष से 19 वर्ष), इत्यादि।
        </p>
      </section>
    </div>
  );
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="glass-card rounded-xl p-5 border border-red-500/15">
        ...
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Misconception:</span> &quot;Saturn dasha is always bad and Venus dasha is always good.&quot; This is false. Saturn dasha for a Taurus or Libra ascendant can be excellent — Saturn rules benefic houses (9th/10th for Taurus, 4th/5th for Libra). Conversely, Venus dasha for a Scorpio ascendant (where Venus rules 7th and 12th) can bring losses alongside relationships. Always judge the planet&apos;s house lordship, placement, and dignity — never by name alone.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">भ्रान्ति:</span> &quot;शनि दशा सदा बुरी और शुक्र दशा सदा अच्छी होती है।&quot; यह असत्य है। वृषभ या तुला लग्न के लिए शनि दशा उत्कृष्ट हो सकती है — शनि शुभ भावों (वृषभ के लिए 9/10, तुला के लिए 4/5) का स्वामी है। इसके विपरीत, वृश्चिक लग्न के लिए शुक्र दशा (जहाँ शुक्र 7वें और 12वें का स्वामी है) सम्बन्धों के साथ हानि भी ला सकती है। सदा ग्रह का भावेशत्व, स्थिति और बल देखें — कभी केवल नाम से न आँकें।
        </p>
      </section>

      <section className="glass-card rounded-xl p-5 border border-blue-500/15">
        <h4 className="text-blue-300 text-[10px] uppercase tracking-widest font-bold mb-3">In Our App / हमारे ऐप में</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          Our Kundali engine computes the complete Vimshottari dasha table from birth through 120 years. It calculates the Moon&apos;s exact sidereal longitude, identifies the birth nakshatra, determines the balance of dasha, and generates Mahadasha and Antardasha periods with precise start and end dates. The Tippanni (interpretive commentary) section explains which dasha is currently running and what its activation means for your specific chart — combining house lordship, placement, and natural signification.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          हमारा कुण्डली इंजन जन्म से 120 वर्षों तक की पूर्ण विंशोत्तरी दशा तालिका गणित करता है। यह चन्द्रमा का सटीक निरयन भोगांश गणित करता है, जन्म नक्षत्र पहचानता है, दशा शेष निर्धारित करता है, और सटीक आरम्भ-समाप्ति तिथियों सहित महादशा एवं अन्तर्दशा काल उत्पन्न करता है। टिप्पणी (व्याख्यात्मक भाष्य) खण्ड बताता है कि वर्तमान में कौन-सी दशा चल रही है और आपकी विशिष्ट कुण्डली के लिए उसके सक्रियण का क्या अर्थ है — भावेशत्व, स्थिति और नैसर्गिक कारकत्व का संयोजन करते हुए।
        </p>
      </section>
    </div>
  );
