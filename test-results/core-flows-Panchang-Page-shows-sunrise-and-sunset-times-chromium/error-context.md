...
- Name: core-flows.spec.ts >> Panchang Page >> shows sunrise and sunset times
- Location: e2e/core-flows.spec.ts:49:7
...
Locator: locator('text=/\\d{2}:\\d{2}/')
Expected: visible
Error: strict mode violation: locator('text=/\\d{2}:\\d{2}/') resolved to 108 elements:
    1) <span class="font-mono text-xs font-bold text-purple-300">22:03 — 23:03</span> aka getByText(':03 — 23:03')
    2) <div class="font-mono text-sm text-amber-300 font-bold">08:30, 5 Apr — 10:41, 6 Apr</div> aka getByText(':30, 5 Apr — 10:41, 6 Apr')
    3) <div class="font-mono text-sm text-amber-300 font-bold mt-1.5">10:41, 6 Apr onwards</div> aka getByText(':41, 6 Apr onwards')
    4) <div class="font-mono text-sm text-amber-300 font-bold">20:37, 5 Apr — 23:26, 6 Apr</div> aka getByText(':37, 5 Apr — 23:26, 6 Apr')
    5) <div class="font-mono text-sm text-amber-300 font-bold mt-1.5">23:26, 6 Apr onwards</div> aka getByText(':26, 6 Apr onwards')
    6) <div class="font-mono text-sm text-amber-300 font-bold">11:13, 5 Apr — 11:54, 6 Apr</div> aka getByText(':13, 5 Apr — 11:54, 6 Apr')
    7) <div class="font-mono text-sm text-amber-300 font-bold">21:33, 5 Apr — 10:41, 6 Apr</div> aka getByText(':33, 5 Apr — 10:41, 6 Apr')
    8) <div class="text-amber-300 font-bold text-xl font-mono">10:00 – 11:00</div> aka getByText(':00 – 11:00')
    9) <div class="text-amber-300 font-mono text-2xl font-bold">07:59</div> aka getByText('07:59', { exact: true })
    10) <div class="text-amber-300 font-mono text-2xl font-bold">20:05</div> aka getByText('20:05', { exact: true })
    ...

Call log:
  - Expect "toBeVisible" with timeout 15000ms
  - waiting for locator('text=/\\d{2}:\\d{2}/')
