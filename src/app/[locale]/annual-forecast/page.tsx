    ...
    <>
      ...
      {forecast.keyDates.length === 0 ? (
        <p className="text-text-secondary text-sm text-center py-4" style={bodyFont}>
          {tl({ en: 'No significant key dates found for this year.', hi: 'इस वर्ष कोई प्रमुख तिथि नहीं मिली।', sa: 'अस्मिन् वर्षे कोऽपि विशेषः महत्त्वपूर्णः दिनाङ्कः न प्राप्तः।', ta: 'இந்த ஆண்டுக்கான முக்கிய தேதிகள் எதுவும் இல்லை.', te: 'ఈ సంవత్సరం కీలక తేదీలు ఏమీ కనుగొనబడలేదు.', bn: 'এই বছরের জন্য কোনো গুরুত্বপূর্ণ তারিখ পাওয়া যায়নি।', kn: 'ಈ ವರ್ಷಕ್ಕೆ ಯಾವುದೇ ಮಹತ್ವದ ಪ್ರಮುಖ ದಿನಾಂಕಗಳು ಕಂಡುಬಂದಿಲ್ಲ.', gu: 'આ વર્ષ માટે કોઈ મહત્ત્વની તારીખ મળી નથી.', mai: 'एहि वर्षक लेल कोनो प्रमुख तिथि नहि भेटल।', mr: 'या वर्षासाठी कोणत्याही महत्त्वाच्या तारखा आढळल्या नाहीत.' }, locale)}
        </p>
      ) : (
  ...
  return (
    <>
      ...
      {forecast.remedies.length === 0 ? (
        <p className="text-text-secondary text-sm text-center py-4" style={bodyFont}>
          {tl({ en: 'No specific remedies indicated.', hi: 'कोई विशेष उपाय आवश्यक नहीं।', sa: 'कोऽपि विशिष्टः उपायः न निर्दिष्टः।', ta: 'குறிப்பிட்ட எந்த தீர்வும் இல்லை.', te: 'ఏ నిర్దిష్ట పరిహారాలు సూచించబడలేదు.', bn: 'কোনো নির্দিষ্ট প্রতিকার নির্দেশিত হয়নি।', kn: 'ಯಾವುದೇ ನಿರ್ದಿಷ್ಟ ಪರಿಹಾರ ಸೂಚಿಸಲಾಗಿಲ್ಲ.', gu: 'કોઈ ચોક્કસ ઉપાય સૂચિત નથી.', mai: 'कोनो विशेष उपाय संकेत नहि अछि।', mr: 'कोणताही विशिष्ट उपाय सुचवलेला नाही.' }, locale)}
        </p>
      ) : (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
