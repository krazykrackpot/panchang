    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Why Astronomers Need a Continuous Day Count / खगोलविदों को निरन्तर दिन-गणना क्यों चाहिए
        </h3>
      ...
      <section className="glass-card rounded-xl p-5 border border-gold-primary/10">
        <h4 className="text-gold-dark text-[10px] uppercase tracking-widest font-bold mb-2">Why 4713 BCE? / 4713 ई.पू. क्यों?</h4>
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          The Algorithm Step by Step / एल्गोरिदम चरणबद्ध
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          Converting a Gregorian date to a Julian Day number follows a precise sequence. Given a date with year Y, month M, day D, and hour H (in UT): Step 1 — If M is 1 (January) or 2 (February), replace Y with Y-1 and M with M+12. This treats January and February as months 13 and 14 of the preceding year, a convention inherited from the Roman calendar where March was the first month. This simplification allows the month-length approximation to work without special-casing February.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          ग्रेगोरियन तिथि को जूलियन दिवस संख्या में बदलना एक सटीक क्रम का पालन करता है। वर्ष Y, मास M, दिन D, और घण्टा H (UT में) वाली तिथि के लिए: चरण 1 — यदि M = 1 (जनवरी) या 2 (फरवरी) हो तो Y को Y-1 और M को M+12 से बदलें। यह जनवरी और फरवरी को पिछले वर्ष के महीने 13 और 14 मानता है — रोमन कैलेण्डर से विरासत में मिली परम्परा जहाँ मार्च प्रथम महीना था। यह सरलीकरण मास-लम्बाई अनुमान को फरवरी का विशेष प्रबन्ध किए बिना कार्य करने देता है।
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          Step 2 — Compute the Gregorian correction: A = floor(Y / 100), B = 2 - A + floor(A / 4). The term A counts completed centuries. The correction B accounts for the leap days dropped in the Gregorian reform: the Julian calendar adds a leap day every 4 years, but the Gregorian calendar skips it on century years not divisible by 400 (e.g., 1700, 1800, 1900 were not leap years, but 2000 was). For dates before October 15, 1582 (Julian calendar), B = 0.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          चरण 2 — ग्रेगोरियन सुधार गणित करें: A = floor(Y / 100), B = 2 - A + floor(A / 4)। A पूर्ण शताब्दियों की गणना करता है। सुधार B ग्रेगोरियन सुधार में हटाए गए अधिवर्ष दिनों का लेखा-जोखा है: जूलियन कैलेण्डर प्रत्येक 4 वर्ष अधिवर्ष दिन जोड़ता है, किन्तु ग्रेगोरियन कैलेण्डर 400 से अविभाज्य शताब्दी वर्षों पर इसे छोड़ता है (जैसे 1700, 1800, 1900 अधिवर्ष नहीं थे, किन्तु 2000 था)। 15 अक्टूबर, 1582 (जूलियन कैलेण्डर) से पहले की तिथियों के लिए B = 0।
        </p>
      </section>

      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">The Complete Formula / सम्पूर्ण सूत्र</h4>
        ...
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          The term floor(365.25 x (Y+4716)) counts the days from leap-year-aware years since the epoch. The term floor(30.6001 x (M+1)) approximates the cumulative days of months elapsed. The 0.6001 (not 0.6) avoids floating-point rounding errors. D + H/24 adds the fractional day. B is the Gregorian correction. The constant -1524.5 aligns the result to the JD epoch.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          floor(365.25 × (Y+4716)) पद युगारम्भ से अधिवर्ष-सचेत वर्षों के दिनों की गणना करता है। floor(30.6001 × (M+1)) पद बीते महीनों के संचयी दिनों का अनुमान लगाता है। 0.6001 (0.6 नहीं) फ़्लोटिंग-पॉइंट पूर्णांकन त्रुटियों से बचाता है। D + H/24 आंशिक दिन जोड़ता है। B ग्रेगोरियन सुधार है। स्थिरांक -1524.5 परिणाम को JD युगारम्भ से संरेखित करता है।
        </p>
      </section>

      <section className="glass-card rounded-xl p-5 border border-blue-500/15">
        <h4 className="text-blue-300 text-[10px] uppercase tracking-widest font-bold mb-3">Worked Example / कार्यान्वित उदाहरण</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">April 2, 2026, 12:00 UT:</span> Y = 2026, M = 4, D = 2, H = 12. Since M &gt; 2, no adjustment needed. A = floor(2026/100) = 20. B = 2 - 20 + floor(20/4) = 2 - 20 + 5 = -13. JD = floor(365.25 x 6742) + floor(30.6001 x 5) + 2 + 0.5 + (-13) - 1524.5 = 2,462,979.5 + 153 + 2 + 0.5 - 13 - 1524.5 = 2,461,132.0.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">2 अप्रैल, 2026, 12:00 UT:</span> Y = 2026, M = 4, D = 2, H = 12। M &gt; 2 होने से कोई समायोजन नहीं। A = floor(2026/100) = 20। B = 2 - 20 + floor(20/4) = 2 - 20 + 5 = -13। JD = floor(365.25 × 6742) + floor(30.6001 × 5) + 2 + 0.5 + (-13) - 1524.5 = 2,462,979.5 + 153 + 2 + 0.5 - 13 - 1524.5 = 2,461,132.0।
        </p>
      </section>
    </div>
  );
...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Julian Centuries and the T Variable / जूलियन शताब्दियाँ और T चर
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          Once we have a Julian Day number, the next step in every astronomical formula is converting it to Julian Centuries (T) from the J2000.0 epoch: T = (JD - 2451545.0) / 36525. The denominator 36525 is simply 100 years multiplied by 365.25 days per Julian year. This T value is the universal time variable that drives ALL positional astronomy formulas in Jean Meeus&apos;s &quot;Astronomical Algorithms.&quot; Every polynomial expression for the Sun&apos;s longitude, the Moon&apos;s latitude, Earth&apos;s obliquity, nutation, and precession is expressed as a power series in T.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          जूलियन दिवस संख्या प्राप्त होने पर प्रत्येक खगोलीय सूत्र का अगला चरण इसे J2000.0 युगारम्भ से जूलियन शताब्दियों (T) में बदलना है: T = (JD - 2451545.0) / 36525। हर 36525 बस 100 वर्ष गुणा 365.25 दिन प्रति जूलियन वर्ष है। यह T मान वह सार्वभौमिक समय चर है जो जीन मीयस की &quot;खगोलीय एल्गोरिदम&quot; में सभी स्थिति-खगोलविज्ञान सूत्रों को चलाता है। सूर्य भोगांश, चन्द्र अक्षांश, पृथ्वी की क्रान्तिवृत्त तिर्यकता, अयन-चलन और पुरस्सरण की प्रत्येक बहुपद अभिव्यक्ति T में घात श्रेणी के रूप में व्यक्त होती है।
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          Why J2000.0? This epoch was adopted by the International Astronomical Union (IAU) because it falls in the modern era when star positions are known with extreme precision (thanks to the Hipparcos satellite catalog), Earth orientation parameters are precisely measured, and it serves as a clean round number that minimizes rounding in T for contemporary dates. For April 2, 2026: T = (2461132.0 - 2451545.0) / 36525 = 9587.0 / 36525 = 0.26246, meaning we are about 0.262 Julian centuries (26.2 years) past J2000.0.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed">
          J2000.0 क्यों? यह युगारम्भ अन्तर्राष्ट्रीय खगोलीय संघ (IAU) ने अपनाया क्योंकि यह आधुनिक युग में आता है जब तारा-स्थान अत्यन्त सटीकता से ज्ञात हैं (हिपार्कोस उपग्रह सूची के कारण), पृथ्वी अभिविन्यास प्राचल सटीक रूप से मापे गए हैं, और यह एक स्पष्ट गोल संख्या है जो समकालीन तिथियों के लिए T में पूर्णांकन न्यूनतम करती है। 2 अप्रैल, 2026 के लिए: T = (2461132.0 - 2451545.0) / 36525 = 9587.0 / 36525 = 0.26246, अर्थात हम J2000.0 से लगभग 0.262 जूलियन शताब्दी (26.2 वर्ष) आगे हैं।
        </p>
      </section>

      <section className="glass-card rounded-xl p-5 border border-gold-primary/10">
        <h4 className="text-gold-dark text-[10px] uppercase tracking-widest font-bold mb-2">How Our App Uses JD / हमारा ऐप JD कैसे उपयोग करता है</h4>
        <p className="text-text-secondary text-sm leading-relaxed mb-2">
          In our codebase, the function dateToJD() is the gateway to all computation. When a user views the Panchang for a date, the first thing that happens is: JD = dateToJD(year, month, day, hour). This JD is then passed to sunLongitude(jd) and moonLongitude(jd) to get the tropical positions of the Sun and Moon. The difference (Moon - Sun) gives the Tithi. The Moon&apos;s sidereal position gives the Nakshatra. The combined Sun-Moon longitude sum gives the Yoga. Every single element of the Panchang traces back to this one JD conversion.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed">
          हमारे कोडबेस में dateToJD() फ़ंक्शन सभी गणना का प्रवेशद्वार है। जब उपयोगकर्ता किसी तिथि का पंचांग देखता है, सबसे पहले होता है: JD = dateToJD(year, month, day, hour)। यह JD फिर sunLongitude(jd) और moonLongitude(jd) को दिया जाता है ताकि सूर्य और चन्द्रमा की सायन स्थितियाँ मिलें। अन्तर (चन्द्र - सूर्य) तिथि देता है। चन्द्रमा की निरयन स्थिति नक्षत्र देती है। संयुक्त सूर्य-चन्द्र भोगांश योग देता है। पंचांग का प्रत्येक अंग इसी एक JD रूपान्तरण से जुड़ा है।
        </p>
      </section>
      ...
      <section className="glass-card rounded-xl p-5 border border-red-500/15">
        ...
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Misconception:</span> &quot;Julian Day is just a Unix timestamp in different units.&quot; While both are continuous time counts, Unix timestamps start at January 1, 1970 and count seconds, while JD starts at 4713 BCE and counts days. More importantly, JD begins at noon UT (not midnight), which means JD .0 = noon and JD .5 = midnight — the opposite of what most programmers expect.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">भ्रान्ति:</span> &quot;जूलियन दिवस बस भिन्न इकाइयों में यूनिक्स टाइमस्टैम्प है।&quot; दोनों निरन्तर समय गणनाएँ हैं, किन्तु यूनिक्स टाइमस्टैम्प 1 जनवरी, 1970 से आरम्भ होकर सेकण्ड गिनता है, जबकि JD 4713 ई.पू. से आरम्भ होकर दिन गिनता है। महत्त्वपूर्ण बात, JD मध्याह्न UT (मध्यरात्रि नहीं) से आरम्भ होता है, अर्थात JD .0 = मध्याह्न और JD .5 = मध्यरात्रि — अधिकांश प्रोग्रामरों की अपेक्षा के विपरीत।
        </p>
      </section>
    </div>
  );
