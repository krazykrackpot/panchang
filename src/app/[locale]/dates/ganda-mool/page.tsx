...
const LABELS: Record<string, Record<string, string>> = {
  ...
  loading: {
    en: "Computing Ganda Mool dates...",
    hi: "गण्ड मूल तिथियां गणना हो रही हैं...",
  },
  ...
  noEntries: {
    en: "No Ganda Mool dates found",
    hi: "कोई गण्ड मूल तिथि नहीं मिली",
  },
...
export default function GandaMoolPage() {
  ...
  useEffect(() => {
    ...
    fetch(
      `/api/ganda-mool?year=${year}&lat=${lat}&lon=${lng}&tz=${encodeURIComponent(tz)}`,
    )
      .then(async (res) => {
    ...
    <main className="min-h-screen bg-bg-primary pt-24 pb-16">
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: safeJsonLd(
            generateBreadcrumbLD(`/${locale}/dates/ganda-mool`, locale),
          ),
        }}
      />
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        ...
        >
          <div className="inline-flex items-center gap-3 mb-4">
            ...
            <h1
              className={`text-3xl sm:text-4xl font-bold text-gold-light ${isDev ? "font-devanagari-heading" : ""}`}
            >
              {L("title")} {year}
            </h1>
          </div>
          ...
          <div className="flex items-center justify-center gap-4 mt-6">
            <button
              ...
              className="p-2 rounded-lg bg-bg-secondary hover:bg-gold-primary/10 text-gold-primary transition-colors"
            >
          ...
          {locName && (
            <p className="text-text-secondary text-sm mt-2">{locName}</p>
          )}
        </motion.div>
          ...
          <div className="space-y-10">
            {Array.from(byMonth.entries())
              ...
              .map(([m, monthEntries]) => (
                ...
                >
                  <h2
                    className={`text-xl font-bold text-gold-light mb-4 ${isDev ? "font-devanagari-heading" : ""}`}
                  >
                    {months[m - 1]} {year}
                  </h2>
                        ...
                        <tbody>
                          {monthEntries.map((e, i) => {
                            ...
                            return (
                              <tr
                                key={i}
                                className="border-b border-gold-primary/8 last:border-b-0 hover:bg-gold-primary/5 transition-colors"
                              >
                                ...
                                <td
                                  className={`px-4 py-3 font-semibold ${NAK_COLORS[e.nakshatraId] || "text-gold-light"}`}
                                >
        ...
        <div className="space-y-10 max-w-3xl mx-auto">
          <section>
            <h2
              className={`text-2xl font-bold text-gold-light mb-4 ${isDev ? "font-devanagari-heading" : ""}`}
            >
              {L("whatIs")}
            </h2>
