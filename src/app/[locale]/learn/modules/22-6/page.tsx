    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Sundial Time vs Clock Time / धूपघड़ी समय बनाम घड़ी समय
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          A sundial tells &quot;apparent solar time&quot; — when the shadow is shortest, it is solar noon, meaning the Sun is at its highest point and exactly due south (in the Northern Hemisphere). A clock tells &quot;mean solar time&quot; — uniform 24-hour days, every minute exactly the same length. These two disagree by up to 16 minutes because the real Sun does not move at constant speed across the sky. The Equation of Time (EoT) quantifies this discrepancy: EoT = Apparent Solar Time - Mean Solar Time. When EoT is positive, the sundial is ahead of the clock (the Sun reaches its highest point before 12:00 mean time).
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
  ...
  return (
    <div className="space-y-6">
      <section>
        ...
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          Effect 2 — Eccentricity: Earth&apos;s orbit is not a circle but an ellipse (e ≈ 0.017). By Kepler&apos;s second law, Earth moves faster near perihelion (January) and slower near aphelion (July). This makes the Sun appear to move faster or slower along the ecliptic, creating an annual oscillation in the EoT with amplitude ~7.7 minutes. Combined with the obliquity effect (~9.9 minutes semi-annual), the two produce the characteristic asymmetric double-peaked EoT curve.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          प्रभाव 2 — उत्केन्द्रता: पृथ्वी की कक्षा वृत्त नहीं बल्कि दीर्घवृत्त (e ≈ 0.017) है। केप्लर के द्वितीय नियम से पृथ्वी उपसौर (जनवरी) के निकट तेज़ और अपसौर (जुलाई) के निकट धीमी चलती है। इससे सूर्य क्रान्तिवृत्त पर तेज़ या धीमा गतिमान दिखता है, EoT में ~7.7 मिनट आयाम का वार्षिक दोलन बनाता है। तिर्यकता प्रभाव (~9.9 मिनट अर्ध-वार्षिक) के साथ मिलकर, दोनों विशिष्ट विषम द्वि-शिखर EoT वक्र बनाते हैं।
        </p>
      </section>

      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">The Mathematical Expression / गणितीय अभिव्यक्ति</h4>
        ...
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          This result is in radians. To convert to minutes: EoT_minutes = EoT × (180/π) × 4. The factor 4 comes from the Sun traversing 360° in 1440 minutes (24 × 60), so 1° = 4 minutes of time.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          y = tan²(ε/2) जहाँ ε ≈ 23.44° तिर्यकता है। e ≈ 0.01671 उत्केन्द्रता। L₀ सूर्य का माध्य भोगांश और M माध्य विलम्बिका। परिणाम रेडियन में है। मिनटों में बदलने के लिए: EoT_minutes = EoT × (180/π) × 4। गुणक 4 इसलिए क्योंकि सूर्य 1440 मिनट (24 × 60) में 360° पार करता है, अतः 1° = 4 मिनट समय।
        </p>
      ...
      <section className="glass-card rounded-xl p-5 border border-gold-primary/10">
        <h4 className="text-gold-dark text-[10px] uppercase tracking-widest font-bold mb-2">The Analemma / एनालेम्मा</h4>
        <p className="text-text-secondary text-sm leading-relaxed mb-2">
          If you photograph the Sun at the same clock time every day for a year, it does NOT return to the same spot. Instead, it traces a figure-8 pattern called the analemma. The east-west displacement is the EoT (the Sun is east of its mean position when EoT &gt; 0, west when EoT &lt; 0). The north-south displacement is the changing declination (high in summer, low in winter). The analemma is asymmetric because the eccentricity and obliquity effects have different periods — one loop is larger than the other.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed">
          यदि आप प्रतिदिन एक ही घड़ी समय पर पूरे वर्ष सूर्य का चित्र लें, तो यह उसी स्थान पर नहीं लौटता। इसके बजाय, यह एनालेम्मा नामक अंक-8 आकृति बनाता है। पूर्व-पश्चिम विस्थापन EoT है (EoT &gt; 0 होने पर सूर्य अपनी माध्य स्थिति से पूर्व में, EoT &lt; 0 होने पर पश्चिम में)। उत्तर-दक्षिण विस्थापन बदलती क्रान्ति है (ग्रीष्म में ऊँचा, शीत में नीचा)। एनालेम्मा विषम है क्योंकि उत्केन्द्रता और तिर्यकता प्रभावों की भिन्न अवधियाँ हैं — एक पाश दूसरे से बड़ा है।
        </p>
      </section>
    </div>
  );
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="glass-card rounded-xl p-5 border border-blue-500/15">
        ...
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          Understanding the EoT connects ancient Indian astronomy with modern computational practice. The Surya Siddhanta already accounts for the eccentricity effect through its mandaphala (equation of center) correction. The obliquity effect appears in the conversion between ecliptic and equatorial coordinates (kranti calculation). Our engine combines both effects in the compact EoT formula, applying it every time it computes sunrise or sunset — the foundational reference times upon which the entire Panchang structure rests.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          EoT को समझना प्राचीन भारतीय खगोलशास्त्र को आधुनिक संगणक अभ्यास से जोड़ता है। सूर्य सिद्धान्त पहले से ही अपने मन्दफल (केन्द्र समीकरण) सुधार द्वारा उत्केन्द्रता प्रभाव का लेखा-जोखा रखता है। तिर्यकता प्रभाव क्रान्तिवृत्तीय और विषुवतीय निर्देशांकों के बीच रूपान्तरण (क्रान्ति गणना) में प्रकट होता है। हमारा इंजन दोनों प्रभावों को संक्षिप्त EoT सूत्र में संयोजित करता है, जब भी सूर्योदय या सूर्यास्त गणित करता है इसे लागू करता है — वे आधारभूत सन्दर्भ समय जिन पर सम्पूर्ण पंचांग संरचना टिकी है।
        </p>
      </section>
    </div>
  );
