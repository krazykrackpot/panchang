  ...
  return (
    <div className="space-y-6">
      ...
      <section className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-xl p-5 border border-blue-500/15">
        ...
        <p className="text-text-secondary text-xs leading-relaxed">
          {tl({ en: 'In contemporary India, nakshatra classifications remain central to muhurta (auspicious timing) selection. Wedding planners, real estate agents, and business consultants routinely consult Panchang apps to verify the Moon&apos;s nakshatra before scheduling important events. Our application computes the Moon&apos;s exact sidereal longitude with Swiss Ephemeris (sub-arcsecond precision; Meeus is the documented fallback) and determines the current nakshatra in real time, enabling users to plan activities aligned with the appropriate nakshatra quality.', hi: 'समकालीन भारत में नक्षत्र वर्गीकरण मुहूर्त (शुभ समय) चयन के लिए केन्द्रीय बना हुआ है। विवाह आयोजक, सम्पत्ति एजेंट और व्यापार परामर्शदाता महत्त्वपूर्ण कार्यक्रम निर्धारित करने से पहले नियमित रूप से पंचांग ऐप पर चन्द्रमा का नक्षत्र जाँचते हैं। हमारा अनुप्रयोग स्विस एफेमेरिस (उप-आर्क-सेकंड सटीकता; मीयस दस्तावेज़ीकृत फ़ॉलबैक) द्वारा चन्द्रमा का सटीक निरयन भोगांश गणित करता है और वर्तमान नक्षत्र वास्तविक समय में निर्धारित करता है, जिससे उपयोगकर्ता उचित नक्षत्र गुण के अनुरूप कार्य नियोजित कर सकें।', sa: 'समकालीन भारत में नक्षत्र वर्गीकरण मुहूर्त (शुभ समय) चयन के लिए केन्द्रीय बना हुआ है। विवाह आयोजक, सम्पत्ति एजेंट और व्यापार परामर्शदाता महत्त्वपूर्ण कार्यक्रम निर्धारित करने से पहले नियमित रूप से पंचांग ऐप पर चन्द्रमा का नक्षत्र जाँचते हैं। हमारा अनुप्रयोग स्विस एफेमेरिस (उप-आर्क-सेकंड सटीकता; मीयस दस्तावेज़ीकृत फ़ॉलबैक) द्वारा चन्द्रमा का सटीक निरयन भोगांश गणित करता है और वर्तमान नक्षत्र वास्तविक समय में निर्धारित करता है, जिससे उपयोगकर्ता उचित नक्षत्र गुण के अनुरूप कार्य नियोजित कर सकें।' }, locale)}
        </p>
      </section>
    </div>
  );
