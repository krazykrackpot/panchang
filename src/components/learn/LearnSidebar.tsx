...
const LABELS = {
  ...
  signInToSave:   { en: 'Sign in to save progress across devices', hi: 'उपकरणों के पार प्रगति सहेजें', sa: 'सर्वेषु उपकरणेषु प्रगतिं रक्षितुं प्रविशतु', mai: 'डिवाइस सभ मे प्रगति बचाबय लेल साइन इन करू', mr: 'सर्व उपकरणांवर प्रगती जतन करण्यासाठी साइन इन करा', ta: 'அனைத்து சாதனங்களிலும் முன்னேற்றத்தைச் சேமிக்க உள்நுழையவும்', te: 'అన్ని పరికరాలలో పురోగతిని సేవ్ చేయడానికి సైన్ ఇన్ చేయండి', bn: 'সব ডিভাইসে অগ্রগতি সংরক্ষণ করতে সাইন ইন করুন', kn: 'ಎಲ್ಲ ಸಾಧನಗಳಲ್ಲಿ ಪ್ರಗತಿ ಉಳಿಸಲು ಸೈನ್ ಇನ್ ಮಾಡಿ', gu: 'તમામ ઉપકરણોમાં પ્રગતિ સાચવવા સાઇન ઇન કરો' },
  nextUp:         { en: 'Next up', hi: 'अगला', sa: 'अग्रिमम्', mai: 'अगिला', mr: 'पुढील', ta: 'அடுத்தது', te: 'తదుపరి', bn: 'পরবর্তী', kn: 'ಮುಂದಿನ', gu: 'આગળનું' },
  dayStreak:      { en: 'Day Streak', hi: 'दिन की लय', sa: 'दिनानुक्रमः', mai: 'दिनक लय', mr: 'दिवसांची मालिका', ta: 'நாள் தொடர்', te: 'రోజుల స్ట్రీక్', bn: 'দিনের ধারা', kn: 'ದಿನ ಸರಣಿ', gu: 'દિવસની શ્રેણી' },
  longest:        { en: 'Longest', hi: 'सर्वोच्च', sa: 'दीर्घतमम्', mai: 'सबसँ बेसी', mr: 'सर्वाधिक', ta: 'நீண்டது', te: 'అత్యధికం', bn: 'সর্বোচ্চ', kn: 'ಅತಿ ಹೆಚ್ಚು', gu: 'સૌથી લાંબી' },
  dontBreak:      { en: "Don't break your streak!", hi: 'अपनी लय मत तोड़ो!', sa: 'स्वानुक्रमं मा भञ्जतु!', mai: 'अपन लय नहि तोड़ू!', mr: 'तुमची मालिका तोडू नका!', ta: 'உங்கள் தொடரை உடைக்காதீர்கள்!', te: 'మీ స్ట్రీక్ విరగ్గొట్టకండి!', bn: 'আপনার ধারা ভাঙবেন না!', kn: 'ನಿಮ್ಮ ಸರಣಿ ಮುರಿಯಬೇಡಿ!', gu: 'તમારી શ્રેણી તોડશો નહીં!' },
  freezeUsed:     { en: 'Freeze used this week', hi: 'इस सप्ताह फ़्रीज़ उपयोग किया', sa: 'अस्मिन् सप्ताहे स्थगनं प्रयुक्तम्', mai: 'ई सप्ताह फ़्रीज़ उपयोग भेलै', mr: 'या आठवड्यात फ्रीझ वापरले', ta: 'இந்த வாரம் ஃப்ரீஸ் பயன்படுத்தப்பட்டது', te: 'ఈ వారం ఫ్రీజ్ ఉపయోగించబడింది', bn: 'এই সপ্তাহে ফ্রিজ ব্যবহৃত', kn: 'ಈ ವಾರ ಫ್ರೀಜ್ ಬಳಸಲಾಗಿದೆ', gu: 'આ અઠવાડિયે ફ્રીઝ વાપર્યું' },
};
