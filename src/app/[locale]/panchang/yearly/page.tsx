...
const MONTHS = [
  { en: 'January', hi: 'जनवरी', sa: 'जानेवारी-मासः', mai: 'जनवरी', mr: 'जानेवारी', ta: 'ஜனவரி', te: 'జనవరి', bn: 'জানুয়ারি', kn: 'ಜನವರಿ', gu: 'જાન્યુઆરી' }, { en: 'February', hi: 'फरवरी', sa: 'फेब्रवरी-मासः', mai: 'फरवरी', mr: 'फेब्रुवारी', ta: 'பிப்ரவரி', te: 'ఫిబ్రవరి', bn: 'ফেব্রুয়ারি', kn: 'ಫೆಬ್ರವರಿ', gu: 'ફેબ્રુઆરી' },
  { en: 'March', hi: 'मार्च', sa: 'मार्च-मासः', mai: 'मार्च', mr: 'मार्च', ta: 'மார்ச்', te: 'మార్చి', bn: 'মার্চ', kn: 'ಮಾರ್ಚ್', gu: 'માર્ચ' }, { en: 'April', hi: 'अप्रैल', sa: 'एप्रिल-मासः', mai: 'अप्रैल', mr: 'एप्रिल', ta: 'ஏப்ரல்', te: 'ఏప్రిల్', bn: 'এপ্রিল', kn: 'ಏಪ್ರಿಲ್', gu: 'એપ્રિલ' },
  { en: 'May', hi: 'मई', sa: 'मई-मासः', mai: 'मई', mr: 'मे', ta: 'மே', te: 'మే', bn: 'মে', kn: 'ಮೇ', gu: 'મે' }, { en: 'June', hi: 'जून', sa: 'जून-मासः', mai: 'जून', mr: 'जून', ta: 'ஜூன்', te: 'జూన్', bn: 'জুন', kn: 'ಜೂನ್', gu: 'જૂન' },
  { en: 'July', hi: 'जुलाई', sa: 'जुलाई-मासः', mai: 'जुलाई', mr: 'जुलै', ta: 'ஜூலை', te: 'జులై', bn: 'জুলাই', kn: 'ಜುಲೈ', gu: 'જુલાઈ' }, { en: 'August', hi: 'अगस्त', sa: 'आगस्ट-मासः', mai: 'अगस्त', mr: 'ऑगस्ट', ta: 'ஆகஸ்ட்', te: 'ఆగస్టు', bn: 'আগস্ট', kn: 'ಆಗಸ್ಟ್', gu: 'ઑગસ્ટ' },
  { en: 'September', hi: 'सितम्बर', sa: 'सेप्टेम्बर-मासः', mai: 'सितम्बर', mr: 'सप्टेंबर', ta: 'செப்டம்பர்', te: 'సెప్టెంబర్', bn: 'সেপ্টেম্বর', kn: 'ಸೆಪ್ಟೆಂಬರ್', gu: 'સપ્ટેમ્બર' }, { en: 'October', hi: 'अक्टूबर', sa: 'अक्टोबर-मासः', mai: 'अक्टूबर', mr: 'ऑक्टोबर', ta: 'அக்டோபர்', te: 'అక్టోబర్', bn: 'অক্টোবর', kn: 'ಅಕ್ಟೋಬರ್', gu: 'ઑક્ટોબર' },
  { en: 'November', hi: 'नवम्बर', sa: 'नवेम्बर-मासः', mai: 'नवम्बर', mr: 'नोव्हेंबर', ta: 'நவம்பர்', te: 'నవంబర్', bn: 'নভেম্বর', kn: 'ನವೆಂಬರ್', gu: 'નવેમ્બર' }, { en: 'December', hi: 'दिसम्बर', sa: 'डिसेम्बर-मासः', mai: 'दिसम्बर', mr: 'डिसेंबर', ta: 'டிசம்பர்', te: 'డిసెంబర్', bn: 'ডিসেম্বর', kn: 'ಡಿಸೆಂಬರ್', gu: 'ડિસેમ್બર' },
];
