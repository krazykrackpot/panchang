...
const QUESTIONS: ModuleQuestion[] = [
  {
    ...
    options: [
      { en: 'The Moon has no declination', hi: 'चन्द्रमा की कोई क्रान्ति नहीं है', sa: 'चन्द्रमा की कोई क्रान्ति नहीं है', mai: 'चन्द्रमा की कोई क्रान्ति नहीं है', mr: 'चन्द्रमा की कोई क्रान्ति नहीं है', ta: 'சந்த்ரமா கீ கோஈ க்ராந்தி நஹீம் ஹை', te: 'చన్ద్రమా కీ కోఈ క్రాన్తి నహీం హై', bn: 'চন্দ্রমা কী কোঈ ক্রান্তি নহীং হৈ', kn: 'ಚನ್ದ್ರಮಾ ಕೀ ಕೋಈ ಕ್ರಾನ್ತಿ ನಹೀಂ ಹೈ', gu: 'ચન્દ્રમા કી કોઈ ક્રાન્તિ નહીં હૈ' },
      { en: 'The Moon moves ~13°/day, changing position significantly during the computation', hi: 'चन्द्रमा ~13°/दिन चलता है, गणना के दौरान स्थिति महत्त्वपूर्ण रूप से बदलती है', sa: 'चन्द्रमा ~13°/दिन चलता है, गणना के दौरान स्थिति महत्त्वपूर्ण रूप से बदलती है', mai: 'चन्द्रमा ~13°/दिन चलता है, गणना के दौरान स्थिति महत्त्वपूर्ण रूप से बदलती है', mr: 'चन्द्रमा ~13°/दिन चलता है, गणना के दौरान स्थिति महत्त्वपूर्ण रूप से बदलती है', ta: 'சந்த்ரமா ~13°/திந சலதா ஹை, கணநா கே தௌராந ஸ்थிதி மஹத்த்வபூர்ண ரூப ஸே பதலதீ ஹை', te: 'చన్ద్రమా ~13°/దిన చలతా హై, గణనా కే దౌరాన స్థితి మహత్త్వపూర్ణ రూప సే బదలతీ హై', bn: 'চন্দ্রমা ~13°/দিন চলতা হৈ, গণনা কে দৌরান স্থিতি মহত্ত্বপূর্ণ রূপ সে বদলতী হৈ', kn: 'ಚನ್ದ್ರಮಾ ~13°/ದಿನ ಚಲತಾ ಹೈ, ಗಣನಾ ಕೇ ದೌರಾನ ಸ್ಥಿತಿ ಮಹತ್ತ್ವಪೂರ್ಣ ರೂಪ ಸೇ ಬದಲತೀ ಹೈ', gu: 'ચન્દ્રમા ~13°/દિન ચલતા હૈ, ગણના કે દૌરાન સ્થિતિ મહત્ત્વપૂર્ણ રૂપ સે બદલતી હૈ' },
      { en: 'The Moon has no atmosphere', hi: 'चन्द्रमा का कोई वायुमण्डल नहीं है', sa: 'चन्द्रमा का कोई वायुमण्डल नहीं है', mai: 'चन्द्रमा का कोई वायुमण्डल नहीं है', mr: 'चन्द्रमा का कोई वायुमण्डल नहीं है', ta: 'சந்த்ரமா கா கோஈ வாயுமண்டல நஹீம் ஹை', te: 'చన్ద్రమా కా కోఈ వాయుమణ్డల నహీం హై', bn: 'চন্দ্রমা কা কোঈ বাযুমণ্ডল নহীং হৈ', kn: 'ಚನ್ದ್ರಮಾ ಕಾ ಕೋಈ ವಾಯುಮಣ್ಡಲ ನಹೀಂ ಹೈ', gu: 'ચન્દ્રમા કા કોઈ વાયુમણ્ડલ નહીં હૈ' },
      { en: 'The Moon is always above the horizon', hi: 'चन्द्रमा सदैव क्षितिज से ऊपर है', sa: 'चन्द्रमा सदैव क्षितिज से ऊपर है', mai: 'चन्द्रमा सदैव क्षितिज से ऊपर है', mr: 'चन्द्रमा सदैव क्षितिज से ऊपर है', ta: 'சந்த்ரமா ஸதைவ க்ஷிதிஜ ஸே ஊபர ஹை', te: 'చన్ద్రమా సదైవ క్షితిజ సే ఊపర హై', bn: 'চন্দ্রমা সদৈব ক্ষিতিজ সে ঊপর হৈ', kn: 'ಚನ್ದ್ರಮಾ ಸದೈವ ಕ್ಷಿತಿಜ ಸೇ ಊಪರ ಹೈ', gu: 'ચન્દ્રમા સદૈવ ક્ષિતિજ સે ઊપર હૈ' },
    ],
    correctAnswer: 1,
    explanation: {
  ...
  },
  {
    ...
    options: [
      { en: 'Direct hour-angle formula like sunrise', hi: 'सूर्योदय जैसा प्रत्यक्ष घण्टा-कोण सूत्र', sa: 'सूर्योदय जैसा प्रत्यक्ष घण्टा-कोण सूत्र', mai: 'सूर्योदय जैसा प्रत्यक्ष घण्टा-कोण सूत्र', mr: 'सूर्योदय जैसा प्रत्यक्ष घण्टा-कोण सूत्र', ta: 'ஸூர்யோதய ஜைஸா ப்ரத்யக்ஷ घண்டா-கோண ஸூத்ர', te: 'సూర్యోదయ జైసా ప్రత్యక్ష ఘణ్టా-కోణ సూత్ర', bn: 'সূর্যোদয জৈসা প্রত্যক্ষ ঘণ্টা-কোণ সূত্র', kn: 'ಸೂರ್ಯೋದಯ ಜೈಸಾ ಪ್ರತ್ಯಕ್ಷ ಘಣ್ಟಾ-ಕೋಣ ಸೂತ್ರ', gu: 'સૂર્યોદય જૈસા પ્રત્યક્ષ ઘણ્ટા-કોણ સૂત્ર' },
      { en: 'Scan Moon altitude every 5 minutes for 24 hours, then binary search the crossing', hi: '24 घण्टे प्रत्येक 5 मिनट पर चन्द्र ऊँचाई जाँचें, फिर क्रॉसिंग पर द्विआधारी खोज', sa: '24 घण्टे प्रत्येक 5 मिनट पर चन्द्र ऊँचाई जाँचें, फिर क्रॉसिंग पर द्विआधारी खोज', mai: '24 घण्टे प्रत्येक 5 मिनट पर चन्द्र ऊँचाई जाँचें, फिर क्रॉसिंग पर द्विआधारी खोज', mr: '24 घण्टे प्रत्येक 5 मिनट पर चन्द्र ऊँचाई जाँचें, फिर क्रॉसिंग पर द्विआधारी खोज', ta: '24 घண்டே ப்ரத்யேக 5 மிநட பர சந்த்ர ஊँசாஈ ஜாँசேம், फிர க்ரॉஸிம்க பர த்விஆधாரீ खோஜ', te: '24 ఘణ్టే ప్రత్యేక 5 మినట పర చన్ద్ర ఊఁచాఈ జాఁచేం, ఫిర క్రॉసింగ పర ద్విఆధారీ ఖోజ', bn: '24 ঘণ্টে প্রত্যেক 5 মিনট পর চন্দ্র ঊঁচাঈ জাঁচেং, ফির ক্রॉসিংগ পর দ্বিআধারী খোজ', kn: '24 ಘಣ್ಟೇ ಪ್ರತ್ಯೇಕ 5 ಮಿನಟ ಪರ ಚನ್ದ್ರ ಊಁಚಾಈ ಜಾಁಚೇಂ, ಫಿರ ಕ್ರॉಸಿಂಗ ಪರ ದ್ವಿಆಧಾರೀ ಖೋಜ', gu: '24 ઘણ્ટે પ્રત્યેક 5 મિનટ પર ચન્દ્ર ઊઁચાઈ જાઁચેં, ફિર ક્રૉસિંગ પર દ્વિઆધારી ખોજ' },
      { en: 'Look up a pre-computed table', hi: 'पूर्व-गणित सारणी देखें', sa: 'पूर्व-गणित सारणी देखें', mai: 'पूर्व-गणित सारणी देखें', mr: 'पूर्व-गणित सारणी देखें', ta: 'பூர்வ-கணித ஸாரணீ தேखேம்', te: 'పూర్వ-గణిత సారణీ దేఖేం', bn: 'পূর্ব-গণিত সারণী দেখেং', kn: 'ಪೂರ್ವ-ಗಣಿತ ಸಾರಣೀ ದೇಖೇಂ', gu: 'પૂર્વ-ગણિત સારણી દેખેં' },
      { en: 'Use the same algorithm as sunrise with different refraction', hi: 'भिन्न अपवर्तन के साथ सूर्योदय का एल्गोरिदम उपयोग करें', sa: 'भिन्न अपवर्तन के साथ सूर्योदय का एल्गोरिदम उपयोग करें', mai: 'भिन्न अपवर्तन के साथ सूर्योदय का एल्गोरिदम उपयोग करें', mr: 'भिन्न अपवर्तन के साथ सूर्योदय का एल्गोरिदम उपयोग करें', ta: 'भிந்ந அபவர்தந கே ஸாथ ஸூர்யோதய கா எல்கோரிதம உபயோக கரேம்', te: 'భిన్న అపవర్తన కే సాథ సూర్యోదయ కా ఏల్గోరిదమ ఉపయోగ కరేం', bn: 'ভিন্ন অপবর্তন কে সাথ সূর্যোদয কা এল্গোরিদম উপযোগ করেং', kn: 'ಭಿನ್ನ ಅಪವರ್ತನ ಕೇ ಸಾಥ ಸೂರ್ಯೋದಯ ಕಾ ಏಲ್ಗೋರಿದಮ ಉಪಯೋಗ ಕರೇಂ', gu: 'ભિન્ન અપવર્તન કે સાથ સૂર્યોદય કા એલ્ગોરિદમ ઉપયોગ કરેં' },
    ],
    correctAnswer: 1,
    explanation: {
