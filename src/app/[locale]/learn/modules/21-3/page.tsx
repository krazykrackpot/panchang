    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Vimshottari Compressed: 120 Years in 365 Days / विंशोत्तरी संकुचित: 120 वर्ष 365 दिनों में
        </h3>
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Computing the Starting Point / आरम्भिक बिन्दु गणना
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Month-Level Prediction with Mudda Dasha / मुद्दा दशा से मास-स्तरीय फलादेश
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
