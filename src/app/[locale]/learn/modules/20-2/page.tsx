    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Nakshatra Sub-Divisions: The KP Innovation / नक्षत्र उप-विभाग: केपी का नवाचार
        </h3>
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Finding the Sub Lord: Step by Step / उप स्वामी ज्ञात करना: चरण दर चरण
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Why the Sub Lord Is the Key / उप स्वामी क्यों कुञ्जी है
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
