    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Why Tithi Duration Varies / तिथि की अवधि क्यों बदलती है
        </h3>
      ...
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Tithi at Sunrise / सूर्योदय की तिथि
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Vriddhi (Extra) Tithi & Parana Timing / वृद्धि तिथि एवं पारण समय
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        ...
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Vriddhi Example:</span> Suppose Saptami tithi begins at 4:30 AM (before sunrise at 6:15 AM) on Monday and ends at 7:45 AM on Wednesday. Saptami is present at sunrise on both Monday and Tuesday. Monday is the first Saptami day and Tuesday is the Vriddhi (repeated) Saptami day. For most festivals tied to Saptami, the first day (Monday) is used.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">वृद्धि उदाहरण:</span> मान लें सप्तमी तिथि सोमवार प्रातः 4:30 (सूर्योदय 6:15 से पहले) आरम्भ होकर बुधवार प्रातः 7:45 पर समाप्त होती है। सप्तमी सोमवार और मंगलवार दोनों के सूर्योदय पर उपस्थित है। सोमवार प्रथम सप्तमी और मंगलवार वृद्धि (दोहरी) सप्तमी है। सप्तमी से जुड़े अधिकांश त्योहारों हेतु प्रथम दिन (सोमवार) प्रयुक्त होता है।
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Parana Example:</span> Ekadashi tithi ends at 9:42 AM on Wednesday. Dwadashi tithi runs from 9:42 AM Wednesday to 11:15 AM Thursday. Sunrise Wednesday is 6:10 AM. The Parana window opens at 9:42 AM (when Dwadashi begins) and the devotee should break the fast between 9:42 AM and 11:15 AM Thursday — ideally on Wednesday morning itself after 9:42 AM.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">पारण उदाहरण:</span> एकादशी तिथि बुधवार प्रातः 9:42 पर समाप्त होती है। द्वादशी तिथि बुधवार 9:42 से गुरुवार 11:15 तक चलती है। बुधवार सूर्योदय 6:10 है। पारण का समय 9:42 (जब द्वादशी आरम्भ हो) पर खुलता है और भक्त को 9:42 से गुरुवार 11:15 के बीच उपवास तोड़ना चाहिए — आदर्श रूप से बुधवार प्रातः 9:42 के तुरन्त बाद।
        </p>
      </section>
...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Worked Calculation: Computing Tithi from Longitudes / कार्यान्वित गणना: भोगांश से तिथि निकालना
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section className="glass-card rounded-xl p-5 border border-red-500/15">
        ...
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">भ्रान्ति:</span> "तिथि समाप्ति समय 12 अंश को चन्द्रमा की औसत गति से भाग देकर निकाला जा सकता है।" यह एक सन्निकटन तो देता है किन्तु एक घण्टे से अधिक की त्रुटि हो सकती है क्योंकि चन्द्रमा की गति दिनभर निरन्तर बदलती रहती है। द्विभाजन खोज विधि प्रत्येक चरण पर चन्द्र और सूर्य की स्थिति पुनः गणना करती है, वास्तविक-समय गति परिवर्तन को पकड़ती है, यही कारण है कि आधुनिक पंचांग सॉफ्टवेयर मिनट-स्तर की सटीकता प्राप्त करता है।
        </p>
      </section>
