...
const SCALE_COMPARE = [
  { label: { en: 'Kali Yuga', hi: 'कलि युग', sa: 'कलि युग', mai: 'कलि युग', mr: 'कलि युग', ta: 'கலியுகம்', te: 'కలియుగం', bn: 'কলিযুগ', kn: 'ಕಲಿಯುಗ', gu: 'કલિયુગ' }, value: '432,000', unit: { en: 'years', hi: 'वर्ष', sa: 'वर्ष', mai: 'वर्ष', mr: 'वर्ष', ta: 'years', te: 'years', bn: 'years', kn: 'years', gu: 'years' }, color: '#f87171' },
  { label: { en: 'Mahayuga', hi: 'महायुग', sa: 'महायुग', mai: 'महायुग', mr: 'महायुग', ta: 'மகாயுகம்', te: 'మహాయుగం', bn: 'মহাযুগ', kn: 'ಮಹಾಯುಗ', gu: 'મહાયુગ' }, value: '4.32 million', unit: { en: 'years', hi: 'वर्ष', sa: 'वर्ष', mai: 'वर्ष', mr: 'वर्ष', ta: 'years', te: 'years', bn: 'years', kn: 'years', gu: 'years' }, color: '#fbbf24' },
  { label: { en: 'Kalpa (1 day of Brahma)', hi: 'कल्प (ब्रह्मा का 1 दिन)', sa: 'कल्प (ब्रह्मा का 1 दिन)', mai: 'कल्प (ब्रह्मा का 1 दिन)', mr: 'कल्प (ब्रह्मा का 1 दिन)', ta: 'கல்பம் (பிரம்மாவின் 1 நாள்)', te: 'కల్పం (బ్రహ్మ యొక్క 1 రోజు)', bn: 'কল্প (ব্রহ্মার ১ দিন)', kn: 'ಕಲ್ಪ (ಬ್ರಹ್ಮನ 1 ದಿನ)', gu: 'કલ્પ (બ્રહ્માનો 1 દિવસ)' }, value: '4.32 billion', unit: { en: 'years', hi: 'वर्ष', sa: 'वर्ष', mai: 'वर्ष', mr: 'वर्ष', ta: 'years', te: 'years', bn: 'years', kn: 'years', gu: 'years' }, color: '#a78bfa' },
  { label: { en: "Brahma's lifespan", hi: 'ब्रह्मा का जीवनकाल', sa: 'ब्रह्मा का जीवनकाल', mai: 'ब्रह्मा का जीवनकाल', mr: 'ब्रह्मा का जीवनकाल', ta: "Brahma's lifespan", te: "Brahma's lifespan", bn: "Brahma's lifespan", kn: "Brahma's lifespan", gu: "Brahma's lifespan" }, value: '311 trillion', unit: { en: 'years', hi: 'वर्ष', sa: 'वर्ष', mai: 'वर्ष', mr: 'वर्ष', ta: 'ஆண்டுகள்', te: 'సంవత్సరాలు', bn: 'বছর', kn: 'ವರ್ಷಗಳು', gu: 'વર્ષ' }, color: '#34d399' },
];
