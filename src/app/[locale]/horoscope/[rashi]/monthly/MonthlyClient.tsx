...
export function MonthlyClient({ rashi, locale }: MonthlyClientProps) {
  ...
  useEffect(() => {
    ...
    .catch(err => {
      console.error('[MonthlyClient] Failed to fetch monthly horoscopes:', err);
    })
    .finally(() => setLoading(false));
  }, [rashi.id, rashiSlug, year, month, daysInMonth, isHi]);
        ...
        <div className="bg-gradient-to-br from-[#2d1b69]/50 via-[#1a1040]/60 to-[#0a0e27] border border-gold-primary/20 rounded-3xl p-8 md:p-10 mb-8">
          <div className="flex flex-col sm:flex-row items-center gap-6">
            ...
            <div className="text-center sm:text-left flex-1">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gold-gradient mb-2" style={headingFont}>
