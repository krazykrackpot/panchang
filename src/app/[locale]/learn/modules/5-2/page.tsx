    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          {tl({ en: 'Shukla and Krishna Paksha', hi: 'शुक्ल एवं कृष्ण पक्ष', sa: 'शुक्ल एवं कृष्ण पक्ष' }, locale)}
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          {tl({ en: 'The lunar month in the Hindu calendar is divided into two halves called pakshas. Shukla Paksha (the bright fortnight) spans tithis 1 through 15 as the Moon waxes from invisibility at Amavasya to full brilliance at Purnima. Krishna Paksha (the dark fortnight) spans the next 15 tithis as the Moon wanes from Purnima back to Amavasya. Each paksha therefore contains 15 tithis, and together they constitute the complete 30-tithi lunar cycle of approximately 29.53 solar days.', hi: 'हिन्दू पंचांग में चान्द्र मास दो अर्धों में विभक्त है जिन्हें पक्ष कहते हैं। शुक्ल पक्ष (उज्ज्वल पखवाड़ा) तिथि 1 से 15 तक फैला है — चन्द्रमा अमावस्या की अदृश्यता से बढ़ते हुए पूर्णिमा की पूर्ण दीप्ति तक पहुँचता है। कृष्ण पक्ष (अन्धकार पखवाड़ा) अगली 15 तिथियों में फैला है — चन्द्रमा पूर्णिमा से घटते हुए पुनः अमावस्या तक पहुँचता है। प्रत्येक पक्ष में 15 तिथियाँ होती हैं और दोनों मिलकर लगभग 29.53 सौर दिनों का पूर्ण 30-तिथि चान्द्र चक्र बनाते हैं।', sa: 'हिन्दू पंचांग में चान्द्र मास दो अर्धों में विभक्त है जिन्हें पक्ष कहते हैं। शुक्ल पक्ष (उज्ज्वल पखवाड़ा) तिथि 1 से 15 तक फैला है — चन्द्रमा अमावस्या की अदृश्यता से बढ़ते हुए पूर्णिमा की पूर्ण दीप्ति तक पहुँचता है। कृष्ण पक्ष (अन्धकार पखवाड़ा) अगली 15 तिथियों में फैला है — चन्द्रमा पूर्णिमा से घटते हुए पुनः अमावस्या तक पहुँचता है। प्रत्येक पक्ष में 15 तिथियाँ होती हैं और दोनों मिलकर लगभग 29.53 सौर दिनों का पूर्ण 30-तिथि चान्द्र चक्र बनाते हैं।' }, locale)}
        </p>
        <p className="text-text-secondary text-sm leading-relaxed">
          {tl({ en: 'The waxing and waning of the Moon is a consequence of the changing geocentric elongation — the angular distance between the Moon and Sun as viewed from Earth. At Amavasya, the Moon and Sun are at nearly the same ecliptic longitude (elongation near 0 degrees), so the Moon\u2019s illuminated side faces away from Earth. As the Moon moves ahead in its orbit, the elongation increases and we see progressively more of the sunlit hemisphere. At Purnima, the elongation reaches 180 degrees and the entire visible disc is illuminated. The process then reverses during Krishna Paksha.', hi: 'चन्द्रमा का बढ़ना और घटना भूकेन्द्रीय कोणीय दूरी — पृथ्वी से देखने पर चन्द्रमा और सूर्य के बीच की कोणीय दूरी — में परिवर्तन का परिणाम है। अमावस्या पर चन्द्रमा और सूर्य लगभग एक ही क्रान्तिवृत्तीय भोगांश पर होते हैं (कोणीय दूरी 0 अंश के निकट), अतः चन्द्रमा का प्रकाशित भाग पृथ्वी से विपरीत दिशा में होता है। जैसे-जैसे चन्द्रमा कक्षा में आगे बढ़ता है, कोणीय दूरी बढ़ती है और हम सूर्य-प्रकाशित गोलार्ध का अधिकाधिक भाग देखते हैं। पूर्णिमा पर कोणीय दूरी 180 अंश तक पहुँचती है और सम्पूर्ण दृश्य चक्रिका प्रकाशित होती है। फिर कृष्ण पक्ष में यह प्रक्रिया विपरीत होती है।', sa: 'चन्द्रमा का बढ़ना और घटना भूकेन्द्रीय कोणीय दूरी — पृथ्वी से देखने पर चन्द्रमा और सूर्य के बीच की कोणीय दूरी — में परिवर्तन का परिणाम है। अमावस्या पर चन्द्रमा और सूर्य लगभग एक ही क्रान्तिवृत्तीय भोगांश पर होते हैं (कोणीय दूरी 0 अंश के निकट), अतः चन्द्रमा का प्रकाशित भाग पृथ्वी से विपरीत दिशा में होता है। जैसे-जैसे चन्द्रमा कक्षा में आगे बढ़ता है, कोणीय दूरी बढ़ती है और हम सूर्य-प्रकाशित गोलार्ध का अधिकाधिक भाग देखते हैं। पूर्णिमा पर कोणीय दूरी 180 अंश तक पहुँचती है और सम्पूर्ण दृश्य चक्रिका प्रकाशित होती है। फिर कृष्ण पक्ष में यह प्रक्रिया विपरीत होती है।' }, locale)}
        </p>
      </section>
...
function Page2() {
  ...
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          {tl({ en: 'Amanta vs Purnimanta Calendar Systems', hi: 'अमान्त बनाम पूर्णिमान्त पद्धतियाँ', sa: 'अमान्त बनाम पूर्णिमान्त पद्धतियाँ' }, locale)}
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          {tl({ en: 'India uses two parallel lunar calendar systems that differ in where the month boundary falls. The Amanta (also called Mukhya Mana) system, prevalent in South India, Maharashtra, and Gujarat, ends the month at Amavasya. A month begins with Shukla Paksha Pratipada and ends with Amavasya. The Purnimanta (also called Gauna Mana) system, predominant in North India (UP, Bihar, MP, Rajasthan), ends the month at Purnima. Here a month begins with Krishna Paksha Pratipada (the day after the previous Purnima) and concludes at the next Purnima.', hi: 'भारत में दो समानान्तर चान्द्र पंचांग पद्धतियाँ प्रचलित हैं जो मास की सीमा के स्थान में भिन्न हैं। अमान्त (मुख्य मान) पद्धति दक्षिण भारत, महाराष्ट्र और गुजरात में प्रचलित है और मास अमावस्या पर समाप्त होता है — मास शुक्ल पक्ष प्रतिपदा से आरम्भ होकर अमावस्या पर समाप्त होता है। पूर्णिमान्त (गौण मान) पद्धति उत्तर भारत (उ.प्र., बिहार, म.प्र., राजस्थान) में प्रमुख है और मास पूर्णिमा पर समाप्त होता है — यहाँ मास कृष्ण पक्ष प्रतिपदा (पिछली पूर्णिमा के अगले दिन) से आरम्भ होकर अगली पूर्णिमा पर समाप्त होता है।', sa: 'भारत में दो समानान्तर चान्द्र पंचांग पद्धतियाँ प्रचलित हैं जो मास की सीमा के स्थान में भिन्न हैं। अमान्त (मुख्य मान) पद्धति दक्षिण भारत, महाराष्ट्र और गुजरात में प्रचलित है और मास अमावस्या पर समाप्त होता है — मास शुक्ल पक्ष प्रतिपदा से आरम्भ होकर अमावस्या पर समाप्त होता है। पूर्णिमान्त (गौण मान) पद्धति उत्तर भारत (उ.प्र., बिहार, म.प्र., राजस्थान) में प्रमुख है और मास पूर्णिमा पर समाप्त होता है — यहाँ मास कृष्ण पक्ष प्रतिपदा (पिछली पूर्णिमा के अगले दिन) से आरम्भ होकर अगली पूर्णिमा पर समाप्त होता है।' }, locale)}
        </p>
        <p className="text-text-secondary text-sm leading-relaxed">
          {tl({ en: 'The critical consequence is that the Krishna Paksha carries a different month name in each system. In Amanta, both pakshas of (say) Chaitra share the name "Chaitra." In Purnimanta, the Krishna half that Amanta calls "Chaitra" is instead labeled "Vaishakha" because it falls after Chaitra Purnima. This means the same astronomical day — say Krishna Paksha Ekadashi falling in late April — is called "Chaitra Krishna Ekadashi" in Amanta but "Vaishakha Krishna Ekadashi" in Purnimanta.', hi: 'इसका महत्वपूर्ण परिणाम यह है कि कृष्ण पक्ष का प्रत्येक पद्धति में भिन्न मास-नाम होता है। अमान्त में (मान लें) चैत्र के दोनों पक्ष "चैत्र" कहलाते हैं। पूर्णिमान्त में अमान्त का जो कृष्ण अर्ध "चैत्र" कहलाता है, वह "वैशाख" कहलाता है क्योंकि वह चैत्र पूर्णिमा के बाद आता है। अर्थात् वही खगोलीय दिन — मान लें अप्रैल के अन्त में पड़ने वाली कृष्ण पक्ष एकादशी — अमान्त में "चैत्र कृष्ण एकादशी" और पूर्णिमान्त में "वैशाख कृष्ण एकादशी" कहलाती है।', sa: 'इसका महत्वपूर्ण परिणाम यह है कि कृष्ण पक्ष का प्रत्येक पद्धति में भिन्न मास-नाम होता है। अमान्त में (मान लें) चैत्र के दोनों पक्ष "चैत्र" कहलाते हैं। पूर्णिमान्त में अमान्त का जो कृष्ण अर्ध "चैत्र" कहलाता है, वह "वैशाख" कहलाता है क्योंकि वह चैत्र पूर्णिमा के बाद आता है। अर्थात् वही खगोलीय दिन — मान लें अप्रैल के अन्त में पड़ने वाली कृष्ण पक्ष एकादशी — अमान्त में "चैत्र कृष्ण एकादशी" और पूर्णिमान्त में "वैशाख कृष्ण एकादशी" कहलाती है।' }, locale)}
        </p>
      </section>
...
function Page3() {
  ...
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          {tl({ en: 'Ritual Significance of Paksha', hi: 'पक्ष का अनुष्ठानिक महत्त्व', sa: 'पक्ष का अनुष्ठानिक महत्त्व' }, locale)}
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          {tl({ en: 'Shukla Paksha is the fortnight of growth, expansion, and auspicious beginnings. Marriages, griha pravesh (housewarming), business inaugurations, upanayana (sacred thread ceremony), and most samskaras (life-cycle rituals) are preferably scheduled in Shukla Paksha. The waxing Moon symbolizes increasing prosperity, health, and spiritual merit. Navratri celebrations during Shukla Paksha (Chaitra and Ashwin) represent the triumph of divine feminine energy.', hi: 'शुक्ल पक्ष वृद्धि, विस्तार और शुभ आरम्भ का पखवाड़ा है। विवाह, गृह प्रवेश, व्यापार उद्घाटन, उपनयन (यज्ञोपवीत संस्कार) और अधिकांश संस्कार शुक्ल पक्ष में ही आयोजित किये जाते हैं। बढ़ता चन्द्रमा बढ़ती समृद्धि, स्वास्थ्य और आध्यात्मिक पुण्य का प्रतीक है। शुक्ल पक्ष में नवरात्रि उत्सव (चैत्र और आश्विन) दिव्य स्त्री शक्ति की विजय का प्रतीक है।', sa: 'शुक्ल पक्ष वृद्धि, विस्तार और शुभ आरम्भ का पखवाड़ा है। विवाह, गृह प्रवेश, व्यापार उद्घाटन, उपनयन (यज्ञोपवीत संस्कार) और अधिकांश संस्कार शुक्ल पक्ष में ही आयोजित किये जाते हैं। बढ़ता चन्द्रमा बढ़ती समृद्धि, स्वास्थ्य और आध्यात्मिक पुण्य का प्रतीक है। शुक्ल पक्ष में नवरात्रि उत्सव (चैत्र और आश्विन) दिव्य स्त्री शक्ति की विजय का प्रतीक है।' }, locale)}
        </p>
        <p className="text-text-secondary text-sm leading-relaxed">
          {tl({ en: 'Krishna Paksha, by contrast, is the fortnight of dissolution, introspection, and release. Shraddha (ancestral rites), Kala Bhairava worship, and tarpan (water offerings to ancestors) are performed primarily during this phase. The Pitru Paksha (16 days of Krishna Paksha in Ashwin/Bhadrapada) is the most important annual period for honoring deceased ancestors. Certain tantric and Shakti-oriented sadhanas are also considered more potent during the dark fortnight.', hi: 'इसके विपरीत, कृष्ण पक्ष विसर्जन, अन्तर्दर्शन और मोक्ष का पखवाड़ा है। श्राद्ध (पितृ कर्म), काल भैरव पूजा और तर्पण (पितरों को जलार्पण) मुख्य रूप से इसी काल में किए जाते हैं। पितृ पक्ष (आश्विन/भाद्रपद के कृष्ण पक्ष के 16 दिन) दिवंगत पूर्वजों के सम्मान का सर्वाधिक महत्वपूर्ण वार्षिक काल है। कुछ तान्त्रिक और शक्ति-उन्मुख साधनाएँ भी अन्धकार पखवाड़े में अधिक प्रभावशाली मानी जाती हैं।', sa: 'इसके विपरीत, कृष्ण पक्ष विसर्जन, अन्तर्दर्शन और मोक्ष का पखवाड़ा है। श्राद्ध (पितृ कर्म), काल भैरव पूजा और तर्पण (पितरों को जलार्पण) मुख्य रूप से इसी काल में किए जाते हैं। पितृ पक्ष (आश्विन/भाद्रपद के कृष्ण पक्ष के 16 दिन) दिवंगत पूर्वजों के सम्मान का सर्वाधिक महत्वपूर्ण वार्षिक काल है। कुछ तान्त्रिक और शक्ति-उन्मुख साधनाएँ भी अन्धकार पखवाड़े में अधिक प्रभावशाली मानी जाती हैं।' }, locale)}
        </p>
      </section>

      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          {tl({ en: 'Ekadashi Fasting in Both Pakshas', hi: 'दोनों पक्षों में एकादशी व्रत', sa: 'दोनों पक्षों में एकादशी व्रत' }, locale)}
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed">
          {tl({ en: 'Ekadashi (the 11th tithi) is observed as a fasting day in both pakshas, yielding 24 Ekadashis per year (plus occasionally extra ones in adhika months). Shukla Paksha Ekadashis are generally associated with positive spiritual growth and Vishnu worship, while Krishna Paksha Ekadashis carry themes of purification, penance, and ancestral liberation. Each of the 24 Ekadashis has a unique name — Nirjala, Vaikunta, Mokshada, Devshayani, and so on — with specific vrat-katha (fasting stories) and prescribed rituals.', hi: 'एकादशी (11वीं तिथि) दोनों पक्षों में उपवास दिवस के रूप में मनाई जाती है, जिससे वर्ष में 24 एकादशियाँ (तथा कभी-कभी अधिक मास में अतिरिक्त) होती हैं। शुक्ल पक्ष एकादशियाँ सामान्यतः सकारात्मक आध्यात्मिक वृद्धि और विष्णु पूजा से जुड़ी हैं, जबकि कृष्ण पक्ष एकादशियाँ शुद्धिकरण, तपस्या और पितृ मोक्ष के विषय लिए होती हैं। प्रत्येक 24 एकादशियों का एक विशिष्ट नाम है — निर्जला, वैकुण्ठ, मोक्षदा, देवशयनी आदि — जिनमें विशिष्ट व्रत-कथा और निर्धारित अनुष्ठान हैं।', sa: 'एकादशी (11वीं तिथि) दोनों पक्षों में उपवास दिवस के रूप में मनाई जाती है, जिससे वर्ष में 24 एकादशियाँ (तथा कभी-कभी अधिक मास में अतिरिक्त) होती हैं। शुक्ल पक्ष एकादशियाँ सामान्यतः सकारात्मक आध्यात्मिक वृद्धि और विष्णु पूजा से जुड़ी हैं, जबकि कृष्ण पक्ष एकादशियाँ शुद्धिकरण, तपस्या और पितृ मोक्ष के विषय लिए होती हैं। प्रत्येक 24 एकादशियों का एक विशिष्ट नाम है — निर्जला, वैकुण्ठ, मोक्षदा, देवशयनी आदि — जिनमें विशिष्ट व्रत-कथा और निर्धारित अनुष्ठान हैं।' }, locale)}
        </p>
      </section>
