      ...
      <motion.section initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
        ...
        <div className="flex flex-wrap justify-center gap-3">
          {[
            ...
            { href: '/learn/modules/23-4', label: { en: 'Module 23-4: Sphutas Deep Dive', hi: 'मॉड्यूल 23-4: स्फुट विस्तार', sa: 'मॉड्यूल 23-4: स्फुट विस्तार', mai: 'मॉड्यूल 23-4: स्फुट विस्तार', mr: 'मॉड्यूल 23-4: स्फुट विस्तार', ta: 'Module 23-4: Sphutas Deep Dive', te: 'Module 23-4: Sphutas Deep Dive', bn: 'Module 23-4: Sphutas Deep Dive', kn: 'Module 23-4: Sphutas Deep Dive', gu: 'Module 23-4: Sphutas Deep Dive' } },
            ...
            { href: '/learn/avasthas', label: { en: 'Avasthas (Planet States)', hi: 'अवस्थाएं (ग्रह दशाएं)', sa: 'अवस्थाएं (ग्रह दशाएं)', mai: 'अवस्थाएं (ग्रह दशाएं)', mr: 'अवस्थाएं (ग्रह दशाएं)', ta: 'Avasthas (Planet States)', te: 'Avasthas (Planet States)', bn: 'Avasthas (Planet States)', kn: 'Avasthas (Planet States)', gu: 'Avasthas (Planet States)' } },
          ].map((link) => (
