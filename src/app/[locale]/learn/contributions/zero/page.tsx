        ...
        <LessonSection number={6} title={t('s6Title')}>
          ...
          <div className="mt-6 grid grid-cols-2 sm:grid-cols-4 gap-3">
            {[
              ...
              { icon: <Circle className="w-5 h-5" />, label: { en: 'Calculus', hi: 'कलन', sa: 'कलन', mai: 'कलन', mr: 'कलन', ta: 'நுண்கணிதம்', te: 'కలనశాస్త్రం', bn: 'ক্যালকুলাস', kn: 'ಕಲನಶಾಸ್ತ್ರ', gu: 'કેલ્ક્યુલસ' }, dep: { en: 'Limits → 0', hi: 'सीमाएँ → 0', sa: 'सीमाएँ → 0', mai: 'सीमाएँ → 0', mr: 'सीमाएँ → 0', ta: 'Limits → 0', te: 'Limits → 0', bn: 'Limits → 0', kn: 'Limits → 0', gu: 'Limits → 0' } },
              { icon: <ArrowRight className="w-5 h-5" />, label: { en: 'Algebra', hi: 'बीजगणित', sa: 'बीजगणित', mai: 'बीजगणित', mr: 'बीजगणित', ta: 'இயற்கணிதம்', te: 'బీజగణితం', bn: 'বীজগণিত', kn: 'ಬೀಜಗಣಿತ', gu: 'બીજગણિત' }, dep: { en: 'Equations need 0', hi: 'समीकरणों को 0 चाहिए', sa: 'समीकरणों को 0 चाहिए', mai: 'समीकरणों को 0 चाहिए', mr: 'समीकरणों को 0 चाहिए', ta: 'Equations need 0', te: 'Equations need 0', bn: 'Equations need 0', kn: 'Equations need 0', gu: 'Equations need 0' } },
            ].map((item, i) => (
              <div
                key={i}
