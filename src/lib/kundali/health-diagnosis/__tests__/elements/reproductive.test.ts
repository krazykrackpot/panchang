// src/lib/kundali/health-diagnosis/__tests__/elements/reproductive.test.ts
//
// Task B11 — reproductive element scorer tests.
//
...
import { scoreReproductive } from '../../elements/reproductive';
...
const result = scoreReproductive(kundali, strength, signatures, 'en');

describe('scoreReproductive', () => {
  ...
  it('returns correct metadata matching ELEMENT_CATALOG[reproductive]', () => {
    const meta = ELEMENT_CATALOG['reproductive'];
    expect(result.id).toBe('reproductive');
