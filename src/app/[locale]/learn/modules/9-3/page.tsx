        ...
        <div className="overflow-x-auto">
          <table className="w-full text-xs border-collapse">
            ...
            <tbody className="text-text-secondary">
              ...
              <tr><td className="p-2">{tl({ en: 'Ketu', hi: 'केतु', sa: 'केतुः' }, locale)}</td><td className="p-2">{tl({ en: 'Scorpio', hi: 'वृश्चिक*', sa: 'वृश्चिक*' }, locale)}</td><td className="p-2">20°</td><td className="p-2">Occult depth (per BPHS)</td></tr>
            </tbody>
          </table>
