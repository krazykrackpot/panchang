...
const LABELS = {
  ...
  disclaimer: L(
    'This comparison is based on publicly available features as of June 2026. We respect Prokerala as a well-established platform serving millions of users. This page highlights differences to help users choose the right tool for their needs.',
    'यह तुलना जून 2026 तक सार्वजनिक रूप से उपलब्ध सुविधाओं पर आधारित है। हम प्रोकेरला को लाखों उपयोगकर्ताओं की सेवा करने वाले एक स्थापित मंच के रूप में सम्मान करते हैं।',
  ),
...
const ROWS: CompRow[] = [
  ...
  },
  {
    ...
    competitor: 'NM-anchored convention without kshaya-aware day attribution; produces 1-day drift on kshaya-Pratipada years.',
    dekhoYes: true, competitorYes: false, highlight: true,
  },
  {
    ...
    competitor: 'Per-region panchang pages exist (Tamil, Malayalam strong); no unified side-by-side comparison hub.',
    dekhoYes: true, competitorYes: false, highlight: true,
  },
  {
  ...
  },
  {
    ...
    competitor: 'Reference articles on medical astrology; no automated multi-axis diagnosis engine.',
    dekhoYes: true, competitorYes: false, highlight: true,
  },
  {
