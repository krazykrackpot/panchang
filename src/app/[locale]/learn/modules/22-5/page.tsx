...
const QUESTIONS: ModuleQuestion[] = [
  {
    ...
    options: [
      ...
      { en: 'The Moon moves ~13°/day, changing position significantly during the computation', hi: 'चन्द्रमा ~13°/दिन चलता है, गणना के दौरान स्थिति महत्त्वपूर्ण रूप से बदलती है', sa: 'चन्द्रः ~13°/दिनं चलति, गणनाकाले स्थितिः महत्त्वपूर्णरूपेण परिवर्तते', mai: 'चन्द्रमा ~13°/दिन चलैत अछि, गणनाक दौरान स्थिति महत्त्वपूर्ण रूप सँ बदलैत अछि', mr: 'चंद्र ~13°/दिवस हलतो, गणनेदरम्यान स्थिती लक्षणीयरित्या बदलते', ta: 'சந்திரன் ~13°/நாள் நகர்கிறது, கணக்கீட்டின் போது நிலை கணிசமாக மாறுகிறது', te: 'చంద్రుడు ~13°/రోజు కదులుతాడు, గణన సమయంలో స్థానం గణనీయంగా మారుతుంది', bn: 'চন্দ্র ~13°/দিন চলে, গণনার সময় অবস্থান উল্লেখযোগ্যভাবে পরিবর্তন হয়', kn: 'ಚಂದ್ರ ~13°/ದಿನ ಚಲಿಸುತ್ತಾನೆ, ಗಣನೆ ಸಮಯದಲ್ಲಿ ಸ್ಥಾನ ಗಮನಾರ್ಹವಾಗಿ ಬದಲಾಗುತ್ತದೆ', gu: 'ચંદ્ર ~13°/દિવસ ચાલે છે, ગણતરી દરમિયાન સ્થિતિ નોંધપાત્ર રીતે બદલાય છે' },
  ...
  },
  {
    ...
    options: [
      { en: '-0.8333° (same as sunrise)', hi: '-0.8333° (सूर्योदय के समान)', sa: '-0.8333° (सूर्योदय के समान)', mai: '-0.8333° (सूर्योदय के समान)', mr: '-0.8333° (सूर्योदय के समान)', ta: '-0.8333° (ஸூர்யோதய கே ஸமாந)', te: '-0.8333° (సూర్యోదయ కే సమాన)', bn: '-0.8333° (সূর্যোদয কে সমান)', kn: '-0.8333° (ಸೂರ್ಯೋದಯ ಕೇ ಸಮಾನ)', gu: '-0.8333° (સૂર્યોદય કે સમાન)' },
      ...
      { en: '-0.3° (semi-diameter minus refraction, with parallax applied separately)', hi: '-0.3° (अर्ध-व्यास ऋण अपवर्तन, लम्बन अलग से लागू)', sa: '-0.3° (अर्ध-व्यास ऋण अपवर्तन, लम्बन अलग से लागू)', mai: '-0.3° (अर्ध-व्यास ऋण अपवर्तन, लम्बन अलग से लागू)', mr: '-0.3° (अर्ध-व्यास ऋण अपवर्तन, लम्बन अलग से लागू)', ta: '-0.3° (அர்ध-வ்யாஸ ऋண அபவர்தந, லம்பந அலக ஸே லாகூ)', te: '-0.3° (అర్ధ-వ్యాస ఋణ అపవర్తన, లమ్బన అలగ సే లాగూ)', bn: '-0.3° (অর্ধ-ব্যাস ঋণ অপবর্তন, লম্বন অলগ সে লাগূ)', kn: '-0.3° (ಅರ್ಧ-ವ್ಯಾಸ ಋಣ ಅಪವರ್ತನ, ಲಮ್ಬನ ಅಲಗ ಸೇ ಲಾಗೂ)', gu: '-0.3° (અર્ધ-વ્યાસ ઋણ અપવર્તન, લમ્બન અલગ સે લાગૂ)' },
  ...
  },
  {
    ...
    options: [
      { en: '5 iterations, ~10 second precision', hi: '5 पुनरावृत्तियाँ, ~10 सेकण्ड सटीकता', sa: '5 पुनरावृत्तियाँ, ~10 सेकण्ड सटीकता', mai: '5 पुनरावृत्तियाँ, ~10 सेकण्ड सटीकता', mr: '5 पुनरावृत्तियाँ, ~10 सेकण्ड सटीकता', ta: '5 புநராவிருத்தியாँ, ~10 ஸேகண்ட ஸடீகதா', te: '5 పునరావృత్తియాఁ, ~10 సేకణ్డ సటీకతా', bn: '5 পুনরাবৃত্তিযাঁ, ~10 সেকণ্ড সটীকতা', kn: '5 ಪುನರಾವೃತ್ತಿಯಾಁ, ~10 ಸೇಕಣ್ಡ ಸಟೀಕತಾ', gu: '5 પુનરાવૃત્તિયાઁ, ~10 સેકણ્ડ સટીકતા' },
      { en: '15 iterations, ~0.03 second precision', hi: '15 पुनरावृत्तियाँ, ~0.03 सेकण्ड सटीकता', sa: '15 पुनरावृत्तियाँ, ~0.03 सेकण्ड सटीकता', mai: '15 पुनरावृत्तियाँ, ~0.03 सेकण्ड सटीकता', mr: '15 पुनरावृत्तियाँ, ~0.03 सेकण्ड सटीकता', ta: '15 புநராவிருத்தியாँ, ~0.03 ஸேகண்ட ஸடீகதா', te: '15 పునరావృత్తియాఁ, ~0.03 సేకణ్డ సటీకతా', bn: '15 পুনরাবৃত্তিযাঁ, ~0.03 সেকণ্ড সটীকতা', kn: '15 ಪುನರಾವೃತ್ತಿಯಾಁ, ~0.03 ಸೇಕಣ್ಡ ಸಟೀಕತಾ', gu: '15 પુનરાવૃત્તિયાઁ, ~0.03 સેકણ્ડ સટીકતા' },
      { en: '100 iterations, ~0.001 second precision', hi: '100 पुनरावृत्तियाँ, ~0.001 सेकण्ड सटीकता', sa: '100 पुनरावृत्तियाँ, ~0.001 सेकण्ड सटीकता', mai: '100 पुनरावृत्तियाँ, ~0.001 सेकण्ड सटीकता', mr: '100 पुनरावृत्तियाँ, ~0.001 सेकण्ड सटीकता', ta: '100 புநராவிருத்தியாँ, ~0.001 ஸேகண்ட ஸடீகதா', te: '100 పునరావృత్తియాఁ, ~0.001 సేకణ్డ సటీకతా', bn: '100 পুনরাবৃত্তিযাঁ, ~0.001 সেকণ্ড সটীকতা', kn: '100 ಪುನರಾವೃತ್ತಿಯಾಁ, ~0.001 ಸೇಕಣ್ಡ ಸಟೀಕತಾ', gu: '100 પુનરાવૃત્તિયાઁ, ~0.001 સેકણ્ડ સટીકતા' },
      { en: '3 iterations, ~1 minute precision', hi: '3 पुनरावृत्तियाँ, ~1 मिनट सटीकता', sa: '3 पुनरावृत्तियाँ, ~1 मिनट सटीकता', mai: '3 पुनरावृत्तियाँ, ~1 मिनट सटीकता', mr: '3 पुनरावृत्तियाँ, ~1 मिनट सटीकता', ta: '3 புநராவிருத்தியாँ, ~1 மிநட ஸடீகதா', te: '3 పునరావృత్తియాఁ, ~1 మినట సటీకతా', bn: '3 পুনরাবৃত্তিযাঁ, ~1 মিনট সটীকতা', kn: '3 ಪುನರಾವೃತ್ತಿಯಾಁ, ~1 ಮಿನಟ ಸಟೀಕತಾ', gu: '3 પુનરાવૃત્તિયાઁ, ~1 મિનટ સટીકતા' },
    ],
    correctAnswer: 1,
    explanation: {
  ...
  },
  {
    ...
    options: [
      { en: 'Within 10 seconds', hi: '10 सेकण्ड के भीतर', sa: '10 सेकण्ड के भीतर', mai: '10 सेकण्ड के भीतर', mr: '10 सेकण्ड के भीतर', ta: '10 ஸேகண்ட கே भீதர', te: '10 సేకణ్డ కే భీతర', bn: '10 সেকণ্ড কে ভীতর', kn: '10 ಸೇಕಣ್ಡ ಕೇ ಭೀತರ', gu: '10 સેકણ્ડ કે ભીતર' },
      { en: 'Within 2 minutes', hi: '2 मिनट के भीतर', sa: '2 मिनट के भीतर', mai: '2 मिनट के भीतर', mr: '2 मिनट के भीतर', ta: '2 மிநட கே भீதர', te: '2 మినట కే భీతర', bn: '2 মিনট কে ভীতর', kn: '2 ಮಿನಟ ಕೇ ಭೀತರ', gu: '2 મિનટ કે ભીતર' },
      { en: 'Within 15 minutes', hi: '15 मिनट के भीतर', sa: '15 मिनट के भीतर', mai: '15 मिनट के भीतर', mr: '15 मिनट के भीतर', ta: '15 மிநட கே भீதர', te: '15 మినట కే భీతర', bn: '15 মিনট কে ভীতর', kn: '15 ಮಿನಟ ಕೇ ಭೀತರ', gu: '15 મિનટ કે ભીતર' },
      { en: 'Within 1 hour', hi: '1 घण्टे के भीतर', sa: '1 घण्टे के भीतर', mai: '1 घण्टे के भीतर', mr: '1 घण्टे के भीतर', ta: '1 घண்டே கே भீதர', te: '1 ఘణ్టే కే భీతర', bn: '1 ঘণ্টে কে ভীতর', kn: '1 ಘಣ್ಟೇ ಕೇ ಭೀತರ', gu: '1 ઘણ્ટે કે ભીતર' },
    ],
    correctAnswer: 1,
    explanation: {
  ...
  },
  {
    ...
    options: [
      ...
      { en: 'Because the Moon moves ~13° eastward daily, and Earth must rotate an extra ~50 minutes to catch up', hi: 'क्योंकि चन्द्रमा प्रतिदिन ~13° पूर्व की ओर चलता है, और पृथ्वी को पकड़ने के लिए अतिरिक्त ~50 मिनट घूमना पड़ता है', sa: 'क्योंकि चन्द्रमा प्रतिदिन ~13° पूर्व की ओर चलता है, और पृथ्वी को पकड़ने के लिए अतिरिक्त ~50 मिनट घूमना पड़ता है', mai: 'क्योंकि चन्द्रमा प्रतिदिन ~13° पूर्व की ओर चलता है, और पृथ्वी को पकड़ने के लिए अतिरिक्त ~50 मिनट घूमना पड़ता है', mr: 'क्योंकि चन्द्रमा प्रतिदिन ~13° पूर्व की ओर चलता है, और पृथ्वी को पकड़ने के लिए अतिरिक्त ~50 मिनट घूमना पड़ता है', ta: 'க்யோம்கி சந்த்ரமா ப்ரதிதிந ~13° பூர்வ கீ ஓர சலதா ஹை, ஔர பிருथ்வீ கோ பகட़நே கே லிஎ அதிரிக்த ~50 மிநட घூமநா பட़தா ஹை', te: 'క్యోంకి చన్ద్రమా ప్రతిదిన ~13° పూర్వ కీ ఓర చలతా హై, ఔర పృథ్వీ కో పకడ़నే కే లిఏ అతిరిక్త ~50 మినట ఘూమనా పడ़తా హై', bn: 'ক্যোংকি চন্দ্রমা প্রতিদিন ~13° পূর্ব কী ওর চলতা হৈ, ঔর পৃথ্বী কো পকড়নে কে লিএ অতিরিক্ত ~50 মিনট ঘূমনা পড়তা হৈ', kn: 'ಕ್ಯೋಂಕಿ ಚನ್ದ್ರಮಾ ಪ್ರತಿದಿನ ~13° ಪೂರ್ವ ಕೀ ಓರ ಚಲತಾ ಹೈ, ಔರ ಪೃಥ್ವೀ ಕೋ ಪಕಡ़ನೇ ಕೇ ಲಿಏ ಅತಿರಿಕ್ತ ~50 ಮಿನಟ ಘೂಮನಾ ಪಡ़ತಾ ಹೈ', gu: 'ક્યોંકિ ચન્દ્રમા પ્રતિદિન ~13° પૂર્વ કી ઓર ચલતા હૈ, ઔર પૃથ્વી કો પકડ़ને કે લિએ અતિરિક્ત ~50 મિનટ ઘૂમના પડ़તા હૈ' },
