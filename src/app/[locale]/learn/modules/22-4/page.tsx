  ...
  return (
    <div className="space-y-6">
      <section>
        ...
        <p className="text-text-secondary text-sm leading-relaxed mb-3">{isHi ? <>आप हमारे ऐप के सूर्योदय समय को किसी भी स्थान के लिए तीन सन्दर्भ स्रोतों से सत्यापित कर सकते हैं: (1) timeanddate.com — सबसे सुलभ ऑनलाइन सन्दर्भ, USNO डेटा पर आधारित। (2) भारतीय खगोलीय पंचांग — भारतीय स्थानों के लिए सरकारी पंचांग सन्दर्भ। (3) NOAA Solar Calculator — अमेरिकी मौसम विज्ञान प्रयोगशाला का आधिकारिक उपकरण। तीनों स्रोतों से हमारा सूर्योदय 1 मिनट के भीतर मिलान करना चाहिए (और प्रायः करता है)।</> : <>You can verify our app&rsquo;s sunrise time against three reference sources for any location: (1) timeanddate.com &mdash; the most accessible online reference, based on USNO data. (2) Indian Astronomical Ephemeris &mdash; the official government panchang reference for Indian locations. (3) NOAA Solar Calculator &mdash; the official US meteorological laboratory tool. Our sunrise should match all three within 1 minute (and typically does).</>}</p>
      </section>
      <section className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-xl p-5 border border-red-500/15">
        <h4 className="text-red-400 text-xs uppercase tracking-widest font-bold mb-3">{tl({ en: 'Additional Misconceptions', hi: 'अतिरिक्त भ्रान्तियाँ', sa: 'अतिरिक्त भ्रान्तियाँ' }, locale)}</h4>
