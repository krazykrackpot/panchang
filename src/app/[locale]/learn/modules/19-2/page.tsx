    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Signs Aspect Signs / राशियाँ राशियों को दृष्ट करती हैं
        </h3>
      ...
      <section className="glass-card rounded-xl p-5 border border-gold-primary/10">
        <h4 className="text-gold-dark text-[10px] uppercase tracking-widest font-bold mb-2">Complete Aspect Table / सम्पूर्ण दृष्टि सारणी</h4>
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Why Rashi Drishti Creates Different Patterns / राशि दृष्टि भिन्न प्रतिरूप क्यों बनाती है
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">Worked Comparison / कार्यान्वित तुलना</h4>
...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Practical Application with Char Dasha / चर दशा के साथ व्यावहारिक अनुप्रयोग
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Whole-Sign Nature — No Orbs / सम्पूर्ण-राशि स्वभाव — कोई ओर्ब नहीं
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
