  ...
  return (
    <div className="space-y-6">
      <section>
        ...
        <p className="text-text-secondary text-sm leading-relaxed mb-3">{isHi ? <>निरयन रूपान्तरण: लाहिरी अयनांश 2026 के लिए ≈ 24.22°। निरयन भोगांश = 10.876° - 24.22° = -13.34° → 346.66° (mod 360°)। यह मीन राशि (330°-360°) में लगभग 16.66° है — सूर्य मीन में, जो अप्रैल आरम्भ के लिए सही है (सूर्य लगभग 14 अप्रैल को मेष प्रवेश करता है)। किसी भी पेशेवर पंचांग स्रोत से सत्यापित करें!<br/><br/>यह उदाहरण दर्शाता है कि कैसे सूत्र वास्तविक कुण्डली प्राचलों से जुड़ते हैं — सूर्य की राशि, जो भाव स्वामित्व, बल, और दशा अवधि निर्धारित करती है।</> : <>Sidereal conversion: Lahiri Ayanamsha for 2026 is approximately 24.22°. Sidereal longitude = 10.876° - 24.22° = -13.34° reduced to 346.66° (mod 360°). This is approximately 16.66° in Pisces (330°-360°) — the Sun is in Pisces, which is correct for early April (the Sun enters Aries around April 14). Verify against any professional panchang source!<br/><br/>This example shows how the formula connects to real chart parameters — the Sun&apos;s rashi placement, which determines house lordship, dignity, and dasha periods.</>}</p>
      </section>
