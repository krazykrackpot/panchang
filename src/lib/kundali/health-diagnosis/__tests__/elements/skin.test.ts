// src/lib/kundali/health-diagnosis/__tests__/elements/skin.test.ts
//
// Task B9 — skin element scorer tests.
//
...
import { scoreSkin } from '../../elements/skin';
...
const result = scoreSkin(kundali, strength, signatures, 'en');
...
describe('scoreSkin', () => {
  ...
  it('returns correct metadata matching ELEMENT_CATALOG[skin]', () => {
    const meta = ELEMENT_CATALOG['skin'];
    expect(result.id).toBe('skin');
