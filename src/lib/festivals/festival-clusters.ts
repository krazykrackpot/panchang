...
export const FESTIVAL_CLUSTERS: Record<string, FestivalCluster> = {
  ...
  'navratri-sequence': {
    ...
    entries: [
      ...
      { slug: 'navratri-day-2', comingSoon: true, dayLabel: { en: 'Day 2 — Brahmacharini',         hi: 'द्वितीय दिवस — ब्रह्मचारिणी' } },
      { slug: 'navratri-day-3', comingSoon: true, dayLabel: { en: 'Day 3 — Chandraghanta',         hi: 'तृतीय दिवस — चन्द्रघण्टा' } },
      { slug: 'navratri-day-4', comingSoon: true, dayLabel: { en: 'Day 4 — Kushmanda',             hi: 'चतुर्थ दिवस — कूष्माण्डा' } },
      { slug: 'navratri-day-5', comingSoon: true, dayLabel: { en: 'Day 5 — Skandamata',            hi: 'पञ्चम दिवस — स्कन्दमाता' } },
      { slug: 'navratri-day-6', comingSoon: true, dayLabel: { en: 'Day 6 — Katyayani',             hi: 'षष्ठ दिवस — कात्यायनी' } },
      { slug: 'navratri-day-7', comingSoon: true, dayLabel: { en: 'Day 7 — Kalaratri',             hi: 'सप्तम दिवस — कालरात्रि' } },
      { slug: 'navratri-day-8', comingSoon: true, dayLabel: { en: 'Day 8 — Mahagauri (Ashtami)',   hi: 'अष्टम दिवस — महागौरी' } },
      { slug: 'navratri-day-9', comingSoon: true, dayLabel: { en: 'Day 9 — Siddhidatri (Navami)',  hi: 'नवम दिवस — सिद्धिदात्री' } },
      { slug: 'dussehra' },
    ],
  },
