...
export default function SavedChartsPage() {
  ...
  const handleDelete = async (id: string) => {
    if (!confirm(tl({ en: 'Delete this chart?', hi: 'यह चार्ट हटाएँ?', sa: 'इदं चक्रं विलोपयतु वा?', ta: 'இந்த விளக்கப்படத்தை நீக்கவா?', te: 'ఈ చార్ట్ తొలగించాలా?', bn: 'এই চার্টটি মুছবেন?', kn: 'ಈ ಚಾರ್ಟ್ ಅಳಿಸಬೇಕೇ?', gu: 'આ ચાર્ટ કાઢી નાખવો?', mai: 'इ चार्ट हटाउ?', mr: 'हा चार्ट हटवायचा?' }, locale))) return;
    const supabase = getSupabase();
    if (!supabase) return;
    setDeleting(id);
  ...
  if (!user) {
    return <div className="max-w-2xl mx-auto px-4 py-20 text-center"><p className="text-text-secondary">{tl({ en: 'Sign in to manage saved charts', hi: 'सहेजे गए चार्ट देखने के लिए साइन इन करें', sa: 'सञ्चितानि चक्राणि प्रबन्धयितुं प्रवेशं करोतु', ta: 'சேமித்த விளக்கப்படங்களை நிர்வகிக்க உள்நுழையவும்', te: 'సేవ్ చేసిన చార్ట్‌లను నిర్వహించడానికి సైన్ ఇన్ చేయండి', bn: 'সংরক্ষিত চার্ট পরিচালনা করতে সাইন ইন করুন', kn: 'ಉಳಿಸಿದ ಚಾರ್ಟ್‌ಗಳನ್ನು ನಿರ್ವಹಿಸಲು ಸೈನ್ ಇನ್ ಮಾಡಿ', gu: 'સાચવેલ ચાર્ટ્સ મેનેજ કરવા સાઇન ઇન કરો', mai: 'सहेजल चार्ट प्रबन्ध करबाक लेल साइन इन करू', mr: 'जतन केलेल्या चार्टस् व्यवस्थापित करण्यासाठी साइन इन करा' }, locale)}</p></div>;
  }
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="flex items-center justify-between mb-8">
        <motion.h1 initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="text-4xl font-bold" style={hf}>
          <span className="text-gold-gradient">{tl({ en: 'Saved Charts', hi: 'सहेजे गए चार्ट', sa: 'सञ्चितानि चक्राणि', ta: 'சேமித்த விளக்கப்படங்கள்', te: 'సేవ్ చేసిన చార్ట్‌లు', bn: 'সংরক্ষিত চার্ট', kn: 'ಉಳಿಸಿದ ಚಾರ್ಟ್‌ಗಳು', gu: 'સાચવેલ ચાર્ટ', mai: 'सहेजल चार्ट', mr: 'जतन केलेले चार्ट' }, locale)}</span>
        </motion.h1>
        <button onClick={() => setShowForm(!showForm)}
          ...
          {showForm ? tl({ en: 'Cancel', hi: 'रद्द', sa: 'निरस्तम्', ta: 'ரத்து செய்', te: 'రద్దు చేయి', bn: 'বাতিল', kn: 'ರದ್ದು ಮಾಡಿ', gu: 'રદ કરો', mai: 'रद्द करू', mr: 'रद्द करा' }, locale) : tl({ en: 'Add New', hi: 'नया जोड़ें', sa: 'नवीनं योजयतु', ta: 'புதியதை சேர்க்கவும்', te: 'కొత్తది జోడించండి', bn: 'নতুন যোগ করুন', kn: 'ಹೊಸದು ಸೇರಿಸಿ', gu: 'નવું ઉમેરો', mai: 'नव जोड़ू', mr: 'नवीन जोडा' }, locale)}
        </button>
      </div>
        ...
        {showForm && (
          <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: 'auto' }} exit={{ opacity: 0, height: 0 }}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
              ...
              <div>
                <label className="text-gold-dark text-xs uppercase tracking-wider font-bold block mb-1">{tl({ en: 'Date of Birth', hi: 'जन्म तिथि', sa: 'जन्म-दिनाङ्कः', ta: 'பிறந்த தேதி', te: 'జన్మ తేదీ', bn: 'জন্ম তারিখ', kn: 'ಹುಟ್ಟಿದ ದಿನಾಂಕ', gu: 'જન્મ તારીખ', mai: 'जन्म तिथि', mr: 'जन्म तारीख' }, locale)}</label>
                <input type="date" value={dob} onChange={e => setDob(e.target.value)}
                  className="w-full bg-bg-tertiary/40 border border-gold-primary/10 rounded-lg px-3 py-2 text-text-primary text-sm focus:border-gold-primary/40 outline-none" />
              </div>
              <div>
                <label className="text-gold-dark text-xs uppercase tracking-wider font-bold block mb-1">{tl({ en: 'Time of Birth', hi: 'जन्म समय', sa: 'जन्म-कालः', ta: 'பிறந்த நேரம்', te: 'జన్మ సమయం', bn: 'জন্ম সময়', kn: 'ಹುಟ್ಟಿದ ಸಮಯ', gu: 'જન્મ સમય', mai: 'जन्म समय', mr: 'जन्मवेळ' }, locale)}</label>
                <input type="time" value={tob} onChange={e => setTob(e.target.value)}
                  className="w-full bg-bg-tertiary/40 border border-gold-primary/10 rounded-lg px-3 py-2 text-text-primary text-sm focus:border-gold-primary/40 outline-none" />
              </div>
              <div className="sm:col-span-2">
                <label className="text-gold-dark text-xs uppercase tracking-wider font-bold block mb-1">{tl({ en: 'Place of Birth', hi: 'जन्म स्थान', sa: 'जन्म-स्थानम्', ta: 'பிறந்த இடம்', te: 'జన్మ స్థలం', bn: 'জন্মস্থান', kn: 'ಹುಟ್ಟಿದ ಸ್ಥಳ', gu: 'જન્મ સ્થળ', mai: 'जन्म स्थान', mr: 'जन्मस्थान' }, locale)}</label>
            ...
            <button onClick={handleSave} disabled={saving || !label || !dob || !placeLat}
              ...
              {tl({ en: 'Save Chart', hi: 'चार्ट सहेजें', sa: 'चक्रं सञ्चयतु', ta: 'விளக்கப்படத்தை சேமி', te: 'చార్ట్ సేవ్ చేయండి', bn: 'চার্ট সংরক্ষণ করুন', kn: 'ಚಾರ್ಟ್ ಉಳಿಸಿ', gu: 'ચાર્ટ સાચવો', mai: 'चार्ट सहेजू', mr: 'चार्ट जतन करा' }, locale)}
            </button>
          </motion.div>
        )}
      </AnimatePresence>
      ...
      {loading ? (
        ...
        <div className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-xl p-12 text-center">
          ...
          <p className="text-text-secondary text-lg mb-2" style={bf}>{tl({ en: 'No saved charts yet', hi: 'अभी तक कोई सहेजा गया चार्ट नहीं', sa: 'अद्यावधि किमपि चक्रं न सञ्चितम्', ta: 'இன்னும் சேமித்த விளக்கப்படங்கள் இல்லை', te: 'ఇంకా సేవ్ చేసిన చార్ట్‌లు లేవు', bn: 'এখনো কোনো চার্ট সংরক্ষণ করা হয়নি', kn: 'ಇನ್ನೂ ಯಾವುದೇ ಚಾರ್ಟ್ ಉಳಿಸಲಾಗಿಲ್ಲ', gu: 'હજી કોઈ ચાર્ટ સાચવ્યો નથી', mai: 'अखन तक कोनो चार्ट सहेजल नहि अछि', mr: 'अद्याप कोणताही चार्ट जतन केलेला नाही' }, locale)}</p>
          <p className="text-text-secondary/70 text-sm mb-4">{tl({ en: 'Save birth charts for family members, friends, or clients', hi: 'परिवार, मित्रों या ग्राहकों की जन्म कुण्डली सहेजें', sa: 'परिवारजनानां मित्राणां ग्राहकाणां च जन्म-कुण्डलीः सञ्चयतु', ta: 'குடும்பத்தினர், நண்பர்கள் அல்லது வாடிக்கையாளர்களின் ஜன்ம ஜாதகங்களை சேமிக்கவும்', te: 'కుటుంబ సభ్యులు, స్నేహితులు లేదా క్లయింట్‌ల జన్మ కుండలులు సేవ్ చేయండి', bn: 'পরিবার, বন্ধু বা ক্লায়েন্টদের জন্য জন্ম কুণ্ডলী সংরক্ষণ করুন', kn: 'ಕುಟುಂಬ ಸದಸ್ಯರು, ಸ್ನೇಹಿತರು ಅಥವಾ ಗ್ರಾಹಕರ ಜನ್ಮ ಕುಂಡಲಿಗಳನ್ನು ಉಳಿಸಿ', gu: 'પરિવારના સભ્યો, મિત્રો અથવા ગ્રાહકો માટે જન્મ કુંડળી સાચવો', mai: 'परिवार, मित्र वा ग्राहकक जन्म-कुण्डली सहेजू', mr: 'कुटुंब, मित्र किंवा ग्राहकांच्या जन्मकुंडल्या जतन करा' }, locale)}</p>
          <button onClick={() => setShowForm(true)} className="px-6 py-2 rounded-lg bg-gold-primary/20 border border-gold-primary/30 text-gold-light text-sm font-bold">
            {tl({ en: 'Add Your First Chart', hi: 'अपना पहला चार्ट जोड़ें', sa: 'स्वप्रथमं चक्रं योजयतु', ta: 'உங்கள் முதல் விளக்கப்படத்தை சேர்க்கவும்', te: 'మీ మొదటి చార్ట్ జోడించండి', bn: 'আপনার প্রথম চার্ট যোগ করুন', kn: 'ನಿಮ್ಮ ಮೊದಲ ಚಾರ್ಟ್ ಸೇರಿಸಿ', gu: 'તમારો પ્રથમ ચાર્ટ ઉમેરો', mai: 'अपन पहिल चार्ट जोड़ू', mr: 'तुमचा पहिला चार्ट जोडा' }, locale)}
          </button>
        </div>
      ) : (
            ...
            <motion.div key={c.id} initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.05 }}
              ...
              <div className="flex items-start justify-between mb-3">
                <div>
                  ...
                  {c.is_primary && <span className="text-xs px-1.5 py-0.5 rounded-full bg-gold-primary/20 text-gold-primary font-bold">{tl({ en: 'Primary', hi: 'प्राथमिक', sa: 'प्राथमिकः', ta: 'முதன்மை', te: 'ప్రాథమిక', bn: 'প্রাথমিক', kn: 'ಪ್ರಾಥಮಿಕ', gu: 'પ્રાથમિક', mai: 'प्राथमिक', mr: 'प्राथमिक' }, locale)}</span>}
                </div>
              ...
              <a href={`/${locale}/kundali?n=${encodeURIComponent(c.birth_data.name || c.label)}&d=${c.birth_data.date}&t=${c.birth_data.time}&la=${c.birth_data.lat}&lo=${c.birth_data.lng}&p=${encodeURIComponent(c.birth_data.place)}`}
                ...
                <Eye className="w-3.5 h-3.5" />{tl({ en: 'View Chart', hi: 'चार्ट देखें', sa: 'चक्रं पश्यतु', ta: 'விளக்கப்படம் காண்க', te: 'చార్ట్ చూడండి', bn: 'চার্ট দেখুন', kn: 'ಚಾರ್ಟ್ ನೋಡಿ', gu: 'ચાર્ટ જુઓ', mai: 'चार्ट देखू', mr: 'चार्ट पाहा' }, locale)}
              </a>
            </motion.div>
          ))}
        </div>
