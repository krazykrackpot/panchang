...
export const FESTIVAL_DETAILS: Record<string, FestivalDetail> = {
  ...
  'makar-sankranti': {
    ...
    mythology: {
      en: 'Makar Sankranti is the day the Sun enters the sign of Capricorn (Makara). Unlike almost every other Hindu festival it is fixed not to the lunar calendar but to the solar one, falling on the same Gregorian date (14 or 15 January) almost every year because it is anchored to an astronomical event rather than to a tithi. Several stories cluster around it.\n\nThe Mahabharata gives the most often-told association. After Bhishma Pitamaha is felled by Arjuna\'s arrows at Kurukshetra, he does not die. He had received from his father Shantanu the boon of icchha-mrityu — death only at a moment of his own choosing — and he refused to leave his body during Dakshinayana, the southward six months in which the Sun travels south of the equator. So Bhishma lay on a bed of arrows for fifty-eight days, in pain but alive, instructing Yudhishthira on dharma in the Shanti and Anushasana Parvas, waiting for the Sun to turn north. On the day the Sun entered Makara, he gave up his body and ascended. The Mahabharata sets this scene to teach that dying in Uttarayana — the bright six months — leads upward, while dying in Dakshinayana leads to the cycle of return; Bhishma chose Uttarayana so that his end matched his lifelong dharma. The festival is observed in his memory as a day on which charity, bathing in sacred rivers, and remembrance of the ancestors carry special weight.\n\nA second strand belongs to Surya and his son Shani. The Bhavishya Purana relates that Shani, lord of Capricorn, had been estranged from his father Surya through a domestic dispute. On Makar Sankranti, Surya visits his son\'s house — a father-son reconciliation that is read as the cosmic basis of the day. By household tradition the day therefore loosens grievances: relatives visit each other, sweets of sesame and jaggery are exchanged with the formula til-gul ghya, god god bola ("take this sesame and jaggery, speak sweetly"). The til-gul itself has been read as a symbol — sesame for sticking together, jaggery for sweetness — of repair across what the year may have strained.\n\nA third strand is agricultural. In the northern plains the harvest of the kharif crop is in; the festival marks gratitude to Surya, the source of all growth. In Tamil Nadu it is observed as Pongal, where rice freshly cooked in milk is allowed to boil over — pongal pongal — as the household calls out, the boiling over taken as the year\'s abundance. In Punjab the eve (Lohri) is celebrated with the bonfire of cane-stalks and a circling that gives thanks for the winter harvest. In Gujarat and Rajasthan the day fills the sky with kites — a celebration, some say, of the sun first being able to be looked at again without harm as its rays soften with the turn northward; others say the kite-cutting symbolises the cutting away of the past year\'s sorrows.\n\nThe astronomical anchoring matters: every other Hindu festival is set to the position of the moon, but Makar Sankranti is set to the position of the sun. It is therefore one of the few days where Bharata\'s calendars across all regions align — Pongal, Lohri, Bihu, Uttarayan, Khichdi, Suggi — and a day on which, more than any other, the festival\'s name changes but its astronomical fact does not.',
      hi: 'मकर संक्रान्ति वह दिन है जब सूर्य मकर राशि में प्रवेश करते हैं। प्रायः सभी हिन्दू पर्वों के विपरीत यह सौर कैलेण्डर से बँधा है — हर वर्ष लगभग उसी ग्रेगोरियन तिथि (14 या 15 जनवरी) को पड़ता है क्योंकि इसका आधार खगोलीय घटना है, तिथि नहीं। इसके चारों ओर कई कथाएँ एकत्र हैं।\n\nसबसे प्रसिद्ध सम्बन्ध महाभारत से है। कुरुक्षेत्र में अर्जुन के बाणों से शर-शय्या पर पतित भीष्म पितामह ने प्राण नहीं त्यागे। उन्हें पिता शान्तनु से इच्छा-मृत्यु का वर प्राप्त था, और उन्होंने दक्षिणायन — सूर्य की दक्षिण-यात्रा के छह मास — में देह छोड़ने से मना कर दिया। अतः अट्ठावन दिनों तक शर-शय्या पर वेदना सहते हुए वे जीवित रहे, और उसी अवधि में युधिष्ठिर को शान्ति-पर्व तथा अनुशासन-पर्व में धर्मोपदेश देते रहे, सूर्य के उत्तरायण की प्रतीक्षा में। जिस दिन सूर्य मकर में प्रविष्ट हुए, उन्होंने देह त्यागी और ऊर्ध्व लोकों में गमन किया। महाभारत यह दृश्य यह सिखाने को रचता है कि उत्तरायण में मृत्यु ऊर्ध्व-गति देती है, दक्षिणायन में मृत्यु पुनरावृत्ति-चक्र में डालती है; भीष्म ने उत्तरायण चुना ताकि उनका अन्त उनके धर्म से मेल खाये। उनकी स्मृति में यह दिन दान, पुण्य-स्नान और पितृ-तर्पण के लिए विशेष महत्व रखता है।\n\nदूसरी कथा सूर्य और उनके पुत्र शनि की है। भविष्य पुराण के अनुसार मकर राशि के स्वामी शनि का अपने पिता सूर्य से एक गृह-कलह के पश्चात् मनमुटाव हुआ था। मकर संक्रान्ति पर सूर्य अपने पुत्र के घर पधारते हैं — एक पिता-पुत्र मेल जिसे इस दिन का खगोलीय आधार माना जाता है। पारिवारिक परम्परा में यह दिन शिकवे शिकायतें मिटाने का है: सम्बन्धी एक-दूसरे के यहाँ जाते हैं, तिल-गुड़ की मिठाई इस वचन के साथ बाँटी जाती है — "तिल-गुड़ ग्या, गोड़-गोड़ बोला" (तिल-गुड़ लो, मीठा बोलो)। तिल चिपकाव का प्रतीक है, गुड़ मधुरता का।\n\nतीसरी कथा कृषि-सम्बन्धी है। उत्तरी मैदानों में खरीफ फसल कट चुकी होती है; पर्व सूर्य के प्रति कृतज्ञता का है। तमिलनाडु में पोङ्गल के रूप में मनाया जाता है, जहाँ दूध में पकाया गया चावल ऊपर उछलने दिया जाता है — "पोङ्गल पोङ्गल" की पुकार के साथ, यह उछाल वर्ष की समृद्धि का प्रतीक है। पंजाब में पूर्व-सन्ध्या (लोहड़ी) पर गन्ने की चिता और परिक्रमा के साथ शीत-ऋतु की फसल का धन्यवाद किया जाता है। गुजरात और राजस्थान में पतंगों से आकाश भर जाता है।\n\nखगोलीय आधार महत्वपूर्ण है: अन्य हिन्दू पर्व चन्द्र-स्थिति से नियत हैं, परन्तु मकर संक्रान्ति सूर्य-स्थिति से। अतः यह उन कुछ दिनों में से है जब भारत के सभी क्षेत्रीय कैलेण्डर एक-साथ संरेखित होते हैं — पोङ्गल, लोहड़ी, बिहु, उत्तरायण, खिचड़ी, सुग्गी — और जिस दिन पर्व का नाम तो बदलता है, खगोलीय तथ्य नहीं।',
      sa: 'मकरसंक्रान्तिः सूर्यस्य मकरराशिप्रवेशदिनम् — अन्यपर्वभ्यः भिन्ना, सौरकालेन निबद्धा, प्रतिवर्षं तस्मिन्नेव ग्रेगोरियनदिनाङ्के (जनवरी 14/15) पतति। महाभारते भीष्मपितामहः अर्जुनबाणैः शरशय्यां पतितः, इच्छामृत्युवरबलेन दक्षिणायने प्राणत्यागं न कृतवान्, अष्टपञ्चाशद्दिनानि शय्यायां युधिष्ठिराय धर्मोपदेशं कुर्वन् उत्तरायणस्य प्रतीक्षां कृतवान्। यस्मिन् दिने सूर्यः मकरं प्राविशत्, स देहत्यागं कृतवान् ऊर्ध्वलोकगमनं च। भविष्यपुराणे सूर्य-शनिपितृपुत्रसम्बन्धकथा — मकरस्वामी शनिः, अस्मिन् दिने सूर्यः पुत्रगृहम् आगच्छति। तिलगुड-वितरणं मधुरवचनप्रतीकम्। दक्षिणे पोङ्गलः, पञ्चाबे लोहडी, गुजरातराजस्थानयोः पतङ्गोत्सवः। सर्वेषु क्षेत्रेषु एकत्र संरेखित-पर्व।',
      mr: 'मकर संक्रान्ति हा दिवस जेव्हा सूर्य मकर राशीत प्रवेश करतो. इतर हिंदू सणांच्या विपरीत हा सौर कॅलेंडरशी जोडलेला आहे — दर वर्षी जवळपास त्याच ग्रेगोरियन तारखेला (14 किंवा 15 जानेवारी) येतो कारण याचा आधार खगोलीय घटना आहे, तिथी नाही.\n\nसर्वात प्रसिद्ध संबंध महाभारतातून आहे. कुरुक्षेत्रात अर्जुनाच्या बाणांनी शरशय्येवर पडलेल्या भीष्म पितामहांनी प्राण सोडले नाहीत. त्यांना पिता शंतनूकडून इच्छा-मृत्यूचे वरदान होते, आणि त्यांनी दक्षिणायन — सूर्याच्या दक्षिणयात्रेच्या सहा महिन्यांत — देहत्याग करण्यास नकार दिला. अठ्ठावन्न दिवस शरशय्येवर वेदना सहन करत ते जिवंत राहिले, याच काळात युधिष्ठिराला शांती-पर्व व अनुशासन-पर्वात धर्मोपदेश देत राहिले, सूर्याच्या उत्तरायणाची वाट पाहत. ज्या दिवशी सूर्य मकरात प्रविष्ट झाला, त्यांनी देहत्याग केला आणि ऊर्ध्व लोकात गमन केले. महाभारत हे शिकवते की उत्तरायणात मृत्यू ऊर्ध्वगती देतो, दक्षिणायनात मृत्यू पुनरावृत्ति-चक्रात टाकतो.\n\nदुसरी कथा सूर्य आणि त्यांचा पुत्र शनी यांची आहे. भविष्य पुराणानुसार मकर राशीचा स्वामी शनी आपल्या पित्या सूर्याशी एका गृह-कलहामुळे दुरावला होता. मकर संक्रांतीला सूर्य आपल्या पुत्राच्या घरी जातो — एक पिता-पुत्र समेट जो या दिवसाचा खगोलीय आधार मानला जातो. म्हणूनच कुटुंबात तिळगूळ वाटण्याची परंपरा — "तिळगूळ घ्या, गोड गोड बोला."\n\nतिसरी कथा शेतीशी संबंधित आहे. उत्तर भारतात खरीप पीक काढून झालेले असते; सण सूर्याप्रती कृतज्ञतेचा. तमिळनाडूत पोंगल, पंजाबमध्ये लोहडी, आसामात बिहू, गुजरातमध्ये पतंगोत्सव — सर्व प्रदेशांत एकाच दिवशी वेगवेगळी नावे.\n\nखगोलीय आधार महत्त्वाचा आहे: इतर सर्व हिंदू सण चंद्र-स्थितीनुसार, पण मकर संक्रांत सूर्य-स्थितीनुसार. म्हणून हा त्या काही दिवसांपैकी एक जेव्हा भारताच्या सर्व प्रादेशिक कॅलेंडर्स एकत्र संरेखित होतात.',
      mai: 'मकर संक्रान्ति ओहि दिन अछि जखन सूर्य मकर राशि मे प्रवेश करैत छथि। अन्य हिन्दू पर्व कें विपरीत ई सौर कैलेण्डर सँ बान्हल अछि — हर साल लगभग ओही ग्रेगोरियन तिथि (14 या 15 जनवरी) कें पड़ैत अछि कारण एकर आधार खगोलीय घटना अछि, तिथि नहि।\n\nसबसँ प्रसिद्ध सम्बन्ध महाभारत सँ अछि। कुरुक्षेत्र मे अर्जुन कें बाण सँ शर-शय्या पर पतित भीष्म पितामह प्राण नहि त्यागलनि। हुनका पिता शान्तनु सँ इच्छा-मृत्यु कें वर प्राप्त छल, आ ओ दक्षिणायन मे देह छोड़य सँ मना कय देलखिन्ह। अट्ठावन दिन शर-शय्या पर वेदना सहैत ओ जिअैत रहलाह, ओही अवधि मे युधिष्ठिर कें धर्मोपदेश दैत रहलाह, सूर्य कें उत्तरायण कें प्रतीक्षा मे। जे दिन सूर्य मकर मे प्रविष्ट भेलाह, ओ देह त्यागलनि।\n\nदोसर कथा सूर्य आ हुनकर पुत्र शनि कें अछि। भविष्य पुराण कें अनुसार मकर राशि कें स्वामी शनि अपन पिता सूर्य सँ गृह-कलह कें बाद दूर भय गेल छलाह। मकर संक्रान्ति पर सूर्य अपन पुत्र कें घर पधारैत छथि — पिता-पुत्र कें मेल। ताहि सँ परिवार मे तिल-गुड़ कें वितरण — "तिल-गुड़ ग्या, गोड़-गोड़ बोला।"\n\nतेसर कथा कृषि सँ अछि। उत्तरी मैदान मे खरीफ फसल कटि जाइत अछि; पर्व सूर्य कें प्रति कृतज्ञता कें अछि। तमिलनाडु मे पोङ्गल, पंजाब मे लोहड़ी, असम मे बिहु, गुजरात-राजस्थान मे पतंगोत्सव — सब क्षेत्र मे एक्के दिन अलग-अलग नाम।\n\nखगोलीय आधार महत्वपूर्ण अछि: अन्य सब हिन्दू पर्व चन्द्र-स्थिति सँ नियत अछि, मुदा मकर संक्रान्ति सूर्य-स्थिति सँ।',
    },
    observance: {
  ...
  'holika-dahan': {
    ...
    observance: {
      ...
      hi: 'फाल्गुन पूर्णिमा को सूर्यास्त बाद शुभ मुहूर्त में सार्वजनिक स्थान पर विशाल अलाव जलाया जाता है। भक्त अग्नि की परिक्रमा करते हैं, नारियल, अनाज और लावा अग्नि में अर्पित करते हैं। कच्चा नारियल और नया अनाज भूनकर प्रसाद बनाया जाता है। लोग मन्त्र जपते हैं और पवित्र अग्नि की राख माथे पर लगाते हैं।',
      sa: 'फाल्गुनपूर्णिमायां सूर्यास्तानन्तरं शुभमुहूर्ते महान् अग्निः प्रज्वाल्यते। भक्ताः अग्निं परिक्रामन्ति, नारिकेलं धान्यं च अग्नौ अर्पयन्ति।',
      mr: 'फाल्गुन पूर्णिमा को सूर्यास्त बाद शुभ मुहूर्त में सार्वजनिक स्थान पर विशाल अलाव जलाया जाता है। भक्त अग्नि की परिक्रमा करते हैं, नारियल, अनाज और लावा अग्नि में अर्पित करते हैं। पवित्र अग्नि की राख माथे पर लगाते हैं।',
    ...
    deity: { en: 'Agni (Fire God), Lord Vishnu', hi: 'अग्नि देव, भगवान विष्णु', sa: 'अग्निः, विष्णुः', ta: 'அக்னி, விஷ்ணு', te: 'అగ్ని, విష్ణువు', bn: 'অগ্নি, বিষ্ণু', kn: 'ಅಗ್ನಿ, ವಿಷ್ಣು', gu: 'અગ્નિ, વિષ્ણુ', mr: 'अग्नि देव, भगवान विष्णु', mai: 'अग्नि देव, भगवान विष्णु' },
  },
  ...
  'durga-ashtami': {
    name: { en: 'Durga Ashtami', hi: 'दुर्गाष्टमी', sa: 'दुर्गाष्टमी', ta: 'துர்கா அஷ்டமி', te: 'దుర్గాష్టమి', bn: 'দুর্গাষ্টমী', kn: 'ದುರ್ಗಾಷ್ಟಮಿ', gu: 'દુર્ગાષ્ટમી', mr: 'दुर्गाष्टमी', mai: 'दुर्गाष्टमी' },
    mythology: {
      en: 'Durga Ashtami, also called Maha Ashtami, is the eighth day of Navaratri when Goddess Durga is worshipped in her fiercest form as Mahagauri or Chamunda. It is believed that on this day, Durga\'s rage reached its peak in her battle against Mahishasura, and she manifested the fearsome Chamunda to slay the demons Chanda and Munda.',
      hi: 'दुर्गाष्टमी, जिसे महाअष्टमी भी कहते हैं, नवरात्रि का आठवाँ दिन है जब देवी दुर्गा की उग्रतम रूप में महागौरी या चामुण्डा के रूप में पूजा होती है। इस दिन महिषासुर से युद्ध में दुर्गा का क्रोध चरम पर पहुँचा और उन्होंने चण्ड-मुण्ड वध के लिए भयंकर चामुण्डा रूप प्रकट किया।',
      sa: 'दुर्गाष्टमी नवरात्रेः अष्टमं दिनम्। अस्मिन् दिने दुर्गादेवी उग्रतमरूपेण चामुण्डारूपेण च पूज्यते। चण्डमुण्डयोः वधार्थं भयंकरं चामुण्डारूपं प्राकट्यत।',
      mr: 'दुर्गाष्टमी, जिसे महाअष्टमी भी कहते हैं, नवरात्रि का आठवाँ दिन है जब देवी दुर्गा की उग्रतम रूप में पूजा होती है। इस दिन महिषासुर से युद्ध में दुर्गा का क्रोध चरम पर पहुँचा और उन्होंने चण्ड-मुण्ड वध के लिए भयंकर चामुण्डा रूप प्रकट किया।',
    ...
    significance: {
      ...
      hi: 'दुर्गाष्टमी नवरात्रि का सबसे शक्तिशाली दिन माना जाता है। अष्टमी-नवमी सन्धि पूजा सम्पूर्ण उत्सव का सबसे पवित्र अनुष्ठान है। दक्षिण भारत में इस दिन आयुध पूजा व्यापक रूप से मनायी जाती है।',
      sa: 'दुर्गाष्टमी नवरात्रेः शक्तिमत्तमं दिनम्। अष्टमीनवमीसन्धिपूजा सम्पूर्णोत्सवस्य पवित्रतमम् अनुष्ठानम्।',
      mr: 'दुर्गाष्टमी नवरात्रि का सबसे शक्तिशाली दिन माना जाता है। अष्टमी-नवमी सन्धि पूजा सम्पूर्ण उत्सव का सबसे पवित्र अनुष्ठान है।',
      mai: 'दुर्गाष्टमी नवरात्रि का सबसे शक्तिशाली दिन माना जाता है। अष्टमी-नवमी सन्धि पूजा सम्पूर्ण उत्सव का सबसे पवित्र अनुष्ठान है।',
    },
    deity: { en: 'Goddess Durga (Mahagauri / Chamunda)', hi: 'देवी दुर्गा (महागौरी / चामुण्डा)', sa: 'दुर्गादेवी (महागौरी / चामुण्डा)', ta: 'துர்கா தேவி (மகாகௌரி / சாமுண்டா)', te: 'దుర్గా దేవి (మహాగౌరి / చాముండా)', bn: 'দুর্গা দেবী (মহাগৌরী / চামুণ্ডা)', kn: 'ದುರ್ಗಾ ದೇವಿ (ಮಹಾಗೌರಿ / ಚಾಮುಂಡಾ)', gu: 'દુર્ગા દેવી (મહાગૌરી / ચામુંડા)', mr: 'देवी दुर्गा (महागौरी / चामुण्डा)', mai: 'देवी दुर्गा (महागौरी / चामुण्डा)' },
  },
  ...
  'hartalika-teej': {
    ...
    observance: {
      ...
      hi: 'महिलाएँ भाद्रपद शुक्ल तृतीया को कठोर निर्जला व्रत रखती हैं। मिट्टी या रेत से शिव-पार्वती की मूर्ति बनाकर मध्याह्न काल में फूल, बेलपत्र और फलों से पूजा करती हैं। रात भर जागरण करती हैं। अगली सुबह मूर्तियों का विसर्जन किया जाता है। अविवाहित कन्याएँ अच्छे वर के लिए और विवाहित महिलाएँ सौभाग्य के लिए व्रत रखती हैं।',
      sa: 'स्त्रियः भाद्रपदशुक्लतृतीयायां कठोरनिर्जलव्रतं धारयन्ति। मृत्तिकया शिवपार्वतीप्रतिमां निर्माय मध्याह्ने पूजयन्ति। रात्रौ जागरणं कुर्वन्ति।',
      mr: 'महिलाएँ भाद्रपद शुक्ल तृतीया को कठोर निर्जला व्रत रखती हैं। मिट्टी या रेत से शिव-पार्वती की मूर्ति बनाकर मध्याह्न काल में फूल, बेलपत्र और फलों से पूजा करती हैं। रात भर जागरण करती हैं। अगली सुबह मूर्तियों का विसर्जन किया जाता है।',
      mai: 'महिलाएँ भाद्रपद शुक्ल तृतीया को कठोर निर्जला व्रत रखती हैं। मिट्टी या रेत से शिव-पार्वती की मूर्ति बनाकर मध्याह्न काल में फूल, बेलपत्र और फलों से पूजा करती हैं। रात भर जागरण करती हैं।',
    },
    significance: {
      en: 'Hartalika Teej is one of the most important vrats for Hindu women, especially in North India, Maharashtra, and Rajasthan. It celebrates Parvati\'s unwavering devotion to Shiva and the power of a woman\'s resolve. The vrat is considered extremely powerful for marital happiness and the longevity of one\'s husband.',
      hi: 'हरतालिका तीज हिन्दू महिलाओं का सबसे महत्वपूर्ण व्रतों में से एक है, विशेषकर उत्तर भारत, महाराष्ट्र और राजस्थान में। यह पार्वती की शिव के प्रति अटल भक्ति और स्त्री संकल्प की शक्ति का उत्सव है। दाम्पत्य सुख और पति की दीर्घायु के लिए अत्यन्त शक्तिशाली व्रत माना जाता है।',
      sa: 'हरतालिकातीजः हिन्दूस्त्रीणां महत्तमव्रतेषु एकम्। पार्वत्याः शिवं प्रति अचलभक्तेः स्त्रीसंकल्पशक्तेः च उत्सवः।',
      mr: 'हरतालिका तीज हिन्दू महिलाओं का सबसे महत्वपूर्ण व्रतों में से एक है, विशेषकर उत्तर भारत, महाराष्ट्र और राजस्थान में। यह पार्वती की शिव के प्रति अटल भक्ति और स्त्री संकल्प की शक्ति का उत्सव है।',
      mai: 'हरतालिका तीज हिन्दू महिलाओं का सबसे महत्वपूर्ण व्रतों में से एक है। यह पार्वती की शिव के प्रति अटल भक्ति और स्त्री संकल्प की शक्ति का उत्सव है।',
    },
    deity: { en: 'Lord Shiva & Goddess Parvati', hi: 'भगवान शिव एवं देवी पार्वती', sa: 'शिवः पार्वतीदेवी च', ta: 'சிவன் & பார்வதி தேவி', te: 'శివుడు & పార్వతీ దేవి', bn: 'শিব ও পার্বতী দেবী', kn: 'ಶಿವ ಮತ್ತು ಪಾರ್ವತಿ ದೇವಿ', gu: 'શિવ અને પાર્વતી દેવી', mr: 'भगवान शिव एवं देवी पार्वती', mai: 'भगवान शिव एवं देवी पार्वती' },
    isFast: true,
    fastNote: { en: 'Strict nirjala (waterless) fast from sunrise to next morning. One of the most rigorous women\'s vrats in Hindu tradition. Break fast after immersing the sand Shiva-Parvati idols.', hi: 'सूर्योदय से अगली सुबह तक कठोर निर्जला व्रत। हिन्दू परम्परा के सबसे कठोर स्त्री व्रतों में से एक। मिट्टी की शिव-पार्वती मूर्तियों के विसर्जन के बाद पारण।', sa: 'सूर्योदयात् प्रभातपर्यन्तं कठोरनिर्जलव्रतम्। मृत्तिकाशिवपार्वतीप्रतिमाविसर्जनानन्तरं पारणम्।', mr: 'सूर्योदय से अगली सुबह तक कठोर निर्जला व्रत। मिट्टी की शिव-पार्वती मूर्तियों के विसर्जन के बाद पारण।', mai: 'सूर्योदय से अगली सुबह तक कठोर निर्जला व्रत। मिट्टी की शिव-पार्वती मूर्तियों के विसर्जन के बाद पारण।' },
    observationRule: { en: 'Madhyahna (Midday) Rule: Observed when the Tritiya tithi prevails during Madhyahna. The vrat is observed during the day with sand Shiva-Parvati idol worship.', hi: 'मध्याह्न नियम: जिस दिन तृतीया तिथि मध्याह्न काल में व्याप्त हो, उस दिन मनाया जाता है। दिन में मिट्टी की शिव-पार्वती मूर्ति की पूजा के साथ व्रत।', sa: 'मध्याह्ननियमः: यस्मिन् दिने तृतीयातिथिः मध्याह्ने व्याप्ता भवति तस्मिन् दिने आचर्यते।', mr: 'मध्याह्न नियम: जिस दिन तृतीया तिथि मध्याह्न काल में व्याप्त हो, उस दिन मनाया जाता है।', mai: 'मध्याह्न नियम: जिस दिन तृतीया तिथि मध्याह्न काल में व्याप्त हो, उस दिन मनाया जाता है।' },
  },

  'karva-chauth': {
    name: { en: 'Karva Chauth', hi: 'करवा चौथ', sa: 'करकचतुर्थी', ta: 'கர்வா சவ்த்', te: 'కర్వా చౌత్', bn: 'করবা চৌথ', kn: 'ಕರ್ವಾ ಚೌತ್', gu: 'કરવા ચોથ', mr: 'करवा चौथ', mai: 'करवा चौथ' },
    mythology: {
      en: 'Karva Chauth — the fast of the karva (small clay pot) on the Chaturthi of the dark fortnight of Kartika — is observed by married women across north India for the long life of their husbands. The Bhavishya Purana, the Skanda Purana, and an oral story-tradition told and retold every year on this day gather around it.\n\nThe most widely retold story is that of Queen Veervati. She was a young, much-loved sister to seven brothers, married into a noble household, and observing Karva Chauth for the first time as a new wife. She had returned to her natal home for the festival. Through the long day of the nirjala (waterless) fast — sunrise to moonrise, no food, no water — Veervati grew faint with hunger and thirst. Her brothers, who could not bear her suffering, contrived an ending. One climbed a peepul tree on a far hill, placed a small lamp behind a sieve, and from the courtyard below it looked exactly like the moon rising. They led their sister to the rooftop, pointed to the false moon, and persuaded her to break the fast. Veervati ate; at the very same moment, her husband, alone in his court many miles away, fell from his seat dead — for the fast, broken before moonrise, had reversed itself onto him.\n\nThe queen ran across the country to her husband\'s house, found him gone, and refused to abandon the body or accept his death. She kept his body, fasted with absolute strictness for an entire year — every Sankashti, every Chaturthi, every month — and when Karva Chauth came round again she observed the fast in its full austerity, watching the moon rise herself, breaking the fast with the karva of water poured under the moon. Goddess Parvati appeared to her and granted that her husband would live. He woke; the household returned. From this story the strict moon-sighting before breaking the fast became the immovable rule.\n\nA second story is from the Mahabharata. Arjuna had gone to Indrakeel mountain for tapasya. Draupadi, fearing for him, was advised by Krishna to observe the Karva Chauth vrat. Krishna himself related to her the story of Shiva and Parvati: how Parvati once asked Shiva, "Who is the most fortunate among women?" and Shiva replied, "She who keeps the karva fast." Krishna told Draupadi to keep it for Arjuna; she did, and Arjuna returned safe from his ascesis. From the Mahabharata layer the tradition gathered the sense that the karva fast is held not in isolation but in a long sister-line of women whose vrat preserved the men they loved.\n\nA third strand, often forgotten, belongs to the agricultural calendar. Karva Chauth falls at the end of the kharif harvest and at the start of the long Indian winter; women would visit their natal homes during the harvest break, and the karva — a small clay pot — would be filled with grains, sweets, bangles, and a token of the family\'s prosperity, exchanged between sister-figures (sisters, sisters-in-law, friends sworn in this ritual as kangan-saheli — bangle-friends). The exchange of karvas predates the fast itself; the fast layered the divine meaning onto an older grain-exchange custom of women in the autumn fields.\n\nThe ritual today therefore carries all three threads. The day-long nirjala fast (no food, no water, sunrise to moonrise) re-enacts Veervati\'s vigil through the year. The sargi at dawn — sent by the mother-in-law and traditionally containing fenugreek-laden sweets, fruits, mithai — is the body\'s store for the long day. The afternoon gathering of women, the singing of Karva Chauth songs in turn around a thali holding a karva of water, sindoor, a diya, sweets, and bangles, is the survival of the older sisterhood of karva-exchange. At evening, the moon is sighted through a sieve held aloft, the husband is sighted through the same sieve, water is offered to the moon, and the fast is broken from the hands of the husband himself — the entire ritual a deliberate enactment of "I will not see the moon until I have first held the moon\'s reflection over your face" — Veervati\'s lesson written into the gesture.',
      hi: 'करवा चौथ — कार्तिक कृष्ण चतुर्थी को करवा (छोटे मिट्टी के पात्र) का व्रत — उत्तर भारत की विवाहित स्त्रियाँ अपने पति की दीर्घायु के लिए रखती हैं। भविष्य पुराण, स्कन्द पुराण और एक मौखिक कथा-परम्परा जो हर वर्ष इस दिन पुनः कही जाती है, इसके चारों ओर हैं।\n\nसर्वाधिक प्रचलित कथा रानी वीरवती की है। वह सात भाइयों की प्रिय बहन थी, उच्च कुल में विवाहित, और नवविवाहिता के रूप में पहली बार करवा चौथ रख रही थी। मायके में थी। निर्जला व्रत के लम्बे दिवस में — सूर्योदय से चन्द्रोदय तक न अन्न न जल — वीरवती क्षुधा और तृषा से व्याकुल हो गयी। भाइयों से बहन की पीड़ा सही न गयी और उन्होंने उपाय रचा। एक भाई दूर पहाड़ी पर पीपल वृक्ष पर चढ़ा, चलनी के पीछे एक छोटा दीपक रखा, और आँगन से ठीक चन्द्रोदय जैसा दिखने लगा। वे बहन को छत पर ले गये, मिथ्या चन्द्र दिखाया, और व्रत तोड़ने को मनाया। वीरवती ने भोजन किया; उसी क्षण उसके पति, दूर अपने दरबार में अकेले बैठे, गिर कर मर गये — व्रत चन्द्रोदय से पहले टूट कर उन पर लौट गया था।\n\nरानी देश-पार पति-गृह दौड़ी, पति को मरा पाया, देह छोड़ी नहीं, मृत्यु स्वीकार नहीं की। एक पूरा वर्ष — हर सङ्कष्टी, हर चतुर्थी, हर मास — पूर्ण कठोरता से व्रत रखा, और जब करवा चौथ पुनः आया तो पूरे अनुष्ठान से रखा, स्वयं चन्द्र-दर्शन कर के, चन्द्र के नीचे करवा से जल अर्पित कर के पारण किया। पार्वती प्रकट हुईं, पति-जीवन का वर दिया। पति जागे; गृह पुनः बसा। इसी कथा से चन्द्रोदय से पूर्व व्रत-भङ्ग न करने का अटल नियम बना।\n\nदूसरी कथा महाभारत से है। अर्जुन इन्द्रकील पर्वत पर तप कर रहे थे। द्रौपदी, उनकी चिन्ता में, कृष्ण से उपाय पूछा; कृष्ण ने करवा चौथ का व्रत बताया, और शिव-पार्वती का प्रसङ्ग सुनाया — पार्वती ने एक बार शिव से पूछा, "स्त्रियों में सबसे भाग्यवती कौन?" शिव ने उत्तर दिया, "जो करवा का व्रत रखे।" कृष्ण ने द्रौपदी को व्रत रखने को कहा; उसने रखा, अर्जुन तप से सकुशल लौटे। महाभारतीय परत से व्रत को यह आयाम मिला कि यह अकेले नहीं, स्त्रियों की दीर्घ बहन-पंक्ति में रखा जाता है जिनके व्रत ने प्रिय पुरुषों की रक्षा की।\n\nतीसरी परत, प्रायः विस्मृत, कृषि-कालिक है। करवा चौथ खरीफ फसल के अन्त और भारतीय शीत-ऋतु के आरम्भ पर आता है; फसल-विश्राम में स्त्रियाँ मायके जातीं, और करवा — छोटा मिट्टी का पात्र — अनाज, मिठाई, चूड़ी, और परिवार की समृद्धि के प्रतीक से भर कर बहन-तुल्य स्त्रियों के बीच विनिमय होता (बहनें, ननदें, सखियाँ जो इस अनुष्ठान में कङ्गन-सहेली ठहरतीं)। करवा-विनिमय व्रत से पूर्व है; व्रत ने पुराने स्त्री-धान्य-विनिमय की पतझड़ी प्रथा पर दैवी अर्थ ओढ़ाया।\n\nआज का अनुष्ठान तीनों धागों को साथ धारण करता है। दिन-भर का निर्जला व्रत वीरवती की वर्ष-वैद्धव्य-व्रत-निष्ठा का स्मरण है। प्रातः की सरगी — सासू-माता द्वारा भेजी, परम्परा में मेथी-युक्त मिठाई, फल, मिष्ठान्न से युक्त — दीर्घ दिवस के लिए शरीर का संचय है। दोपहर की स्त्री-सभा, थाली के चारों ओर बारी-बारी से करवा चौथ गीतों का गायन, जिसमें करवा-जल, सिन्दूर, दीपक, मिठाई, और चूड़ियाँ रखी जाती हैं, पुरानी करवा-विनिमय की बहन-परम्परा का बचाव है। सन्ध्या में चन्द्र को चलनी से देखा जाता है, उसी चलनी से पति को देखा जाता है, चन्द्र को अर्घ्य दिया जाता है, और पति के हाथों से पारण होता है — सम्पूर्ण अनुष्ठान सायास इस वाक्य का अभिनय है: "जब तक तुम्हारे मुख पर चन्द्र-प्रतिबिम्ब न रख लूँ तब तक स्वयं चन्द्र न देखूँगी।" वीरवती का पाठ हस्त-मुद्रा में लिखा।',
      sa: 'करकचतुर्थी कार्तिककृष्णचतुर्थ्यां विवाहितानां स्त्रीणां पत्युः दीर्घायुषे आचर्यते। भविष्य-स्कन्दपुराणयोः कथा। राज्ञी वीरवती सप्तभ्रातृणां प्रिया भगिनी, नवविवाहितायां प्रथमवारं करवाव्रते मातृगृहे क्षुत्पिपासाभ्यां पीडिता। भ्रातरः मिथ्याचन्द्रं चलन्यां दीपं रचयित्वा भगिनीं व्रतभङ्गाय प्रेरितवन्तः। तस्मिन्नेव क्षणे पतिः मृतः। वीरवती संवत्सरं कठोरव्रतेन व्रतं पालयित्वा करकचतुर्थ्यां पुनः पूर्णानुष्ठानेन व्रते कृते पार्वत्या वरेण पतिं जीवितं प्राप्तवती। महाभारते कृष्णः द्रौपद्यै अर्जुनस्य रक्षायै व्रतं उपदिष्टवान्, शिव-पार्वतीप्रसङ्गं च कथितवान्। प्राचीनकृषिकाले स्त्रीणां शस्यान्ते करकविनिमयप्रथा। निर्जलव्रतम् सूर्योदयात् चन्द्रोदयपर्यन्तम्, चलन्या चन्द्र-पति-दर्शनं, करकेण जलार्घ्यं, पतिहस्तेन पारणम् — सर्वं वीरवतीकथायाः अनुसरणम्।',
      mr: 'करवा चौथ — कार्तिक कृष्ण चतुर्थीला करव्याचा (छोट्या मातीच्या भांड्याचा) व्रत — उत्तर भारतातील विवाहित स्त्रिया आपल्या पतीच्या दीर्घायुष्यासाठी पाळतात.\n\nसर्वात प्रचलित कथा राणी वीरवतीची आहे. ती सात भावांची लाडकी बहीण, उच्च कुळात विवाहित, आणि नववधू म्हणून प्रथमच करवा चौथ पाळत होती. माहेरी होती. निर्जला व्रताच्या दीर्घ दिवशी ती भुकेने व तहानेने व्याकुळ झाली. भावांनी बहिणीचे दुःख सहन न होऊन एक भाऊ डोंगरावरील पिंपळावर चढून चाळणीमागे दिवा लावला; अंगणातून तो चंद्रोदयासारखाच दिसला. त्यांनी बहिणीला छतावर नेले, खोटा चंद्र दाखवला, व्रत सोडण्यास भाग पाडले. वीरवतीने खाल्ले; त्याच क्षणी तिचा पती दूर दरबारात कोसळून मेला — चंद्रोदयापूर्वी व्रत मोडल्यामुळे.\n\nराणी देश ओलांडून पतिघरी धावत गेली, पतीला मेलेले पाहिले, देह सोडला नाही. एक वर्षभर — प्रत्येक संकष्टी, प्रत्येक चतुर्थी — कठोर व्रत पाळले. पुन्हा करवा चौथ आला तेव्हा संपूर्ण अनुष्ठानाने पाळला, स्वतः चंद्रदर्शन घेऊन पारण केले. पार्वती प्रकट होऊन वर दिला; पती परत आला. यातून चंद्रोदयापूर्वी व्रत मोडू नये हा अटल नियम झाला.\n\nदुसरी कथा महाभारतातून. अर्जुन इंद्रकील पर्वतावर तपस्या करत होता; द्रौपदीने कृष्णाला उपाय विचारला; कृष्णाने करवा चौथचे व्रत सुचवले व शिव-पार्वतीचा प्रसंग सांगितला — पार्वतीने एकदा शिवांना विचारले, "स्त्रियांत सर्वाधिक भाग्यवती कोण?" शिव म्हणाले, "जी करव्याचे व्रत पाळते."\n\nतिसरी थर शेती-कालाची. करवा चौथ खरीप पिकाच्या शेवटी येतो; स्त्रिया माहेरी जात असत आणि करवा — छोटे मातीचे भांडे — धान्य, मिठाई, बांगड्या यांनी भरून बहीण-तुल्य स्त्रियांत वाटले जात असे.\n\nआजचा अनुष्ठान तिन्ही धागे एकत्र धारण करतो. दिवसभरचे निर्जला व्रत, सकाळची सरगी, दुपारची स्त्री-सभा, संध्याकाळी चाळणीतून चंद्रदर्शन व पतीदर्शन, करव्यातून अर्घ्य, पतीच्या हातून पारण — सर्व वीरवतीच्या कथेचा पुनरुच्चार.',
      mai: 'करवा चौथ — कार्तिक कृष्ण चतुर्थी कें करवा (छोट माटि कें पात्र) कें व्रत — उत्तर भारत कें विवाहित स्त्री अपन पति कें दीर्घायु कें लेल राखैत छथि।\n\nसबसँ प्रचलित कथा रानी वीरवती कें अछि। ओ सात भाइ कें प्रिय बहीन छलथि, उच्च कुल मे विवाहित, आ नवविवाहिता रूप मे पहिल बेर करवा चौथ राखि रहल छलथि। मायके मे छलथि। निर्जला व्रत कें लम्बा दिन मे ओ क्षुधा-तृषा सँ व्याकुल भय गेलथि। भाइ बहीन कें कष्ट सहि नहि सकलाह; एक भाइ पीपल वृक्ष पर चढ़ि कय चलनी कें पाछाँ दीप राखलक, जे चन्द्रोदय जकाँ देखाओल पड़ल। बहीन कें छत पर लय जा कय मिथ्या चन्द्र देखा कय व्रत तोड़य कें लेल मनाओलनि। वीरवती भोजन कयलथि; ओही क्षण हुनकर पति दूर दरबार मे गिरि कय मरि गेलाह।\n\nरानी पतिघर दौड़ि कय गेलि, देह नहि छोड़लनि। एक साल पूर्ण कठोरता सँ व्रत राखलनि, फेर करवा चौथ अबय पर पूर्ण अनुष्ठान सँ राखलनि, स्वयं चन्द्र-दर्शन कयलनि, करवा सँ जल अर्पित कयलनि। पार्वती वर देलखिन्ह; पति जागलाह।\n\nदोसर कथा महाभारत सँ — अर्जुन कें तपस्या समय द्रौपदी कें कृष्ण करवा चौथ कें व्रत बतेलनि।\n\nतेसर परत कृषि-कालिक — करवा कें अनाज, मिठाइ, चूड़ी सँ भरि कय बहीन-तुल्य स्त्री कें बीच विनिमय।\n\nआइ कें अनुष्ठान सब धागा एक संग धारण करैत अछि — सूर्योदय सँ चन्द्रोदय तक निर्जला व्रत, प्रातः कें सरगी, सन्ध्या मे चलनी सँ चन्द्र-दर्शन आ पति-दर्शन, करवा सँ अर्घ्य, पति कें हाथ सँ पारण।',
    },
    observance: {
      en: 'Rise before dawn for sargi (pre-sunrise meal sent by the mother-in-law: fenugreek-laced sweets, mathri, kheer, fruits, dry fruits — enough to last the day). Bathe, dress in shringar (red sari, full bridal ornaments, fresh sindoor and mehendi). Observe the fast strictly nirjala — no food, no water — from sunrise until moonrise. Mid-afternoon, gather with other married women for the Karva Chauth katha; pass the karva-thali in a circle while listening to the story of Veervati, Draupadi, or the Shiva-Parvati prasanga. In the evening, when the moon rises, view it through a sieve (chalni), then view the husband through the same sieve, offer water (arghya) to the moon, and accept the first sip and bite of food from the husband\'s hand.',
      hi: 'सूर्योदय से पूर्व उठ कर सरगी (सासू-माता द्वारा भेजा गया प्रातः-भोजन: मेथी-युक्त मिठाई, मठरी, खीर, फल, मेवे — दिन भर का संचय)। स्नान, श्रृङ्गार (लाल साड़ी, पूर्ण आभूषण, ताज़ा सिन्दूर और मेंहदी)। सूर्योदय से चन्द्रोदय तक कठोर निर्जला व्रत — न अन्न न जल। दोपहर में विवाहित स्त्रियों के साथ करवा चौथ कथा का श्रवण; करवा-थाली एक वृत्त में सरकाते हुए वीरवती, द्रौपदी, या शिव-पार्वती प्रसङ्ग की कथा सुनी जाती है। सन्ध्या में चन्द्रोदय पर चलनी से चन्द्र-दर्शन, उसी चलनी से पति-दर्शन, चन्द्र को अर्घ्य, पति के हाथ से प्रथम जल और प्रथम ग्रास।',
      sa: 'सूर्योदयात् पूर्वं सर्गिभोजनम्। स्नानम्, श्रृङ्गारः (रक्तवस्त्रं, सिन्दूरं, मेहन्दी)। सूर्योदयात् चन्द्रोदयपर्यन्तं निर्जलव्रतम्। मध्याह्ने स्त्रीभिः सह कथाश्रवणम्। सायं चलन्या चन्द्रदर्शनं पतिदर्शनं च, चन्द्राय अर्घ्यदानम्, पतिहस्तेन पारणम्।',
      mr: 'सूर्योदयापूर्वी उठून सरगी (सासूकडून पाठवलेला प्रातः-भोजन: मेथी-युक्त मिठाई, मठरी, खीर, फळे, सुकामेवा — दिवसभरासाठी). स्नान, शृंगार (लाल साडी, संपूर्ण आभूषणे, ताजे सिंदूर व मेहंदी). सूर्योदयापासून चंद्रोदयापर्यंत कठोर निर्जला व्रत. दुपारी विवाहित स्त्रियांसोबत करवा चौथ कथेचे श्रवण. संध्याकाळी चंद्रोदयाला चाळणीतून चंद्रदर्शन, त्याच चाळणीतून पतीदर्शन, चंद्राला अर्घ्य, पतीच्या हातून पारण.',
      mai: 'सूर्योदय सँ पहिने उठि कय सरगी (सासु सँ पठाओल प्रातः भोजन)। स्नान, श्रृङ्गार (लाल साड़ी, सिन्दूर, मेहन्दी)। सूर्योदय सँ चन्द्रोदय तक कठोर निर्जला व्रत। दुपहर मे विवाहित स्त्री कें संग कथा-श्रवण। सन्ध्या मे चन्द्रोदय पर चलनी सँ चन्द्र-दर्शन, ओही चलनी सँ पति-दर्शन, चन्द्र कें अर्घ्य, पति कें हाथ सँ पारण।',
    },
    significance: {
      en: 'A woman\'s vrat for the long life and well-being of her husband, observed across north India on Kartika Krishna Chaturthi. The strict day-long nirjala fast — from sunrise until moonrise — is among the most demanding vrats in the Hindu calendar. The collective observance binds married women into a sisterhood across the day; the ritual of sighting the moon and then the husband through the sieve enacts a precise gesture — that the moon\'s grace will pass through the same opening that frames the husband\'s face.',
      hi: 'विवाहित स्त्रियाँ अपने पति की दीर्घायु और कल्याण के लिए कार्तिक कृष्ण चतुर्थी पर रखती हैं। दिन-भर का कठोर निर्जला व्रत — सूर्योदय से चन्द्रोदय तक — हिन्दू पञ्चाङ्ग के सबसे कठिन व्रतों में है। सामूहिक आचरण विवाहित स्त्रियों को दिन भर एक बहन-मण्डल में बाँधता है; चलनी से चन्द्र और फिर पति का दर्शन एक सूक्ष्म मुद्रा है — कि चन्द्र की कृपा उसी छिद्र से उतरे जो पति के मुख को आकार दे रहा है।',
      sa: 'विवाहितानां स्त्रीणां पत्युः दीर्घायुषे आचर्यते। निर्जलव्रतम् सूर्योदयात् चन्द्रोदयपर्यन्तम्। चलन्या चन्द्र-पति-दर्शनम् सूक्ष्ममुद्रा — चन्द्रकृपायाः पत्युः मुखोपरि अवतरणम्।',
      mr: 'विवाहित स्त्रिया आपल्या पतीच्या दीर्घायुष्य व कल्याणासाठी पाळतात. दिवसभरचे कठोर निर्जला व्रत. चाळणीतून चंद्र व पतीदर्शन ही सूक्ष्म मुद्रा — चंद्राच्या कृपेने पतीच्या चेहऱ्यावर उतरण्याची.',
      mai: 'विवाहित स्त्री अपन पति कें दीर्घायु आ कल्याण कें लेल कार्तिक कृष्ण चतुर्थी कें राखैत छथि। दिन-भर कें कठोर निर्जला व्रत। चलनी सँ चन्द्र आ पति कें दर्शन।',
    },
    deity: { en: 'Karva Mata (Goddess Parvati) / Lord Shiva / Lord Ganesha', hi: 'करवा माता (देवी पार्वती) / भगवान शिव / भगवान गणेश', sa: 'करवामाता (पार्वती) / शिवः / गणेशः', ta: 'கர்வா மாதா (பார்வதி) / சிவன் / விநாயகர்', te: 'కర్వా మాత (పార్వతి) / శివుడు / గణేశుడు', bn: 'করবা মাতা (পার্বতী) / শিব / গণেশ', kn: 'ಕರ್ವಾ ಮಾತಾ (ಪಾರ್ವತಿ) / ಶಿವ / ಗಣೇಶ', gu: 'કરવા માતા (પાર્વતી) / શિવ / ગણેશ', mr: 'करवा माता (पार्वती) / शिव / गणेश', mai: 'करवा माता (पार्वती) / शिव / गणेश' },
    isFast: true,
    fastNote: { en: 'Strict nirjala (waterless) fast from sunrise to moonrise. Break only after sighting the moon through a sieve and then the husband. Pre-dawn sargi sustains the day; first food and water taken from the husband\'s hand.', hi: 'सूर्योदय से चन्द्रोदय तक कठोर निर्जला व्रत। चलनी से चन्द्र-दर्शन और पति-दर्शन के पश्चात् ही पारण। प्रातः की सरगी दिन को सहारा देती है; प्रथम जल और भोजन पति के हाथ से।', sa: 'सूर्योदयात् चन्द्रोदयपर्यन्तं निर्जलव्रतम्। चलन्या चन्द्र-पति-दर्शनानन्तरं पतिहस्तेन पारणम्।', mr: 'सूर्योदयापासून चंद्रोदयापर्यंत कठोर निर्जला व्रत. चाळणीतून चंद्र व पतीदर्शनानंतरच पारण. पतीच्या हातून प्रथम जल व अन्न.', mai: 'सूर्योदय सँ चन्द्रोदय तक कठोर निर्जला व्रत। चलनी सँ चन्द्र आ पति कें दर्शन कें बाद पारण।' },
    observationRule: { en: 'Pradosh / Moonrise Rule: Observed on the day when the Chaturthi tithi prevails in the evening (Pradosh Kaal) so that the moon can be sighted under the Chaturthi tithi. The fast ends only after the actual moon is sighted at the given location — moon-sighting time therefore varies by city and is critical to the vrat.', hi: 'प्रदोष / चन्द्रोदय नियम: जिस दिन चतुर्थी तिथि सन्ध्या (प्रदोष काल) में व्याप्त हो ताकि चतुर्थी तिथि में चन्द्र-दर्शन सम्भव हो। व्रत वास्तविक चन्द्रोदय के बाद ही पारणीय — इसलिए चन्द्रोदय-समय नगर-वार भिन्न होता है और व्रत की कुंजी है।' },
  },
  ...
  'bhai-dooj': {
    ...
    deity: { en: 'Yama, Yamuna', hi: 'यमराज, यमुना', sa: 'यमः, यमुना', ta: 'யமன், யமுனா', te: 'యముడు, யమున', bn: 'যম, যমুনা', kn: 'ಯಮ, ಯಮುನಾ', gu: 'યમ, યમુના', mr: 'यमराज, यमुना', mai: 'यमराज, यमुना' },
  },

  'chhath-puja': {
    name: { en: 'Chhath Puja', hi: 'छठ पूजा', sa: 'षष्ठीपूजा', ta: 'சத் பூஜை', te: 'ఛఠ్ పూజ', bn: 'ছট পূজা', kn: 'ಛಠ್ ಪೂಜೆ', gu: 'છઠ પૂજા', mr: 'छठ पूजा', mai: 'छठ पूजा' },
    mythology: {
      en: 'Chhath is dedicated to Surya (the Sun God) and Chhathi Maiya (Usha, the goddess of dawn). In the Mahabharata, Draupadi and the Pandavas observed this vrat for regaining their lost kingdom. Karna, the son of Surya, was also a devoted worshipper of the Sun and performed rituals standing in water, which mirrors the Chhath tradition.',
      hi: 'छठ सूर्य देव और छठी मैया (उषा, प्रभात की देवी) को समर्पित है। महाभारत में द्रौपदी और पाण्डवों ने अपना खोया राज्य पुनः प्राप्त करने के लिए यह व्रत रखा। सूर्यपुत्र कर्ण भी जल में खड़े होकर सूर्य की उपासना करते थे, जो छठ परम्परा का प्रतिबिम्ब है।',
      sa: 'छठपूजा सूर्यदेवाय छठीमातायै (उषायै) च समर्पिता। महाभारते द्रौपदी पाण्डवाश्च स्वराज्यप्राप्त्यर्थम् इदं व्रतम् अकुर्वन्।',
      mr: 'छठ सूर्य देव और छठी मैया (उषा, प्रभात की देवी) को समर्पित है। महाभारत में द्रौपदी और पाण्डवों ने अपना खोया राज्य पुनः प्राप्त करने के लिए यह व्रत रखा। सूर्यपुत्र कर्ण भी जल में खड़े होकर सूर्य की उपासना करते थे, जो छठ परम्परा का प्रतिबिम्ब है।',
    ...
    significance: {
      ...
      mai: 'छठ एकमात्र वैदिक उत्सव अछि जे सूर्य कऽ जीवनदायी शक्ति कऽ उपासना केँ समर्पित अछि। ई बिहार, झारखण्ड आ पूर्वी उत्तर प्रदेश कऽ सबसँ महत्वपूर्ण त्योहार अछि।',
    },
  ...
  'tulsi-vivah': {
    name: { en: 'Tulsi Vivah', hi: 'तुलसी विवाह', sa: 'तुलसीविवाहः', ta: 'துளசி விவாஹ்', te: 'తులసీ వివాహం', bn: 'তুলসী বিবাহ', kn: 'ತುಳಸಿ ವಿವಾಹ', gu: 'તુલસી વિવાહ', mr: 'तुलसी विवाह', mai: 'तुलसी विवाह' },
    mythology: {
      en: 'Tulsi (Holy Basil) was originally Vrinda, a devoted wife of the demon Jalandhara. When Vishnu used deception to break Jalandhara\'s invincibility, Vrinda cursed Vishnu to become a stone (Shaligrama). Vishnu blessed her to be reborn as the sacred Tulsi plant and promised to marry her in that form every year on Kartika Shukla Dwadashi.',
      hi: 'तुलसी मूलतः वृन्दा थीं, दैत्य जलन्धर की पतिव्रता पत्नी। विष्णु ने जलन्धर की अजेयता तोड़ने के लिए छल किया, वृन्दा ने विष्णु को पत्थर (शालिग्राम) बनने का शाप दिया। विष्णु ने उन्हें पवित्र तुलसी के रूप में पुनर्जन्म का वरदान दिया और प्रतिवर्ष कार्तिक शुक्ल द्वादशी को विवाह का वचन दिया।',
      sa: 'तुलसी मूलतः वृन्दा आसीत्, जलन्धरदैत्यस्य पतिव्रता पत्नी। विष्णुः वृन्दां तुलसीरूपेण पुनर्जन्मवरदानम् अददात्।',
      mr: 'तुलसी मूलतः वृन्दा थीं, दैत्य जलन्धर की पतिव्रता पत्नी। विष्णु ने जलन्धर की अजेयता तोड़ने के लिए छल किया, वृन्दा ने विष्णु को पत्थर (शालिग्राम) बनने का शाप दिया। विष्णु ने उन्हें पवित्र तुलसी के रूप में पुनर्जन्म का वरदान दिया और प्रतिवर्ष कार्तिक शुक्ल द्वादशी को विवाह का वचन दिया।',
      mai: 'तुलसी मूलतः वृन्दा थीं, दैत्य जलन्धर की पतिव्रता पत्नी। विष्णु ने जलन्धर की अजेयता तोड़ने के लिए छल किया, वृन्दा ने विष्णु को पत्थर (शालिग्राम) बनने का शाप दिया। विष्णु ने उन्हें पवित्र तुलसी के रूप में पुनर्जन्म का वरदान दिया और प्रतिवर्ष कार्तिक शुक्ल द्वादशी को विवाह का वचन दिया।',
    },
    observance: {
      en: 'A Tulsi plant is ceremonially married to a Shaligrama stone or an idol of Lord Vishnu/Krishna. The plant is decorated like a bride with a sari, flowers, and jewellery. A mandap (canopy) of sugarcane is erected. Mantras are chanted and all wedding rituals are performed. This marks the end of Chaturmas and the beginning of the Hindu wedding season.',
      hi: 'तुलसी के पौधे का शालिग्राम या विष्णु/कृष्ण की मूर्ति से विधिवत विवाह कराया जाता है। तुलसी को दुल्हन की तरह साड़ी, फूल और गहनों से सजाया जाता है। गन्ने का मण्डप बनाया जाता है। मन्त्रोच्चारण और सभी विवाह संस्कार किये जाते हैं। यह चातुर्मास का अन्त और हिन्दू विवाह मौसम का आरम्भ है।',
      sa: 'तुलसीं शालिग्रामेण विष्णुमूर्त्या वा विधिवत् विवाहयन्ति। चातुर्मासस्य अन्तः विवाहकालस्य च आरम्भः।',
      mr: 'तुलसी के पौधे का शालिग्राम या विष्णु/कृष्ण की मूर्ति से विधिवत विवाह कराया जाता है। तुलसी को दुल्हन की तरह साड़ी, फूल और गहनों से सजाया जाता है। गन्ने का मण्डप बनाया जाता है। मन्त्रोच्चारण और सभी विवाह संस्कार किये जाते हैं। यह चातुर्मास का अन्त और हिन्दू विवाह मौसम का आरम्भ है।',
      mai: 'तुलसी के पौधे का शालिग्राम या विष्णु/कृष्ण की मूर्ति से विधिवत विवाह कराया जाता है। तुलसी को दुल्हन की तरह साड़ी, फूल और गहनों से सजाया जाता है। गन्ने का मण्डप बनाया जाता है। मन्त्रोच्चारण और सभी विवाह संस्कार किये जाते हैं। यह चातुर्मास का अन्त और हिन्दू विवाह मौसम का आरम्भ है।',
    },
    significance: {
      en: 'Tulsi Vivah marks the end of the four-month Chaturmas period and signals the resumption of Hindu marriages and auspicious ceremonies. It symbolizes the eternal bond between Tulsi (devotion) and Vishnu (the divine), and is considered highly meritorious.',
      hi: 'तुलसी विवाह चार माह के चातुर्मास काल का अन्त और हिन्दू विवाह तथा शुभ कार्यों के पुनः आरम्भ का संकेत है। यह तुलसी (भक्ति) और विष्णु (दिव्यता) के शाश्वत बन्धन का प्रतीक है।',
      sa: 'तुलसीविवाहः चातुर्मासकालस्य अन्तं सूचयति। विवाहशुभकार्याणां पुनरारम्भः। तुलस्याः विष्णोश्च शाश्वतबन्धनस्य प्रतीकः।',
      mr: 'तुलसी विवाह चार माह के चातुर्मास काल का अन्त और हिन्दू विवाह तथा शुभ कार्यों के पुनः आरम्भ का संकेत है। यह तुलसी (भक्ति) और विष्णु (दिव्यता) के शाश्वत बन्धन का प्रतीक है।',
      mai: 'तुलसी विवाह चार माह के चातुर्मास काल का अन्त और हिन्दू विवाह तथा शुभ कार्यों के पुनः आरम्भ का संकेत है। यह तुलसी (भक्ति) और विष्णु (दिव्यता) के शाश्वत बन्धन का प्रतीक है।',
    },
    deity: { en: 'Lord Vishnu (Krishna), Tulsi (Vrinda)', hi: 'भगवान विष्णु (कृष्ण), तुलसी (वृन्दा)', sa: 'विष्णुः (कृष्णः), तुलसी (वृन्दा)', ta: 'விஷ்ணு (கிருஷ்ணர்), துளசி (விருந்தா)', te: 'విష్ణువు (కృష్ణుడు), తులసి (వృందా)', bn: 'বিষ্ণু (কৃষ্ণ), তুলসী (বৃন্দা)', kn: 'ವಿಷ್ಣು (ಕೃಷ್ಣ), ತುಳಸಿ (ವೃಂದಾ)', gu: 'વિષ્ણુ (કૃષ્ણ), તુલસી (વૃન્દા)', mr: 'भगवान विष्णु (कृष्ण), तुलसी (वृन्दा)', mai: 'भगवान विष्णु (कृष्ण), तुलसी (वृन्दा)' },
  },
