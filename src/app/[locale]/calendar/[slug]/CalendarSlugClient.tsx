...
export default function CalendarSlugClient() {
    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center px-4">
        <motion.div {...fadeInUp} className="text-center max-w-md">
          ...
          {/* Notfound title is h2 to avoid duplicating the page h1 which is
              server-rendered with the requested slug name in page.tsx. */}
          ...
          <motion.div {...fadeInUp}>
            ...
            <div className="flex items-start gap-4">
              <div className="flex-1">
                {/* H1 with the festival / category name is server-rendered
                    in page.tsx so Bingbot sees it in the initial HTML.
                    Removed here to avoid duplicate headings. */}
