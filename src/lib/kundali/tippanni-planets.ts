...
export const DIGNITY_EFFECTS: Record<string, LocaleText> = {
  exalted: {
...
export const DASHA_EFFECTS: Record<string, LocaleText> = {
  Sun: {
...
export const PLANET_REMEDIES: Record<number, { gemstone: LocaleText; mantra: LocaleText; practice: { en: string; hi: string; day: string } }> = {
  0: { gemstone: { en: 'Ruby (Manikya)', hi: 'माणिक्य', sa: 'माणिक्य', mai: 'माणिक्य', mr: 'माणिक्य', ta: 'Ruby (Manikya)', te: 'Ruby (Manikya)', bn: 'Ruby (Manikya)', kn: 'Ruby (Manikya)', gu: 'Ruby (Manikya)' }, mantra: { en: 'Om Suryaya Namah (108 times)', hi: 'ॐ सूर्याय नमः (108 बार)', sa: 'ॐ सूर्याय नमः (108 बार)', mai: 'ॐ सूर्याय नमः (108 बार)', mr: 'ॐ सूर्याय नमः (108 बार)', ta: 'Om Suryaya Namah (108 times)', te: 'Om Suryaya Namah (108 times)', bn: 'Om Suryaya Namah (108 times)', kn: 'Om Suryaya Namah (108 times)', gu: 'Om Suryaya Namah (108 times)' }, practice: { en: 'Offer water to Sun at sunrise. Donate wheat on Sundays.', hi: 'सूर्योदय पर सूर्य को जल अर्पण करें। रविवार को गेहूँ दान करें।', day: 'Sunday' } },
  1: { gemstone: { en: 'Pearl (Moti)', hi: 'मोती', sa: 'मोती', mai: 'मोती', mr: 'मोती', ta: 'Pearl (Moti)', te: 'Pearl (Moti)', bn: 'Pearl (Moti)', kn: 'Pearl (Moti)', gu: 'Pearl (Moti)' }, mantra: { en: 'Om Chandraya Namah (108 times)', hi: 'ॐ चन्द्राय नमः (108 बार)', sa: 'ॐ चन्द्राय नमः (108 बार)', mai: 'ॐ चन्द्राय नमः (108 बार)', mr: 'ॐ चन्द्राय नमः (108 बार)', ta: 'Om Chandraya Namah (108 times)', te: 'Om Chandraya Namah (108 times)', bn: 'Om Chandraya Namah (108 times)', kn: 'Om Chandraya Namah (108 times)', gu: 'Om Chandraya Namah (108 times)' }, practice: { en: 'Offer milk to Shivalinga on Mondays. Donate rice.', hi: 'सोमवार को शिवलिंग पर दूध अर्पित करें। चावल दान करें।', day: 'Monday' } },
  2: { gemstone: { en: 'Red Coral (Moonga)', hi: 'मूँगा', sa: 'मूँगा', mai: 'मूँगा', mr: 'मूँगा', ta: 'Red Coral (Moonga)', te: 'Red Coral (Moonga)', bn: 'Red Coral (Moonga)', kn: 'Red Coral (Moonga)', gu: 'Red Coral (Moonga)' }, mantra: { en: 'Om Mangalaya Namah (108 times)', hi: 'ॐ मङ्गलाय नमः (108 बार)', sa: 'ॐ मङ्गलाय नमः (108 बार)', mai: 'ॐ मङ्गलाय नमः (108 बार)', mr: 'ॐ मङ्गलाय नमः (108 बार)', ta: 'Om Mangalaya Namah (108 times)', te: 'Om Mangalaya Namah (108 times)', bn: 'Om Mangalaya Namah (108 times)', kn: 'Om Mangalaya Namah (108 times)', gu: 'Om Mangalaya Namah (108 times)' }, practice: { en: 'Offer red flowers to Hanuman on Tuesdays. Donate red lentils.', hi: 'मंगलवार को हनुमान जी को लाल फूल अर्पित करें। मसूर दाल दान करें।', day: 'Tuesday' } },
  3: { gemstone: { en: 'Emerald (Panna)', hi: 'पन्ना', sa: 'पन्ना', mai: 'पन्ना', mr: 'पन्ना', ta: 'Emerald (Panna)', te: 'Emerald (Panna)', bn: 'Emerald (Panna)', kn: 'Emerald (Panna)', gu: 'Emerald (Panna)' }, mantra: { en: 'Om Budhaya Namah (108 times)', hi: 'ॐ बुधाय नमः (108 बार)', sa: 'ॐ बुधाय नमः (108 बार)', mai: 'ॐ बुधाय नमः (108 बार)', mr: 'ॐ बुधाय नमः (108 बार)', ta: 'Om Budhaya Namah (108 times)', te: 'Om Budhaya Namah (108 times)', bn: 'Om Budhaya Namah (108 times)', kn: 'Om Budhaya Namah (108 times)', gu: 'Om Budhaya Namah (108 times)' }, practice: { en: 'Donate green vegetables on Wednesdays. Feed green grass to cows.', hi: 'बुधवार को हरी सब्जियाँ दान करें। गाय को हरा चारा खिलाएँ।', day: 'Wednesday' } },
  4: { gemstone: { en: 'Yellow Sapphire (Pukhraj)', hi: 'पुखराज', sa: 'पुखराज', mai: 'पुखराज', mr: 'पुखराज', ta: 'Yellow Sapphire (Pukhraj)', te: 'Yellow Sapphire (Pukhraj)', bn: 'Yellow Sapphire (Pukhraj)', kn: 'Yellow Sapphire (Pukhraj)', gu: 'Yellow Sapphire (Pukhraj)' }, mantra: { en: 'Om Gurave Namah (108 times)', hi: 'ॐ गुरवे नमः (108 बार)', sa: 'ॐ गुरवे नमः (108 बार)', mai: 'ॐ गुरवे नमः (108 बार)', mr: 'ॐ गुरवे नमः (108 बार)', ta: 'Om Gurave Namah (108 times)', te: 'Om Gurave Namah (108 times)', bn: 'Om Gurave Namah (108 times)', kn: 'Om Gurave Namah (108 times)', gu: 'Om Gurave Namah (108 times)' }, practice: { en: 'Donate yellow cloth and turmeric on Thursdays. Respect teachers.', hi: 'गुरुवार को पीले वस्त्र और हल्दी दान करें। गुरुजनों का सम्मान करें।', day: 'Thursday' } },
  5: { gemstone: { en: 'Diamond (Heera)', hi: 'हीरा', sa: 'हीरा', mai: 'हीरा', mr: 'हीरा', ta: 'Diamond (Heera)', te: 'Diamond (Heera)', bn: 'Diamond (Heera)', kn: 'Diamond (Heera)', gu: 'Diamond (Heera)' }, mantra: { en: 'Om Shukraya Namah (108 times)', hi: 'ॐ शुक्राय नमः (108 बार)', sa: 'ॐ शुक्राय नमः (108 बार)', mai: 'ॐ शुक्राय नमः (108 बार)', mr: 'ॐ शुक्राय नमः (108 बार)', ta: 'Om Shukraya Namah (108 times)', te: 'Om Shukraya Namah (108 times)', bn: 'Om Shukraya Namah (108 times)', kn: 'Om Shukraya Namah (108 times)', gu: 'Om Shukraya Namah (108 times)' }, practice: { en: 'Donate white clothes and sugar on Fridays. Support arts and artists.', hi: 'शुक्रवार को सफेद वस्त्र और शक्कर दान करें। कला और कलाकारों का समर्थन करें।', day: 'Friday' } },
  6: { gemstone: { en: 'Blue Sapphire (Neelam)', hi: 'नीलम', sa: 'नीलम', mai: 'नीलम', mr: 'नीलम', ta: 'Blue Sapphire (Neelam)', te: 'Blue Sapphire (Neelam)', bn: 'Blue Sapphire (Neelam)', kn: 'Blue Sapphire (Neelam)', gu: 'Blue Sapphire (Neelam)' }, mantra: { en: 'Om Shanaischaraya Namah (108 times)', hi: 'ॐ शनैश्चराय नमः (108 बार)', sa: 'ॐ शनैश्चराय नमः (108 बार)', mai: 'ॐ शनैश्चराय नमः (108 बार)', mr: 'ॐ शनैश्चराय नमः (108 बार)', ta: 'Om Shanaischaraya Namah (108 times)', te: 'Om Shanaischaraya Namah (108 times)', bn: 'Om Shanaischaraya Namah (108 times)', kn: 'Om Shanaischaraya Namah (108 times)', gu: 'Om Shanaischaraya Namah (108 times)' }, practice: { en: 'Donate black sesame and oil on Saturdays. Serve the elderly and poor.', hi: 'शनिवार को काले तिल और तेल दान करें। बुजुर्गों और गरीबों की सेवा करें।', day: 'Saturday' } },
  7: { gemstone: { en: 'Hessonite Garnet (Gomed)', hi: 'गोमेद', sa: 'गोमेद', mai: 'गोमेद', mr: 'गोमेद', ta: 'Hessonite Garnet (Gomed)', te: 'Hessonite Garnet (Gomed)', bn: 'Hessonite Garnet (Gomed)', kn: 'Hessonite Garnet (Gomed)', gu: 'Hessonite Garnet (Gomed)' }, mantra: { en: 'Om Rahave Namah (108 times)', hi: 'ॐ राहवे नमः (108 बार)', sa: 'ॐ राहवे नमः (108 बार)', mai: 'ॐ राहवे नमः (108 बार)', mr: 'ॐ राहवे नमः (108 बार)', ta: 'Om Rahave Namah (108 times)', te: 'Om Rahave Namah (108 times)', bn: 'Om Rahave Namah (108 times)', kn: 'Om Rahave Namah (108 times)', gu: 'Om Rahave Namah (108 times)' }, practice: { en: 'Donate blue/black cloth on Saturdays. Feed birds. Avoid intoxicants.', hi: 'शनिवार को नीले/काले वस्त्र दान करें। पक्षियों को दाना डालें। नशे से बचें।', day: 'Saturday' } },
  8: { gemstone: { en: 'Cat\'s Eye (Lehsuniya)', hi: 'लहसुनिया' }, mantra: { en: 'Om Ketave Namah (108 times)', hi: 'ॐ केतवे नमः (108 बार)', sa: 'ॐ केतवे नमः (108 बार)', mai: 'ॐ केतवे नमः (108 बार)', mr: 'ॐ केतवे नमः (108 बार)', ta: 'Om Ketave Namah (108 times)', te: 'Om Ketave Namah (108 times)', bn: 'Om Ketave Namah (108 times)', kn: 'Om Ketave Namah (108 times)', gu: 'Om Ketave Namah (108 times)' }, practice: { en: 'Donate blankets to the needy. Feed stray dogs. Practice meditation regularly.', hi: 'जरूरतमन्दों को कम्बल दान करें। आवारा कुत्तों को खिलाएँ। नियमित ध्यान करें।', day: 'Tuesday' } },
};
