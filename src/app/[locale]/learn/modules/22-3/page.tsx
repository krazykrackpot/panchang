    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          {isHi ? 'चन्द्रमा सबसे कठिन पिण्ड क्यों है' : 'Why the Moon Is the Hardest Object to Track'}
        </h3>
...
function Page2() {
  ...
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          {isHi ? 'मीयस सारणी 47.A — 60 ज्या पद' : 'Meeus Table 47.A — The 60 Sine Terms'}
        </h3>
...
function Page3() {
  ...
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          {isHi ? 'अक्षांश, दूरी और सटीकता' : 'Latitude, Distance, and Accuracy'}
        </h3>
