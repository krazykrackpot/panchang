...
const ORBITAL_DATA: OrbitalRow[] = [
  ...
  { planet: { en: 'Mars', hi: 'मंगल', sa: 'मंगल', mai: 'मंगल', mr: 'मंगल', ta: 'செவ்வாய்', te: 'కుజుడు', bn: 'মঙ্গল', kn: 'ಮಂಗಳ', gu: 'મંગળ' }, sanskrit: 'Mangala', vedic: '686.997 d', modern: '686.971 d', error: '37 min', jyotish: { en: '~2-yr cycle, retrograde every 26 mo', hi: '~2 वर्ष चक्र, 26 माह में वक्री', sa: '~2 वर्ष चक्र, 26 माह में वक्री', mai: '~2 वर्ष चक्र, 26 माह में वक्री', mr: '~2 वर्ष चक्र, 26 माह में वक्री', ta: '~2-yr cycle, retrograde every 26 mo', te: '~2-yr cycle, retrograde every 26 mo', bn: '~2-yr cycle, retrograde every 26 mo', kn: '~2-yr cycle, retrograde every 26 mo', gu: '~2-yr cycle, retrograde every 26 mo' } },
...
const DASHA_DATA: DashaRow[] = [
  ...
  { planet: { en: 'Venus', hi: 'शुक्र', sa: 'शुक्र', mai: 'शुक्र', mr: 'शुक्र', ta: 'சுக்கிரன்', te: 'శుక్రుడు', bn: 'শুক্র', kn: 'ಶುಕ್ರ', gu: 'શુક્ર' }, years: 20, connection: { en: 'Venus synodic cycle = 584 d. 20 x 365 / 584 = 12.5 synodic returns', hi: 'शुक्र सिनोडिक = 584 दिन। 20 x 365 / 584 = 12.5 चक्र', sa: 'शुक्र सिनोडिक = 584 दिन। 20 x 365 / 584 = 12.5 चक्र', mai: 'शुक्र सिनोडिक = 584 दिन। 20 x 365 / 584 = 12.5 चक्र', mr: 'शुक्र सिनोडिक = 584 दिन। 20 x 365 / 584 = 12.5 चक्र', ta: 'Venus synodic cycle = 584 d. 20 x 365 / 584 = 12.5 synodic returns', te: 'Venus synodic cycle = 584 d. 20 x 365 / 584 = 12.5 synodic returns', bn: 'Venus synodic cycle = 584 d. 20 x 365 / 584 = 12.5 synodic returns', kn: 'Venus synodic cycle = 584 d. 20 x 365 / 584 = 12.5 synodic returns', gu: 'Venus synodic cycle = 584 d. 20 x 365 / 584 = 12.5 synodic returns' } },
  ...
  { planet: { en: 'Jupiter', hi: 'बृहस्पति', sa: 'बृहस्पति', mai: 'बृहस्पति', mr: 'बृहस्पति', ta: 'வியாழன்', te: 'గురువు', bn: 'বৃহস্পতি', kn: 'ಗುರು', gu: 'ગુરુ' }, years: 16, connection: { en: '~1.35 Jupiter orbits. Close to synodic period count', hi: '~1.35 बृहस्पति कक्षाएँ', sa: '~1.35 बृहस्पति कक्षाएँ', mai: '~1.35 बृहस्पति कक्षाएँ', mr: '~1.35 बृहस्पति कक्षाएँ', ta: '~1.35 Jupiter orbits. Close to synodic period count', te: '~1.35 Jupiter orbits. Close to synodic period count', bn: '~1.35 Jupiter orbits. Close to synodic period count', kn: '~1.35 Jupiter orbits. Close to synodic period count', gu: '~1.35 Jupiter orbits. Close to synodic period count' } },
