// src/lib/kundali/health-diagnosis/__tests__/elements/muscular.test.ts
//
// Task B8 — muscular element scorer tests.
//
...
import { scoreMuscular } from '../../elements/muscular';
...
const result = scoreMuscular(kundali, strength, signatures, 'en');

describe('scoreMuscular', () => {
  ...
  it('returns correct metadata matching ELEMENT_CATALOG[muscular]', () => {
    const meta = ELEMENT_CATALOG['muscular'];
    expect(result.id).toBe('muscular');
