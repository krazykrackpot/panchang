...
const HOW_TO_POINTS = [
  ...
  { point: { en: 'Map constitutional Sphutas to Nakshatras', hi: 'संवैधानिक स्फुटों को नक्षत्रों से मिलाएं', sa: 'संवैधानिक स्फुटों को नक्षत्रों से मिलाएं', mai: 'संवैधानिक स्फुटों को नक्षत्रों से मिलाएं', mr: 'संवैधानिक स्फुटों को नक्षत्रों से मिलाएं', ta: 'உடலமைப்பு ஸ்புடங்களை நட்சத்திரங்களுடன் பொருத்தவும்', te: 'రాజ్యాంగ స్ఫుటాలను నక్షత్రాలకు అనుసంధానించండి', bn: 'সাংবিধানিক স্ফুটগুলি নক্ষত্রে মানচিত্র করুন', kn: 'ಸಂವಿಧಾನಿಕ ಸ್ಫುಟಗಳನ್ನು ನಕ್ಷತ್ರಗಳಿಗೆ ನಕ್ಷೆ ಮಾಡಿ', gu: 'બંધારણીય સ્ફુટોને નક્ષત્રો સાથે મેળવો' }, detail: { en: 'Each Sphuta falls in a Nakshatra. The Nakshatra lord becomes the governing planet for that life dimension. Strengthen it if weak.', hi: 'प्रत्येक स्फुट एक नक्षत्र में पड़ता है। नक्षत्र स्वामी उस जीवन आयाम का शासक ग्रह बन जाता है। यदि कमजोर है तो बलवान करें।', sa: 'प्रत्येक स्फुट एक नक्षत्र में पड़ता है। नक्षत्र स्वामी उस जीवन आयाम का शासक ग्रह बन जाता है। यदि कमजोर है तो बलवान करें।', mai: 'प्रत्येक स्फुट एक नक्षत्र में पड़ता है। नक्षत्र स्वामी उस जीवन आयाम का शासक ग्रह बन जाता है। यदि कमजोर है तो बलवान करें।', mr: 'प्रत्येक स्फुट एक नक्षत्र में पड़ता है। नक्षत्र स्वामी उस जीवन आयाम का शासक ग्रह बन जाता है। यदि कमजोर है तो बलवान करें।', ta: 'Each Sphuta falls in a Nakshatra. The Nakshatra lord becomes the governing planet for that life dimension. Strengthen it if weak.', te: 'Each Sphuta falls in a Nakshatra. The Nakshatra lord becomes the governing planet for that life dimension. Strengthen it if weak.', bn: 'Each Sphuta falls in a Nakshatra. The Nakshatra lord becomes the governing planet for that life dimension. Strengthen it if weak.', kn: 'Each Sphuta falls in a Nakshatra. The Nakshatra lord becomes the governing planet for that life dimension. Strengthen it if weak.', gu: 'Each Sphuta falls in a Nakshatra. The Nakshatra lord becomes the governing planet for that life dimension. Strengthen it if weak.' } },
