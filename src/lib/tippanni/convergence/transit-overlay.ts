...
const TRANSIT_HOUSE_EFFECTS: Record<number, { en: string; hi: string }> = {
  1: { en: 'Transiting your 1st house — affects health, self-image, and personal energy.', hi: 'प्रथम भाव में गोचर — स्वास्थ्य, आत्म-छवि और व्यक्तिगत ऊर्जा प्रभावित।' },
  2: { en: 'Transiting your 2nd house — affects finances, family, and speech.', hi: 'द्वितीय भाव में — वित्त, परिवार और वाणी प्रभावित।' },
  3: { en: 'Transiting your 3rd house — affects courage, siblings, and communication.', hi: 'तृतीय भाव में — साहस, भाई-बहन और संवाद प्रभावित।' },
  4: { en: 'Transiting your 4th house — affects home, mother, and emotional peace.', hi: 'चतुर्थ भाव में — घर, माता और मानसिक शांति प्रभावित।' },
  5: { en: 'Transiting your 5th house — affects children, romance, and creativity.', hi: 'पंचम भाव में — संतान, प्रेम और सृजनशीलता प्रभावित।' },
  6: { en: 'Transiting your 6th house — affects health, enemies, and debts.', hi: 'षष्ठ भाव में — स्वास्थ्य, शत्रु और ऋण प्रभावित।' },
  7: { en: 'Transiting your 7th house — affects marriage, partnerships, and contracts.', hi: 'सप्तम भाव में — विवाह, साझेदारी और अनुबंध प्रभावित।' },
  8: { en: 'Transiting your 8th house — affects longevity, hidden matters, and transformation.', hi: 'अष्टम भाव में — दीर्घायु, गुप्त मामले और परिवर्तन प्रभावित।' },
  9: { en: 'Transiting your 9th house — affects luck, father, and higher learning.', hi: 'नवम भाव में — भाग्य, पिता और उच्च शिक्षा प्रभावित।' },
  10: { en: 'Transiting your 10th house — affects career, reputation, and authority.', hi: 'दशम भाव में — करियर, प्रतिष्ठा और अधिकार प्रभावित।' },
  11: { en: 'Transiting your 11th house — affects gains, friends, and aspirations.', hi: 'एकादश भाव में — लाभ, मित्र और आकांक्षाएँ प्रभावित।' },
  12: { en: 'Transiting your 12th house — affects expenses, sleep, and foreign connections.', hi: 'द्वादश भाव में — व्यय, नींद और विदेशी संपर्क प्रभावित।' },
};
...
export function computeTransitOverlay(input: ConvergenceInput): {
  ...
  const retroStatus: { planetId: number; effect: { en: string; hi: string } }[] = [];
  const combustStatus: { planetId: number; effect: { en: string; hi: string } }[] = [];
