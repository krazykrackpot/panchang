  ...
  return (
    <div className="space-y-6">
      ...
      <section className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-xl p-5 border border-blue-500/15">
        ...
        <p className="text-text-secondary text-xs leading-relaxed">
          Our app defaults to the Lahiri ayanamsha (Chitrapaksha — Indian Government standard) for all calculations. The internal pipeline works as follows: Swiss Ephemeris computes tropical planetary longitudes (sub-arcsecond; Meeus is the documented fallback), then the Lahiri polynomial subtracts the ayanamsha to produce sidereal positions. For KP practitioners, the app&apos;s KP module uses the Krishnamurti ayanamsha with its own sub-lord tables. The difference between systems is purely in the constant offset  –  the underlying astronomical engine remains identical. When in doubt, use Lahiri: it has 70+ years of institutional backing, the largest corpus of validated predictions, and is what the Rashtriya Panchang uses.
        </p>
      </section>
    </div>
  );
