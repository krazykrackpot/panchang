...
export function computeParana(
  ...
  switch (rule.type) {
    ...
    case 'moonrise': {
      // TODO: Implement moonrise calculation for accurate parana timing.
      // Moonrise computation requires iterative lunar position solving
      // which is complex. For now, fall back to next_sunrise logic.
      return {
        start: sunrise,
        end: addHours(sunrise, 4),
        description: rule.description.en,
