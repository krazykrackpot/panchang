...
If you'd like to try it: the builder is at [dekhopanchang.com/widget](https://dekhopanchang.com/widget?utm_source=medium&utm_medium=article&utm_campaign=widget-launch). It's free, requires no signup, copy-paste in two minutes. If you run a temple, a diaspora community site, or a Hindu lifestyle blog, I'd like to hear from you.

---

*Code: `src/app/embed/*` in [dekhopanchang.com](https://dekhopanchang.com?utm_source=medium&utm_medium=article&utm_campaign=widget-launch). The `mr ≠ hi` test is in `src/app/embed/__tests__/embed-helpers.test.ts`.*
