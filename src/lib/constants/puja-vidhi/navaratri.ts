...
export const NAVARATRI_PUJA: PujaVidhi = {
  ...
  samagri: [
    { name: { en: 'Kalash (copper or brass pot)', hi: 'कलश (ताम्बे या पीतल का)', sa: 'कलशः (ताम्रः पीतलो वा)' }, quantity: '1' },
    { name: { en: 'Mango leaves', hi: 'आम के पत्ते', sa: 'आम्रपत्राणि' }, quantity: '5-7' },
    { name: { en: 'Whole coconut (with husk)', hi: 'पूरा नारियल (छिलके सहित)', sa: 'सम्पूर्णनारिकेलम् (सवल्कलम्)' }, quantity: '1' },
    { name: { en: 'Red cloth', hi: 'लाल कपड़ा', sa: 'रक्तवस्त्रम्' } },
    { name: { en: 'Durga idol or image', hi: 'दुर्गा मूर्ति या चित्र', sa: 'दुर्गामूर्तिः अथवा चित्रम्' } },
    { name: { en: 'Navdhanya (9 types of grains)', hi: 'नवधान्य (9 प्रकार के अनाज)', sa: 'नवधान्यानि' }, note: { en: 'Wheat, rice, moong, chana, urad, masoor, barley, sesame, jowar', hi: 'गेहूँ, चावल, मूँग, चना, उड़द, मसूर, जौ, तिल, ज्वार', sa: 'गोधूमः, तण्डुलः, मुद्गः, चणकः, माषः, मसूरः, यवः, तिलः, यावनालः' } },
    { name: { en: 'Akhand Jyoti lamp (with sufficient ghee/oil)', hi: 'अखण्ड ज्योति दीपक (पर्याप्त घी/तेल सहित)', sa: 'अखण्डज्योतिदीपः (पर्याप्तघृततैलयुक्तः)' }, quantity: '1' },
    { name: { en: 'Red flowers (hibiscus, rose)', hi: 'लाल फूल (गुड़हल, गुलाब)', sa: 'रक्तपुष्पाणि (जपाकुसुमम्, पाटलम्)' } },
    { name: { en: 'Kumkum (vermilion)', hi: 'कुमकुम (सिन्दूर)', sa: 'कुङ्कुमम्' } },
    { name: { en: 'Sindoor', hi: 'सिन्दूर', sa: 'सिन्दूरम्' } },
    { name: { en: 'Betel leaves', hi: 'पान के पत्ते', sa: 'ताम्बूलपत्राणि' }, quantity: '9' },
    { name: { en: 'Camphor', hi: 'कपूर', sa: 'कर्पूरम्' } },
    { name: { en: 'Ghee (for akhand jyoti and havan)', hi: 'घी (अखण्ड ज्योति और हवन के लिए)', sa: 'घृतम् (अखण्डज्योत्यर्थं हवनार्थं च)' } },
    { name: { en: 'Akshat (unbroken rice)', hi: 'अक्षत (साबुत चावल)', sa: 'अक्षताः' } },
    { name: { en: 'Incense sticks', hi: 'अगरबत्ती', sa: 'धूपम्' } },
    { name: { en: 'Barley seeds (for sowing in kalash)', hi: 'जौ के बीज (कलश में बोने के लिए)', sa: 'यवबीजानि (कलशे वपनार्थम्)' } },
    { name: { en: 'Havan samagri', hi: 'हवन सामग्री', sa: 'हवनसामग्री' } },
    { name: { en: 'Fruits and sweets for Kanya Pujan', hi: 'कन्या पूजन के लिए फल और मिठाई', sa: 'कन्यापूजनार्थं फलानि मिष्टान्नानि च' } },
  ],
