...
const META: ModuleMeta = {
  id: 'mod_5_1', phase: 2, topic: 'Nakshatra', moduleNumber: '5.1',
...
const QUESTIONS: ModuleQuestion[] = [
  { id: 'q5_1_01', type: 'mcq', question: { en: "Span?", hi: '' }, options: [{ en: "It only applies to Sun signs", hi: '' }, { en: "It is based on systematic astronomical observation", hi: '' }, { en: "It was invented in the 20th century", hi: '' }, { en: "It has no practical application", hi: '' }], correctAnswer: 1, explanation: { en: "360/27=13d20m", hi: '' } },
  { id: 'q5_1_02', type: 'true_false', question: { en: "This topic is covered in BPHS (Brihat Parashara Hora Shastra).", hi: '' }, correctAnswer: true, explanation: { en: "Correct. BPHS is the foundational text of Parashari Jyotish and covers virtually every topic in Vedic astrology.", hi: '' } },
