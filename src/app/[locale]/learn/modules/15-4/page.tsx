    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Varshaphal — The Solar Return Chart / वर्षफल — सौर प्रत्यावर्तन कुण्डली
        </h3>
      ...
      <section className="glass-card rounded-xl p-5 border border-gold-primary/10">
        <h4 className="text-gold-dark text-[10px] uppercase tracking-widest font-bold mb-2">Muntha & Varsheshvara / मुन्था एवं वर्षेश्वर</h4>
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">Sahams & Mudda Dasha / सहम एवं मुद्दा दशा</h4>
      ...
      <section className="glass-card rounded-xl p-5 border border-red-500/15">
        <h4 className="text-red-400 text-[10px] uppercase tracking-widest font-bold mb-3">Common Tajika Misconceptions / सामान्य ताजिक भ्रान्तियाँ</h4>
        <p className="text-text-secondary text-xs leading-relaxed">
...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          KP System — Krishnamurti Paddhati / के.पी. पद्धति — कृष्णमूर्ति पद्धति
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">The Sub Lord Decides / उप स्वामी निर्णय करता है</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
      ...
      <section className="glass-card rounded-xl p-5 border border-blue-500/15">
        <h4 className="text-blue-300 text-[10px] uppercase tracking-widest font-bold mb-3">Ruling Planets for Timing / समयनिर्धारण हेतु शासक ग्रह</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
