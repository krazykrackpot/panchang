...
export const MAKAR_SANKRANTI_PUJA: PujaVidhi = {
  ...
  samagri: [
    { name: { en: 'Til (sesame seeds — black and white)', hi: 'तिल (काले और सफेद)', sa: 'तिलाः (कृष्णाः शुक्लाः च)' } },
    { name: { en: 'Gur (jaggery)', hi: 'गुड़', sa: 'गुडम्' } },
    { name: { en: 'Khichdi ingredients (rice and urad dal)', hi: 'खिचड़ी सामग्री (चावल और उड़द दाल)', sa: 'खिच्चिकासामग्री (तण्डुलाः माषदालं च)' } },
    { name: { en: 'New pot for Arghya (copper or brass)', hi: 'अर्घ्य के लिए नया पात्र (ताम्बे या पीतल का)', sa: 'अर्घ्यार्थं नवपात्रम् (ताम्रं पीतलं वा)' }, quantity: '1' },
    { name: { en: 'Water (for Arghya)', hi: 'जल (अर्घ्य के लिए)', sa: 'जलम् (अर्घ्यार्थम्)' } },
    { name: { en: 'Red flowers (marigold, red lotus)', hi: 'लाल फूल (गेंदा, लाल कमल)', sa: 'रक्तपुष्पाणि (स्थलपद्मम्, रक्तकमलम्)' } },
    { name: { en: 'Akshat (unbroken rice)', hi: 'अक्षत (साबुत चावल)', sa: 'अक्षताः' } },
    { name: { en: 'Kumkum (vermilion)', hi: 'कुमकुम (सिन्दूर)', sa: 'कुङ्कुमम्' } },
    { name: { en: 'Fruits (sugarcane, banana, orange)', hi: 'फल (गन्ना, केला, संतरा)', sa: 'फलानि (इक्षुः, कदलीफलम्, नारङ्गम्)' } },
    { name: { en: 'Til-Gur laddoo (sesame-jaggery sweets)', hi: 'तिल-गुड़ के लड्डू', sa: 'तिलगुडमोदकानि' } },
    { name: { en: 'Warm clothes (for donation)', hi: 'गर्म कपड़े (दान के लिए)', sa: 'उष्णवस्त्राणि (दानार्थम्)' } },
