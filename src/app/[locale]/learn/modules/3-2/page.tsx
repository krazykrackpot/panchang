...
const META: ModuleMeta = {
  ...
  subtitle: { en: "Movable, Fixed, and Dual signs combined with Fire, Earth, Air, and Water create 12 unique energy patterns", hi: "चर, स्थिर और द्विस्वभाव राशियाँ अग्नि, पृथ्वी, वायु और जल के साथ मिलकर 12 अद्वितीय ऊर्जा प्रतिरूप बनाती हैं" },
  estimatedMinutes: 15,
  crossRefs: [
    { label: { en: 'Module 3-1: The 12 Signs', hi: 'मॉड्यूल 3-1: 12 राशियाँ' }, href: '/learn/modules/3-1' },
    { label: { en: 'Module 3-3: Sign Rulerships', hi: 'मॉड्यूल 3-3: राशि स्वामित्व' }, href: '/learn/modules/3-3' },
...
const QUESTIONS: ModuleQuestion[] = [
  {
    id: 'q3_2_01', type: 'mcq',
    question: { en: "Which signs are Movable (Chara)?", hi: "कौन सी राशियाँ चर (गतिशील) हैं?" },
    options: [
      { en: "Taurus, Leo, Scorpio, Aquarius", hi: "वृषभ, सिंह, वृश्चिक, कुम्भ" },
      { en: "Aries, Cancer, Libra, Capricorn", hi: "मेष, कर्क, तुला, मकर" },
      { en: "Gemini, Virgo, Sagittarius, Pisces", hi: "मिथुन, कन्या, धनु, मीन" },
      { en: "All fire signs", hi: "सभी अग्नि राशियाँ" },
    ],
    correctAnswer: 1,
    explanation: { en: "Movable signs are at the 4 cardinal points: 1st(Aries), 4th(Cancer), 7th(Libra), 10th(Capricorn). These correspond to the Kendras (angular houses).", hi: "चर राशियाँ 4 कार्डिनल बिन्दुओं पर हैं: 1(मेष), 4(कर्क), 7(तुला), 10(मकर)। ये केन्द्र भावों से मेल खाती हैं।" },
    classicalRef: "BPHS Ch.4 v.7",
  },
  {
    id: 'q3_2_02', type: 'mcq',
    question: { en: "What element is Aquarius?", hi: "कुम्भ राशि का तत्व क्या है?" },
    options: [
      { en: "Fire", hi: "अग्नि" },
      { en: "Earth", hi: "पृथ्वी" },
      { en: "Air", hi: "वायु" },
    ...
    correctAnswer: 2,
    explanation: { en: "Aquarius is an AIR sign despite the water-bearer imagery. Air signs: Gemini, Libra, Aquarius. The water-bearer represents distribution of knowledge, not the water element.", hi: "कुम्भ जल-वाहक चित्रण के बावजूद वायु राशि है। वायु राशियाँ: मिथुन, तुला, कुम्भ। जल-वाहक ज्ञान के वितरण का प्रतीक है, जल तत्व का नहीं।" },
  },
  {
    id: 'q3_2_03', type: 'true_false',
    question: { en: "Odd-numbered signs (1,3,5,7,9,11) are Male and Diurnal.", hi: "विषम-संख्या राशियाँ (1,3,5,7,9,11) पुरुष और दिवाचर हैं।" },
    correctAnswer: true,
    explanation: { en: "Correct. Odd = Male/Purusha/Day-strong. Even = Female/Stri/Night-strong. This alternating pattern creates balance in the zodiac.", hi: "सही। विषम = पुरुष/दिवा-बली। सम = स्त्री/रात्रि-बली। यह वैकल्पिक प्रतिरूप राशिचक्र में सन्तुलन बनाता है।" },
    classicalRef: "BPHS Ch.4",
  },
  {
    id: 'q3_2_04', type: 'mcq',
    question: { en: "Shirshodaya signs manifest events:", hi: "शीर्षोदय राशियाँ घटनाओं को प्रकट करती हैं:" },
    options: [
      { en: "Slowly", hi: "धीरे" },
      { en: "Quickly (head rises first)", hi: "शीघ्र (सिर पहले उदय होता है)" },
      { en: "Only at night", hi: "केवल रात में" },
      { en: "Never", hi: "कभी नहीं" },
    ],
    correctAnswer: 1,
    explanation: { en: "Shirshodaya = head-first rising. Events from these signs (Gemini, Leo, Virgo, Libra, Scorpio, Aquarius) manifest quickly. This is especially important in Prashna astrology.", hi: "शीर्षोदय = सिर-पहले उदय। इन राशियों (मिथुन, सिंह, कन्या, तुला, वृश्चिक, कुम्भ) की घटनाएँ शीघ्र प्रकट होती हैं।" },
  },
  {
    id: 'q3_2_05', type: 'mcq',
    question: { en: "3 Qualities × 4 Elements = ?", hi: "3 गुण × 4 तत्व = ?" },
    options: [
      { en: "8 combinations", hi: "8 संयोजन" },
      { en: "10 combinations", hi: "10 संयोजन" },
      { en: "12 unique combinations (= 12 signs)", hi: "12 अद्वितीय संयोजन (= 12 राशियाँ)" },
      { en: "16 combinations", hi: "16 संयोजन" },
    ],
    correctAnswer: 2,
    explanation: { en: "3 × 4 = 12 — each sign has a unique quality-element combination. This is NOT coincidental; it's the mathematical structure of the zodiac.", hi: "3 × 4 = 12 — प्रत्येक राशि का एक अद्वितीय गुण-तत्व संयोजन है। यह संयोग नहीं; यह राशिचक्र की गणितीय संरचना है।" },
  },
  {
    id: 'q3_2_06', type: 'true_false',
    question: { en: "Cancer is a Movable Water sign.", hi: "कर्क एक चर जल राशि है।" },
    correctAnswer: true,
    explanation: { en: "Correct. Cancer = Movable (initiates) + Water (emotion). It initiates emotional connections, home-building, and nurturing — all water-like actions with cardinal energy.", hi: "सही। कर्क = चर (आरम्भ करता है) + जल (भावना)। यह भावनात्मक सम्बन्ध, गृह-निर्माण और पोषण आरम्भ करता है।" },
  },
  {
    id: 'q3_2_07', type: 'mcq',
    question: { en: "Which house positions do the Fixed signs occupy?", hi: "स्थिर राशियाँ किन भाव स्थानों पर होती हैं?" },
    options: [
    ...
    correctAnswer: 1,
    explanation: { en: "Fixed signs = houses 2, 5, 8, 11 (Panaphara houses). Movable = 1,4,7,10 (Kendras). Dual = 3,6,9,12 (Apoklima).", hi: "स्थिर राशियाँ = भाव 2, 5, 8, 11 (पणफर भाव)। चर = 1,4,7,10 (केन्द्र)। द्वि = 3,6,9,12 (आपोक्लिम)।" },
  },
  {
    id: 'q3_2_08', type: 'mcq',
    question: { en: "A chart with most planets in Fire signs suggests a person who is:", hi: "अग्नि राशियों में अधिकांश ग्रहों वाली कुण्डली व्यक्ति को सुझाती है:" },
    options: [
      { en: "Emotionally sensitive and intuitive", hi: "भावनात्मक रूप से संवेदनशील और अन्तर्ज्ञानी" },
      { en: "Practical, methodical, and grounded", hi: "व्यावहारिक, व्यवस्थित और ज़मीन से जुड़ा" },
      { en: "Action-oriented, energetic, possibly aggressive", hi: "कर्म-उन्मुख, ऊर्जावान, सम्भवतः आक्रामक" },
      { en: "Intellectual, communicative, and detached", hi: "बौद्धिक, संवादशील और निर्लिप्त" },
    ],
    correctAnswer: 2,
    explanation: { en: "Fire (Agni) element = action, energy, initiative, leadership. Too much fire can manifest as aggression, impatience, or burnout. Fire signs: Aries, Leo, Sagittarius.", hi: "अग्नि तत्व = क्रिया, ऊर्जा, पहल, नेतृत्व। अत्यधिक अग्नि आक्रामकता या अधीरता के रूप में प्रकट हो सकती है।" },
  },
  {
    id: 'q3_2_09', type: 'mcq',
    question: { en: "Which element is associated with intellectual and communicative energy?", hi: "कौन सा तत्व बौद्धिक और संवादात्मक ऊर्जा से जुड़ा है?" },
    options: [
      { en: "Fire (Agni)", hi: "अग्नि" },
      { en: "Earth (Prithvi)", hi: "पृथ्वी" },
      { en: "Air (Vayu)", hi: "वायु" },
      { en: "Water (Jala)", hi: "जल" },
    ],
    correctAnswer: 2,
  ...
  },
  {
    ...
    question: { en: "Pisces is the only sign that rises both head-first and back-first (Ubhayodaya).", hi: "मीन एकमात्र राशि है जो सिर-पहले और पीठ-पहले दोनों तरह उदय होती है (उभयोदय)।" },
    correctAnswer: true,
    explanation: { en: "Correct. Pisces is Ubhayodaya — it can manifest events quickly or slowly depending on other factors. All other signs are either Shirshodaya (head-first, quick) or Prishtodaya (back-first, slow).", hi: "सही। मीन उभयोदय है — यह अन्य कारकों के आधार पर घटनाओं को शीघ्र या धीरे प्रकट कर सकती है।" },
  },
];
...
function Page2() {
  return (
    <div className="space-y-6">
      ...
      <section className="glass-card rounded-xl p-5 border border-gold-primary/10 mt-4">
