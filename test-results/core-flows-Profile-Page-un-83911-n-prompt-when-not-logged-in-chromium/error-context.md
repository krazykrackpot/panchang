...
- Name: core-flows.spec.ts >> Profile Page (unauthenticated) >> shows sign-in prompt when not logged in
- Location: e2e/core-flows.spec.ts:182:7
...
- generic [active] [ref=e1]:
  ...
  - main [ref=e53]:
    - generic [ref=e55]:
      - img [ref=e56]
      - paragraph [ref=e59]: Sign in to view your Vedic profile.
