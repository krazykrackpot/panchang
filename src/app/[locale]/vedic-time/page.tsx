...
const PRAHAR_NAMES: LocaleText[] = [
  { en: 'Pratah Kaal', hi: 'प्रातःकाल', sa: 'प्रातःकाल', mai: 'प्रातःकाल', mr: 'प्रातःकाल', ta: 'பிராதக்காலம்', te: 'ప్రాతఃకాలం', bn: 'প্রাতঃকাল', kn: 'ಪ್ರಾತಃಕಾಲ', gu: 'પ્રાતઃકાળ' },
  { en: 'Sangava Kaal', hi: 'सङ्गवकाल', sa: 'सङ्गवकाल', mai: 'सङ्गवकाल', mr: 'सङ्गवकाल', ta: 'சங்கவ காலம்', te: 'సంగవ కాలం', bn: 'সঙ্গব কাল', kn: 'ಸಂಗವ ಕಾಲ', gu: 'સંગવ કાળ' },
  { en: 'Madhyahna Kaal', hi: 'मध्याह्नकाल', sa: 'मध्याह्नकाल', mai: 'मध्याह्नकाल', mr: 'मध्याह्नकाल', ta: 'மத்யான்ன காலம்', te: 'మధ్యాహ్న కాలం', bn: 'মধ্যাহ্ন কাল', kn: 'ಮಧ್ಯಾಹ್ನ ಕಾಲ', gu: 'મધ્યાહ્ન કાળ' },
  { en: 'Aparahna Kaal', hi: 'अपराह्णकाल', sa: 'अपराह्णकाल', mai: 'अपराह्णकाल', mr: 'अपराह्णकाल', ta: 'அபராஹ்ண காலம்', te: 'అపరాహ్ణ కాలం', bn: 'অপরাহ্ণ কাল', kn: 'ಅಪರಾಹ್ಣ ಕಾಲ', gu: 'અપરાહ્ણ કાળ' },
  { en: 'Sayahna Kaal', hi: 'सायंकाल', sa: 'सायंकाल', mai: 'सायंकाल', mr: 'सायंकाल', ta: 'சாயங்காலம்', te: 'సాయంకాలం', bn: 'সায়াহ্ন কাল', kn: 'ಸಾಯಂಕಾಲ', gu: 'સાયંકાળ' },
  { en: 'Pradosha Kaal', hi: 'प्रदोषकाल', sa: 'प्रदोषकाल', mai: 'प्रदोषकाल', mr: 'प्रदोषकाल', ta: 'பிரதோஷ காலம்', te: 'ప్రదోష కాలం', bn: 'প্রদোষ কাল', kn: 'ಪ್ರದೋಷ ಕಾಲ', gu: 'પ્રદોષ કાળ' },
  { en: 'Nisha Kaal', hi: 'निशाकाल', sa: 'निशाकाल', mai: 'निशाकाल', mr: 'निशाकाल', ta: 'நிசா காலம்', te: 'నిశా కాలం', bn: 'নিশা কাল', kn: 'ನಿಶಾ ಕಾಲ', gu: 'નિશા કાળ' },
  { en: 'Usha Kaal', hi: 'ऊषाकाल', sa: 'ऊषाकाल', mai: 'ऊषाकाल', mr: 'ऊषाकाल', ta: 'உஷா காலம்', te: 'ఉషా కాలం', bn: 'ঊষা কাল', kn: 'ಉಷಾ ಕಾಲ', gu: 'ઉષા કાળ' },
];
