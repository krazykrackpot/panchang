...
const HOUSE_LIFE_EN: Record<number, { area: string; lahiri: string; concrete: string }> = {
  ...
  2: { area: 'wealth & family', lahiri: 'your earning capacity, family bonds, and how you communicate value', concrete: 'your relationship with money, your voice and speech patterns, and the warmth (or distance) in your immediate family' },
  3: { area: 'courage & effort', lahiri: 'your initiative, short travels, and relationship with siblings', concrete: 'whether you take bold risks or play it safe, how often you travel domestically, and the dynamic with your brothers and sisters' },
  4: { area: 'home & inner peace', lahiri: 'your emotional foundation, property, and bond with your mother', concrete: 'how settled you feel internally, your relationship with your home and hometown, and the role your mother plays in your emotional life' },
  5: { area: 'creativity & children', lahiri: 'your creative expression, romance, and relationship with children', concrete: 'your artistic inclinations, how you experience romance and dating, and the timing and nature of your relationship with children' },
  6: { area: 'health & obstacles', lahiri: 'your resilience against illness, debts, and daily work discipline', concrete: 'what health issues you\'re prone to, how you handle workplace stress, and your ability to overcome enemies and competitors' },
  7: { area: 'marriage & partnerships', lahiri: 'your spouse\'s nature, business partnerships, and public dealings', concrete: 'the kind of partner you attract, whether your marriage brings growth or friction, and how you navigate one-on-one relationships' },
  8: { area: 'transformation & longevity', lahiri: 'sudden changes, inheritance, and hidden dimensions of life', concrete: 'how you handle crises, whether you receive windfalls or insurance payouts, and your relationship with the unknown and occult' },
  9: { area: 'fortune & higher purpose', lahiri: 'your luck, spiritual growth, long-distance travel, and father', concrete: 'whether opportunities seem to find you naturally, your inclination toward philosophy or religion, and the role your father plays in shaping your worldview' },
  10: { area: 'career & public image', lahiri: 'your professional achievements, reputation, and authority', concrete: 'the kind of career you build, how much public recognition you receive, and whether you hold positions of power or influence' },
  11: { area: 'gains & social network', lahiri: 'your income from profession, friendships, and fulfilled desires', concrete: 'how much you actually earn from your work, the quality of your friend circle, and whether your ambitions tend to materialize' },
  12: { area: 'loss & liberation', lahiri: 'your expenses, foreign lands, sleep quality, and spiritual surrender', concrete: 'whether money slips through your fingers, your connection to foreign countries, the quality of your sleep, and your capacity for letting go' },
};

const HOUSE_LIFE_HI: Record<number, { area: string; concrete: string }> = {
  1: { area: 'व्यक्तित्व एवं स्वास्थ्य', concrete: 'लोग आपको पहली मुलाकात में कैसे देखते हैं, आपकी ऊर्जा का स्तर, और जीवन के प्रति आपका सहज दृष्टिकोण' },
  2: { area: 'धन एवं परिवार', concrete: 'पैसे से आपका रिश्ता, आपकी वाणी और बोलने की शैली, और निकट परिवार में गर्मजोशी या दूरी' },
  3: { area: 'साहस एवं प्रयास', concrete: 'क्या आप साहसिक जोखिम लेते हैं या सतर्क रहते हैं, और भाई-बहनों के साथ गतिशीलता' },
  4: { area: 'गृह एवं आन्तरिक शान्ति', concrete: 'आप आन्तरिक रूप से कितना स्थिर अनुभव करते हैं, घर और मातृभूमि से सम्बन्ध, और माँ की भूमिका' },
  5: { area: 'रचनात्मकता एवं सन्तान', concrete: 'कलात्मक झुकाव, प्रेम-सम्बन्ध का अनुभव, और सन्तान के साथ सम्बन्ध' },
  6: { area: 'स्वास्थ्य एवं बाधाएँ', concrete: 'किन स्वास्थ्य समस्याओं की प्रवृत्ति है, कार्यस्थल तनाव से कैसे निपटते हैं' },
  7: { area: 'विवाह एवं साझेदारी', concrete: 'किस प्रकार का साथी आकर्षित होता है, विवाह से वृद्धि या कलह, व्यापारिक साझेदारी' },
  8: { area: 'रूपान्तरण एवं आयु', concrete: 'संकटों से कैसे निपटते हैं, अचानक लाभ या हानि, अज्ञात और गूढ़ विषयों से सम्बन्ध' },
  9: { area: 'भाग्य एवं धर्म', concrete: 'क्या अवसर स्वाभाविक रूप से मिलते हैं, दर्शन या धर्म की ओर झुकाव, पिता की भूमिका' },
  10: { area: 'कैरियर एवं यश', concrete: 'किस प्रकार का कैरियर बनता है, कितनी सार्वजनिक मान्यता मिलती है, सत्ता या प्रभाव' },
  11: { area: 'लाभ एवं मित्र-मण्डल', concrete: 'कार्य से वास्तविक आय, मित्र-मण्डल की गुणवत्ता, और महत्वाकांक्षाओं की पूर्ति' },
  12: { area: 'व्यय एवं मोक्ष', concrete: 'क्या धन हाथ से फिसलता है, विदेश से सम्बन्ध, नींद की गुणवत्ता, और त्याग की क्षमता' },
};

/** Planet karaka (significator) descriptions for concrete impact */
const PLANET_KARAKA_EN: Record<number, string> = {
  0: 'Your Sun represents your core identity, father, authority figures, and vitality. This shift changes how you express your ego and where you find recognition.',
  1: 'Your Moon represents your emotional nature, mind, mother, and daily habits. This is deeply personal — it changes what makes you feel secure and how you process emotions.',
  2: 'Your Mars represents your drive, courage, siblings, and physical energy. This shift changes where you direct your aggression and how you fight for what you want.',
  3: 'Your Mercury represents your intellect, communication style, and analytical ability. This shift changes how you think, learn, and express ideas.',
  4: 'Your Jupiter represents your wisdom, optimism, teachers, and growth opportunities. This is a major shift — Jupiter\'s house placement shapes where life opens doors for you.',
  5: 'Your Venus represents your love life, aesthetic sense, luxuries, and creative pleasures. This shift changes what you find beautiful and how you experience relationships.',
  6: 'Your Saturn represents your discipline, karmic lessons, longevity, and where life demands hard work. This shift changes which area of life requires your most sustained effort.',
  7: 'Your Rahu represents your deepest desires, obsessions, and the unfamiliar territories you\'re drawn to explore in this lifetime.',
  8: 'Your Ketu represents your past-life mastery, spiritual detachment, and the areas where you seek liberation rather than achievement.',
};
const PLANET_KARAKA_HI: Record<number, string> = {
  0: 'सूर्य आपकी मूल पहचान, पिता, सत्ता और जीवनशक्ति का प्रतिनिधित्व करता है। यह परिवर्तन बदलता है कि आप अपना अहंकार कैसे व्यक्त करते हैं।',
  1: 'चन्द्रमा आपकी भावनात्मक प्रकृति, मन, माँ और दैनिक आदतों का प्रतिनिधित्व करता है। यह गहन व्यक्तिगत है — यह बदलता है कि आपको किससे सुरक्षा मिलती है।',
  2: 'मंगल आपके साहस, भाई-बहनों और शारीरिक ऊर्जा का प्रतिनिधित्व करता है। यह बदलता है कि आप अपनी आक्रामकता कहाँ लगाते हैं।',
  3: 'बुध आपकी बुद्धि, संवाद शैली और विश्लेषणात्मक क्षमता का प्रतिनिधित्व करता है। यह बदलता है कि आप कैसे सोचते और सीखते हैं।',
  4: 'बृहस्पति आपके ज्ञान, आशावाद, गुरुओं और वृद्धि के अवसरों का प्रतिनिधित्व करता है। यह बड़ा परिवर्तन है — बृहस्पति का भाव-स्थान निर्धारित करता है कि जीवन कहाँ द्वार खोलता है।',
  5: 'शुक्र आपके प्रेम-जीवन, सौन्दर्य-बोध और रचनात्मक आनन्द का प्रतिनिधित्व करता है। यह बदलता है कि आपको क्या सुन्दर लगता है।',
  6: 'शनि आपके अनुशासन, कर्म-पाठ और जहाँ जीवन कठिन परिश्रम माँगता है, का प्रतिनिधित्व करता है।',
  7: 'राहु आपकी गहनतम इच्छाओं, जुनून और उन अपरिचित क्षेत्रों का प्रतिनिधित्व करता है जिन्हें आप इस जन्म में खोजने के लिए आकर्षित होते हैं।',
  8: 'केतु आपकी पूर्वजन्म निपुणता, आध्यात्मिक विरक्ति और उन क्षेत्रों का प्रतिनिधित्व करता है जहाँ आप उपलब्धि नहीं, मुक्ति चाहते हैं।',
};

/** Holistic summary — concrete, personal impact of ayanamsha differences. */
function HolisticImpactSummary({ planets, locale, kundali }: { planets: PlanetRow[]; locale: string; kundali: KundaliData }) {
  ...
  // Build structured impact cards instead of flat text
  const cards: { title: string; body: string; type: 'lagna' | 'planet' | 'advice' }[] = [];

  // Lagna shift — most consequential
  const lagnaRow = planets.find(p => p.id === -1);
  if (lagnaRow?.hasSignChange) {
    const lahiriSign = Math.floor(((lagnaRow.positions.lahiri % 360) + 360) % 360 / 30);
    const ramanSign = Math.floor(((lagnaRow.positions.raman % 360) + 360) % 360 / 30);
  ...
  // Per-planet shifts with concrete life implications
  for (const row of shifted) {
    if (row.id < 0) continue;
    const lahiriSign = Math.floor(((row.positions.lahiri % 360) + 360) % 360 / 30);
    const ramanSign = Math.floor(((row.positions.raman % 360) + 360) % 360 / 30);
    const houseL = ((lahiriSign - (ascSign - 1) + 12) % 12) + 1;
    const houseR = ((ramanSign - (ascSign - 1) + 12) % 12) + 1;
    const pName = isHi ? (PLANET_HI[row.id] || row.name) : (PLANET_EN[row.id] || row.name);

    const karakaText = isHi ? (PLANET_KARAKA_HI[row.id] || '') : (PLANET_KARAKA_EN[row.id] || '');

    let body = karakaText;

    if (houseL !== houseR) {
      const lifeL = isHi ? HOUSE_LIFE_HI[houseL] : HOUSE_LIFE_EN[houseL];
      const lifeR = isHi ? HOUSE_LIFE_HI[houseR] : HOUSE_LIFE_EN[houseR];
      if (lifeL && lifeR) {
        if (isHi) {
          body += `\n\nलाहिरी में ${pName} आपके ${houseL}वें भाव (${lifeL.area}) में है — यह प्रभावित करता है ${lifeL.concrete}। रमन में यह ${houseR}वें भाव (${lifeR.area}) में चला जाता है — जो प्रभावित करता है ${lifeR.concrete}।`;
          body += `\n\nअपने आप से पूछें: क्या ${pName} की ऊर्जा आपके जीवन में ${lifeL.area} में अधिक दिखती है, या ${lifeR.area} में? उत्तर बताएगा कि कौन-सा अयनांश आपके लिए अधिक सटीक है।`;
        } else {
          body += `\n\nIn Lahiri, ${pName} sits in your ${ordinal(houseL)} house (${lifeL.area}) — this governs ${lifeL.concrete}. In Raman, ${pName} shifts to your ${ordinal(houseR)} house (${lifeR.area}) — which governs ${lifeR.concrete}.`;
          body += `\n\nAsk yourself honestly: does ${pName}'s energy show up more in your ${lifeL.area}, or in your ${lifeR.area}? The answer tells you which ayanamsha is more accurate for your chart.`;
        }
      }
    } else {
      // Same house, different sign — subtler difference
      const s1 = tl(RASHIS[lahiriSign]?.name, locale);
      const s2 = tl(RASHIS[ramanSign]?.name, locale);
      if (isHi) {
        body += `\n\n${pName} दोनों पद्धतियों में ${houseL}वें भाव में रहता है, लेकिन राशि ${s1} से ${s2} बदलती है। भाव वही है, पर अभिव्यक्ति की शैली बदलती है — ${s1} और ${s2} का स्वभाव भिन्न है।`;
      } else {
        body += `\n\n${pName} stays in the ${ordinal(houseL)} house under both systems, but the sign changes from ${s1} to ${s2}. The life area is the same, but the style of expression differs — ${s1} and ${s2} have fundamentally different temperaments.`;
      }
    }

    cards.push({ title: pName, body, type: 'planet' });
  }
      ...
      {cards.map((card, i) => (
        <div
          ...
          className={`rounded-xl p-4 sm:p-5 ${
            card.type === 'lagna'
              ? 'bg-gradient-to-br from-red-500/8 via-[#1a1040]/40 to-[#0a0e27] border border-red-400/20'
              : card.type === 'advice'
                ? 'bg-gradient-to-br from-emerald-500/8 via-[#1a1040]/40 to-[#0a0e27] border border-emerald-400/20'
                : 'bg-gradient-to-br from-amber-500/6 via-[#1a1040]/35 to-[#0a0e27] border border-amber-400/15'
          }`}
        >
          <h5 className={`text-sm font-bold mb-2 ${
            card.type === 'lagna' ? 'text-red-300' : card.type === 'advice' ? 'text-emerald-300' : 'text-amber-300'
          }`}>
            {card.type === 'lagna' && '⚠ '}{card.title}
          </h5>
          {card.body.split('\n\n').map((para, j) => (
            <p key={j} className="text-text-primary/80 text-sm leading-relaxed mt-2 first:mt-0">
              {para}
            </p>
          ))}
        </div>
