...
const QUESTIONS: ModuleQuestion[] = [
  { id: 'q5_2_01', type: 'mcq', question: { en: "Span?", hi: '' }, options: [{ en: "30d", hi: '' }, { en: "13d20m", hi: '' }, { en: "12d", hi: '' }, { en: "27d", hi: '' }], correctAnswer: 1, explanation: { en: "360/27=13d20m", hi: '' } },
  { id: 'q5_2_02', type: 'true_false', question: { en: "Moon ~1 day per nakshatra", hi: '' }, correctAnswer: true, explanation: { en: "Sidereal ~27.3 days", hi: '' } },
];
