...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Latitude, Distance, and Accuracy / अक्षांश, दूरी और सटीकता
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          The Moon&apos;s latitude (angular distance above or below the ecliptic) is computed from Meeus Table 47.B using 13 sine terms with the same D, M, M&apos;, F arguments. The Moon&apos;s orbit is tilted ~5.14° to the ecliptic, so its latitude swings up to ±5.3° (including perturbations). Latitude matters for two practical reasons: it affects moonrise timing (a Moon at +5° latitude rises earlier at northern latitudes) and it determines whether a new/full moon produces an eclipse (eclipses occur only when the Moon is very close to the ecliptic, i.e., near a node where F ≈ 0° or 180°).
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          चन्द्र अक्षांश (क्रान्तिवृत्त के ऊपर या नीचे कोणीय दूरी) मीयस सारणी 47.B से उन्हीं D, M, M&apos;, F तर्कों वाले 13 ज्या पदों द्वारा गणित होता है। चन्द्र कक्षा क्रान्तिवृत्त से ~5.14° झुकी है, अतः इसका अक्षांश ±5.3° (विक्षोभ सहित) तक झूलता है। अक्षांश दो व्यावहारिक कारणों से महत्त्वपूर्ण है: यह चन्द्रोदय समय प्रभावित करता है (+5° अक्षांश पर चन्द्रमा उत्तरी अक्षांशों पर पहले उदित होता है) और यह निर्धारित करता है कि अमावस्या/पूर्णिमा ग्रहण उत्पन्न करेगी (ग्रहण तभी होते हैं जब चन्द्रमा क्रान्तिवृत्त के अत्यन्त निकट हो, अर्थात पात के निकट जहाँ F ≈ 0° या 180°)।
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          The Moon&apos;s distance is computed from 14 cosine terms in Table 47.A. The mean distance is 385,001 km, but it varies from about 356,000 km (perigee) to 407,000 km (apogee). From the distance we derive the horizontal parallax: sin(HP) = 6378.14 / distance, where 6378.14 km is Earth&apos;s equatorial radius. HP ranges from about 54&apos; (apogee) to 61&apos; (perigee). This nearly 1-degree parallax is critical for moonrise calculations — it means the Moon&apos;s observed position from the surface differs significantly from the theoretical geocentric position.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed">
          चन्द्र दूरी सारणी 47.A के 14 कोज्या पदों से गणित होती है। माध्य दूरी 385,001 किमी है, किन्तु यह लगभग 356,000 किमी (उपभू) से 407,000 किमी (अपभू) तक भिन्न होती है। दूरी से हम क्षैतिज लम्बन प्राप्त करते हैं: sin(HP) = 6378.14 / दूरी, जहाँ 6378.14 किमी पृथ्वी की विषुवतीय त्रिज्या है। HP लगभग 54&apos; (अपभू) से 61&apos; (उपभू) तक होता है। यह लगभग 1 अंश का लम्बन चन्द्रोदय गणनाओं के लिए अत्यन्त महत्त्वपूर्ण है — इसका अर्थ है कि सतह से चन्द्रमा की प्रेक्षित स्थिति सैद्धान्तिक भूकेन्द्रीय स्थिति से महत्त्वपूर्ण रूप से भिन्न होती है।
        </p>
      </section>

      <section className="glass-card rounded-xl p-5 border border-red-500/15">
        <h4 className="text-red-400 text-[10px] uppercase tracking-widest font-bold mb-3">Accuracy Limits / सटीकता सीमाएँ</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Our engine&apos;s accuracy:</span> ~0.3° in longitude (about 10 arcminutes). Since the Moon moves ~13.2°/day, a 0.3° error translates to about 30 minutes of time for transit predictions. This is sufficient for determining which Nakshatra, Tithi, or Yoga is active at sunrise, but it means our tithi transition times may be off by up to ~30 minutes from high-precision ephemerides.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">हमारे इंजन की सटीकता:</span> भोगांश में ~0.3° (लगभग 10 कला)। चन्द्रमा ~13.2°/दिन चलता है, अतः 0.3° त्रुटि गोचर भविष्यवाणियों के लिए लगभग 30 मिनट समय में बदलती है। यह निर्धारित करने के लिए पर्याप्त है कि सूर्योदय पर कौन-सा नक्षत्र, तिथि या योग सक्रिय है, किन्तु इसका अर्थ है कि हमारी तिथि संक्रमण समय उच्च-सटीकता एफेमेरिस से ~30 मिनट तक भिन्न हो सकते हैं।
        </p>
      </section>
      ...
      <section className="glass-card rounded-xl p-5 border border-blue-500/15">
        ...
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          Our moonLongitude(jd) function implements all 60 sine terms from Table 47.A, computes the eccentricity correction E, and returns the Moon&apos;s geocentric tropical longitude. This is called for every Panchang element that depends on the Moon: Tithi (Moon-Sun angle), Nakshatra (Moon&apos;s sidereal position), Yoga (Sun+Moon sum), Karana (half-tithi), and moonrise/moonset timing. The 60-term computation runs in microseconds on modern hardware — a testament to how efficiently Meeus distilled centuries of lunar theory into a compact algorithm.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          हमारा moonLongitude(jd) फ़ंक्शन सारणी 47.A के सभी 60 ज्या पद लागू करता है, उत्केन्द्रता सुधार E गणित करता है, और चन्द्रमा का भूकेन्द्रीय सायन भोगांश लौटाता है। यह प्रत्येक पंचांग तत्व के लिए बुलाया जाता है जो चन्द्रमा पर निर्भर है: तिथि (चन्द्र-सूर्य कोण), नक्षत्र (चन्द्र निरयन स्थिति), योग (सूर्य+चन्द्र योग), करण (अर्ध-तिथि), और चन्द्रोदय/चन्द्रास्त समय। 60-पद गणना आधुनिक हार्डवेयर पर माइक्रोसेकण्ड में चलती है — मीयस ने शताब्दियों के चन्द्र सिद्धान्त को कितनी कुशलता से संक्षिप्त एल्गोरिदम में संकलित किया, इसका प्रमाण।
        </p>
      </section>
    </div>
  );
