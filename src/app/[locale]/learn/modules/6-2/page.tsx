    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          The Pada System — 108 Divisions / पाद पद्धति — 108 विभाजन
        </h3>
      ...
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          The Sacred Number 108 / पवित्र संख्या 108
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          How Each Pada Modifies Nakshatra Energy / प्रत्येक पाद नक्षत्र ऊर्जा को कैसे बदलता है
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Pushkara Navamshas — The Most Auspicious Padas / पुष्कर नवांश — सर्वाधिक शुभ पाद
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        ...
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Example:</span> Consider two people both born with Moon in Bharani (13°20&apos;-26°40&apos; Aries). Person A has Moon at 15° (pada 1, Leo Navamsha) and Person B has Moon at 25° (pada 4, Scorpio Navamsha). Both share Bharani&apos;s Venusian, transformative, Yama-ruled energy. However, Person A (Leo Navamsha) expresses this with regal authority, creative confidence, and dramatic flair. Person B (Scorpio Navamsha) channels the same energy through deep psychological insight, intensity, and hidden transformation. Same nakshatra, dramatically different expression.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">उदाहरण:</span> दो व्यक्तियों पर विचार करें जिनका चन्द्रमा भरणी (मेष 13°20&apos;-26°40&apos;) में है। व्यक्ति A का चन्द्रमा 15° (पाद 1, सिंह नवांश) पर और व्यक्ति B का 25° (पाद 4, वृश्चिक नवांश) पर। दोनों भरणी की शुक्र-शासित, रूपान्तरकारी, यम-शासित ऊर्जा साझा करते हैं। किन्तु व्यक्ति A (सिंह नवांश) इसे राजसी अधिकार, सृजनात्मक आत्मविश्वास और नाटकीय शैली से व्यक्त करता है। व्यक्ति B (वृश्चिक नवांश) उसी ऊर्जा को गहन मनोवैज्ञानिक अन्तर्दृष्टि, तीव्रता और गुप्त रूपान्तरण द्वारा प्रवाहित करता है। समान नक्षत्र, नाटकीय रूप से भिन्न अभिव्यक्ति।
        </p>
      </section>
...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Practical Calculation — Finding Nakshatra & Pada / व्यावहारिक गणना — नक्षत्र एवं पाद ज्ञात करना
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">Worked Examples / कार्यान्वित उदाहरण</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Example 1:</span> Moon at 167.3°. Step 1: floor(167.3 / 13.333) = floor(12.548) = 12. Step 2: Nakshatra = 12 + 1 = 13 → Hasta (spanning 160° to 173.33°). Step 3: Position = 167.3 - (12 x 13.333) = 167.3 - 160 = 7.3°. Step 4: Pada = floor(7.3 / 3.333) + 1 = floor(2.19) + 1 = 2 + 1 = 3. Result: Hasta pada 3.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">उदाहरण 1:</span> चन्द्रमा 167.3° पर। चरण 1: floor(167.3 / 13.333) = floor(12.548) = 12। चरण 2: नक्षत्र = 12 + 1 = 13 → हस्त (160° से 173.33° तक)। चरण 3: स्थिति = 167.3 - (12 x 13.333) = 167.3 - 160 = 7.3°। चरण 4: पाद = floor(7.3 / 3.333) + 1 = floor(2.19) + 1 = 2 + 1 = 3। परिणाम: हस्त पाद 3।
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Example 2:</span> Moon at 280.5°. Step 1: floor(280.5 / 13.333) = floor(21.038) = 21. Step 2: Nakshatra = 21 + 1 = 22 → Shravana (spanning 280° to 293.33°). Step 3: Position = 280.5 - (21 x 13.333) = 280.5 - 280 = 0.5°. Step 4: Pada = floor(0.5 / 3.333) + 1 = 0 + 1 = 1. Result: Shravana pada 1.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">उदाहरण 2:</span> चन्द्रमा 280.5° पर। चरण 1: floor(280.5 / 13.333) = floor(21.038) = 21। चरण 2: नक्षत्र = 21 + 1 = 22 → श्रवण (280° से 293.33° तक)। चरण 3: स्थिति = 280.5 - (21 x 13.333) = 280.5 - 280 = 0.5°। चरण 4: पाद = floor(0.5 / 3.333) + 1 = 0 + 1 = 1। परिणाम: श्रवण पाद 1।
        </p>
      </section>

      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Navamsha Sign from Pada / पाद से नवांश राशि
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
