...
const result = scoreSleep(kundali, strength, signatures, 'en');
...
describe('scoreSleep', () => {
  ...
  it('returns correct metadata matching ELEMENT_CATALOG[sleep]', () => {
    const meta = ELEMENT_CATALOG['sleep'];
