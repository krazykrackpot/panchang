...
export const PLANET_REMEDIES: Record<number, { gemstone: LocaleText; mantra: LocaleText; practice: { en: string; hi: string; day: string } }> = {
  0: { gemstone: { en: 'Ruby (Manikya)', hi: 'माणिक्य', sa: 'माणिक्य', mai: 'माणिक्य', mr: 'माणिक्य', ta: 'மாணிக்கம்', te: 'మాణిక్యం', bn: 'মাণিক্য', kn: 'ಮಾಣಿಕ್ಯ', gu: 'માણેક' }, mantra: { en: 'Om Suryaya Namah (108 times)', hi: 'ॐ सूर्याय नमः (108 बार)', sa: 'ॐ सूर्याय नमः (108 बार)', mai: 'ॐ सूर्याय नमः (108 बार)', mr: 'ॐ सूर्याय नमः (108 बार)', ta: 'ஓம் சூர்யாய நம: (108 முறை)', te: 'ఓం సూర్యాయ నమః (108 సార్లు)', bn: 'ওঁ সূর্যায় নমঃ (১০৮ বার)', kn: 'ಓಂ ಸೂರ್ಯಾಯ ನಮಃ (108 ಬಾರಿ)', gu: 'ઓમ સૂર્યાય નમઃ (108 વખત)' }, practice: { en: 'Offer water to Sun at sunrise. Donate wheat on Sundays.', hi: 'सूर्योदय पर सूर्य को जल अर्पण करें। रविवार को गेहूँ दान करें।', day: 'Sunday' } },
  1: { gemstone: { en: 'Pearl (Moti)', hi: 'मोती', sa: 'मोती', mai: 'मोती', mr: 'मोती', ta: 'முத்து', te: 'ముత్యం', bn: 'মুক্তা', kn: 'ಮುತ್ತು', gu: 'મોતી' }, mantra: { en: 'Om Chandraya Namah (108 times)', hi: 'ॐ चन्द्राय नमः (108 बार)', sa: 'ॐ चन्द्राय नमः (108 बार)', mai: 'ॐ चन्द्राय नमः (108 बार)', mr: 'ॐ चन्द्राय नमः (108 बार)', ta: 'ஓம் சந்த்ராய நம: (108 முறை)', te: 'ఓం చంద్రాయ నమః (108 సార్లు)', bn: 'ওঁ চন্দ্রায় নমঃ (১০৮ বার)', kn: 'ಓಂ ಚಂದ್ರಾಯ ನಮಃ (108 ಬಾರಿ)', gu: 'ઓમ ચંદ્રાય નમઃ (108 વખત)' }, practice: { en: 'Offer milk to Shivalinga on Mondays. Donate rice.', hi: 'सोमवार को शिवलिंग पर दूध अर्पित करें। चावल दान करें।', day: 'Monday' } },
  2: { gemstone: { en: 'Red Coral (Moonga)', hi: 'मूँगा', sa: 'मूँगा', mai: 'मूँगा', mr: 'मूँगा', ta: 'பவளம்', te: 'పగడం', bn: 'প্রবাল', kn: 'ಹವಳ', gu: 'મૂંગા' }, mantra: { en: 'Om Mangalaya Namah (108 times)', hi: 'ॐ मङ्गलाय नमः (108 बार)', sa: 'ॐ मङ्गलाय नमः (108 बार)', mai: 'ॐ मङ्गलाय नमः (108 बार)', mr: 'ॐ मङ्गलाय नमः (108 बार)', ta: 'ஓம் மங்களாய நம: (108 முறை)', te: 'ఓం మంగళాయ నమః (108 సార్లు)', bn: 'ওঁ মঙ্গলায় নমঃ (১০৮ বার)', kn: 'ಓಂ ಮಂಗಳಾಯ ನಮಃ (108 ಬಾರಿ)', gu: 'ઓમ મંગળાય નમઃ (108 વખત)' }, practice: { en: 'Offer red flowers to Hanuman on Tuesdays. Donate red lentils.', hi: 'मंगलवार को हनुमान जी को लाल फूल अर्पित करें। मसूर दाल दान करें।', day: 'Tuesday' } },
  3: { gemstone: { en: 'Emerald (Panna)', hi: 'पन्ना', sa: 'पन्ना', mai: 'पन्ना', mr: 'पन्ना', ta: 'மரகதம்', te: 'మరకతం', bn: 'পান্না', kn: 'ಪಚ್ಚೆ', gu: 'પન્ના' }, mantra: { en: 'Om Budhaya Namah (108 times)', hi: 'ॐ बुधाय नमः (108 बार)', sa: 'ॐ बुधाय नमः (108 बार)', mai: 'ॐ बुधाय नमः (108 बार)', mr: 'ॐ बुधाय नमः (108 बार)', ta: 'ஓம் புதாய நம: (108 முறை)', te: 'ఓం బుధాయ నమః (108 సార్లు)', bn: 'ওঁ বুধায় নমঃ (১০৮ বার)', kn: 'ಓಂ ಬುಧಾಯ ನಮಃ (108 ಬಾರಿ)', gu: 'ઓમ બુધાય નમઃ (108 વખત)' }, practice: { en: 'Donate green vegetables on Wednesdays. Feed green grass to cows.', hi: 'बुधवार को हरी सब्जियाँ दान करें। गाय को हरा चारा खिलाएँ।', day: 'Wednesday' } },
  4: { gemstone: { en: 'Yellow Sapphire (Pukhraj)', hi: 'पुखराज', sa: 'पुखराज', mai: 'पुखराज', mr: 'पुखराज', ta: 'புஷ்பராகம்', te: 'పుష్యరాగం', bn: 'পোখরাজ', kn: 'ಪುಷ್ಯರಾಗ', gu: 'પોખરાજ' }, mantra: { en: 'Om Gurave Namah (108 times)', hi: 'ॐ गुरवे नमः (108 बार)', sa: 'ॐ गुरवे नमः (108 बार)', mai: 'ॐ गुरवे नमः (108 बार)', mr: 'ॐ गुरवे नमः (108 बार)', ta: 'ஓம் குரவே நம: (108 முறை)', te: 'ఓం గురవే నమః (108 సార్లు)', bn: 'ওঁ গুরবে নমঃ (১০৮ বার)', kn: 'ಓಂ ಗುರವೇ ನಮಃ (108 ಬಾರಿ)', gu: 'ઓમ ગુરવે નમઃ (108 વખત)' }, practice: { en: 'Donate yellow cloth and turmeric on Thursdays. Respect teachers.', hi: 'गुरुवार को पीले वस्त्र और हल्दी दान करें। गुरुजनों का सम्मान करें।', day: 'Thursday' } },
  5: { gemstone: { en: 'Diamond (Heera)', hi: 'हीरा', sa: 'हीरा', mai: 'हीरा', mr: 'हीरा', ta: 'வைரம்', te: 'వజ్రం', bn: 'হীরা', kn: 'ವಜ್ರ', gu: 'હીરા' }, mantra: { en: 'Om Shukraya Namah (108 times)', hi: 'ॐ शुक्राय नमः (108 बार)', sa: 'ॐ शुक्राय नमः (108 बार)', mai: 'ॐ शुक्राय नमः (108 बार)', mr: 'ॐ शुक्राय नमः (108 बार)', ta: 'ஓம் சுக்ராய நம: (108 முறை)', te: 'ఓం శుక్రాయ నమః (108 సార్లు)', bn: 'ওঁ শুক্রায় নমঃ (১০৮ বার)', kn: 'ಓಂ ಶುಕ್ರಾಯ ನಮಃ (108 ಬಾರಿ)', gu: 'ઓમ શુક્રાય નમઃ (108 વખત)' }, practice: { en: 'Donate white clothes and sugar on Fridays. Support arts and artists.', hi: 'शुक्रवार को सफेद वस्त्र और शक्कर दान करें। कला और कलाकारों का समर्थन करें।', day: 'Friday' } },
  6: { gemstone: { en: 'Blue Sapphire (Neelam)', hi: 'नीलम', sa: 'नीलम', mai: 'नीलम', mr: 'नीलम', ta: 'நீலம்', te: 'నీలం', bn: 'নীলম', kn: 'ನೀಲ', gu: 'નીલમ' }, mantra: { en: 'Om Shanaischaraya Namah (108 times)', hi: 'ॐ शनैश्चराय नमः (108 बार)', sa: 'ॐ शनैश्चराय नमः (108 बार)', mai: 'ॐ शनैश्चराय नमः (108 बार)', mr: 'ॐ शनैश्चराय नमः (108 बार)', ta: 'ஓம் சனைச்சராய நம: (108 முறை)', te: 'ఓం శనైశ్చరాయ నమః (108 సార్లు)', bn: 'ওঁ শনৈশ্চরায় নমঃ (১০৮ বার)', kn: 'ಓಂ ಶನೈಶ್ಚರಾಯ ನಮಃ (108 ಬಾರಿ)', gu: 'ઓમ શનૈશ્ચરાય નમઃ (108 વખત)' }, practice: { en: 'Donate black sesame and oil on Saturdays. Serve the elderly and poor.', hi: 'शनिवार को काले तिल और तेल दान करें। बुजुर्गों और गरीबों की सेवा करें।', day: 'Saturday' } },
  7: { gemstone: { en: 'Hessonite Garnet (Gomed)', hi: 'गोमेद', sa: 'गोमेद', mai: 'गोमेद', mr: 'गोमेद', ta: 'கோமேதகம்', te: 'గోమేధికం', bn: 'গোমেদ', kn: 'ಗೋಮೇಧಿಕ', gu: 'ગોમેદ' }, mantra: { en: 'Om Rahave Namah (108 times)', hi: 'ॐ राहवे नमः (108 बार)', sa: 'ॐ राहवे नमः (108 बार)', mai: 'ॐ राहवे नमः (108 बार)', mr: 'ॐ राहवे नमः (108 बार)', ta: 'ஓம் ராகவே நம: (108 முறை)', te: 'ఓం రాహవే నమః (108 సార్లు)', bn: 'ওঁ রাহবে নমঃ (১০৮ বার)', kn: 'ಓಂ ರಾಹವೇ ನಮಃ (108 ಬಾರಿ)', gu: 'ઓમ રાહવે નમઃ (108 વખત)' }, practice: { en: 'Donate blue/black cloth on Saturdays. Feed birds. Avoid intoxicants.', hi: 'शनिवार को नीले/काले वस्त्र दान करें। पक्षियों को दाना डालें। नशे से बचें।', day: 'Saturday' } },
  8: { gemstone: { en: 'Cat\'s Eye (Lehsuniya)', hi: 'लहसुनिया' }, mantra: { en: 'Om Ketave Namah (108 times)', hi: 'ॐ केतवे नमः (108 बार)', sa: 'ॐ केतवे नमः (108 बार)', mai: 'ॐ केतवे नमः (108 बार)', mr: 'ॐ केतवे नमः (108 बार)', ta: 'ஓம் கேதவே நம: (108 முறை)', te: 'ఓం కేతవే నమః (108 సార్లు)', bn: 'ওঁ কেতবে নমঃ (১০৮ বার)', kn: 'ಓಂ ಕೇತವೇ ನಮಃ (108 ಬಾರಿ)', gu: 'ઓમ કેતવે નમઃ (108 વખત)' }, practice: { en: 'Donate blankets to the needy. Feed stray dogs. Practice meditation regularly.', hi: 'जरूरतमन्दों को कम्बल दान करें। आवारा कुत्तों को खिलाएँ। नियमित ध्यान करें।', day: 'Tuesday' } },
};
