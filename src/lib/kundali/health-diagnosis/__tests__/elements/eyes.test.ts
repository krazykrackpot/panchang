// src/lib/kundali/health-diagnosis/__tests__/elements/eyes.test.ts
//
// Task B10 — eyes element scorer tests.
//
...
import { scoreEyes } from '../../elements/eyes';
...
const result = scoreEyes(kundali, strength, signatures, 'en');
...
describe('scoreEyes', () => {
  ...
  it('returns correct metadata matching ELEMENT_CATALOG[eyes]', () => {
    const meta = ELEMENT_CATALOG['eyes'];
    expect(result.id).toBe('eyes');
