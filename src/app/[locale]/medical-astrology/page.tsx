...
const LABELS = {
  ...
  // ── Telugu (te) — English fallback for most strings ──────────────────────
  te: {
    title: 'Medical Astrology',
    subtitle: 'Prakriti · Body Map · Health Timeline · Disease Patterns',
    desc: 'Discover your Ayurvedic constitution, body vulnerability map, and health vulnerability windows from your Vedic birth chart.',
    ...
    summaryLabel: 'Summary',
    editorialTitle: 'Understanding Medical Astrology (Jyotish Chikitsa)',
    editorialIntro: 'Medical Astrology, known as Jyotish Chikitsa in the Vedic tradition, is the ancient discipline that correlates planetary positions at birth with an individual\'s physical constitution and health predispositions.',
    editorialDoshaTitle: 'The Three Doshas and Their Planetary Rulers',
    editorialDosha: 'Ayurveda identifies three fundamental bio-energies (doshas). Vata (air + ether) is ruled by Saturn and Rahu. Pitta (fire + water) is ruled by the Sun and Mars. Kapha (earth + water) is ruled by the Moon, Jupiter, and Venus.',
    editorialHousesTitle: 'Health-Significant Houses: 6th, 8th, and 12th',
    editorialHouses: 'In Jyotish, the 6th house rules disease, the 8th governs chronic illness and longevity, and the 12th relates to hospitalisation and loss of vitality.',
    editorialPrakritiTitle: 'Prakriti: Your Birth Chart Constitution',
    editorialPrakriti: 'The Prakriti concept bridges Jyotish and Ayurveda, determining your innate constitutional type from planetary longitudes at birth.',
    editorialDashaTitle: 'How Dashas Activate Health Vulnerabilities',
    editorialDasha: 'Vedic astrology uses Vimshottari Dasha to time life events. When a planet ruling the 6th, 8th, or 12th house becomes active, latent health vulnerabilities can manifest.',
    editorialMethodTitle: 'Our Computational Approach',
    editorialMethod: 'This tool implements classical BPHS house-based analysis. It computes planetary strengths (Shadbala), house affliction scores, dasha timelines, and current transit overlays to generate a personalised health profile.',
  },
  // ── Gujarati (gu) — English fallback ─────────────────────────────────────
  gu: {
    title: 'Medical Astrology',
    subtitle: 'Prakriti · Body Map · Health Timeline · Disease Patterns',
    desc: 'Discover your Ayurvedic constitution, body vulnerability map, and health vulnerability windows from your Vedic birth chart.',
  ...
  // ── Maithili (mai) — uses Hindi for Devanagari strings ───────────────────
  mai: {
    title: 'चिकित्सा ज्योतिष',
    subtitle: 'प्रकृति · देह मानचित्र · स्वास्थ्य समयरेखा · रोग प्रारूप',
    desc: 'अपनी जन्म कुण्डली से अपनी आयुर्वेदिक प्रकृति, देह असुरक्षा मानचित्र और स्वास्थ्य असुरक्षा काल जानें।',
    ...
    guidance: 'स्वास्थ्य मार्गदर्शन',
    overallOutlook: 'समग्र दृष्टिकोण',
    toneGood: 'अनुकूल', toneModerate: 'स्थिर', toneCaution: 'ध्यान आवश्यक', toneChallenging: 'विशेष देखभाल',
    doLabel: 'करें', avoidLabel: 'बचें', watchLabel: 'ध्यान दें',
    sadeSatiNote: 'साढ़े साती सक्रिय',
    noAlerts: 'स्वास्थ्य भावों पर कोई प्रमुख गोचर चेतावनी नहीं।',
    noDoshas: 'स्वास्थ्य को प्रभावित करने वाले कोई उल्लेखनीय दोष नहीं।',
    summaryLabel: 'सारांश',
    editorialTitle: 'चिकित्सा ज्योतिष को समझें',
    editorialIntro: 'चिकित्सा ज्योतिष एक प्राचीन विद्या है जो जन्म के समय ग्रहों की स्थिति को व्यक्ति की शारीरिक संरचना और स्वास्थ्य प्रवृत्तियों से जोड़ती है।',
    editorialDoshaTitle: 'तीन दोष और उनके ग्रह स्वामी',
    editorialDosha: 'आयुर्वेद तीन मूलभूत जैव-ऊर्जाओं की पहचान करता है। वात के स्वामी शनि और राहु हैं। पित्त के स्वामी सूर्य और मंगल हैं। कफ के स्वामी चन्द्र, गुरु और शुक्र हैं।',
    editorialHousesTitle: 'स्वास्थ्य-महत्वपूर्ण भाव',
    editorialHouses: 'ज्योतिष में छठा भाव रोग, आठवाँ दीर्घकालिक रोग और बारहवाँ अस्पताल से सम्बन्धित है।',
    editorialPrakritiTitle: 'प्रकृति: आपकी जन्म कुण्डली संरचना',
    editorialPrakriti: 'प्रकृति की अवधारणा ज्योतिष और आयुर्वेद के बीच सेतु है।',
    editorialDashaTitle: 'दशाएँ स्वास्थ्य कमजोरियों को कैसे सक्रिय करती हैं',
    editorialDasha: 'विंशोत्तरी दशा में जब 6वें, 8वें या 12वें भाव का स्वामी ग्रह सक्रिय होता है, तो स्वास्थ्य कमजोरियाँ प्रकट हो सकती हैं।',
    editorialMethodTitle: 'हमारा गणना दृष्टिकोण',
    editorialMethod: 'यह उपकरण शास्त्रीय BPHS भाव-आधारित विश्लेषण लागू करता है।',
  },
  // ── Marathi (mr) — English fallback ──────────────────────────────────────
  mr: {
    title: 'Medical Astrology',
    subtitle: 'Prakriti · Body Map · Health Timeline · Disease Patterns',
    desc: 'Discover your Ayurvedic constitution, body vulnerability map, and health vulnerability windows from your Vedic birth chart.',
