...
<body>
  ...
  <div class="page-footer">
    ...
    <p style="margin-top:8px;font-size:8px;color:#bbb;">Computed with Swiss Ephemeris (based on NASA JPL DE ephemerides) using Lahiri Ayanamsha (Chitrapaksha). This report is for educational and entertainment purposes.</p>
  </div>
</body>
</html>`;
}
