  ...
  const TRACKS = [
    {
      ...
      icon: Sparkles,
      gradient: 'from-indigo-600/20 via-violet-600/10 to-purple-600/5',
      ...
      stats: { en: '~30 modules, 15 references', hi: '~30 मॉड्यूल, 15 संदर्भ', sa: '~30 मॉड्यूलाः' },
    ...
    },
    {
      ...
      icon: Calendar,
      gradient: 'from-amber-600/20 via-gold-primary/10 to-yellow-600/5',
      ...
      stats: { en: '~15 modules, 10 references', hi: '~15 मॉड्यूल, 10 संदर्भ', sa: '~15 मॉड्यूलाः' },
    ...
    },
    {
      ...
      stats: { en: '~45 modules, 20 references, 5 labs', hi: '~45 मॉड्यूल, 20 संदर्भ, 5 लैब', sa: '~45 मॉड्यूलाः 5 प्रयोगशालाः' },
