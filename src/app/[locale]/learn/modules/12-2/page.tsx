    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          What is Sade Sati? / साढ़े साती क्या है?
        </h3>
      ...
      <section className="glass-card rounded-xl p-5 border border-gold-primary/10">
        <h4 className="text-gold-dark text-[10px] uppercase tracking-widest font-bold mb-3">The Three Phases / तीन चरण</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Rising Phase (12th from Moon):</span> Saturn enters the sign before your Moon sign. The 12th house governs losses, expenses, sleep, and the subconscious. This phase brings growing anxiety, disturbed sleep, increased expenses, and a nagging sense that something is about to change. It is the preparation — the storm clouds gathering before the rain.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">आरोही चरण (चन्द्र से 12वाँ):</span> शनि आपकी चन्द्र राशि से पहली राशि में प्रवेश करता है। 12वाँ भाव हानि, व्यय, निद्रा और अवचेतन का शासक है। यह चरण बढ़ती चिन्ता, अनिद्रा, बढ़ा हुआ व्यय और बदलाव की अनुभूति लाता है। यह तैयारी है — बारिश से पहले बादलों का जमाव।
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-red-400 font-medium">Peak Phase (over the Moon):</span> Saturn directly transits over your natal Moon. This is the most intense phase — maximum emotional pressure, forced transformation, potential health issues, career upheavals, and deep karmic confrontations. It strips away what is not authentic and forces you to rebuild from a place of truth.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
        ...
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-emerald-400 font-medium">Setting Phase (2nd from Moon):</span> Saturn moves to the sign after your Moon sign. The 2nd house governs wealth, family, speech, and accumulated resources. Financial pressures and family tensions gradually resolve. This is the recovery phase — the storm passes and you begin to see the fruits of your endurance.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-emerald-400 font-medium">अवरोही चरण (चन्द्र से 2रा):</span> शनि आपकी चन्द्र राशि के बाद की राशि में जाता है। 2रा भाव धन, परिवार, वाणी और संचित संसाधनों का शासक है। आर्थिक दबाव और पारिवारिक तनाव धीरे-धीरे समाधान की ओर बढ़ते हैं। यह पुनर्प्राप्ति चरण है — तूफान गुजरता है और आप अपनी सहनशीलता के फल देखने लगते हैं।
        </p>
      </section>
    </div>
  );
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          What Determines Severity? / तीव्रता किससे निर्धारित होती है?
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          Not all Sade Satis are equally harsh. The severity varies enormously based on multiple chart factors. Understanding these factors transforms Sade Sati from a blanket fear into a nuanced predictive tool. The same transit that devastates one person may catalyze greatness in another.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          सभी साढ़े साती समान रूप से कठोर नहीं होतीं। तीव्रता अनेक कुण्डली कारकों के आधार पर अत्यधिक भिन्न होती है। इन कारकों को समझना साढ़े साती को सामान्य भय से एक सूक्ष्म भविष्यसूचक उपकरण में बदल देता है। वही गोचर जो एक व्यक्ति को तबाह करता है, दूसरे में महानता को प्रेरित कर सकता है।
        </p>
      </section>

      <section className="glass-card rounded-xl p-5 border border-gold-primary/10">
        <h4 className="text-gold-dark text-[10px] uppercase tracking-widest font-bold mb-3">Key Severity Factors / प्रमुख तीव्रता कारक</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
      ...
      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">Dasha Interaction / दशा पारस्परिक क्रिया</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Life Cycle Patterns / जीवन चक्र प्रतिमान
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          Saturn&apos;s orbital period of approximately 29.5 years means Sade Sati recurs in a roughly 30-year cycle. Most people experience 2-3 Sade Satis in their lifetime, each corresponding to a distinct developmental stage. Understanding which Sade Sati you are in reveals the specific life lessons being demanded.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          शनि की लगभग 29.5 वर्ष की कक्षा अवधि का अर्थ है कि साढ़े साती लगभग 30 वर्ष के चक्र में पुनरावृत्त होती है। अधिकांश लोग जीवन में 2-3 साढ़े साती अनुभव करते हैं, प्रत्येक एक विशिष्ट विकास चरण से सम्बद्ध। आप कौन-सी साढ़े साती में हैं यह समझना माँगे जा रहे विशिष्ट जीवन पाठों को प्रकट करता है।
        </p>
      </section>

      <section className="glass-card rounded-xl p-5 border border-blue-500/15">
        <h4 className="text-blue-300 text-[10px] uppercase tracking-widest font-bold mb-3">The Three Life Sade Satis / तीन जीवनकालीन साढ़े साती</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-3">
          <span className="text-gold-light font-medium">First Sade Sati (~Age 22-30):</span> This coincides with Saturn&apos;s first return — the astrological marker of true adulthood. The universe demands that you establish your career, take responsibility, and build a solid foundation. Relationships are tested. The carefree youth phase ends. Those who resist Saturn&apos;s discipline face prolonged struggle; those who embrace it emerge with a career and identity that can last decades.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-3">
          <span className="text-gold-light font-medium">पहली साढ़े साती (~आयु 22-30):</span> यह शनि की प्रथम वापसी के साथ आती है — सच्ची प्रौढ़ता का ज्योतिषीय चिह्न। ब्रह्माण्ड माँग करता है कि आप करियर स्थापित करें, जिम्मेदारी लें और ठोस नींव बनाएँ। सम्बन्ध परीक्षित होते हैं। लापरवाह युवावस्था समाप्त होती है।
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-3">
          <span className="text-gold-light font-medium">Second Sade Sati (~Age 52-60):</span> The most emotionally intense cycle. Health concerns emerge, parents and elders may pass away, and one confronts mortality and legacy directly. Career may peak or plateau. This Sade Sati forces a reckoning with what truly matters — stripping away ambition-driven pursuits in favor of meaning-driven ones.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-3">
          <span className="text-gold-light font-medium">दूसरी साढ़े साती (~आयु 52-60):</span> सर्वाधिक भावनात्मक रूप से तीव्र चक्र। स्वास्थ्य चिन्ताएँ उभरती हैं, माता-पिता और बड़ों का वियोग हो सकता है, मृत्यु और विरासत का सीधा सामना होता है। करियर शिखर या ठहराव पर हो सकता है।
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
      ...
      <section className="glass-card rounded-xl p-5 border border-amber-500/15">
        <h4 className="text-amber-400 text-[10px] uppercase tracking-widest font-bold mb-3">The Hidden Gift / छिपा हुआ वरदान</h4>
        <p className="text-text-secondary text-xs leading-relaxed">
