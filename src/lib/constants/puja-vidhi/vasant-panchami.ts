...
export const VASANT_PANCHAMI_PUJA: PujaVidhi = {
  ...
  samagri: [
    { name: { en: 'Saraswati idol or image', hi: 'सरस्वती मूर्ति या चित्र', sa: 'सरस्वतीमूर्तिः अथवा चित्रम्' } },
    { name: { en: 'White flowers (especially white lotus)', hi: 'श्वेत फूल (विशेषकर श्वेत कमल)', sa: 'श्वेतपुष्पाणि (विशेषतः श्वेतकमलम्)' } },
    { name: { en: 'Yellow flowers (marigold, mustard flowers)', hi: 'पीले फूल (गेंदा, सरसों के फूल)', sa: 'पीतपुष्पाणि (स्थलपद्मम्, सर्षपपुष्पाणि)' } },
    { name: { en: 'Books (for blessing)', hi: 'पुस्तकें (आशीर्वाद के लिए)', sa: 'पुस्तकानि (आशीर्वादार्थम्)' } },
    { name: { en: 'Pen, pencil, or writing instrument', hi: 'कलम, पेंसिल या लेखन सामग्री', sa: 'लेखनी कूर्चिका लेखनसामग्री वा' } },
    { name: { en: 'Musical instrument (veena if available)', hi: 'वाद्ययन्त्र (वीणा यदि उपलब्ध हो)', sa: 'वाद्ययन्त्रम् (वीणा यदि उपलभ्यते)' } },
    { name: { en: 'White cloth (for altar)', hi: 'श्वेत कपड़ा (वेदी के लिए)', sa: 'श्वेतवस्त्रम् (वेदिकायै)' } },
    ...
    { name: { en: 'Yellow rice (turmeric-tinted akshat)', hi: 'पीले चावल (हल्दी मिश्रित अक्षत)', sa: 'पीताक्षताः (हरिद्रामिश्रिताः)' } },
    { name: { en: 'Yellow sweets (kesar barfi, boondi laddoo)', hi: 'पीली मिठाई (केसर बर्फी, बूँदी लड्डू)', sa: 'पीतमिष्टान्नानि (केसरबर्फी, बून्दीमोदकानि)' } },
    ...
    { name: { en: 'Yellow cloth or dupatta (to wear)', hi: 'पीला कपड़ा या दुपट्टा (पहनने के लिए)', sa: 'पीतवस्त्रम् (धारणार्थम्)' } },
  ],
  ...
  aarti: {
    ...
    devanagari:
      'जय सरस्वती माता, मैया जय सरस्वती माता।\nसद्गुण वैभव शालिनि, त्रिभुवन विख्याता॥\nजय सरस्वती माता॥\n\nचन्द्र वदनि पद्मासिनि, द्युति मंगलकारी।\nसोहे शुभ हंसवाहिनि, अनुपम सुखकारी॥\nजय सरस्वती माता॥\n\nबायें कर में वीणा, दायें कर में माला।\nशीश मुकुट मणि शोभित, गल हार विशाला॥\nजय सरस्वती माता॥\n\nदेवी शरण जो आवें, उनका उद्धार किया।\nपैठी मन्दबुद्धि को, बुद्धि विद्या दिया॥\nजय सरस्वती माता॥\n\nतुम सम कौन दयालु, जग में दयामयी।\nरात-दिन तुमको ध्यावत, हे माँ करुणामयी॥\nजय सरस्वती माता॥',
    iast:
      'jaya sarasvatī mātā, maiyā jaya sarasvatī mātā |\nsadguṇa vaibhava śālinī, tribhuvana vikhyātā ||\njaya sarasvatī mātā ||\n\ncandra vadanī padmāsinī, dyuti maṅgalakārī |\nsohe śubha haṃsavāhinī, anupama sukhakārī ||\njaya sarasvatī mātā ||\n\nbāyeṃ kara meṃ vīṇā, dāyeṃ kara meṃ mālā |\nśīśa mukuṭa maṇi śobhita, gala hāra viśālā ||\njaya sarasvatī mātā ||\n\ndevī śaraṇa jo āveṃ, unakā uddhāra kiyā |\npaiṭhī mandabuddhi ko, buddhi vidyā diyā ||\njaya sarasvatī mātā ||\n\ntuma sama kauna dayālu, jaga meṃ dayāmayī |\nrāta-dina tumako dhyāvata, he māṃ karuṇāmayī ||\njaya sarasvatī mātā ||',
  },
