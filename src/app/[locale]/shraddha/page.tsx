...
function findTithiDateInYear(tithiNum: number, paksha: 'shukla' | 'krishna', year: number): string | null {
  ...
  for (let month = 1; month <= 12; month++) {
    ...
    for (let day = 1; day <= daysInMonth; day++) {
      const jd = dateToJD(year, month, day, 0.5); // ~noon IST
        ...
        {result && (
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }}>
            ...
            <div className="my-10 space-y-4">
              {result.date && (
                <div className="glass-card rounded-2xl p-8 border-2 border-gold-primary/30 bg-gradient-to-br from-gold-primary/5 to-transparent text-center">
              ...
              {result.nextDate && (
                <div className="glass-card rounded-xl p-6 text-center border border-gold-primary/10">
