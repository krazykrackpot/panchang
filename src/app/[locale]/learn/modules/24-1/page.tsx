...
const GANDA_MULA = [
  {
    id: 1, name: { en: 'Ashwini', hi: 'अश्विनी', sa: 'अश्विनी', mai: 'अश्विनी', mr: 'अश्विनी', ta: 'அஶ்விநீ', te: 'అశ్వినీ', bn: 'অশ্বিনী', kn: 'ಅಶ್ವಿನೀ', gu: 'અશ્વિની' }, sign: { en: 'Aries (Mesha)', hi: 'मेष', sa: 'मेष', mai: 'मेष', mr: 'मेष', ta: 'மேஷ', te: 'మేష', bn: 'মেষ', kn: 'ಮೇಷ', gu: 'મેષ' },
    ruler: { en: 'Ketu', hi: 'केतु', sa: 'केतु', mai: 'केतु', mr: 'केतु', ta: 'கேது', te: 'కేతు', bn: 'কেতু', kn: 'ಕೇತು', gu: 'કેતુ' }, deity: { en: 'Ashwini Kumaras (Divine Physicians)', hi: 'अश्विनी कुमार (दैवीय चिकित्सक)', sa: 'अश्विनी कुमार (दैवीय चिकित्सक)', mai: 'अश्विनी कुमार (दैवीय चिकित्सक)', mr: 'अश्विनी कुमार (दैवीय चिकित्सक)', ta: 'அஶ்விநீ குமார (தைவீய சிகித்ஸக)', te: 'అశ్వినీ కుమార (దైవీయ చికిత్సక)', bn: 'অশ্বিনী কুমার (দৈবীয চিকিত্সক)', kn: 'ಅಶ್ವಿನೀ ಕುಮಾರ (ದೈವೀಯ ಚಿಕಿತ್ಸಕ)', gu: 'અશ્વિની કુમાર (દૈવીય ચિકિત્સક)' },
    junction: { en: 'Pisces → Aries (Water → Fire)', hi: 'मीन → मेष (जल → अग्नि)', sa: 'मीन → मेष (जल → अग्नि)', mai: 'मीन → मेष (जल → अग्नि)', mr: 'मीन → मेष (जल → अग्नि)', ta: 'மீந → மேஷ (ஜல → அக்நி)', te: 'మీన → మేష (జల → అగ్ని)', bn: 'মীন → মেষ (জল → অগ্নি)', kn: 'ಮೀನ → ಮೇಷ (ಜಲ → ಅಗ್ನಿ)', gu: 'મીન → મેષ (જલ → અગ્નિ)' },
    affected: { en: 'Father', hi: 'पिता', sa: 'पिता', mai: 'पिता', mr: 'पिता', ta: 'பிதா', te: 'పితా', bn: 'পিতা', kn: 'ಪಿತಾ', gu: 'પિતા' },
    criticalPadas: '1, 2',
  ...
  {
    id: 9, name: { en: 'Ashlesha', hi: 'आश्लेषा', sa: 'आश्लेषा', mai: 'आश्लेषा', mr: 'आश्लेषा', ta: 'ஆஶ்லேஷா', te: 'ఆశ్లేషా', bn: 'আশ্লেষা', kn: 'ಆಶ್ಲೇಷಾ', gu: 'આશ્લેષા' }, sign: { en: 'Cancer (Karka)', hi: 'कर्क', sa: 'कर्क', mai: 'कर्क', mr: 'कर्क', ta: 'கர்க', te: 'కర్క', bn: 'কর্ক', kn: 'ಕರ್ಕ', gu: 'કર્ક' },
    ruler: { en: 'Mercury', hi: 'बुध', sa: 'बुध', mai: 'बुध', mr: 'बुध', ta: 'புध', te: 'బుధ', bn: 'বুধ', kn: 'ಬುಧ', gu: 'બુધ' }, deity: { en: 'Naga (Serpent deities)', hi: 'नाग (सर्प देवता)', sa: 'नाग (सर्प देवता)', mai: 'नाग (सर्प देवता)', mr: 'नाग (सर्प देवता)', ta: 'நாக (ஸர்ப தேவதா)', te: 'నాగ (సర్ప దేవతా)', bn: 'নাগ (সর্প দেবতা)', kn: 'ನಾಗ (ಸರ್ಪ ದೇವತಾ)', gu: 'નાગ (સર્પ દેવતા)' },
    junction: { en: 'Cancer → Leo (Water → Fire)', hi: 'कर्क → सिंह (जल → अग्नि)', sa: 'कर्क → सिंह (जल → अग्नि)', mai: 'कर्क → सिंह (जल → अग्नि)', mr: 'कर्क → सिंह (जल → अग्नि)', ta: 'கர்க → ஸிம்ஹ (ஜல → அக்நி)', te: 'కర్క → సింహ (జల → అగ్ని)', bn: 'কর্ক → সিংহ (জল → অগ্নি)', kn: 'ಕರ್ಕ → ಸಿಂಹ (ಜಲ → ಅಗ್ನಿ)', gu: 'કર્ક → સિંહ (જલ → અગ્નિ)' },
    affected: { en: 'Mother-in-law', hi: 'सास', sa: 'सास', mai: 'सास', mr: 'सास', ta: 'ஸாஸ', te: 'సాస', bn: 'সাস', kn: 'ಸಾಸ', gu: 'સાસ' },
    criticalPadas: '3, 4',
  ...
  {
    id: 10, name: { en: 'Magha', hi: 'मघा', sa: 'मघा', mai: 'मघा', mr: 'मघा', ta: 'மघா', te: 'మఘా', bn: 'মঘা', kn: 'ಮಘಾ', gu: 'મઘા' }, sign: { en: 'Leo (Simha)', hi: 'सिंह', sa: 'सिंह', mai: 'सिंह', mr: 'सिंह', ta: 'ஸிம்ஹ', te: 'సింహ', bn: 'সিংহ', kn: 'ಸಿಂಹ', gu: 'સિંહ' },
    ruler: { en: 'Ketu', hi: 'केतु', sa: 'केतु', mai: 'केतु', mr: 'केतु', ta: 'கேது', te: 'కేతు', bn: 'কেতু', kn: 'ಕೇತು', gu: 'કેતુ' }, deity: { en: 'Pitris (Ancestors)', hi: 'पितृ (पूर्वज)', sa: 'पितृ (पूर्वज)', mai: 'पितृ (पूर्वज)', mr: 'पितृ (पूर्वज)', ta: 'பிதிரு (பூர்வஜ)', te: 'పితృ (పూర్వజ)', bn: 'পিতৃ (পূর্বজ)', kn: 'ಪಿತೃ (ಪೂರ್ವಜ)', gu: 'પિતૃ (પૂર્વજ)' },
    junction: { en: 'Cancer → Leo (Water → Fire)', hi: 'कर्क → सिंह (जल → अग्नि)', sa: 'कर्क → सिंह (जल → अग्नि)', mai: 'कर्क → सिंह (जल → अग्नि)', mr: 'कर्क → सिंह (जल → अग्नि)', ta: 'கர்க → ஸிம்ஹ (ஜல → அக்நி)', te: 'కర్క → సింహ (జల → అగ్ని)', bn: 'কর্ক → সিংহ (জল → অগ্নি)', kn: 'ಕರ್ಕ → ಸಿಂಹ (ಜಲ → ಅಗ್ನಿ)', gu: 'કર્ક → સિંહ (જલ → અગ્નિ)' },
    affected: { en: 'Mother', hi: 'माता', sa: 'माता', mai: 'माता', mr: 'माता', ta: 'மாதா', te: 'మాతా', bn: 'মাতা', kn: 'ಮಾತಾ', gu: 'માતા' },
    criticalPadas: '1, 2',
  ...
  {
    id: 18, name: { en: 'Jyeshtha', hi: 'ज्येष्ठा', sa: 'ज्येष्ठा', mai: 'ज्येष्ठा', mr: 'ज्येष्ठा', ta: 'ஜ்யேஷ்ठா', te: 'జ్యేష్ఠా', bn: 'জ্যেষ্ঠা', kn: 'ಜ್ಯೇಷ್ಠಾ', gu: 'જ્યેષ્ઠા' }, sign: { en: 'Scorpio (Vrishchika)', hi: 'वृश्चिक', sa: 'वृश्चिक', mai: 'वृश्चिक', mr: 'वृश्चिक', ta: 'விருஶ்சிக', te: 'వృశ్చిక', bn: 'বৃশ্চিক', kn: 'ವೃಶ್ಚಿಕ', gu: 'વૃશ્ચિક' },
    ruler: { en: 'Mercury', hi: 'बुध', sa: 'बुध', mai: 'बुध', mr: 'बुध', ta: 'புध', te: 'బుధ', bn: 'বুধ', kn: 'ಬುಧ', gu: 'બુધ' }, deity: { en: 'Indra (King of Gods)', hi: 'इन्द्र (देवराज)', sa: 'इन्द्र (देवराज)', mai: 'इन्द्र (देवराज)', mr: 'इन्द्र (देवराज)', ta: 'இந்த்ர (தேவராஜ)', te: 'ఇన్ద్ర (దేవరాజ)', bn: 'ইন্দ্র (দেবরাজ)', kn: 'ಇನ್ದ್ರ (ದೇವರಾಜ)', gu: 'ઇન્દ્ર (દેવરાજ)' },
    junction: { en: 'Scorpio → Sagittarius (Water → Fire)', hi: 'वृश्चिक → धनु (जल → अग्नि)', sa: 'वृश्चिक → धनु (जल → अग्नि)', mai: 'वृश्चिक → धनु (जल → अग्नि)', mr: 'वृश्चिक → धनु (जल → अग्नि)', ta: 'விருஶ்சிக → धநு (ஜல → அக்நி)', te: 'వృశ్చిక → ధను (జల → అగ్ని)', bn: 'বৃশ্চিক → ধনু (জল → অগ্নি)', kn: 'ವೃಶ್ಚಿಕ → ಧನು (ಜಲ → ಅಗ್ನಿ)', gu: 'વૃશ્ચિક → ધનુ (જલ → અગ્નિ)' },
    affected: { en: 'Elder brother/sister', hi: 'बड़ा भाई/बहन', sa: 'बड़ा भाई/बहन', mai: 'बड़ा भाई/बहन', mr: 'बड़ा भाई/बहन', ta: 'பட़ா भாஈ/பஹந', te: 'బడ़ా భాఈ/బహన', bn: 'বড়া ভাঈ/বহন', kn: 'ಬಡ़ಾ ಭಾಈ/ಬಹನ', gu: 'બડ़ા ભાઈ/બહન' },
    criticalPadas: '3, 4',
  ...
  {
    id: 19, name: { en: 'Moola', hi: 'मूल', sa: 'मूल', mai: 'मूल', mr: 'मूल', ta: 'மூல', te: 'మూల', bn: 'মূল', kn: 'ಮೂಲ', gu: 'મૂલ' }, sign: { en: 'Sagittarius (Dhanu)', hi: 'धनु', sa: 'धनु', mai: 'धनु', mr: 'धनु', ta: 'धநு', te: 'ధను', bn: 'ধনু', kn: 'ಧನು', gu: 'ધનુ' },
    ruler: { en: 'Ketu', hi: 'केतु', sa: 'केतु', mai: 'केतु', mr: 'केतु', ta: 'கேது', te: 'కేతు', bn: 'কেতু', kn: 'ಕೇತು', gu: 'કેતુ' }, deity: { en: 'Nirriti (Goddess of Destruction)', hi: 'निर्ऋति (विनाश की देवी)', sa: 'निर्ऋति (विनाश की देवी)', mai: 'निर्ऋति (विनाश की देवी)', mr: 'निर्ऋति (विनाश की देवी)', ta: 'நிர்ऋதி (விநாஶ கீ தேவீ)', te: 'నిర్ఋతి (వినాశ కీ దేవీ)', bn: 'নির্ঋতি (বিনাশ কী দেবী)', kn: 'ನಿರ್ಋತಿ (ವಿನಾಶ ಕೀ ದೇವೀ)', gu: 'નિર્ઋતિ (વિનાશ કી દેવી)' },
    junction: { en: 'Scorpio → Sagittarius (Water → Fire)', hi: 'वृश्चिक → धनु (जल → अग्नि)', sa: 'वृश्चिक → धनु (जल → अग्नि)', mai: 'वृश्चिक → धनु (जल → अग्नि)', mr: 'वृश्चिक → धनु (जल → अग्नि)', ta: 'விருஶ்சிக → धநு (ஜல → அக்நி)', te: 'వృశ్చిక → ధను (జల → అగ్ని)', bn: 'বৃশ্চিক → ধনু (জল → অগ্নি)', kn: 'ವೃಶ್ಚಿಕ → ಧನು (ಜಲ → ಅಗ್ನಿ)', gu: 'વૃશ્ચિક → ધનુ (જલ → અગ્નિ)' },
    affected: { en: 'Father / family wealth', hi: 'पिता / पारिवारिक सम्पत्ति', sa: 'पिता / पारिवारिक सम्पत्ति', mai: 'पिता / पारिवारिक सम्पत्ति', mr: 'पिता / पारिवारिक सम्पत्ति', ta: 'பிதா / பாரிவாரிக ஸம்பத்தி', te: 'పితా / పారివారిక సమ్పత్తి', bn: 'পিতা / পারিবারিক সম্পত্তি', kn: 'ಪಿತಾ / ಪಾರಿವಾರಿಕ ಸಮ್ಪತ್ತಿ', gu: 'પિતા / પારિવારિક સમ્પત્તિ' },
    criticalPadas: '1',
  ...
  {
    id: 27, name: { en: 'Revati', hi: 'रेवती', sa: 'रेवती', mai: 'रेवती', mr: 'रेवती', ta: 'ரேவதீ', te: 'రేవతీ', bn: 'রেবতী', kn: 'ರೇವತೀ', gu: 'રેવતી' }, sign: { en: 'Pisces (Meena)', hi: 'मीन', sa: 'मीन', mai: 'मीन', mr: 'मीन', ta: 'மீந', te: 'మీన', bn: 'মীন', kn: 'ಮೀನ', gu: 'મીન' },
    ruler: { en: 'Mercury', hi: 'बुध', sa: 'बुध', mai: 'बुध', mr: 'बुध', ta: 'புध', te: 'బుధ', bn: 'বুধ', kn: 'ಬುಧ', gu: 'બુધ' }, deity: { en: 'Pushan (Nourisher, Protector of journeys)', hi: 'पूषन (पोषक, यात्रा रक्षक)', sa: 'पूषन (पोषक, यात्रा रक्षक)', mai: 'पूषन (पोषक, यात्रा रक्षक)', mr: 'पूषन (पोषक, यात्रा रक्षक)', ta: 'பூஷந (போஷக, யாத்ரா ரக்ஷக)', te: 'పూషన (పోషక, యాత్రా రక్షక)', bn: 'পূষন (পোষক, যাত্রা রক্ষক)', kn: 'ಪೂಷನ (ಪೋಷಕ, ಯಾತ್ರಾ ರಕ್ಷಕ)', gu: 'પૂષન (પોષક, યાત્રા રક્ષક)' },
    junction: { en: 'Pisces → Aries (Water → Fire)', hi: 'मीन → मेष (जल → अग्नि)', sa: 'मीन → मेष (जल → अग्नि)', mai: 'मीन → मेष (जल → अग्नि)', mr: 'मीन → मेष (जल → अग्नि)', ta: 'மீந → மேஷ (ஜல → அக்நி)', te: 'మీన → మేష (జల → అగ్ని)', bn: 'মীন → মেষ (জল → অগ্নি)', kn: 'ಮೀನ → ಮೇಷ (ಜಲ → ಅಗ್ನಿ)', gu: 'મીન → મેષ (જલ → અગ્નિ)' },
    affected: { en: 'Younger siblings', hi: 'छोटे भाई/बहन', sa: 'छोटे भाई/बहन', mai: 'छोटे भाई/बहन', mr: 'छोटे भाई/बहन', ta: 'छோடே भாஈ/பஹந', te: 'ఛోటే భాఈ/బహన', bn: 'ছোটে ভাঈ/বহন', kn: 'ಛೋಟೇ ಭಾಈ/ಬಹನ', gu: 'છોટે ભાઈ/બહન' },
    criticalPadas: '4',
