...
const NAKSHATRA_GROUPS = [
  { name: { en: 'Deva (Divine)', hi: 'देव (दैवी)', sa: 'देव (दैवी)', mai: 'देव (दैवी)', mr: 'देव (दैवी)', ta: 'Deva (Divine)', te: 'Deva (Divine)', bn: 'Deva (Divine)', kn: 'Deva (Divine)', gu: 'Deva (Divine)' }, nakshatras: 'Ashwini, Mrigashira, Punarvasu, Pushya, Hasta, Swati, Anuradha, Shravana, Revati', count: 9 },
  { name: { en: 'Manushya (Human)', hi: 'मनुष्य (मानवी)', sa: 'मनुष्य (मानवी)', mai: 'मनुष्य (मानवी)', mr: 'मनुष्य (मानवी)', ta: 'Manushya (Human)', te: 'Manushya (Human)', bn: 'Manushya (Human)', kn: 'Manushya (Human)', gu: 'Manushya (Human)' }, nakshatras: 'Bharani, Rohini, Ardra, P.Phalguni, U.Phalguni, P.Ashadha, U.Ashadha, P.Bhadra, U.Bhadra', count: 9 },
  { name: { en: 'Rakshasa (Fierce)', hi: 'राक्षस (आसुरी)', sa: 'राक्षस (आसुरी)', mai: 'राक्षस (आसुरी)', mr: 'राक्षस (आसुरी)', ta: 'Rakshasa (Fierce)', te: 'Rakshasa (Fierce)', bn: 'Rakshasa (Fierce)', kn: 'Rakshasa (Fierce)', gu: 'Rakshasa (Fierce)' }, nakshatras: 'Krittika, Ashlesha, Magha, Chitra, Vishakha, Jyeshtha, Moola, Dhanishta, Shatabhisha', count: 9 },
];
...
const NAKSHATRA_CATEGORIES = [
  { name: { en: 'Dhruva (Fixed)', hi: 'ध्रुव (स्थिर)', sa: 'ध्रुव (स्थिर)', mai: 'ध्रुव (स्थिर)', mr: 'ध्रुव (स्थिर)', ta: 'Dhruva (Fixed)', te: 'Dhruva (Fixed)', bn: 'Dhruva (Fixed)', kn: 'Dhruva (Fixed)', gu: 'Dhruva (Fixed)' }, color: '#3b82f6', desc: { en: 'Foundation laying, temples, permanent structures, planting trees', hi: 'नींव रखना, मन्दिर, स्थायी संरचनाएँ, वृक्षारोपण', sa: 'नींव रखना, मन्दिर, स्थायी संरचनाएँ, वृक्षारोपण', mai: 'नींव रखना, मन्दिर, स्थायी संरचनाएँ, वृक्षारोपण', mr: 'नींव रखना, मन्दिर, स्थायी संरचनाएँ, वृक्षारोपण', ta: 'Foundation laying, temples, permanent structures, planting trees', te: 'Foundation laying, temples, permanent structures, planting trees', bn: 'Foundation laying, temples, permanent structures, planting trees', kn: 'Foundation laying, temples, permanent structures, planting trees', gu: 'Foundation laying, temples, permanent structures, planting trees' }, nakshatras: 'Rohini, U.Phalguni, U.Ashadha, U.Bhadrapada' },
  { name: { en: 'Chara (Movable)', hi: 'चर (गतिशील)', sa: 'चर (गतिशील)', mai: 'चर (गतिशील)', mr: 'चर (गतिशील)', ta: 'Chara (Movable)', te: 'Chara (Movable)', bn: 'Chara (Movable)', kn: 'Chara (Movable)', gu: 'Chara (Movable)' }, color: '#22c55e', desc: { en: 'Travel, vehicle purchase, moving house, beginning journeys', hi: 'यात्रा, वाहन खरीद, गृह-प्रवेश, यात्रा प्रारम्भ', sa: 'यात्रा, वाहन खरीद, गृह-प्रवेश, यात्रा प्रारम्भ', mai: 'यात्रा, वाहन खरीद, गृह-प्रवेश, यात्रा प्रारम्भ', mr: 'यात्रा, वाहन खरीद, गृह-प्रवेश, यात्रा प्रारम्भ', ta: 'Travel, vehicle purchase, moving house, beginning journeys', te: 'Travel, vehicle purchase, moving house, beginning journeys', bn: 'Travel, vehicle purchase, moving house, beginning journeys', kn: 'Travel, vehicle purchase, moving house, beginning journeys', gu: 'Travel, vehicle purchase, moving house, beginning journeys' }, nakshatras: 'Punarvasu, Swati, Shravana, Dhanishta, Shatabhisha' },
  { name: { en: 'Ugra (Fierce)', hi: 'उग्र (प्रचण्ड)', sa: 'उग्र (प्रचण्ड)', mai: 'उग्र (प्रचण्ड)', mr: 'उग्र (प्रचण्ड)', ta: 'Ugra (Fierce)', te: 'Ugra (Fierce)', bn: 'Ugra (Fierce)', kn: 'Ugra (Fierce)', gu: 'Ugra (Fierce)' }, color: '#ef4444', desc: { en: 'Battles, surgery, demolition, confrontation, fire rituals', hi: 'युद्ध, शल्यचिकित्सा, ध्वंस, सामना, अग्नि अनुष्ठान', sa: 'युद्ध, शल्यचिकित्सा, ध्वंस, सामना, अग्नि अनुष्ठान', mai: 'युद्ध, शल्यचिकित्सा, ध्वंस, सामना, अग्नि अनुष्ठान', mr: 'युद्ध, शल्यचिकित्सा, ध्वंस, सामना, अग्नि अनुष्ठान', ta: 'Battles, surgery, demolition, confrontation, fire rituals', te: 'Battles, surgery, demolition, confrontation, fire rituals', bn: 'Battles, surgery, demolition, confrontation, fire rituals', kn: 'Battles, surgery, demolition, confrontation, fire rituals', gu: 'Battles, surgery, demolition, confrontation, fire rituals' }, nakshatras: 'Bharani, Magha, P.Phalguni, P.Ashadha, P.Bhadrapada' },
  { name: { en: 'Kshipra/Laghu (Swift/Light)', hi: 'क्षिप्र/लघु (शीघ्र)', sa: 'क्षिप्र/लघु (शीघ्र)', mai: 'क्षिप्र/लघु (शीघ्र)', mr: 'क्षिप्र/लघु (शीघ्र)', ta: 'Kshipra/Laghu (Swift/Light)', te: 'Kshipra/Laghu (Swift/Light)', bn: 'Kshipra/Laghu (Swift/Light)', kn: 'Kshipra/Laghu (Swift/Light)', gu: 'Kshipra/Laghu (Swift/Light)' }, color: '#f0d48a', desc: { en: 'Sports, trade, learning, medicine, quick tasks, travel', hi: 'खेल, व्यापार, अध्ययन, चिकित्सा, त्वरित कार्य', sa: 'खेल, व्यापार, अध्ययन, चिकित्सा, त्वरित कार्य', mai: 'खेल, व्यापार, अध्ययन, चिकित्सा, त्वरित कार्य', mr: 'खेल, व्यापार, अध्ययन, चिकित्सा, त्वरित कार्य', ta: 'Sports, trade, learning, medicine, quick tasks, travel', te: 'Sports, trade, learning, medicine, quick tasks, travel', bn: 'Sports, trade, learning, medicine, quick tasks, travel', kn: 'Sports, trade, learning, medicine, quick tasks, travel', gu: 'Sports, trade, learning, medicine, quick tasks, travel' }, nakshatras: 'Ashwini, Pushya, Hasta' },
  { name: { en: 'Mridu (Gentle)', hi: 'मृदु (कोमल)', sa: 'मृदु (कोमल)', mai: 'मृदु (कोमल)', mr: 'मृदु (कोमल)', ta: 'Mridu (Gentle)', te: 'Mridu (Gentle)', bn: 'Mridu (Gentle)', kn: 'Mridu (Gentle)', gu: 'Mridu (Gentle)' }, color: '#a78bfa', desc: { en: 'Music, art, romance, friendship, wearing new clothes, celebrations', hi: 'संगीत, कला, प्रेम, मित्रता, नये वस्त्र, उत्सव', sa: 'संगीत, कला, प्रेम, मित्रता, नये वस्त्र, उत्सव', mai: 'संगीत, कला, प्रेम, मित्रता, नये वस्त्र, उत्सव', mr: 'संगीत, कला, प्रेम, मित्रता, नये वस्त्र, उत्सव', ta: 'Music, art, romance, friendship, wearing new clothes, celebrations', te: 'Music, art, romance, friendship, wearing new clothes, celebrations', bn: 'Music, art, romance, friendship, wearing new clothes, celebrations', kn: 'Music, art, romance, friendship, wearing new clothes, celebrations', gu: 'Music, art, romance, friendship, wearing new clothes, celebrations' }, nakshatras: 'Mrigashira, Chitra, Anuradha, Revati' },
  { name: { en: 'Tikshna/Daruna (Sharp)', hi: 'तीक्ष्ण/दारुण (तीव्र)', sa: 'तीक्ष्ण/दारुण (तीव्र)', mai: 'तीक्ष्ण/दारुण (तीव्र)', mr: 'तीक्ष्ण/दारुण (तीव्र)', ta: 'Tikshna/Daruna (Sharp)', te: 'Tikshna/Daruna (Sharp)', bn: 'Tikshna/Daruna (Sharp)', kn: 'Tikshna/Daruna (Sharp)', gu: 'Tikshna/Daruna (Sharp)' }, color: '#f97316', desc: { en: 'Tantra, incantation, poisoning enemies, invoking spirits, black magic', hi: 'तन्त्र, मन्त्र, शत्रु-नाश, आत्मा-आवाहन', sa: 'तन्त्र, मन्त्र, शत्रु-नाश, आत्मा-आवाहन', mai: 'तन्त्र, मन्त्र, शत्रु-नाश, आत्मा-आवाहन', mr: 'तन्त्र, मन्त्र, शत्रु-नाश, आत्मा-आवाहन', ta: 'Tantra, incantation, poisoning enemies, invoking spirits, black magic', te: 'Tantra, incantation, poisoning enemies, invoking spirits, black magic', bn: 'Tantra, incantation, poisoning enemies, invoking spirits, black magic', kn: 'Tantra, incantation, poisoning enemies, invoking spirits, black magic', gu: 'Tantra, incantation, poisoning enemies, invoking spirits, black magic' }, nakshatras: 'Ardra, Ashlesha, Jyeshtha, Moola' },
  { name: { en: 'Mishra (Mixed)', hi: 'मिश्र (मिश्रित)', sa: 'मिश्र (मिश्रित)', mai: 'मिश्र (मिश्रित)', mr: 'मिश्र (मिश्रित)', ta: 'Mishra (Mixed)', te: 'Mishra (Mixed)', bn: 'Mishra (Mixed)', kn: 'Mishra (Mixed)', gu: 'Mishra (Mixed)' }, color: '#64748b', desc: { en: 'Day-to-day activities, routine work, worship, charity', hi: 'दैनिक गतिविधियाँ, नियमित कार्य, पूजा, दान', sa: 'दैनिक गतिविधियाँ, नियमित कार्य, पूजा, दान', mai: 'दैनिक गतिविधियाँ, नियमित कार्य, पूजा, दान', mr: 'दैनिक गतिविधियाँ, नियमित कार्य, पूजा, दान', ta: 'Day-to-day activities, routine work, worship, charity', te: 'Day-to-day activities, routine work, worship, charity', bn: 'Day-to-day activities, routine work, worship, charity', kn: 'Day-to-day activities, routine work, worship, charity', gu: 'Day-to-day activities, routine work, worship, charity' }, nakshatras: 'Krittika, Vishakha' },
];

const TARA_NAMES = [
  { num: 1, name: { en: 'Janma (Birth)', hi: 'जन्म', sa: 'जन्म', mai: 'जन्म', mr: 'जन्म', ta: 'Janma (Birth)', te: 'Janma (Birth)', bn: 'Janma (Birth)', kn: 'Janma (Birth)', gu: 'Janma (Birth)' }, effect: { en: 'Moderate -- needs care. Physical health sensitive.', hi: 'मध्यम -- सावधानी। शारीरिक स्वास्थ्य संवेदनशील।', sa: 'मध्यम -- सावधानी। शारीरिक स्वास्थ्य संवेदनशील।', mai: 'मध्यम -- सावधानी। शारीरिक स्वास्थ्य संवेदनशील।', mr: 'मध्यम -- सावधानी। शारीरिक स्वास्थ्य संवेदनशील।', ta: 'Moderate -- needs care. Physical health sensitive.', te: 'Moderate -- needs care. Physical health sensitive.', bn: 'Moderate -- needs care. Physical health sensitive.', kn: 'Moderate -- needs care. Physical health sensitive.', gu: 'Moderate -- needs care. Physical health sensitive.' }, good: false },
  { num: 2, name: { en: 'Sampat (Wealth)', hi: 'सम्पत्', sa: 'सम्पत्', mai: 'सम्पत्', mr: 'सम्पत्', ta: 'Sampat (Wealth)', te: 'Sampat (Wealth)', bn: 'Sampat (Wealth)', kn: 'Sampat (Wealth)', gu: 'Sampat (Wealth)' }, effect: { en: 'Favorable. Financial gains, prosperity.', hi: 'शुभ। वित्तीय लाभ, समृद्धि।', sa: 'शुभ। वित्तीय लाभ, समृद्धि।', mai: 'शुभ। वित्तीय लाभ, समृद्धि।', mr: 'शुभ। वित्तीय लाभ, समृद्धि।', ta: 'Favorable. Financial gains, prosperity.', te: 'Favorable. Financial gains, prosperity.', bn: 'Favorable. Financial gains, prosperity.', kn: 'Favorable. Financial gains, prosperity.', gu: 'Favorable. Financial gains, prosperity.' }, good: true },
  { num: 3, name: { en: 'Vipat (Danger)', hi: 'विपत्', sa: 'विपत्', mai: 'विपत्', mr: 'विपत्', ta: 'Vipat (Danger)', te: 'Vipat (Danger)', bn: 'Vipat (Danger)', kn: 'Vipat (Danger)', gu: 'Vipat (Danger)' }, effect: { en: 'Unfavorable. Obstacles, losses.', hi: 'अशुभ। बाधाएँ, हानि।', sa: 'अशुभ। बाधाएँ, हानि।', mai: 'अशुभ। बाधाएँ, हानि।', mr: 'अशुभ। बाधाएँ, हानि।', ta: 'Unfavorable. Obstacles, losses.', te: 'Unfavorable. Obstacles, losses.', bn: 'Unfavorable. Obstacles, losses.', kn: 'Unfavorable. Obstacles, losses.', gu: 'Unfavorable. Obstacles, losses.' }, good: false },
  { num: 4, name: { en: 'Kshema (Well-being)', hi: 'क्षेम', sa: 'क्षेम', mai: 'क्षेम', mr: 'क्षेम', ta: 'Kshema (Well-being)', te: 'Kshema (Well-being)', bn: 'Kshema (Well-being)', kn: 'Kshema (Well-being)', gu: 'Kshema (Well-being)' }, effect: { en: 'Favorable. Safety, peace, comfort.', hi: 'शुभ। सुरक्षा, शान्ति, सुख।', sa: 'शुभ। सुरक्षा, शान्ति, सुख।', mai: 'शुभ। सुरक्षा, शान्ति, सुख।', mr: 'शुभ। सुरक्षा, शान्ति, सुख।', ta: 'Favorable. Safety, peace, comfort.', te: 'Favorable. Safety, peace, comfort.', bn: 'Favorable. Safety, peace, comfort.', kn: 'Favorable. Safety, peace, comfort.', gu: 'Favorable. Safety, peace, comfort.' }, good: true },
  { num: 5, name: { en: 'Pratyari (Obstacle)', hi: 'प्रत्यरि', sa: 'प्रत्यरि', mai: 'प्रत्यरि', mr: 'प्रत्यरि', ta: 'Pratyari (Obstacle)', te: 'Pratyari (Obstacle)', bn: 'Pratyari (Obstacle)', kn: 'Pratyari (Obstacle)', gu: 'Pratyari (Obstacle)' }, effect: { en: 'Unfavorable. Opposition, enemies.', hi: 'अशुभ। विरोध, शत्रुता।', sa: 'अशुभ। विरोध, शत्रुता।', mai: 'अशुभ। विरोध, शत्रुता।', mr: 'अशुभ। विरोध, शत्रुता।', ta: 'Unfavorable. Opposition, enemies.', te: 'Unfavorable. Opposition, enemies.', bn: 'Unfavorable. Opposition, enemies.', kn: 'Unfavorable. Opposition, enemies.', gu: 'Unfavorable. Opposition, enemies.' }, good: false },
  { num: 6, name: { en: 'Sadhaka (Achievement)', hi: 'साधक', sa: 'साधक', mai: 'साधक', mr: 'साधक', ta: 'Sadhaka (Achievement)', te: 'Sadhaka (Achievement)', bn: 'Sadhaka (Achievement)', kn: 'Sadhaka (Achievement)', gu: 'Sadhaka (Achievement)' }, effect: { en: 'Favorable. Accomplishment, success.', hi: 'शुभ। उपलब्धि, सफलता।', sa: 'शुभ। उपलब्धि, सफलता।', mai: 'शुभ। उपलब्धि, सफलता।', mr: 'शुभ। उपलब्धि, सफलता।', ta: 'Favorable. Accomplishment, success.', te: 'Favorable. Accomplishment, success.', bn: 'Favorable. Accomplishment, success.', kn: 'Favorable. Accomplishment, success.', gu: 'Favorable. Accomplishment, success.' }, good: true },
  { num: 7, name: { en: 'Vadha (Death)', hi: 'वध', sa: 'वध', mai: 'वध', mr: 'वध', ta: 'Vadha (Death)', te: 'Vadha (Death)', bn: 'Vadha (Death)', kn: 'Vadha (Death)', gu: 'Vadha (Death)' }, effect: { en: 'Unfavorable. Conflict, harm.', hi: 'अशुभ। संघर्ष, हानि।', sa: 'अशुभ। संघर्ष, हानि।', mai: 'अशुभ। संघर्ष, हानि।', mr: 'अशुभ। संघर्ष, हानि।', ta: 'Unfavorable. Conflict, harm.', te: 'Unfavorable. Conflict, harm.', bn: 'Unfavorable. Conflict, harm.', kn: 'Unfavorable. Conflict, harm.', gu: 'Unfavorable. Conflict, harm.' }, good: false },
  { num: 8, name: { en: 'Mitra (Friend)', hi: 'मित्र', sa: 'मित्र', mai: 'मित्र', mr: 'मित्र', ta: 'Mitra (Friend)', te: 'Mitra (Friend)', bn: 'Mitra (Friend)', kn: 'Mitra (Friend)', gu: 'Mitra (Friend)' }, effect: { en: 'Favorable. Friendships, alliances.', hi: 'शुभ। मित्रता, सहयोग।', sa: 'शुभ। मित्रता, सहयोग।', mai: 'शुभ। मित्रता, सहयोग।', mr: 'शुभ। मित्रता, सहयोग।', ta: 'Favorable. Friendships, alliances.', te: 'Favorable. Friendships, alliances.', bn: 'Favorable. Friendships, alliances.', kn: 'Favorable. Friendships, alliances.', gu: 'Favorable. Friendships, alliances.' }, good: true },
  { num: 9, name: { en: 'Atimitra (Great friend)', hi: 'अतिमित्र', sa: 'अतिमित्र', mai: 'अतिमित्र', mr: 'अतिमित्र', ta: 'Atimitra (Great friend)', te: 'Atimitra (Great friend)', bn: 'Atimitra (Great friend)', kn: 'Atimitra (Great friend)', gu: 'Atimitra (Great friend)' }, effect: { en: 'Very favorable. Deep support, blessings.', hi: 'अत्यन्त शुभ। गहन सहयोग, आशीर्वाद।', sa: 'अत्यन्त शुभ। गहन सहयोग, आशीर्वाद।', mai: 'अत्यन्त शुभ। गहन सहयोग, आशीर्वाद।', mr: 'अत्यन्त शुभ। गहन सहयोग, आशीर्वाद।', ta: 'Very favorable. Deep support, blessings.', te: 'Very favorable. Deep support, blessings.', bn: 'Very favorable. Deep support, blessings.', kn: 'Very favorable. Deep support, blessings.', gu: 'Very favorable. Deep support, blessings.' }, good: true },
];

const MATCHING_KUTAS = [
  { name: { en: 'Yoni Kuta (4 pts)', hi: 'योनि कूट (4 अंक)', sa: 'योनि कूट (4 अंक)', mai: 'योनि कूट (4 अंक)', mr: 'योनि कूट (4 अंक)', ta: 'Yoni Kuta (4 pts)', te: 'Yoni Kuta (4 pts)', bn: 'Yoni Kuta (4 pts)', kn: 'Yoni Kuta (4 pts)', gu: 'Yoni Kuta (4 pts)' }, desc: { en: 'Each Nakshatra is mapped to an animal (Yoni): Horse, Elephant, Sheep, Serpent, Dog, Cat, Rat, Cow, Buffalo, Tiger, Deer, Monkey, Mongoose, Lion. Same Yoni = 4 pts. Enemy Yonis (e.g., Cat-Rat, Snake-Mongoose) = 0 pts. This assesses physical and sexual compatibility.', hi: 'प्रत्येक नक्षत्र एक पशु (योनि) से मेल खाता है: अश्व, गज, मेष, सर्प, श्वान, मार्जार, मूषक, गौ, महिष, व्याघ्र, मृग, वानर, नकुल, सिंह। समान योनि = 4 अंक। शत्रु योनियाँ = 0 अंक। यह शारीरिक अनुकूलता का मूल्यांकन करता है।', sa: 'प्रत्येक नक्षत्र एक पशु (योनि) से मेल खाता है: अश्व, गज, मेष, सर्प, श्वान, मार्जार, मूषक, गौ, महिष, व्याघ्र, मृग, वानर, नकुल, सिंह। समान योनि = 4 अंक। शत्रु योनियाँ = 0 अंक। यह शारीरिक अनुकूलता का मूल्यांकन करता है।', mai: 'प्रत्येक नक्षत्र एक पशु (योनि) से मेल खाता है: अश्व, गज, मेष, सर्प, श्वान, मार्जार, मूषक, गौ, महिष, व्याघ्र, मृग, वानर, नकुल, सिंह। समान योनि = 4 अंक। शत्रु योनियाँ = 0 अंक। यह शारीरिक अनुकूलता का मूल्यांकन करता है।', mr: 'प्रत्येक नक्षत्र एक पशु (योनि) से मेल खाता है: अश्व, गज, मेष, सर्प, श्वान, मार्जार, मूषक, गौ, महिष, व्याघ्र, मृग, वानर, नकुल, सिंह। समान योनि = 4 अंक। शत्रु योनियाँ = 0 अंक। यह शारीरिक अनुकूलता का मूल्यांकन करता है।', ta: 'Each Nakshatra is mapped to an animal (Yoni): Horse, Elephant, Sheep, Serpent, Dog, Cat, Rat, Cow, Buffalo, Tiger, Deer, Monkey, Mongoose, Lion. Same Yoni = 4 pts. Enemy Yonis (e.g., Cat-Rat, Snake-Mongoose) = 0 pts. This assesses physical and sexual compatibility.', te: 'Each Nakshatra is mapped to an animal (Yoni): Horse, Elephant, Sheep, Serpent, Dog, Cat, Rat, Cow, Buffalo, Tiger, Deer, Monkey, Mongoose, Lion. Same Yoni = 4 pts. Enemy Yonis (e.g., Cat-Rat, Snake-Mongoose) = 0 pts. This assesses physical and sexual compatibility.', bn: 'Each Nakshatra is mapped to an animal (Yoni): Horse, Elephant, Sheep, Serpent, Dog, Cat, Rat, Cow, Buffalo, Tiger, Deer, Monkey, Mongoose, Lion. Same Yoni = 4 pts. Enemy Yonis (e.g., Cat-Rat, Snake-Mongoose) = 0 pts. This assesses physical and sexual compatibility.', kn: 'Each Nakshatra is mapped to an animal (Yoni): Horse, Elephant, Sheep, Serpent, Dog, Cat, Rat, Cow, Buffalo, Tiger, Deer, Monkey, Mongoose, Lion. Same Yoni = 4 pts. Enemy Yonis (e.g., Cat-Rat, Snake-Mongoose) = 0 pts. This assesses physical and sexual compatibility.', gu: 'Each Nakshatra is mapped to an animal (Yoni): Horse, Elephant, Sheep, Serpent, Dog, Cat, Rat, Cow, Buffalo, Tiger, Deer, Monkey, Mongoose, Lion. Same Yoni = 4 pts. Enemy Yonis (e.g., Cat-Rat, Snake-Mongoose) = 0 pts. This assesses physical and sexual compatibility.' } },
  { name: { en: 'Gana Kuta (6 pts)', hi: 'गण कूट (6 अंक)', sa: 'गण कूट (6 अंक)', mai: 'गण कूट (6 अंक)', mr: 'गण कूट (6 अंक)', ta: 'Gana Kuta (6 pts)', te: 'Gana Kuta (6 pts)', bn: 'Gana Kuta (6 pts)', kn: 'Gana Kuta (6 pts)', gu: 'Gana Kuta (6 pts)' }, desc: { en: 'Deva-Deva = 6, Manushya-Manushya = 6, Rakshasa-Rakshasa = 6. Deva-Manushya = 5. Deva-Rakshasa = 0. Manushya-Rakshasa = 1. Assesses temperamental and social compatibility.', hi: 'देव-देव = 6, मनुष्य-मनुष्य = 6, राक्षस-राक्षस = 6। देव-मनुष्य = 5। देव-राक्षस = 0। मनुष्य-राक्षस = 1। स्वभाव और सामाजिक अनुकूलता का मूल्यांकन करता है।', sa: 'देव-देव = 6, मनुष्य-मनुष्य = 6, राक्षस-राक्षस = 6। देव-मनुष्य = 5। देव-राक्षस = 0। मनुष्य-राक्षस = 1। स्वभाव और सामाजिक अनुकूलता का मूल्यांकन करता है।', mai: 'देव-देव = 6, मनुष्य-मनुष्य = 6, राक्षस-राक्षस = 6। देव-मनुष्य = 5। देव-राक्षस = 0। मनुष्य-राक्षस = 1। स्वभाव और सामाजिक अनुकूलता का मूल्यांकन करता है।', mr: 'देव-देव = 6, मनुष्य-मनुष्य = 6, राक्षस-राक्षस = 6। देव-मनुष्य = 5। देव-राक्षस = 0। मनुष्य-राक्षस = 1। स्वभाव और सामाजिक अनुकूलता का मूल्यांकन करता है।', ta: 'Deva-Deva = 6, Manushya-Manushya = 6, Rakshasa-Rakshasa = 6. Deva-Manushya = 5. Deva-Rakshasa = 0. Manushya-Rakshasa = 1. Assesses temperamental and social compatibility.', te: 'Deva-Deva = 6, Manushya-Manushya = 6, Rakshasa-Rakshasa = 6. Deva-Manushya = 5. Deva-Rakshasa = 0. Manushya-Rakshasa = 1. Assesses temperamental and social compatibility.', bn: 'Deva-Deva = 6, Manushya-Manushya = 6, Rakshasa-Rakshasa = 6. Deva-Manushya = 5. Deva-Rakshasa = 0. Manushya-Rakshasa = 1. Assesses temperamental and social compatibility.', kn: 'Deva-Deva = 6, Manushya-Manushya = 6, Rakshasa-Rakshasa = 6. Deva-Manushya = 5. Deva-Rakshasa = 0. Manushya-Rakshasa = 1. Assesses temperamental and social compatibility.', gu: 'Deva-Deva = 6, Manushya-Manushya = 6, Rakshasa-Rakshasa = 6. Deva-Manushya = 5. Deva-Rakshasa = 0. Manushya-Rakshasa = 1. Assesses temperamental and social compatibility.' } },
  { name: { en: 'Nadi Kuta (8 pts)', hi: 'नाडी कूट (8 अंक)', sa: 'नाडी कूट (8 अंक)', mai: 'नाडी कूट (8 अंक)', mr: 'नाडी कूट (8 अंक)', ta: 'Nadi Kuta (8 pts)', te: 'Nadi Kuta (8 pts)', bn: 'Nadi Kuta (8 pts)', kn: 'Nadi Kuta (8 pts)', gu: 'Nadi Kuta (8 pts)' }, desc: { en: 'The highest-weighted factor. Each Nakshatra belongs to one of 3 Nadis: Aadi (Vata), Madhya (Pitta), Antya (Kapha). Same Nadi = 0 (Nadi Dosha -- risk to progeny). Different Nadi = 8. This is the only factor with a binary outcome: full points or zero.', hi: 'सबसे अधिक भार वाला कारक। प्रत्येक नक्षत्र 3 नाडियों में से एक का है: आदि (वात), मध्य (पित्त), अन्त्य (कफ)। समान नाडी = 0 (नाडी दोष)। भिन्न नाडी = 8।', sa: 'सबसे अधिक भार वाला कारक। प्रत्येक नक्षत्र 3 नाडियों में से एक का है: आदि (वात), मध्य (पित्त), अन्त्य (कफ)। समान नाडी = 0 (नाडी दोष)। भिन्न नाडी = 8।', mai: 'सबसे अधिक भार वाला कारक। प्रत्येक नक्षत्र 3 नाडियों में से एक का है: आदि (वात), मध्य (पित्त), अन्त्य (कफ)। समान नाडी = 0 (नाडी दोष)। भिन्न नाडी = 8।', mr: 'सबसे अधिक भार वाला कारक। प्रत्येक नक्षत्र 3 नाडियों में से एक का है: आदि (वात), मध्य (पित्त), अन्त्य (कफ)। समान नाडी = 0 (नाडी दोष)। भिन्न नाडी = 8।', ta: 'The highest-weighted factor. Each Nakshatra belongs to one of 3 Nadis: Aadi (Vata), Madhya (Pitta), Antya (Kapha). Same Nadi = 0 (Nadi Dosha -- risk to progeny). Different Nadi = 8. This is the only factor with a binary outcome: full points or zero.', te: 'The highest-weighted factor. Each Nakshatra belongs to one of 3 Nadis: Aadi (Vata), Madhya (Pitta), Antya (Kapha). Same Nadi = 0 (Nadi Dosha -- risk to progeny). Different Nadi = 8. This is the only factor with a binary outcome: full points or zero.', bn: 'The highest-weighted factor. Each Nakshatra belongs to one of 3 Nadis: Aadi (Vata), Madhya (Pitta), Antya (Kapha). Same Nadi = 0 (Nadi Dosha -- risk to progeny). Different Nadi = 8. This is the only factor with a binary outcome: full points or zero.', kn: 'The highest-weighted factor. Each Nakshatra belongs to one of 3 Nadis: Aadi (Vata), Madhya (Pitta), Antya (Kapha). Same Nadi = 0 (Nadi Dosha -- risk to progeny). Different Nadi = 8. This is the only factor with a binary outcome: full points or zero.', gu: 'The highest-weighted factor. Each Nakshatra belongs to one of 3 Nadis: Aadi (Vata), Madhya (Pitta), Antya (Kapha). Same Nadi = 0 (Nadi Dosha -- risk to progeny). Different Nadi = 8. This is the only factor with a binary outcome: full points or zero.' } },
];
