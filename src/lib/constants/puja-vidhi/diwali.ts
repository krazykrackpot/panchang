...
export const DIWALI_PUJA: PujaVidhi = {
  ...
  samagri: [
    { name: { en: 'New Lakshmi-Ganesha idols or images', hi: 'नई लक्ष्मी-गणेश मूर्तियाँ या चित्र', sa: 'नवलक्ष्मीगणेशमूर्ती अथवा चित्रे' } },
    { name: { en: 'Red cloth (for puja platform)', hi: 'लाल कपड़ा (पूजा चौकी के लिए)', sa: 'रक्तवस्त्रम् (पूजावेदिकायै)' } },
    { name: { en: 'Coins and currency notes', hi: 'सिक्के और नोट', sa: 'मुद्राः नोटाः च' } },
    { name: { en: 'Lotus flowers', hi: 'कमल के फूल', sa: 'कमलपुष्पाणि' } },
    ...
    { name: { en: 'Cloves', hi: 'लौंग', sa: 'लवङ्गम्' }, quantity: '5' },
    ...
    { name: { en: 'Ghee lamps (diyas)', hi: 'घी के दीपक', sa: 'घृतदीपाः' }, quantity: '13', note: { en: 'Traditionally 13 diyas are lit', hi: 'परम्परानुसार 13 दीपक जलाए जाते हैं', sa: 'परम्परया त्रयोदश दीपाः प्रज्वाल्यन्ते' } },
    { name: { en: 'Camphor', hi: 'कपूर', sa: 'कर्पूरम्' } },
    { name: { en: 'Coconut', hi: 'नारियल', sa: 'नारिकेलम्' }, quantity: '1' },
    { name: { en: 'Fruits (banana, apple, pomegranate)', hi: 'फल (केला, सेब, अनार)', sa: 'फलानि (कदलीफलम्, सेवफलम्, दाडिमम्)' } },
    { name: { en: 'Sweets (mithai)', hi: 'मिठाई', sa: 'मिष्टान्नानि' } },
    { name: { en: 'New account book (Bahi Khata)', hi: 'नया बही खाता', sa: 'नवलेखापुस्तकम्' } },
    { name: { en: 'New pen (red ink preferred)', hi: 'नई कलम (लाल स्याही वाली)', sa: 'नवलेखनी (रक्तमष्या)' } },
    { name: { en: 'Conch shell (Shankh)', hi: 'शंख', sa: 'शङ्खः' } },
