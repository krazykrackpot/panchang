...
export const FAQ_DATA: Record<string, FAQEntry[]> = {
  ...
  // /vs/* FAQ blocks (prokerala, astrosage, mpanchang) removed May 2026
  // per feedback_no_competitor_references.md. The corresponding pages,
  // PAGE_META entries, sitemap entries, and BreadcrumbList labels were
  // all stripped in the same PR.
