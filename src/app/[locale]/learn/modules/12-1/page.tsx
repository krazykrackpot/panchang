    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          What Are Transits? / गोचर क्या है?
        </h3>
      ...
      <section className="glass-card rounded-xl p-5 border border-gold-primary/10">
        <h4 className="text-gold-dark text-[10px] uppercase tracking-widest font-bold mb-3">Slow Planets — Major Life Themes / मन्द ग्रह — प्रमुख जीवन विषय</h4>
      ...
      <section className="glass-card rounded-xl p-5 border border-purple-500/15">
        <h4 className="text-purple-300 text-[10px] uppercase tracking-widest font-bold mb-3">Fast Planets — Event Triggers / तीव्र ग्रह — घटना प्रेरक</h4>
        <p className="text-text-secondary text-sm leading-relaxed mb-2">
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Transit from Moon Sign / चन्द्र राशि से गोचर
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          In Vedic astrology, the Moon sign (Janma Rashi) is the primary reference point for evaluating transits, unlike Western astrology which uses the Sun sign. The Moon represents the mind (Manas), emotional experience, and the subjective lens through which we perceive life events. Since transit effects are fundamentally about how we experience changing circumstances, Chandra Lagna is the natural anchor.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          वैदिक ज्योतिष में चन्द्र राशि (जन्म राशि) गोचर मूल्यांकन का प्राथमिक सन्दर्भ बिन्दु है, पश्चिमी ज्योतिष के विपरीत जो सूर्य राशि का उपयोग करता है। चन्द्रमा मन (मनस), भावनात्मक अनुभव और उस व्यक्तिपरक दृष्टि का प्रतिनिधि है जिससे हम जीवन की घटनाओं को देखते हैं। चूँकि गोचर फल मूलतः बदलती परिस्थितियों के अनुभव के बारे में है, चन्द्र लग्न स्वाभाविक आधार है।
        </p>
      </section>

      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">Jupiter Transit Results / गुरु गोचर फल</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Favorable (2, 5, 7, 9, 11 from Moon):</span> Jupiter in the 2nd brings wealth and family harmony; in the 5th, intelligence, children, and spiritual merit; in the 7th, marriage and partnerships; in the 9th, fortune, dharma, and guru blessings; in the 11th, gains, fulfillment of desires, and social success.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">शुभ (चन्द्र से 2, 5, 7, 9, 11):</span> 2वें में गुरु धन और पारिवारिक सामंजस्य लाता है; 5वें में बुद्धि, सन्तान और पुण्य; 7वें में विवाह और साझेदारी; 9वें में भाग्य, धर्म और गुरु कृपा; 11वें में लाभ, इच्छापूर्ति और सामाजिक सफलता।
        </p>
      ...
      <section className="glass-card rounded-xl p-5 border border-blue-500/15">
        <h4 className="text-blue-300 text-[10px] uppercase tracking-widest font-bold mb-3">Saturn Transit Results / शनि गोचर फल</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-emerald-400 font-medium">Favorable (3, 6, 11 from Moon):</span> Saturn in the 3rd gives courage and victory over rivals; in the 6th, defeat of enemies and improved health; in the 11th, financial gains and achievement of long-term goals. These are Saturn&apos;s only comfortable positions from the Moon.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-emerald-400 font-medium">शुभ (चन्द्र से 3, 6, 11):</span> 3वें में शनि साहस और प्रतिद्वन्द्वियों पर विजय देता है; 6वें में शत्रु पराजय और स्वास्थ्य सुधार; 11वें में आर्थिक लाभ और दीर्घकालिक लक्ष्यों की प्राप्ति। चन्द्रमा से ये शनि की एकमात्र सुखद स्थितियाँ हैं।
        </p>
      </section>
    </div>
  );
...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Ashtakavarga System / अष्टकवर्ग पद्धति
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          The Ashtakavarga system is one of the most powerful tools for refining transit predictions. Each of the 7 planets (Sun through Saturn) receives benefic points (bindus) in each of the 12 signs from 8 sources: the 7 planets plus the Lagna. The maximum bindus a planet can receive in any sign is 8. If a planet has 4 or more bindus in a sign, its transit through that sign tends to be favorable; with 0-3 bindus, the transit is likely challenging.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          अष्टकवर्ग पद्धति गोचर भविष्यवाणी को सूक्ष्म बनाने का सर्वाधिक शक्तिशाली उपकरण है। 7 ग्रहों (सूर्य से शनि तक) में प्रत्येक को 12 राशियों में 8 स्रोतों से शुभ बिन्दु प्राप्त होते हैं: 7 ग्रह और लग्न। किसी राशि में ग्रह को अधिकतम 8 बिन्दु मिल सकते हैं। यदि ग्रह को किसी राशि में 4 या अधिक बिन्दु हों, तो उस राशि में उसका गोचर शुभ रहता है; 0-3 बिन्दु हों तो गोचर कठिन रहने की सम्भावना है।
        </p>
      </section>

      <section className="glass-card rounded-xl p-5 border border-gold-primary/10">
        <h4 className="text-gold-dark text-[10px] uppercase tracking-widest font-bold mb-3">Sarvashtakavarga (SAV) / सर्वाष्टकवर्ग</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Total Score:</span> The Sarvashtakavarga combines all 7 individual planet Ashtakavarga charts into one summary. Each sign gets a total score out of 56 (7 planets x 8 maximum bindus). Signs with 28 or more SAV points are generally auspicious — planets transiting these signs deliver better results regardless of the general transit rule.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">कुल अंक:</span> सर्वाष्टकवर्ग सभी 7 ग्रहों के व्यक्तिगत अष्टकवर्ग को एक सारांश में जोड़ता है। प्रत्येक राशि को 56 में से कुल अंक मिलता है (7 ग्रह x अधिकतम 8 बिन्दु)। 28 या अधिक SAV अंक वाली राशियाँ सामान्यतः शुभ हैं — इन राशियों से गोचर करने वाले ग्रह सामान्य गोचर नियम की परवाह किए बिना बेहतर फल देते हैं।
        </p>
      </section>

      <section className="glass-card rounded-xl p-5 border border-amber-500/15">
        <h4 className="text-amber-400 text-[10px] uppercase tracking-widest font-bold mb-3">Practical Application / व्यावहारिक प्रयोग</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Example:</span> Saturn transiting the 8th from Moon is generally very difficult. But if Saturn has 5 bindus in that sign in the native&apos;s Ashtakavarga chart, the transit will be significantly mitigated — challenges exist but are manageable and may even bring hidden gains (8th house transformation).
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">उदाहरण:</span> चन्द्र से 8वें भाव में शनि गोचर सामान्यतः अत्यन्त कठिन है। परन्तु यदि जातक के अष्टकवर्ग में उस राशि में शनि के 5 बिन्दु हों, तो गोचर काफी शमित होगा — चुनौतियाँ हैं परन्तु सम्भालने योग्य हैं और छिपे लाभ भी ला सकता है (8वें भाव का रूपान्तरण)।
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
