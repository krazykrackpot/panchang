...
export default function LearnAvasthasPage() {
  ...
  const JAGRA_STATES = [
    ...
    { name: { en: 'Sushupti (Deep Sleep)', hi: 'सुषुप्ति', sa: 'सुषुप्ति', mai: 'सुषुप्ति', mr: 'सुषुप्ति', ta: 'சுஷுப்தி (ஆழ்நிலை)', te: 'సుషుప్తి (గాఢనిద్ర)', bn: 'সুষুপ্তি (গভীর নিদ্রা)', kn: 'ಸುಷುಪ್ತಿ (ಗಾಢ ನಿದ್ರೆ)', gu: 'સુષુપ્તિ (ગાઢ નિદ્રા)' }, condition: { en: 'Planet in enemy sign or debilitation', hi: 'ग्रह शत्रु राशि या नीच में', sa: 'ग्रह शत्रु राशि या नीच में', mai: 'ग्रह शत्रु राशि या नीच में', mr: 'ग्रह शत्रु राशि या नीच में', ta: 'பகை ராசி அல்லது நீச ராசியில் கிரகம்', te: 'శత్రు రాశి లేదా నీచ రాశిలో గ్రహం', bn: 'শত্রু রাশি বা নীচ রাশিতে গ্রহ', kn: 'ಶತ್ರು ರಾಶಿ ಅಥವಾ ನೀಚ ರಾಶಿಯಲ್ಲಿ ಗ್ರಹ', gu: 'શત્રુ રાશિ અથવા નીચ રાશિમાં ગ્રહ' }, result: { en: 'Dormant — significations suppressed, results blocked or severely delayed. The planet struggles to express itself.', hi: 'सुप्त — कारकत्व दबे, फल अवरुद्ध या अत्यधिक विलम्बित।', sa: 'सुप्त — कारकत्व दबे, फल अवरुद्ध या अत्यधिक विलम्बित।', mai: 'सुप्त — कारकत्व दबे, फल अवरुद्ध या अत्यधिक विलम्बित।', mr: 'सुप्त — कारकत्व दबे, फल अवरुद्ध या अत्यधिक विलम्बित।', ta: 'Dormant — significations suppressed, results blocked or severely delayed. The planet struggles to express itself.', te: 'Dormant — significations suppressed, results blocked or severely delayed. The planet struggles to express itself.', bn: 'Dormant — significations suppressed, results blocked or severely delayed. The planet struggles to express itself.', kn: 'Dormant — significations suppressed, results blocked or severely delayed. The planet struggles to express itself.', gu: 'Dormant — significations suppressed, results blocked or severely delayed. The planet struggles to express itself.' }, color: 'text-red-400', tier: 'denied', stateKey: 'sushupti' },
  ];
  ...
  const DEEPTA_STATES = [
    ...
    { name: { en: 'Shanta (Neutral)', hi: 'शान्त (सम)', sa: 'शान्त (सम)', mai: 'शान्त (सम)', mr: 'शान्त (सम)', ta: 'சாந்த (நடுநிலை)', te: 'శాంత (సమరాశి)', bn: 'শান্ত (সমরাশি)', kn: 'ಶಾಂತ (ಸಮರಾಶಿ)', gu: 'શાંત (સમરાશિ)' }, condition: { en: 'Planet in neutral sign', hi: 'ग्रह सम राशि में', sa: 'ग्रह सम राशि में', mai: 'ग्रह सम राशि में', mr: 'ग्रह सम राशि में', ta: 'நடுநிலை ராசியில் கிரகம்', te: 'సమ రాశిలో గ్రహం', bn: 'নিরপেক্ষ রাশিতে গ্রহ', kn: 'ಸಮ ರಾಶಿಯಲ್ಲಿ ಗ್ರಹ', gu: 'સમ રાશિમાં ગ્રહ' }, result: { en: 'Calm but uninspired — average results, neither helped nor hindered.', hi: 'शांत पर प्रेरणाहीन — औसत फल, न सहायक न बाधक।', sa: 'शांत पर प्रेरणाहीन — औसत फल, न सहायक न बाधक।', mai: 'शांत पर प्रेरणाहीन — औसत फल, न सहायक न बाधक।', mr: 'शांत पर प्रेरणाहीन — औसत फल, न सहायक न बाधक।', ta: 'Calm but uninspired — average results, neither helped nor hindered.', te: 'Calm but uninspired — average results, neither helped nor hindered.', bn: 'Calm but uninspired — average results, neither helped nor hindered.', kn: 'Calm but uninspired — average results, neither helped nor hindered.', gu: 'Calm but uninspired — average results, neither helped nor hindered.' }, color: 'text-text-secondary', tier: 'mixed', stateKey: null },
