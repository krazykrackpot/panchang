...
export const CAREER_ACTIVITIES: Record<CareerActivityId, ExtendedActivity> = {
  ...
  contract_signing: {
    ...
    label: {
      ...
      ta: 'ஒப்பந்தம் / வாய்ப்பு கையெழுத்து',
      te: 'కాంట్రాక్ట్ / ఆఫర్ సంతకం',
      bn: 'চুক্তি / অফার স্বাক্ষর',
      gu: 'કરાર / ઓફર પર સહી',
      kn: 'ಒಪ್ಪಂದ / ಆಫರ್ ಸಹಿ',
      mai: 'अनुबंध / प्रस्ताव हस्ताक्षर',
      mr: 'करार / ऑफर स्वाक्षरी',
    },
    goodTithis: [2, 3, 5, 7, 10, 11, 13],
  ...
  first_day_at_job: {
    ...
    label: {
      ...
      sa: 'नवकार्यप्रवेशः',
      ta: 'புதிய வேலையின் முதல் நாள்',
      te: 'కొత్త ఉద్యోగంలో మొదటి రోజు',
      bn: 'নতুন চাকরির প্রথম দিন',
      gu: 'નવી નોકરીનો પ્રથમ દિવસ',
      kn: 'ಹೊಸ ಉದ್ಯೋಗದ ಮೊದಲ ದಿನ',
      mai: 'नई नौकरीक पहिल दिन',
      mr: 'नवीन नोकरीचा पहिला दिवस',
    },
    goodTithis: [2, 3, 5, 7, 10, 11, 13],
  ...
  asking_promotion: {
    ...
    label: {
      ...
      hi: 'पदोन्नति अनुरोध',
      sa: 'अधिकार-वृद्धिः',
      ta: 'பதவி உயர்வு கோரிக்கை',
      te: 'ప్రమోషన్ అభ్యర్థన',
      bn: 'পদোন্নতির অনুরোধ',
      gu: 'બઢતી માટે વિનંતી',
      kn: 'ಬಡ್ತಿ ಮನವಿ',
      mai: 'पदोन्नति अनुरोध',
