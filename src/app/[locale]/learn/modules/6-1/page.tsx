    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          What Are Nakshatras? / नक्षत्र क्या हैं?
        </h3>
      ...
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Names, Deities & Ruling Planets / नाम, देवता एवं स्वामी ग्रह
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Nakshatra Qualities (Svabhava) / नक्षत्र गुण (स्वभाव)
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        ...
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Example 1:</span> A family wants to schedule a housewarming (Griha Pravesh). Ideal nakshatras would be Dhruva types: Rohini (permanence, prosperity under Brahma), Uttara Phalguni (stability under Aryaman), or Uttara Ashadha (enduring victory under Vishvadevas). They should avoid Tikshna nakshatras like Ardra or Mula, which could bring instability to the home.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">उदाहरण 1:</span> एक परिवार गृह प्रवेश का समय निश्चित करना चाहता है। आदर्श नक्षत्र ध्रुव प्रकार के होंगे: रोहिणी (ब्रह्मा के अधीन स्थायित्व, समृद्धि), उत्तरा फाल्गुनी (अर्यमन के अधीन स्थिरता), या उत्तराषाढ़ा (विश्वदेवों के अधीन स्थायी विजय)। तीक्ष्ण नक्षत्र जैसे आर्द्रा या मूल से बचना चाहिए, जो घर में अस्थिरता ला सकते हैं।
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Example 2:</span> A person born with Moon in Pushya (Deva gana, Dhruva type, ruled by Saturn) would have a nurturing, dutiful personality. Being Deva gana, they are gentle; being Dhruva, they seek stability; Saturn as ruler gives discipline. In compatibility matching, they pair best with other Deva gana nakshatras.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">उदाहरण 2:</span> पुष्य (देव गण, ध्रुव प्रकार, शनि शासित) में चन्द्रमा वाले व्यक्ति का स्वभाव पोषक और कर्तव्यनिष्ठ होगा। देव गण होने से सौम्य; ध्रुव होने से स्थिरता चाहने वाला; शनि स्वामी होने से अनुशासित। अनुकूलता मिलान में, अन्य देव गण नक्षत्रों के साथ सर्वोत्तम जोड़ी बनती है।
        </p>
      </section>
      ...
      <section className="glass-card rounded-xl p-5 border border-red-500/15">
        ...
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">भ्रान्ति:</span> &quot;राक्षस गण के लोग दुष्ट या खतरनाक होते हैं।&quot; यह पूर्णतया गलत है। राक्षस गण स्वतन्त्रता, दृढ़ इच्छाशक्ति और अपरम्परागत चिन्तन का प्रतीक है। अनेक सफल नेता, नवप्रवर्तक और कलाकार राक्षस गण नक्षत्रों में जन्मे हैं। &quot;राक्षस&quot; शब्द स्वभाव की तीव्रता का वर्णन करता है, नैतिक चरित्र का नहीं। मूल (राक्षस गण) के जातक प्रायः गहन शोधकर्ता और अन्वेषक बनते हैं।
        </p>
      </section>
...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Practical Usage: Birth Nakshatra & Dasha / व्यावहारिक उपयोग: जन्म नक्षत्र एवं दशा
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Nakshatra-Based Baby Name Syllables / नक्षत्र-आधारित शिशु नाम अक्षर
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          A cherished tradition in Hindu families is naming the baby based on the birth nakshatra and pada (quarter). Each of the 108 padas (27 nakshatras x 4 padas) is assigned a specific syllable. The first syllable of the child&apos;s name should ideally match the syllable of their birth pada. For example, Ashwini pada 1 gives &quot;Chu&quot;, pada 2 gives &quot;Che&quot;, pada 3 gives &quot;Cho&quot;, pada 4 gives &quot;La&quot;. A baby born with Moon in Ashwini pada 2 might be named &quot;Chetan&quot; or &quot;Chetana.&quot; This practice connects the child&apos;s identity to the cosmic vibration present at their birth.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed">
          हिन्दू परिवारों में एक प्रिय परम्परा है कि शिशु का नामकरण जन्म नक्षत्र और पाद (चतुर्थांश) के आधार पर किया जाए। 108 पादों (27 नक्षत्र x 4 पाद) में से प्रत्येक को एक विशिष्ट अक्षर निर्धारित है। बालक के नाम का प्रथम अक्षर आदर्श रूप से उसके जन्म पाद के अक्षर से मेल खाना चाहिए। उदाहरणार्थ, अश्विनी पाद 1 &quot;चु&quot; देता है, पाद 2 &quot;चे&quot;, पाद 3 &quot;चो&quot;, पाद 4 &quot;ला&quot;। अश्विनी पाद 2 में जन्मे शिशु का नाम &quot;चेतन&quot; या &quot;चेतना&quot; रखा जा सकता है। यह प्रथा बालक की पहचान को जन्म के समय उपस्थित ब्रह्माण्डीय कम्पन से जोड़ती है।
        </p>
      </section>

      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Moon&apos;s Nakshatra in the Daily Panchang / दैनिक पंचांग में चन्द्र नक्षत्र
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">Worked Examples / कार्यान्वित उदाहरण</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Calculation:</span> Moon&apos;s sidereal longitude = 47.8°. Nakshatra number = floor(47.8 / 13.333) + 1 = floor(3.585) + 1 = 3 + 1 = 4. The 4th nakshatra is Rohini (spanning 40° to 53°20&apos;). Position within Rohini = 47.8° - 40° = 7.8°. Pada = floor(7.8 / 3.333) + 1 = floor(2.34) + 1 = 2 + 1 = 3. So the Moon is in Rohini pada 3.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">गणना:</span> चन्द्रमा का निरयन भोगांश = 47.8°। नक्षत्र संख्या = floor(47.8 / 13.333) + 1 = floor(3.585) + 1 = 3 + 1 = 4। चौथा नक्षत्र रोहिणी है (40° से 53°20&apos; तक)। रोहिणी में स्थिति = 47.8° - 40° = 7.8°। पाद = floor(7.8 / 3.333) + 1 = floor(2.34) + 1 = 2 + 1 = 3। अतः चन्द्रमा रोहिणी पाद 3 में है।
        </p>
      </section>
      ...
      <section className="glass-card rounded-xl p-5 border border-red-500/15">
        ...
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">भ्रान्ति:</span> &quot;आपका नक्षत्र आपकी सूर्य राशि के तारामण्डल के समान है।&quot; आपका जन्म नक्षत्र चन्द्रमा की निरयन स्थिति से निर्धारित होता है, सूर्य की नहीं। वृषभ राशि में सूर्य वाले व्यक्ति का चन्द्रमा 27 में से किसी भी नक्षत्र में हो सकता है। नक्षत्र पद्धति और राशि पद्धति पूरक किन्तु भिन्न हैं — नक्षत्र चान्द्र व्यक्तित्व और दशा समय देते हैं, जबकि राशियाँ व्यापक सौर-चिह्न विशेषताओं का वर्णन करती हैं।
        </p>
      </section>
