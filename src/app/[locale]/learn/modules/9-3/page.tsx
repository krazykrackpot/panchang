    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          {t('exaltationUcchaPeakPlanetaryStrength', locale)}
        </h3>
          ...
          <table className="w-full text-xs border-collapse">
            <thead>
              <tr className="border-b border-white/10">
                <th className="text-gold-light text-left p-2">{t('planet', locale)}</th>
                <th className="text-gold-light text-left p-2">{t('exaltedIn', locale)}</th>
                <th className="text-gold-light text-left p-2">{t('deepExaltation', locale)}</th>
                <th className="text-gold-light text-left p-2">{t('why', locale)}</th>
              </tr>
            </thead>
            <tbody className="text-text-secondary">
              <tr className="border-b border-white/5"><td className="p-2">{t('sun', locale)}</td><td className="p-2">{t('aries', locale)}</td><td className="p-2">10°</td><td className="p-2">Fire + initiative = peak authority</td></tr>
              <tr className="border-b border-white/5"><td className="p-2">{t('moon', locale)}</td><td className="p-2">{t('taurus', locale)}</td><td className="p-2">3°</td><td className="p-2">Earth stability nourishes emotions</td></tr>
              <tr className="border-b border-white/5"><td className="p-2">{t('mars', locale)}</td><td className="p-2">{t('capricorn', locale)}</td><td className="p-2">28°</td><td className="p-2">Discipline channels raw courage</td></tr>
              <tr className="border-b border-white/5"><td className="p-2">{t('mercury', locale)}</td><td className="p-2">{t('virgo', locale)}</td><td className="p-2">15°</td><td className="p-2">Analytical sign perfects intellect</td></tr>
              <tr className="border-b border-white/5"><td className="p-2">{t('jupiter', locale)}</td><td className="p-2">{t('cancer', locale)}</td><td className="p-2">5°</td><td className="p-2">Nurturing amplifies wisdom</td></tr>
              <tr className="border-b border-white/5"><td className="p-2">{t('venus', locale)}</td><td className="p-2">{t('pisces', locale)}</td><td className="p-2">27°</td><td className="p-2">Spiritual love = highest beauty</td></tr>
              <tr className="border-b border-white/5"><td className="p-2">{t('saturn', locale)}</td><td className="p-2">{t('libra', locale)}</td><td className="p-2">20°</td><td className="p-2">Justice + balance = ideal discipline</td></tr>
              <tr className="border-b border-white/5"><td className="p-2">{t('rahu', locale)}</td><td className="p-2">{t('taurus', locale)}</td><td className="p-2">20°</td><td className="p-2">Material mastery (per BPHS)</td></tr>
              <tr><td className="p-2">{t('ketu', locale)}</td><td className="p-2">{t('scorpio', locale)}</td><td className="p-2">20°</td><td className="p-2">Occult depth (per BPHS)</td></tr>
            </tbody>
          </table>
...
function Page2() {
  ...
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          {t('debilitationNeechaAndItsCancellation', locale)}
        </h3>
      ...
      <section className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-xs uppercase tracking-widest font-bold mb-3">{t('workedExampleNeechaBhanga', locale)}</h4>
        <ExampleChart
          ascendant={4}
          planets={{ 7: [4], 10: [6] }}
          title={t('cancerLagnaJupiterDebilitatedIn', locale)}
          highlight={[7, 10]}
        />
...
function Page3() {
  ...
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          {t('ownSignMoolatrikonaAndThe', locale)}
        </h3>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-xs border-collapse">
            <thead>
              <tr className="border-b border-white/10">
                <th className="text-gold-light text-left p-2">{t('planet', locale)}</th>
                <th className="text-gold-light text-left p-2">{t('moolatrikona', locale)}</th>
                <th className="text-gold-light text-left p-2">{t('ownSigns', locale)}</th>
              </tr>
            </thead>
            <tbody className="text-text-secondary">
              <tr className="border-b border-white/5"><td className="p-2">{t('sun', locale)}</td><td className="p-2">Leo 0°-20°</td><td className="p-2">{t('leo', locale)}</td></tr>
              <tr className="border-b border-white/5"><td className="p-2">{t('moon', locale)}</td><td className="p-2">Taurus 4°-20°</td><td className="p-2">{t('cancer', locale)}</td></tr>
              <tr className="border-b border-white/5"><td className="p-2">{t('mars', locale)}</td><td className="p-2">Aries 0°-12°</td><td className="p-2">{t('ariesScorpio', locale)}</td></tr>
              <tr className="border-b border-white/5"><td className="p-2">{t('mercury', locale)}</td><td className="p-2">Virgo 16°-20°</td><td className="p-2">{t('geminiVirgo', locale)}</td></tr>
              <tr className="border-b border-white/5"><td className="p-2">{t('jupiter', locale)}</td><td className="p-2">Sagittarius 0°-10°</td><td className="p-2">{t('sagittariusPisces', locale)}</td></tr>
              <tr className="border-b border-white/5"><td className="p-2">{t('venus', locale)}</td><td className="p-2">Libra 0°-15°</td><td className="p-2">{t('taurusLibra', locale)}</td></tr>
              <tr><td className="p-2">{t('saturn', locale)}</td><td className="p-2">Aquarius 0°-20°</td><td className="p-2">{t('capricornAquarius', locale)}</td></tr>
            </tbody>
          </table>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-xs uppercase tracking-widest font-bold mb-3">{t('theCompleteHierarchy', locale)}</h4>
      ...
      <section className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-xl p-5 border border-red-500/15">
        <h4 className="text-red-400 text-xs uppercase tracking-widest font-bold mb-3">{t('commonMisconceptions', locale)}</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">{isHi ? <><strong className="text-gold-light">भ्रांति:</strong> &quot;उच्च ग्रह हमेशा अच्छे फल देता है।&quot; वास्तविकता: उच्च ग्रह दुःस्थान (6, 8, 12) का स्वामी होने पर चुनौतियों को भी शक्तिशाली बनाता है। मेष लग्न में उच्च शुक्र (मीन, 12वें में) विलासिता पर अधिक व्यय और विदेश प्रवास ला सकता है।</> : <><strong className="text-gold-light">Misconception:</strong> &quot;An exalted planet always gives good results.&quot; Reality: an exalted planet ruling a dusthana (6th, 8th, 12th) amplifies challenges too. For Aries Lagna, exalted Venus (Pisces, in the 12th) may bring excessive spending on luxuries and foreign relocation — powerful, but not necessarily pleasant.</>}</p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">{isHi ? <><strong className="text-gold-light">भ्रांति:</strong> &quot;मूलत्रिकोण और स्वराशि समान हैं।&quot; वास्तविकता: मूलत्रिकोण केवल राशि के एक विशिष्ट अंश क्षेत्र में होती है (जैसे सिंह 0-20° ही सूर्य की मूलत्रिकोण, 20-30° केवल स्वराशि)। मूलत्रिकोण स्वराशि से थोड़ी अधिक शक्तिशाली मानी जाती है।</> : <><strong className="text-gold-light">Misconception:</strong> &quot;Moolatrikona and own sign are the same.&quot; Reality: Moolatrikona applies only to a specific degree range within the sign (e.g., Leo 0-20 degrees is Sun&apos;s Moolatrikona, 20-30 degrees is merely own sign). Moolatrikona is considered slightly stronger than own sign.</>}</p>
        <p className="text-text-secondary text-xs leading-relaxed">{isHi ? <><strong className="text-gold-light">भ्रांति:</strong> &quot;वैदिक और पश्चिमी ज्योतिष में उच्च राशियाँ समान हैं।&quot; वास्तविकता: पश्चिमी ज्योतिष में उच्च की अवधारणा कम महत्वपूर्ण है और कुछ परम्पराओं में भिन्न है। वैदिक उच्च/नीच प्रणाली BPHS पर आधारित है और 2000 से अधिक वर्षों से अपरिवर्तित है।</> : <><strong className="text-gold-light">Misconception:</strong> &quot;Exaltation signs are the same in Vedic and Western astrology.&quot; Reality: while the basic exaltation signs overlap historically, the concept is far more central in Vedic astrology. The precise deep exaltation degrees and Neecha Bhanga rules are unique to the Vedic system.</>}</p>
      </section>

      <section className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-xl p-5 border border-blue-500/15">
        <h4 className="text-blue-300 text-xs uppercase tracking-widest font-bold mb-3">{t('modernRelevance', locale)}</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">{isHi ? <>हमारा कुण्डली इंजन प्रत्येक ग्रह की गरिमा का मूल्यांकन करता है, नीचभंग शर्तों की जाँच करती है, और षड्बल शक्ति मूल्यांकन में एकीकृत करता है। मॉड्यूल 9.1 में कुण्डली संरचना और 9.2 में भाव वर्गीकरण तथा राजयोग की मूल अवधारणा समझाई गई है।</> : <>Our Kundali engine evaluates every planet&apos;s dignity, checks for Neecha Bhanga conditions, and integrates this into the Shadbala strength assessment. See Module 9.1 for Kundali structure and Module 9.2 for house classifications and the Raja Yoga concept that ties house lordship to fortune.</>}</p>
      </section>
    </div>
  );
}
