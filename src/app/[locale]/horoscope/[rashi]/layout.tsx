...
export async function generateMetadata({ params }: { params: Promise<{ locale: string; rashi: string }> }): Promise<Metadata> {
  ...
  const title = isHi
    ? `${hindiName} (${westernName}) राशिफल आज | दैनिक वैदिक भविष्यवाणी`
    : `${vedicName} (${westernName}) Horoscope Today | Daily Vedic Predictions`;

  const description = isHi
    ? `${hindiName} राशि का आज का राशिफल। करियर, प्रेम, स्वास्थ्य, वित्त और आध्यात्म स्कोर। वैदिक ग्रह गोचर पर आधारित दैनिक भविष्यवाणी।`
    : `Today's ${westernName} (${vedicName}) horoscope with career, love, health, finance & spirituality scores. Daily Vedic predictions based on actual planetary transits.`;
