...
import L from '@/messages/learn/modules/23-5.json';
...
const META: ModuleMeta = {
  ...
  estimatedMinutes: 13,
  crossRefs: [
    { label: L.crossRefs[0].label as Record<string, string>, href: '/learn/modules/23-3' },
    { label: L.crossRefs[1].label as Record<string, string>, href: '/learn/modules/23-4' },
    { label: L.crossRefs[2].label as Record<string, string>, href: '/learn/modules/15-3' },
    { label: L.crossRefs[3].label as Record<string, string>, href: '/prashna' },
  ],
};
  ...
  return (
    <div className="space-y-6">
      <section>
        ...
        <div className="space-y-3">
          <div className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-lg p-3">
            <p className="text-gold-light font-bold text-sm">{tl({ en: 'Mook Prashna — The Silent Question', hi: 'मूक प्रश्न — मौन प्रश्न', sa: 'मूकप्रश्नः — मौनप्रश्नः' }, locale)}</p>
          ...
          <div className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-lg p-3">
            <p className="text-gold-light font-bold text-sm">{tl({ en: 'Key Houses in Prashna', hi: 'प्रश्न में प्रमुख भाव', sa: 'प्रश्ने मुख्यानि भवनानि' }, locale)}</p>
          ...
          <div className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-lg p-3">
            <p className="text-gold-light font-bold text-sm">{tl({ en: 'Applying vs. Separating Aspects', hi: 'आगामी बनाम वियोजी दृष्टि', sa: 'आगामी-दृष्टिः विरुद्धं वियोजिदृष्टिः' }, locale)}</p>
      ...
      <section className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-300 text-xs uppercase tracking-widest font-bold mb-3">{tl({ en: 'When to Use Prashna', hi: 'प्रश्न कब उपयोग करें', sa: 'प्रश्नः कदा उपयोक्तव्यः' }, locale)}</h4>
  ...
  return (
    <div className="space-y-6">
      <section>
        ...
        <div className="space-y-3">
          <div className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-lg p-3 border border-emerald-500/10">
            <p className="text-emerald-300 font-bold text-sm">{tl({ en: 'Moon in Kendra/Trikona', hi: 'केन्द्र/त्रिकोण में चन्द्र', sa: 'केन्द्र/त्रिकोणे चन्द्रः' }, locale)}</p>
          ...
          <div className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-lg p-3 border border-emerald-500/10">
            <p className="text-emerald-300 font-bold text-sm">{tl({ en: 'Lagna Lord in the 7th', hi: 'लग्न स्वामी सप्तम में', sa: 'लग्नेशः सप्तमे भावे' }, locale)}</p>
          ...
          <div className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-lg p-3 border border-emerald-500/10">
            <p className="text-emerald-300 font-bold text-sm">{tl({ en: 'Benefics in Kendras', hi: 'केन्द्रों में शुभ ग्रह', sa: 'केन्द्रेषु शुभग्रहाः' }, locale)}</p>
          ...
          <div className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-lg p-3 border border-emerald-500/10">
            <p className="text-emerald-300 font-bold text-sm">{tl({ en: 'Moon in Favorable Nakshatra', hi: 'अनुकूल नक्षत्र में चन्द्र', sa: 'अनुकूले नक्षत्रे चन्द्रः' }, locale)}</p>
      ...
      <section className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-xl p-5">
        <h4 className="text-gold-light text-xs uppercase tracking-widest font-bold mb-3">{tl({ en: 'Timing from Prashna', hi: 'प्रश्न से समय', sa: 'प्रश्नात् कालनिर्णयः' }, locale)}</h4>
  ...
  return (
    <div className="space-y-6">
      <section>
        ...
        <div className="space-y-3">
          <div className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-lg p-3 border border-red-500/10">
            <p className="text-red-400 font-bold text-sm">{tl({ en: 'Moon Void of Course', hi: 'चन्द्र शून्य पथ', sa: 'चन्द्रः शून्यमार्गे' }, locale)}</p>
          ...
          <div className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-lg p-3 border border-red-500/10">
            <p className="text-red-400 font-bold text-sm">{tl({ en: 'Lagna Lord in Dusthana', hi: 'लग्न स्वामी दुःस्थान में', sa: 'लग्नेशः दुःस्थाने' }, locale)}</p>
          ...
          <div className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-lg p-3 border border-red-500/10">
            <p className="text-red-400 font-bold text-sm">{tl({ en: 'Malefics in 7th', hi: 'सप्तम में पाप ग्रह', sa: 'सप्तमे पापग्रहाः' }, locale)}</p>
          ...
          <div className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-lg p-3 border border-red-500/10">
            <p className="text-red-400 font-bold text-sm">{tl({ en: 'Separating Aspects & Combust Lagna Lord', hi: 'वियोजी दृष्टि और अस्त लग्न स्वामी', sa: 'वियोजिदृष्टयः अस्तलग्नेशश्च' }, locale)}</p>
      ...
      <section className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-xl p-5 border border-blue-500/15">
        <h4 className="text-blue-300 text-xs uppercase tracking-widest font-bold mb-3">{tl({ en: 'Our Prashna Engine', hi: 'हमारा प्रश्न इंजन', sa: 'अस्माकं प्रश्नयन्त्रम्' }, locale)}</h4>
