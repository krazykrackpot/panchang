    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          {t('pingalaAndChandahshastraTheBinaryScience', locale)}
        </h3>
      ...
      <section className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-xl p-5">
        <h4 className="text-gold-dark text-xs uppercase tracking-widest font-bold mb-3">
          {t('sanskritPoetryAndTheProblemOf', locale)}
        </h4>
      ...
      <section className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-amber-500/15 rounded-xl p-5">
        <h4 className="text-amber-400 text-xs uppercase tracking-widest font-bold mb-3">
          {t('theBinaryAlgorithmDvihShunye', locale)}
        </h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          {isHi
        ...
        <div className="space-y-1">
          ...
          <p className="text-text-secondary text-xs">2. {t('ifEvenDivideBy2Note', locale)}</p>
          <p className="text-text-secondary text-xs">3. {t('repeatUntilNumberReaches0', locale)}</p>
          <p className="text-text-secondary text-xs">4. {t('readNotedSyllablesInReverseBinary', locale)}  </p>
        </div>
        <p className="text-text-secondary text-xs leading-relaxed mt-2">
          {t('thisIsExactlyTheAlgorithmTaught', locale)}
        </p>
      </section>
    </div>
  );
...
function Page2() {
  ...
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          {t('meruprastaraPascalsTriangle2000YearsEarly', locale)}
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          {isHi
      ...
      <section className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-xl p-5">
        <h4 className="text-gold-dark text-xs uppercase tracking-widest font-bold mb-3">
          {t('structureOfMeruprastara', locale)}
        </h4>
      ...
      <section className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-purple-500/15 rounded-xl p-5">
        <h4 className="text-purple-300 text-xs uppercase tracking-widest font-bold mb-3">
          {t('theQuestionOfPriority', locale)}
        </h4>
        <div className="space-y-2">
          <p className="text-text-secondary text-xs"><span className="text-gold-light font-medium">{t('pingala200Bce', locale)}</span> {t('meruprastaraFirstKnownOccurrence', locale)}</p>
          <p className="text-text-secondary text-xs"><span className="text-gold-light font-medium">{t('halayudha10thCenturyCe', locale)}</span> {t('extensiveCommentaryOnMeruprastara', locale)}</p>
          <p className="text-text-secondary text-xs"><span className="text-gold-light font-medium">{t('yangHui1261Ce', locale)}</span> {t('chineseIndependentDiscovery', locale)}</p>
          <p className="text-text-secondary text-xs"><span className="text-gold-light font-medium">{t('blaisePascal1653Ce', locale)}</span> {t('europeanDiscovery1850YearsAfterPingala', locale)}</p>
        </div>
      </section>
    </div>
  );
...
function Page3() {
  ...
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          {t('legacyCombinatoricsAndComputing', locale)}
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          {isHi
      ...
      <section className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-emerald-500/15 rounded-xl p-5">
        <h4 className="text-emerald-400 text-xs uppercase tracking-widest font-bold mb-3">
          {t('pingalasThreeGreatDiscoveries', locale)}
        </h4>
        <div className="space-y-2">
          <p className="text-text-secondary text-xs leading-relaxed">
            <span className="text-gold-light font-semibold">{t('1BinaryNumberSystem', locale)}</span>{' '}
            {t('laghu0Guru1ThePrincipleOfEncoding', locale)}
          </p>
          <p className="text-text-secondary text-xs leading-relaxed">
            <span className="text-gold-light font-semibold">{t('2MeruprastaraPascalsTriangle', locale)}</span>{' '}
            {t('triangularArrangementOfBinomialCoefficientsComputes', locale)}
          </p>
          <p className="text-text-secondary text-xs leading-relaxed">
            <span className="text-gold-light font-semibold">{t('3CombinatoricsFormulas', locale)}</span>{' '}
            {t('numberOfWaysToChooseR', locale)}
          </p>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-amber-500/15 rounded-xl p-5">
        <h4 className="text-amber-400 text-xs uppercase tracking-widest font-bold mb-3">
          {t('fromPoetryToComputersADirect', locale)}
        </h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          {isHi
