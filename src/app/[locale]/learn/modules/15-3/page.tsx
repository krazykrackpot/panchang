    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          What Is Prashna? / प्रश्न क्या है?
        </h3>
      ...
      <section className="glass-card rounded-xl p-5 border border-gold-primary/10">
        <h4 className="text-gold-dark text-[10px] uppercase tracking-widest font-bold mb-2">When Prashna Is Indispensable / जब प्रश्न अपरिहार्य हो</h4>
        <p className="text-text-secondary text-sm leading-relaxed">
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Reading a Prashna Chart / प्रश्न कुण्डली का पठन
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">Worked Example: &quot;Will I Get the Job?&quot; / कार्यान्वित उदाहरण: &quot;क्या मुझे नौकरी मिलेगी?&quot;</h4>
      ...
      <section className="glass-card rounded-xl p-5 border border-red-500/15">
        <h4 className="text-red-400 text-[10px] uppercase tracking-widest font-bold mb-3">Red Flags in Prashna / प्रश्न में चेतावनी संकेत</h4>
        <p className="text-text-secondary text-xs leading-relaxed">
...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Ashtamangala Prashna — The Kerala Tradition / अष्टमंगल प्रश्न — केरल परम्परा
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">Ideal Times for Prashna / प्रश्न के लिए आदर्श समय</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
      ...
      <section className="glass-card rounded-xl p-5 border border-blue-500/15">
        <h4 className="text-blue-300 text-[10px] uppercase tracking-widest font-bold mb-3">Try It Yourself / स्वयं आज़माएँ</h4>
        <p className="text-text-secondary text-xs leading-relaxed">
