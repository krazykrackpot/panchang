...
export default function SignShiftClient() {
  ...
  return (
    <div className="min-h-screen bg-bg-primary">
      {/* ── Hero Section ── */}
      {/* Hero (h1 + subtitle) is server-rendered in page.tsx so Bingbot
...
// Default export moved up to SignShiftClient (renamed from SignShiftPageInner).
// The Suspense wrapper now lives in page.tsx alongside the server-rendered h1
// header — see page.tsx comment.
