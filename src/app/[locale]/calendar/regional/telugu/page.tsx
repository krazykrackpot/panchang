...
const UGADI_PACHADI: Array<{ taste: LocaleText; ingredient: LocaleText; represents: LocaleText }> = [
  ...
  { taste: { en: 'Spicy (Karam)', hi: 'मसालेदार (करम)', te: 'కారం' }, ingredient: { en: 'Green chilli or pepper', hi: 'हरी मिर्च या काली मिर्च', te: 'పచ్చి మిర్చి లేదా మిరియాలు' }, represents: { en: 'Anger, intensity', hi: 'क्रोध, तीव्रता', te: 'కోపం, తీవ్రత' } },
