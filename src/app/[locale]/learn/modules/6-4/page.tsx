    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Nakshatra Lords in the Vimshottari Scheme / विंशोत्तरी पद्धति में नक्षत्र स्वामी
        </h3>
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Calculating Remaining Dasha Balance / शेष दशा सन्तुलन की गणना
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          At the moment of birth, the Moon is rarely at the exact start of a nakshatra. It has usually traversed some portion of the nakshatra, which means that much of the corresponding Mahadasha has already &quot;elapsed&quot; (conceptually consumed). The remaining balance is what the native actually experiences from birth. The calculation is straightforward:
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          जन्म के क्षण चन्द्रमा शायद ही कभी नक्षत्र के ठीक आरम्भ पर होता है। वह सामान्यतः नक्षत्र का कुछ भाग पार कर चुका होता है, जिसका अर्थ है कि सम्बन्धित महादशा का उतना अंश पहले ही &quot;बीत चुका&quot; है। शेष सन्तुलन वह है जो जातक वास्तव में जन्म से अनुभव करता है। गणना सरल है:
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        ...
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Example:</span> Birth Moon at 167.3° in Hasta (Moon-ruled, starting at 160°). Position within Hasta = 167.3 - 160 = 7.3°. Fraction elapsed = 7.3 / 13.333 = 0.5475 = 54.75%. Moon dasha total = 10 years. Remaining = 10 x (1 - 0.5475) = 10 x 0.4525 = 4.525 years ≈ 4 years, 6 months, 9 days.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">उदाहरण:</span> जन्म चन्द्रमा 167.3° हस्त (चन्द्र-शासित, 160° से आरम्भ) में। हस्त में स्थिति = 167.3 - 160 = 7.3°। बीता हुआ अंश = 7.3 / 13.333 = 0.5475 = 54.75%। चन्द्र दशा कुल = 10 वर्ष। शेष = 10 x (1 - 0.5475) = 10 x 0.4525 = 4.525 वर्ष ≈ 4 वर्ष, 6 माह, 9 दिन।
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Full sequence:</span> After the remaining 4.53 years of Moon dasha, the native enters Mars dasha (7 years), then Rahu (18 years), Jupiter (16 years), Saturn (19 years), Mercury (17 years), Ketu (7 years), Venus (20 years), Sun (6 years), and then Moon again (10 years). The cycle continues in this fixed order for the entire life.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">पूर्ण अनुक्रम:</span> चन्द्र दशा के शेष 4.53 वर्षों के बाद जातक मंगल दशा (7 वर्ष) में प्रवेश करता है, फिर राहु (18 वर्ष), बृहस्पति (16 वर्ष), शनि (19 वर्ष), बुध (17 वर्ष), केतु (7 वर्ष), शुक्र (20 वर्ष), सूर्य (6 वर्ष), और फिर पुनः चन्द्र (10 वर्ष)। यह चक्र इसी निश्चित क्रम में सम्पूर्ण जीवन भर चलता है।
        </p>
      </section>
...
function Page3() {
  return (
    <div className="space-y-6">
      ...
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          The Nakshatra-Lord Cycle Pattern / नक्षत्र-स्वामी चक्र प्रारूप
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
