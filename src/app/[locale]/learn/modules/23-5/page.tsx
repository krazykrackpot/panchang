    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Prashna Yogas — Instant Answers from the Cosmos / प्रश्न योग — ब्रह्माण्ड से तत्काल उत्तर
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          Prashna (horary) astrology is the branch of Jyotish that casts a chart for the moment a question is asked, rather than for the moment of birth. The underlying principle is profound: the cosmos at any given moment reflects the concerns and destiny of whoever is engaging with it. The question and its answer are embedded in the sky at the moment of asking.
        </p>
        ...
        <div className="space-y-3">
          <div className="glass-card rounded-lg p-3 border border-gold-primary/10">
            <p className="text-gold-light font-bold text-sm">Mook Prashna — The Silent Question / मूक प्रश्न — मौन प्रश्न</p>
            <p className="text-text-secondary text-xs mt-1">In Mook Prashna, the querent doesn&apos;t even need to state their question verbally. The chart at the moment of consultation contains both the question and the answer. The astrologer reads the chart to determine what the person is concerned about (from house activations and planetary configurations) and what the outcome will be.</p>
            <p className="text-text-secondary text-xs mt-1" style={{ fontFamily: 'var(--font-devanagari-body)' }}>मूक प्रश्न में, जिज्ञासु को अपना प्रश्न मौखिक रूप से बताने की भी आवश्यकता नहीं। परामर्श के क्षण की कुण्डली प्रश्न और उत्तर दोनों समाहित करती है। ज्योतिषी कुण्डली पढ़कर निर्धारित करता है कि व्यक्ति किस बारे में चिन्तित है (भाव सक्रियण और ग्रहीय विन्यास से) और परिणाम क्या होगा।</p>
          </div>
          <div className="glass-card rounded-lg p-3 border border-gold-primary/10">
            <p className="text-gold-light font-bold text-sm">Key Houses in Prashna / प्रश्न में प्रमुख भाव</p>
            <p className="text-text-secondary text-xs mt-1">1st house = the querent (person asking). 7th house = the subject of inquiry, the &quot;other party,&quot; or the desired outcome. Then the relevant house for the specific question type: 10th for career, 7th for marriage/partnership, 5th for children/education, 4th for property/mother, 2nd for wealth, 6th for health/enemies, 11th for gains, 12th for losses/foreign travel.</p>
            <p className="text-text-secondary text-xs mt-1" style={{ fontFamily: 'var(--font-devanagari-body)' }}>प्रथम भाव = जिज्ञासु (पूछने वाला)। सप्तम भाव = पूछताछ का विषय, &quot;दूसरा पक्ष,&quot; या वांछित परिणाम। फिर विशिष्ट प्रश्न प्रकार का सम्बन्धित भाव: कैरियर के लिए दशम, विवाह/साझेदारी के लिए सप्तम, संतान/शिक्षा के लिए पंचम, सम्पत्ति/माता के लिए चतुर्थ, धन के लिए द्वितीय, स्वास्थ्य/शत्रुओं के लिए षष्ठ, लाभ के लिए एकादश, हानि/विदेश यात्रा के लिए द्वादश।</p>
          </div>
          <div className="glass-card rounded-lg p-3 border border-gold-primary/10">
            <p className="text-gold-light font-bold text-sm">Applying vs. Separating Aspects / आगामी बनाम वियोजी दृष्टि</p>
            <p className="text-text-secondary text-xs mt-1">The most critical timing indicator in Prashna: applying aspects (a faster planet moving toward an exact aspect with a slower one) indicate the event IS approaching and WILL happen. Separating aspects (the aspect already exact and moving apart) indicate the opportunity HAS PASSED. The orb of application tells how soon the event will occur.</p>
            <p className="text-text-secondary text-xs mt-1" style={{ fontFamily: 'var(--font-devanagari-body)' }}>प्रश्न में सबसे महत्वपूर्ण समय संकेतक: आगामी दृष्टि (तीव्र ग्रह धीमे ग्रह के साथ सटीक दृष्टि की ओर बढ़ रहा है) दर्शाती है कि घटना निकट आ रही है और होगी। वियोजी दृष्टि (दृष्टि पहले ही सटीक हो चुकी और अलग हो रही) दर्शाती है कि अवसर बीत चुका है। आगमन का ओर्ब बताता है कि घटना कितनी शीघ्र होगी।</p>
          </div>
        </div>
      </section>

      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-300 text-[10px] uppercase tracking-widest font-bold mb-3">When to Use Prashna / प्रश्न कब उपयोग करें</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          Prashna is ideal when: birth time is unknown or imprecise, the question is about a specific event with a yes/no answer, timing is urgent and you need immediate guidance, or when you want to confirm what a natal chart analysis suggests. It works best for concrete questions: &quot;Will I get this job?&quot;, &quot;Should I invest in this property?&quot;, &quot;Will the marriage happen?&quot;
        </p>
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Favorable Prashna Yogas / अनुकूल प्रश्न योग
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          These are the specific planetary combinations that indicate a positive answer to the querent&apos;s question. The more of these present simultaneously, the stronger the positive indication. A single favorable yoga is suggestive; multiple together are conclusive.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3" style={{ fontFamily: 'var(--font-devanagari-body)' }}>
          ये विशिष्ट ग्रहीय संयोजन हैं जो जिज्ञासु के प्रश्न का सकारात्मक उत्तर दर्शाते हैं। इनमें से जितने अधिक एक साथ उपस्थित हों, सकारात्मक संकेत उतना मजबूत। एक अकेला अनुकूल योग सुझावात्मक है; एक साथ अनेक निर्णायक हैं।
        </p>

        <div className="space-y-3">
          <div className="glass-card rounded-lg p-3 border border-emerald-500/10">
            <p className="text-emerald-300 font-bold text-sm">Moon in Kendra/Trikona / केन्द्र/त्रिकोण में चन्द्र</p>
            <p className="text-text-secondary text-xs mt-1">Moon in houses 1, 4, 5, 7, 9, or 10 from the Prashna Lagna is the first and most important check. A well-placed Moon indicates that the flow of events supports a positive outcome. The Moon represents the mind of the querent and the momentum of circumstances. Waxing Moon (Shukla Paksha) strengthens this yoga further.</p>
            <p className="text-text-secondary text-xs mt-1" style={{ fontFamily: 'var(--font-devanagari-body)' }}>प्रश्न लग्न से 1, 4, 5, 7, 9, या 10 भावों में चन्द्रमा पहली और सबसे महत्वपूर्ण जाँच है। सुस्थित चन्द्रमा दर्शाता है कि घटनाओं का प्रवाह सकारात्मक परिणाम का समर्थन करता है। चन्द्रमा जिज्ञासु के मन और परिस्थितियों की गति का प्रतिनिधित्व करता है। शुक्ल पक्ष का चन्द्रमा इस योग को और मजबूत करता है।</p>
          </div>
          <div className="glass-card rounded-lg p-3 border border-emerald-500/10">
            <p className="text-emerald-300 font-bold text-sm">Lagna Lord in the 7th / लग्न स्वामी सप्तम में</p>
            <p className="text-text-secondary text-xs mt-1">The Lagna lord moving to the 7th house shows the querent is directed toward the desired outcome. This is one of the strongest positive indicators. If the 7th lord is also strong and well-placed, the outcome is mutually beneficial. If the Lagna lord and 7th lord have an applying aspect, the coming together is imminent.</p>
            <p className="text-text-secondary text-xs mt-1" style={{ fontFamily: 'var(--font-devanagari-body)' }}>लग्न स्वामी का सप्तम भाव में जाना दर्शाता है कि जिज्ञासु वांछित परिणाम की ओर निर्देशित है। यह सबसे मजबूत सकारात्मक संकेतकों में से एक है। यदि सप्तम स्वामी भी बलवान और सुस्थित है, तो परिणाम पारस्परिक रूप से लाभकारी है। यदि लग्न स्वामी और सप्तम स्वामी की आगामी दृष्टि है, तो मिलन आसन्न है।</p>
          </div>
          <div className="glass-card rounded-lg p-3 border border-emerald-500/10">
            <p className="text-emerald-300 font-bold text-sm">Benefics in Kendras / केन्द्रों में शुभ ग्रह</p>
            <p className="text-text-secondary text-xs mt-1">Jupiter, Venus, waxing Moon, or unafflicted Mercury in the angular houses (1, 4, 7, 10) creates a favorable environment for the question. Benefics in Kendras stabilize the situation and support positive outcomes. The more benefics in angles, the more favorable the overall picture.</p>
            <p className="text-text-secondary text-xs mt-1" style={{ fontFamily: 'var(--font-devanagari-body)' }}>बृहस्पति, शुक्र, शुक्ल पक्ष का चन्द्रमा, या अपीड़ित बुध कोणीय भावों (1, 4, 7, 10) में प्रश्न के लिए अनुकूल वातावरण बनाता है। केन्द्रों में शुभ ग्रह स्थिति को स्थिर करते हैं और सकारात्मक परिणामों का समर्थन करते हैं। जितने अधिक शुभ ग्रह कोणों में, समग्र चित्र उतना अनुकूल।</p>
          </div>
          <div className="glass-card rounded-lg p-3 border border-emerald-500/10">
            <p className="text-emerald-300 font-bold text-sm">Moon in Favorable Nakshatra / अनुकूल नक्षत्र में चन्द्र</p>
            <p className="text-text-secondary text-xs mt-1">Moon in a &quot;fixed&quot; (Sthira) nakshatra = stable, lasting outcome. Moon in a &quot;moveable&quot; (Chara) nakshatra = quick result. Moon in a Deva (divine) nakshatra = blessed outcome. Moon in Mrityu (death) nakshatras like Bharani or Ashlesha = caution needed. The nakshatra quality colors the nature and timing of the result.</p>
            <p className="text-text-secondary text-xs mt-1" style={{ fontFamily: 'var(--font-devanagari-body)' }}>स्थिर नक्षत्र में चन्द्र = स्थिर, स्थायी परिणाम। चर नक्षत्र में चन्द्र = शीघ्र परिणाम। देव नक्षत्र में चन्द्र = आशीर्वादित परिणाम। मृत्यु नक्षत्रों जैसे भरणी या अश्लेषा में चन्द्र = सावधानी आवश्यक। नक्षत्र गुणवत्ता परिणाम की प्रकृति और समय को रंगती है।</p>
          </div>
        </div>
      </section>

      <section className="glass-card rounded-xl p-5 border border-gold-primary/15">
        <h4 className="text-gold-light text-[10px] uppercase tracking-widest font-bold mb-3">Timing from Prashna / प्रश्न से समय</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          The degree of the applying aspect tells timing: if the Lagna lord applies to the 7th lord at 5° orb, the event may happen in 5 days/weeks/months (the unit depends on the sign type — cardinal = days, fixed = months, mutable = weeks). Fast-moving planets (Moon, Mercury) indicate quick results; slow planets (Saturn, Jupiter) indicate longer waits.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed" style={{ fontFamily: 'var(--font-devanagari-body)' }}>
          आगामी दृष्टि का अंश समय बताता है: यदि लग्न स्वामी 5° ओर्ब पर सप्तम स्वामी की ओर आ रहा है, तो घटना 5 दिन/सप्ताह/महीने में हो सकती है (इकाई राशि प्रकार पर निर्भर — चर = दिन, स्थिर = महीने, द्विस्वभाव = सप्ताह)। तीव्र ग्रह (चन्द्र, बुध) शीघ्र परिणाम दर्शाते हैं; मन्द ग्रह (शनि, बृहस्पति) लम्बी प्रतीक्षा।
        </p>
      </section>
    </div>
  );
...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Unfavorable Prashna Yogas / प्रतिकूल प्रश्न योग
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          These combinations indicate obstacles, denial, or negative outcomes. Understanding them is as important as knowing the favorable yogas — they serve as warning signals that protect the querent from poor decisions.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3" style={{ fontFamily: 'var(--font-devanagari-body)' }}>
          ये संयोजन बाधाओं, अस्वीकृति, या नकारात्मक परिणामों को दर्शाते हैं। इन्हें समझना अनुकूल योगों को जानने जितना ही महत्वपूर्ण है — वे चेतावनी संकेतों के रूप में कार्य करते हैं जो जिज्ञासु को खराब निर्णयों से बचाते हैं।
        </p>

        <div className="space-y-3">
          <div className="glass-card rounded-lg p-3 border border-red-500/10">
            <p className="text-red-400 font-bold text-sm">Moon Void of Course / चन्द्र शून्य पथ</p>
            <p className="text-text-secondary text-xs mt-1">When the Moon makes no applying aspect to any planet before leaving its current sign, it is &quot;void of course.&quot; This is the strongest indicator of &quot;nothing will happen&quot; — the matter will not materialize, fizzle out, or come to no definitive conclusion. Do not proceed with the venture.</p>
            <p className="text-text-secondary text-xs mt-1" style={{ fontFamily: 'var(--font-devanagari-body)' }}>जब चन्द्रमा अपनी वर्तमान राशि छोड़ने से पहले किसी भी ग्रह से कोई आगामी दृष्टि नहीं बनाता, तो यह &quot;शून्य पथ&quot; है। यह &quot;कुछ नहीं होगा&quot; का सबसे मजबूत संकेतक है — मामला साकार नहीं होगा, समाप्त हो जाएगा, या कोई निश्चित निष्कर्ष नहीं होगा। उपक्रम के साथ आगे न बढ़ें।</p>
          </div>
          <div className="glass-card rounded-lg p-3 border border-red-500/10">
            <p className="text-red-400 font-bold text-sm">Lagna Lord in Dusthana / लग्न स्वामी दुःस्थान में</p>
            <p className="text-text-secondary text-xs mt-1">Lagna lord in the 6th (conflict/disease), 8th (obstacles/losses), or 12th (expenses/isolation) house indicates the querent faces significant obstacles. The person&apos;s energy is directed toward struggle (6th), hidden dangers (8th), or losses (12th) rather than achievement.</p>
            <p className="text-text-secondary text-xs mt-1" style={{ fontFamily: 'var(--font-devanagari-body)' }}>लग्न स्वामी 6ठे (संघर्ष/रोग), 8वें (बाधा/हानि), या 12वें (खर्च/एकान्त) भाव में जिज्ञासु के महत्वपूर्ण बाधाओं का सामना दर्शाता है। व्यक्ति की ऊर्जा उपलब्धि के बजाय संघर्ष (6ठा), छिपे खतरों (8वाँ), या हानि (12वाँ) की ओर निर्देशित है।</p>
          </div>
          <div className="glass-card rounded-lg p-3 border border-red-500/10">
            <p className="text-red-400 font-bold text-sm">Malefics in 7th / सप्तम में पाप ग्रह</p>
            <p className="text-text-secondary text-xs mt-1">Saturn, Mars, Rahu, or Ketu in the 7th house indicates the subject of inquiry is inherently problematic. For marriage: the partner has serious issues. For business: the deal is risky or fraudulent. For any question: what you&apos;re seeking carries hidden problems.</p>
            <p className="text-text-secondary text-xs mt-1" style={{ fontFamily: 'var(--font-devanagari-body)' }}>सप्तम भाव में शनि, मंगल, राहु, या केतु दर्शाता है कि पूछताछ का विषय स्वाभाविक रूप से समस्याग्रस्त है। विवाह के लिए: साथी में गम्भीर समस्याएँ हैं। व्यापार के लिए: सौदा जोखिमभरा या कपटपूर्ण है। किसी भी प्रश्न के लिए: जो आप खोज रहे हैं उसमें छिपी समस्याएँ हैं।</p>
          </div>
          <div className="glass-card rounded-lg p-3 border border-red-500/10">
            <p className="text-red-400 font-bold text-sm">Separating Aspects & Combust Lagna Lord / वियोजी दृष्टि और अस्त लग्न स्वामी</p>
            <p className="text-text-secondary text-xs mt-1">Separating aspects between the Lagna lord and the relevant house lord indicate the opportunity has already passed — you missed it. Combust Lagna lord means the querent is weakened, overwhelmed by circumstances, or unable to act effectively. Both are strong indicators of an unfavorable outcome.</p>
            <p className="text-text-secondary text-xs mt-1" style={{ fontFamily: 'var(--font-devanagari-body)' }}>लग्न स्वामी और सम्बन्धित भाव स्वामी के बीच वियोजी दृष्टि दर्शाती है कि अवसर पहले ही बीत चुका है — आपने इसे खो दिया। अस्त लग्न स्वामी का अर्थ है कि जिज्ञासु दुर्बल है, परिस्थितियों से अभिभूत है, या प्रभावी ढंग से कार्य करने में असमर्थ है। दोनों प्रतिकूल परिणाम के मजबूत संकेतक हैं।</p>
          </div>
        </div>
      </section>

      <section className="glass-card rounded-xl p-5 border border-blue-500/15">
        <h4 className="text-blue-300 text-[10px] uppercase tracking-widest font-bold mb-3">Our Prashna Engine / हमारा प्रश्न इंजन</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          Our Prashna page evaluates all these yogas automatically. When you submit a question, the engine: 1) Casts the chart for the exact moment. 2) Checks Moon placement, phase, and nakshatra. 3) Evaluates Lagna lord position and dignity. 4) Identifies benefic/malefic placements in Kendras. 5) Analyzes applying and separating aspects. 6) Checks for combustion of key planets. 7) Synthesizes all factors into an automatic verdict (favorable/unfavorable/neutral) with detailed explanation of supporting and opposing yogas.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed" style={{ fontFamily: 'var(--font-devanagari-body)' }}>
          हमारा प्रश्न पृष्ठ इन सभी योगों का स्वचालित मूल्यांकन करता है। जब आप प्रश्न प्रस्तुत करते हैं, इंजन: 1) सटीक क्षण की कुण्डली बनाता है। 2) चन्द्र स्थिति, कला और नक्षत्र जाँचता है। 3) लग्न स्वामी स्थान और गरिमा का मूल्यांकन करता है। 4) केन्द्रों में शुभ/पाप स्थिति पहचानता है। 5) आगामी और वियोजी दृष्टि का विश्लेषण करता है। 6) प्रमुख ग्रहों के अस्त की जाँच करता है। 7) सभी कारकों का समर्थक और विरोधी योगों की विस्तृत व्याख्या के साथ स्वचालित निर्णय (अनुकूल/प्रतिकूल/तटस्थ) में संश्लेषण करता है।
        </p>
      </section>
    </div>
  );
