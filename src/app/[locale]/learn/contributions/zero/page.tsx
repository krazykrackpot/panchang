...
const BRAHMAGUPTA_RULES = [
  { rule: { en: 'zero + zero = zero', hi: 'शून्य + शून्य = शून्य', sa: 'शून्य + शून्य = शून्य', mai: 'शून्य + शून्य = शून्य', mr: 'शून्य + शून्य = शून्य', ta: 'zero + zero = zero', te: 'zero + zero = zero', bn: 'zero + zero = zero', kn: 'zero + zero = zero', gu: 'zero + zero = zero' }, sanskrit: 'शून्यं शून्येन संयुक्तं शून्यम्' },
  { rule: { en: 'positive + zero = positive', hi: 'धन + शून्य = धन', sa: 'धन + शून्य = धन', mai: 'धन + शून्य = धन', mr: 'धन + शून्य = धन', ta: 'positive + zero = positive', te: 'positive + zero = positive', bn: 'positive + zero = positive', kn: 'positive + zero = positive', gu: 'positive + zero = positive' }, sanskrit: 'धनं शून्येन संयुक्तं धनम्' },
  { rule: { en: 'negative + zero = negative', hi: 'ऋण + शून्य = ऋण', sa: 'ऋण + शून्य = ऋण', mai: 'ऋण + शून्य = ऋण', mr: 'ऋण + शून्य = ऋण', ta: 'negative + zero = negative', te: 'negative + zero = negative', bn: 'negative + zero = negative', kn: 'negative + zero = negative', gu: 'negative + zero = negative' }, sanskrit: 'ऋणं शून्येन संयुक्तं ऋणम्' },
  { rule: { en: 'zero × any number = zero', hi: 'शून्य × कोई भी = शून्य', sa: 'शून्य × कोई भी = शून्य', mai: 'शून्य × कोई भी = शून्य', mr: 'शून्य × कोई भी = शून्य', ta: 'zero × any number = zero', te: 'zero × any number = zero', bn: 'zero × any number = zero', kn: 'zero × any number = zero', gu: 'zero × any number = zero' }, sanskrit: 'शून्यं धनर्णयोः कृतिः शून्यम्' },
  { rule: { en: 'positive × negative = negative', hi: 'धन × ऋण = ऋण', sa: 'धन × ऋण = ऋण', mai: 'धन × ऋण = ऋण', mr: 'धन × ऋण = ऋण', ta: 'positive × negative = negative', te: 'positive × negative = negative', bn: 'positive × negative = negative', kn: 'positive × negative = negative', gu: 'positive × negative = negative' }, sanskrit: 'धनर्णयोः घातो ऋणम्' },
  { rule: { en: '0 ÷ 0 = 0 (his one error!)', hi: '0 ÷ 0 = 0 (उनकी एकमात्र त्रुटि!)', sa: '0 ÷ 0 = 0 (उनकी एकमात्र त्रुटि!)', mai: '0 ÷ 0 = 0 (उनकी एकमात्र त्रुटि!)', mr: '0 ÷ 0 = 0 (उनकी एकमात्र त्रुटि!)', ta: '0 ÷ 0 = 0 (his one error!)', te: '0 ÷ 0 = 0 (his one error!)', bn: '0 ÷ 0 = 0 (his one error!)', kn: '0 ÷ 0 = 0 (his one error!)', gu: '0 ÷ 0 = 0 (his one error!)' }, sanskrit: 'शून्यं शून्यहृतं शून्यम् ✗' },
];

const JOURNEY = [
  { year: '~300 CE', place: { en: 'Bakhshali, India', hi: 'बख्शाली, भारत', sa: 'बख्शाली, भारत', mai: 'बख्शाली, भारत', mr: 'बख्शाली, भारत', ta: 'Bakhshali, India', te: 'Bakhshali, India', bn: 'Bakhshali, India', kn: 'Bakhshali, India', gu: 'Bakhshali, India' }, event: { en: 'Earliest physical zero dot on birch bark manuscript', hi: 'भोजपत्र पांडुलिपि पर सबसे पुराना भौतिक शून्य बिंदु', sa: 'भोजपत्र पांडुलिपि पर सबसे पुराना भौतिक शून्य बिंदु', mai: 'भोजपत्र पांडुलिपि पर सबसे पुराना भौतिक शून्य बिंदु', mr: 'भोजपत्र पांडुलिपि पर सबसे पुराना भौतिक शून्य बिंदु', ta: 'Earliest physical zero dot on birch bark manuscript', te: 'Earliest physical zero dot on birch bark manuscript', bn: 'Earliest physical zero dot on birch bark manuscript', kn: 'Earliest physical zero dot on birch bark manuscript', gu: 'Earliest physical zero dot on birch bark manuscript' }, color: 'border-gold-primary/60' },
  { year: '628 CE', place: { en: 'Ujjain, India', hi: 'उज्जैन, भारत', sa: 'उज्जैन, भारत', mai: 'उज्जैन, भारत', mr: 'उज्जैन, भारत', ta: 'Ujjain, India', te: 'Ujjain, India', bn: 'Ujjain, India', kn: 'Ujjain, India', gu: 'Ujjain, India' }, event: { en: 'Brahmagupta defines zero as a full number with arithmetic rules', hi: 'ब्रह्मगुप्त शून्य को अंकगणितीय नियमों के साथ पूर्ण संख्या के रूप में परिभाषित करते हैं', sa: 'ब्रह्मगुप्त शून्य को अंकगणितीय नियमों के साथ पूर्ण संख्या के रूप में परिभाषित करते हैं', mai: 'ब्रह्मगुप्त शून्य को अंकगणितीय नियमों के साथ पूर्ण संख्या के रूप में परिभाषित करते हैं', mr: 'ब्रह्मगुप्त शून्य को अंकगणितीय नियमों के साथ पूर्ण संख्या के रूप में परिभाषित करते हैं', ta: 'Brahmagupta defines zero as a full number with arithmetic rules', te: 'Brahmagupta defines zero as a full number with arithmetic rules', bn: 'Brahmagupta defines zero as a full number with arithmetic rules', kn: 'Brahmagupta defines zero as a full number with arithmetic rules', gu: 'Brahmagupta defines zero as a full number with arithmetic rules' }, color: 'border-amber-400/60' },
  { year: '825 CE', place: { en: 'Baghdad, Iraq', hi: 'बगदाद, इराक', sa: 'बगदाद, इराक', mai: 'बगदाद, इराक', mr: 'बगदाद, इराक', ta: 'Baghdad, Iraq', te: 'Baghdad, Iraq', bn: 'Baghdad, Iraq', kn: 'Baghdad, Iraq', gu: 'Baghdad, Iraq' }, event: { en: "Al-Khwarizmi translates Indian numerals — gives us 'algorithm'", hi: 'अल-ख्वारिज्मी भारतीय अंकों का अनुवाद करते हैं — हमें "एल्गोरिदम" देते हैं', sa: 'अल-ख्वारिज्मी भारतीय अंकों का अनुवाद करते हैं — हमें "एल्गोरिदम" देते हैं', mai: 'अल-ख्वारिज्मी भारतीय अंकों का अनुवाद करते हैं — हमें "एल्गोरिदम" देते हैं', mr: 'अल-ख्वारिज्मी भारतीय अंकों का अनुवाद करते हैं — हमें "एल्गोरिदम" देते हैं', ta: "Al-Khwarizmi translates Indian numerals — gives us 'algorithm'", te: "Al-Khwarizmi translates Indian numerals — gives us 'algorithm'", bn: "Al-Khwarizmi translates Indian numerals — gives us 'algorithm'", kn: "Al-Khwarizmi translates Indian numerals — gives us 'algorithm'", gu: "Al-Khwarizmi translates Indian numerals — gives us 'algorithm'" }, color: 'border-blue-400/60' },
  { year: '1202 CE', place: { en: 'Pisa, Italy', hi: 'पीसा, इटली', sa: 'पीसा, इटली', mai: 'पीसा, इटली', mr: 'पीसा, इटली', ta: 'Pisa, Italy', te: 'Pisa, Italy', bn: 'Pisa, Italy', kn: 'Pisa, Italy', gu: 'Pisa, Italy' }, event: { en: 'Fibonacci publishes Liber Abaci, introducing zero to Europe', hi: 'फिबोनाची लिबर अबासी प्रकाशित करते हैं, यूरोप को शून्य से परिचित कराते हैं', sa: 'फिबोनाची लिबर अबासी प्रकाशित करते हैं, यूरोप को शून्य से परिचित कराते हैं', mai: 'फिबोनाची लिबर अबासी प्रकाशित करते हैं, यूरोप को शून्य से परिचित कराते हैं', mr: 'फिबोनाची लिबर अबासी प्रकाशित करते हैं, यूरोप को शून्य से परिचित कराते हैं', ta: 'Fibonacci publishes Liber Abaci, introducing zero to Europe', te: 'Fibonacci publishes Liber Abaci, introducing zero to Europe', bn: 'Fibonacci publishes Liber Abaci, introducing zero to Europe', kn: 'Fibonacci publishes Liber Abaci, introducing zero to Europe', gu: 'Fibonacci publishes Liber Abaci, introducing zero to Europe' }, color: 'border-emerald-400/60' },
  { year: '1299 CE', place: { en: 'Florence, Italy', hi: 'फ्लोरेंस, इटली', sa: 'फ्लोरेंस, इटली', mai: 'फ्लोरेंस, इटली', mr: 'फ्लोरेंस, इटली', ta: 'Florence, Italy', te: 'Florence, Italy', bn: 'Florence, Italy', kn: 'Florence, Italy', gu: 'Florence, Italy' }, event: { en: "Florence BANS Indian numerals — calls them 'Saracen numerals'", hi: 'फ्लोरेंस ने भारतीय अंकों पर प्रतिबंध लगाया — उन्हें "सारासेन अंक" कहा', sa: 'फ्लोरेंस ने भारतीय अंकों पर प्रतिबंध लगाया — उन्हें "सारासेन अंक" कहा', mai: 'फ्लोरेंस ने भारतीय अंकों पर प्रतिबंध लगाया — उन्हें "सारासेन अंक" कहा', mr: 'फ्लोरेंस ने भारतीय अंकों पर प्रतिबंध लगाया — उन्हें "सारासेन अंक" कहा', ta: "Florence BANS Indian numerals — calls them 'Saracen numerals'", te: "Florence BANS Indian numerals — calls them 'Saracen numerals'", bn: "Florence BANS Indian numerals — calls them 'Saracen numerals'", kn: "Florence BANS Indian numerals — calls them 'Saracen numerals'", gu: "Florence BANS Indian numerals — calls them 'Saracen numerals'" }, color: 'border-red-400/60' },
  { year: '~1500 CE', place: { en: 'All of Europe', hi: 'सारा यूरोप', sa: 'सारा यूरोप', mai: 'सारा यूरोप', mr: 'सारा यूरोप', ta: 'All of Europe', te: 'All of Europe', bn: 'All of Europe', kn: 'All of Europe', gu: 'All of Europe' }, event: { en: 'Indian numerals finally win. Zero universally accepted. Modern math begins.', hi: 'भारतीय अंक अंततः जीत गए। शून्य सार्वभौमिक रूप से स्वीकृत। आधुनिक गणित शुरू।', sa: 'भारतीय अंक अंततः जीत गए। शून्य सार्वभौमिक रूप से स्वीकृत। आधुनिक गणित शुरू।', mai: 'भारतीय अंक अंततः जीत गए। शून्य सार्वभौमिक रूप से स्वीकृत। आधुनिक गणित शुरू।', mr: 'भारतीय अंक अंततः जीत गए। शून्य सार्वभौमिक रूप से स्वीकृत। आधुनिक गणित शुरू।', ta: 'Indian numerals finally win. Zero universally accepted. Modern math begins.', te: 'Indian numerals finally win. Zero universally accepted. Modern math begins.', bn: 'Indian numerals finally win. Zero universally accepted. Modern math begins.', kn: 'Indian numerals finally win. Zero universally accepted. Modern math begins.', gu: 'Indian numerals finally win. Zero universally accepted. Modern math begins.' }, color: 'border-violet-400/60' },
];
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 pb-20 space-y-2">
        ...
        <LessonSection number={1} title={t('s1Title')} variant="highlight">
          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              { civ: 'Rome', problem: { en: 'No zero → counting boards required for every calculation', hi: 'शून्य नहीं → हर गणना के लिए काउंटिंग बोर्ड चाहिए', sa: 'शून्य नहीं → हर गणना के लिए काउंटिंग बोर्ड चाहिए', mai: 'शून्य नहीं → हर गणना के लिए काउंटिंग बोर्ड चाहिए', mr: 'शून्य नहीं → हर गणना के लिए काउंटिंग बोर्ड चाहिए', ta: 'No zero → counting boards required for every calculation', te: 'No zero → counting boards required for every calculation', bn: 'No zero → counting boards required for every calculation', kn: 'No zero → counting boards required for every calculation', gu: 'No zero → counting boards required for every calculation' }, color: 'border-red-500/30' },
              { civ: 'Greece', problem: { en: 'Philosophical block — "Nothing cannot be Something"', hi: 'दार्शनिक बाधा — "शून्य कुछ नहीं हो सकता"', sa: 'दार्शनिक बाधा — "शून्य कुछ नहीं हो सकता"', mai: 'दार्शनिक बाधा — "शून्य कुछ नहीं हो सकता"', mr: 'दार्शनिक बाधा — "शून्य कुछ नहीं हो सकता"', ta: 'Philosophical block — "Nothing cannot be Something"', te: 'Philosophical block — "Nothing cannot be Something"', bn: 'Philosophical block — "Nothing cannot be Something"', kn: 'Philosophical block — "Nothing cannot be Something"', gu: 'Philosophical block — "Nothing cannot be Something"' }, color: 'border-blue-500/30' },
              { civ: 'Babylon', problem: { en: 'Placeholder zero only — never a number', hi: 'केवल स्थान-धारक शून्य — कभी संख्या नहीं', sa: 'केवल स्थान-धारक शून्य — कभी संख्या नहीं', mai: 'केवल स्थान-धारक शून्य — कभी संख्या नहीं', mr: 'केवल स्थान-धारक शून्य — कभी संख्या नहीं', ta: 'Placeholder zero only — never a number', te: 'Placeholder zero only — never a number', bn: 'Placeholder zero only — never a number', kn: 'Placeholder zero only — never a number', gu: 'Placeholder zero only — never a number' }, color: 'border-amber-500/30' },
            ].map((item, i) => (
              <div
                key={i}
        ...
        <LessonSection number={4} title={t('s4Title')}>
          ...
          <div className="mt-6 overflow-x-auto -mx-2">
            <table className="w-full text-sm">
              ...
              <tbody>
                {[
                  { civ: 'Babylon (~300 BCE)', type: { en: 'Placeholder only', hi: 'केवल स्थान-धारक', sa: 'केवल स्थान-धारक', mai: 'केवल स्थान-धारक', mr: 'केवल स्थान-धारक', ta: 'Placeholder only', te: 'Placeholder only', bn: 'Placeholder only', kn: 'Placeholder only', gu: 'Placeholder only' }, arith: false },
                  { civ: 'Maya (~350 CE)', type: { en: 'Placeholder only', hi: 'केवल स्थान-धारक', sa: 'केवल स्थान-धारक', mai: 'केवल स्थान-धारक', mr: 'केवल स्थान-धारक', ta: 'Placeholder only', te: 'Placeholder only', bn: 'Placeholder only', kn: 'Placeholder only', gu: 'Placeholder only' }, arith: false },
                  { civ: 'India — Bakhshali (~300 CE)', type: { en: 'Placeholder dot', hi: 'स्थान-धारक बिंदु', sa: 'स्थान-धारक बिंदु', mai: 'स्थान-धारक बिंदु', mr: 'स्थान-धारक बिंदु', ta: 'Placeholder dot', te: 'Placeholder dot', bn: 'Placeholder dot', kn: 'Placeholder dot', gu: 'Placeholder dot' }, arith: false },
                  { civ: 'India — Brahmagupta (628 CE)', type: { en: 'FULL NUMBER with rules', hi: 'नियमों के साथ पूर्ण संख्या', sa: 'नियमों के साथ पूर्ण संख्या', mai: 'नियमों के साथ पूर्ण संख्या', mr: 'नियमों के साथ पूर्ण संख्या', ta: 'FULL NUMBER with rules', te: 'FULL NUMBER with rules', bn: 'FULL NUMBER with rules', kn: 'FULL NUMBER with rules', gu: 'FULL NUMBER with rules' }, arith: true },
                ].map((row, i) => (
                  <tr
                    key={i}
        ...
        <LessonSection number={6} title={t('s6Title')}>
          ...
          <div className="mt-6 grid grid-cols-2 sm:grid-cols-4 gap-3">
            {[
              { icon: <Cpu className="w-5 h-5" />, label: { en: 'Binary Code', hi: 'बाइनरी कोड', sa: 'बाइनरी कोड', mai: 'बाइनरी कोड', mr: 'बाइनरी कोड', ta: 'Binary Code', te: 'Binary Code', bn: 'Binary Code', kn: 'Binary Code', gu: 'Binary Code' }, dep: { en: 'Requires 0 and 1', hi: '0 और 1 आवश्यक', sa: '0 और 1 आवश्यक', mai: '0 और 1 आवश्यक', mr: '0 और 1 आवश्यक', ta: 'Requires 0 and 1', te: 'Requires 0 and 1', bn: 'Requires 0 and 1', kn: 'Requires 0 and 1', gu: 'Requires 0 and 1' } },
              { icon: <Globe className="w-5 h-5" />, label: { en: 'GPS', hi: 'जीपीएस', sa: 'जीपीएस', mai: 'जीपीएस', mr: 'जीपीएस', ta: 'GPS', te: 'GPS', bn: 'GPS', kn: 'GPS', gu: 'GPS' }, dep: { en: 'Continuous calculus', hi: 'निरंतर कलन', sa: 'निरंतर कलन', mai: 'निरंतर कलन', mr: 'निरंतर कलन', ta: 'Continuous calculus', te: 'Continuous calculus', bn: 'Continuous calculus', kn: 'Continuous calculus', gu: 'Continuous calculus' } },
              { icon: <Circle className="w-5 h-5" />, label: { en: 'Calculus', hi: 'कलन', sa: 'कलन', mai: 'कलन', mr: 'कलन', ta: 'Calculus', te: 'Calculus', bn: 'Calculus', kn: 'Calculus', gu: 'Calculus' }, dep: { en: 'Limits → 0', hi: 'सीमाएँ → 0', sa: 'सीमाएँ → 0', mai: 'सीमाएँ → 0', mr: 'सीमाएँ → 0', ta: 'Limits → 0', te: 'Limits → 0', bn: 'Limits → 0', kn: 'Limits → 0', gu: 'Limits → 0' } },
              { icon: <ArrowRight className="w-5 h-5" />, label: { en: 'Algebra', hi: 'बीजगणित', sa: 'बीजगणित', mai: 'बीजगणित', mr: 'बीजगणित', ta: 'Algebra', te: 'Algebra', bn: 'Algebra', kn: 'Algebra', gu: 'Algebra' }, dep: { en: 'Equations need 0', hi: 'समीकरणों को 0 चाहिए', sa: 'समीकरणों को 0 चाहिए', mai: 'समीकरणों को 0 चाहिए', mr: 'समीकरणों को 0 चाहिए', ta: 'Equations need 0', te: 'Equations need 0', bn: 'Equations need 0', kn: 'Equations need 0', gu: 'Equations need 0' } },
            ].map((item, i) => (
              <div
                key={i}
