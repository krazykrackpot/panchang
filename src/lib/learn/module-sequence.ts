...
export const MODULE_SEQUENCE: ModuleRef[] = [
  ...
  { id: 'contributions-zero', phase: 1, topic: 'Mathematics', href: '/learn/contributions/zero', title: { en: 'The Invention of Zero', hi: 'शून्य का आविष्कार', ta: 'சுழியத்தின் கண்டுபிடிப்பு', bn: 'শূন্যের আবিষ্কার' } },
  { id: 'contributions-sine', phase: 1, topic: 'Mathematics', href: '/learn/contributions/sine', title: { en: 'Sine — From Jya to Modern Trig', hi: 'ज्या से आधुनिक त्रिकोणमिति', ta: 'ஜ்யா — நவீன முக்கோணவியலுக்கு', bn: 'জ্যা থেকে আধুনিক ত্রিকোণমিতি' } },
  { id: 'contributions-pi', phase: 1, topic: 'Mathematics', href: '/learn/contributions/pi', title: { en: 'Pi — Aryabhata to Madhava', hi: 'π — आर्यभट से माधव', ta: 'π — ஆர்யபட்டர் முதல் மாதவர் வரை', bn: 'π — আর্যভট্ট থেকে মাধব' } },
  { id: 'contributions-negative-numbers', phase: 1, topic: 'Mathematics', href: '/learn/contributions/negative-numbers', title: { en: 'Negative Numbers — Brahmagupta', hi: 'ऋणात्मक संख्याएँ — ब्रह्मगुप्त', ta: 'எதிர்மறை எண்கள் — பிரம்மகுப்தர்', bn: 'ঋণাত্মক সংখ্যা — ব্রহ্মগুপ্ত' } },
  { id: 'contributions-binary', phase: 1, topic: 'Mathematics', href: '/learn/contributions/binary', title: { en: 'Binary Code — Pingala', hi: 'द्विआधारी — पिंगल', ta: 'இருமக் குறியீடு — பிங்களர்', bn: 'বাইনারি কোড — পিঙ্গল' } },
  { id: 'contributions-fibonacci', phase: 1, topic: 'Mathematics', href: '/learn/contributions/fibonacci', title: { en: 'Fibonacci — Virahanka & Hemachandra', hi: 'फिबोनाची — विरहांक और हेमचंद्र', ta: 'ஃபிபோனச்சி — விரகாங்கர் & ஹேமச்சந்திரர்', bn: 'ফিবোনাচি — বিরহাঙ্ক ও হেমচন্দ্র' } },
  { id: 'contributions-calculus', phase: 1, topic: 'Mathematics', href: '/learn/contributions/calculus', title: { en: 'Calculus — Kerala School', hi: 'कैलकुलस — केरल स्कूल', ta: 'கணிதம் — கேரள பள்ளி', bn: 'ক্যালকুলাস — কেরালা স্কুল' } },
  { id: 'contributions-pythagoras', phase: 1, topic: 'Mathematics', href: '/learn/contributions/pythagoras', title: { en: 'Pythagoras — Baudhayana Sulbasutras', hi: 'पाइथागोरस — बौधायन शुल्बसूत्र', ta: 'பைதாகரஸ் — பௌதாயன சூல்பசூத்திரம்', bn: 'পিথাগোরাস — বৌধায়ন শুল্বসূত্র' } },
  { id: 'contributions-kerala-school', phase: 1, topic: 'Mathematics', href: '/learn/contributions/kerala-school', title: { en: 'Kerala School of Astronomy', hi: 'केरल खगोल विद्यालय', ta: 'கேரள வானியல் பள்ளி', bn: 'কেরালা জ্যোতির্বিদ্যা বিদ্যালয়' } },
  { id: 'contributions-earth-rotation', phase: 1, topic: 'Astronomy & Physics', href: '/learn/contributions/earth-rotation', title: { en: 'Earth Rotation — Aryabhata', hi: 'पृथ्वी की घूर्णन — आर्यभट', ta: 'பூமியின் சுழற்சி — ஆர்யபட்டர்', bn: 'পৃথিবীর ঘূর্ণন — আর্যভট্ট' } },
  { id: 'contributions-gravity', phase: 1, topic: 'Astronomy & Physics', href: '/learn/contributions/gravity', title: { en: 'Gravity — Bhaskaracharya', hi: 'गुरुत्वाकर्षण — भास्कराचार्य', ta: 'ஈர்ப்பு — பாஸ்கராச்சாரியர்', bn: 'মাধ্যাকর্ষণ — ভাস্করাচার্য' } },
  { id: 'contributions-speed-of-light', phase: 1, topic: 'Astronomy & Physics', href: '/learn/contributions/speed-of-light', title: { en: 'Speed of Light — Sayana', hi: 'प्रकाश की गति — सायण', ta: 'ஒளியின் வேகம் — சாயணர்', bn: 'আলোর গতি — সায়ণ' } },
  { id: 'contributions-cosmic-time', phase: 1, topic: 'Astronomy & Physics', href: '/learn/contributions/cosmic-time', title: { en: 'Cosmic Time — Yugas & Kalpas', hi: 'ब्रह्माण्डीय काल — युग और कल्प', ta: 'பிரபஞ்ச காலம் — யுகங்கள் & கல்பங்கள்', bn: 'মহাজাগতিক কাল — যুগ ও কল্প' } },
  { id: 'contributions-al-khwarizmi', phase: 1, topic: 'Mathematics', href: '/learn/contributions/al-khwarizmi', title: { en: 'Al-Khwarizmi & Indian Mathematics', hi: 'अल-ख्वारिज्मी और भारतीय गणित', ta: 'அல்-குவாரிஸ்மி & இந்திய கணிதம்', bn: 'আল-খোয়ারিজমি ও ভারতীয় গণিত' } },
  { id: 'contributions-timeline', phase: 1, topic: 'Mathematics', href: '/learn/contributions/timeline', title: { en: 'Timeline of Indian Contributions', hi: 'भारतीय योगदान की समयरेखा', ta: 'இந்திய பங்களிப்புகளின் காலவரிசை', bn: 'ভারতীয় অবদানের সময়রেখা' } },
