...
published: true
published_url: "https://dev.to/krazykrackpot/hindu-festival-tithi-rules-ikh"
...
canonical_url: "https://medium.com/@aditya.kr.jha/hindu-festival-tithi-rules-e7cc0c927b75"
---
...
*Code: `src/lib/calendar/festival-defs.ts` and `src/lib/calendar/festival-generator.ts` in [dekhopanchang.com](https://dekhopanchang.com?utm_source=devto&utm_medium=article&utm_campaign=festival-rules). The muhurta rules sit on a `muhurtaRule` field with the kala-vyapti taxonomy documented inline.*
