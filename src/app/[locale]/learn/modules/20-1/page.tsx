    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Equal vs Unequal House Systems / समान बनाम असमान भाव पद्धतियाँ
        </h3>
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          How Placidus Calculates Cusps / प्लेसिडस भाव-सन्धि गणना
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Impact on Predictions / फलादेश पर प्रभाव
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
