...
const BRAHMAGUPTA_RULES = [
  ...
  { rule: { en: '(+) × (+) = (+)  [fortune × fortune = fortune]', hi: '(+) × (+) = (+)  [धन × धन = धन]', sa: '(+) × (+) = (+)  [धन × धन = धन]', mai: '(+) × (+) = (+)  [धन × धन = धन]', mr: '(+) × (+) = (+)  [धन × धन = धन]', ta: '(+) × (+) = (+)  [செல்வம் × செல்வம் = செல்வம்]', te: '(+) × (+) = (+)  [ధనం × ధనం = ధనం]', bn: '(+) × (+) = (+)  [ধন × ধন = ধন]', kn: '(+) × (+) = (+)  [ಧನ × ಧನ = ಧನ]', gu: '(+) × (+) = (+)  [ધન × ધન = ધન]' }, sign: 'bg-emerald-500/10 border-emerald-500/20 text-emerald-400' },
