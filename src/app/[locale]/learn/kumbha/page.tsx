  ...
  return (
    <main className="max-w-4xl mx-auto px-4 sm:px-6 pt-28 pb-16">
      ...
      <LessonSection number={next()} title={ml({ en: 'Health & Body', hi: 'स्वास्थ्य एवं शरीर' })}>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-bg-primary/50 rounded-lg border border-gold-primary/10 p-3">
            ...
            <p className="text-text-primary text-sm mt-1" style={bf}>{ml({ en: 'Ankles, calves, shins, circulatory system, nervous system (electrical), peripheral blood vessels', hi: 'टखने, पिण्डलियाँ, नलियाँ, रक्त संचार तन्त्र, तन्त्रिका तन्त्र (विद्युत), परिधीय रक्त वाहिकाएँ' })}</p>
          </div>
          <div className="bg-bg-primary/50 rounded-lg border border-gold-primary/10 p-3">
            <span className="text-gold-dark text-xs uppercase tracking-wider">{ml({ en: 'Ayurvedic Constitution', hi: 'आयुर्वेदिक प्रकृति' })}</span>
            <p className="text-text-primary text-sm mt-1" style={bf}>{ml({ en: 'Vata dominant (air-cold). Favour warming, circulation-supporting foods. Avoid cold, dry items and excess caffeine. Leg circulation exercises essential. Grounding practices counterbalance airy nature.', hi: 'वात प्रधान (वायु-शीत)। ऊष्ण, संचार-सहायक आहार अनुकूल। शीतल, शुष्क पदार्थ और अतिरिक्त कैफीन वर्जित। पैर संचार व्यायाम अनिवार्य। भूमिकारक अभ्यास वायव प्रकृति सन्तुलित।' })}</p>
          </div>
        </div>
      </LessonSection>
      ...
      <LessonSection number={next()} title={ml({ en: 'Practical Application', hi: 'व्यावहारिक अनुप्रयोग' })}>
        ...
        <WhyItMatters locale={locale}>
          {ml({ en: 'Reading Kumbha in a chart reveals where the native thinks beyond personal interest, where innovation and unconventional approaches yield breakthroughs, and where the tension between individual authenticity and collective belonging must be resolved. The house where Aquarius falls is where you serve something larger than yourself — and where detachment must be balanced with enough human warmth to remain connected.', hi: 'कुण्डली में कुम्भ पढ़ना बताता है कि जातक कहाँ व्यक्तिगत हित से परे सोचता है, नवाचार और अपरम्परागत दृष्टिकोण कहाँ सफलता देते हैं, और व्यक्तिगत प्रामाणिकता और सामूहिक अपनेपन का तनाव कहाँ हल करना है। जिस भाव में कुम्भ पड़ता है वहाँ स्वयं से बड़ी किसी चीज़ की सेवा — और वैराग्य को जुड़े रहने के लिए पर्याप्त मानवीय ऊष्णता से सन्तुलित करना।' })}
        </WhyItMatters>
      </LessonSection>

      {/* ── 12. Kumbha as House Cusp ── */}
      <LessonSection number={next()} title={ml({ en: 'Kumbha as House Cusp', hi: 'भाव शिखर के रूप में कुम्भ' })}>
        <p style={bf} className="mb-3">{ml({ en: 'When Kumbha falls on different house cusps, it brings Saturn and Rahu\'s innovative, humanitarian, and unconventional energy to that life domain. Here is how Aquarius colours each house:', hi: 'जब कुम्भ विभिन्न भाव शिखरों पर पड़ता है, तो वह उस जीवन क्षेत्र में शनि और राहु की नवाचारी, मानवतावादी और अपरम्परागत ऊर्जा लाता है। यहाँ कुम्भ प्रत्येक भाव को कैसे रंगता है:' })}</p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {[
            { house: '1st', effect: { en: 'Saturn-Rahu ruled personality — unconventional appearance, intellectual bearing, socially conscious. Thinks differently from peers. Natural innovator who challenges outdated norms.', hi: 'शनि-राहु शासित व्यक्तित्व — अपरम्परागत दिखावट, बौद्धिक आचरण, सामाजिक रूप से सचेत। साथियों से भिन्न सोचता है। पुरानी रीतियों को चुनौती देने वाला स्वाभाविक नवाचारक।' } },
            { house: '2nd', effect: { en: 'Wealth through technology, innovation, and unconventional means. Speech is intellectually original but can seem detached. Family values centred on social justice and progressive thinking.', hi: 'प्रौद्योगिकी, नवाचार और अपरम्परागत माध्यमों से धन। वाणी बौद्धिक रूप से मौलिक किन्तु विरक्त लग सकती है। सामाजिक न्याय और प्रगतिशील चिन्तन वाले पारिवारिक मूल्य।' } },
            { house: '3rd', effect: { en: 'Original, innovative communication. Writing about technology, social change, and future visions. Unconventional sibling relationships. Short travels for social causes and networking.', hi: 'मौलिक, नवाचारी संवाद। प्रौद्योगिकी, सामाजिक परिवर्तन और भविष्य दृष्टि पर लेखन। अपरम्परागत भाई-बहन सम्बन्ध। सामाजिक कारणों और नेटवर्किंग हेतु लघु यात्राएँ।' } },
            { house: '4th', effect: { en: 'Unconventional home setup — communal living, smart home technology, or minimalist design. Mother is progressive and independent. Emotional security from belonging to a like-minded community.', hi: 'अपरम्परागत गृह व्यवस्था — सामुदायिक जीवन, स्मार्ट होम प्रौद्योगिकी या न्यूनतावादी डिज़ाइन। माता प्रगतिशील और स्वतन्त्र। समान विचारधारा समुदाय से भावनात्मक सुरक्षा।' } },
            { house: '5th', effect: { en: 'Creative expression through technology, digital art, and social innovation. Unconventional romantic relationships. Children are independent and intellectually gifted. Speculation through technology and networking.', hi: 'प्रौद्योगिकी, डिजिटल कला और सामाजिक नवाचार से सृजनात्मक अभिव्यक्ति। अपरम्परागत रोमांटिक सम्बन्ध। सन्तान स्वतन्त्र और बौद्धिक रूप से प्रतिभाशाली। प्रौद्योगिकी और नेटवर्किंग से सट्टा।' } },
            { house: '6th', effect: { en: 'Circulatory and nervous system health concerns. Service in technology, social work, or alternative healing. Unconventional approaches to defeating enemies. Interest in alternative medicine and biohacking.', hi: 'संचार और तन्त्रिका तन्त्र स्वास्थ्य चिन्ताएँ। प्रौद्योगिकी, सामाजिक कार्य या वैकल्पिक चिकित्सा में सेवा। शत्रुओं को पराजित करने के अपरम्परागत तरीके। वैकल्पिक चिकित्सा और बायोहैकिंग में रुचि।' } },
            { house: '7th', effect: { en: 'Spouse is unconventional, intellectual, and socially conscious. Non-traditional marriage arrangements. Business partnerships in technology or social enterprise. Relationship based on shared ideals rather than convention.', hi: 'जीवनसाथी अपरम्परागत, बौद्धिक और सामाजिक रूप से सचेत। गैर-पारम्परिक विवाह व्यवस्था। प्रौद्योगिकी या सामाजिक उद्यम में व्यापारिक साझेदारी। परम्परा के बजाय साझे आदर्शों पर आधारित सम्बन्ध।' } },
            { house: '8th', effect: { en: 'Transformation through technological or social revolution. Unconventional inheritance or crowdfunded resources. Interest in consciousness research and death-tech. Sudden, unexpected transformative events.', hi: 'तकनीकी या सामाजिक क्रान्ति से रूपान्तरण। अपरम्परागत विरासत या क्राउडफण्डेड संसाधन। चेतना शोध और मृत्यु-तकनीक में रुचि। अचानक, अप्रत्याशित रूपान्तरकारी घटनाएँ।' } },
            { house: '9th', effect: { en: 'Dharma through social innovation and unconventional spirituality. Father is progressive or unconventional. Fortune through technology and social networks. Non-traditional approaches to higher learning.', hi: 'सामाजिक नवाचार और अपरम्परागत अध्यात्म से धर्म। पिता प्रगतिशील या अपरम्परागत। प्रौद्योगिकी और सामाजिक नेटवर्क से भाग्य। उच्च शिक्षा के गैर-पारम्परिक दृष्टिकोण।' } },
            { house: '10th', effect: { en: 'Career in technology, social activism, scientific research, humanitarian organizations, or network systems. Public reputation for innovation and unconventional thinking. Career involves changing systems and structures.', hi: 'प्रौद्योगिकी, सामाजिक सक्रियता, वैज्ञानिक शोध, मानवतावादी संगठनों या नेटवर्क प्रणालियों में करियर। नवाचार और अपरम्परागत चिन्तन की सार्वजनिक प्रतिष्ठा। करियर प्रणालियाँ और संरचनाएँ बदलना।' } },
            { house: '11th', effect: { en: 'Aquarius in its natural house — extraordinary networking capacity and collective leadership. Friends are diverse, intellectual, and socially committed. Gains through technology and large networks. Aspirations are humanitarian.', hi: 'कुम्भ अपने स्वाभाविक भाव में — असाधारण नेटवर्किंग क्षमता और सामूहिक नेतृत्व। मित्र विविध, बौद्धिक और सामाजिक रूप से प्रतिबद्ध। प्रौद्योगिकी और बड़े नेटवर्क से लाभ। मानवतावादी आकांक्षाएँ।' } },
            { house: '12th', effect: { en: 'Expenditure on humanitarian causes and technology. Foreign residence in progressive communities. Spiritual growth through collective meditation and group consciousness work. Detachment as spiritual practice.', hi: 'मानवतावादी कारणों और प्रौद्योगिकी पर व्यय। प्रगतिशील समुदायों में विदेशी निवास। सामूहिक ध्यान और समूह चेतना कार्य से आध्यात्मिक विकास। आध्यात्मिक साधना के रूप में वैराग्य।' } },
          ].map((item, i) => (
