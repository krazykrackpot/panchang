...
const LABELS = {
  ...
  disclaimer: L(
    'This comparison is based on publicly available features as of June 2026. We respect Drik Panchang as a pioneering platform that has served millions. This page highlights differences to help users choose the right tool for their needs.',
    'यह तुलना जून 2026 तक सार्वजनिक रूप से उपलब्ध सुविधाओं पर आधारित है। हम दृक् पंचांग को एक अग्रणी मंच के रूप में सम्मान करते हैं। यह पृष्ठ उपयोगकर्ताओं को सही उपकरण चुनने में मदद करता है।',
  ),
...
const ROWS: CompRow[] = [
  ...
  },
  {
    ...
    drik: 'Standard panchang reference following the same Pratipada-anchored convention.',
  ...
  },
  {
    ...
    drik: 'Per-region pages exist; no unified side-by-side comparison hub.',
    dekhoYes: true, drikYes: false, highlight: true,
  },
  {
    ...
    drik: 'Generic muhurta tables; no dedicated career-window scorer.',
    dekhoYes: true, drikYes: false, highlight: true,
  },
  {
    ...
    drik: 'Reference data only; no automated medical-astrology diagnosis engine.',
    dekhoYes: true, drikYes: false, highlight: true,
  },
  {
  ...
  return (
    <main className="min-h-screen bg-bg-primary">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <CompareOthers currentSlug="drik-panchang" />
