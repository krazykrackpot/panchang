    ...
    <div className="space-y-10">
      ...
      <div className={sectionCard}>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {[
            { label: { en: 'Language', hi: 'भाषा', sa: 'भाषा', mai: 'भाषा', mr: 'भाषा', ta: 'மொழி', te: 'భాష', bn: 'ভাষা', kn: 'ಭಾಷೆ', gu: 'ભાષા' }, value: { en: 'Malayalam', hi: 'मलयालम', sa: 'मलयालम', mai: 'मलयालम', mr: 'मलयालम', ta: 'Malayalam', te: 'Malayalam', bn: 'Malayalam', kn: 'Malayalam', gu: 'Malayalam' } },
            { label: { en: 'Written', hi: 'रचना', sa: 'रचना', mai: 'रचना', mr: 'रचना', ta: 'எழுதப்பட்டது', te: 'రాయబడింది', bn: 'লেখা হয়েছে', kn: 'ಬರೆಯಲಾಗಿದೆ', gu: 'લખાયેલ' }, value: { en: '~1530 CE', hi: '~1530 ई.', sa: '~1530 ई.', mai: '~1530 ई.', mr: '~1530 ई.', ta: '~1530 CE', te: '~1530 CE', bn: '~1530 CE', kn: '~1530 CE', gu: '~1530 CE' } },
            { label: { en: 'Contains', hi: 'विषयवस्तु', sa: 'विषयवस्तु', mai: 'विषयवस्तु', mr: 'विषयवस्तु', ta: 'கொண்டுள்ளது', te: 'కలిగి ఉంది', bn: 'ধারণ করে', kn: 'ಒಳಗೊಂಡಿದೆ', gu: 'સમાવે છે' }, value: { en: 'Full proofs', hi: 'पूर्ण प्रमाण', sa: 'पूर्ण प्रमाण', mai: 'पूर्ण प्रमाण', mr: 'पूर्ण प्रमाण', ta: 'Full proofs', te: 'Full proofs', bn: 'Full proofs', kn: 'Full proofs', gu: 'Full proofs' } },
