// src/lib/kundali/health-diagnosis/__tests__/elements/addictions.test.ts
import { describe, it, expect } from 'vitest';
import { generateKundali } from '@/lib/ephem/kundali-calc';
import type { BirthData } from '@/types/kundali';
import { collectStrengthInputs } from '../../strength-inputs';
import { detectAllSignatures } from '../../signatures';
import { scoreAddictions } from '../../elements/addictions';
...
const result = scoreAddictions(kundali, strength, signatures, 'en');

describe('scoreAddictions', () => {
  ...
  it('returns correct metadata matching ELEMENT_CATALOG[addictions]', () => {
    const meta = ELEMENT_CATALOG['addictions'];
    expect(result.id).toBe('addictions');
