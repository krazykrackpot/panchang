    ...
    <div>
      ...
      <LessonSection number={2} title={L.vimshottariTitle[locale]}>
        ...
        <div className="mt-6 space-y-2">
          {DASHA_PERIODS.map((d, i) => (
            ...
            >
              <div className="w-20 text-right text-sm font-semibold" style={{ color: d.color }}>
                {locale === 'en' || String(locale) === 'ta' ? d.planet : d.planetHi}
              </div>
              <div
              ...
              >
                {d.years} {locale === 'en' || String(locale) === 'ta' ? 'yrs' : 'वर्ष'}
              </div>
          ...
          <div className="mt-2 text-center text-text-secondary/70 text-xs font-mono">
            Total: 7+20+6+10+7+18+16+19+17 = 120 {locale === 'en' || String(locale) === 'ta' ? 'years' : 'वर्ष'}
          </div>
        </div>
      </LessonSection>
          ...
          <table className="w-full text-xs">
            <thead>
              <tr className="border-b border-gold-primary/10">
                <th className="text-left py-2 px-2 text-gold-dark">{locale === 'en' || String(locale) === 'ta' ? 'Planet' : 'ग्रह'}</th>
                <th className="text-left py-2 px-2 text-gold-dark">{locale === 'en' || String(locale) === 'ta' ? 'Years' : 'वर्ष'}</th>
                <th className="text-left py-2 px-2 text-gold-dark">{locale === 'en' || String(locale) === 'ta' ? 'Ruling Nakshatras (1-9)' : 'शासित नक्षत्र (1-9)'}</th>
                <th className="text-left py-2 px-2 text-gold-dark">{locale === 'en' || String(locale) === 'ta' ? '(10-18)' : '(10-18)'}</th>
                <th className="text-left py-2 px-2 text-gold-dark">{locale === 'en' || String(locale) === 'ta' ? '(19-27)' : '(19-27)'}</th>
              </tr>
            </thead>
      ...
      <LessonSection number={4} title={L.calcTitle[locale]}>
        ...
        <div className="mt-4 p-4 bg-bg-primary/50 rounded-lg border border-gold-primary/10">
          ...
          <p className="text-gold-light/80 font-mono text-xs">1. {locale === 'en' || String(locale) === 'ta' ? 'Find Moon\'s Nakshatra at birth (e.g., Pushya)' : 'जन्म के समय चन्द्र का नक्षत्र ज्ञात करें (जैसे, पुष्य)'}</p>
          <p className="text-gold-light/80 font-mono text-xs">2. {locale === 'en' || String(locale) === 'ta' ? 'Nakshatra lord = Dasha lord at birth (Pushya lord = Saturn)' : 'नक्षत्र स्वामी = जन्म पर दशा स्वामी (पुष्य स्वामी = शनि)'}</p>
          <p className="text-gold-light/80 font-mono text-xs">3. {locale === 'en' || String(locale) === 'ta' ? 'Moon\'s progress through Nakshatra = elapsed portion of Dasha' : 'नक्षत्र में चन्द्र की प्रगति = दशा का बीता हुआ भाग'}</p>
          <p className="text-gold-light/80 font-mono text-xs mt-2">
            {locale === 'en' || String(locale) === 'ta' ? 'Example: Moon at 10° in Pushya (3°20\' to 16°40\')' : 'उदाहरण: पुष्य में चन्द्र 10° पर (3°20\' से 16°40\')'}
          </p>
          <p className="text-gold-light/80 font-mono text-xs">
            {locale === 'en' || String(locale) === 'ta' ? 'Progress = (10° - 3.333°) / 13.333° = 50%' : 'प्रगति = (10° - 3.333°) / 13.333° = 50%'}
          </p>
          <p className="text-gold-light/80 font-mono text-xs">
            {locale === 'en' || String(locale) === 'ta' ? 'Remaining Saturn Dasha = 19 × (1 - 0.50) = 9.5 years' : 'शेष शनि दशा = 19 × (1 - 0.50) = 9.5 वर्ष'}
          </p>
        </div>
      </LessonSection>
        ...
        <div className="mt-4 space-y-3">
          <div className="p-4 bg-bg-primary/50 rounded-lg border border-gold-primary/10">
            <p className="text-gold-light font-mono text-sm mb-3">
              {locale === 'en' || String(locale) === 'ta' ? 'Given: Moon at 14°30\' Aries (Mesha)' : 'दिया गया: मेष में चन्द्र 14°30\' पर'}
            </p>
            <div className="space-y-1.5 text-gold-light/80 font-mono text-xs">
              <p>{locale === 'en' || String(locale) === 'ta' ? 'Step 1: Identify Nakshatra' : 'चरण 1: नक्षत्र पहचानें'}</p>
              <p className="pl-4">{locale === 'en' || String(locale) === 'ta' ? '14°30\' Aries falls in Bharani (13°20\' - 26°40\' Aries)' : '14°30\' मेष भरणी में आता है (13°20\' - 26°40\' मेष)'}</p>
              <p className="mt-2">{locale === 'en' || String(locale) === 'ta' ? 'Step 2: Nakshatra lord' : 'चरण 2: नक्षत्र स्वामी'}</p>
              <p className="pl-4">{locale === 'en' || String(locale) === 'ta' ? 'Bharani lord = Venus → Birth Dasha = Venus Maha Dasha' : 'भरणी स्वामी = शुक्र → जन्म दशा = शुक्र महादशा'}</p>
              <p className="mt-2">{locale === 'en' || String(locale) === 'ta' ? 'Step 3: Calculate progress through Nakshatra' : 'चरण 3: नक्षत्र में प्रगति गणना'}</p>
              <p className="pl-4">{locale === 'en' || String(locale) === 'ta' ? 'Moon position within Bharani = 14°30\' - 13°20\' = 1°10\' = 1.167°' : 'भरणी में चन्द्र स्थिति = 14°30\' - 13°20\' = 1°10\' = 1.167°'}</p>
              <p className="pl-4">{locale === 'en' || String(locale) === 'ta' ? 'Nakshatra span = 13°20\' = 13.333°' : 'नक्षत्र विस्तार = 13°20\' = 13.333°'}</p>
              <p className="pl-4">{locale === 'en' || String(locale) === 'ta' ? 'Progress = 1.167 / 13.333 = 8.75% elapsed' : 'प्रगति = 1.167 / 13.333 = 8.75% बीता'}</p>
              <p className="mt-2">{locale === 'en' || String(locale) === 'ta' ? 'Step 4: Calculate remaining Dasha' : 'चरण 4: शेष दशा गणना'}</p>
              <p className="pl-4">{locale === 'en' || String(locale) === 'ta' ? 'Venus total = 20 years' : 'शुक्र कुल = 20 वर्ष'}</p>
              <p className="pl-4">{locale === 'en' || String(locale) === 'ta' ? 'Remaining = 20 × (1 - 0.0875) = 18.25 years = 18 years 3 months' : 'शेष = 20 × (1 - 0.0875) = 18.25 वर्ष = 18 वर्ष 3 माह'}</p>
              <p className="mt-2">{locale === 'en' || String(locale) === 'ta' ? 'Step 5: Sequence after Venus' : 'चरण 5: शुक्र के बाद का क्रम'}</p>
          ...
          {OTHER_DASHA_SYSTEMS.map((sys, i) => (
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-text-tertiary text-xs font-mono">{sys.cycle} / {sys.planets} {locale === 'en' || String(locale) === 'ta' ? 'planets' : 'ग्रह'}</span>
              </div>
              ...
              <div className="mt-2 text-xs text-emerald-400/80 font-mono">
                {locale === 'en' || String(locale) === 'ta' ? 'Best used when: ' : 'सर्वोत्तम उपयोग: '}{sys.when[locale]}
              </div>
            </motion.div>
          ))}
        </div>
      ...
      <LessonSection number={10} title={L.findYourTitle[locale]}>
        ...
        <div className="mt-4 p-4 bg-bg-primary/50 rounded-lg border border-gold-primary/10">
          ...
          <div className="space-y-1 text-gold-light/80 font-mono text-xs">
            <p>1. {locale === 'en' || String(locale) === 'ta' ? 'Go to /kundali and enter your birth details' : '/kundali पर जाएँ और जन्म विवरण दर्ज करें'}</p>
            <p>2. {locale === 'en' || String(locale) === 'ta' ? 'Click on the "Dashas" tab in the results' : 'परिणामों में "दशा" टैब पर क्लिक करें'}</p>
            <p>3. {locale === 'en' || String(locale) === 'ta' ? 'The highlighted row is your current Maha Dasha' : 'हाइलाइट पंक्ति आपकी वर्तमान महादशा है'}</p>
            <p>4. {locale === 'en' || String(locale) === 'ta' ? 'Expand it to see Antardashas — the highlighted sub-row is your current Antardasha' : 'इसे विस्तार करें अन्तर्दशाएँ देखने के लिए — हाइलाइट उप-पंक्ति आपकी वर्तमान अन्तर्दशा है'}</p>
          </div>
        </div>
      </LessonSection>
      ...
      <LessonSection number={11} title={L.antardashaCalcTitle[locale]}>
        ...
        <div className="mt-4 bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-2xl p-4 overflow-x-auto">
          <p className="text-gold-light text-sm font-semibold mb-3" style={headingFont}>
            {locale === 'en' || String(locale) === 'ta' ? 'Venus Maha Dasha (20 years) — All 9 Antardashas' : 'शुक्र महादशा (20 वर्ष) — सभी 9 अन्तर्दशाएँ'}
          </p>
          <table className="w-full text-xs">
            <thead>
              <tr className="border-b border-gold-primary/10">
                <th className="text-left py-2 px-2 text-gold-dark">{locale === 'en' || String(locale) === 'ta' ? 'Antardasha' : 'अन्तर्दशा'}</th>
                <th className="text-left py-2 px-2 text-gold-dark">{locale === 'en' || String(locale) === 'ta' ? 'Calculation' : 'गणना'}</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-gold-primary/5">
              {VENUS_ANTARDASHA_EXAMPLE.map((ad) => (
                <tr key={ad.planet} className="hover:bg-gold-primary/3">
                  <td className="py-2 px-2 font-medium text-text-secondary">
                    {locale === 'en' || String(locale) === 'ta' ? `Venus-${ad.planet}` : `शुक्र-${ad.planetHi}`}
                  </td>
          ...
          <p className="mt-2 text-text-tertiary text-xs font-mono">
            {locale === 'en' || String(locale) === 'ta' ? 'Total: 3y4m + 1y + 1y8m + 1y2m + 3y + 2y8m + 3y2m + 2y10m + 1y2m = 20 years' : 'कुल: 3वर्ष4माह + 1वर्ष + 1वर्ष8माह + 1वर्ष2माह + 3वर्ष + 2वर्ष8माह + 3वर्ष2माह + 2वर्ष10माह + 1वर्ष2माह = 20 वर्ष'}
          </p>
        </div>
      </LessonSection>
          ...
          {MAHADASHA_THEMES.map((md, i) => (
            ...
            >
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-text-tertiary text-xs font-mono">{md.years} {locale === 'en' || String(locale) === 'ta' ? 'years' : 'वर्ष'}</span>
              </div>
          ...
          {[
            ...
            <div key={item.from.en} className={`rounded-lg p-3 border ${item.color}`}>
              ...
              <div className="text-text-tertiary text-xs font-mono mb-1">
                {locale === 'en' || String(locale) === 'ta' ? `Friction: ${item.friction.en}` : `घर्षण: ${item.friction.hi}`}
              </div>
