    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Ashta Kuta — The Eight-Factor Compatibility System / अष्ट कूट — आठ-कारक अनुकूलता पद्धति
        </h3>
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Tara Kuta — Star Compatibility in Detail / तारा कूट — तारा अनुकूलता विस्तार से
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        ...
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Example:</span> Bride&apos;s nakshatra = Rohini (4th). Groom&apos;s nakshatra = Hasta (13th). Count from bride to groom: 13 - 4 + 1 = 10. 10 mod 9 = 1 → Janma tara (neutral). Count from groom to bride: 4 - 13 + 27 + 1 = 19. 19 mod 9 = 1 → Janma tara (neutral). Since both directions give non-harmful taras, Tara Kuta is satisfied.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">उदाहरण:</span> वधू का नक्षत्र = रोहिणी (4था)। वर का नक्षत्र = हस्त (13वाँ)। वधू से वर तक गणना: 13 - 4 + 1 = 10। 10 mod 9 = 1 → जन्म तारा (तटस्थ)। वर से वधू तक: 4 - 13 + 27 + 1 = 19। 19 mod 9 = 1 → जन्म तारा (तटस्थ)। चूँकि दोनों दिशाओं में हानिकारक तारा नहीं, तारा कूट सन्तुष्ट है।
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Counter-example:</span> Bride = Ashwini (1st), Groom = Jyeshtha (18th). Count: 18 - 1 + 1 = 18. 18 mod 9 = 0 → maps to 9 (Atimitra, favorable). Reverse: 1 - 18 + 27 + 1 = 11. 11 mod 9 = 2 → Sampat (favorable). Both directions are favorable — full 3 points awarded.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">प्रति-उदाहरण:</span> वधू = अश्विनी (1ला), वर = ज्येष्ठा (18वाँ)। गणना: 18 - 1 + 1 = 18। 18 mod 9 = 0 → 9 (अतिमित्र, अनुकूल)। विपरीत: 1 - 18 + 27 + 1 = 11। 11 mod 9 = 2 → सम्पत् (अनुकूल)। दोनों दिशाएँ अनुकूल — पूर्ण 3 अंक प्रदत्त।
        </p>
      </section>
      ...
      <section className="glass-card rounded-xl p-5 border border-red-500/15">
        ...
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">भ्रान्ति:</span> &quot;यदि तारा कूट अंक 0 है तो विवाह विनाशकारी होगा।&quot; तारा कूट 36 में से केवल 3 अंक वहन करता है। कमजोर तारा अंक की भरपाई भकूट (7), नाड़ी (8) और ग्रह मैत्री (5) के सुदृढ़ अंकों से हो सकती है। कोई भी एकल कूट पृथक् रूप से मूल्यांकित नहीं होना चाहिए — समग्र अंक और सभी 8 कूटों का प्रारूप सर्वाधिक महत्त्वपूर्ण है।
        </p>
      </section>
...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Nadi Dosha — The Most Feared Incompatibility / नाड़ी दोष — सर्वाधिक भयावह अनुकूलता दोष
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Nadi Dosha Cancellation Conditions / नाड़ी दोष निवारण शर्तें
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">Worked Examples / कार्यान्वित उदाहरण</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Example:</span> Bride = Rohini (Aadi nadi, Taurus), Groom = Mrigashira (Madhya nadi, Taurus/Gemini). Rohini is Aadi, Mrigashira is Madhya — different nadis. Full 8 points awarded. No Nadi Dosha.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">उदाहरण:</span> वधू = रोहिणी (आदि नाड़ी, वृषभ), वर = मृगशिरा (मध्य नाड़ी, वृषभ/मिथुन)। रोहिणी आदि है, मृगशिरा मध्य — भिन्न नाड़ियाँ। पूर्ण 8 अंक प्रदत्त। नाड़ी दोष नहीं।
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Dosha case:</span> Bride = Ashwini (Aadi nadi, Aries), Groom = Punarvasu (Aadi nadi, Gemini/Cancer). Both Aadi — Nadi Dosha triggered, 0/8 points. However, since their rashis are different and rashi lords (Mars vs Mercury/Moon) are not enemies, partial cancellation may apply in some traditions.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">दोष स्थिति:</span> वधू = अश्विनी (आदि नाड़ी, मेष), वर = पुनर्वसु (आदि नाड़ी, मिथुन/कर्क)। दोनों आदि — नाड़ी दोष, 0/8 अंक। तथापि, चूँकि उनकी राशियाँ भिन्न हैं और राशि स्वामी (मंगल बनाम बुध/चन्द्र) शत्रु नहीं हैं, कुछ परम्पराओं में आंशिक निवारण लागू हो सकता है।
        </p>
      </section>
