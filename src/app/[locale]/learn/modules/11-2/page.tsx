    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          {tl({ en: 'Yogini Dasha — The 36-Year Cycle', hi: 'योगिनी दशा — 36 वर्षीय चक्र', sa: 'योगिनी दशा — 36 वर्षीय चक्र' }, locale)}
        </h3>
      ...
      <section className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-xl p-5">
        <h4 className="text-gold-dark text-xs uppercase tracking-widest font-bold mb-2">{tl({ en: 'The Eight Yoginis — Quick Reference', hi: 'आठ योगिनियाँ — त्वरित सन्दर्भ', sa: 'आठ योगिनियाँ — त्वरित सन्दर्भ' }, locale)}</h4>
...
function Page2() {
  ...
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          {tl({ en: 'Char Dasha (Jaimini) — Sign-Based Timing', hi: 'चर दशा (जैमिनी) — राशि-आधारित समय-निर्धारण', sa: 'चर दशा (जैमिनी) — राशि-आधारित समय-निर्धारण' }, locale)}
        </h3>
      ...
      <section className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-xs uppercase tracking-widest font-bold mb-3">{tl({ en: 'Rashi Drishti — Jaimini Aspects', hi: 'राशि दृष्टि — जैमिनी दृष्टि', sa: 'राशि दृष्टि — जैमिनी दृष्टि' }, locale)}</h4>
...
function Page3() {
  ...
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          {tl({ en: 'When to Use Which System', hi: 'कौन-सी पद्धति कब प्रयोग करें', sa: 'कौन-सी पद्धति कब प्रयोग करें' }, locale)}
        </h3>
      ...
      <section className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-xl p-5 border border-blue-500/15">
        <h4 className="text-blue-300 text-xs uppercase tracking-widest font-bold mb-3">{tl({ en: 'Convergent Validation in Practice', hi: 'व्यवहार में अभिसारी प्रमाणीकरण', sa: 'व्यवहार में अभिसारी प्रमाणीकरण' }, locale)}</h4>
