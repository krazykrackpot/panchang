  ...
  return (
    <div>
      ...
      <LessonSection number={1} title={L.jdTitle[locale]}>
        ...
        <div className="mt-4 p-4 bg-bg-primary/50 rounded-lg border border-gold-primary/10">
          <p className="text-gold-light font-mono text-sm mb-2">
            {locale === 'en' ? 'Julian Day Conversion (Meeus formula):' : 'जूलियन दिन रूपान्तरण:'}
          </p>
          ...
          <p className="text-gold-light/60 font-mono text-xs mt-2">
            {locale === 'en' ? 'Then: T = (JD - 2451545.0) / 36525.0  → centuries from J2000.0' : 'फिर: T = (JD - 2451545.0) / 36525.0  → J2000.0 से शताब्दियाँ'}
          </p>
        </div>
      </LessonSection>
      ...
      <LessonSection number={2} title={L.sunTitle[locale]}>
        ...
        <div className="mt-4 p-4 bg-bg-primary/50 rounded-lg border border-gold-primary/10">
          <p className="text-gold-light font-mono text-sm mb-2">
            {locale === 'en' ? 'Our Sun algorithm (Meeus Ch. 25):' : 'हमारा सूर्य एल्गोरिथ्म:'}
          </p>
      ...
      <LessonSection number={3} title={L.moonTitle[locale]}>
        ...
        <div className="mt-4 p-4 bg-bg-primary/50 rounded-lg border border-gold-primary/10">
          <p className="text-gold-light font-mono text-sm mb-2">
            {locale === 'en' ? 'Moon longitude — 60-term algorithm:' : 'चन्द्र देशान्तर — 60-पद एल्गोरिथ्म:'}
          </p>
      ...
      <LessonSection number={4} title={L.ayanamshaTitle[locale]}>
        ...
        <div className="mt-4 p-4 bg-bg-primary/50 rounded-lg border border-gold-primary/10">
          <p className="text-gold-light font-mono text-sm mb-2">
            {locale === 'en' ? 'Lahiri Ayanamsha polynomial:' : 'लहिरी अयनांश बहुपद:'}
          </p>
          ...
          <p className="text-gold-light/60 font-mono text-xs mt-1">
            {locale === 'en' ? 'where T = centuries from J2000.0' : 'जहाँ T = J2000.0 से शताब्दियाँ'}
          </p>
      ...
      <LessonSection number={6} title={L.transitionTitle[locale]}>
        ...
        <div className="mt-4 p-4 bg-bg-primary/50 rounded-lg border border-gold-primary/10">
          <p className="text-gold-light font-mono text-sm mb-2">
            {locale === 'en' ? 'Binary Search Algorithm:' : 'बाइनरी खोज एल्गोरिथ्म:'}
          </p>
          ...
          <p className="text-gold-light/60 font-mono text-xs mt-2">
            {locale === 'en' ? 'Converges in ~20 iterations → ~40 function evaluations per element' : '~20 पुनरावृत्तियों में अभिसरित → प्रति तत्व ~40 फ़ंक्शन मूल्यांकन'}
          </p>
        </div>
      </LessonSection>
      ...
      <LessonSection number={7} title={L.sunriseTitle[locale]}>
        ...
        <div className="mt-4 p-4 bg-bg-primary/50 rounded-lg border border-gold-primary/10">
          <p className="text-gold-light font-mono text-sm mb-2">
            {locale === 'en' ? 'Sunrise calculation:' : 'सूर्योदय गणना:'}
          </p>
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gold-primary/20">
                <th className="text-left py-2 text-gold-primary font-semibold">{locale === 'en' ? 'Calculation' : 'गणना'}</th>
                <th className="text-left py-2 text-gold-primary font-semibold">{locale === 'en' ? 'Accuracy' : 'सटीकता'}</th>
                <th className="text-left py-2 text-gold-primary font-semibold">{locale === 'en' ? 'Practical Impact' : 'व्यावहारिक प्रभाव'}</th>
              </tr>
            </thead>
            <tbody>
