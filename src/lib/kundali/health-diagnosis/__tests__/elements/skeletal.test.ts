// src/lib/kundali/health-diagnosis/__tests__/elements/skeletal.test.ts
//
// Task B7 — skeletal element scorer tests.
//
...
import { scoreSkeletal } from '../../elements/skeletal';
...
const result = scoreSkeletal(kundali, strength, signatures, 'en');

describe('scoreSkeletal', () => {
  ...
  it('returns correct metadata matching ELEMENT_CATALOG[skeletal]', () => {
    const meta = ELEMENT_CATALOG['skeletal'];
    expect(result.id).toBe('skeletal');
