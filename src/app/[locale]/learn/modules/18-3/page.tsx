    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          What is Ashtakavarga? / अष्टकवर्ग क्या है?
        </h3>
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Reading BAV and SAV Tables / BAV और SAV तालिकाएँ पढ़ना
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">Worked Example: Saturn&apos;s BAV / कार्यरत उदाहरण: शनि का BAV</h4>
...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Transit Prediction with Ashtakavarga / अष्टकवर्ग से गोचर भविष्यवाणी
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
