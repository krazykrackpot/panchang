    ...
    <div className="max-w-4xl mx-auto px-4 py-10 space-y-10">
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="text-gold-dark text-xs uppercase tracking-widest border-b border-gold-primary/15">
                ...
                <th className="text-left py-3 px-3">{tl({ en: 'House', hi: 'भाव', sa: 'भावः' }, locale)}</th>
                <th className="text-left py-3 px-3">{tl({ en: 'Significations', hi: 'कारकत्व', sa: 'कारकत्वानि' }, locale)}</th>
                <th className="text-center py-3 px-3">{tl({ en: 'Type', hi: 'वर्ग', sa: 'प्रकारः' }, locale)}</th>
              </tr>
            </thead>
            <tbody>
              {[
                ...
                <motion.tr key={h.num} initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}
                  ...
                  <td className="py-2.5 px-3 text-center">
                    <span className={`text-xs px-2 py-0.5 rounded border ${classificationColor(h.classification)}`}>
                      {h.classification === 'kendra' ? tl({ en: 'Kendra', hi: 'केन्द्र', sa: 'केन्द्रम्' }, locale) :
                       h.classification === 'trikona' ? tl({ en: 'Trikona', hi: 'त्रिकोण', sa: 'त्रिकोणम्' }, locale) :
                       h.classification === 'dusthana' ? tl({ en: 'Dusthana', hi: 'दुःस्थान', sa: 'दुःस्थानम्' }, locale) :
                       h.classification === 'upachaya' ? tl({ en: 'Upachaya', hi: 'उपचय', sa: 'उपचयः' }, locale) :
                       tl({ en: 'Maraka', hi: 'मारक', sa: 'मारकः' }, locale)}
                    </span>
                  </td>
                </motion.tr>
              ))}
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead>
              <tr className="text-gold-dark text-xs uppercase tracking-widest border-b border-gold-primary/15">
                <th className="text-left py-3 px-3">{tl({ en: 'House', hi: 'भाव', sa: 'भावः' }, locale)}</th>
                <th className="text-left py-3 px-3">{tl({ en: 'Remedies', hi: 'उपचार', sa: 'उपायाः' }, locale)}</th>
              </tr>
            </thead>
            <tbody>
      ...
      <motion.section initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
        ...
        <div className="flex flex-wrap justify-center gap-3">
          {[
            { href: '/kundali', label: { en: 'Generate Kundali', hi: 'कुण्डली बनाएं', sa: 'कुण्डली बनाएं', mai: 'कुण्डली बनाएं', mr: 'कुण्डली बनाएं', ta: 'குண்டலி உருவாக்கு', te: 'కుండలి రూపొందించు', bn: 'কুণ্ডলী তৈরি করুন', kn: 'ಕುಂಡಲಿ ರಚಿಸಿ', gu: 'કુંડળી બનાવો' } },
            { href: '/learn/modules/18-2', label: { en: 'Module 18-2: Bhavabala Deep Dive', hi: 'मॉड्यूल 18-2: भावबल विस्तार', sa: 'मॉड्यूल 18-2: भावबल विस्तार', mai: 'मॉड्यूल 18-2: भावबल विस्तार', mr: 'मॉड्यूल 18-2: भावबल विस्तार', ta: 'பாடம் 18-2: பாவபலா ஆழ்ந்த பார்வை', te: 'మాడ్యూల్ 18-2: భావబల లోతైన అధ్యయనం', bn: 'মডিউল ১৮-২: ভাববল গভীর অধ্যয়ন', kn: 'ಮಾಡ್ಯೂಲ್ 18-2: ಭಾವಬಲ ಆಳವಾದ ಅಧ್ಯಯನ', gu: 'મોડ્યુલ 18-2: ભાવબલ ઊંડો અભ્યાસ' } },
            { href: '/learn/shadbala', label: { en: 'Shadbala (Planet Strength)', hi: 'षड्बल (ग्रह शक्ति)', sa: 'षड्बल (ग्रह शक्ति)', mai: 'षड्बल (ग्रह शक्ति)', mr: 'षड्बल (ग्रह शक्ति)', ta: 'ஷட்பலா (கிரக பலம்)', te: 'షడ్బల (గ్రహ బలం)', bn: 'ষড়বল (গ্রহ বল)', kn: 'ಷಡ್ಬಲ (ಗ್ರಹ ಬಲ)', gu: 'ષડ્બળ (ગ્રહ બળ)' } },
          ].map((link) => (
