    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Shukla and Krishna Paksha / शुक्ल एवं कृष्ण पक्ष
        </h3>
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Amanta vs Purnimanta Calendar Systems / अमान्त बनाम पूर्णिमान्त पद्धतियाँ
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        ...
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Example:</span> Consider Maha Shivaratri, observed on Chaturdashi (14th) of Krishna Paksha. In Amanta, this falls in Magha month. In Purnimanta, the same day falls in Phalguna month (because after Magha Purnima, Purnimanta begins Phalguna). The astronomical event — the exact position of Moon and Sun — is identical. Only the label changes.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">उदाहरण:</span> महा शिवरात्रि पर विचार करें, जो कृष्ण पक्ष चतुर्दशी (14वीं) को मनाई जाती है। अमान्त में यह माघ मास में आती है। पूर्णिमान्त में वही दिन फाल्गुन मास में आता है (क्योंकि माघ पूर्णिमा के बाद पूर्णिमान्त में फाल्गुन आरम्भ होता है)। खगोलीय घटना — चन्द्रमा और सूर्य की ठीक वही स्थिति — समान है, केवल नाम बदलता है।
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">Tip:</span> When reading regional panchangs, always check whether they use Amanta or Purnimanta before mapping festivals to Gregorian dates. Our app supports both systems with a toggle, ensuring correct month labeling regardless of regional convention.
        </p>
      </section>
      ...
      <section className="glass-card rounded-xl p-5 border border-red-500/15">
        ...
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">भ्रान्ति:</span> "अमान्त और पूर्णिमान्त में त्योहारों की तिथियाँ भिन्न होती हैं।" शुक्ल पक्ष के त्योहारों के लिए यह असत्य है — चैत्र शुक्ल नवमी (राम नवमी) दोनों पद्धतियों में एक ही ग्रेगोरियन दिन पर और एक ही मास-नाम से आती है। भ्रम केवल कृष्ण पक्ष के अनुष्ठानों में उत्पन्न होता है जहाँ मास-नाम भिन्न होता है, वास्तविक तारीख नहीं।
        </p>
      </section>
    </div>
  );
...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Ritual Significance of Paksha / पक्ष का अनुष्ठानिक महत्त्व
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Ekadashi Fasting in Both Pakshas / दोनों पक्षों में एकादशी व्रत
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">Worked Examples / कार्यान्वित उदाहरण</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Example:</span> A devotee in Chennai (Amanta) and one in Varanasi (Purnimanta) both observe Vaikunta Ekadashi. The astronomical Ekadashi — the same Moon-Sun elongation — falls on the same Gregorian date for both. But if a Krishna Paksha festival is involved, the Chennai devotee calls it "Margashirsha Krishna Ekadashi" while the Varanasi devotee calls the same day "Pausha Krishna Ekadashi." The ritual performed and the date are identical; only the month label differs.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">उदाहरण:</span> चेन्नई (अमान्त) का एक भक्त और वाराणसी (पूर्णिमान्त) का एक भक्त दोनों वैकुण्ठ एकादशी मनाते हैं। खगोलीय एकादशी — वही चन्द्र-सूर्य कोणीय दूरी — दोनों के लिए एक ही ग्रेगोरियन तारीख पर आती है। किन्तु यदि कृष्ण पक्ष का कोई त्योहार हो तो चेन्नई का भक्त उसे "मार्गशीर्ष कृष्ण एकादशी" कहता है जबकि वाराणसी का भक्त उसी दिन को "पौष कृष्ण एकादशी" कहता है। अनुष्ठान और तारीख समान हैं; केवल मास-नाम भिन्न है।
        </p>
      </section>
