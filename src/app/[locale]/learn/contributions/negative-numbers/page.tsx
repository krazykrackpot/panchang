          ...
          <div className="mt-5 bg-white/[0.02] border border-gold-primary/15 rounded-xl p-5">
            ...
            <ul className="space-y-2">
              {[
                ...
                { en: 'Systematic treatment of losses and debts in commercial arithmetic', hi: 'वाणिज्यिक अंकगणित में हानि और ऋण का व्यवस्थित उपचार', sa: 'वाणिज्यिक अंकगणित में हानि और ऋण का व्यवस्थित उपचार', mai: 'वाणिज्यिक अंकगणित में हानि और ऋण का व्यवस्थित उपचार', mr: 'वाणिज्यिक अंकगणित में हानि और ऋण का व्यवस्थित उपचार', ta: 'வணிக எண்கணிதத்தில் இழப்புகள் மற்றும் கடன்களின் முறையான கையாளுதல்', te: 'వాణిజ్య గణితంలో నష్టాలు మరియు అప్పుల క్రమబద్ధ చికిత్స', bn: 'বাণিজ্যিক পাটিগণিতে ক্ষতি এবং ঋণের পদ্ধতিগত চিকিৎসা', kn: 'ವಾಣಿಜ್ಯ ಅಂಕಗಣಿತದಲ್ಲಿ ನಷ್ಟಗಳು ಮತ್ತು ಸಾಲಗಳ ಕ್ರಮಬದ್ಧ ಚಿಕಿತ್ಸೆ', gu: 'વ્યાપારી ગણિતમાં ખોટ અને દેવાંની વ્યવસ્થિત સારવાર' },
                { en: 'Worked with negative results in subtraction sequences', hi: 'घटाव अनुक्रमों में ऋणात्मक परिणामों के साथ काम किया', sa: 'घटाव अनुक्रमों में ऋणात्मक परिणामों के साथ काम किया', mai: 'घटाव अनुक्रमों में ऋणात्मक परिणामों के साथ काम किया', mr: 'घटाव अनुक्रमों में ऋणात्मक परिणामों के साथ काम किया', ta: 'கழிப்பு வரிசைகளில் எதிர்மறை முடிவுகளுடன் பணியாற்றினார்', te: 'వ్యవకలన శ్రేణులలో ఋణ ఫలితాలతో పనిచేశారు', bn: 'বিয়োগ ক্রমে ঋণাত্মক ফলাফল নিয়ে কাজ করেছেন', kn: 'ವ್ಯವಕಲನ ಅನುಕ್ರಮಗಳಲ್ಲಿ ಋಣ ಫಲಿತಾಂಶಗಳೊಂದಿಗೆ ಕೆಲಸ ಮಾಡಿದರು', gu: 'બાદબાકી ક્રમમાં ઋણાત્મક પરિણામો સાથે કામ કર્યું' },
                { en: 'Noted (incorrectly) that square roots of negatives do not exist — foreshadowing imaginary numbers by 700 years', hi: '(गलत तरीके से) नोट किया कि ऋणात्मक संख्याओं के वर्गमूल मौजूद नहीं हैं — काल्पनिक संख्याओं की 700 साल पहले भविष्यवाणी', sa: '(गलत तरीके से) नोट किया कि ऋणात्मक संख्याओं के वर्गमूल मौजूद नहीं हैं — काल्पनिक संख्याओं की 700 साल पहले भविष्यवाणी', mai: '(गलत तरीके से) नोट किया कि ऋणात्मक संख्याओं के वर्गमूल मौजूद नहीं हैं — काल्पनिक संख्याओं की 700 साल पहले भविष्यवाणी', mr: '(गलत तरीके से) नोट किया कि ऋणात्मक संख्याओं के वर्गमूल मौजूद नहीं हैं — काल्पनिक संख्याओं की 700 साल पहले भविष्यवाणी', ta: '(தவறாக) எதிர்மறைகளின் வர்க்கமூலங்கள் இல்லை என்று குறிப்பிட்டார் — கற்பனை எண்களை 700 ஆண்டுகள் முன்னரே முன்னறிவித்தார்', te: '(తప్పుగా) ఋణ సంఖ్యల వర్గమూలాలు ఉనికిలో లేవని గమనించారు — ఊహాత్మక సంఖ్యలను 700 సంవత్సరాల ముందుగానే సూచించారు', bn: '(ভুলভাবে) উল্লেখ করেছেন যে ঋণাত্মক সংখ্যার বর্গমূল নেই — 700 বছর আগে কাল্পনিক সংখ্যার পূর্বাভাস', kn: '(ತಪ್ಪಾಗಿ) ಋಣ ಸಂಖ್ಯೆಗಳ ವರ್ಗಮೂಲಗಳು ಅಸ್ತಿತ್ವದಲ್ಲಿಲ್ಲ ಎಂದು ಗಮನಿಸಿದರು — 700 ವರ್ಷಗಳ ಮುಂಚೆ ಕಾಲ್ಪನಿಕ ಸಂಖ್ಯೆಗಳನ್ನು ಮುನ್ಸೂಚಿಸಿದರು', gu: '(ખોટી રીતે) નોંધ્યું કે ઋણાત્મક સંખ્યાઓના વર્ગમૂળ અસ્તિત્વમાં નથી — 700 વર્ષ પહેલાં કાલ્પનિક સંખ્યાઓનો પૂર્વાભાસ' },
              ].map((item, i) => (
          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="rounded-xl bg-emerald-500/5 border border-emerald-500/20 p-5">
              ...
              <ul className="space-y-2 text-text-secondary text-sm">
                {[
                  { en: 'Active banking & credit economy needed debt arithmetic', hi: 'सक्रिय बैंकिंग और ऋण अर्थव्यवस्था को ऋण अंकगणित की जरूरत थी', sa: 'सक्रिय बैंकिंग और ऋण अर्थव्यवस्था को ऋण अंकगणित की जरूरत थी', mai: 'सक्रिय बैंकिंग और ऋण अर्थव्यवस्था को ऋण अंकगणित की जरूरत थी', mr: 'सक्रिय बैंकिंग और ऋण अर्थव्यवस्था को ऋण अंकगणित की जरूरत थी', ta: 'செயலில் உள்ள வங்கி மற்றும் கடன் பொருளாதாரத்திற்கு கடன் கணிதம் தேவைப்பட்டது', te: 'చురుకైన బ్యాంకింగ్ & రుణ ఆర్థిక వ్యవస్థకు అప్పు గణితం అవసరం', bn: 'সক্রিয় ব্যাংকিং ও ঋণ অর্থনীতিতে ঋণ গণিত প্রয়োজন ছিল', kn: 'ಸಕ್ರಿಯ ಬ್ಯಾಂಕಿಂಗ್ ಮತ್ತು ಸಾಲ ಆರ್ಥಿಕತೆಗೆ ಸಾಲ ಗಣಿತ ಅಗತ್ಯವಿತ್ತು', gu: 'સક્રિય બેંકિંગ અને ધિરાણ અર્થતંત્રને દેવા ગણિતની જરૂર હતી' },
                  { en: 'Rina (debt) legally codified in Arthashastra & Manusmriti', hi: 'ऋण अर्थशास्त्र और मनुस्मृति में कानूनी रूप से संहिताबद्ध', sa: 'ऋण अर्थशास्त्र और मनुस्मृति में कानूनी रूप से संहिताबद्ध', mai: 'ऋण अर्थशास्त्र और मनुस्मृति में कानूनी रूप से संहिताबद्ध', mr: 'ऋण अर्थशास्त्र और मनुस्मृति में कानूनी रूप से संहिताबद्ध', ta: 'ரிண (கடன்) அர்த்தசாஸ்திரம் மற்றும் மனுஸ்மிருதியில் சட்டப்பூர்வமாக வகுக்கப்பட்டது', te: 'ఋణం (అప్పు) అర్థశాస్త్రం & మనుస్మృతిలో చట్టబద్ధంగా క్రోడీకరించబడింది', bn: 'ঋণ (দেনা) অর্থশাস্ত্র ও মনুস্মৃতিতে আইনিভাবে সংকলিত', kn: 'ಋಣ (ಸಾಲ) ಅರ್ಥಶಾಸ್ತ್ರ ಮತ್ತು ಮನುಸ್ಮೃತಿಯಲ್ಲಿ ಕಾನೂನುಬದ್ಧವಾಗಿ ಕ್ರೋಡೀಕರಿಸಲಾಗಿದೆ', gu: 'ઋણ (દેવું) અર્થશાસ્ત્ર અને મનુસ્મૃતિમાં કાયદેસર રીતે સંહિતાબદ્ધ' },
                  { en: 'Astronomical calculations require signed numbers', hi: 'खगोलीय गणनाओं के लिए चिह्नित संख्याओं की आवश्यकता है', sa: 'खगोलीय गणनाओं के लिए चिह्नित संख्याओं की आवश्यकता है', mai: 'खगोलीय गणनाओं के लिए चिह्नित संख्याओं की आवश्यकता है', mr: 'खगोलीय गणनाओं के लिए चिह्नित संख्याओं की आवश्यकता है', ta: 'வானியல் கணக்கீடுகளுக்கு குறியீட்டு எண்கள் தேவை', te: 'ఖగోళ గణనలకు చిహ్న సంఖ్యలు అవసరం', bn: 'জ্যোতির্বৈজ্ঞানিক গণনায় চিহ্নযুক্ত সংখ্যা প্রয়োজন', kn: 'ಖಗೋಳ ಲೆಕ್ಕಾಚಾರಕ್ಕೆ ಚಿಹ್ನೆಯುಕ್ತ ಸಂಖ್ಯೆಗಳು ಅಗತ್ಯ', gu: 'ખગોળીય ગણતરીઓ માટે ચિહ્નિત સંખ્યાઓ જરૂરી' },
                  { en: 'Philosophical tradition comfortable with "void" (shunya)', hi: 'दार्शनिक परंपरा "शून्यता" के साथ सहज', sa: 'दार्शनिक परंपरा "शून्यता" के साथ सहज', mai: 'दार्शनिक परंपरा "शून्यता" के साथ सहज', mr: 'दार्शनिक परंपरा "शून्यता" के साथ सहज', ta: '"சூன்யம்" (வெறுமை) என்ற தத்துவ மரபில் வசதியானது', te: '"శూన్యం" (శూన్యత) తో సౌకర్యంగా ఉన్న తాత్విక సంప్రదాయం', bn: '"শূন্য" (শূন্যতা) ধারণায় স্বাচ্ছন্দ্যপূর্ণ দার্শনিক ঐতিহ্য', kn: '"ಶೂನ್ಯ" (ಬರಿದು) ಪರಿಕಲ್ಪನೆಯಲ್ಲಿ ಅನುಕೂಲಕರ ತಾತ್ವಿಕ ಸಂಪ್ರದಾಯ', gu: '"શૂન્ય" (ખાલીપણ) સાથે આરામદાયક દાર્શનિક પરંપરા' },
                ].map((item, j) => (
            ...
            <div className="rounded-xl bg-red-500/5 border border-red-500/20 p-5">
              ...
              <ul className="space-y-2 text-text-secondary text-sm">
                {[
                  { en: 'Greek geometry dominated — no negative lengths possible', hi: 'यूनानी ज्यामिति का प्रभुत्व — ऋणात्मक लंबाई संभव नहीं', sa: 'यूनानी ज्यामिति का प्रभुत्व — ऋणात्मक लंबाई संभव नहीं', mai: 'यूनानी ज्यामिति का प्रभुत्व — ऋणात्मक लंबाई संभव नहीं', mr: 'यूनानी ज्यामिति का प्रभुत्व — ऋणात्मक लंबाई संभव नहीं', ta: 'கிரேக்க வடிவியல் ஆதிக்கம் செலுத்தியது — எதிர்மறை நீளங்கள் சாத்தியமில்லை', te: 'గ్రీకు జ్యామితి ఆధిపత్యం — ఋణ పొడవులు సాధ్యం కాదు', bn: 'গ্রিক জ্যামিতির আধিপত্য — ঋণাত্মক দৈর্ঘ্য সম্ভব নয়', kn: 'ಗ್ರೀಕ್ ರೇಖಾಗಣಿತ ಪ್ರಾಬಲ್ಯ — ಋಣ ಉದ್ದಗಳು ಸಾಧ್ಯವಿಲ್ಲ', gu: 'ગ્રીક ભૂમિતિનું વર્ચસ્વ — ઋણ લંબાઈ શક્ય ન હતી' },
                  { en: 'Barter economies needed less abstract arithmetic', hi: 'वस्तु-विनिमय अर्थव्यवस्थाओं को कम अमूर्त अंकगणित चाहिए', sa: 'वस्तु-विनिमय अर्थव्यवस्थाओं को कम अमूर्त अंकगणित चाहिए', mai: 'वस्तु-विनिमय अर्थव्यवस्थाओं को कम अमूर्त अंकगणित चाहिए', mr: 'वस्तु-विनिमय अर्थव्यवस्थाओं को कम अमूर्त अंकगणित चाहिए', ta: 'பண்டமாற்று பொருளாதாரங்களுக்கு குறைவான அமூர்த்த கணிதம் தேவை', te: 'వస్తుమార్పిడి ఆర్థిక వ్యవస్థలకు తక్కువ నైరూప్య గణితం అవసరం', bn: 'বিনিময় অর্থনীতিতে কম বিমূর্ত গণিত প্রয়োজন ছিল', kn: 'ವಿನಿಮಯ ಆರ್ಥಿಕತೆಗಳಿಗೆ ಕಡಿಮೆ ಅಮೂರ್ತ ಗಣಿತ ಬೇಕಿತ್ತು', gu: 'વિનિમય અર્થતંત્રને ઓછા અમૂર્ત ગણિતની જરૂર હતી' },
                  { en: 'Philosophical block: "Nothing can be less than nothing"', hi: 'दार्शनिक बाधा: "शून्य से कम कुछ भी नहीं हो सकता"', sa: 'दार्शनिक बाधा: "शून्य से कम कुछ भी नहीं हो सकता"', mai: 'दार्शनिक बाधा: "शून्य से कम कुछ भी नहीं हो सकता"', mr: 'दार्शनिक बाधा: "शून्य से कम कुछ भी नहीं हो सकता"', ta: 'தத்துவ தடை: "எதுவும் ஒன்றுமில்லாததைவிட குறைவாக இருக்க முடியாது"', te: 'తాత్విక అవరోధం: "ఏదీ శూన్యం కంటే తక్కువ కాదు"', bn: 'দার্শনিক বাধা: "কিছুই শূন্যের চেয়ে কম হতে পারে না"', kn: 'ತಾತ್ವಿಕ ತಡೆ: "ಏನೂ ಶೂನ್ಯಕ್ಕಿಂತ ಕಡಿಮೆ ಆಗಲು ಸಾಧ್ಯವಿಲ್ಲ"', gu: 'દાર્શનિક અવરોધ: "કંઈ પણ કંઈ નહીં કરતાં ઓછું હોઈ શકે નહીં"' },
                  { en: 'Church viewed zero and negatives with theological suspicion', hi: 'चर्च ने शून्य और ऋणात्मक को धार्मिक संदेह से देखा', sa: 'चर्च ने शून्य और ऋणात्मक को धार्मिक संदेह से देखा', mai: 'चर्च ने शून्य और ऋणात्मक को धार्मिक संदेह से देखा', mr: 'चर्च ने शून्य और ऋणात्मक को धार्मिक संदेह से देखा', ta: 'திருச்சபை பூஜ்ஜியத்தையும் எதிர்மறை எண்களையும் இறையியல் சந்தேகத்துடன் பார்த்தது', te: 'చర్చి సున్నా మరియు ఋణ సంఖ్యలను వేదాంత అనుమానంతో చూసింది', bn: 'চার্চ শূন্য ও ঋণাত্মক সংখ্যাকে ধর্মতাত্ত্বিক সন্দেহের চোখে দেখত', kn: 'ಚರ್ಚ್ ಶೂನ್ಯ ಮತ್ತು ಋಣ ಸಂಖ್ಯೆಗಳನ್ನು ಧಾರ್ಮಿಕ ಅನುಮಾನದಿಂದ ನೋಡಿತು', gu: 'ચર્ચે શૂન્ય અને ઋણ સંખ્યાઓને ધર્મશાસ્ત્રીય શંકાથી જોયા' },
                ].map((item, j) => (
                  <li key={j} className="flex items-start gap-2">
