    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Why Moonrise Is Harder Than Sunrise / चन्द्रोदय सूर्योदय से कठिन क्यों है
        </h3>
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Topocentric Correction — Why Parallax Matters / स्थलकेन्द्रीय सुधार — लम्बन क्यों महत्त्वपूर्ण है
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          The Moon is the one celestial object close enough to Earth that parallax — the shift in apparent position due to the observer being on the surface rather than at the center of the Earth — makes a significant difference. The Sun&apos;s parallax is only 8.8 arcseconds (negligible). The Moon&apos;s horizontal parallax ranges from 54&apos; to 61&apos; — nearly 1 degree! At the horizon (where altitude is close to 0°), the parallax correction is at its maximum: alt_topo = alt_geo - HP x cos(alt). Since cos(0°) = 1, the full HP value is subtracted from the geometric altitude at the horizon.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          चन्द्रमा एकमात्र ऐसा आकाशीय पिण्ड है जो पृथ्वी से इतना निकट है कि लम्बन — प्रेक्षक के केन्द्र के बजाय सतह पर होने से दृश्य स्थिति में खिसकाव — महत्त्वपूर्ण अन्तर डालता है। सूर्य का लम्बन केवल 8.8 कला-सेकण्ड (नगण्य) है। चन्द्रमा का क्षैतिज लम्बन 54&apos; से 61&apos; तक — लगभग 1 अंश! क्षितिज पर (जहाँ ऊँचाई 0° के निकट), लम्बन सुधार अधिकतम है: alt_topo = alt_geo - HP × cos(alt)। cos(0°) = 1 होने से, पूर्ण HP मान क्षितिज पर ज्यामितीय ऊँचाई से घटाया जाता है।
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          The HP itself is computed from the Moon&apos;s distance: sin(HP) = 6378.14 / distance, where 6378.14 km is Earth&apos;s equatorial radius. The distance comes from the 14 cosine terms of Meeus Table 47.A. At perigee (~356,000 km), HP ≈ 61&apos; (the Moon appears larger — this is when &quot;supermoons&quot; occur). At apogee (~407,000 km), HP ≈ 54&apos;. This 7-arcminute variation in parallax causes moonrise times to shift by several minutes between perigee and apogee, even for the same sky position.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed">
          HP स्वयं चन्द्र दूरी से गणित होता है: sin(HP) = 6378.14 / दूरी, जहाँ 6378.14 किमी पृथ्वी की विषुवतीय त्रिज्या है। दूरी मीयस सारणी 47.A के 14 कोज्या पदों से आती है। उपभू (~356,000 किमी) पर HP ≈ 61&apos; (चन्द्रमा बड़ा दिखता है — यही &quot;सुपरमून&quot; का समय है)। अपभू (~407,000 किमी) पर HP ≈ 54&apos;। लम्बन में यह 7 कला भिन्नता उपभू और अपभू के बीच चन्द्रोदय समय को कई मिनट खिसकाती है, उसी आकाश स्थिति के लिए भी।
        </p>
      </section>

      <section className="glass-card rounded-xl p-5 border border-gold-primary/10">
        <h4 className="text-gold-dark text-[10px] uppercase tracking-widest font-bold mb-2">The Rise Threshold / उदय सीमा</h4>
        <p className="text-text-secondary text-sm leading-relaxed mb-2">
          The moonrise threshold h₀ ≈ -0.3°. This differs from the Sun&apos;s -0.8333° because the Moon&apos;s semi-diameter (~16&apos;) and atmospheric refraction (~34&apos;) partially cancel, and the large parallax correction is handled separately in the topocentric conversion. The exact threshold varies slightly with the Moon&apos;s distance (semi-diameter ranges from 14.7&apos; to 16.7&apos;), but -0.3° is a good average.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed">
          चन्द्रोदय सीमा h₀ ≈ -0.3°। यह सूर्य के -0.8333° से भिन्न है क्योंकि चन्द्र अर्ध-व्यास (~16&apos;) और वायुमण्डलीय अपवर्तन (~34&apos;) आंशिक रूप से एक-दूसरे को सन्तुलित करते हैं, और बड़ा लम्बन सुधार स्थलकेन्द्रीय रूपान्तरण में अलग से संभाला जाता है। सटीक सीमा चन्द्र दूरी के साथ थोड़ी भिन्न होती है (अर्ध-व्यास 14.7&apos; से 16.7&apos; तक), किन्तु -0.3° एक अच्छा औसत है।
        </p>
      </section>
    </div>
  );
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="glass-card rounded-xl p-5 border border-red-500/15">
        ...
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Misconception:</span> &quot;Moonrise parallax is negligible like the Sun&apos;s.&quot; The Sun&apos;s parallax (8.8&quot;) is indeed negligible. The Moon&apos;s parallax (~57&apos;) is 400 times larger and shifts the apparent moonrise time by 3-5 minutes. Ignoring it would make our moonrise consistently late by several minutes.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">भ्रान्ति:</span> &quot;चन्द्रोदय लम्बन सूर्य की तरह नगण्य है।&quot; सूर्य का लम्बन (8.8&quot;) वास्तव में नगण्य है। चन्द्रमा का लम्बन (~57&apos;) 400 गुना बड़ा है और दृश्य चन्द्रोदय समय को 3-5 मिनट खिसकाता है। इसकी अनदेखी करने से हमारा चन्द्रोदय लगातार कई मिनट देर से आता।
        </p>
      </section>
