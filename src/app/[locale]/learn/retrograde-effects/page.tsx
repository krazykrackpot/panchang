...
const RETRO_TABLE: { planet: Record<string, string>; frequency: Record<string, string>; duration: Record<string, string>; view: Record<string, string>; color: string }[] = [
  { planet: { en: 'Mercury', hi: 'बुध', sa: 'बुध', mai: 'बुध', mr: 'बुध', ta: 'புதன்', te: 'బుధుడు', bn: 'বুধ', kn: 'ಬುಧ', gu: 'બુધ' }, frequency: { en: '3-4x per year', hi: 'वर्ष में 3-4 बार', sa: 'वर्ष में 3-4 बार', mai: 'वर्ष में 3-4 बार', mr: 'वर्ष में 3-4 बार', ta: '3-4x per year', te: '3-4x per year', bn: '3-4x per year', kn: '3-4x per year', gu: '3-4x per year' }, duration: { en: '~21 days', hi: '~21 दिन', sa: '~21 दिन', mai: '~21 दिन', mr: '~21 दिन', ta: '~21 days', te: '~21 days', bn: '~21 days', kn: '~21 days', gu: '~21 days' }, view: { en: 'Communication internalized, deep processing', hi: 'संवाद आन्तरिक, गहन प्रसंस्करण', sa: 'संवाद आन्तरिक, गहन प्रसंस्करण', mai: 'संवाद आन्तरिक, गहन प्रसंस्करण', mr: 'संवाद आन्तरिक, गहन प्रसंस्करण', ta: 'Communication internalized, deep processing', te: 'Communication internalized, deep processing', bn: 'Communication internalized, deep processing', kn: 'Communication internalized, deep processing', gu: 'Communication internalized, deep processing' }, color: 'text-emerald-400' },
  ...
  { planet: { en: 'Mars', hi: 'मंगल', sa: 'मंगल', mai: 'मंगल', mr: 'मंगल', ta: 'செவ்வாய்', te: 'కుజుడు', bn: 'মঙ্গল', kn: 'ಕುಜ', gu: 'મંગળ' }, frequency: { en: 'Every 26 months', hi: 'हर 26 माह', sa: 'हर 26 माह', mai: 'हर 26 माह', mr: 'हर 26 माह', ta: 'ஒவ்வொரு 26 மாதமும்', te: 'ప్రతి 26 నెలలకు', bn: 'প্রতি ২৬ মাসে', kn: 'ಪ್ರತಿ 26 ತಿಂಗಳಿಗೆ', gu: 'દર 26 મહિને' }, duration: { en: '~72 days', hi: '~72 दिन', sa: '~72 दिन', mai: '~72 दिन', mr: '~72 दिन', ta: '~72 days', te: '~72 days', bn: '~72 days', kn: '~72 days', gu: '~72 days' }, view: { en: 'Action stalled then redirected, strategy over force', hi: 'कर्म अवरुद्ध फिर पुनर्निर्देशित, बल पर रणनीति', sa: 'कर्म अवरुद्ध फिर पुनर्निर्देशित, बल पर रणनीति', mai: 'कर्म अवरुद्ध फिर पुनर्निर्देशित, बल पर रणनीति', mr: 'कर्म अवरुद्ध फिर पुनर्निर्देशित, बल पर रणनीति', ta: 'Action stalled then redirected, strategy over force', te: 'Action stalled then redirected, strategy over force', bn: 'Action stalled then redirected, strategy over force', kn: 'Action stalled then redirected, strategy over force', gu: 'Action stalled then redirected, strategy over force' }, color: 'text-red-400' },
  { planet: { en: 'Jupiter', hi: 'गुरु', sa: 'गुरु', mai: 'गुरु', mr: 'गुरु', ta: 'குரு', te: 'గురువు', bn: 'বৃহস্পতি', kn: 'ಗುರು', gu: 'ગુરુ' }, frequency: { en: '4 months/year', hi: '4 माह/वर्ष', sa: '4 माह/वर्ष', mai: '4 माह/वर्ष', mr: '4 माह/वर्ष', ta: '4 months/year', te: '4 months/year', bn: '4 months/year', kn: '4 months/year', gu: '4 months/year' }, duration: { en: '~120 days', hi: '~120 दिन', sa: '~120 दिन', mai: '~120 दिन', mr: '~120 दिन', ta: '~120 days', te: '~120 days', bn: '~120 days', kn: '~120 days', gu: '~120 days' }, view: { en: 'Inner wisdom deepening, unconventional guru', hi: 'आन्तरिक ज्ञान गहनता, अपरम्परागत गुरु', sa: 'आन्तरिक ज्ञान गहनता, अपरम्परागत गुरु', mai: 'आन्तरिक ज्ञान गहनता, अपरम्परागत गुरु', mr: 'आन्तरिक ज्ञान गहनता, अपरम्परागत गुरु', ta: 'Inner wisdom deepening, unconventional guru', te: 'Inner wisdom deepening, unconventional guru', bn: 'Inner wisdom deepening, unconventional guru', kn: 'Inner wisdom deepening, unconventional guru', gu: 'Inner wisdom deepening, unconventional guru' }, color: 'text-yellow-400' },
  { planet: { en: 'Saturn', hi: 'शनि', sa: 'शनि', mai: 'शनि', mr: 'शनि', ta: 'சனி', te: 'శని', bn: 'শনি', kn: 'ಶನಿ', gu: 'શનિ' }, frequency: { en: '4.5 months/year', hi: '4.5 माह/वर्ष', sa: '4.5 माह/वर्ष', mai: '4.5 माह/वर्ष', mr: '4.5 माह/वर्ष', ta: '4.5 months/year', te: '4.5 months/year', bn: '4.5 months/year', kn: '4.5 months/year', gu: '4.5 months/year' }, duration: { en: '~138 days', hi: '~138 दिन', sa: '~138 दिन', mai: '~138 दिन', mr: '~138 दिन', ta: '~138 days', te: '~138 days', bn: '~138 days', kn: '~138 days', gu: '~138 days' }, view: { en: 'Karmic review intensified, past debts surface', hi: 'कार्मिक समीक्षा तीव्र, पूर्व ऋण उभरना', sa: 'कार्मिक समीक्षा तीव्र, पूर्व ऋण उभरना', mai: 'कार्मिक समीक्षा तीव्र, पूर्व ऋण उभरना', mr: 'कार्मिक समीक्षा तीव्र, पूर्व ऋण उभरना', ta: 'Karmic review intensified, past debts surface', te: 'Karmic review intensified, past debts surface', bn: 'Karmic review intensified, past debts surface', kn: 'Karmic review intensified, past debts surface', gu: 'Karmic review intensified, past debts surface' }, color: 'text-slate-400' },
...
const TRANSIT_EFFECTS: { planet: Record<string, string>; doList: Record<string, string>; dontList: Record<string, string>; color: string }[] = [
  ...
  { planet: { en: 'Saturn Retrograde Transit', hi: 'शनि वक्री गोचर', sa: 'शनि वक्री गोचर', mai: 'शनि वक्री गोचर', mr: 'शनि वक्री गोचर', ta: 'சனி வக்கிர கோசாரம்', te: 'శని వక్ర గోచారం', bn: 'শনি বক্র গোচর', kn: 'ಶನಿ ವಕ್ರ ಗೋಚಾರ', gu: 'શનિ વક્ર ગોચર' }, doList: { en: 'Revisit old responsibilities, karmic cleansing, restructure foundations, patience and discipline', hi: 'पुरानी जिम्मेदारियां पुनरावलोकन, कार्मिक शुद्धि, नींव पुनर्गठन, धैर्य और अनुशासन', sa: 'पुरानी जिम्मेदारियां पुनरावलोकन, कार्मिक शुद्धि, नींव पुनर्गठन, धैर्य और अनुशासन', mai: 'पुरानी जिम्मेदारियां पुनरावलोकन, कार्मिक शुद्धि, नींव पुनर्गठन, धैर्य और अनुशासन', mr: 'पुरानी जिम्मेदारियां पुनरावलोकन, कार्मिक शुद्धि, नींव पुनर्गठन, धैर्य और अनुशासन', ta: 'Revisit old responsibilities, karmic cleansing, restructure foundations, patience and discipline', te: 'Revisit old responsibilities, karmic cleansing, restructure foundations, patience and discipline', bn: 'Revisit old responsibilities, karmic cleansing, restructure foundations, patience and discipline', kn: 'Revisit old responsibilities, karmic cleansing, restructure foundations, patience and discipline', gu: 'Revisit old responsibilities, karmic cleansing, restructure foundations, patience and discipline' }, dontList: { en: 'Ignore responsibilities, cut corners on quality, avoid hard conversations, neglect health', hi: 'जिम्मेदारी उपेक्षा, गुणवत्ता में कटौती, कठिन बातचीत से बचना, स्वास्थ्य उपेक्षा', sa: 'जिम्मेदारी उपेक्षा, गुणवत्ता में कटौती, कठिन बातचीत से बचना, स्वास्थ्य उपेक्षा', mai: 'जिम्मेदारी उपेक्षा, गुणवत्ता में कटौती, कठिन बातचीत से बचना, स्वास्थ्य उपेक्षा', mr: 'जिम्मेदारी उपेक्षा, गुणवत्ता में कटौती, कठिन बातचीत से बचना, स्वास्थ्य उपेक्षा', ta: 'Ignore responsibilities, cut corners on quality, avoid hard conversations, neglect health', te: 'Ignore responsibilities, cut corners on quality, avoid hard conversations, neglect health', bn: 'Ignore responsibilities, cut corners on quality, avoid hard conversations, neglect health', kn: 'Ignore responsibilities, cut corners on quality, avoid hard conversations, neglect health', gu: 'Ignore responsibilities, cut corners on quality, avoid hard conversations, neglect health' }, color: 'text-slate-400' },
];
