...
const result = scoreAccidents(kundali, strength, signatures, 'en');

describe('scoreAccidents', () => {
  ...
  it('returns correct metadata matching ELEMENT_CATALOG[accidents]', () => {
    const meta = ELEMENT_CATALOG['accidents'];
    expect(result.id).toBe('accidents');
