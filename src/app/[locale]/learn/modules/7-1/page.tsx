...
const QUESTIONS: ModuleQuestion[] = [
  { id: 'q7_1_01', type: 'mcq', question: { en: "Yoga uses?", hi: '' }, options: [{ en: "It only applies to Sun signs", hi: '' }, { en: "It is based on systematic astronomical observation", hi: '' }, { en: "It was invented in the 20th century", hi: '' }, { en: "It has no practical application", hi: '' }], correctAnswer: 1, explanation: { en: "SUM not difference", hi: '' } },
  { id: 'q7_1_02', type: 'true_false', question: { en: "This topic is covered in BPHS (Brihat Parashara Hora Shastra).", hi: '' }, correctAnswer: true, explanation: { en: "Correct. BPHS is the foundational text of Parashari Jyotish and covers virtually every topic in Vedic astrology.", hi: '' } },
  { id: 'q7_1_03', type: 'mcq', question: { en: "The purpose of studying Panchang Yoga is to:", hi: '' }, options: [{ en: "Memorize arbitrary rules", hi: '' }, { en: "Understand how planetary positions create life patterns and enable prediction", hi: '' }, { en: "Replace modern science", hi: '' }, { en: "None of the above", hi: '' }], correctAnswer: 1, explanation: { en: "Jyotish is a systematic framework for understanding how celestial positions correlate with terrestrial events. It combines astronomy (where planets are) with interpretation (what it means).", hi: '' } },
  { id: 'q7_1_04', type: 'true_false', question: { en: "Jyotish results are completely deterministic and cannot be modified.", hi: '' }, correctAnswer: false, explanation: { en: "False. Jyotish describes tendencies and karmic patterns. Remedial measures (gemstones, mantras, charity), conscious effort, and spiritual practice can modify outcomes. The chart is a map, not a prison.", hi: '' } },
  { id: 'q7_1_05', type: 'mcq', question: { en: "Our app implements Panchang Yoga using:", hi: '' }, options: [{ en: "Random number generators", hi: '' }, { en: "Swiss Ephemeris precision with BPHS interpretive framework", hi: '' }, { en: "Only Western astrology rules", hi: '' }, { en: "No computation at all", hi: '' }], correctAnswer: 1, explanation: { en: "We use modern astronomical computation (Meeus algorithms, Swiss Ephemeris precision) combined with classical Jyotish interpretation from BPHS, Phaladeepika, and other foundational texts.", hi: '' } }
];
  ...
  return (
    <div className="space-y-6">
      <section>
        ...
        <p className="text-text-secondary text-sm leading-relaxed mb-3">This module covers Panchang Yoga — a core concept in Yoga Karana within Vedic Jyotish. Understanding this topic is essential for reading birth charts, making predictions, and applying the wisdom of classical texts like BPHS and Phaladeepika.</p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">27 yogas from Sun+Moon sum. This concept has been practiced for over 2000 years and remains the foundation of modern Jyotish practice. Every chart reading, dasha interpretation, and transit analysis relies on this knowledge.</p>
        <p className="text-text-secondary text-sm leading-relaxed">As we explore Panchang Yoga, pay attention to the underlying mathematical structure — Jyotish is built on precise astronomical observations encoded into systematic frameworks. The beauty of this system is that the same rules apply whether you are reading a chart from 500 BCE or 2026 CE.</p>
      </section>
  ...
  return (
    <div className="space-y-6">
      <section>
        ...
        <p className="text-text-secondary text-sm leading-relaxed mb-3">The detailed mechanics of Panchang Yoga involve understanding how planetary positions, sign placements, and house occupancies interact to produce specific life outcomes. This is not arbitrary — it follows systematic rules that have been refined over millennia of observation and codification.</p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">In practice, applying Panchang Yoga requires both theoretical knowledge (which you are building here) and chart-reading experience. The questions below will test your understanding of the key principles. As you progress through more modules, you will see how this topic connects to dashas, transits, and predictive techniques.</p>
      </section>
      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">Worked Examples</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2"><span className="text-gold-light font-medium">Example 1:</span> Consider a chart where the key planet for Panchang Yoga is well-placed in a kendra (angular house) in its own sign. This would indicate strong positive results in the life area governed by this topic — the native experiences natural support and favorable outcomes.</p>
      ...
      <section className="glass-card rounded-xl p-5 border border-red-500/15">
        ...
        <p className="text-text-secondary text-xs leading-relaxed">A common misconception about Panchang Yoga is that results are deterministic and unchangeable. In reality, Jyotish describes tendencies and karmic patterns that can be modified through conscious effort, remedial measures (gemstones, mantras, charity), and spiritual practice. The chart shows the map — you choose the path.</p>
      </section>
