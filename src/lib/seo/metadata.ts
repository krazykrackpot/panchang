...
export const PAGE_META: Record<string, PageMeta> = {
  ...
  '/panchang': {
    title: {
      ...
      ta: 'இன்றைய பஞ்சாங்கம் | Today\'s Panchang — Tithi, Nakshatra',
    ...
    description: {
      ...
      mai: 'अपन शहरक लेल आजुक पञ्चाङ्ग  –  तिथि, नक्षत्र, योग, करण, राहु काल, शुभ मुहूर्त, सूर्योदय आ सूर्यास्त. निःशुल्क, सही आ रोज अद्यतन.',
        mr: 'आज का पंचांग अपने शहर के लिए देखें  –  तिथि, नक्षत्र, योग, करण, राहु काल, शुभ मुहूर्त। निःशुल्क, सटीक, प्रतिदिन अपडेट।'
    },
  ...
  '/kundali': {
    ...
    description: {
      ...
      mai: 'किछ सेकेण्डमे अहांक निःशुल्क कुण्डली बनाउ. नवसिखुआक लेल सरल मोड आ साधकक लेल 19 चार्ट, 15 दशा प्रणाली, 210+ योग, षड्बल, अष्टकवर्ग आ AI विश्लेषण. स्विस इफेमेरिस सटीकता.',
        mr: 'सेकण्डों में अपनी निःशुल्क कुण्डली बनाएँ। शुरुआती के लिए सरल मोड \u2014 विज़ुअल पहचान कार्ड, जीवन क्षेत्र अंक, सरल भाषा में अन्तर्दृष्टि। विशेषज्ञों के लिए एक्सपर्ट मोड \u2014 19 चार्ट, 15 दशा प्रणालियाँ, 210+ योग, षड्बल, अष्टकवर्ग और AI पठन। स्विस एफ़ेमेरिस सटीकता। कोई साइनअप नहीं।'
    },
  ...
  '/matching': {
    title: {
      ...
      mai: 'कुण्डली मिलान | Kundali Matching — 36-Point Ashta Kuta',
    ...
    description: {
      ...
      mai: 'विवाहक लेल 36-अंक अष्ट कूट कुण्डली मिलान. वर्ण, वश्य, तारा, योनि, ग्रह मैत्री, गण, भाशी, नाड़ी — सब आठ कूट. मङ्गल दोष आ नाड़ी दोषक जाँचक संग विस्तृत संयोग रिपोर्ट.',
        mr: '36 अंकों वाली अष्ट कूट गुण मिलान प्रणाली से निःशुल्क कुण्डली मिलान। नाड़ी दोष विश्लेषण सहित।'
    },
  ...
  '/calendar': {
    ...
    description: {
      ...
      mai: '2026क सब 180+ हिन्दू पाबनि आ व्रतक तारीख — एकादशी, पूर्णिमा, अमावस्या, चतुर्थी. अपन शहरक लेल सही समयक संग स्थान-जागरूक.',
        mr: '180+ त्योहार, व्रत, एकादशी, पूर्णिमा, अमावस्या तिथियों के साथ पूर्ण हिन्दू त्योहार कैलेंडर।'
    },
  ...
  '/hindu-calendar/2026': {
    ...
    description: {
      ...
      mai: '2026क लेल पूर्ण हिन्दू कैलेण्डर — विक्रम सम्वत् 2083. अमान्त + पूर्णिमान्त मास, अधिक मास, सब व्रत आ पाबनि, सङ्क्रान्ति तिथि आ प्रत्येक दिनक लेल व्यक्तिगत पञ्चाङ्ग.',
        mr: '2026 का सम्पूर्ण हिन्दू कैलेंडर  –  180+ त्योहार, 24 एकादशी व्रत तिथियाँ, ग्रहण, पूर्णिमा एवं अमावस्या। प्रत्येक प्रमुख हिन्दू त्योहार की सटीक तिथियाँ।'
    },
  ...
  '/sign-calculator': {
    ...
    description: {
      ...
      mai: 'अहांक सूर्य राशि पश्चिमी (ट्रॉपिकल) आ वैदिक (साइडेरियल, लाहिड़ी अयनांश) मे भिन्न अछि? निःशुल्क जाँचू. अपन जन्म तिथि लिखू — दूनू राशि अलग होय त किएक ताहिक व्याख्याक संग.',
        mr: 'अपनी वैदिक सूर्य राशि, चन्द्र राशि और जन्म नक्षत्र तुरंत जानें। निःशुल्क और सटीक।'
    },
  ...
  '/sade-sati': {
    ...
    description: {
      ...
      mai: 'अपन साढ़ेसाती चरण जाँचू — जखन शनि अहांक चन्द्र राशिसँ पहिने, ऊपर, अथवा बाद चलैत अछि. तीव्रता क्रम, आन कठिन शनि अवधि (कण्टक शनि, अष्टम शनि), आ व्यक्तिगत उपाय.',
        mr: 'जानें कि क्या आपकी चन्द्र राशि पर साढ़े साती सक्रिय है। चरण विश्लेषण, तिथियां और उपाय।'
    },
  ...
  '/muhurta-ai': {
    ...
    description: {
      ...
      mai: 'AI-संचालित मुहूर्त चयन — 20 गतिविधिक लेल शुभ समय. विवाह, गृह प्रवेश, मुण्डन, गाड़ी खरीद, यात्रा, शिक्षा शुरू, सोनाक खरीद, आध्यात्मिक अनुष्ठान. विष्टि करण, पञ्चक, राहु काल त्यागक संग बहु-कारक स्कोरिंग.',
        mr: 'विवाह, गृह प्रवेश, व्यापार और 18 अन्य कार्यों के लिए सबसे शुभ तिथि और समय। 36-नियम वैदिक स्कोरिंग, 15 मिनट की सटीकता। मुफ़्त।'
    },
  ...
  '/vrat-calendar': {
    ...
    description: {
      ...
      mai: '2026क लेल पूर्ण व्रत कैलेण्डर. एकादशी (24), पूर्णिमा, प्रदोष, चतुर्थी (सङ्कष्टी + विनायक), सोमवार, मङ्गलवार, शनिवार व्रत. अपन शहरक लेल पारण समय आ व्यक्तिगत पूजा विधि.',
        mr: 'एकादशी, प्रदोष, पूर्णिमा, संकष्टी चतुर्थी आदि व्रतों का अनुसरण करें। प्रत्येक व्रत से पहले स्मरण प्राप्त करें।'
    },
  ...
  '/charts': {
    ...
    description: {
      ...
      mai: 'अहांक सहेजल सब कुण्डली चार्ट एके ठाम. परिवार, मित्र अथवा ग्राहकक जन्म पत्रिका सहजे ताकू, सम्पादित करू, अदलू-बदलू.',
        mr: 'सभी वैदिक ज्योतिष कुण्डली उपकरण  –  कुण्डली, वर्षफल, केपी, प्रश्न, मिलान आदि।'
    },
  ...
  '/eclipses': {
    title: {
      ...
      kn: 'ಇಂದಿನ ರಾಶಿಫಲ — 12 ರಾಶಿಗಳ ವೈದಿಕ ಜ್ಯೋತಿಷ ಭವಿಷ್ಯ',
      mai: 'आजुक राशिफल — 12 राशिक वैदिक ज्योतिष भविष्यवाणी',
        mr: 'सूर्य और चन्द्र ग्रहण कैलेंडर 2026'
    },
    description: {
  ...
  '/panchang/rashi/mesh': {
    title: { en: "Aries (Mesh)  –  Personality, Career, Love & Today's Horoscope", hi: 'मेष राशि  –  व्यक्तित्व, करियर, प्रेम और आज का राशिफल' },
  ...
  '/panchang/rashi/mithun': {
    title: { en: "Gemini (Mithun)  –  Personality, Career, Love & Today's Horoscope", hi: 'मिथुन राशि  –  व्यक्तित्व, करियर, प्रेम और आज का राशिफल' },
  ...
  '/panchang/rashi/kark': {
    title: { en: "Cancer (Kark)  –  Personality, Career, Love & Today's Horoscope", hi: 'कर्क राशि  –  व्यक्तित्व, करियर, प्रेम और आज का राशिफल' },
  ...
  '/panchang/rashi/simha': {
    title: { en: "Leo (Simha)  –  Personality, Career, Love & Today's Horoscope", hi: 'सिंह राशि  –  व्यक्तित्व, करियर, प्रेम और आज का राशिफल' },
  ...
  '/panchang/rashi/kanya': {
    title: { en: "Virgo (Kanya)  –  Personality, Career, Love & Today's Horoscope", hi: 'कन्या राशि  –  व्यक्तित्व, करियर, प्रेम और आज का राशिफल' },
  ...
  '/panchang/rashi/tula': {
    title: { en: "Libra (Tula)  –  Personality, Career, Love & Today's Horoscope", hi: 'तुला राशि  –  व्यक्तित्व, करियर, प्रेम और आज का राशिफल' },
  ...
  '/panchang/rashi/meen': {
    title: { en: "Pisces (Meen)  –  Personality, Career, Love & Today's Horoscope", hi: 'मीन राशि  –  व्यक्तित्व, करियर, प्रेम और आज का राशिफल' },
  ...
  '/learn/sphutas': {
    title: { en: 'Sphutas  –  Sensitive Points (Yogi, Prana, Mrityu)', hi: 'स्फुट  –  संवेदनशील बिन्दु' },
    description: { en: 'Yogi & Avayogi Points, Prana Sphuta, Deha Sphuta, Mrityu Sphuta, fertility sphutas. Cosmic GPS coordinates in your chart.', hi: 'योगी, अवयोगी बिन्दु, प्राण, देह, मृत्यु स्फुट। कुण्डली के संवेदनशील बिन्दु।' },
    keywords: ['sphutas', 'yogi point', 'avayogi', 'prana sphuta', 'sensitive points'],
  },
  '/learn/argala': {
    title: { en: 'Argala  –  Planetary Intervention System (Jaimini)', hi: 'अर्गला  –  ग्रह हस्तक्षेप पद्धति' },
    description: { en: 'Argala (bolt) and Virodha Argala: how planets intervene in house affairs. Dhana, Sukha, Labha, Putra Argala explained.', hi: 'अर्गला और विरोध अर्गला: ग्रह भाव मामलों में कैसे हस्तक्षेप करते हैं।' },
    keywords: ['argala', 'virodha argala', 'jaimini', 'planetary intervention'],
  },
  '/learn/jaimini': {
    title: { en: 'Jaimini Astrology  –  Sign-Based System', hi: 'जैमिनी ज्योतिष  –  राशि आधारित' },
    description: { en: 'Jaimini system: Chara Karakas, Atmakaraka, Rashi Drishti, Arudha Padas, Karakamsha, and Chara Dasha.', hi: 'जैमिनी: चर कारक, आत्मकारक, राशि दृष्टि, आरूढ़ पद, कारकांश और चर दशा।' },
    keywords: ['jaimini astrology', 'chara karaka', 'atmakaraka', 'rashi drishti', 'arudha pada'],
  },
  '/learn/sade-sati': {
    title: { en: 'Sade Sati  –  Saturn\'s 7.5-Year Transit', hi: 'साढ़े साती  –  शनि का 7.5 वर्ष गोचर' },
    description: { en: 'Complete Sade Sati guide: 3 phases, severity factors, life cycle patterns, remedies, and myths debunked.', hi: 'साढ़े साती: 3 चरण, तीव्रता कारक, जीवन चक्र, उपाय और मिथक।' },
  ...
  '/learn/grahas': {
    title: { en: 'The Nine Grahas (Planets) in Vedic Astrology', hi: 'वैदिक ज्योतिष में नव ग्रह' },
    description: { en: 'Complete guide to the nine Grahas: Sun, Moon, Mars, Mercury, Jupiter, Venus, Saturn, Rahu, Ketu  –  their significations, natures, and roles in Jyotish.', hi: 'नौ ग्रहों का सम्पूर्ण मार्गदर्शन  –  सूर्य, चन्द्र, मंगल, बुध, बृहस्पति, शुक्र, शनि, राहु, केतु।' },
    keywords: ['grahas vedic astrology', 'nine planets jyotish', 'navagraha', 'planets in astrology'],
  },
  '/learn/rashis': {
    title: { en: 'The 12 Rashis (Zodiac Signs) in Vedic Astrology', hi: 'वैदिक ज्योतिष में 12 राशियाँ' },
    description: { en: 'Learn the 12 Rashis from Mesha to Meena  –  their elements, qualities, ruling planets, and meanings in Jyotish birth chart interpretation.', hi: 'मेष से मीन तक 12 राशियाँ  –  तत्त्व, गुण, स्वामी ग्रह और जन्म कुण्डली में अर्थ।' },
    keywords: ['12 rashis', 'zodiac signs vedic', 'mesha aries', 'vedic zodiac'],
  },
  '/learn/nakshatras': {
    title: { en: 'The 27 Nakshatras  –  Lunar Mansions in Jyotish', hi: '27 नक्षत्र  –  ज्योतिष में चन्द्र मंडल' },
    description: { en: 'Complete reference for all 27 Nakshatras  –  their deities, ruling planets, qualities, syllables, and roles in birth chart analysis and muhurta.', hi: '27 नक्षत्रों का सम्पूर्ण संदर्भ  –  देवता, स्वामी ग्रह, गुण, अक्षर और कुण्डली विश्लेषण में भूमिका।' },
    keywords: ['27 nakshatras', 'lunar mansions', 'nakshatra astrology', 'birth star'],
  },
  '/learn/tithis': {
    title: { en: 'Tithis  –  The 30 Lunar Days in Hindu Calendar', hi: 'तिथियाँ  –  हिन्दू पंचांग में 30 चन्द्र दिवस' },
    description: { en: 'Learn the 30 Tithis of the Hindu lunar month  –  from Pratipada to Amavasya. Their meanings, ruling deities, auspicious and inauspicious nature.', hi: 'प्रतिपदा से अमावस्या तक 30 तिथियाँ  –  अर्थ, अधिदेवता, शुभ और अशुभ स्वभाव।' },
    keywords: ['tithi', 'lunar day', 'panchang tithi', 'pratipada purnima amavasya'],
  },
  '/learn/yoga': {
    title: { en: 'Yogas in Vedic Astrology  –  Raj, Dhana, Dosha Yogas', hi: 'वैदिक ज्योतिष में योग  –  राज, धन, दोष योग' },
    description: { en: 'Master the major yogas of Jyotish  –  Pancha Mahapurusha, Raj Yoga, Dhana Yoga, Neecha Bhanga, and dosha yogas. How they form and what they mean in your chart.', hi: 'पञ्च महापुरुष, राज योग, धन योग, नीच भंग और दोष योगों की सम्पूर्ण जानकारी।' },
    keywords: ['yogas in astrology', 'raj yoga', 'dhana yoga', 'pancha mahapurusha'],
  },
  '/learn/karanas': {
    title: { en: 'Karanas  –  The 11 Half-Day Units in Panchang', hi: 'करण  –  पंचांग में 11 अर्द्ध-दिवस इकाइयाँ' },
    description: { en: 'Learn the 11 Karanas (half-Tithis) used in Panchang: Bava, Balava, Kaulava, Taitila, Garaja, Vanija, Vishti (Bhadra), Sakuni, Chatushpada, Naga, Kimstughna.', hi: '11 करण  –  बव, बालव, कौलव, तैतिल, गर, वणिज, विष्टि, शकुनि, चतुष्पद, नाग, किंस्तुघ्न।' },
    keywords: ['karana panchang', 'half tithi', 'bhadra karana', 'vishti karana'],
  },
  '/learn/muhurtas': {
    title: { en: 'Muhurta  –  Auspicious Timing in Vedic Astrology', hi: 'मुहूर्त  –  वैदिक ज्योतिष में शुभ समय' },
    description: { en: 'Learn how to choose auspicious Muhurtas for marriage, travel, business, and ceremonies. Tithi, Nakshatra, Vara, and Yoga combinations explained.', hi: 'विवाह, यात्रा, व्यापार और उत्सवों के लिए शुभ मुहूर्त कैसे चुनें।' },
  ...
  '/learn/eclipses': {
    ...
    description: { en: 'Complete guide to solar and lunar eclipses in Jyotish  –  the Rahu-Ketu mythology, how eclipses are calculated, eclipse types, Sutak rules, and eclipse effects in your Kundali.', hi: 'ज्योतिष में सूर्य और चन्द्र ग्रहणों की सम्पूर्ण मार्गदर्शिका  –  राहु-केतु पौराणिक कथा, गणना, प्रकार, सूतक नियम और कुण्डली में प्रभाव।' },
    keywords: ['grahan vedic astrology', 'solar eclipse jyotish', 'lunar eclipse sutak', 'rahu ketu eclipse', 'eclipse kundali'],
  },
  '/learn/kundali': {
    title: { en: 'Reading a Kundali  –  Vedic Birth Chart Interpretation', hi: 'कुण्डली पढ़ना  –  वैदिक जन्म कुण्डली व्याख्या' },
    description: { en: 'Step-by-step guide to reading a Vedic birth chart (Kundali): houses, planets, signs, aspects, dashas, and yogas. From beginner to advanced interpretation.', hi: 'वैदिक जन्म कुण्डली पढ़ने की चरणबद्ध मार्गदर्शिका  –  भाव, ग्रह, राशि, दशा और योग।' },
    keywords: ['how to read kundali', 'birth chart interpretation', 'jyotish chart', 'kundali reading'],
  },
  '/learn/lagna': {
    title: { en: 'Lagna (Ascendant)  –  The Most Important Point in Kundali', hi: 'लग्न  –  कुण्डली का सबसे महत्त्वपूर्ण बिन्दु' },
    description: { en: 'Understand the Lagna (rising sign / ascendant) in Vedic astrology  –  how it is calculated, its role as chart ruler, and its meaning for personality and life path.', hi: 'वैदिक ज्योतिष में लग्न  –  गणना, कुण्डली में भूमिका और व्यक्तित्व पर प्रभाव।' },
    keywords: ['lagna astrology', 'ascendant vedic', 'rising sign jyotish', 'udaya lagna'],
  },
  '/learn/matching': {
    title: { en: 'Kundali Matching  –  How Guna Milan Works', hi: 'कुण्डली मिलान  –  गुण मिलान कैसे काम करता है' },
    description: { en: 'Learn the 8-factor Ashta Kuta Guna Milan system for marriage compatibility  –  Varna, Vashya, Tara, Yoni, Graha Maitri, Gana, Bhakoot, Nadi, and Nadi Dosha.', hi: 'विवाह अनुकूलता के लिए अष्ट कूट गुण मिलान  –  वर्ण, वश्य, तारा, योनि, ग्रह मैत्री, गण, भकूट, नाड़ी।' },
  ...
  '/learn/vara': {
    title: { en: 'Vara  –  The 7 Weekdays in Vedic Astrology', hi: 'वार  –  वैदिक ज्योतिष में 7 दिन' },
    description: { en: 'Learn the 7 Varas (weekdays) in Jyotish  –  their ruling planets, auspicious activities, and role in Panchang and Muhurta.', hi: '7 वार  –  रवि से शनि तक  –  स्वामी ग्रह, शुभ कार्य और मुहूर्त में भूमिका।' },
    keywords: ['vara weekday astrology', 'panchang vara', 'day of week jyotish'],
  },
  '/learn/vargas': {
    title: { en: 'Varga Charts  –  Divisional Charts in Vedic Astrology', hi: 'वर्ग कुण्डलियाँ  –  वैदिक ज्योतिष में विभागीय चार्ट' },
    description: { en: 'Master the 16 Varga charts  –  Rasi, Hora, Drekkana, Navamsha, Dashamsha, and more. How divisional charts reveal deeper life themes.', hi: '16 वर्ग कुण्डलियाँ  –  राशि, होरा, द्रेक्काण, नवमांश, दशमांश आदि।' },
    keywords: ['varga charts', 'divisional charts', 'navamsha', 'shodashamsha astrology'],
  },
  '/learn/dashas': {
    title: { en: 'Dashas  –  Planetary Period Systems in Vedic Astrology', hi: 'दशा  –  वैदिक ज्योतिष में ग्रहकाल प्रणाली' },
    description: { en: 'Complete guide to Vimshottari Dasha  –  maha dasha, antar dasha, pratyantar dasha, and how planetary periods shape life events.', hi: 'विंशोत्तरी दशा  –  महादशा, अन्तर्दशा, प्रत्यन्तर दशा और जीवन घटनाओं पर प्रभाव।' },
    keywords: ['dasha system', 'vimshottari dasha', 'mahadasha', 'planetary periods vedic'],
  },
  '/learn/doshas': {
    title: { en: 'Doshas in Vedic Astrology  –  Manglik, Kaal Sarp, Sade Sati', hi: 'वैदिक ज्योतिष में दोष  –  मांगलिक, काल सर्प, साढ़े साती' },
    description: { en: 'Understand the major Doshas in Jyotish  –  Manglik Dosha, Kaal Sarp Dosha, Sade Sati, Ganda Mula, and Pitra Dosha. Their formation, effects, and remedies.', hi: 'ज्योतिष के प्रमुख दोष  –  मांगलिक, काल सर्प, साढ़े साती, गण्ड मूल, पितृ दोष  –  निर्माण, प्रभाव और उपाय।' },
    keywords: ['manglik dosha', 'kaal sarp dosha', 'astrological doshas', 'pitra dosha'],
  },
  '/learn/grahan-yoga': {
    title: { en: 'Grahan Yoga  –  Eclipse Yoga in the Birth Chart', hi: 'ग्रहण योग  –  जन्म कुण्डली में ग्रहण' },
    description: { en: 'Complete guide to Grahan Yoga: Sun/Moon conjunct Rahu/Ketu. Four types, house-wise effects, cancellation rules, classical references, severity assessment, and remedies.', hi: 'ग्रहण योग: सूर्य/चन्द्र की राहु/केतु से युति। चार प्रकार, भाव अनुसार प्रभाव, भंग नियम, शास्त्रीय सन्दर्भ और उपाय।' },
  ...
  '/learn/doshas-detailed': {
    ...
    description: { en: 'In-depth guide to all major Jyotish doshas: detection methods, severity levels, cancellation conditions, effects, remedies, and classical references with worked examples.', hi: 'ज्योतिष के सभी प्रमुख दोषों का गहन अध्ययन  –  पहचान विधि, गंभीरता स्तर, रद्दीकरण शर्तें, प्रभाव और उपचार।' },
  ...
  '/learn/gochar': {
    title: { en: 'Gochar  –  Planetary Transits in Vedic Astrology', hi: 'गोचर  –  वैदिक ज्योतिष में ग्रह गोचर' },
    description: { en: 'Learn how planetary transits (Gochar) interact with your natal chart  –  Jupiter, Saturn, Rahu-Ketu transits and their effects on life areas.', hi: 'ग्रह गोचर  –  बृहस्पति, शनि, राहु-केतु का जन्म कुण्डली पर प्रभाव।' },
    keywords: ['gochar transit', 'planetary transits vedic', 'jupiter transit', 'saturn transit'],
  },
  '/learn/advanced': {
    title: { en: 'Advanced Vedic Astrology  –  Deeper Jyotish Techniques', hi: 'उन्नत वैदिक ज्योतिष  –  गहन ज्योतिष तकनीकें' },
    description: { en: 'Advanced Jyotish topics  –  Jaimini Sutras, Ashtakavarga, Shadbala, Bhavabala, Argala, Varga charts, special lagnas, and predictive techniques.', hi: 'उन्नत ज्योतिष  –  जैमिनी सूत्र, अष्टकवर्ग, षड्बल, भावबल, अर्गल, वर्ग कुण्डली।' },
    keywords: ['advanced vedic astrology', 'jaimini astrology', 'advanced jyotish', 'predictive astrology'],
  },
  '/learn/ayanamsha': {
    title: { en: 'Ayanamsha  –  The Vedic Sidereal Correction Explained', hi: 'अयनांश  –  वैदिक नाक्षत्र संशोधन की व्याख्या' },
    description: { en: 'Understand Ayanamsha  –  the difference between tropical and sidereal zodiacs. Lahiri, Raman, Krishnamurti ayanamshas compared.', hi: 'अयनांश  –  उष्णकटिबंधीय और नाक्षत्र राशिचक्र का अंतर। लाहिड़ी, रमण, कृष्णमूर्ति अयनांश।' },
    keywords: ['ayanamsha', 'lahiri ayanamsha', 'sidereal zodiac', 'tropical vs sidereal'],
  },
  '/learn/bhavas': {
    title: { en: 'The 12 Bhavas (Houses) in Vedic Astrology', hi: 'वैदिक ज्योतिष में 12 भाव' },
    description: { en: 'Complete guide to the 12 Bhavas (houses) in Jyotish  –  their significations, natural rulers, Kendra/Trikona/Dusthana classification, and interpretation.', hi: 'ज्योतिष के 12 भाव  –  अर्थ, प्राकृतिक स्वामी, केन्द्र/त्रिकोण/दुःस्थान वर्गीकरण।' },
