...
const result = scoreChronic(kundali, strength, signatures, 'en');

describe('scoreChronic', () => {
  ...
  it('returns correct metadata matching ELEMENT_CATALOG[chronic]', () => {
    const meta = ELEMENT_CATALOG['chronic'];
    expect(result.id).toBe('chronic');
