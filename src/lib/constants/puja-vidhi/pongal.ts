...
export const PONGAL_PUJA: PujaVidhi = {
  ...
  samagri: [
    { name: { en: 'New earthen pot (Pongal Paanai)', hi: 'नया मिट्टी का बर्तन (पोंगल पानै)', sa: 'नवं मृत्तिकापात्रम् (पोङ्गलपानै)' }, category: 'vessels', essential: true },
    { name: { en: 'Raw rice', hi: 'कच्चे चावल', sa: 'आमतण्डुलाः' }, category: 'food', essential: true },
    { name: { en: 'Fresh cow milk', hi: 'ताजा गाय का दूध', sa: 'नवं गोक्षीरम्' }, category: 'food', essential: true },
    { name: { en: 'Jaggery (vellam)', hi: 'गुड़ (वेल्लम्)', sa: 'गुडम् (वेल्लम्)' }, category: 'food', essential: true },
    { name: { en: 'Sugarcane stalks', hi: 'गन्ने के डंठल', sa: 'इक्षुदण्डाः' }, quantity: '4-5', category: 'food', essential: true },
    { name: { en: 'Turmeric plant with root (manjal)', hi: 'जड़ सहित हल्दी का पौधा (मंजल)', sa: 'समूलं हरिद्रासस्यम् (मञ्जल्)' }, category: 'puja_items', essential: true },
    { name: { en: 'Fresh turmeric leaves', hi: 'ताजी हल्दी की पत्तियाँ', sa: 'आर्द्रहरिद्रापत्राणि' }, category: 'puja_items', essential: false },
    { name: { en: 'Kolam powder (rice flour)', hi: 'कोलम पाउडर (चावल का आटा)', sa: 'कोलमचूर्णम् (तण्डुलचूर्णम्)' }, category: 'puja_items', essential: true },
    { name: { en: 'Banana leaves', hi: 'केले के पत्ते', sa: 'कदलीपत्राणि' }, category: 'other', essential: true },
    { name: { en: 'Cashews and raisins', hi: 'काजू और किशमिश', sa: 'काजूद्राक्षाशुष्कफलानि' }, category: 'food', essential: false },
    { name: { en: 'Cardamom', hi: 'इलायची', sa: 'एला' }, category: 'food', essential: false },
    { name: { en: 'Ghee', hi: 'घी', sa: 'घृतम्' }, category: 'food', essential: true },
    { name: { en: 'Moong dal', hi: 'मूँग दाल', sa: 'मुद्गदालम्' }, category: 'food', essential: false },
    ...
    { name: { en: 'Flowers (marigold, jasmine)', hi: 'फूल (गेंदा, चमेली)', sa: 'पुष्पाणि (स्थलपद्मं मल्लिका च)' }, category: 'flowers', essential: true },
    { name: { en: 'Coconut', hi: 'नारियल', sa: 'नारिकेलम्' }, category: 'food', essential: true },
    { name: { en: 'Bananas', hi: 'केले', sa: 'कदलीफलानि' }, category: 'food', essential: true },
  ],
  ...
  vidhiSteps: [
    {
      step: 1,
      title: { en: 'Bhogi Pongal — Day 1: Cleansing & Bonfire', hi: 'भोगी पोंगल — दिन 1: शुद्धि एवं अलाव', sa: 'भोगीपोङ्गलम् — प्रथमदिनम्: शुद्धिः अग्निहोत्रं च' },
      description: {
    ...
    {
      step: 2,
      title: { en: 'Thai Pongal — Day 2: Cooking the Sacred Pongal', hi: 'थाई पोंगल — दिन 2: पवित्र पोंगल पकाना', sa: 'थाईपोङ्गलम् — द्वितीयदिनम्: पवित्रपोङ्गलपाकः' },
      description: {
    ...
    {
      step: 3,
      title: { en: 'Surya Puja — Offering Pongal to the Sun', hi: 'सूर्य पूजा — सूर्य को पोंगल अर्पण', sa: 'सूर्यपूजा — सूर्याय पोङ्गलसमर्पणम्' },
      description: {
    ...
    {
      step: 4,
      title: { en: 'Mattu Pongal — Day 3: Honoring Cattle', hi: 'मट्टू पोंगल — दिन 3: पशुधन का सम्मान', sa: 'मट्टुपोङ्गलम् — तृतीयदिनम्: पशूनां सम्मानम्' },
      description: {
    ...
    {
      step: 5,
      title: { en: 'Kaanum Pongal — Day 4: Family Reunion', hi: 'कानुम पोंगल — दिन 4: पारिवारिक मिलन', sa: 'कानुमपोङ्गलम् — चतुर्थदिनम्: कुटुम्बमिलनम्' },
      description: {
    ...
    {
      step: 6,
      title: { en: 'Aarti & Prasad Distribution', hi: 'आरती एवं प्रसाद वितरण', sa: 'आरात्रिकं प्रसादवितरणं च' },
      description: {
