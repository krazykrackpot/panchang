...
function SectionAccordion({
  ...
  return (
    <motion.div {...fadeInUp} className="bg-gradient-to-br from-\[#2d1b69\]/40 via-\[#1a1040\]/50 to-\[#0a0e27\] border border-gold-primary/12 rounded-xl border border-gold-primary/10 overflow-hidden">
      <button
    ...
    return (
      <main className="min-h-screen pt-28 pb-16 px-4">
        <div className="max-w-2xl mx-auto text-center">
          <motion.div {...fadeInUp} className="bg-gradient-to-br from-\[#2d1b69\]/40 via-\[#1a1040\]/50 to-\[#0a0e27\] border border-gold-primary/12 rounded-xl border border-gold-primary/10 p-10">
            <h1
