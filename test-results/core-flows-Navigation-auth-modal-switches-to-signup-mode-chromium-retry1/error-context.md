...
- Name: core-flows.spec.ts >> Navigation >> auth modal switches to signup mode
- Location: e2e/core-flows.spec.ts:137:7
...
Error: strict mode violation: locator('text=Create Account') resolved to 2 elements:
    1) <h2 class="text-2xl font-bold text-gold-gradient mb-6">Create Account</h2> aka getByRole('heading', { name: 'Create Account' })
    2) <button type="submit" class="w-full py-3 bg-gradient-to-r from-gold-dark to-gold-primary text-bg-primary font-semibold rounded-xl hover:from-gold-primary hover:to-gold-light transition-all duration-300 disabled:opacity-50">Create Account</button> aka getByRole('button', { name: 'Create Account' })
...
- generic [active] [ref=e1]:
  ...
  - alert [ref=e194]
  - generic [ref=e197]:
    - button "Close" [ref=e198]:
      - img [ref=e199]
    - heading "Create Account" [level=2] [ref=e202]
    - button "Continue with Google" [ref=e203]:
      - img [ref=e204]
      - text: Continue with Google
    - generic [ref=e211]: or
    - generic [ref=e213]:
      - textbox "Name" [ref=e214]
      - textbox "Email" [ref=e215]
      - textbox "Password" [ref=e216]
      - textbox "Confirm Password" [ref=e217]
      - button "Create Account" [ref=e218]
    - paragraph [ref=e220]:
      - text: Already have an account?
      - button "Sign in" [ref=e221]
```
