    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Ratna Shastra — The Science of Gemstones / रत्न शास्त्र — रत्नों का विज्ञान
        </h3>
      ...
      <section className="glass-card rounded-xl p-5 border border-gold-primary/10">
        <h4 className="text-gold-dark text-[10px] uppercase tracking-widest font-bold mb-2">The Nine Gems at a Glance / नौ रत्न एक दृष्टि में</h4>
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          When to Wear and When NOT to Wear / कब पहनें और कब न पहनें
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">Planet-Gem-Metal-Finger Reference / ग्रह-रत्न-धातु-उँगली सन्दर्भ</h4>
      ...
      <section className="glass-card rounded-xl p-5 border border-red-500/15">
        <h4 className="text-red-400 text-[10px] uppercase tracking-widest font-bold mb-3">Blue Sapphire Warning / नीलम चेतावनी</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          The Great Debate — Do Gemstones Actually Work? / महा-विवाद — क्या रत्न वास्तव में कार्य करते हैं?
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">The Navaratna Alternative / नवरत्न विकल्प</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
      ...
      <section className="glass-card rounded-xl p-5 border border-red-500/15">
        <h4 className="text-red-400 text-[10px] uppercase tracking-widest font-bold mb-3">Why a Wrong Gemstone Can Cause Harm / गलत रत्न हानिकारक क्यों</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
      ...
      <section className="glass-card rounded-xl p-5 border border-blue-500/15">
        <h4 className="text-blue-300 text-[10px] uppercase tracking-widest font-bold mb-3">Chart-Specific Over Generic / सामान्य से ऊपर कुण्डली-विशिष्ट</h4>
        <p className="text-text-secondary text-xs leading-relaxed">
