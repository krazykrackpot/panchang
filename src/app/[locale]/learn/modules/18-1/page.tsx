    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          What is Shadbala? / षड्बल क्या है?
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          Shadbala (&ldquo;six strengths&rdquo;) is the most comprehensive system in Vedic astrology for quantifying how powerful a planet truly is. A planet may sit in exaltation yet be combust, or occupy its own sign yet languish in a dusthana house. Shadbala resolves these contradictions by computing six independent measurements and summing them into a single composite score measured in shashtiamsas (sixtieths of a rupa).
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          षड्बल (&ldquo;छह शक्तियाँ&rdquo;) वैदिक ज्योतिष में ग्रह की वास्तविक शक्ति को परिमाणित करने की सर्वाधिक व्यापक पद्धति है। कोई ग्रह उच्च में हो सकता है पर अस्त भी, या स्वराशि में हो पर दुःस्थान में। षड्बल छह स्वतन्त्र माप गणनाओं को जोड़कर एकल समग्र अंक (षष्ट्यंश में) देता है जो इन विरोधाभासों को सुलझाता है।
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section className="glass-card rounded-xl p-5 border border-gold-primary/10">
        <h4 className="text-gold-dark text-[10px] uppercase tracking-widest font-bold mb-2">Classical Origin / शास्त्रीय उद्गम</h4>
        <p className="text-text-secondary text-sm leading-relaxed">
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Computing Each Component / प्रत्येक घटक की गणना
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">Worked Example / कार्यरत उदाहरण</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Mars in Capricorn, 10th house, daytime chart, direct motion, Jupiter aspecting:</span>
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-1">Sthana Bala: ~150 (Uccha 60 + Saptavargaja ~50 + Ojha-Yugma ~15 + Kendradi ~15 + Drekkana ~10)</p>
        <p className="text-text-secondary text-xs leading-relaxed mb-1">Dig Bala: 60 (10th house = South = maximum for Mars)</p>
        <p className="text-text-secondary text-xs leading-relaxed mb-1">Kala Bala: ~95 (day-night ~30 + hora ~10 + month ~20 + year ~20 + other ~15)</p>
        <p className="text-text-secondary text-xs leading-relaxed mb-1">Cheshta Bala: ~30 (direct motion, moderate speed)</p>
        <p className="text-text-secondary text-xs leading-relaxed mb-1">Naisargika Bala: 17.14 (fixed value for Mars)</p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">Drig Bala: ~10 (Jupiter aspect +15, minor malefic aspect -5)</p>
      ...
      <section className="glass-card rounded-xl p-5 border border-red-500/15">
        <h4 className="text-red-400 text-[10px] uppercase tracking-widest font-bold mb-2">Common Misconceptions / सामान्य भ्रम</h4>
        <p className="text-text-secondary text-sm leading-relaxed">
...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Interpretation and Practical Use / व्याख्या एवं व्यावहारिक उपयोग
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          The planet with the highest total Shadbala is the chart&apos;s &ldquo;captain&rdquo; &mdash; its significations dominate the native&apos;s life. If Jupiter leads, the person gravitates toward wisdom, teaching, and expansion. If Venus leads, aesthetics, relationships, and comfort define them. The weakest planet reveals the life area requiring the most conscious effort and remedial measures.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          सर्वाधिक कुल षड्बल वाला ग्रह कुण्डली का &ldquo;कप्तान&rdquo; है &mdash; उसके कारकत्व जातक के जीवन में प्रभुत्व रखते हैं। यदि बृहस्पति अग्रणी हो तो व्यक्ति ज्ञान, शिक्षण और विस्तार की ओर आकर्षित होता है। यदि शुक्र अग्रणी हो तो सौन्दर्य, सम्बन्ध और सुख परिभाषित करते हैं। सबसे दुर्बल ग्रह उस जीवन क्षेत्र को दर्शाता है जिसमें सबसे अधिक सचेत प्रयास और उपचारात्मक उपायों की आवश्यकता है।
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section className="glass-card rounded-xl p-5 border border-blue-500/15">
        <h4 className="text-blue-300 text-[10px] uppercase tracking-widest font-bold mb-2">Modern Relevance / आधुनिक प्रासंगिकता</h4>
        <p className="text-text-secondary text-sm leading-relaxed">
