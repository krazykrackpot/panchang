  ...
  return (
    <div className="space-y-6">
      ...
      <section className="glass-card rounded-xl p-5 border border-gold-primary/10">
        <h4 className="text-gold-dark text-[10px] uppercase tracking-widest font-bold mb-2">Virodha Argala — The Counter-Bolt / विरोध अर्गला — प्रतिचिटकनी</h4>
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Types of Argala in Detail / अर्गला के प्रकार विस्तार से
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">Putra Argala — The Special 5th / पुत्र अर्गला — विशेष पाँचवाँ</h4>
...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Using Argala in Prediction / भविष्यवाणी में अर्गला का प्रयोग
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
