    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Eclipse Mechanics — Sun, Moon & Nodes / ग्रहण यांत्रिकी — सूर्य, चन्द्र और राहु-केतु
        </h3>
        ...
        <div className="space-y-3">
          <div className="glass-card rounded-lg p-3 border border-gold-primary/10">
            <p className="text-gold-light font-bold text-sm">Solar Eclipse (Surya Grahan) / सूर्य ग्रहण</p>
            <p className="text-text-secondary text-xs mt-1">Occurs at New Moon (Amavasya) when the Moon passes between the Sun and Earth. The Moon blocks the Sun&apos;s light. This only happens when the New Moon is within approximately 15° of Rahu or Ketu. Types: total (Moon fully covers Sun), annular (Moon slightly smaller, creating a ring), partial (partial coverage).</p>
            <p className="text-text-secondary text-xs mt-1" style={{ fontFamily: 'var(--font-devanagari-body)' }}>अमावस्या पर होता है जब चन्द्रमा सूर्य और पृथ्वी के बीच से गुजरता है। चन्द्रमा सूर्य के प्रकाश को रोकता है। यह केवल तब होता है जब अमावस्या राहु या केतु से लगभग 15° के भीतर हो। प्रकार: पूर्ण (चन्द्रमा सूर्य को पूरी तरह ढकता है), वलयाकार (चन्द्रमा थोड़ा छोटा, एक वलय बनाता है), आंशिक (आंशिक आच्छादन)।</p>
          </div>
          <div className="glass-card rounded-lg p-3 border border-gold-primary/10">
            <p className="text-gold-light font-bold text-sm">Lunar Eclipse (Chandra Grahan) / चन्द्र ग्रहण</p>
            <p className="text-text-secondary text-xs mt-1">Occurs at Full Moon (Purnima) when the Earth passes between the Sun and Moon. Earth&apos;s shadow falls on the Moon. Requires the Full Moon to be within approximately 18° of a node. The wider threshold (vs. 15° for solar) is because Earth&apos;s shadow is larger than the Moon&apos;s. Lunar eclipses are visible from the entire nightside of Earth.</p>
            <p className="text-text-secondary text-xs mt-1" style={{ fontFamily: 'var(--font-devanagari-body)' }}>पूर्णिमा पर होता है जब पृथ्वी सूर्य और चन्द्रमा के बीच आती है। पृथ्वी की छाया चन्द्रमा पर पड़ती है। पूर्णिमा का नोड से लगभग 18° के भीतर होना आवश्यक है। व्यापक सीमा (सूर्य ग्रहण के 15° की तुलना में) इसलिए है क्योंकि पृथ्वी की छाया चन्द्रमा से बड़ी है। चन्द्र ग्रहण पृथ्वी के सम्पूर्ण रात्रि पक्ष से दिखाई देते हैं।</p>
          </div>
          <div className="glass-card rounded-lg p-3 border border-gold-primary/10">
            <p className="text-gold-light font-bold text-sm">Eclipse Frequency / ग्रहण आवृत्ति</p>
            <p className="text-text-secondary text-xs mt-1">There are approximately 4-7 eclipses per year globally — a mix of solar and lunar. However, only 2-3 are typically visible from any given location. Eclipses come in &quot;seasons&quot; about 6 months apart, when the Sun is near the nodal axis. Each season produces 2-3 eclipses within a few weeks.</p>
            <p className="text-text-secondary text-xs mt-1" style={{ fontFamily: 'var(--font-devanagari-body)' }}>विश्व भर में प्रति वर्ष लगभग 4-7 ग्रहण होते हैं — सूर्य और चन्द्र का मिश्रण। हालाँकि, किसी भी स्थान से आमतौर पर केवल 2-3 दिखाई देते हैं। ग्रहण लगभग 6 महीने के अन्तराल पर &quot;ऋतुओं&quot; में आते हैं, जब सूर्य नोडल अक्ष के निकट होता है। प्रत्येक ऋतु कुछ सप्ताहों में 2-3 ग्रहण उत्पन्न करती है।</p>
          </div>
        </div>
      </section>

      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-300 text-[10px] uppercase tracking-widest font-bold mb-3">Why Not Every New/Full Moon? / हर अमावस्या/पूर्णिमा पर क्यों नहीं?</h4>
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Eclipse Prediction Algorithm / ग्रहण भविष्यवाणी एल्गोरिदम
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          The core prediction method is elegantly simple: at every New Moon and Full Moon, compute the angular distance between the Sun and Rahu (the ascending node). If the distance falls below a threshold, an eclipse is possible. Ancient Indian astronomers encoded this into Surya Siddhanta algorithms millennia ago.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3" style={{ fontFamily: 'var(--font-devanagari-body)' }}>
          मूल भविष्यवाणी विधि सुरुचिपूर्ण रूप से सरल है: प्रत्येक अमावस्या और पूर्णिमा पर, सूर्य और राहु (उत्तरी नोड) के बीच कोणीय दूरी की गणना करें। यदि दूरी एक सीमा से नीचे आती है, तो ग्रहण सम्भव है। प्राचीन भारतीय खगोलविदों ने इसे सहस्राब्दियों पहले सूर्य सिद्धान्त एल्गोरिदम में संकलित किया था।
        </p>

        <div className="space-y-3">
          <div className="glass-card rounded-lg p-3 border border-gold-primary/10">
            <p className="text-gold-light font-bold text-sm">Step-by-Step Algorithm / चरणबद्ध एल्गोरिदम</p>
            <p className="text-text-secondary text-xs mt-1">1. Compute the Sun&apos;s longitude and Rahu&apos;s longitude at each New/Full Moon. 2. Calculate the angular distance: |Sun_lon - Rahu_lon|. 3. If at Full Moon and distance &lt; 18° → lunar eclipse possible. 4. If at New Moon and distance &lt; 15° → solar eclipse possible. 5. For greater precision, also check the Moon&apos;s latitude at the moment of conjunction/opposition.</p>
            <p className="text-text-secondary text-xs mt-1" style={{ fontFamily: 'var(--font-devanagari-body)' }}>1. प्रत्येक अमावस्या/पूर्णिमा पर सूर्य और राहु का देशान्तर गणना करें। 2. कोणीय दूरी गणना करें: |सूर्य_देशान्तर - राहु_देशान्तर|। 3. यदि पूर्णिमा पर और दूरी &lt; 18° → चन्द्र ग्रहण सम्भव। 4. यदि अमावस्या पर और दूरी &lt; 15° → सूर्य ग्रहण सम्भव। 5. अधिक सटीकता के लिए, युति/प्रतियुति के क्षण चन्द्रमा का अक्षांश भी जाँचें।</p>
          </div>
          <div className="glass-card rounded-lg p-3 border border-gold-primary/10">
            <p className="text-gold-light font-bold text-sm">The Saros Cycle / सैरोस चक्र</p>
            <p className="text-text-secondary text-xs mt-1">Eclipses repeat in a remarkable pattern: every 223 synodic months (18 years, 11 days, 8 hours), a nearly identical eclipse occurs. This happens because after 223 synodic months, the Sun-Moon-Node geometry returns to almost the same configuration. The 8-hour shift means each repeat moves ~120° in longitude, so the same eclipse is visible from a different part of the world.</p>
            <p className="text-text-secondary text-xs mt-1" style={{ fontFamily: 'var(--font-devanagari-body)' }}>ग्रहण एक उल्लेखनीय पैटर्न में दोहराते हैं: प्रत्येक 223 सिनोडिक मास (18 वर्ष, 11 दिन, 8 घण्टे) में, लगभग समान ग्रहण होता है। यह इसलिए होता है क्योंकि 223 सिनोडिक मास के बाद, सूर्य-चन्द्र-नोड ज्यामिति लगभग समान विन्यास में लौटती है। 8 घण्टे का अन्तर का अर्थ है कि प्रत्येक पुनरावृत्ति देशान्तर में ~120° खिसकती है, इसलिए वही ग्रहण विश्व के भिन्न भाग से दिखाई देता है।</p>
          </div>
          <div className="glass-card rounded-lg p-3 border border-gold-primary/10">
            <p className="text-gold-light font-bold text-sm">Our Engine Implementation / हमारे इंजन का कार्यान्वयन</p>
            <p className="text-text-secondary text-xs mt-1">Our Panchang engine checks every lunation against the nodal axis using Meeus-precision positions. For each upcoming New and Full Moon, we compute the Sun-Rahu distance and flag potential eclipses. We also compute the eclipse type (total/annular/partial for solar; total/partial/penumbral for lunar) based on the Moon&apos;s apparent diameter and angular separation.</p>
            <p className="text-text-secondary text-xs mt-1" style={{ fontFamily: 'var(--font-devanagari-body)' }}>हमारा पंचांग इंजन मीयस-सटीकता स्थितियों का उपयोग करके प्रत्येक ल्यूनेशन की नोडल अक्ष से जाँच करता है। प्रत्येक आगामी अमावस्या और पूर्णिमा के लिए, हम सूर्य-राहु दूरी गणना करते हैं और सम्भावित ग्रहणों को चिह्नित करते हैं। हम चन्द्रमा के दृश्य व्यास और कोणीय पृथक्करण के आधार पर ग्रहण प्रकार (सूर्य के लिए पूर्ण/वलयाकार/आंशिक; चन्द्र के लिए पूर्ण/आंशिक/उपच्छायात्मक) भी गणना करते हैं।</p>
          </div>
        </div>
      </section>

      <section className="glass-card rounded-xl p-5 border border-red-500/15">
        <h4 className="text-red-400 text-[10px] uppercase tracking-widest font-bold mb-3">Historical Precision / ऐतिहासिक सटीकता</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          Indian astronomers could predict eclipses with remarkable accuracy using Surya Siddhanta methods. Aryabhata (5th century CE) computed the Moon&apos;s orbital parameters so precisely that his eclipse predictions were within minutes of actual events. The node regression period (18.6 years) was known to within seconds. Modern algorithms simply refine what ancient Indian mathematics established.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed" style={{ fontFamily: 'var(--font-devanagari-body)' }}>
          भारतीय खगोलविद सूर्य सिद्धान्त विधियों का उपयोग करके उल्लेखनीय सटीकता से ग्रहणों की भविष्यवाणी कर सकते थे। आर्यभट (5वीं शताब्दी ईस्वी) ने चन्द्रमा के कक्षीय मापदण्डों की इतनी सटीक गणना की कि उनकी ग्रहण भविष्यवाणियाँ वास्तविक घटनाओं से मिनटों के भीतर थीं। नोड प्रत्यागमन अवधि (18.6 वर्ष) सेकण्डों के भीतर ज्ञात थी। आधुनिक एल्गोरिदम केवल उसे परिष्कृत करते हैं जो प्राचीन भारतीय गणित ने स्थापित किया था।
        </p>
      </section>
    </div>
  );
...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Astrological Significance of Eclipses / ग्रहणों का ज्योतिषीय महत्व
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          Eclipses activate the houses where they fall by transit in your birth chart. Their effects are potent and long-lasting — typically 6 months for a solar eclipse and 3 months for a lunar eclipse. The house and sign of the eclipse determine which life area is activated.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3" style={{ fontFamily: 'var(--font-devanagari-body)' }}>
          ग्रहण आपकी जन्म कुण्डली में गोचर द्वारा जिन भावों में पड़ते हैं उन्हें सक्रिय करते हैं। उनके प्रभाव शक्तिशाली और दीर्घकालिक होते हैं — सूर्य ग्रहण के लिए आमतौर पर 6 महीने और चन्द्र ग्रहण के लिए 3 महीने। ग्रहण का भाव और राशि निर्धारित करते हैं कि कौन सा जीवन क्षेत्र सक्रिय होता है।
        </p>

        <div className="space-y-3">
          <div className="glass-card rounded-lg p-3 border border-gold-primary/10">
            <p className="text-gold-light font-bold text-sm">Eclipse on Natal Moon / जन्म चन्द्रमा पर ग्रहण</p>
            <p className="text-text-secondary text-xs mt-1">A solar eclipse conjunct your natal Moon is one of the most intense transits possible. It indicates emotional upheaval, inner transformation, and a reset of emotional patterns for approximately 6 months. The house of the natal Moon determines which life area undergoes this emotional restructuring. A lunar eclipse on the natal Moon is similarly powerful but manifests more as external emotional events.</p>
            <p className="text-text-secondary text-xs mt-1" style={{ fontFamily: 'var(--font-devanagari-body)' }}>आपके जन्म चन्द्रमा पर सूर्य ग्रहण सबसे तीव्र गोचरों में से एक है। यह लगभग 6 महीनों के लिए भावनात्मक उथल-पुथल, आन्तरिक परिवर्तन और भावनात्मक प्रतिमानों का पुनर्स्थापन दर्शाता है। जन्म चन्द्रमा का भाव निर्धारित करता है कि कौन सा जीवन क्षेत्र इस भावनात्मक पुनर्गठन से गुजरता है। जन्म चन्द्रमा पर चन्द्र ग्रहण समान रूप से शक्तिशाली है लेकिन अधिक बाह्य भावनात्मक घटनाओं के रूप में प्रकट होता है।</p>
          </div>
          <div className="glass-card rounded-lg p-3 border border-gold-primary/10">
            <p className="text-gold-light font-bold text-sm">House-Specific Effects / भाव-विशिष्ट प्रभाव</p>
            <p className="text-text-secondary text-xs mt-1">1st house: identity transformation. 4th house: home/mother changes. 7th house: partnership upheaval. 10th house: career change. 2nd/8th axis: financial shifts. 5th/11th axis: children, creativity, social circle changes. 6th/12th axis: health and spiritual awakening. The axis matters — eclipses always activate opposite houses simultaneously.</p>
            <p className="text-text-secondary text-xs mt-1" style={{ fontFamily: 'var(--font-devanagari-body)' }}>प्रथम भाव: पहचान परिवर्तन। चतुर्थ भाव: गृह/मातृ परिवर्तन। सप्तम भाव: साझेदारी उथल-पुथल। दशम भाव: कैरियर परिवर्तन। द्वितीय/अष्टम अक्ष: आर्थिक बदलाव। पंचम/एकादश अक्ष: संतान, सृजनात्मकता, सामाजिक वृत्त परिवर्तन। षष्ठ/द्वादश अक्ष: स्वास्थ्य और आध्यात्मिक जागरण। अक्ष महत्वपूर्ण है — ग्रहण सदैव विपरीत भावों को एक साथ सक्रिय करते हैं।</p>
          </div>
          <div className="glass-card rounded-lg p-3 border border-gold-primary/10">
            <p className="text-gold-light font-bold text-sm">Eclipse Season & Grahan Dosha / ग्रहण ऋतु और ग्रहण दोष</p>
            <p className="text-text-secondary text-xs mt-1">The &quot;eclipse season&quot; — the 2-week window around each eclipse — is considered inauspicious for new beginnings (marriage, business launch, house purchase). However, eclipses are excellent for endings and closure. Grahan Dosha: being born during an eclipse creates specific karmic patterns. Sun-Rahu/Ketu conjunction at birth = Surya Grahan Dosha (identity/authority challenges). Moon-Rahu/Ketu = Chandra Grahan Dosha (emotional/mental patterns).</p>
            <p className="text-text-secondary text-xs mt-1" style={{ fontFamily: 'var(--font-devanagari-body)' }}>&quot;ग्रहण ऋतु&quot; — प्रत्येक ग्रहण के आसपास 2 सप्ताह की अवधि — नये कार्यों (विवाह, व्यापार आरम्भ, गृह खरीद) के लिए अशुभ मानी जाती है। हालाँकि, ग्रहण समाप्ति और पूर्णता के लिए उत्कृष्ट हैं। ग्रहण दोष: ग्रहण के दौरान जन्म विशिष्ट कार्मिक प्रतिमान उत्पन्न करता है। जन्म पर सूर्य-राहु/केतु युति = सूर्य ग्रहण दोष (पहचान/अधिकार चुनौतियाँ)। चन्द्र-राहु/केतु = चन्द्र ग्रहण दोष (भावनात्मक/मानसिक प्रतिमान)।</p>
          </div>
        </div>
      </section>

      <section className="glass-card rounded-xl p-5 border border-blue-500/15">
        <h4 className="text-blue-300 text-[10px] uppercase tracking-widest font-bold mb-3">Practical Application / व्यावहारिक अनुप्रयोग</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          Track upcoming eclipses on our Grahan page. Note which house they transit in your birth chart. Avoid major initiations during the eclipse season, but use the energy for meditation, releasing old patterns, and inner work. If an eclipse falls within 3° of a natal planet, expect significant events related to that planet&apos;s significations within the following 6 months.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed" style={{ fontFamily: 'var(--font-devanagari-body)' }}>
          हमारे ग्रहण पृष्ठ पर आगामी ग्रहणों को ट्रैक करें। ध्यान दें कि वे आपकी जन्म कुण्डली में किस भाव से गोचर करते हैं। ग्रहण काल में प्रमुख शुरुआतें टालें, लेकिन ऊर्जा का उपयोग ध्यान, पुराने प्रतिमानों को छोड़ने और आन्तरिक कार्य के लिए करें। यदि कोई ग्रहण किसी जन्मकालीन ग्रह के 3° के भीतर पड़ता है, तो अगले 6 महीनों में उस ग्रह के कारकत्व से सम्बन्धित महत्वपूर्ण घटनाओं की अपेक्षा करें।
        </p>
      </section>
    </div>
  );
