...
const DURGA_PUJA_DAYS: Array<{ name: string; tithi: string; engineKey: string | null; desc: string }> = [
  ...
  { name: 'Shashthi', tithi: 'Ashwin Shukla Shashthi', engineKey: null, desc: 'First day of major public ceremony. The Bodhana rite formally invokes Durga into the idol; the Adhivasa anointing ceremony follows. From this evening the pandals are open to the public.' },
  { name: 'Maha Saptami', tithi: 'Ashwin Shukla Saptami', engineKey: null, desc: 'Worship proper begins with the Navapatrika snan, the ritual bathing of nine sacred plants — banana, turmeric, jayanti, bel, pomegranate, ashoka, mana, dhan and kachu — which together constitute the goddess in her vegetal aspect. The Navapatrika is dressed in a white sari with a red border and installed beside the idol, often colloquially called Kala Bou.' },
  { name: 'Maha Ashtami', tithi: 'Ashwin Shukla Ashtami', engineKey: 'durga-ashtami', desc: 'The most attended day. The morning Pushpanjali, in which devotees offer flowers in successive batches led by a priest’s recitation, draws the largest pandal crowds of the week.' },
  ...
  { name: 'Maha Navami', tithi: 'Ashwin Shukla Navami', engineKey: null, desc: 'The morning is dominated by the homa, the fire oblation, and by the distribution of bhog — typically khichuri, labra and chutney — to all who come to the pandal.' },
  { name: 'Vijayadashami', tithi: 'Ashwin Shukla Dashami', engineKey: 'dussehra', desc: 'The day opens with sindoor khela, in which married women apply vermilion first to the idol’s forehead and feet and then to one another. From afternoon to late evening the bishorjon processions begin: the clay idols are loaded onto trucks, paraded through the lanes, and immersed in the Hooghly, Ganges or local tanks, returning the goddess to the formless water from which her clay was drawn.' },
];
