...
export const SATYANARAYAN_PUJA: PujaVidhi = {
  ...
  samagri: [
    { name: { en: 'Banana leaves (for altar setup)', hi: 'केले के पत्ते (वेदी सज्जा के लिए)', sa: 'कदलीपत्राणि (वेदिसज्जायै)' }, quantity: '5-7' },
    { name: { en: 'Panchamrit (milk, curd, ghee, honey, sugar)', hi: 'पंचामृत (दूध, दही, घी, शहद, शक्कर)', sa: 'पञ्चामृतम् (क्षीरं, दधि, घृतं, मधु, शर्करा)' } },
    { name: { en: 'Suji/Sooji (semolina for sheera prasad)', hi: 'सूजी (शीरा प्रसाद के लिए)', sa: 'गोधूमसूक्ष्मचूर्णम् (शीरानैवेद्यार्थम्)' }, quantity: '500g', note: { en: 'For making sheera — the essential Satyanarayan prasad', hi: 'शीरा बनाने के लिए — सत्यनारायण का अनिवार्य प्रसाद', sa: 'शीरानिर्माणार्थम् — सत्यनारायणस्य अनिवार्यं नैवेद्यम्' } },
    { name: { en: 'Tulsi leaves', hi: 'तुलसी के पत्ते', sa: 'तुलसीपत्राणि' } },
    { name: { en: 'Fruits (banana, apple, pomegranate, coconut)', hi: 'फल (केला, सेब, अनार, नारियल)', sa: 'फलानि (कदलीफलम्, सेवफलम्, दाडिमम्, नारिकेलम्)' } },
    { name: { en: 'Singhada (water chestnut flour/fruit)', hi: 'सिंघाड़ा (आटा/फल)', sa: 'श्रृङ्गाटकम्' } },
    { name: { en: 'Coins (for offering)', hi: 'सिक्के (अर्पण के लिए)', sa: 'मुद्राः (अर्पणार्थम्)' }, quantity: '5-11' },
    { name: { en: 'Flowers (yellow marigold preferred)', hi: 'फूल (पीले गेंदे के फूल)', sa: 'पुष्पाणि (पीतस्थालपद्मानि श्रेष्ठानि)' } },
    ...
    { name: { en: 'Red thread (mauli/kalava)', hi: 'लाल धागा (मौली/कलावा)', sa: 'रक्तसूत्रम् (मौलिः)' } },
    { name: { en: 'Akshat (unbroken rice)', hi: 'अक्षत (साबुत चावल)', sa: 'अक्षताः' } },
    { name: { en: 'Kumkum & turmeric', hi: 'कुमकुम एवं हल्दी', sa: 'कुङ्कुमं हरिद्रा च' } },
    { name: { en: 'Supari (betel nut) and paan leaves', hi: 'सुपारी और पान के पत्ते', sa: 'पूगीफलं ताम्बूलपत्राणि च' }, quantity: '5' },
    { name: { en: 'Satyanarayan Katha book', hi: 'सत्यनारायण कथा पुस्तक', sa: 'सत्यनारायणकथापुस्तकम्' } },
  ],
