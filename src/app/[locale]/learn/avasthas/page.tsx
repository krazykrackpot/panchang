...
export default function LearnAvasthasPage() {
  ...
  const BALADI_STATES = [
    ...
    { name: { en: 'Yuva (Prime)', hi: 'युवा (पूर्ण)', sa: 'युवा (पूर्ण)', mai: 'युवा (पूर्ण)', mr: 'युवा (पूर्ण)', ta: 'யுவ (முழுமை)', te: 'యువ (యువకుడు)', bn: 'যুব (পূর্ণ)', kn: 'ಯುವ (ಪ್ರೌಢ)', gu: 'યુવ (પૂર્ણ)' }, condition: { en: '12-18° (odd) / 12-18° (even)', hi: '12-18° (विषम) / 12-18° (सम)', sa: '12-18° (विषम) / 12-18° (सम)', mai: '12-18° (विषम) / 12-18° (सम)', mr: '12-18° (विषम) / 12-18° (सम)', ta: '12-18° (odd) / 12-18° (even)', te: '12-18° (odd) / 12-18° (even)', bn: '12-18° (odd) / 12-18° (even)', kn: '12-18° (odd) / 12-18° (even)', gu: '12-18° (odd) / 12-18° (even)' }, result: { en: 'Planet at peak — gives full, powerful results. The best Baladi state.', hi: 'ग्रह चरम पर — पूर्ण, शक्तिशाली फल। सर्वश्रेष्ठ बालादि अवस्था।', sa: 'ग्रह चरम पर — पूर्ण, शक्तिशाली फल। सर्वश्रेष्ठ बालादि अवस्था।', mai: 'ग्रह चरम पर — पूर्ण, शक्तिशाली फल। सर्वश्रेष्ठ बालादि अवस्था।', mr: 'ग्रह चरम पर — पूर्ण, शक्तिशाली फल। सर्वश्रेष्ठ बालादि अवस्था।', ta: 'கிரகம் உச்சத்தில் — முழு, சக்திவாய்ந்த பலன்கள் தருகிறது. சிறந்த பாலாதி நிலை.', te: 'గ్రహం శిఖరంలో — పూర్తి, శక్తివంతమైన ఫలితాలు ఇస్తుంది. అత్యుత్తమ బాలాది స్థితి.', bn: 'গ্রহ শীর্ষে — পূর্ণ, শক্তিশালী ফল দেয়। সেরা বালাদি অবস্থা।', kn: 'ಗ್ರಹ ಉತ್ತುಂಗದಲ್ಲಿ — ಪೂರ್ಣ, ಶಕ್ತಿಶಾಲಿ ಫಲ ನೀಡುತ್ತದೆ. ಅತ್ಯುತ್ತಮ ಬಾಲಾದಿ ಸ್ಥಿತಿ.', gu: 'ગ્રહ ટોચ પર — પૂર્ણ, શક્તિશાળી ફળ આપે છે. શ્રેષ્ઠ બાલાદિ સ્થિતિ.' }, color: 'text-amber-400', tier: 'excellent', stateKey: 'yuva' },
    { name: { en: 'Vriddha (Old)', hi: 'वृद्ध (प्रौढ़)', sa: 'वृद्ध (प्रौढ़)', mai: 'वृद्ध (प्रौढ़)', mr: 'वृद्ध (प्रौढ़)', ta: 'வ்ருத்த (வயோதிகம்)', te: 'వృద్ధ (వృద్ధుడు)', bn: 'বৃদ্ধ (বৃদ্ধ)', kn: 'ವೃದ್ಧ (ವೃದ್ಧ)', gu: 'વૃદ્ધ (વૃદ્ધ)' }, condition: { en: '18-24° (odd) / 6-12° (even)', hi: '18-24° (विषम) / 6-12° (सम)', sa: '18-24° (विषम) / 6-12° (सम)', mai: '18-24° (विषम) / 6-12° (सम)', mr: '18-24° (विषम) / 6-12° (सम)', ta: '18-24° (odd) / 6-12° (even)', te: '18-24° (odd) / 6-12° (even)', bn: '18-24° (odd) / 6-12° (even)', kn: '18-24° (odd) / 6-12° (even)', gu: '18-24° (odd) / 6-12° (even)' }, result: { en: 'Planet declining — gives results with decreasing enthusiasm.', hi: 'ग्रह क्षीण — घटते उत्साह से फल देता है।', sa: 'ग्रह क्षीण — घटते उत्साह से फल देता है।', mai: 'ग्रह क्षीण — घटते उत्साह से फल देता है।', mr: 'ग्रह क्षीण — घटते उत्साह से फल देता है।', ta: 'கிரகம் வீழ்ச்சியடைகிறது — குறையும் உற்சாகத்துடன் பலன்கள் தருகிறது.', te: 'గ్రహం క్షీణిస్తోంది — తగ్గుతున్న ఉత్సాహంతో ఫలితాలు ఇస్తుంది.', bn: 'গ্রহ ক্ষীয়মান — হ্রাসমান উৎসাহ সহ ফল দেয়।', kn: 'ಗ್ರಹ ಕ್ಷೀಣಿಸುತ್ತಿದೆ — ಕಡಿಮೆಯಾಗುತ್ತಿರುವ ಉತ್ಸಾಹದೊಂದಿಗೆ ಫಲ ನೀಡುತ್ತದೆ.', gu: 'ગ્રહ ઘટી રહ્યો છે — ઘટતા ઉત્સાહ સાથે ફળ આપે છે.' }, color: 'text-violet-400', tier: 'mixed', stateKey: null },
    { name: { en: 'Mrita (Dead)', hi: 'मृत', sa: 'मृत', mai: 'मृत', mr: 'मृत', ta: 'ம்ருத (மரணம்)', te: 'మృత (మరణం)', bn: 'মৃত (মৃত)', kn: 'ಮೃತ (ಮೃತ)', gu: 'મૃત (મૃત)' }, condition: { en: '24-30° (odd) / 0-6° (even)', hi: '24-30° (विषम) / 0-6° (सम)', sa: '24-30° (विषम) / 0-6° (सम)', mai: '24-30° (विषम) / 0-6° (सम)', mr: '24-30° (विषम) / 0-6° (सम)', ta: '24-30° (odd) / 0-6° (even)', te: '24-30° (odd) / 0-6° (even)', bn: '24-30° (odd) / 0-6° (even)', kn: '24-30° (odd) / 0-6° (even)', gu: '24-30° (odd) / 0-6° (even)' }, result: { en: 'Planet at minimum power — gives weak or denied results in its significations.', hi: 'ग्रह न्यूनतम शक्ति पर — अपने कारकत्वों में कमजोर या अस्वीकृत फल।', sa: 'ग्रह न्यूनतम शक्ति पर — अपने कारकत्वों में कमजोर या अस्वीकृत फल।', mai: 'ग्रह न्यूनतम शक्ति पर — अपने कारकत्वों में कमजोर या अस्वीकृत फल।', mr: 'ग्रह न्यूनतम शक्ति पर — अपने कारकत्वों में कमजोर या अस्वीकृत फल।', ta: 'கிரகம் குறைந்தபட்ச சக்தியில் — அதன் காரகத்துவங்களில் பலவீனமான அல்லது மறுக்கப்பட்ட பலன்கள் தருகிறது.', te: 'గ్రహం కనిష్ట శక్తిలో — దాని కారకత్వాలలో బలహీనమైన లేదా నిరాకరించబడిన ఫలితాలు ఇస్తుంది.', bn: 'গ্রহ ন্যূনতম শক্তিতে — এর কারকত্বে দুর্বল বা প্রত্যাখ্যাত ফল দেয়।', kn: 'ಗ್ರಹ ಕನಿಷ್ಠ ಶಕ್ತಿಯಲ್ಲಿ — ಅದರ ಕಾರಕತ್ವಗಳಲ್ಲಿ ದುರ್ಬಲ ಅಥವಾ ನಿರಾಕರಿಸಿದ ಫಲ ನೀಡುತ್ತದೆ.', gu: 'ગ્રહ ન્યૂનતમ શક્તિમાં — તેના કારકત્વોમાં નબળા અથવા નકારેલા ફળ આપે છે.' }, color: 'text-red-400', tier: 'denied', stateKey: 'mrita' },
  ];
