    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          The Double Transit Theory / द्वि-गोचर सिद्धान्त
        </h3>
      ...
      <section className="glass-card rounded-xl p-5 border border-gold-primary/10">
        <h4 className="text-gold-dark text-[10px] uppercase tracking-widest font-bold mb-2">Why Jupiter and Saturn? / गुरु और शनि ही क्यों?</h4>
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Dasha Sandhi — The Turbulent Transition / दशा सन्धि — अशान्त संक्रमण
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          Dasha sandhi (junction) is the transition zone between two Mahadashas — one of the most sensitive periods in a person&apos;s life. The term &quot;sandhi&quot; means junction or meeting point. During the last ~6 months of an outgoing Mahadasha and the first ~6 months of an incoming one, the native experiences a fundamental shift in life themes. The old planetary influence is waning but not gone; the new one is emerging but not yet established. This creates uncertainty, confusion, and sometimes turbulence.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          दशा सन्धि (सन्धि स्थल) दो महादशाओं के बीच का संक्रमण क्षेत्र है — व्यक्ति के जीवन के सबसे संवेदनशील कालों में से एक। &quot;सन्धि&quot; शब्द का अर्थ जंक्शन या मिलन बिन्दु है। निवर्तमान महादशा के अन्तिम ~6 मास और आगामी के प्रथम ~6 मास में जातक जीवन विषयों में मूलभूत परिवर्तन अनुभव करता है। पुराना ग्रह प्रभाव क्षीण हो रहा है किन्तु समाप्त नहीं हुआ; नया उभर रहा है किन्तु अभी स्थापित नहीं। यह अनिश्चितता, भ्रम और कभी-कभी अशान्ति उत्पन्न करता है।
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
        ...
        <p className="text-text-secondary text-sm leading-relaxed">
          उदाहरणार्थ, गुरु महादशा (विस्तार, आशावाद, शिक्षण, धर्म) से शनि महादशा (प्रतिबन्ध, अनुशासन, कठोर श्रम, कर्म) में संक्रमण सम्भव सबसे नाटकीय परिवर्तनों में से एक है। व्यक्ति को लग सकता है कि उसकी पूर्व सहायता प्रणालियाँ विलीन हो रही हैं, अवसर अचानक सिकुड़ रहे हैं, और एक नई, अधिक कठोर वास्तविकता आकार ले रही है। यह &quot;बुरा&quot; नहीं है — यह आवश्यक पुनर्संशोधन है। राहु और गुरु के बीच सन्धि गतिशीलता उलट देती है: जुनूनी सांसारिक अनुसरण से दार्शनिक स्पष्टता की ओर।
        </p>
      </section>

      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">Navigating Sandhi Periods / सन्धि काल का संचालन</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Awareness:</span> Simply knowing a sandhi is approaching reduces anxiety. Mark the exact Mahadasha transition date in advance and recognize that the 6 months before and after will feel unsettled. This is natural and temporary.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">जागरूकता:</span> केवल यह जानना कि सन्धि आ रही है, चिन्ता कम करता है। सटीक महादशा संक्रमण तिथि पहले से चिह्नित करें और मानें कि पहले और बाद के 6 मास अस्थिर अनुभव होंगे। यह स्वाभाविक और अस्थायी है।
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Avoid major commitments:</span> Do not make irreversible decisions (marriage, major investment, career change) during sandhi if possible. Wait for the new dasha to establish itself — typically 3-6 months into the new Mahadasha.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">बड़े निर्णय टालें:</span> यदि सम्भव हो तो सन्धि काल में अपरिवर्तनीय निर्णय (विवाह, बड़ा निवेश, कैरियर परिवर्तन) न लें। नई दशा के स्थापित होने की प्रतीक्षा करें — सामान्यतः नई महादशा में प्रवेश के 3-6 मास बाद।
        </p>
      </section>
      ...
      <section className="glass-card rounded-xl p-5 border border-red-500/15">
        ...
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Misconception:</span> &quot;Dasha sandhi always brings disaster.&quot; Not true. The sandhi between two benefic dashas (e.g., Jupiter to Mercury for a chart where both are well-placed) can simply feel like a period of recalibration — mild restlessness rather than crisis. The severity depends on how different the two Mahadasha lords are in nature and placement, and whether they are mutual friends or enemies.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">भ्रान्ति:</span> &quot;दशा सन्धि सदा विपत्ति लाती है।&quot; सत्य नहीं। दो शुभ दशाओं के बीच सन्धि (जैसे गुरु से बुध, जब दोनों शुभ स्थित हों) केवल पुनर्संशोधन काल जैसा अनुभव हो सकता है — संकट नहीं, हल्की बेचैनी। गम्भीरता इस पर निर्भर करती है कि दोनों महादशा स्वामी स्वभाव और स्थिति में कितने भिन्न हैं, और वे परस्पर मित्र हैं या शत्रु।
        </p>
      </section>
    </div>
  );
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="glass-card rounded-xl p-5 border border-blue-500/15">
        ...
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          Our Kundali engine generates the complete Vimshottari dasha table and identifies the current running Mahadasha and Antardasha. The Tippanni (interpretive commentary) section analyzes the Mahadasha planet&apos;s house, sign, and lordship, the Antardasha relationship, and cross-references with current Jupiter and Saturn transits. The Transits page shows real-time planetary positions, making it easy to verify double transit conditions for any house in your chart.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          हमारा कुण्डली इंजन पूर्ण विंशोत्तरी दशा तालिका बनाता है और वर्तमान चल रही महादशा एवं अन्तर्दशा पहचानता है। टिप्पणी (व्याख्यात्मक भाष्य) खण्ड महादशा ग्रह के भाव, राशि और भावेशत्व का विश्लेषण करता है, अन्तर्दशा सम्बन्ध आँकता है, और वर्तमान गुरु-शनि गोचर से तुलना करता है। गोचर पृष्ठ वास्तविक समय में ग्रह स्थितियाँ दिखाता है, जिससे आपकी कुण्डली के किसी भी भाव के लिए द्वि-गोचर शर्तें सत्यापित करना सरल है।
        </p>
      </section>
    </div>
  );
