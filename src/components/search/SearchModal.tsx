...
const SEARCH_INDEX: SearchItem[] = [
  ...
  { title: 'Gauri Panchang', titleHi: 'गौरी पंचांग', href: '/gauri-panchang', category: 'Tools', keywords: ['gauri', 'gowri', 'gauri panchang', 'gowri panchangam', 'nalla neram', 'amritha', 'siddha', 'laabha', 'tamil panchangam', 'south indian'] },
  ...
  // Yogas
  { title: 'Yoga Encyclopedia', titleHi: 'योग विश्वकोश', href: '/learn/yoga', category: 'Yogas', keywords: ['yoga', 'encyclopedia', 'all yogas', 'index'] },
  { title: 'Gajakesari Yoga', titleHi: 'गजकेसरी योग', href: '/learn/yoga/gajakesari', category: 'Yogas', keywords: ['gajakesari', 'elephant', 'jupiter', 'moon', 'kendra'] },
  { title: 'Budhaditya Yoga', titleHi: 'बुधादित्य योग', href: '/learn/yoga/budhaditya', category: 'Yogas', keywords: ['budhaditya', 'mercury', 'sun', 'intelligence'] },
  { title: 'Mangal Dosha', titleHi: 'मंगल दोष', href: '/learn/yoga/mangala_dosha', category: 'Yogas', keywords: ['mangal', 'manglik', 'mars', 'marriage', 'dosha'] },
  { title: 'Kaal Sarpa Yoga', titleHi: 'काल सर्प योग', href: '/learn/yoga/kala_sarpa', category: 'Yogas', keywords: ['kaal sarpa', 'rahu', 'ketu', 'serpent'] },
  { title: 'Guru Chandal Yoga', titleHi: 'गुरु चाण्डाल योग', href: '/learn/yoga/guru_chandal', category: 'Yogas', keywords: ['guru chandal', 'jupiter', 'rahu', 'corruption'] },
  { title: 'Ruchaka Yoga', titleHi: 'रुचक योग', href: '/learn/yoga/ruchaka', category: 'Yogas', keywords: ['ruchaka', 'mahapurusha', 'mars', 'courage'] },
  { title: 'Bhadra Yoga', titleHi: 'भद्र योग', href: '/learn/yoga/bhadra', category: 'Yogas', keywords: ['bhadra', 'mahapurusha', 'mercury', 'intellect'] },
  { title: 'Hansa Yoga', titleHi: 'हंस योग', href: '/learn/yoga/hansa', category: 'Yogas', keywords: ['hansa', 'hamsa', 'mahapurusha', 'jupiter', 'wisdom'] },
  { title: 'Malavya Yoga', titleHi: 'मालव्य योग', href: '/learn/yoga/malavya', category: 'Yogas', keywords: ['malavya', 'mahapurusha', 'venus', 'luxury'] },
  { title: 'Shasha Yoga', titleHi: 'शश योग', href: '/learn/yoga/shasha', category: 'Yogas', keywords: ['shasha', 'mahapurusha', 'saturn', 'discipline'] },
  { title: 'Kemadruma Yoga', titleHi: 'केमद्रुम योग', href: '/learn/yoga/kemadruma', category: 'Yogas', keywords: ['kemadruma', 'moon', 'isolation', 'poverty'] },
  { title: 'Chandra Mangala Yoga', titleHi: 'चन्द्र मंगल योग', href: '/learn/yoga/chandra_mangala', category: 'Yogas', keywords: ['chandra mangala', 'moon', 'mars', 'wealth'] },
  { title: 'Neechabhanga Raja Yoga', titleHi: 'नीचभंग राज योग', href: '/learn/yoga/neechabhanga_raja', category: 'Yogas', keywords: ['neechabhanga', 'debilitation', 'cancellation', 'raja'] },
  { title: 'Viparita Raja Yoga', titleHi: 'विपरीत राज योग', href: '/learn/yoga/viparita_raja', category: 'Yogas', keywords: ['viparita', 'raja', 'dusthana', 'reversal'] },
  { title: 'Saraswati Yoga', titleHi: 'सरस्वती योग', href: '/learn/yoga/saraswati', category: 'Yogas', keywords: ['saraswati', 'learning', 'knowledge', 'mercury', 'jupiter'] },
  { title: 'Pitra Dosha', titleHi: 'पितृ दोष', href: '/learn/yoga/pitra_dosha', category: 'Yogas', keywords: ['pitra', 'pitru', 'ancestor', 'sun', 'rahu'] },
  { title: 'Shrapit Dosha', titleHi: 'शापित दोष', href: '/learn/yoga/shrapit_dosha', category: 'Yogas', keywords: ['shrapit', 'cursed', 'saturn', 'rahu'] },
  { title: 'Sunapha Yoga', titleHi: 'सुनफा योग', href: '/learn/yoga/sunapha', category: 'Yogas', keywords: ['sunapha', 'moon', 'second house'] },
  { title: 'Anapha Yoga', titleHi: 'अनफा योग', href: '/learn/yoga/anapha', category: 'Yogas', keywords: ['anapha', 'moon', 'twelfth house'] },
  { title: 'Durdhara Yoga', titleHi: 'दुर्धरा योग', href: '/learn/yoga/durdhara', category: 'Yogas', keywords: ['durdhara', 'moon', 'flanked'] },
  { title: 'Raja Yoga', titleHi: 'राज योग', href: '/learn/yoga/raja_yoga', category: 'Yogas', keywords: ['raja', 'king', 'kendra', 'trikona', 'power'] },
  { title: 'Dhana Yoga', titleHi: 'धन योग', href: '/learn/yoga/dhana_yoga', category: 'Yogas', keywords: ['dhana', 'wealth', 'money', 'prosperity'] },
  { title: 'Lakshmi Yoga', titleHi: 'लक्ष्मी योग', href: '/learn/yoga/lakshmi', category: 'Yogas', keywords: ['lakshmi', 'wealth', 'venus', 'fortune'] },
  { title: 'Mahabhagya Yoga', titleHi: 'महाभाग्य योग', href: '/learn/yoga/mahabhagya', category: 'Yogas', keywords: ['mahabhagya', 'great fortune', 'lagna', 'sun', 'moon'] },
  { title: 'Vasumati Yoga', titleHi: 'वसुमती योग', href: '/learn/yoga/vasumati', category: 'Yogas', keywords: ['vasumati', 'wealth', 'upachaya'] },
  { title: 'Shakata Yoga', titleHi: 'शकट योग', href: '/learn/yoga/shakata', category: 'Yogas', keywords: ['shakata', 'moon', 'jupiter', 'sixth eighth'] },
  { title: 'Amala Yoga', titleHi: 'अमल योग', href: '/learn/yoga/amala', category: 'Yogas', keywords: ['amala', 'benefic', 'tenth', 'fame'] },
  { title: 'Grahan Yoga', titleHi: 'ग्रहण योग', href: '/learn/yoga/grahan', category: 'Yogas', keywords: ['grahan', 'eclipse', 'rahu', 'ketu', 'conjunction'] },
  { title: 'Kendradhipati Dosha', titleHi: 'केन्द्राधिपति दोष', href: '/learn/yoga/kendradhipati_dosha', category: 'Yogas', keywords: ['kendradhipati', 'kendra', 'benefic', 'dosha'] },
  ...
  if (!mounted || !open) {
    return (
      <button
        ...
        className="flex items-center gap-2 px-3 py-1.5 text-xs text-text-secondary/75 border border-gold-primary/10 rounded-lg hover:border-gold-primary/25 hover:text-text-secondary transition-all"
        aria-label="Search"
      >
        ...
        <div className="bg-bg-primary/95 backdrop-blur-xl border border-gold-primary/20 rounded-2xl shadow-2xl shadow-black/50 overflow-hidden">
          ...
          <div className="flex items-center gap-3 px-5 py-4 border-b border-gold-primary/10">
            ...
            <input
              ...
              autoComplete="off"
            />
            <button onClick={() => setOpen(false)} className="text-text-secondary/65 hover:text-text-secondary transition-colors">
              <X className="w-4 h-4" />
            </button>
          </div>
          ...
          {/* Footer */}
          <div className="px-5 py-2.5 border-t border-gold-primary/10 flex items-center justify-between text-xs text-text-secondary/55">
