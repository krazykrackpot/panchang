...
const LABELS = {
  ...
  disclaimer: L(
    'This comparison is based on publicly available features as of June 2026. We respect GaneshaSpeaks as a long-running platform that has popularised Vedic astrology for millions. This page highlights structural differences  –  the two products serve different needs, and the right tool depends on what you want.',
    'यह तुलना जून 2026 तक सार्वजनिक रूप से उपलब्ध सुविधाओं पर आधारित है। हम गणेशास्पीक्स को एक स्थापित मंच के रूप में सम्मान करते हैं। दोनों उत्पाद अलग आवश्यकताओं की सेवा करते हैं।',
  ),
...
const ROWS: CompRow[] = [
  ...
  },
  {
    ...
    competitor: 'Calendar service follows the conventional NM-anchored boundary convention.',
    dekhoYes: true, competitorYes: false, highlight: true,
  },
  {
    ...
    competitor: 'Region not a first-class navigation; no calendar-comparison hub.',
    dekhoYes: true, competitorYes: false, highlight: true,
  },
  {
    ...
    competitor: 'Career horoscope articles; no automated muhurta-window scorer.',
    dekhoYes: true, competitorYes: false, highlight: true,
  },
  {
    ...
    competitor: 'Health-themed horoscope articles; no automated multi-axis diagnosis engine.',
    dekhoYes: true, competitorYes: false, highlight: true,
  },
  {
