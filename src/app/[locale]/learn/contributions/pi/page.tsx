...
const TIMELINE = [
  { year: '~800 BCE', who: { en: 'Baudhayana (India)', hi: 'बौधायन (भारत)', sa: 'बौधायन (भारत)', mai: 'बौधायन (भारत)', mr: 'बौधायन (भारत)', ta: 'பௌதாயனர் (இந்தியா)', te: 'బౌధాయన (భారతదేశం)', bn: 'বৌধায়ন (ভারত)', kn: 'ಬೌಧಾಯನ (ಭಾರತ)', gu: 'બૌધાયન (ભારત)' }, value: '≈ 3.088', decimals: 1, color: 'bg-amber-700/50' },
  { year: '~250 BCE', who: { en: 'Archimedes (Greece)', hi: 'आर्किमिडीज (ग्रीस)', sa: 'आर्किमिडीज (ग्रीस)', mai: 'आर्किमिडीज (ग्रीस)', mr: 'आर्किमिडीज (ग्रीस)', ta: 'ஆர்க்கிமிடிஸ் (கிரேக்கம்)', te: 'ఆర్కిమెడిస్ (గ్రీస్)', bn: 'আর্কিমিডিস (গ্রিস)', kn: 'ಆರ್ಕಿಮಿಡಿಸ್ (ಗ್ರೀಸ್)', gu: 'આર્કિમિડીઝ (ગ્રીસ)' }, value: '3.14163', decimals: 2, color: 'bg-blue-700/50' },
  { year: '263 CE', who: { en: 'Liu Hui (China)', hi: 'लियू हुई (चीन)', sa: 'लियू हुई (चीन)', mai: 'लियू हुई (चीन)', mr: 'लियू हुई (चीन)', ta: 'லியு ஹுய் (சீனா)', te: 'లియు హుయ్ (చైనా)', bn: 'লিউ হুই (চীন)', kn: 'ಲಿಯು ಹುಯ್ (ಚೀನಾ)', gu: 'લિઉ હુઈ (ચીન)' }, value: '3.14159', decimals: 3, color: 'bg-red-700/50' },
  { year: '499 CE', who: { en: 'Aryabhata (India)', hi: 'आर्यभट (भारत)', sa: 'आर्यभट (भारत)', mai: 'आर्यभट (भारत)', mr: 'आर्यभट (भारत)', ta: 'ஆர்யபட்டர் (இந்தியா)', te: 'ఆర్యభట (భారతదేశం)', bn: 'আর্যভট (ভারত)', kn: 'ಆರ್ಯಭಟ (ಭಾರತ)', gu: 'આર્યભટ્ટ (ભારત)' }, value: '3.14160', decimals: 4, color: 'bg-gold-primary/50', highlight: true },
  { year: '~1350 CE', who: { en: 'Madhava (India)', hi: 'माधव (भारत)', sa: 'माधव (भारत)', mai: 'माधव (भारत)', mr: 'माधव (भारत)', ta: 'மாதவர் (இந்தியா)', te: 'మాధవ (భారతదేశం)', bn: 'মাধব (ভারত)', kn: 'ಮಾಧವ (ಭಾರತ)', gu: 'માધવ (ભારત)' }, value: '3.14159265358...', decimals: 11, color: 'bg-emerald-700/50', highlight: true },
  { year: '1424 CE', who: { en: 'Al-Kashi (Persia)', hi: 'अल-काशी (फ़ारस)', sa: 'अल-काशी (फ़ारस)', mai: 'अल-काशी (फ़ारस)', mr: 'अल-काशी (फ़ारस)', ta: 'அல்-காஷி (பாரசீகம்)', te: 'అల్-కాషి (పర్షియా)', bn: 'আল-কাশি (পারস্য)', kn: 'ಅಲ್-ಕಾಶಿ (ಪರ್ಷಿಯಾ)', gu: 'અલ-કાશી (પર્શિયા)' }, value: '3.14159265358979...', decimals: 16, color: 'bg-violet-700/50' },
  { year: '1761 CE', who: { en: 'Lambert (Europe)', hi: 'लैम्बर्ट (यूरोप)', sa: 'लैम्बर्ट (यूरोप)', mai: 'लैम्बर्ट (यूरोप)', mr: 'लैम्बर्ट (यूरोप)', ta: 'லாம்பர்ட் (ஐரோப்பா)', te: 'లాంబర్ట్ (యూరప్)', bn: 'ল্যাম্বার্ট (ইউরোপ)', kn: 'ಲ್ಯಾಂಬರ್ಟ್ (ಯೂರೋಪ್)', gu: 'લેમ્બર્ટ (યુરોપ)' }, value: 'Proved irrational', decimals: 0, color: 'bg-slate-600/50' },
];
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 pb-20 space-y-2">
        ...
        <LessonSection number={2} title={t('s2Title')}>
          ...
          <div className="mt-6 space-y-3">
            {[
              { step: { en: '100 + 4 = 104', hi: '100 + 4 = 104', sa: '100 + 4 = 104', mai: '100 + 4 = 104', mr: '100 + 4 = 104', ta: '100 + 4 = 104', te: '100 + 4 = 104', bn: '100 + 4 = 104', kn: '100 + 4 = 104', gu: '100 + 4 = 104' }, note: { en: '"Add 4 to 100"', hi: '"100 में 4 जोड़ें"', sa: '"100 में 4 जोड़ें"', mai: '"100 में 4 जोड़ें"', mr: '"100 में 4 जोड़ें"', ta: '"100-க்கு 4 கூட்டுக"', te: '"100కి 4 కలపండి"', bn: '"100-তে 4 যোগ করুন"', kn: '"100ಕ್ಕೆ 4 ಸೇರಿಸಿ"', gu: '"100માં 4 ઉમેરો"' } },
              { step: { en: '104 × 8 = 832', hi: '104 × 8 = 832', sa: '104 × 8 = 832', mai: '104 × 8 = 832', mr: '104 × 8 = 832', ta: '104 × 8 = 832', te: '104 × 8 = 832', bn: '104 × 8 = 832', kn: '104 × 8 = 832', gu: '104 × 8 = 832' }, note: { en: '"Multiply by 8"', hi: '"8 से गुणा करें"', sa: '"8 से गुणा करें"', mai: '"8 से गुणा करें"', mr: '"8 से गुणा करें"', ta: '"8-ஆல் பெருக்குக"', te: '"8తో గుణించండి"', bn: '"8 দিয়ে গুণ করুন"', kn: '"8ರಿಂದ ಗುಣಿಸಿ"', gu: '"8 વડે ગુણાકાર કરો"' } },
              { step: { en: '832 + 62,000 = 62,832', hi: '832 + 62,000 = 62,832', sa: '832 + 62,000 = 62,832', mai: '832 + 62,000 = 62,832', mr: '832 + 62,000 = 62,832', ta: '832 + 62,000 = 62,832', te: '832 + 62,000 = 62,832', bn: '832 + 62,000 = 62,832', kn: '832 + 62,000 = 62,832', gu: '832 + 62,000 = 62,832' }, note: { en: '"Add 62,000" = circumference for diameter 20,000', hi: '"62,000 जोड़ें" = 20,000 व्यास के लिए परिधि', sa: '"62,000 जोड़ें" = 20,000 व्यास के लिए परिधि', mai: '"62,000 जोड़ें" = 20,000 व्यास के लिए परिधि', mr: '"62,000 जोड़ें" = 20,000 व्यास के लिए परिधि', ta: '"62,000 கூட்டுக" = 20,000 விட்டத்திற்கான சுற்றளவு', te: '"62,000 కలపండి" = 20,000 వ్యాసానికి చుట్టుకొలత', bn: '"62,000 যোগ করুন" = 20,000 ব্যাসের জন্য পরিধি', kn: '"62,000 ಸೇರಿಸಿ" = 20,000 ವ್ಯಾಸಕ್ಕೆ ಸುತ್ತಳತೆ', gu: '"62,000 ઉમેરો" = 20,000 વ્યાસ માટે પરિઘ' } },
              { step: { en: '62,832 ÷ 20,000 = 3.1416', hi: '62,832 ÷ 20,000 = 3.1416', sa: '62,832 ÷ 20,000 = 3.1416', mai: '62,832 ÷ 20,000 = 3.1416', mr: '62,832 ÷ 20,000 = 3.1416', ta: '62,832 ÷ 20,000 = 3.1416', te: '62,832 ÷ 20,000 = 3.1416', bn: '62,832 ÷ 20,000 = 3.1416', kn: '62,832 ÷ 20,000 = 3.1416', gu: '62,832 ÷ 20,000 = 3.1416' }, note: { en: 'Circumference ÷ Diameter = π', hi: 'परिधि ÷ व्यास = π', sa: 'परिधि ÷ व्यास = π', mai: 'परिधि ÷ व्यास = π', mr: 'परिधि ÷ व्यास = π', ta: 'சுற்றளவு ÷ விட்டம் = π', te: 'చుట్టుకొలత ÷ వ్యాసం = π', bn: 'পরিধি ÷ ব্যাস = π', kn: 'ಸುತ್ತಳತೆ ÷ ವ್ಯಾಸ = π', gu: 'પરિઘ ÷ વ્યાસ = π' }, highlight: true },
            ].map((row, i) => (
              <div
                key={i}
