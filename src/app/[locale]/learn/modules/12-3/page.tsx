    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Jupiter Transit / गुरु गोचर
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          Jupiter (Guru/Brihaspati) is the greatest natural benefic in Vedic astrology. Its transit through the zodiac — changing signs approximately every 13 months — is one of the most significant annual astrological events. Jupiter expands whatever it touches: wealth, knowledge, spirituality, relationships, or children. Its sign change often correlates with a visible shift in the dominant theme of your life.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">Transit Results from Moon / चन्द्र से गोचर फल</h4>
      ...
      <section className="glass-card rounded-xl p-5 border border-purple-500/15">
        <h4 className="text-purple-300 text-[10px] uppercase tracking-widest font-bold mb-3">Jupiter&apos;s Special Aspects / गुरु की विशेष दृष्टि</h4>
        <p className="text-text-secondary text-xs leading-relaxed">
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Rahu-Ketu Transit / राहु-केतु गोचर
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          Rahu (North Node) and Ketu (South Node) are the shadow planets — mathematical points where the Moon&apos;s orbital plane intersects the ecliptic. They always transit in retrograde motion (backward through the zodiac), spending approximately 18 months in each sign and completing a full cycle in about 18 years. Their transits are uniquely karmic — they stir desires (Rahu) and trigger release (Ketu) in the houses they affect.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          राहु (उत्तर पात) और केतु (दक्षिण पात) छाया ग्रह हैं — गणितीय बिन्दु जहाँ चन्द्रमा का कक्षा तल क्रान्तिवृत्त को काटता है। ये सदैव वक्री गति (राशिचक्र में पीछे की ओर) से गोचर करते हैं, प्रत्येक राशि में लगभग 18 मास रहते हैं और पूर्ण चक्र लगभग 18 वर्षों में पूरा करते हैं। इनका गोचर अद्वितीय रूप से कार्मिक है — ये प्रभावित भावों में इच्छाएँ (राहु) और विमोचन (केतु) जगाते हैं।
        </p>
      </section>

      <section className="glass-card rounded-xl p-5 border border-gold-primary/10">
        <h4 className="text-gold-dark text-[10px] uppercase tracking-widest font-bold mb-3">Rahu Transit Results / राहु गोचर फल</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-emerald-400 font-medium">Favorable (1, 3, 6, 10, 11 from Moon):</span> Rahu in the 1st gives personal magnetism and ambition. In the 3rd, it brings courage, adventure, and success in media/communication. In the 6th, it gives victory over enemies and disease. In the 10th, career rise and public recognition. In the 11th, large financial gains and powerful connections.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-emerald-400 font-medium">शुभ (चन्द्र से 1, 3, 6, 10, 11):</span> 1ले में राहु व्यक्तिगत आकर्षण और महत्वाकांक्षा देता है। 3वें में साहस, रोमांच और मीडिया/संचार में सफलता। 6वें में शत्रुओं और रोग पर विजय। 10वें में करियर उन्नति और सार्वजनिक मान्यता। 11वें में बड़ा आर्थिक लाभ और प्रभावशाली सम्पर्क।
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
      ...
      <section className="glass-card rounded-xl p-5 border border-red-500/15">
        <h4 className="text-red-400 text-[10px] uppercase tracking-widest font-bold mb-3">Karmic Activation / कार्मिक सक्रियता</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Nodal Return (~18 years):</span> When transiting Rahu returns to its natal position (and Ketu to its natal position), a major karmic cycle completes. This happens around ages 18-19, 36-37, 54-55, and 72-73. These are pivotal years when life direction shifts dramatically — the universe recalibrates your karmic trajectory.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">नोडल वापसी (~18 वर्ष):</span> जब गोचरी राहु अपनी जन्मकालिक स्थिति पर लौटता है (और केतु अपनी पर), एक प्रमुख कार्मिक चक्र पूर्ण होता है। यह लगभग 18-19, 36-37, 54-55 और 72-73 वर्ष की आयु में होता है। ये निर्णायक वर्ष हैं जब जीवन दिशा नाटकीय रूप से बदलती है।
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Double Transit Theory / दोहरा गोचर सिद्धान्त
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          The Double Transit (Dwigraha Gochar) theory is one of the most reliable timing techniques in Vedic astrology. It states that for any house&apos;s significations to manifest in real life, BOTH Jupiter AND Saturn must simultaneously influence (by aspect or occupation) that house — whether counted from the Moon sign or from the Lagna. This theory elegantly combines the two slowest visible planets whose combined influence represents the consensus of cosmic timing.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          दोहरा गोचर (द्विग्रह गोचर) सिद्धान्त वैदिक ज्योतिष की सर्वाधिक विश्वसनीय समय निर्धारण तकनीकों में से एक है। यह कहता है कि किसी भाव के फल वास्तविक जीवन में प्रकट होने के लिए, गुरु और शनि दोनों को एक साथ उस भाव को प्रभावित (दृष्टि या अधिवास द्वारा) करना चाहिए — चाहे चन्द्र राशि से गिना जाए या लग्न से। यह सिद्धान्त सुन्दर ढंग से दो सबसे धीमे दृश्य ग्रहों को जोड़ता है जिनका संयुक्त प्रभाव ब्रह्माण्डीय समय की सहमति दर्शाता है।
        </p>
      </section>

      <section className="glass-card rounded-xl p-5 border border-gold-primary/10">
        <h4 className="text-gold-dark text-[10px] uppercase tracking-widest font-bold mb-3">How It Works / यह कैसे काम करता है</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
      ...
      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">Worked Example — Marriage Timing / उदाहरण — विवाह समय</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          Consider a native with Moon in Aries (Mesha). For marriage, we need Jupiter and Saturn to both influence the 7th house (Libra/Tula) from Moon. Jupiter in Gemini (Mithuna) aspects Libra with its 5th aspect. Saturn in Aquarius (Kumbha) aspects Libra with its 10th aspect (Saturn&apos;s special Vishesh Drishti). Since both planets simultaneously influence the 7th house, this period opens a marriage window — provided the dasha also supports it.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          एक जातक पर विचार करें जिसका चन्द्रमा मेष में है। विवाह के लिए हमें गुरु और शनि दोनों को 7वें भाव (तुला) को प्रभावित करने की आवश्यकता है। मिथुन में गुरु अपनी 5वीं दृष्टि से तुला को देखता है। कुम्भ में शनि अपनी 10वीं दृष्टि (शनि की विशेष दृष्टि) से तुला को देखता है। चूँकि दोनों ग्रह एक साथ 7वें भाव को प्रभावित करते हैं, यह काल विवाह की सम्भावना खोलता है — बशर्ते दशा भी समर्थन करे।
        </p>
      </section>

      <section className="glass-card rounded-xl p-5 border border-amber-500/15">
        <h4 className="text-amber-400 text-[10px] uppercase tracking-widest font-bold mb-3">Important Caveat / महत्वपूर्ण सावधानी</h4>
        <p className="text-text-secondary text-xs leading-relaxed">
