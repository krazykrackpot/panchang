...
const LABELS = {
  pageTitle:        { en: 'Family Command Center', hi: 'परिवार कमांड सेंटर', ta: 'குடும்பக் கட்டுப்பாட்டு மையம்' },
  members:          { en: 'members', hi: 'सदस्य', ta: 'உறுப்பினர்கள்' },
  needsAttention:   { en: 'needs attention', hi: 'ध्यान चाहिए', ta: 'கவனம் தேவை' },
  needAttention:    { en: 'need attention', hi: 'ध्यान चाहिए', ta: 'கவனம் தேவை' },
  signInPrompt:     { en: 'Sign in to access your family dashboard', hi: 'अपने परिवार डैशबोर्ड तक पहुँचने के लिए साइन इन करें', ta: 'உங்கள் குடும்ப டாஷ்போர்டை அணுக உள்நுழையவும்' },
  noChartsTitle:    { en: 'No Charts Found', hi: 'कोई कुंडली नहीं मिली', ta: 'சார்ட்டுகள் இல்லை' },
  noChartsDesc:     { en: 'Generate your kundali first to use the Family Command Center.', hi: 'फैमिली कमांड सेंटर का उपयोग करने के लिए पहले अपनी कुंडली बनाएं।', ta: 'குடும்பக் கட்டுப்பாட்டு மையத்தைப் பயன்படுத்த முதலில் உங்கள் குண்டலியை உருவாக்கவும்.' },
  goToKundali:      { en: 'Go to Kundali', hi: 'कुंडली पर जाएं', ta: 'குண்டலிக்கு செல்லவும்' },
  onlyYouTitle:     { en: 'Only Your Chart Found', hi: 'केवल आपकी कुंडली मिली', ta: 'உங்கள் சார்ட் மட்டுமே கிடைத்தது' },
  onlyYouDesc:      { en: 'Add family members by saving their charts on the Kundali page with a relationship tag.', hi: 'कुंडली पृष्ठ पर रिश्ते का टैग लगाकर परिवार के सदस्यों की कुंडली सहेजें।', ta: 'குண்டலி பக்கத்தில் உறவு குறிச்சொல்லுடன் குடும்ப உறுப்பினர்களின் சார்ட்டுகளைச் சேமிக்கவும்.' },
  loading:          { en: 'Computing family status...', hi: 'परिवार स्थिति की गणना हो रही है...', ta: 'குடும்ப நிலையைக் கணக்கிடுகிறது...' },
  statusCards:      { en: 'Member Status', hi: 'सदस्य स्थिति', ta: 'உறுப்பினர் நிலை' },
  collectiveTitle:  { en: 'Collective Muhurta Finder', hi: 'सामूहिक मुहूर्त खोजें', ta: 'கூட்டு முஹூர்த்தம் கண்டுபிடிப்பான்' },
  activity:         { en: 'Activity', hi: 'गतिविधि', ta: 'செயல்பாடு' },
  month:            { en: 'Month', hi: 'माह', ta: 'மாதம்' },
  findBestTime:     { en: 'Find Best Time for Everyone', hi: 'सबके लिए सर्वोत्तम समय खोजें', ta: 'அனைவருக்கும் சிறந்த நேரத்தைக் கண்டறியவும்' },
  scanning:         { en: 'Scanning...', hi: 'खोज रहे हैं...', ta: 'ஸ்கேன் செய்கிறது...' },
  bestWindows:      { en: 'Best collective windows', hi: 'सर्वोत्तम सामूहिक समय', ta: 'சிறந்த கூட்டு நேரங்கள்' },
  score:            { en: 'Score', hi: 'अंक', ta: 'மதிப்பெண்' },
  noWindows:        { en: 'No suitable collective windows found for this period.', hi: 'इस अवधि के लिए कोई उपयुक्त सामूहिक समय नहीं मिला।', ta: 'இந்த காலத்திற்கு பொருத்தமான கூட்டு நேரங்கள் காணப்படவில்லை.' },
  critical:         { en: 'CRITICAL', hi: 'गंभीर', ta: 'முக்கியம்' },
  watch:            { en: 'WATCH', hi: 'ध्यान दें', ta: 'கவனம்' },
  stable:           { en: 'STABLE', hi: 'स्थिर', ta: 'நிலையானது' },
  favorable:        { en: 'FAVORABLE', hi: 'अनुकूल', ta: 'சாதகமான' },
  dashaLabel:       { en: 'Dasha', hi: 'दशा', ta: 'தசை' },
  antarEnds:        { en: 'Antar ends', hi: 'अंतर्दशा समाप्ति', ta: 'அந்தர தசை முடிவு' },
  dashaTransition:  { en: 'Dasha transition approaching', hi: 'दशा परिवर्तन निकट', ta: 'தசை மாற்றம் நெருங்குகிறது' },
  sadeSatiLabel:    { en: 'Sade Sati', hi: 'साढ़े साती', ta: 'சாடே சாதி' },
  rising:           { en: 'Rising', hi: 'आरोही', ta: 'உயர்வு' },
  peak:             { en: 'Peak', hi: 'चरम', ta: 'உச்சம்' },
  setting:          { en: 'Setting', hi: 'अवरोही', ta: 'இறக்கம்' },
  familyDynamics:   { en: 'Family Dynamics', hi: 'पारिवारिक गतिशीलता', ta: 'குடும்ப இயக்கவியல்' },
  self:             { en: 'Self', hi: 'स्वयं', ta: 'நான்' },
  spouse:           { en: 'Spouse', hi: 'जीवनसाथी', ta: 'வாழ்க்கைத் துணை' },
  child:            { en: 'Child', hi: 'संतान', ta: 'குழந்தை' },
  parent:           { en: 'Parent', hi: 'माता-पिता', ta: 'பெற்றோர்' },
  sibling:          { en: 'Sibling', hi: 'भाई-बहन', ta: 'உடன்பிறப்பு' },
  friend:           { en: 'Friend', hi: 'मित्र', ta: 'நண்பர்' },
  other:            { en: 'Other', hi: 'अन्य', ta: 'மற்றவை' },
  error:            { en: 'Something went wrong. Please try again.', hi: 'कुछ गलत हो गया। कृपया पुनः प्रयास करें।', ta: 'ஏதோ தவறு நடந்துவிட்டது. மீண்டும் முயற்சிக்கவும்.' },
};
