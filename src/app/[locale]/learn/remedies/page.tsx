        ...
        {rows.map((row, i) => (
          <div key={i} className={`flex items-start gap-3 rounded-lg p-2.5 ${
            ...
            <div className="min-w-0">
              <span className="text-[10px] uppercase tracking-wider text-text-secondary/60 block" style={bodyFont}>{row.label}</span>
  ...
  return (
    <div className="space-y-10">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
        className="glass-card rounded-2xl p-6 border border-gold-primary/10">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
        className="glass-card rounded-2xl p-6 border border-gold-primary/15">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          {RELATED_LINKS.map((link, i) => (
            <Link key={i} href={link.href}
              className="glass-card rounded-xl p-4 border border-gold-primary/10 hover:border-gold-primary/30 transition-colors flex items-center justify-between group">
