      ...
      <section>
        ...
        <div className="space-y-3">
          ...
          <div className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-lg p-3">
            ...
            <p className="text-text-secondary text-xs mt-1">{isHi ? <>हमारा पंचांग इंजन प्रत्येक ल्यूनेशन की नोडल अक्ष से जाँच स्विस एफेमेरिस (उप-आर्क-सेकंड ग्रह स्थितियाँ; मीयस दस्तावेज़ीकृत फ़ॉलबैक) से करता है। प्रत्येक आगामी अमावस्या और पूर्णिमा के लिए, हम सूर्य-राहु दूरी गणना करते हैं और सम्भावित ग्रहणों को चिह्नित करते हैं। ग्रहण प्रकार (सूर्य के लिए पूर्ण/वलयाकार/आंशिक; चन्द्र के लिए पूर्ण/आंशिक/उपच्छायात्मक) चन्द्रमा के दृश्य व्यास और कोणीय पृथक्करण के आधार पर गणना करते हैं।</> : <>Our Panchang engine checks every lunation against the nodal axis using Swiss Ephemeris positions (sub-arcsecond; Meeus is the documented fallback). For each upcoming New and Full Moon, we compute the Sun-Rahu distance and flag potential eclipses. We also compute the eclipse type (total/annular/partial for solar; total/partial/penumbral for lunar) based on the Moon&apos;s apparent diameter and angular separation.</>}</p>
          </div>
        </div>
      </section>
