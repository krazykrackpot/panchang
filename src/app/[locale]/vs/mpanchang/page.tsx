...
const LABELS = {
  ...
  disclaimer: L(
    'This comparison is based on publicly available features as of May 2026. We respect mPanchang as a well-designed mobile panchang application. This page highlights differences to help users choose the right tool for their needs.',
    'यह तुलना मई 2026 तक सार्वजनिक रूप से उपलब्ध सुविधाओं पर आधारित है। हम एमपंचांग को एक अच्छी तरह डिज़ाइन किए गए मोबाइल पंचांग ऐप के रूप में सम्मान करते हैं।',
  ),
