...
export function AvasthasInterpretation({ avasthas, planets: _planets, locale }: AvasthasInterpretationProps) {
  ...
  const HOW_TO_ACTIVATE: Record<string, string> = {
    sushupta: 'ஆழ்ந்த தூக்கத்திலிருந்து செயல்படுத்துங்கள்: (1) இந்த கிரகத்திற்கான தினசரி மந்திரம் — even 7–10 minutes creates a "wake signal" over weeks. (2) Entering this planet\'s own Mahadasha or Antardasha naturally stirs it. (3) Neecha Bhanga rules — if debilitation is cancelled, Sushupti lifts substantially. (4) Jupiter transiting this planet\'s natal degree (conjunction or trine) gives a 1–2 month temporary awakening. (5) The right gemstone worn consistently acts as a long-duration activation.',
    ...
    mrita: 'தடுக்கப்பட்ட மிருத கிரகத்திற்கு: (1) பரிகாரங்கள் மிக முக்கியம் — Mantra japa, gemstone, fasting on this planet\'s day, donating its associated items. (2) During its Mahadasha: life will push you to confront this domain — cooperate actively. (3) Neecha Bhanga check: if the debilitation lord is angular or the dispositor is exalted, the block is partially lifted even if fixed in the chart. (4) The Mrita state is natally fixed, but dashas and supportive transits can substantially revive it.',
...
const AK_THEMES: Record<string, AKTheme> = {
  ...
  Mars: {
    desire: { en: 'Your soul seeks courage — the ability to act righteously in the face of opposition, protect the innocent, and conquer internal and external enemies. The Martian soul came here to fight its most important war.', hi: 'आपकी आत्मा साहस चाहती है — विरोध के सामने धर्मपूर्वक कार्य करने और निर्दोषों की रक्षा करने की क्षमता।', sa: 'भवतः आत्मा शौर्यम् इच्छति — विरोधे धर्मेण कर्तुं निर्दोषाणां रक्षितुं च सामर्थ्यम्।', mai: 'अहाँक आत्मा साहस चाहैत अछि — विरोधक सामने धर्मपूर्वक कार्य करबाक आ निर्दोषक रक्षा करबाक क्षमता।', mr: 'तुमचा आत्मा धाडस शोधतो — विरोधासमोर धर्माने कृती करण्याची आणि निरपराध्यांचे रक्षण करण्याची क्षमता।', ta: 'உங்கள் ஆன்மா தைரியத்தைத் தேடுகிறது — எதிர்ப்பின் முன் நீதியாக செயல்படும் திறன், நிரபராதிகளைப் பாதுகாத்தல், உள் மற்றும் வெளி எதிரிகளை வெல்லுதல்.', te: 'మీ ఆత్మ ధైర్యాన్ని కోరుతుంది — వ్యతిరేకత ముందు ధర్మబద్ధంగా చర్య తీసుకునే సామర్థ్యం, అమాయకులను రక్షించడం, అంతర్గత బాహ్య శత్రువులను జయించడం.', bn: 'আপনার আত্মা সাহস খোঁজে — বিরোধিতার মুখে ধার্মিকভাবে কাজ করার ক্ষমতা, নিরপরাধদের রক্ষা করা, অভ্যন্তরীণ ও বাহ্যিক শত্রু জয় করা।', kn: 'ನಿಮ್ಮ ಆತ್ಮ ಧೈರ್ಯ ಬಯಸುತ್ತದೆ — ವಿರೋಧದ ಎದುರು ಧಾರ್ಮಿಕವಾಗಿ ಕ್ರಿಯೆ ಮಾಡುವ ಸಾಮರ್ಥ್ಯ, ನಿರಪರಾಧಿಗಳನ್ನು ರಕ್ಷಿಸುವುದು, ಆಂತರಿಕ ಮತ್ತು ಬಾಹ್ಯ ಶತ್ರುಗಳನ್ನು ಜಯಿಸುವುದು.', gu: 'તમારી આત્મા સાહસ શોધે — વિરોધ સામે ધાર્મિક રીતે કાર્ય કરવાની ક્ષમતા, નિર્દોષોનું રક્ષણ, આંતરિક અને બાહ્ય શત્રુઓ પર વિજય.' },
    lessons: { en: 'Channel aggression into disciplined, dharmic action. The soul left battles unfinished in past lives — either avoiding conflict when it should have fought, or fighting the wrong wars for wrong reasons. This life demands you learn the difference.', hi: 'आक्रमण को अनुशासित धार्मिक कार्य में बदलें। सही और गलत लड़ाई के बीच अन्तर सीखना आवश्यक है।', sa: 'आक्रामकतां अनुशासिते धार्मिककर्मणि परिवर्तयन्तु। सम्यक् असम्यक् युद्धयोः अन्तरं ज्ञातव्यम्।', mai: 'आक्रमण केँ अनुशासित धार्मिक कार्य मे बदलू। सही आ गलत लड़ाइक बीच अन्तर सीखब आवश्यक अछि।', mr: 'आक्रमकता अनुशासित, धार्मिक कृतीत रूपांतरित करा। योग्य आणि अयोग्य लढाईतील फरक शिकणे आवश्यक आहे।', ta: 'ஆக்ரோஷத்தை ஒழுக்கமான, தர்ம செயலாக மாற்றுங்கள். ஆன்மா முற்பிறவிகளில் போர்களை முடிக்காமல் விட்டது — போராட வேண்டிய போது மோதலைத் தவிர்த்தது, அல்லது தவறான காரணங்களுக்காக தவறான போர்களை நடத்தியது.', te: 'దూకుడును క్రమశిక్షణాబద్ధమైన, ధార్మిక చర్యలోకి మళ్లించండి. గత జన్మలలో ఆత్మ యుద్ధాలను అసంపూర్ణంగా వదిలింది — పోరాడాల్సినప్పుడు సంఘర్షణను నివారించింది, లేదా తప్పుడు కారణాల కోసం తప్పుడు యుద్ధాలు చేసింది.', bn: 'আগ্রাসনকে শৃঙ্খলাবদ্ধ, ধর্মীয় কর্মে রূপান্তরিত করুন। পূর্বজন্মে আত্মা যুদ্ধ অসমাপ্ত রেখেছিল — যুদ্ধ করা উচিত ছিল তখন দ্বন্দ্ব এড়িয়েছিল, বা ভুল কারণে ভুল যুদ্ধ করেছিল।', kn: 'ಆಕ್ರಮಣಶೀಲತೆಯನ್ನು ಶಿಸ್ತುಬದ್ಧ, ಧಾರ್ಮಿಕ ಕ್ರಿಯೆಯಾಗಿ ಮಾರ್ಪಡಿಸಿ. ಹಿಂದಿನ ಜನ್ಮಗಳಲ್ಲಿ ಆತ್ಮ ಯುದ್ಧಗಳನ್ನು ಅಪೂರ್ಣವಾಗಿ ಬಿಟ್ಟಿತು.', gu: 'આક્રમકતાને શિસ્તબદ્ધ, ધાર્મિક ક્રિયામાં ફેરવો. ગત જન્મોમાં આત્માએ યુદ્ધ અધૂરા છોડ્યા — લડવું જોઈતું ત્યારે સંઘર્ષ ટાળ્યો, કે ખોટા કારણોસર ખોટા યુદ્ધ લડ્યા.' },
    ...
    karma: { en: 'A warrior soul returning to learn when to draw the sword and when to sheathe it. The karma involves protection and service — guarding, building, or healing. Courage must become compassion.', hi: 'एक योद्धा आत्मा जो सीखने आई है कब तलवार उठानी है। साहस को करुणा बनना है।', sa: 'योद्धा आत्मा पुनरागता कदा खड्गं निष्कासयेत् कदा कोषे स्थापयेत् इति शिक्षितुम्। शौर्यं करुणा भवेत्।', mai: 'एक योद्धा आत्मा जे सीखय लेल आएल अछि कहिया तलवार उठाबय। साहस केँ करुणा बनबाक अछि।', mr: 'तलवार कधी काढायची आणि कधी म्यानात ठेवायची हे शिकायला परतलेला योद्धा आत्मा। धाडस करुणा व्हायला हवे।', ta: 'எப்போது வாளை உருவ வேண்டும் எப்போது அடக்க வேண்டும் என்பதைக் கற்றுக்கொள்ள திரும்பும் போர்வீர ஆன்மா. கர்மம் பாதுகாப்பு மற்றும் சேவையை உள்ளடக்கியது. தைரியம் கருணையாக மாற வேண்டும்.', te: 'ఖడ్గం ఎప్పుడు దూయాలి ఎప్పుడు ఒరలో పెట్టాలి అని నేర్చుకోవడానికి తిరిగి వస్తున్న యోధ ఆత్మ. కర్మ రక్షణ మరియు సేవను కలిగి ఉంటుంది. ధైర్యం కరుణగా మారాలి.', bn: 'কখন তলোয়ার তুলতে হবে ও কখন খাপে রাখতে হবে তা শিখতে ফিরে আসা যোদ্ধা আত্মা। কর্ম রক্ষা ও সেবা জড়িত। সাহস করুণায় পরিণত হতে হবে।', kn: 'ಖಡ್ಗ ಯಾವಾಗ ಹಿರಿಯಬೇಕು ಯಾವಾಗ ಒರೆಗೆ ಹಾಕಬೇಕು ಎಂದು ಕಲಿಯಲು ಮರಳುತ್ತಿರುವ ಯೋಧ ಆತ್ಮ. ಕರ್ಮ ರಕ್ಷಣೆ ಮತ್ತು ಸೇವೆ ಒಳಗೊಂಡಿದೆ. ಧೈರ್ಯ ಕರುಣೆಯಾಗಬೇಕು.', gu: 'ક્યારે તલવાર ખેંચવી ક્યારે મ્યાન કરવી તે શીખવા પાછી આવતી યોદ્ધા આત્મા. કર્મ રક્ષણ અને સેવા સાથે સંકળાયેલું. સાહસ કરુણા બનવું જોઈએ.' },
  },
  Mercury: {
    desire: { en: 'Your soul seeks mastery of the mind — the power to understand, communicate, and transmit knowledge in ways that transform others. It longs to find the words that change the world.', hi: 'आपकी आत्मा मन की महारत चाहती है — ज्ञान को इस प्रकार संप्रेषित करने की शक्ति जो दूसरों को बदल दे।', sa: 'भवतः आत्मा मनसः प्रावीण्यम् इच्छति — ज्ञानं तथा संप्रेषयितुं शक्तिः या परान् परिवर्तयेत्।', mai: 'अहाँक आत्मा मनक महारत चाहैत अछि — ज्ञान केँ एहन तरीका सँ संप्रेषित करबाक शक्ति जे दोसर केँ बदलि दिअय।', mr: 'तुमचा आत्मा मनावर प्रभुत्व शोधतो — ज्ञान अशा प्रकारे प्रसारित करण्याची शक्ती जी इतरांना बदलून टाकेल।', ta: 'உங்கள் ஆன்மா மனதின் கட்டுப்பாட்டைத் தேடுகிறது — புரிந்துகொள்ளும், தொடர்புகொள்ளும், மற்றவர்களை மாற்றும் வகையில் அறிவைக் கடத்தும் சக்தி.', te: 'మీ ఆత్మ మనస్సు పై ఆధిపత్యం కోరుతుంది — అర్థం చేసుకునే, సంభాషించే, ఇతరులను మార్చే విధంగా జ్ఞానాన్ని ప్రసారం చేసే శక్తి.', bn: 'আপনার আত্মা মনের উপর দক্ষতা খোঁজে — বোঝার, যোগাযোগ করার এবং অন্যদের রূপান্তরিত করে এমনভাবে জ্ঞান প্রেরণের শক্তি।', kn: 'ನಿಮ್ಮ ಆತ್ಮ ಮನಸ್ಸಿನ ಮೇಲೆ ಪ್ರಾವೀಣ್ಯತೆ ಬಯಸುತ್ತದೆ — ಅರ್ಥಮಾಡಿಕೊಳ್ಳುವ, ಸಂವಹಿಸುವ, ಇತರರನ್ನು ಪರಿವರ್ತಿಸುವ ರೀತಿಯಲ್ಲಿ ಜ್ಞಾನ ಪ್ರಸಾರಿಸುವ ಶಕ್ತಿ.', gu: 'તમારી આત્મા મનની નિપુણતા શોધે — સમજવાની, સંવાદ કરવાની, બીજાને બદલે તેવી રીતે જ્ઞાન પ્રસારિત કરવાની શક્તિ.' },
    lessons: { en: 'Depth over breadth. The Mercury AK soul scatters brilliance across too many pursuits and achieves mastery in none. Go deep — study one subject until it reveals its hidden roots, then teach what you have truly understood, not merely memorized.', hi: 'विस्तार से गहराई श्रेयस्कर है। किसी एक विषय में गहरे जाएं, फिर जो वास्तव में समझा है उसे सिखाएं।', sa: 'विस्तारात् गाम्भीर्यं श्रेयः। एकस्मिन् विषये गभीरं गच्छन्तु, ततः यत् वस्तुतः अवगतं तत् शिक्षयन्तु।', mai: 'विस्तार सँ गहराई नीक अछि। कोनो एक विषय मे गहींर जाउ, तखन जे वास्तव मे बुझल अछि से सिखाउ।', mr: 'विस्तारापेक्षा खोली श्रेयस्कर. एका विषयात खोलवर जा, मग खरोखर जे समजले ते शिकवा।', ta: 'பரப்பை விட ஆழம். புதன் AK ஆன்மா பல முயற்சிகளில் மேதமையை சிதறடித்து எதிலும் தேர்ச்சி பெறாது. ஆழமாகச் செல்லுங்கள் — ஒரு பொருளை அதன் மறைந்த வேர்களை வெளிப்படுத்தும் வரை படியுங்கள்.', te: 'వెడల్పు కంటే లోతు. బుధ AK ఆత్మ చాలా అన్వేషణల్లో ప్రతిభను చెదరగొట్టి ఏదానిలోనూ ప్రావీణ్యం సాధించదు. లోతుకు వెళ్ళండి.', bn: 'বিস্তারের চেয়ে গভীরতা। বুধ AK আত্মা অনেক অনুসন্ধানে উজ্জ্বলতা ছড়িয়ে কোনওটিতে দক্ষতা অর্জন করে না। গভীরে যান।', kn: 'ಅಗಲಕ್ಕಿಂತ ಆಳ. ಬುಧ AK ಆತ್ಮ ಹಲವು ಅನ್ವೇಷಣೆಗಳಲ್ಲಿ ಪ್ರತಿಭೆ ಚದುರಿಸಿ ಯಾವುದರಲ್ಲೂ ಪ್ರಾವೀಣ್ಯತೆ ಸಾಧಿಸುವುದಿಲ್ಲ. ಆಳಕ್ಕೆ ಹೋಗಿ.', gu: 'વિસ્તાર કરતાં ઊંડાઈ. બુધ AK આત્મા ઘણી શોધમાં તેજ વેરવે છે અને કોઈમાં નિપુણતા મેળવતી નથી. ઊંડે જાઓ.' },
    shadow: { en: 'Superficiality, cleverness masquerading as wisdom, intellectual arrogance, and the manipulation of truth through words. The mercurial soul can become a sophist rather than a sage.', hi: 'सतहीपन और शब्दों के माध्यम से सत्य का हेरफेर। बुध आत्मा ज्ञानी नहीं बल्कि वाग्मी बन सकती है।', sa: 'उपरितलता शब्दैः सत्यस्य विकृतिश्च। बुधात्मा ज्ञानी न भवेत्, अपितु वाक्चतुरः।', mai: 'सतहीपन आ शब्दक माध्यम सँ सत्यक हेरफेर। बुध आत्मा ज्ञानी नहि बल्कि वाग्मी बनि सकैत अछि।', mr: 'वरवरपणा आणि शब्दांद्वारे सत्याची हेराफेरी। बुध आत्मा ज्ञानी नव्हे तर वाक्पटू बनू शकतो।', ta: 'மேலோட்டம், ஞானமாக வேடமிடும் புத்திசாலித்தனம், அறிவுசார் அகந்தை, வார்த்தைகளால் உண்மையை திரிவு செய்தல். புதன் ஆன்மா ஞானியாக அல்ல, வாக்குவாதிகளாக மாறலாம்.', te: 'ఉపరితలత, జ్ఞానంగా నటించే చతురత, బౌద్ధిక అహంకారం, మాటల ద్వారా సత్యం యొక్క వక్రీకరణ.', bn: 'উপরিতলতা, প্রজ্ঞার ছদ্মবেশে চতুরতা, বৌদ্ধিক অহংকার, শব্দের মাধ্যমে সত্যের কারসাজি।', kn: 'ಮೇಲ್ಮೈತನ, ಜ್ಞಾನವಾಗಿ ವೇಷ ಹಾಕುವ ಚತುರತೆ, ಬೌದ್ಧಿಕ ಅಹಂಕಾರ, ಮಾತಿನ ಮೂಲಕ ಸತ್ಯದ ಕುಶಲತೆ.', gu: 'ઉપરછલ્લાપણું, જ્ઞાનનો ઢોંગ કરતી ચતુરાઈ, બૌદ્ધિક અહંકાર, શબ્દો દ્વારા સત્યનું વિકૃતિકરણ.' },
    karma: { en: 'A learner across many lifetimes who collected knowledge without integration. This life calls for synthesis — gathering all you have learned into a coherent teaching and sharing it generously. The pen, the voice, or the code is your tool of karma.', hi: 'कई जन्मों में ज्ञान बिना एकीकरण के एकत्र किया। इस जीवन में उसका संश्लेषण और उदारता से साझा करना ही कर्म है।', sa: 'बहुजन्मसु ज्ञानम् एकीकरणं विना सञ्चितम्। अस्मिन् जीवने तस्य संश्लेषणं औदार्येण च विभजनमेव कर्म।', mai: 'कतेक जन्म मे ज्ञान बिना एकीकरणक एकत्र कएल। ई जीवन मे ओकर संश्लेषण आ उदारता सँ साझा करब कर्म अछि।', mr: 'अनेक जन्मांत एकीकरणाशिवाय ज्ञान जमा केले. या जीवनात त्याचे संश्लेषण आणि उदारतेने वाटणे हेच कर्म आहे।', ta: 'பல வாழ்நாட்களில் ஒருங்கிணைப்பின்றி அறிவை சேகரித்த கற்பவர். இந்த வாழ்க்கை ஒருங்கிணைப்பை கோருகிறது — கற்றவற்றை ஒரு ஒத்திசைவான போதனையாக திரட்டி பரவலாக பகிர்ந்துகொள்ளுங்கள்.', te: 'అనేక జన్మల్లో సమీకరణ లేకుండా జ్ఞానం సేకరించిన విద్యార్థి. ఈ జీవితం సంశ్లేషణను కోరుతుంది — మీరు నేర్చుకున్నది అంతా సమన్వయ బోధనగా సేకరించి ఉదారంగా పంచుకోండి.', bn: 'অনেক জন্মে সংহতি ছাড়া জ্ঞান সংগ্রহকারী শিক্ষার্থী। এই জীবন সংশ্লেষণ দাবি করে — আপনি যা শিখেছেন তা একটি সমন্বিত শিক্ষায় একত্রিত করুন এবং উদারভাবে ভাগ করুন।', kn: 'ಅನೇಕ ಜನ್ಮಗಳಲ್ಲಿ ಸಮನ್ವಯವಿಲ್ಲದೆ ಜ್ಞಾನ ಸಂಗ್ರಹಿಸಿದ ಕಲಿಯುವವ. ಈ ಜೀವನ ಸಂಶ್ಲೇಷಣೆಯನ್ನು ಕೋರುತ್ತದೆ — ಕಲಿತದ್ದನ್ನೆಲ್ಲ ಸಮನ್ವಿತ ಬೋಧನೆಯಾಗಿ ಸೇರಿಸಿ ಉದಾರವಾಗಿ ಹಂಚಿಕೊಳ್ಳಿ.', gu: 'ઘણા જન્મોમાં સંકલન વિના જ્ઞાન એકત્ર કરનાર વિદ્યાર્થી. આ જીવન સંશ્લેષણ માગે — શીખેલું બધું એક સુસંગત શિક્ષણમાં ભેગું કરો અને ઉદારતાથી વહેંચો.' },
  },
  Jupiter: {
    ...
    karma: { en: 'This soul was a seeker in past lives who gained wisdom but kept it for themselves, or used it improperly. The karma is to become a true Brahmin in the original sense — one who radiates dharma through their very being. You are meant to be a light that other lights come to rekindle themselves from.', hi: 'पूर्व जन्मों में ज्ञान प्राप्त किया पर अपने पास रखा। कर्म है सच्चा ब्राह्मण बनना — जो अपने अस्तित्व से धर्म विकीर्ण करे।', sa: 'पूर्वजन्मेषु ज्ञानं प्राप्तं किन्तु स्वस्य कृते एव रक्षितम्। कर्म अस्ति सत्यब्राह्मणं भवितुम् — यः स्वसत्तया धर्मं विकिरति।', mai: 'पूर्व जन्म मे ज्ञान प्राप्त कएल मुदा अपना लग रखल। कर्म अछि सच्चा ब्राह्मण बनब — जे अपन अस्तित्व सँ धर्म विकीर्ण करय।', mr: 'मागील जन्मांत ज्ञान मिळवले पण स्वतःकडे ठेवले. कर्म म्हणजे खरा ब्राह्मण होणे — जो आपल्या अस्तित्वातून धर्म प्रसृत करतो।', ta: 'இந்த ஆன்மா முற்பிறவிகளில் ஞானம் பெற்ற ஆனால் தனக்கே வைத்துக்கொண்ட அல்லது தவறாக பயன்படுத்திய தேடுபவர். கர்மம் உண்மையான பிராமணராக மாறுவது — தங்கள் இருப்பின் வழியாக தர்மத்தை பிரகாசிக்கும் ஒருவர்.', te: 'ఈ ఆత్మ గత జన్మలలో జ్ఞానం పొందినా తమ కోసమే ఉంచుకున్న లేదా తప్పుగా ఉపయోగించిన అన్వేషి. కర్మ నిజమైన బ్రాహ్మణుడిగా మారడం — తమ ఉనికి ద్వారా ధర్మాన్ని ప్రసరింపజేసేవారు.', bn: 'এই আত্মা পূর্বজন্মে জ্ঞান অর্জন করেও নিজের কাছে রেখেছিল বা অনুচিতভাবে ব্যবহার করেছিল। কর্ম হল প্রকৃত ব্রাহ্মণ হওয়া — যার সত্তা থেকে ধর্ম বিকিরিত হয়।', kn: 'ಈ ಆತ್ಮ ಹಿಂದಿನ ಜನ್ಮಗಳಲ್ಲಿ ಜ್ಞಾನ ಪಡೆದರೂ ತಮಗಾಗಿ ಇಟ್ಟುಕೊಂಡ ಅಥವಾ ಅನುಚಿತವಾಗಿ ಬಳಸಿದ ಅನ್ವೇಷಕ. ಕರ್ಮ ನಿಜವಾದ ಬ್ರಾಹ್ಮಣನಾಗುವುದು — ತಮ್ಮ ಅಸ್ತಿತ್ವದ ಮೂಲಕ ಧರ್ಮವನ್ನು ಪ್ರಸರಿಸುವವ.', gu: 'આ આત્મા ગત જન્મોમાં જ્ઞાન મેળવ્યું પણ પોતાને માટે રાખ્યું કે અયોગ્ય રીતે વાપર્યું. કર્મ સાચા બ્રાહ્મણ બનવાનું — પોતાના અસ્તિત્વ દ્વારા ધર્મ પ્રસરાવનાર.' },
  },
  Venus: {
    desire: { en: 'Your soul seeks beauty, love, and profound connection — the experience of the divine through aesthetics, relationship, and the senses. It came here to create and to love, not merely to be loved.', hi: 'आपकी आत्मा सौन्दर्य, प्रेम और गहरे सम्बन्ध — सौन्दर्यशास्त्र और इन्द्रियों के माध्यम से दिव्यता का अनुभव — चाहती है।', sa: 'भवतः आत्मा सौन्दर्यं प्रेम गहनसम्बन्धं च इच्छति — सौन्दर्यशास्त्रेण इन्द्रियैः च दिव्यतायाः अनुभवम्।', mai: 'अहाँक आत्मा सौन्दर्य, प्रेम आ गहन सम्बन्ध चाहैत अछि — सौन्दर्यशास्त्र आ इन्द्रिय सँ दिव्यताक अनुभव।', mr: 'तुमचा आत्मा सौंदर्य, प्रेम आणि गहन संबंध शोधतो — सौंदर्यशास्त्र आणि इंद्रियांच्या माध्यमातून दिव्यतेचा अनुभव।', ta: 'உங்கள் ஆன்மா அழகு, காதல் மற்றும் ஆழ்ந்த தொடர்பைத் தேடுகிறது — அழகியல், உறவு மற்றும் புலன்கள் வழியாக தெய்வீக அனுபவம்.', te: 'మీ ఆత్మ అందం, ప్రేమ మరియు లోతైన అనుబంధాన్ని కోరుతుంది — సౌందర్యశాస్త్రం, సంబంధం మరియు ఇంద్రియాల ద్వారా దైవిక అనుభవం.', bn: 'আপনার আত্মা সৌন্দর্য, প্রেম ও গভীর সংযোগ খোঁজে — নান্দনিকতা, সম্পর্ক ও ইন্দ্রিয়ের মাধ্যমে ঐশ্বরিক অভিজ্ঞতা।', kn: 'ನಿಮ್ಮ ಆತ್ಮ ಸೌಂದರ್ಯ, ಪ್ರೀತಿ ಮತ್ತು ಆಳವಾದ ಸಂಪರ್ಕ ಬಯಸುತ್ತದೆ — ಸೌಂದರ್ಯಶಾಸ್ತ್ರ, ಸಂಬಂಧ ಮತ್ತು ಇಂದ್ರಿಯಗಳ ಮೂಲಕ ದೈವಿಕ ಅನುಭವ.', gu: 'તમારી આત્મા સૌંદર્ય, પ્રેમ અને ગહન જોડાણ શોધે — સૌંદર્યશાસ્ત્ર, સંબંધ અને ઇન્દ્રિયો દ્વારા દિવ્ય અનુભવ.' },
    lessons: { en: 'Love without attachment and create without craving recognition. The Venus AK soul must learn that real beauty is discovered, not manufactured, and real love is unconditional, not transactional. The spiritual test is to move from Venusian pleasure to Venusian grace.', hi: 'आसक्ति के बिना प्रेम करें। वास्तविक सौन्दर्य खोजा जाता है, निर्मित नहीं। शुक्र के आनन्द से शुक्र की कृपा की ओर बढ़ें।', sa: 'आसक्तिं विना प्रेम कुर्वन्तु। वास्तविकं सौन्दर्यं लभ्यते, न निर्मीयते। शुक्रस्य आनन्दात् शुक्रस्य कृपां प्रति गच्छन्तु।', mai: 'आसक्ति बिना प्रेम करू। वास्तविक सौन्दर्य खोजल जाइत अछि, निर्मित नहि। शुक्रक आनन्द सँ शुक्रक कृपा दिस बढ़ू।', mr: 'आसक्तीशिवाय प्रेम करा। खरे सौंदर्य शोधले जाते, बनवले नाही. शुक्राच्या सुखापासून शुक्राच्या कृपेकडे जा।', ta: 'பற்றின்றி காதலிக்கவும் அங்கீகாரம் ஏங்காமல் படைக்கவும். சுக்கிர AK ஆன்மா உண்மையான அழகு கண்டுபிடிக்கப்படுவது, தயாரிக்கப்படுவது அல்ல என்று கற்றுக்கொள்ள வேண்டும்.', te: 'అనుబంధం లేకుండా ప్రేమించండి, గుర్తింపు కోసం ఆరాటపడకుండా సృష్టించండి. శుక్ర AK ఆత్మ నిజమైన అందం కనుగొనబడుతుందని, తయారు చేయబడదని నేర్చుకోవాలి.', bn: 'আসক্তি ছাড়া ভালোবাসুন ও স্বীকৃতির লোভ ছাড়া সৃষ্টি করুন। শুক্র AK আত্মাকে শিখতে হবে যে প্রকৃত সৌন্দর্য আবিষ্কৃত হয়, তৈরি হয় না।', kn: 'ಅಂಟಿಕೊಳ್ಳದೆ ಪ್ರೀತಿಸಿ ಮತ್ತು ಮನ್ನಣೆಗಾಗಿ ಹಾತೊರೆಯದೆ ಸೃಷ್ಟಿಸಿ. ಶುಕ್ರ AK ಆತ್ಮ ನಿಜವಾದ ಸೌಂದರ್ಯ ಕಂಡುಹಿಡಿಯಲ್ಪಡುತ್ತದೆ, ತಯಾರಿಸಲ್ಪಡುವುದಿಲ್ಲ ಎಂದು ಕಲಿಯಬೇಕು.', gu: 'આસક્તિ વિના પ્રેમ કરો અને માન્યતાની તૃષ્ણા વિના સર્જન કરો. શુક્ર AK આત્માએ શીખવું જોઈએ કે સાચું સૌંદર્ય શોધાય છે, બનાવાતું નથી.' },
    shadow: { en: 'Vanity, attachment to comfort and luxury, fear of ugliness and pain, codependency, and the use of beauty or charm for manipulation.', hi: 'घमंड, विलासिता से आसक्ति, कुरूपता का भय, सहनिर्भरता और आकर्षण का हेरफेर के लिए उपयोग।', sa: 'दम्भः, विलासितायाम् आसक्तिः, कुरूपतायाः भयम्, सहनिर्भरता, सौन्दर्यस्य मोहस्य वा छलाय उपयोगः।', mai: 'घमंड, विलासिता सँ आसक्ति, कुरूपताक भय, सहनिर्भरता आ आकर्षणक हेरफेर लेल उपयोग।', mr: 'अहंकार, विलासिततेची आसक्ती, कुरूपतेची भीती, सहनिर्भरता आणि सौंदर्य किंवा आकर्षणाचा फसवणुकीसाठी वापर।', ta: 'அகந்தை, வசதி மற்றும் ஆடம்பரத்தில் பற்று, அசிங்கம் மற்றும் வலியின் பயம், இணை சார்பு, அழகு அல்லது கவர்ச்சியை கையாளுதலுக்கு பயன்படுத்துதல்.', te: 'అహంభావం, సౌకర్యం మరియు విలాసంపై అనుబంధం, వికారం మరియు నొప్పి పట్ల భయం, సహ-ఆధారపడటం, మరియు మోహం కోసం అందం లేదా ఆకర్షణ ఉపయోగించడం.', bn: 'অহংকার, আরাম ও বিলাসিতায় আসক্তি, কুৎসিততা ও যন্ত্রণার ভয়, সহনির্ভরশীলতা, এবং কারসাজির জন্য সৌন্দর্য বা মোহ ব্যবহার।', kn: 'ವ್ಯರ್ಥ ಅಭಿಮಾನ, ಸೌಕರ್ಯ ಮತ್ತು ವೈಭವದ ಮೇಲೆ ಅಂಟು, ವಿಕೃತಿ ಮತ್ತು ನೋವಿನ ಭಯ, ಸಹ-ಅವಲಂಬನೆ, ಮತ್ತು ಕುಶಲತೆಗಾಗಿ ಸೌಂದರ್ಯ ಅಥವಾ ಮೋಹ ಬಳಸುವುದು.', gu: 'ઘમંડ, આરામ અને વૈભવમાં આસક્તિ, કુરૂપતા અને પીડાનો ભય, સહનિર્ભરતા, અને છેતરપિંડી માટે સૌંદર્ય કે આકર્ષણનો ઉપયોગ.' },
    karma: { en: 'A soul that has moved through many relationships seeking completion in another. The karma is the recognition that beauty is not found in another person — it is found within. This life calls for the creation of art, beauty, or relationship structures that outlast you.', hi: 'एक आत्मा जो पूर्णता की खोज में कई सम्बन्धों से गुज़री है। कर्म है यह जानना कि सौन्दर्य स्वयं के भीतर है।', sa: 'या आत्मा बहुषु सम्बन्धेषु पूर्णतां अन्यस्मिन् अन्विष्य गता। कर्म अस्ति ज्ञातुं यत् सौन्दर्यं स्वान्तरे एव अस्ति।', mai: 'एक आत्मा जे पूर्णताक खोज मे कतेक सम्बन्ध सँ गुजरल अछि। कर्म अछि ई जानब जे सौन्दर्य अपने भीतर अछि।', mr: 'अनेक नात्यांतून पूर्णता शोधत फिरलेला आत्मा. कर्म म्हणजे हे ओळखणे की सौंदर्य स्वतःच्या आत अाहे।', ta: 'மற்றொருவரில் முழுமையைத் தேடி பல உறவுகளின் வழியாக நகர்ந்த ஆன்மா. கர்மம் அழகு மற்றொரு நபரில் காணப்படுவதில்லை — அது உள்ளேயே காணப்படும் என்ற அங்கீகாரம்.', te: 'మరొకరిలో సంపూర్ణతను వెతుకుతూ అనేక సంబంధాల గుండా సాగిన ఆత్మ. కర్మ అందం మరొక వ్యక్తిలో కనుగొనబడదు — లోపల కనుగొనబడుతుంది అనే గ్రహింపు.', bn: 'অন্যের মধ্যে সম্পূর্ণতা খুঁজে অনেক সম্পর্কের মধ্য দিয়ে চলে আসা আত্মা। কর্ম হল এই উপলব্ধি যে সৌন্দর্য অন্যের মধ্যে নয় — নিজের মধ্যে পাওয়া যায়।', kn: 'ಮತ್ತೊಬ್ಬರಲ್ಲಿ ಪೂರ್ಣತೆ ಹುಡುಕುತ್ತಾ ಅನೇಕ ಸಂಬಂಧಗಳ ಮೂಲಕ ಸಾಗಿದ ಆತ್ಮ. ಕರ್ಮ ಸೌಂದರ್ಯ ಮತ್ತೊಬ್ಬರಲ್ಲಿ ಸಿಗುವುದಿಲ್ಲ — ಒಳಗೆ ಸಿಗುತ್ತದೆ ಎಂಬ ಗ್ರಹಿಕೆ.', gu: 'બીજામાં પૂર્ણતા શોધતા ઘણા સંબંધોમાંથી પસાર થયેલી આત્મા. કર્મ એ ઓળખ છે કે સૌંદર્ય બીજામાં નથી — અંદર છે.' },
  },
  Saturn: {
    desire: { en: 'Your soul seeks justice, lasting achievement, and the fulfillment of karmic debt through disciplined service. The Saturn soul came here to master time — to build things that endure and serve causes greater than the self.', hi: 'आपकी आत्मा न्याय, स्थायी उपलब्धि और अनुशासित सेवा से कार्मिक ऋण की पूर्ति चाहती है।', sa: 'भवतः आत्मा न्यायं स्थायिसिद्धिं अनुशासितसेवया च कार्मिकऋणपूर्तिम् इच्छति।', mai: 'अहाँक आत्मा न्याय, स्थायी उपलब्धि आ अनुशासित सेवा सँ कार्मिक ऋणक पूर्ति चाहैत अछि।', mr: 'तुमचा आत्मा न्याय, टिकाऊ साध्य आणि शिस्तबद्ध सेवेतून कार्मिक ऋण पूर्तता शोधतो।', ta: 'உங்கள் ஆன்மா நீதி, நிலையான சாதனை மற்றும் ஒழுக்கமான சேவையின் மூலம் கர்ம கடனை நிறைவேற்றுவதைத் தேடுகிறது. சனி ஆன்மா காலத்தை கட்டுப்படுத்த வந்தது.', te: 'మీ ఆత్మ న్యాయం, శాశ్వత సాధన మరియు క్రమశిక్షణాబద్ధ సేవ ద్వారా కర్మ ఋణ నెరవేర్పును కోరుతుంది. శని ఆత్మ కాలాన్ని జయించడానికి వచ్చింది.', bn: 'আপনার আত্মা ন্যায়বিচার, স্থায়ী অর্জন এবং শৃঙ্খলাবদ্ধ সেবার মাধ্যমে কর্মঋণ পূরণ খোঁজে। শনি আত্মা সময়কে আয়ত্ত করতে এসেছে।', kn: 'ನಿಮ್ಮ ಆತ್ಮ ನ್ಯಾಯ, ಶಾಶ್ವತ ಸಾಧನೆ ಮತ್ತು ಶಿಸ್ತುಬದ್ಧ ಸೇವೆಯ ಮೂಲಕ ಕರ್ಮ ಋಣ ನೆರವೇರಿಕೆ ಬಯಸುತ್ತದೆ. ಶನಿ ಆತ್ಮ ಕಾಲವನ್ನು ಕರಗತ ಮಾಡಿಕೊಳ್ಳಲು ಬಂದಿದೆ.', gu: 'તમારી આત્મા ન્યાય, ટકાઉ સિદ્ધિ અને શિસ્તબદ્ધ સેવા દ્વારા કર્મઋણ પૂર્તિ શોધે. શનિ આત્મા સમયને જીતવા આવી.' },
    lessons: { en: 'Embrace limitation as a teacher, not an enemy. Discipline is a spiritual practice, suffering can be alchemized into strength, and serving the margins of society — the old, the poor, the forgotten — is a high dharma.', hi: 'सीमा को शत्रु नहीं, गुरु मानें। अनुशासन आध्यात्मिक अभ्यास है। समाज के हाशिये पर सेवा उच्च धर्म है।', sa: 'सीमां शत्रुं न, गुरुं मन्यन्तु। अनुशासनम् आध्यात्मिकसाधना अस्ति। समाजस्य सीमान्ते सेवा उच्चधर्मः।', mai: 'सीमा केँ शत्रु नहि, गुरु मानू। अनुशासन आध्यात्मिक अभ्यास अछि। समाजक हाशिया पर सेवा उच्च धर्म अछि।', mr: 'मर्यादा शत्रू नव्हे, गुरू माना. शिस्त ही आध्यात्मिक साधना आहे. समाजाच्या किनाऱ्यावरील सेवा उच्च धर्म आहे।', ta: 'எல்லையை எதிரியாக அல்ல, ஆசிரியராக ஏற்றுக்கொள்ளுங்கள். ஒழுக்கம் ஒரு ஆன்மிக பயிற்சி, துன்பத்தை வலிமையாக மாற்றலாம், சமூகத்தின் விளிம்புநிலையோர் — வயதானோர், ஏழைகள், மறக்கப்பட்டோர் — சேவை உயர் தர்மம்.', te: 'పరిమితిని శత్రువుగా కాదు, గురువుగా స్వీకరించండి. క్రమశిక్షణ ఒక ఆధ్యాత్మిక సాధన, బాధను బలంగా మార్చవచ్చు, సమాజ అంచుల వారికి సేవ — వృద్ధులు, పేదలు, మరచిపోయిన వారు — ఉన్నత ధర్మం.', bn: 'সীমাবদ্ধতাকে শত্রু নয়, শিক্ষক হিসেবে গ্রহণ করুন। শৃঙ্খলা একটি আধ্যাত্মিক সাধনা, দুঃখকে শক্তিতে রূপান্তর করা যায়, সমাজের প্রান্তিক — বৃদ্ধ, দরিদ্র, বিস্মৃত — সেবা উচ্চ ধর্ম।', kn: 'ಮಿತಿಯನ್ನು ಶತ್ರು ಅಲ್ಲ, ಗುರು ಎಂದು ಸ್ವೀಕರಿಸಿ. ಶಿಸ್ತು ಒಂದು ಅಧ್ಯಾತ್ಮಿಕ ಅಭ್ಯಾಸ, ದುಃಖವನ್ನು ಶಕ್ತಿಯಾಗಿ ಪರಿವರ್ತಿಸಬಹುದು, ಸಮಾಜದ ಅಂಚಿನವರಿಗೆ ಸೇವೆ ಉನ್ನತ ಧರ್ಮ.', gu: 'મર્યાદાને દુશ્મન નહીં, શિક્ષક તરીકે સ્વીકારો. શિસ્ત આધ્યાત્મિક સાધના, દુઃખને શક્તિમાં ફેરવી શકાય, સમાજના હાંસિયા — વૃદ્ધ, ગરીબ, ભૂલાયેલા — ની સેવા ઉચ્ચ ધર્મ.' },
    shadow: { en: 'Pessimism, harsh self-judgment, excessive austerity, bitterness toward life, and the belief that suffering is the only teacher. The Saturn soul risks becoming so disciplined it forgets how to live.', hi: 'निराशावाद, कठोर आत्म-निर्णय और जीवन के प्रति कड़वाहट। शनि आत्मा इतनी अनुशासित हो सकती है कि जीना भूल जाए।', sa: 'निराशावादः, कठोरः आत्मनिर्णयः, जीवनं प्रति तिक्तता च। शनिआत्मा एतावत् अनुशासिता भवेत् यत् जीवितुं विस्मरेत्।', mai: 'निराशावाद, कठोर आत्म-निर्णय आ जीवनक प्रति कड़वाहट। शनि आत्मा एतेक अनुशासित भय सकैत अछि जे जीनाइ बिसरि जाय।', mr: 'निराशावाद, कठोर आत्मनिर्णय आणि जीवनाप्रती कटुता. शनि आत्मा इतकी शिस्तबद्ध होऊ शकतो की जगणे विसरेल।', ta: 'அவநம்பிக்கை, கடுமையான சுய-விமர்சனம், அதிகப்படியான கடுமை, வாழ்க்கையின் மீது கசப்பு, துன்பம் மட்டுமே ஆசிரியர் என்ற நம்பிக்கை.', te: 'నిరాశావాదం, కఠినమైన స్వీయ-తీర్పు, అధిక తపస్సు, జీవితం పట్ల చేదు, బాధ మాత్రమే గురువు అనే నమ్మకం.', bn: 'নৈরাশ্যবাদ, কঠোর আত্ম-বিচার, অতিরিক্ত কঠোরতা, জীবনের প্রতি তিক্ততা, এবং দুঃখই একমাত্র শিক্ষক বিশ্বাস।', kn: 'ನಿರಾಶಾವಾದ, ಕಠಿಣ ಸ್ವಯಂ-ತೀರ್ಪು, ಅತಿಯಾದ ತಪಸ್ಸು, ಜೀವನದ ಕಡೆ ಕಹಿ, ದುಃಖ ಮಾತ್ರ ಗುರು ಎಂಬ ನಂಬಿಕೆ.', gu: 'નિરાશાવાદ, કઠોર આત્મ-ચુકાદો, અતિશય કઠોરતા, જીવન પ્રત્યે કડવાશ, દુઃખ જ એકમાત્ર શિક્ષક હોવાનો વિશ્વાસ.' },
    karma: { en: 'This soul carries heavy karmic loads — debts of neglect, exploitation of workers, or the abuse of authority. The mission is karmic rectification: serve those you once ignored, and build structures of justice that protect others long after you are gone.', hi: 'इस आत्मा पर भारी कार्मिक बोझ है। मिशन है कार्मिक सुधार और न्याय की ऐसी संरचनाएं बनाना जो आपके बाद भी दूसरों की रक्षा करें।', sa: 'अस्याः आत्मनः भारः कार्मिकभारः। कार्यम् अस्ति कार्मिकसंशोधनं न्यायसंरचनानां च निर्माणं याः भवतः अनन्तरमपि परान् रक्षयन्ति।', mai: 'ई आत्मा पर भारी कार्मिक बोझ अछि। मिशन अछि कार्मिक सुधार आ न्यायक एहन संरचना बनाब जे अहाँक बाद मे सेहो दोसरक रक्षा करय।', mr: 'या आत्म्यावर जड कार्मिक भार आहे. मिशन म्हणजे कार्मिक सुधार आणि न्यायाच्या अशा रचना तयार करणे ज्या तुमच्या नंतरही इतरांचे रक्षण करतील।', ta: 'இந்த ஆன்மா கனமான கர்ம சுமைகளை சுமக்கிறது — புறக்கணிப்பு கடன்கள், தொழிலாளர் சுரண்டல் அல்லது அதிகார துஷ்பிரயோகம். பணி கர்ம சீர்திருத்தம்: நீங்கள் ஒரு காலத்தில் புறக்கணித்தவர்களுக்கு சேவை செய்யுங்கள்.', te: 'ఈ ఆత్మ భారీ కర్మ భారాలు మోస్తుంది — నిర్లక్ష్యం ఋణాలు, కార్మికుల దోపిడీ, లేదా అధికార దుర్వినియోగం. మిషన్ కర్మ సంస్కరణ: మీరు ఒకప్పుడు నిర్లక్ష్యం చేసిన వారికి సేవ చేయండి.', bn: 'এই আত্মা ভারী কর্মভার বহন করে — উপেক্ষার ঋণ, শ্রমিক শোষণ, বা কর্তৃত্বের অপব্যবহার। মিশন কর্মগত সংশোধন: আপনি একদা যাদের উপেক্ষা করেছেন তাদের সেবা করুন।', kn: 'ಈ ಆತ್ಮ ಭಾರೀ ಕರ್ಮ ಹೊರೆಗಳನ್ನು ಹೊತ್ತಿದೆ — ನಿರ್ಲಕ್ಷ್ಯದ ಋಣ, ಕಾರ್ಮಿಕರ ಶೋಷಣೆ, ಅಥವಾ ಅಧಿಕಾರ ದುರ್ಬಳಕೆ. ಕಾರ್ಯ ಕರ್ಮ ಸರಿಪಡಿಸುವಿಕೆ: ನೀವು ಒಮ್ಮೆ ನಿರ್ಲಕ್ಷಿಸಿದವರಿಗೆ ಸೇವೆ ಮಾಡಿ.', gu: 'આ આત્મા ભારે કર્મભાર ઉપાડે છે — ઉપેક્ષાના ઋણ, શ્રમિકોનું શોષણ, કે સત્તાનો દુરુપયોગ. મિશન કર્મ સુધારણા: તમે એક સમયે જેમને અવગણ્યા તેમની સેવા કરો.' },
  },
};

interface AMKTheme { fields: LocaleText; style: LocaleText; }
const AMK_THEMES: Record<string, AMKTheme> = {
  Sun:     { fields: { en: 'Government, administration, politics, corporate leadership, film/media, or any role requiring authority and public visibility.', hi: 'सरकार, प्रशासन, राजनीति, कॉर्पोरेट नेतृत्व, फिल्म/मीडिया, या अधिकार और सार्वजनिक दृश्यता वाली भूमिका।', sa: 'शासनम्, प्रशासनम्, राजनीतिः, निगमनेतृत्वम्, चलचित्रम्/माध्यमम्, अधिकारं सार्वजनिकदृश्यतां च अपेक्षमाणा भूमिका।', mai: 'सरकार, प्रशासन, राजनीति, कॉर्पोरेट नेतृत्व, फिल्म/मीडिया, अथवा अधिकार आ सार्वजनिक दृश्यता वाली भूमिका।', mr: 'सरकार, प्रशासन, राजकारण, कॉर्पोरेट नेतृत्व, चित्रपट/मीडिया, किंवा अधिकार आणि सार्वजनिक दृश्यमानता आवश्यक असलेली भूमिका।', ta: 'அரசு, நிர்வாகம், அரசியல், கார்ப்பரேட் தலைமை, திரைப்படம்/ஊடகம், அல்லது அதிகாரம் மற்றும் பொது தெரிவு தேவைப்படும் எந்த பாத்திரமும்.', te: 'ప్రభుత్వం, పరిపాలన, రాజకీయాలు, కార్పొరేట్ నాయకత్వం, చలనచిత్రం/మీడియా, లేదా అధికారం మరియు బహిరంగ దృశ్యమానత అవసరమైన ఏదైనా పాత్ర.', bn: 'সরকার, প্রশাসন, রাজনীতি, কর্পোরেট নেতৃত্ব, চলচ্চিত্র/মিডিয়া, বা কর্তৃত্ব ও জনদৃশ্যমানতা প্রয়োজন এমন যেকোনো ভূমিকা।', kn: 'ಸರ್ಕಾರ, ಆಡಳಿತ, ರಾಜಕೀಯ, ಕಾರ್ಪೊರೇಟ್ ನಾಯಕತ್ವ, ಚಲನಚಿತ್ರ/ಮಾಧ್ಯಮ, ಅಥವಾ ಅಧಿಕಾರ ಮತ್ತು ಸಾರ್ವಜನಿಕ ಗೋಚರತೆ ಅಗತ್ಯವಿರುವ ಯಾವುದೇ ಪಾತ್ರ.', gu: 'સરકાર, વહીવટ, રાજકારણ, કોર્પોરેટ નેતૃત્વ, ફિલ્મ/મીડિયા, કે સત્તા અને જાહેર દૃશ્યતા જરૂરી કોઈપણ ભૂમિકા.' }, style: { en: 'You work best in leadership roles where your name and identity are on the line. Solar AMK people rarely thrive as anonymous contributors — they need a stage and the satisfaction of being the one who leads.', hi: 'आप नेतृत्व भूमिकाओं में सर्वश्रेष्ठ कार्य करते हैं जहाँ आपकी पहचान दाँव पर हो।', sa: 'भवान् नेतृत्वभूमिकासु श्रेष्ठं कार्यं करोति यत्र भवतः अस्मिता दावे अस्ति।', mai: 'अहाँ नेतृत्व भूमिका मे सर्वश्रेष्ठ कार्य करैत छी जतय अहाँक पहचान दाँव पर होइत अछि।', mr: 'तुम्ही नेतृत्व भूमिकांमध्ये सर्वोत्तम काम करता जिथे तुमची ओळख पणाला लागते.', ta: 'உங்கள் பெயர் மற்றும் அடையாளம் பொறுப்பில் இருக்கும் தலைமைப் பாத்திரங்களில் நீங்கள் சிறப்பாகச் செயல்படுவீர்கள். சூரிய AMK நபர்களுக்கு ஒரு மேடை தேவை.', te: 'మీ పేరు మరియు గుర్తింపు ఉన్న నాయకత్వ పాత్రల్లో మీరు బాగా పని చేస్తారు. సూర్య AMK వ్యక్తులకు వేదిక మరియు నడిపించే సంతృప్తి అవసరం.', bn: 'আপনি নেতৃত্বের ভূমিকায় সবচেয়ে ভালো কাজ করেন যেখানে আপনার নাম ও পরিচয় দাঁড়িয়ে থাকে। সূর্য AMK ব্যক্তিদের একটি মঞ্চ প্রয়োজন।', kn: 'ನಿಮ್ಮ ಹೆಸರು ಮತ್ತು ಗುರುತು ಪಣದಲ್ಲಿರುವ ನಾಯಕತ್ವ ಪಾತ್ರಗಳಲ್ಲಿ ನೀವು ಅತ್ಯುತ್ತಮವಾಗಿ ಕೆಲಸ ಮಾಡುತ್ತೀರಿ. ಸೂರ್ಯ AMK ಜನರಿಗೆ ವೇದಿಕೆ ಬೇಕು.', gu: 'તમારું નામ અને ઓળખ દાવ પર હોય તેવી નેતૃત્વ ભૂમિકાઓમાં તમે શ્રેષ્ઠ કામ કરો છો. સૂર્ય AMK વ્યક્તિઓને એક મંચ જોઈએ.' } },
  Moon:    { fields: { en: 'Healthcare, psychology, food, hospitality, public relations, education, caregiving, or any profession serving human comfort and emotional needs.', hi: 'स्वास्थ्य सेवा, मनोविज्ञान, भोजन, आतिथ्य, जनसम्पर्क, शिक्षा, देखभाल।', sa: 'स्वास्थ्यसेवा, मनोविज्ञानम्, आहारः, आतिथ्यम्, जनसम्पर्कः, शिक्षा, परिचर्या।', mai: 'स्वास्थ्य सेवा, मनोविज्ञान, भोजन, आतिथ्य, जनसम्पर्क, शिक्षा, देखभाल।', mr: 'आरोग्यसेवा, मानसशास्त्र, अन्न, आदरातिथ्य, जनसंपर्क, शिक्षण, सेवा।', ta: 'உடல்நலப் பராமரிப்பு, உளவியல், உணவு, விருந்தோம்பல், மக்கள் தொடர்பு, கல்வி, பராமரிப்பு, அல்லது மனித வசதி மற்றும் உணர்ச்சித் தேவைகளுக்கு சேவை செய்யும் எந்த தொழிலும்.', te: 'ఆరోగ్య సంరక్షణ, మనస్తత్వశాస్త్రం, ఆహారం, ఆతిథ్యం, ప్రజా సంబంధాలు, విద్య, సంరక్షణ, లేదా మానవ సౌకర్యం మరియు భావోద్వేగ అవసరాలకు సేవ చేసే ఏదైనా వృత్తి.', bn: 'স্বাস্থ্যসেবা, মনোবিজ্ঞান, খাদ্য, আতিথেয়তা, জনসম্পর্ক, শিক্ষা, পরিচর্যা, বা মানুষের আরাম ও আবেগজ চাহিদা পূরণকারী যেকোনো পেশা।', kn: 'ಆರೋಗ್ಯ ಸೇವೆ, ಮನೋವಿಜ್ಞಾನ, ಆಹಾರ, ಆತಿಥ್ಯ, ಸಾರ್ವಜನಿಕ ಸಂಪರ್ಕ, ಶಿಕ್ಷಣ, ಆರೈಕೆ, ಅಥವಾ ಮಾನವ ಸೌಕರ್ಯ ಮತ್ತು ಭಾವನಾತ್ಮಕ ಅಗತ್ಯಗಳಿಗೆ ಸೇವೆ ಸಲ್ಲಿಸುವ ಯಾವುದೇ ವೃತ್ತಿ.', gu: 'આરોગ્ય સેવા, મનોવિજ્ઞાન, ભોજન, આતિથ્ય, જનસંપર્ક, શિક્ષણ, સંભાળ, કે માનવ આરામ અને ભાવનાત્મક જરૂરિયાતોની સેવા કરતો કોઈપણ વ્યવસાય.' }, style: { en: 'Career success comes through empathy and public trust. You are most effective when working with people\'s innermost needs. Success often involves the public or masses in some way — your reputation is your professional currency.', hi: 'सहानुभूति और जनविश्वास के माध्यम से सफलता। आप लोगों की सबसे गहरी जरूरतों के साथ काम करने में सबसे प्रभावी हैं।' } },
  Mars:    { fields: { en: 'Military, police, surgery, engineering, real estate, construction, competitive sports, entrepreneurship, or any field demanding physical action and decisive risk-taking.', hi: 'सेना, पुलिस, शल्य चिकित्सा, इंजीनियरिंग, अचल सम्पत्ति, निर्माण, प्रतिस्पर्धी खेल, उद्यमिता।', sa: 'सेना, पुलिस, शल्य चिकित्सा, इंजीनियरिंग, अचल सम्पत्ति, निर्माण, प्रतिस्पर्धी खेल, उद्यमिता।', mai: 'सेना, पुलिस, शल्य चिकित्सा, इंजीनियरिंग, अचल सम्पत्ति, निर्माण, प्रतिस्पर्धी खेल, उद्यमिता।', mr: 'सेना, पुलिस, शल्य चिकित्सा, इंजीनियरिंग, अचल सम्पत्ति, निर्माण, प्रतिस्पर्धी खेल, उद्यमिता।', ta: 'இராணுவம், காவல்துறை, அறுவை சிகிச்சை, பொறியியல், ரியல் எஸ்டேட், கட்டுமானம், போட்டி விளையாட்டு, தொழில்முனைவு, அல்லது உடல் செயல்பாடு மற்றும் தீர்க்கமான அபாயம் எடுக்க வேண்டிய எந்த துறையும்.', te: 'సైన్యం, పోలీసు, శస్త్రచికిత్స, ఇంజినీరింగ్, రియల్ ఎస్టేట్, నిర్మాణం, పోటీ క్రీడలు, వ్యాపారవేత్తగా, లేదా శారీరక చర్య మరియు నిర్ణయాత్మక రిస్క్ తీసుకోవడం అవసరమైన ఏదైనా రంగం.', bn: 'সেনাবাহিনী, পুলিশ, সার্জারি, ইঞ্জিনিয়ারিং, রিয়েল এস্টেট, নির্মাণ, প্রতিযোগিতামূলক খেলা, উদ্যোক্তা, বা শারীরিক কর্ম ও দৃঢ় ঝুঁকি নেওয়া প্রয়োজন এমন যেকোনো ক্ষেত্র।', kn: 'ಸೈನ್ಯ, ಪೊಲೀಸ್, ಶಸ್ತ್ರಚಿಕಿತ್ಸೆ, ಎಂಜಿನಿಯರಿಂಗ್, ರಿಯಲ್ ಎಸ್ಟೇಟ್, ನಿರ್ಮಾಣ, ಸ್ಪರ್ಧಾತ್ಮಕ ಕ್ರೀಡೆ, ಉದ್ಯಮಶೀಲತೆ, ಅಥವಾ ಶಾರೀರಿಕ ಕ್ರಿಯೆ ಮತ್ತು ನಿರ್ಣಾಯಕ ಅಪಾಯ ಅಗತ್ಯವಿರುವ ಯಾವುದೇ ಕ್ಷೇತ್ರ.', gu: 'લશ્કર, પોલીસ, સર્જરી, એન્જિનિયરિંગ, રિયલ એસ્ટેટ, બાંધકામ, સ્પર્ધાત્મક રમત, ઉદ્યોગસાહસ, કે શારીરિક ક્રિયા અને નિર્ણાયક જોખમ લેવાની માગ કરતું કોઈપણ ક્ષેત્ર.' }, style: { en: 'You are built to initiate, compete, and conquer. Career should involve tangible results and the satisfaction of winning. Desk work without stakes depletes you — you need a field where something real is on the line.', hi: 'आप शुरुआत करने, प्रतिस्पर्धा और जीतने के लिए बने हैं। ठोस परिणाम और वास्तविक दाँव आपको ऊर्जावान बनाते हैं।', sa: 'आप शुरुआत करने, प्रतिस्पर्धा और जीतने के लिए बने हैं। ठोस परिणाम और वास्तविक दाँव आपको ऊर्जावान बनाते हैं।', mai: 'आप शुरुआत करने, प्रतिस्पर्धा और जीतने के लिए बने हैं। ठोस परिणाम और वास्तविक दाँव आपको ऊर्जावान बनाते हैं।', mr: 'आप शुरुआत करने, प्रतिस्पर्धा और जीतने के लिए बने हैं। ठोस परिणाम और वास्तविक दाँव आपको ऊर्जावान बनाते हैं।', ta: 'நீங்கள் தொடங்க, போட்டியிட, வெற்றிகொள்ள உருவாக்கப்பட்டவர். தொழில் உறுதியான முடிவுகளையும் வெற்றியின் திருப்தியையும் உள்ளடக்கியதாக இருக்க வேண்டும். பந்தயம் இல்லாத மேசை வேலை உங்களை வடிகட்டுகிறது — உண்மையான ஒன்று பொறுப்பில் இருக்கும் துறை உங்களுக்கு தேவை.', te: 'మీరు ప్రారంభించడానికి, పోటీపడటానికి, జయించడానికి నిర్మించబడ్డారు. వృత్తి స్పష్టమైన ఫలితాలు మరియు గెలుపు సంతృప్తిని కలిగి ఉండాలి. పందెం లేని డెస్క్ పని మిమ్మల్ని నిర్వీర్యం చేస్తుంది — నిజమైనది పణంగా ఉండే రంగం మీకు కావాలి.', bn: 'আপনি শুরু করতে, প্রতিযোগিতা করতে এবং জয় করতে তৈরি। পেশায় স্পর্শগ্রাহ্য ফলাফল এবং জেতার তৃপ্তি থাকা উচিত। দাঁও ছাড়া ডেস্ক কাজ আপনাকে ক্ষয় করে — আপনার এমন ক্ষেত্র দরকার যেখানে সত্যিকারের কিছু ঝুঁকিতে থাকে।', kn: 'ನೀವು ಪ್ರಾರಂಭಿಸಲು, ಸ್ಪರ್ಧಿಸಲು ಮತ್ತು ಜಯಿಸಲು ನಿರ್ಮಿಸಲ್ಪಟ್ಟಿದ್ದೀರಿ. ವೃತ್ತಿಯಲ್ಲಿ ಸ್ಪಷ್ಟ ಫಲಿತಾಂಶಗಳು ಮತ್ತು ಗೆಲುವಿನ ತೃಪ್ತಿ ಇರಬೇಕು. ಪಣವಿಲ್ಲದ ಮೇಜಿನ ಕೆಲಸ ನಿಮ್ಮನ್ನು ಖಾಲಿ ಮಾಡುತ್ತದೆ — ನಿಜವಾದದ್ದು ಅಪಾಯದಲ್ಲಿರುವ ಕ್ಷೇತ್ರ ನಿಮಗೆ ಬೇಕು.', gu: 'તમે શરૂ કરવા, સ્પર્ધા કરવા અને જીતવા માટે બનેલા છો. કારકિર્દીમાં નક્કર પરિણામો અને જીતનો સંતોષ હોવો જોઈએ. દાવ વિનાનું ડેસ્ક કામ તમને ખાલી કરે છે — તમારે એવું ક્ષેત્ર જોઈએ જ્યાં કંઈક વાસ્તવિક દાવ પર હોય.' } },
  Mercury: { fields: { en: 'Writing, journalism, IT, software, finance, trading, teaching, law, consulting, research, or any profession centred on information, analysis, and the intellect.', hi: 'लेखन, पत्रकारिता, आईटी, सॉफ्टवेयर, वित्त, व्यापार, शिक्षण, कानून, परामर्श, शोध।', sa: 'लेखन, पत्रकारिता, आईटी, सॉफ्टवेयर, वित्त, व्यापार, शिक्षण, कानून, परामर्श, शोध।', mai: 'लेखन, पत्रकारिता, आईटी, सॉफ्टवेयर, वित्त, व्यापार, शिक्षण, कानून, परामर्श, शोध।', mr: 'लेखन, पत्रकारिता, आईटी, सॉफ्टवेयर, वित्त, व्यापार, शिक्षण, कानून, परामर्श, शोध।', ta: 'எழுத்து, பத்திரிகை, IT, மென்பொருள், நிதி, வர்த்தகம், கற்பித்தல், சட்டம், ஆலோசனை, ஆராய்ச்சி, அல்லது தகவல், பகுப்பாய்வு மற்றும் புத்திசாலித்தனத்தை மையமாகக் கொண்ட எந்த தொழிலும்.', te: 'రాయడం, జర్నలిజం, IT, సాఫ్ట్‌వేర్, ఆర్థికం, వ్యాపారం, బోధన, న్యాయం, సలహా, పరిశోధన, లేదా సమాచారం, విశ్లేషణ మరియు బుద్ధిపై కేంద్రీకృతమైన ఏదైనా వృత్తి.', bn: 'লেখা, সাংবাদিকতা, IT, সফটওয়্যার, অর্থ, ট্রেডিং, শিক্ষাদান, আইন, পরামর্শ, গবেষণা, বা তথ্য, বিশ্লেষণ ও বুদ্ধি কেন্দ্রিক যেকোনো পেশা।', kn: 'ಬರವಣಿಗೆ, ಪತ್ರಿಕೋದ್ಯಮ, IT, ಸಾಫ್ಟ್‌ವೇರ್, ಹಣಕಾಸು, ವ್ಯಾಪಾರ, ಬೋಧನೆ, ಕಾನೂನು, ಸಲಹೆ, ಸಂಶೋಧನೆ, ಅಥವಾ ಮಾಹಿತಿ, ವಿಶ್ಲೇಷಣೆ ಮತ್ತು ಬುದ್ಧಿ ಕೇಂದ್ರಿತ ಯಾವುದೇ ವೃತ್ತಿ.', gu: 'લેખન, પત્રકારત્વ, IT, સોફ્ટવેર, નાણાં, ટ્રેડિંગ, શિક્ષણ, કાયદો, કન્સલ્ટિંગ, સંશોધન, કે માહિતી, વિશ્લેષણ અને બુદ્ધિ કેન્દ્રિત કોઈપણ વ્યવસાય.' }, style: { en: 'You succeed through intelligence and communication. Multiple skills and simultaneous ventures are natural. The mind is your greatest professional asset — keep it fed, challenged, and well-expressed. Monotonous work is poison.', hi: 'बुद्धि और संवाद के माध्यम से सफलता। मन आपकी सबसे बड़ी व्यावसायिक सम्पत्ति है — उसे पोषित और चुनौतीपूर्ण बनाए रखें।', sa: 'बुद्धि और संवाद के माध्यम से सफलता। मन आपकी सबसे बड़ी व्यावसायिक सम्पत्ति है — उसे पोषित और चुनौतीपूर्ण बनाए रखें।', mai: 'बुद्धि और संवाद के माध्यम से सफलता। मन आपकी सबसे बड़ी व्यावसायिक सम्पत्ति है — उसे पोषित और चुनौतीपूर्ण बनाए रखें।', mr: 'बुद्धि और संवाद के माध्यम से सफलता। मन आपकी सबसे बड़ी व्यावसायिक सम्पत्ति है — उसे पोषित और चुनौतीपूर्ण बनाए रखें।', ta: 'நீங்கள் புத்திசாலித்தனம் மற்றும் தொடர்பாடல் மூலம் வெற்றி பெறுவீர்கள். பல திறன்களும் ஒரே நேரத்தில் பல முயற்சிகளும் இயல்பானவை. மனம் உங்கள் மிகப்பெரிய தொழில் சொத்து — அதை ஊட்டமாகவும் சவாலாகவும் வைத்திருங்கள். சலிப்பூட்டும் வேலை நஞ்சு.', te: 'మీరు తెలివితేటలు మరియు సంభాషణ ద్వారా విజయం సాధిస్తారు. బహుళ నైపుణ్యాలు మరియు ఏకకాల ప్రయత్నాలు సహజం. మనసు మీ గొప్ప వృత్తిపరమైన ఆస్తి — దానిని పోషించి, సవాలు చేసి, బాగా వ్యక్తం చేయండి. ఏకరీతి పని విషం.', bn: 'আপনি বুদ্ধিমত্তা ও যোগাযোগের মাধ্যমে সফল হন। একাধিক দক্ষতা ও একসাথে একাধিক উদ্যোগ স্বাভাবিক। মন আপনার সবচেয়ে বড় পেশাগত সম্পদ — একে পুষ্ট, চ্যালেঞ্জিত ও সুপ্রকাশিত রাখুন। একঘেয়ে কাজ বিষ।', kn: 'ನೀವು ಬುದ್ಧಿವಂತಿಕೆ ಮತ್ತು ಸಂವಹನದ ಮೂಲಕ ಯಶಸ್ವಿಯಾಗುತ್ತೀರಿ. ಬಹು ಕೌಶಲ್ಯಗಳು ಮತ್ತು ಏಕಕಾಲ ಉದ್ಯಮಗಳು ಸಹಜ. ಮನಸ್ಸು ನಿಮ್ಮ ಅತಿದೊಡ್ಡ ವೃತ್ತಿಪರ ಆಸ್ತಿ — ಅದನ್ನು ಪೋಷಿಸಿ, ಸವಾಲು ಮಾಡಿ, ಚೆನ್ನಾಗಿ ವ್ಯಕ್ತಪಡಿಸಿ. ಏಕತಾನ ಕೆಲಸ ವಿಷ.', gu: 'તમે બુદ્ધિ અને સંવાદ દ્વારા સફળ થાઓ છો. અનેક કૌશલ્ય અને એકસાથે અનેક ઉદ્યમ સ્વાભાવિક છે. મન તમારી સૌથી મોટી વ્યાવસાયિક સંપત્તિ છે — તેને પોષિત, પડકારરૂપ અને સુવ્યક્ત રાખો. એકવિધ કામ ઝેર છે.' } },
  Jupiter: { fields: { en: 'Teaching, law, judiciary, counseling, astrology, philosophy, publishing, priesthood, or any role requiring wisdom, ethical guidance, and the expansion of others\' understanding.', hi: 'शिक्षण, कानून, न्यायपालिका, परामर्श, ज्योतिष, दर्शन, प्रकाशन, पुरोहित।' }, style: { en: 'Your greatest professional tool is trust and wisdom. People come to you not for services but for guidance. Career thrives when you embrace the role of mentor — the one who expands others, not just informs them. Over-extending into too many roles dilutes your power.', hi: 'आपका सबसे बड़ा उपकरण विश्वास और ज्ञान है। करियर तब फलता-फूलता है जब आप संरक्षक की भूमिका अपनाते हैं।', sa: 'आपका सबसे बड़ा उपकरण विश्वास और ज्ञान है। करियर तब फलता-फूलता है जब आप संरक्षक की भूमिका अपनाते हैं।', mai: 'आपका सबसे बड़ा उपकरण विश्वास और ज्ञान है। करियर तब फलता-फूलता है जब आप संरक्षक की भूमिका अपनाते हैं।', mr: 'आपका सबसे बड़ा उपकरण विश्वास और ज्ञान है। करियर तब फलता-फूलता है जब आप संरक्षक की भूमिका अपनाते हैं।', ta: 'உங்கள் மிகப்பெரிய தொழில்சார் கருவி நம்பிக்கையும் ஞானமும். மக்கள் சேவைகளுக்காக அல்ல, வழிகாட்டுதலுக்காக உங்களிடம் வருகிறார்கள். வழிகாட்டியின் பங்கை ஏற்கும்போது தொழில் செழிக்கிறது — மற்றவர்களை விரிவுபடுத்துபவர், தகவல் மட்டும் தருபவர் அல்ல. பல பங்குகளில் விரிவடைவது உங்கள் சக்தியைக் குறைக்கிறது.', te: 'మీ గొప్ప వృత్తిపరమైన సాధనం నమ్మకం మరియు జ్ఞానం. ప్రజలు సేవల కోసం కాదు, మార్గదర్శకత్వం కోసం మీ వద్దకు వస్తారు. మెంటార్ పాత్రను స్వీకరించినప్పుడు వృత్తి వర్ధిల్లుతుంది — ఇతరులను విస్తరింపజేసేవారు, కేవలం సమాచారం అందించేవారు కాదు. ఎక్కువ పాత్రలలో విస్తరించడం మీ శక్తిని క్షీణింపజేస్తుంది.', bn: 'আপনার সর্বশ্রেষ্ঠ পেশাদার হাতিয়ার বিশ্বাস ও প্রজ্ঞা। মানুষ সেবার জন্য নয়, পথনির্দেশের জন্য আসে। পরামর্শদাতার ভূমিকা গ্রহণ করলে কর্মজীবন সমৃদ্ধ হয় — যিনি অন্যদের প্রসারিত করেন, শুধু তথ্য দেন না। অতিরিক্ত ভূমিকায় বিস্তৃত হলে শক্তি ক্ষয় হয়।', kn: 'ನಿಮ್ಮ ಅತ್ಯುತ್ತಮ ವೃತ್ತಿಪರ ಸಾಧನ ನಂಬಿಕೆ ಮತ್ತು ಜ್ಞಾನ. ಜನರು ಸೇವೆಗಳಿಗಾಗಿ ಅಲ್ಲ, ಮಾರ್ಗದರ್ಶನಕ್ಕಾಗಿ ನಿಮ್ಮ ಬಳಿ ಬರುತ್ತಾರೆ. ಮಾರ್ಗದರ್ಶಿಯ ಪಾತ್ರ ಸ್ವೀಕರಿಸಿದಾಗ ವೃತ್ತಿ ಅಭಿವೃದ್ಧಿ ಹೊಂದುತ್ತದೆ — ಇತರರನ್ನು ವಿಸ್ತರಿಸುವವರು, ಕೇವಲ ಮಾಹಿತಿ ನೀಡುವವರಲ್ಲ. ಹೆಚ್ಚು ಪಾತ್ರಗಳಿಗೆ ವಿಸ್ತರಿಸುವುದು ನಿಮ್ಮ ಶಕ್ತಿಯನ್ನು ಕ್ಷೀಣಿಸುತ್ತದೆ.', gu: 'તમારું સૌથી મોટું વ્યાવસાયિક સાધન વિશ્વાસ અને જ્ઞાન છે. લોકો સેવાઓ માટે નહીં, માર્ગદર્શન માટે તમારી પાસે આવે છે. માર્ગદર્શકની ભૂમિકા અપનાવો ત્યારે કારકિર્દી ખીલે છે — જે અન્યોને વિસ્તારે, ફક્ત માહિતી ન આપે. ઘણી ભૂમિકાઓમાં વિસ્તરણ તમારી શક્તિ ઘટાડે છે.' } },
  Venus:   { fields: { en: 'Fine arts, music, cinema, fashion, luxury goods, hospitality, interior design, beauty, diplomacy, or any profession requiring aesthetic sense and refined taste.', hi: 'ललित कला, संगीत, सिनेमा, फैशन, विलासिता, आतिथ्य, आन्तरिक सज्जा, सौन्दर्य उद्योग, कूटनीति।', sa: 'ललित कला, संगीत, सिनेमा, फैशन, विलासिता, आतिथ्य, आन्तरिक सज्जा, सौन्दर्य उद्योग, कूटनीति।', mai: 'ललित कला, संगीत, सिनेमा, फैशन, विलासिता, आतिथ्य, आन्तरिक सज्जा, सौन्दर्य उद्योग, कूटनीति।', mr: 'ललित कला, संगीत, सिनेमा, फैशन, विलासिता, आतिथ्य, आन्तरिक सज्जा, सौन्दर्य उद्योग, कूटनीति।', ta: 'நுண்கலைகள், இசை, சினிமா, பேஷன், ஆடம்பர பொருட்கள், விருந்தோம்பல், உள்ளக வடிவமைப்பு, அழகு, இராஜதந்திரம், அல்லது அழகியல் உணர்வு மற்றும் நுட்பமான ரசனை தேவைப்படும் எந்த தொழிலும்.', te: 'లలితకళలు, సంగీతం, సినిమా, ఫ్యాషన్, విలాస వస్తువులు, ఆతిథ్యం, ఇంటీరియర్ డిజైన్, అందం, దౌత్యం, లేదా సౌందర్య భావన మరియు పరిష్కృత రుచి అవసరమైన ఏదైనా వృత్తి.', bn: 'চারুকলা, সংগীত, সিনেমা, ফ্যাশন, বিলাস দ্রব্য, আতিথেয়তা, ইন্টেরিয়র ডিজাইন, সৌন্দর্য, কূটনীতি, বা নান্দনিক চেতনা ও পরিশীলিত রুচি প্রয়োজন এমন যেকোনো পেশা।', kn: 'ಲಲಿತಕಲೆ, ಸಂಗೀತ, ಚಲನಚಿತ್ರ, ಫ್ಯಾಷನ್, ವೈಭವ ವಸ್ತುಗಳು, ಆತಿಥ್ಯ, ಒಳಾಂಗಣ ವಿನ್ಯಾಸ, ಸೌಂದರ್ಯ, ರಾಜತಾಂತ್ರಿಕತೆ, ಅಥವಾ ಸೌಂದರ್ಯ ಜ್ಞಾನ ಮತ್ತು ಶುದ್ಧ ರುಚಿ ಅಗತ್ಯವಿರುವ ಯಾವುದೇ ವೃತ್ತಿ.', gu: 'લલિતકલા, સંગીત, સિનેમા, ફેશન, લક્ઝરી ચીજો, આતિથ્ય, ઇન્ટીરિયર ડિઝાઇન, સૌંદર્ય, રાજદ્વારી, કે સૌંદર્ય ભાવ અને પરિષ્કૃત રુચિ જરૂરી કોઈપણ વ્યવસાય.' }, style: { en: 'You work best in environments that are beautiful, harmonious, and relationship-rich. Professional energy thrives through collaboration, aesthetics, and sensory excellence. Conflict-heavy environments deplete you quickly — you need grace around you to work at your best.', hi: 'आप सुन्दर, सामंजस्यपूर्ण वातावरण में सर्वश्रेष्ठ काम करते हैं। सहयोग और सौन्दर्यशास्त्र से पेशेवर ऊर्जा बढ़ती है।', sa: 'आप सुन्दर, सामंजस्यपूर्ण वातावरण में सर्वश्रेष्ठ काम करते हैं। सहयोग और सौन्दर्यशास्त्र से पेशेवर ऊर्जा बढ़ती है।', mai: 'आप सुन्दर, सामंजस्यपूर्ण वातावरण में सर्वश्रेष्ठ काम करते हैं। सहयोग और सौन्दर्यशास्त्र से पेशेवर ऊर्जा बढ़ती है।', mr: 'आप सुन्दर, सामंजस्यपूर्ण वातावरण में सर्वश्रेष्ठ काम करते हैं। सहयोग और सौन्दर्यशास्त्र से पेशेवर ऊर्जा बढ़ती है।', ta: 'அழகான, இசைவான, உறவுகள் நிறைந்த சூழலில் நீங்கள் சிறப்பாகச் செயல்படுவீர்கள். ஒத்துழைப்பு, அழகியல் மற்றும் புலன் சிறப்பு மூலம் தொழில் ஆற்றல் செழிக்கிறது. மோதல் நிறைந்த சூழல் உங்களை விரைவாகக் கரைக்கிறது — சிறப்பாகச் செயல்பட உங்களைச் சுற்றி நளினம் தேவை.', te: 'అందమైన, సామరస్యమైన, బంధాలు పుష్కలమైన వాతావరణంలో మీరు ఉత్తమంగా పని చేస్తారు. సహకారం, సౌందర్యం మరియు ఇంద్రియ శ్రేష్ఠత ద్వారా వృత్తిపరమైన శక్తి వృద్ధి చెందుతుంది. ఘర్షణ భరితమైన వాతావరణాలు మిమ్మల్ని త్వరగా నిర్వీర్యం చేస్తాయి — ఉత్తమంగా పని చేయడానికి మీ చుట్టూ సొగసు అవసరం.', bn: 'আপনি সুন্দর, সুসংহত ও সম্পর্ক সমৃদ্ধ পরিবেশে সেরা কাজ করেন। সহযোগিতা, নন্দনতত্ত্ব ও ইন্দ্রিয় শ্রেষ্ঠতার মাধ্যমে পেশাগত শক্তি বিকশিত হয়। সংঘাতপূর্ণ পরিবেশ আপনাকে দ্রুত ক্ষয় করে — সেরা কাজের জন্য আপনার চারপাশে কমনীয়তা প্রয়োজন।', kn: 'ಸುಂದರ, ಸಾಮರಸ್ಯ ಮತ್ತು ಸಂಬಂಧ ಸಮೃದ್ಧ ವಾತಾವರಣದಲ್ಲಿ ನೀವು ಉತ್ತಮವಾಗಿ ಕೆಲಸ ಮಾಡುತ್ತೀರಿ. ಸಹಯೋಗ, ಸೌಂದರ್ಯ ಮತ್ತು ಇಂದ್ರಿಯ ಶ್ರೇಷ್ಠತೆಯ ಮೂಲಕ ವೃತ್ತಿಪರ ಶಕ್ತಿ ಅಭಿವೃದ್ಧಿ ಹೊಂದುತ್ತದೆ. ಸಂಘರ್ಷ ತುಂಬಿದ ವಾತಾವರಣ ನಿಮ್ಮನ್ನು ಬೇಗ ಖಾಲಿ ಮಾಡುತ್ತದೆ — ಉತ್ತಮವಾಗಿ ಕೆಲಸ ಮಾಡಲು ನಿಮ್ಮ ಸುತ್ತ ಲಾಲಿತ್ಯ ಬೇಕು.', gu: 'સુંદર, સુમેળપૂર્ણ અને સંબંધ સમૃદ્ધ વાતાવરણમાં તમે શ્રેષ્ઠ કામ કરો છો. સહયોગ, સૌંદર્ય અને ઇન્દ્રિય ઉત્કૃષ્ટતા દ્વારા વ્યાવસાયિક ઊર્જા ખીલે છે. સંઘર્ષથી ભરેલું વાતાવરણ તમને ઝડપથી ખાલી કરે છે — શ્રેષ્ઠ કામ માટે તમારી આસપાસ ગરિમા જોઈએ.' } },
  Saturn:  { fields: { en: 'Law, social work, government, labor sectors, agriculture, mining, construction, urban planning, healthcare for the elderly or poor, or any slow-building, high-integrity profession.', hi: 'कानून, समाज सेवा, सरकार, श्रम क्षेत्र, कृषि, खनन, निर्माण, वृद्धों/गरीबों की स्वास्थ्य सेवा।', sa: 'कानून, समाज सेवा, सरकार, श्रम क्षेत्र, कृषि, खनन, निर्माण, वृद्धों/गरीबों की स्वास्थ्य सेवा।', mai: 'कानून, समाज सेवा, सरकार, श्रम क्षेत्र, कृषि, खनन, निर्माण, वृद्धों/गरीबों की स्वास्थ्य सेवा।', mr: 'कानून, समाज सेवा, सरकार, श्रम क्षेत्र, कृषि, खनन, निर्माण, वृद्धों/गरीबों की स्वास्थ्य सेवा।', ta: 'சட்டம், சமூக பணி, அரசு, தொழிலாளர் துறை, விவசாயம், சுரங்கம், கட்டுமானம், நகர திட்டமிடல், வயதானோர் அல்லது ஏழைகளுக்கான உடல்நலப் பராமரிப்பு, அல்லது மெதுவாக வளரும், உயர் நேர்மையான தொழில்.', te: 'న్యాయం, సామాజిక సేవ, ప్రభుత్వం, కార్మిక రంగాలు, వ్యవసాయం, గనుల తవ్వకం, నిర్మాణం, నగర ప్రణాళిక, వృద్ధులు లేదా పేదల ఆరోగ్య సంరక్షణ, లేదా నెమ్మదిగా నిర్మించే, ఉన్నత సమగ్రత వృత్తి.', bn: 'আইন, সমাজকর্ম, সরকার, শ্রমিক খাত, কৃষি, খনন, নির্মাণ, নগর পরিকল্পনা, বৃদ্ধ বা দরিদ্রদের স্বাস্থ্যসেবা, বা ধীরে গড়ে ওঠা, উচ্চ সততার পেশা।', kn: 'ಕಾನೂನು, ಸಮಾಜ ಸೇವೆ, ಸರ್ಕಾರ, ಕಾರ್ಮಿಕ ಕ್ಷೇತ್ರ, ಕೃಷಿ, ಗಣಿಗಾರಿಕೆ, ನಿರ್ಮಾಣ, ನಗರ ಯೋಜನೆ, ವೃದ್ಧರ ಅಥವಾ ಬಡವರ ಆರೋಗ್ಯ ಸೇವೆ, ಅಥವಾ ನಿಧಾನವಾಗಿ ಬೆಳೆಯುವ, ಉನ್ನತ ಸಮಗ್ರತೆಯ ವೃತ್ತಿ.', gu: 'કાયદો, સમાજકાર્ય, સરકાર, શ્રમિક ક્ષેત્ર, ખેતી, ખાણકામ, બાંધકામ, શહેર આયોજન, વૃદ્ધ કે ગરીબોની આરોગ્ય સેવા, કે ધીમે-ધીમે બનતો, ઉચ્ચ પ્રામાણિકતાનો વ્યવસાય.' }, style: { en: 'You are built for the long game. Career success comes slowly but is rock-solid when it arrives. You excel in professions that others abandon — because you have patience, discipline, and the ability to serve without recognition. The less glamorous the work, often the better you perform.', hi: 'आप लम्बी दौड़ के लिए बने हैं। करियर की सफलता धीरे आती है पर अटल होती है। आप वहाँ उत्कृष्ट हैं जहाँ दूसरे हार मानते हैं।', sa: 'आप लम्बी दौड़ के लिए बने हैं। करियर की सफलता धीरे आती है पर अटल होती है। आप वहाँ उत्कृष्ट हैं जहाँ दूसरे हार मानते हैं।', mai: 'आप लम्बी दौड़ के लिए बने हैं। करियर की सफलता धीरे आती है पर अटल होती है। आप वहाँ उत्कृष्ट हैं जहाँ दूसरे हार मानते हैं।', mr: 'आप लम्बी दौड़ के लिए बने हैं। करियर की सफलता धीरे आती है पर अटल होती है। आप वहाँ उत्कृष्ट हैं जहाँ दूसरे हार मानते हैं।', ta: 'நீங்கள் நீண்ட கால விளையாட்டிற்கு உருவாக்கப்பட்டவர். தொழில் வெற்றி மெதுவாக வருகிறது ஆனால் வரும்போது கல் போல் உறுதியானது. மற்றவர்கள் கைவிடும் தொழில்களில் நீங்கள் சிறந்து விளங்குவீர்கள் — ஏனெனில் உங்களிடம் பொறுமை, ஒழுக்கம் மற்றும் அங்கீகாரம் இல்லாமல் சேவை செய்யும் திறன் உள்ளது.', te: 'మీరు దీర్ఘకాలిక ఆటకు నిర్మించబడ్డారు. వృత్తి విజయం నెమ్మదిగా వస్తుంది కానీ వచ్చినప్పుడు బండరాయిలా గట్టిగా ఉంటుంది. ఇతరులు విడిచిపెట్టే వృత్తులలో మీరు రాణిస్తారు — ఎందుకంటే మీకు సహనం, క్రమశిక్షణ మరియు గుర్తింపు లేకుండా సేవ చేసే సామర్థ్యం ఉంది.', bn: 'আপনি দীর্ঘ খেলার জন্য তৈরি। পেশাগত সাফল্য ধীরে আসে কিন্তু যখন আসে তখন পাথরের মতো দৃঢ়। অন্যেরা যে পেশা ছেড়ে দেয় সেখানে আপনি উৎকর্ষ লাভ করেন — কারণ আপনার ধৈর্য, শৃঙ্খলা এবং স্বীকৃতি ছাড়া সেবা করার ক্ষমতা আছে।', kn: 'ನೀವು ದೀರ್ಘಕಾಲಿಕ ಆಟಕ್ಕೆ ನಿರ್ಮಿಸಲ್ಪಟ್ಟಿದ್ದೀರಿ. ವೃತ್ತಿ ಯಶಸ್ಸು ನಿಧಾನವಾಗಿ ಬರುತ್ತದೆ ಆದರೆ ಬಂದಾಗ ಬಂಡೆಯಂತೆ ಗಟ್ಟಿ. ಇತರರು ಬಿಟ್ಟುಬಿಡುವ ವೃತ್ತಿಗಳಲ್ಲಿ ನೀವು ಉತ್ಕೃಷ್ಟತೆ ಸಾಧಿಸುತ್ತೀರಿ — ಏಕೆಂದರೆ ನಿಮಗೆ ತಾಳ್ಮೆ, ಶಿಸ್ತು ಮತ್ತು ಮನ್ನಣೆ ಇಲ್ಲದೆ ಸೇವೆ ಮಾಡುವ ಸಾಮರ್ಥ್ಯ ಇದೆ.', gu: 'તમે લાંબી રમત માટે બનેલા છો. કારકિર્દીની સફળતા ધીમે આવે છે પણ આવે ત્યારે ખડક જેવી મજબૂત હોય છે. બીજા જે વ્યવસાય છોડી દે છે તેમાં તમે ઉત્કૃષ્ટ થાઓ છો — કારણ કે તમારી પાસે ધીરજ, શિસ્ત અને ઓળખ વિના સેવા કરવાની ક્ષમતા છે.' } },
};

interface DKTheme { nature: LocaleText; dynamic: LocaleText; }
const DK_THEMES: Record<string, DKTheme> = {
  Sun:     { nature: { en: 'Authoritative, proud, career-driven, and dignified. Your partner has a strong identity and needs recognition. They may be drawn to leadership, carry a solar radiance, and struggle with being second.', hi: 'अधिकारपूर्ण, गर्वित, करियर-उन्मुख और प्रतिष्ठित। साथी की पहचान मजबूत है, उन्हें मान्यता चाहिए।', sa: 'अधिकारपूर्ण, गर्वित, करियर-उन्मुख और प्रतिष्ठित। साथी की पहचान मजबूत है, उन्हें मान्यता चाहिए।', mai: 'अधिकारपूर्ण, गर्वित, करियर-उन्मुख और प्रतिष्ठित। साथी की पहचान मजबूत है, उन्हें मान्यता चाहिए।', mr: 'अधिकारपूर्ण, गर्वित, करियर-उन्मुख और प्रतिष्ठित। साथी की पहचान मजबूत है, उन्हें मान्यता चाहिए।', ta: 'அதிகாரமுள்ள, பெருமையான, தொழில்சார், கண்ணியமான. உங்கள் துணைவர் வலுவான அடையாளம் கொண்டவர், அங்கீகாரம் தேவை. தலைமைக்கு ஈர்க்கப்படலாம், சூரிய ஒளியைக் கொண்டிருக்கலாம்.', te: 'అధికారిక, గర్వంగల, వృత్తి ఆధారిత, గౌరవప్రదమైన. మీ భాగస్వామికి బలమైన గుర్తింపు ఉంది, గుర్తింపు అవసరం.', bn: 'কর্তৃত্বশীল, গর্বিত, কর্মজীবন-চালিত, মর্যাদাশীল। আপনার সঙ্গীর শক্তিশালী পরিচয় আছে ও স্বীকৃতি প্রয়োজন।', kn: 'ಅಧಿಕಾರಯುತ, ಹೆಮ್ಮೆಯ, ವೃತ್ತಿ-ಚಾಲಿತ, ಘನತೆಯ. ನಿಮ್ಮ ಸಂಗಾತಿಗೆ ಬಲಿಷ್ಠ ಗುರುತು ಇದೆ ಮತ್ತು ಮನ್ನಣೆ ಅಗತ್ಯ.', gu: 'અધિકારયુક્ત, ગર્વિષ્ઠ, કારકિર્દી-ચાલિત, ગૌરવશાળી. તમારા સાથીને મજબૂત ઓળખ છે અને માન્યતા જરૂરી.' }, dynamic: { en: 'Power balance is crucial. Two suns create friction unless roles are clearly defined. The relationship thrives when both have their own domain of authority — and the wisdom to respect each other\'s.', hi: 'शक्ति सन्तुलन महत्वपूर्ण है। दोनों की अलग-अलग अधिकार-भूमिकाएँ होनी चाहिए।' } },
  Moon:    { nature: { en: 'Nurturing, emotionally sensitive, family-oriented, and deeply caring. Your partner feels deeply and gives deeply — but also needs consistent emotional reassurance and security.', hi: 'पोषणकारी, भावनात्मक रूप से संवेदनशील, पारिवारिक। साथी गहराई से महसूस और देते हैं।', sa: 'पोषणकारी, भावनात्मक रूप से संवेदनशील, पारिवारिक। साथी गहराई से महसूस और देते हैं।', mai: 'पोषणकारी, भावनात्मक रूप से संवेदनशील, पारिवारिक। साथी गहराई से महसूस और देते हैं।', mr: 'पोषणकारी, भावनात्मक रूप से संवेदनशील, पारिवारिक। साथी गहराई से महसूस और देते हैं।', ta: 'வளர்ப்பு, உணர்ச்சிரீதியாக உணர்திறன் கொண்ட, குடும்ப சார்ந்த, ஆழமாக அக்கறை கொண்ட. உங்கள் துணைவர் ஆழமாக உணர்கிறார், ஆழமாக கொடுக்கிறார் — ஆனால் நிலையான உணர்ச்சி உறுதிப்பாடும் பாதுகாப்பும் தேவை.', te: 'పోషక, భావోద్వేగపరంగా సున్నితమైన, కుటుంబ ఆధారిత, లోతుగా శ్రద్ధగల. మీ భాగస్వామి లోతుగా అనుభవిస్తారు, లోతుగా ఇస్తారు — కానీ స్థిరమైన భావోద్వేగ భరోసా మరియు భద్రత కూడా అవసరం.', bn: 'লালনকারী, আবেগে সংবেদনশীল, পরিবারমুখী, গভীর যত্নশীল। আপনার সঙ্গী গভীরভাবে অনুভব ও দেয় — কিন্তু ধারাবাহিক আবেগজ আশ্বাস ও নিরাপত্তাও প্রয়োজন।', kn: 'ಪೋಷಕ, ಭಾವನಾತ್ಮಕವಾಗಿ ಸೂಕ್ಷ್ಮ, ಕುಟುಂಬ ಕೇಂದ್ರಿತ, ಆಳವಾಗಿ ಕಾಳಜಿ ವಹಿಸುವ. ನಿಮ್ಮ ಸಂಗಾತಿ ಆಳವಾಗಿ ಅನುಭವಿಸುತ್ತಾರೆ, ಆಳವಾಗಿ ನೀಡುತ್ತಾರೆ — ಆದರೆ ಸ್ಥಿರ ಭಾವನಾತ್ಮಕ ಭರವಸೆ ಮತ್ತು ಸುರಕ್ಷತೆ ಅಗತ್ಯ.', gu: 'પાલનકર્તા, ભાવનાત્મક રીતે સંવેદનશીલ, કુટુંબલક્ષી, ઊંડી કાળજી. તમારા સાથી ઊંડેથી અનુભવે છે, ઊંડેથી આપે છે — પણ સતત ભાવનાત્મક ખાતરી અને સુરક્ષા પણ જોઈએ.' }, dynamic: { en: 'This partnership runs on emotional currency. Feeling seen, safe, and cared for matters more than logic or achievement. Home, family, and shared roots anchor the bond. Neglect emotional maintenance at your peril.', hi: 'यह साझेदारी भावनात्मक मुद्रा पर चलती है। देखा-सुना महसूस करना तर्क से अधिक मायने रखता है।', sa: 'यह साझेदारी भावनात्मक मुद्रा पर चलती है। देखा-सुना महसूस करना तर्क से अधिक मायने रखता है।', mai: 'यह साझेदारी भावनात्मक मुद्रा पर चलती है। देखा-सुना महसूस करना तर्क से अधिक मायने रखता है।', mr: 'यह साझेदारी भावनात्मक मुद्रा पर चलती है। देखा-सुना महसूस करना तर्क से अधिक मायने रखता है।', ta: 'இந்த கூட்டாண்மை உணர்ச்சி நாணயத்தில் இயங்குகிறது. பார்க்கப்படுவது, பாதுகாப்பாக உணர்வது, கவனிக்கப்படுவது ஆகியவை தர்க்கம் அல்லது சாதனையை விட முக்கியம். வீடு, குடும்பம் மற்றும் பகிரப்பட்ட வேர்கள் பிணைப்பை நங்கூரமிடுகின்றன. உணர்ச்சிப் பராமரிப்பை புறக்கணித்தால் ஆபத்து.', te: 'ఈ భాగస్వామ్యం భావోద్వేగ ద్రవ్యంపై నడుస్తుంది. చూడబడటం, సురక్షితంగా భావించడం, సంరక్షించబడటం తర్కం లేదా సాధన కంటే ఎక్కువ ముఖ్యం. ఇల్లు, కుటుంబం మరియు భాగస్వామ్య మూలాలు బంధాన్ని లంగరు వేస్తాయి. భావోద్వేగ నిర్వహణను నిర్లక్ష్యం చేయడం ప్రమాదకరం.', bn: 'এই সম্পর্ক আবেগজ মুদ্রায় চলে। দেখা, নিরাপদ ও যত্নবান অনুভব করা যুক্তি বা অর্জনের চেয়ে বেশি গুরুত্বপূর্ণ। ঘর, পরিবার ও ভাগাভাগি শিকড় বন্ধনকে নোঙর করে। আবেগজ রক্ষণাবেক্ষণ অবহেলা করলে বিপদ।', kn: 'ಈ ಪಾಲುದಾರಿಕೆ ಭಾವನಾತ್ಮಕ ನಾಣ್ಯದ ಮೇಲೆ ನಡೆಯುತ್ತದೆ. ನೋಡಲ್ಪಡುವುದು, ಸುರಕ್ಷಿತವಾಗಿ ಅನುಭವಿಸುವುದು, ಆರೈಕೆ ಪಡೆಯುವುದು ತರ್ಕ ಅಥವಾ ಸಾಧನೆಗಿಂತ ಹೆಚ್ಚು ಮುಖ್ಯ. ಮನೆ, ಕುಟುಂಬ ಮತ್ತು ಹಂಚಿಕೊಂಡ ಬೇರುಗಳು ಬಂಧವನ್ನು ಲಂಗರು ಹಾಕುತ್ತವೆ. ಭಾವನಾತ್ಮಕ ನಿರ್ವಹಣೆ ನಿರ್ಲಕ್ಷಿಸಿದರೆ ಅಪಾಯ.', gu: 'આ ભાગીદારી ભાવનાત્મક ચલણ પર ચાલે છે. જોવામાં આવવું, સુરક્ષિત અનુભવવું, સંભાળ મળવી તર્ક કે સિદ્ધિ કરતાં વધુ મહત્વનું છે. ઘર, કુટુંબ અને વહેંચાયેલા મૂળ બંધનને લંગર કરે છે. ભાવનાત્મક જાળવણીની ઉપેક્ષા જોખમી છે.' } },
  Mars:    { nature: { en: 'Energetic, assertive, physically driven, and passionately expressive. Your partner acts first and thinks later, brings intense vitality to the relationship, and may have a short fuse.', hi: 'ऊर्जावान, मुखर, शारीरिक रूप से सक्रिय। साथी पहले कार्य करते हैं, बाद में सोचते हैं।', sa: 'ऊर्जावान, मुखर, शारीरिक रूप से सक्रिय। साथी पहले कार्य करते हैं, बाद में सोचते हैं।', mai: 'ऊर्जावान, मुखर, शारीरिक रूप से सक्रिय। साथी पहले कार्य करते हैं, बाद में सोचते हैं।', mr: 'ऊर्जावान, मुखर, शारीरिक रूप से सक्रिय। साथी पहले कार्य करते हैं, बाद में सोचते हैं।', ta: 'ஆற்றல் மிக்க, உறுதியான, உடல் சார்ந்த, ஆர்வமாக வெளிப்படுத்தும். உங்கள் துணைவர் முதலில் செயல்படுவார், பின் சிந்திப்பார், உறவில் தீவிர உயிர்ச்சக்தியை கொண்டுவருவார்.', te: 'శక్తివంతమైన, నిశ్చయాత్మకమైన, శారీరకంగా చోదితమైన, ఆవేశంగా వ్యక్తీకరించే. మీ భాగస్వామి ముందు చర్య తీసుకుంటారు తర్వాత ఆలోచిస్తారు, సంబంధానికి తీవ్రమైన శక్తిని తెస్తారు.', bn: 'উদ্যমী, দৃঢ়চেতা, শারীরিকভাবে চালিত, আবেগের সাথে প্রকাশশীল। আপনার সঙ্গী আগে কাজ করে পরে ভাবে, সম্পর্কে তীব্র প্রাণশক্তি আনে।', kn: 'ಶಕ್ತಿಶಾಲಿ, ದೃಢ, ಶಾರೀರಿಕವಾಗಿ ಚಾಲಿತ, ಉತ್ಸಾಹದಿಂದ ಅಭಿವ್ಯಕ್ತಿಸುವ. ನಿಮ್ಮ ಸಂಗಾತಿ ಮೊದಲು ಕ್ರಿಯೆ ಮಾಡುತ್ತಾರೆ ನಂತರ ಯೋಚಿಸುತ್ತಾರೆ, ಸಂಬಂಧಕ್ಕೆ ತೀವ್ರ ಚೈತನ್ಯ ತರುತ್ತಾರೆ.', gu: 'ઉર્જાવાન, દ્રઢ, શારીરિક રીતે ચાલિત, ઉત્સાહથી વ્યક્ત કરનાર. તમારા સાથી પહેલાં કાર્ય કરે પછી વિચારે, સંબંધમાં તીવ્ર જીવનશક્તિ લાવે.' }, dynamic: { en: 'This is a high-energy partnership. There will be friction, passion, and intensity. It needs physical vitality and healthy competition to stay alive. Monotony kills it. Conflict, handled maturely, makes it stronger.', hi: 'यह उच्च-ऊर्जा साझेदारी है। घर्षण और जुनून होगा। शारीरिक जीवन्तता से सम्बन्ध जीवित रहता है।', sa: 'यह उच्च-ऊर्जा साझेदारी है। घर्षण और जुनून होगा। शारीरिक जीवन्तता से सम्बन्ध जीवित रहता है।', mai: 'यह उच्च-ऊर्जा साझेदारी है। घर्षण और जुनून होगा। शारीरिक जीवन्तता से सम्बन्ध जीवित रहता है।', mr: 'यह उच्च-ऊर्जा साझेदारी है। घर्षण और जुनून होगा। शारीरिक जीवन्तता से सम्बन्ध जीवित रहता है।', ta: 'இது உயர் ஆற்றல் கூட்டாண்மை. உராய்வு, உணர்வு மற்றும் தீவிரம் இருக்கும். உயிர்ப்புடன் இருக்க உடல் வலிமை மற்றும் ஆரோக்கியமான போட்டி தேவை. ஒரே மாதிரி அதைக் கொல்லும். முதிர்ச்சியாக கையாளப்படும் மோதல் அதை வலிமையாக்கும்.', te: 'ఇది అధిక శక్తి భాగస్వామ్యం. ఘర్షణ, ఉద్వేగం మరియు తీవ్రత ఉంటాయి. జీవంగా ఉండటానికి శారీరక చైతన్యం మరియు ఆరోగ్యకరమైన పోటీ అవసరం. ఏకరీతి దానిని చంపుతుంది. పరిణతిగా నిర్వహించబడే ఘర్షణ దానిని బలంగా చేస్తుంది.', bn: 'এটি একটি উচ্চ-শক্তি সম্পর্ক। ঘর্ষণ, আবেগ এবং তীব্রতা থাকবে। জীবিত থাকতে শারীরিক প্রাণশক্তি ও সুস্থ প্রতিযোগিতা দরকার। একঘেয়েমি এটি মারে। পরিণতভাবে পরিচালিত সংঘাত এটিকে শক্তিশালী করে।', kn: 'ಇದು ಉನ್ನತ ಶಕ್ತಿಯ ಪಾಲುದಾರಿಕೆ. ಘರ್ಷಣೆ, ಉತ್ಸಾಹ ಮತ್ತು ತೀವ್ರತೆ ಇರುತ್ತದೆ. ಜೀವಂತವಾಗಿರಲು ದೈಹಿಕ ಚೈತನ್ಯ ಮತ್ತು ಆರೋಗ್ಯಕರ ಸ್ಪರ್ಧೆ ಬೇಕು. ಏಕತಾನತೆ ಅದನ್ನು ಕೊಲ್ಲುತ್ತದೆ. ಪ್ರಬುದ್ಧವಾಗಿ ನಿರ್ವಹಿಸಿದ ಸಂಘರ್ಷ ಅದನ್ನು ಬಲಪಡಿಸುತ್ತದೆ.', gu: 'આ ઉચ્ચ-ઊર્જા ભાગીદારી છે. ઘર્ષણ, જુસ્સો અને તીવ્રતા હશે. જીવંત રહેવા શારીરિક ચેતના અને તંદુરસ્ત સ્પર્ધા જરૂરી છે. એકવિધતા તેને મારે છે. પરિપક્વ રીતે સંભાળાયેલ સંઘર્ષ તેને મજબૂત બનાવે છે.' } },
  Mercury: { nature: { en: 'Intellectually sharp, communicative, playful, and youthful in spirit. Your partner engages through ideas and conversation. They may be versatile, restless, and need mental stimulation constantly.', hi: 'बौद्धिक रूप से तेज, संवादशील, चुलबुले। साथी विचारों और बातचीत से जुड़ते हैं।', sa: 'बौद्धिक रूप से तेज, संवादशील, चुलबुले। साथी विचारों और बातचीत से जुड़ते हैं।', mai: 'बौद्धिक रूप से तेज, संवादशील, चुलबुले। साथी विचारों और बातचीत से जुड़ते हैं।', mr: 'बौद्धिक रूप से तेज, संवादशील, चुलबुले। साथी विचारों और बातचीत से जुड़ते हैं।', ta: 'அறிவுசார் கூர்மையான, தகவல்தொடர்புடைய, விளையாட்டான, ஆன்மாவில் இளமையான. உங்கள் துணைவர் கருத்துக்கள் மற்றும் உரையாடல் மூலம் ஈடுபடுவார்.', te: 'బౌద్ధికంగా పదునైన, సంభాషణాత్మక, ఆటపట్టిక, ఆత్మలో యువతరం. మీ భాగస్వామి ఆలోచనలు మరియు సంభాషణ ద్వారా నిమగ్నమవుతారు.', bn: 'বুদ্ধিমত্তায় তীক্ষ্ণ, যোগাযোগশীল, খেলাধুলো, মনে তরুণ। আপনার সঙ্গী ধারণা ও কথোপকথনের মাধ্যমে সম্পৃক্ত হয়।', kn: 'ಬೌದ್ಧಿಕವಾಗಿ ಚುರುಕು, ಸಂವಹನಶೀಲ, ಆಟಿಕೆ, ಆತ್ಮದಲ್ಲಿ ಯೌವನ. ನಿಮ್ಮ ಸಂಗಾತಿ ವಿಚಾರಗಳು ಮತ್ತು ಸಂಭಾಷಣೆಯ ಮೂಲಕ ತೊಡಗಿಕೊಳ್ಳುತ್ತಾರೆ.', gu: 'બૌદ્ધિક રીતે તીક્ષ્ણ, સંવાદશીલ, રમતિયાળ, આત્મામાં યુવાન. તમારા સાથી વિચારો અને વાતચીત દ્વારા જોડાય.' }, dynamic: { en: 'Communication is everything. A partner who doesn\'t talk, think, or grow intellectually will not hold your attention long. The relationship feeds on wit, debate, and shared curiosity — it must keep learning together.', hi: 'संवाद सब कुछ है। बुद्धि और साझा जिज्ञासा से सम्बन्ध पोषित होता है।' } },
  Jupiter: { nature: { en: 'Wise, generous, philosophical, and morally grounded. Your partner has a teacher quality — they guide and expand you. They may be religious or spiritual, well-educated, and known for their integrity.', hi: 'बुद्धिमान, उदार, दार्शनिक और नैतिक। आपके साथी में गुरु का गुण है।', sa: 'बुद्धिमान, उदार, दार्शनिक और नैतिक। आपके साथी में गुरु का गुण है।', mai: 'बुद्धिमान, उदार, दार्शनिक और नैतिक। आपके साथी में गुरु का गुण है।', mr: 'बुद्धिमान, उदार, दार्शनिक और नैतिक। आपके साथी में गुरु का गुण है।', ta: 'ஞானமுள்ள, தாராளமான, தத்துவமான, நெறிமுறையில் நிலைத்த. உங்கள் துணைவர் ஆசிரியர் குணம் கொண்டவர் — உங்களை வழிநடத்துவார் மற்றும் விரிவாக்குவார்.', te: 'జ్ఞానవంతుడు, ఉదారుడు, తాత్విక, నైతికంగా స్థిరమైన. మీ భాగస్వామికి గురువు లక్షణం ఉంది — మిమ్మల్ని మార్గదర్శనం చేస్తారు మరియు విస్తరిస్తారు.', bn: 'জ্ঞানী, উদার, দার্শনিক, নৈতিকভাবে দৃঢ়। আপনার সঙ্গীর শিক্ষক গুণ আছে — তারা আপনাকে গাইড করে ও প্রসারিত করে।', kn: 'ಜ್ಞಾನಿ, ಉದಾರ, ತಾತ್ವಿಕ, ನೈತಿಕವಾಗಿ ಸ್ಥಿರ. ನಿಮ್ಮ ಸಂಗಾತಿಗೆ ಗುರು ಗುಣ ಇದೆ — ನಿಮ್ಮನ್ನು ಮಾರ್ಗದರ್ಶನ ಮಾಡುತ್ತಾರೆ ಮತ್ತು ವಿಸ್ತರಿಸುತ್ತಾರೆ.', gu: 'જ્ઞાની, ઉદાર, દાર્શનિક, નૈતિક રીતે મજબૂત. તમારા સાથીમાં શિક્ષક ગુણ છે — તમને માર્ગદર્શન આપે અને વિસ્તૃત કરે.' }, dynamic: { en: 'This partnership is built on wisdom, shared values, and mutual growth. There\'s a teacher-student dynamic — in the best sense: both make each other wiser. Shared dharma and life philosophy are the foundation. Without shared values, the bond has no centre.', hi: 'यह साझेदारी ज्ञान और साझा मूल्यों पर बनी है। साझा धर्म इसकी नींव है।' } },
  Venus:   { nature: { en: 'Beautiful (inner or outer), artistic, pleasure-loving, and relationship-centred. Your partner brings grace, aesthetic sensibility, and social charm. They value comfort and harmony intensely and may avoid all conflict.', hi: 'सुन्दर, कलात्मक, सुख-प्रेमी। साथी जीवन में सौन्दर्यशास्त्र और सामाजिक आकर्षण लाते हैं।', sa: 'सुन्दर, कलात्मक, सुख-प्रेमी। साथी जीवन में सौन्दर्यशास्त्र और सामाजिक आकर्षण लाते हैं।', mai: 'सुन्दर, कलात्मक, सुख-प्रेमी। साथी जीवन में सौन्दर्यशास्त्र और सामाजिक आकर्षण लाते हैं।', mr: 'सुन्दर, कलात्मक, सुख-प्रेमी। साथी जीवन में सौन्दर्यशास्त्र और सामाजिक आकर्षण लाते हैं।', ta: 'அழகான (உள் அல்லது வெளி), கலைத்திறன் கொண்ட, இன்பம் விரும்பும், உறவு மையமான. உங்கள் துணைவர் கண்ணியம், அழகியல் உணர்வு மற்றும் சமூக கவர்ச்சியைக் கொண்டுவருவார்.', te: 'అందమైన (లోపలి లేదా బయటి), కళాత్మక, ఆనందప్రియ, సంబంధ కేంద్రిత. మీ భాగస్వామి గొప్పతనం, సౌందర్య సున్నితత్వం మరియు సామాజిక ఆకర్షణ తెస్తారు.', bn: 'সুন্দর (ভিতরে বা বাইরে), শৈল্পিক, আনন্দপ্রিয়, সম্পর্ককেন্দ্রিক। আপনার সঙ্গী মার্জিততা, নান্দনিক সংবেদনশীলতা ও সামাজিক আকর্ষণ আনে।', kn: 'ಸುಂದರ (ಒಳ ಅಥವಾ ಹೊರ), ಕಲಾತ್ಮಕ, ಸುಖಪ್ರಿಯ, ಸಂಬಂಧ ಕೇಂದ್ರಿತ. ನಿಮ್ಮ ಸಂಗಾತಿ ಮೋಹಕತೆ, ಸೌಂದರ್ಯ ಸಂವೇದನಶೀಲತೆ ಮತ್ತು ಸಾಮಾಜಿಕ ಆಕರ್ಷಣೆ ತರುತ್ತಾರೆ.', gu: 'સુંદર (અંદર કે બહાર), કલાત્મક, આનંદપ્રિય, સંબંધકેન્દ્રી. તમારા સાથી ગ્રેસ, સૌંદર્ય સંવેદનશીલતા અને સામાજિક આકર્ષણ લાવે.' }, dynamic: { en: 'This is a deeply romantic partnership that values beauty, pleasure, and harmony. Conflict and ugliness are handled poorly — the bond needs to be maintained with affection, aesthetic nourishment, and consistent tenderness.', hi: 'यह गहरी रोमांटिक साझेदारी है जो सौन्दर्य और सामंजस्य को महत्व देती है।', sa: 'यह गहरी रोमांटिक साझेदारी है जो सौन्दर्य और सामंजस्य को महत्व देती है।', mai: 'यह गहरी रोमांटिक साझेदारी है जो सौन्दर्य और सामंजस्य को महत्व देती है।', mr: 'यह गहरी रोमांटिक साझेदारी है जो सौन्दर्य और सामंजस्य को महत्व देती है।', ta: 'இது அழகு, இன்பம் மற்றும் இசைவை மதிக்கும் ஆழமான காதல் கூட்டாண்மை. மோதல் மற்றும் அசிங்கம் மோசமாக கையாளப்படுகிறது — பிணைப்பை பாசம், அழகியல் ஊட்டம் மற்றும் நிலையான மென்மையுடன் பராமரிக்க வேண்டும்.', te: 'ఇది అందం, ఆనందం మరియు సామరస్యాన్ని విలువగా ఉంచే తీవ్రమైన ప్రేమ భాగస్వామ్యం. ఘర్షణ మరియు వికారం బాగా నిర్వహించబడవు — ఆప్యాయత, సౌందర్య పోషణ మరియు నిలకడ సున్నితత్వంతో బంధాన్ని నిర్వహించాలి.', bn: 'এটি সৌন্দর্য, আনন্দ ও সংহতি মূল্যায়নকারী গভীর রোমান্টিক সম্পর্ক। সংঘাত ও কদর্যতা খারাপভাবে মোকাবেলা করা হয় — স্নেহ, নান্দনিক পুষ্টি ও ধারাবাহিক কোমলতায় বন্ধন রক্ষণাবেক্ষণ করতে হবে।', kn: 'ಇದು ಸೌಂದರ್ಯ, ಆನಂದ ಮತ್ತು ಸಾಮರಸ್ಯವನ್ನು ಗೌರವಿಸುವ ಆಳವಾದ ಪ್ರಣಯ ಪಾಲುದಾರಿಕೆ. ಸಂಘರ್ಷ ಮತ್ತು ಕೊಳಕುತನ ಕಳಪೆಯಾಗಿ ನಿರ್ವಹಿಸಲ್ಪಡುತ್ತದೆ — ಪ್ರೀತಿ, ಸೌಂದರ್ಯ ಪೋಷಣೆ ಮತ್ತು ಸ್ಥಿರ ಮೃದುತ್ವದಿಂದ ಬಂಧವನ್ನು ನಿರ್ವಹಿಸಬೇಕು.', gu: 'આ સુંદરતા, આનંદ અને સુમેળને મૂલ્ય આપતી ગહન રોમેન્ટિક ભાગીદારી છે. સંઘર્ષ અને કદરૂપતા ખરાબ રીતે સંભાળાય છે — સ્નેહ, સૌંદર્ય પોષણ અને સતત કોમળતા સાથે બંધન જાળવવું જરૂરી છે.' } },
  Saturn:  { nature: { en: 'Mature, responsible, disciplined, and deeply committed. Your partner may be older, more serious, or someone who has been tested by life. They bring stability, loyalty, and a long-term perspective that other partners may lack.', hi: 'परिपक्व, जिम्मेदार, अनुशासित। साथी बड़े, अधिक गम्भीर, या जीवन से परखे हुए हो सकते हैं।', sa: 'परिपक्व, जिम्मेदार, अनुशासित। साथी बड़े, अधिक गम्भीर, या जीवन से परखे हुए हो सकते हैं।', mai: 'परिपक्व, जिम्मेदार, अनुशासित। साथी बड़े, अधिक गम्भीर, या जीवन से परखे हुए हो सकते हैं।', mr: 'परिपक्व, जिम्मेदार, अनुशासित। साथी बड़े, अधिक गम्भीर, या जीवन से परखे हुए हो सकते हैं।', ta: 'முதிர்ச்சியான, பொறுப்பான, ஒழுக்கமான, ஆழமாக அர்ப்பணிப்புள்ள. உங்கள் துணைவர் வயதானவராகவோ, தீவிரமானவராகவோ, வாழ்க்கையால் சோதிக்கப்பட்டவராகவோ இருக்கலாம். நிலைத்தன்மை, விசுவாசம் மற்றும் நீண்டகால கண்ணோட்டத்தைக் கொண்டுவருவார்.', te: 'పరిపక్వమైన, బాధ్యతాయుతమైన, క్రమశిక్షణాబద్ధమైన, లోతుగా అంకితమైన. మీ భాగస్వామి వయసులో పెద్దవారు, తీవ్రంగా ఉండవచ్చు, లేదా జీవితం పరీక్షించిన వ్యక్తి. స్థిరత్వం, విశ్వసనీయత మరియు దీర్ఘకాలిక దృష్టి తెస్తారు.', bn: 'পরিণত, দায়িত্বশীল, শৃঙ্খলাবদ্ধ, গভীরভাবে প্রতিশ্রুতিবদ্ধ। আপনার সঙ্গী বয়সে বড়, বেশি গুরুতর, বা জীবনে পরীক্ষিত হতে পারেন। স্থিতিশীলতা, আনুগত্য ও দীর্ঘমেয়াদী দৃষ্টিভঙ্গি আনেন।', kn: 'ಪಕ್ವ, ಜವಾಬ್ದಾರಿಯುತ, ಶಿಸ್ತುಬದ್ಧ, ಆಳವಾಗಿ ಬದ್ಧ. ನಿಮ್ಮ ಸಂಗಾತಿ ವಯಸ್ಸಿನಲ್ಲಿ ಹಿರಿಯ, ಗಂಭೀರ, ಅಥವಾ ಜೀವನದಿಂದ ಪರೀಕ್ಷಿಸಲ್ಪಟ್ಟವ ಆಗಿರಬಹುದು. ಸ್ಥಿರತೆ, ನಿಷ್ಠೆ ಮತ್ತು ದೀರ್ಘಾವಧಿ ದೃಷ್ಟಿಕೋನ ತರುತ್ತಾರೆ.', gu: 'પરિપક્વ, જવાબદાર, શિસ્તબદ્ધ, ઊંડી પ્રતિબદ્ધતા. તમારા સાથી ઉંમરમાં મોટા, વધુ ગંભીર, કે જીવનથી કસોટી પામેલા હોઈ શકે. સ્થિરતા, વફાદારી અને લાંબા ગાળાનો દૃષ્ટિકોણ લાવે.' }, dynamic: { en: 'This partnership is built for the long haul, not the honeymoon. It deepens with time, shared challenge, and struggle. Romance may be understated, but loyalty and reliability run bone-deep. Do not mistake slowness for coldness — Saturn love is proven over decades, not days.', hi: 'यह साझेदारी लम्बे समय के लिए बनी है। धीरेपन को ठंडक मत समझें — शनि का प्रेम दशकों में सिद्ध होता है।', sa: 'यह साझेदारी लम्बे समय के लिए बनी है। धीरेपन को ठंडक मत समझें — शनि का प्रेम दशकों में सिद्ध होता है।', mai: 'यह साझेदारी लम्बे समय के लिए बनी है। धीरेपन को ठंडक मत समझें — शनि का प्रेम दशकों में सिद्ध होता है।', mr: 'यह साझेदारी लम्बे समय के लिए बनी है। धीरेपन को ठंडक मत समझें — शनि का प्रेम दशकों में सिद्ध होता है।', ta: 'இந்த கூட்டாண்மை நீண்ட பயணத்திற்கு கட்டப்பட்டது, தேனிலவுக்கு அல்ல. நேரம், பகிரப்பட்ட சவால் மற்றும் போராட்டத்துடன் ஆழமாகிறது. காதல் அடக்கமாக இருக்கலாம், ஆனால் விசுவாசம் மற்றும் நம்பகத்தன்மை எலும்புக்குள் ஆழமாக ஓடுகிறது. மெதுவை குளிர்ச்சி என்று தவறாக நினைக்காதீர்கள் — சனி காதல் நாட்களால் அல்ல, தசாப்தங்களால் நிரூபிக்கப்படுகிறது.', te: 'ఈ భాగస్వామ్యం దీర్ఘకాలానికి నిర్మించబడింది, హనీమూన్‌కు కాదు. సమయం, భాగస్వామ్య సవాలు మరియు పోరాటంతో లోతుపడుతుంది. ప్రేమ తక్కువగా చెప్పబడవచ్చు, కానీ విశ్వసనీయత మరియు నమ్మకత్వం ఎముకల లోతులో ఉంటాయి. నెమ్మదిని చల్లదనంగా పొరపడకండి — శని ప్రేమ రోజులతో కాదు, దశాబ్దాలతో నిరూపించబడుతుంది.', bn: 'এই সম্পর্ক দীর্ঘ পথের জন্য তৈরি, মধুচন্দ্রিমার জন্য নয়। সময়, ভাগাভাগি চ্যালেঞ্জ ও সংগ্রামের সাথে গভীর হয়। রোমান্স অপ্রকাশিত হতে পারে, কিন্তু আনুগত্য ও নির্ভরযোগ্যতা হাড়ের গভীরে চলে। ধীরতাকে ঠান্ডা ভেবে ভুল করবেন না — শনির প্রেম দিনে নয়, দশকে প্রমাণিত হয়।', kn: 'ಈ ಪಾಲುದಾರಿಕೆ ದೀರ್ಘ ಪ್ರಯಾಣಕ್ಕೆ ನಿರ್ಮಿಸಲ್ಪಟ್ಟಿದೆ, ಹನಿಮೂನ್‌ಗೆ ಅಲ್ಲ. ಸಮಯ, ಹಂಚಿಕೊಂಡ ಸವಾಲು ಮತ್ತು ಹೋರಾಟದೊಂದಿಗೆ ಆಳವಾಗುತ್ತದೆ. ಪ್ರಣಯ ಅಡಗಿಸಲ್ಪಟ್ಟಿರಬಹುದು, ಆದರೆ ನಿಷ್ಠೆ ಮತ್ತು ವಿಶ್ವಾಸಾರ್ಹತೆ ಮೂಳೆಯೊಳಗೆ ಆಳವಾಗಿ ಹರಿಯುತ್ತದೆ. ನಿಧಾನತೆಯನ್ನು ಶೀತಲತೆ ಎಂದು ತಪ್ಪಾಗಿ ಭಾವಿಸಬೇಡಿ — ಶನಿ ಪ್ರೀತಿ ದಿನಗಳಲ್ಲಲ್ಲ, ದಶಕಗಳಲ್ಲಿ ಸಾಬೀತಾಗುತ್ತದೆ.', gu: 'આ ભાગીદારી લાંબા સફર માટે બનેલી છે, મધુચંદ્ર માટે નહીં. સમય, વહેંચાયેલ પડકાર અને સંઘર્ષ સાથે ઊંડી થાય છે. રોમાન્સ અલ્પોક્ત હોઈ શકે, પણ વફાદારી અને વિશ્વસનીયતા હાડકાં સુધી ઊંડી ચાલે છે. ધીમાપણાને ઠંડક ન સમજો — શનિનો પ્રેમ દિવસોમાં નહીં, દાયકાઓમાં સાબિત થાય છે.' } },
};
