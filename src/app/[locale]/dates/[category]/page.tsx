...
const EXPLANATIONS: Record<Category, { en: string[]; hi: string[] }> = {
  ...
  pradosham: {
    en: [
      ...
      'Shani Pradosham (Saturday) combines Saturn\'s karmic discipline with Shiva\'s transformative power -- recommended for those undergoing Sade Sati. Soma Pradosham (Monday) links the Moon\'s emotional healing with Shiva worship. The Pradosham puja involves lighting a ghee lamp at twilight, offering bilva leaves, and chanting Maha Mrityunjaya Mantra.',
    ...
    hi: [
      ...
      'शनि प्रदोष (शनिवार) शनि की कर्म-शक्ति और शिव की रूपान्तरण शक्ति का संयोग है -- साढ़े साती वालों के लिए विशेष। सोम प्रदोष (सोमवार) मानसिक शान्ति के लिए प्रसिद्ध है। प्रदोष पूजा में सन्ध्याकाल में घी का दीपक, बिल्व पत्र और महामृत्युञ्जय मन्त्र का पाठ शामिल है।',
