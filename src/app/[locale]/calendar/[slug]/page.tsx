...
const LABELS = {
  back: { en: 'Back to Calendar', hi: 'कैलेंडर पर वापस', sa: 'पञ्चाङ्गं प्रति', ta: 'நாட்காட்டிக்குத் திரும்பு', te: 'క్యాలెండర్‌కు తిరిగి', bn: 'ক্যালেন্ডারে ফিরুন', kn: 'ಕ್ಯಾಲೆಂಡರ್‌ಗೆ ಹಿಂತಿರುಗಿ' },
  about: { en: 'About', hi: 'परिचय', sa: 'परिचयः', ta: 'பற்றி', te: 'పరిచయం', bn: 'পরিচয়', kn: 'ಪರಿಚಯ' },
  deity: { en: 'Deity', hi: 'देवता', sa: 'देवता', ta: 'தெய்வம்', te: 'దేవత', bn: 'দেবতা', kn: 'ದೇವತೆ' },
  mythology: { en: 'Story & Origin', hi: 'कथा एवं उत्पत्ति', sa: 'कथा उत्पत्तिश्च', ta: 'கதை & தோற்றம்', te: 'కథ & మూలం', bn: 'কাহিনী ও উৎপত্তি', kn: 'ಕಥೆ & ಮೂಲ' },
  observance: { en: 'How to Observe', hi: 'पालन विधि', sa: 'पालनविधिः', ta: 'எப்படி அனுசரிப்பது', te: 'ఎలా ఆచరించాలి', bn: 'কীভাবে পালন করবেন', kn: 'ಹೇಗೆ ಆಚರಿಸುವುದು' },
  significance: { en: 'Significance', hi: 'महत्व', sa: 'महत्त्वम्', ta: 'முக்கியத்துவம்', te: 'ప్రాముఖ్యత', bn: 'গুরুত্ব', kn: 'ಮಹತ್ವ' },
  fasting: { en: 'Fasting Rules', hi: 'व्रत नियम', sa: 'व्रतनियमाः', ta: 'விரத விதிகள்', te: 'వ్రత నియమాలు', bn: 'ব্রত নিয়ম', kn: 'ವ್ರತ ನಿಯಮಗಳು' },
  pujaVidhi: { en: 'Puja Vidhi', hi: 'पूजा विधि', sa: 'पूजाविधिः', ta: 'பூஜை விதி', te: 'పూజా విధి', bn: 'পূজা বিধি', kn: 'ಪೂಜಾ ವಿಧಿ' },
  muhurta: { en: 'Auspicious Timing (Muhurta)', hi: 'शुभ मुहूर्त', sa: 'शुभमुहूर्तम्', ta: 'நல்ல நேரம் (முகூர்த்தம்)', te: 'శుభ ముహూర్తం', bn: 'শুভ মুহূর্ত', kn: 'ಶುಭ ಮುಹೂರ್ತ' },
  samagri: { en: 'Materials (Samagri)', hi: 'सामग्री', sa: 'सामग्री', ta: 'சாமக்ரி (பொருட்கள்)', te: 'సామగ్రి (పదార్థాలు)', bn: 'সামগ্রী (উপকরণ)', kn: 'ಸಾಮಗ್ರಿ (ವಸ್ತುಗಳು)' },
  sankalpa: { en: 'Sankalpa (Sacred Resolve)', hi: 'संकल्प', sa: 'सङ्कल्पः', ta: 'சங்கல்பம்', te: 'సంకల్పం', bn: 'সংকল্প', kn: 'ಸಂಕಲ್ಪ' },
  procedure: { en: 'Puja Steps', hi: 'पूजा विधि', sa: 'पूजाविधिः', ta: 'பூஜை படிகள்', te: 'పూజ దశలు', bn: 'পূজার ধাপ', kn: 'ಪೂಜೆ ಹಂತಗಳು' },
  mantras: { en: 'Mantras', hi: 'मन्त्र', sa: 'मन्त्राः', ta: 'மந்திரங்கள்', te: 'మంత్రాలు', bn: 'মন্ত্র', kn: 'ಮಂತ್ರಗಳು' },
  stotras: { en: 'Stotras', hi: 'स्तोत्र', sa: 'स्तोत्राणि', ta: 'ஸ்தோத்திரங்கள்', te: 'స్తోత్రాలు', bn: 'স্তোত্র', kn: 'ಸ್ತೋತ್ರಗಳು' },
  aarti: { en: 'Aarti', hi: 'आरती', sa: 'आरतिः', ta: 'ஆரத்தி', te: 'ఆరతి', bn: 'আরতি', kn: 'ಆರತಿ' },
  naivedya: { en: 'Offering (Naivedya)', hi: 'नैवेद्य', sa: 'नैवेद्यम्', ta: 'நைவேத்யம்', te: 'నైవేద్యం', bn: 'নৈবেদ্য', kn: 'ನೈವೇದ್ಯ' },
  precautions: { en: 'Precautions', hi: 'सावधानियाँ', sa: 'सावधान्यानि', ta: 'எச்சரிக்கைகள்', te: 'జాగ్రత్తలు', bn: 'সাবধানতা', kn: 'ಎಚ್ಚರಿಕೆಗಳು' },
  phala: { en: 'Benefits (Phala)', hi: 'फल', sa: 'फलम्', ta: 'பலன்கள்', te: 'ఫలితాలు', bn: 'ফল', kn: 'ಫಲಗಳು' },
  visarjan: { en: 'Visarjan (Conclusion)', hi: 'विसर्जन', sa: 'विसर्जनम्', ta: 'விசர்ஜனம்', te: 'విసర్జన', bn: 'বিসর্জন', kn: 'ವಿಸರ್ಜನ' },
  ekadashiStory: { en: 'Legend', hi: 'कथा', sa: 'कथा', ta: 'புராணக்கதை', te: 'కథ', bn: 'কাহিনী', kn: 'ಕಥೆ' },
  ekadashiBenefit: { en: 'Benefit', hi: 'फल', sa: 'फलम्', ta: 'பலன்', te: 'ఫలం', bn: 'ফল', kn: 'ಫಲ' },
  notFound: { en: 'Festival details coming soon', hi: 'त्योहार विवरण शीघ्र आ रहा है', sa: 'उत्सवविवरणं शीघ्रम् आगच्छति', ta: 'பண்டிகை விவரங்கள் விரைவில் வரும்', te: 'పండుగ వివరాలు త్వరలో వస్తాయి', bn: 'উৎসবের বিবরণ শীঘ্রই আসছে', kn: 'ಹಬ್ಬದ ವಿವರಗಳು ಶೀಘ್ರದಲ್ಲೇ ಬರಲಿವೆ' },
  notFoundSub: { en: 'We are working on adding detailed information for this festival.', hi: 'हम इस त्योहार की विस्तृत जानकारी जोड़ने पर कार्य कर रहे हैं।', sa: 'अस्य उत्सवस्य विस्तृतं विवरणं योजयितुं वयं कार्यं कुर्मः।', ta: 'இந்த பண்டிகையின் விரிவான தகவல்களை சேர்க்க நாங்கள் பணியாற்றுகிறோம்.', te: 'ఈ పండుగ యొక్క వివరమైన సమాచారాన్ని జోడించడంపై పనిచేస్తున్నాము.', bn: 'আমরা এই উৎসবের বিস্তারিত তথ্য যোগ করতে কাজ করছি।', kn: 'ಈ ಹಬ್ಬದ ವಿವರವಾದ ಮಾಹಿತಿಯನ್ನು ಸೇರಿಸಲು ನಾವು ಕೆಲಸ ಮಾಡುತ್ತಿದ್ದೇವೆ.' },
  itemsSelected: { en: 'items collected', hi: 'सामग्री एकत्र', sa: 'सामग्री सङ्गृहीता', ta: 'பொருட்கள் சேகரிக்கப்பட்டன', te: 'సామగ్రి సేకరించబడింది', bn: 'উপকরণ সংগৃহীত', kn: 'ವಸ್ತುಗಳು ಸಂಗ್ರಹಿಸಲಾಗಿದೆ' },
  japaCount: { en: 'Japa Count', hi: 'जप संख्या', sa: 'जपसङ्ख्या', ta: 'ஜப எண்ணிக்கை', te: 'జప సంఖ్య', bn: 'জপ সংখ্যা', kn: 'ಜಪ ಸಂಖ್ಯೆ' },
};
