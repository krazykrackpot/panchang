        ...
        {active === 'badhaka' && (
          <motion.div key="badhaka" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }} className="space-y-6">
            ...
            <Glass className="p-4 overflow-x-auto">
              <h3 className="text-sm font-bold text-gold-light mb-3">{(locale !== 'hi' && String(locale) !== 'sa') ? 'Badhakesh for All 12 Lagnas' : locale === 'hi' ? 'सभी 12 लग्नों के बाधकेश' : 'सर्वेषां 12 लग्नानां बाधकेशः'}</h3>
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-gold-primary/20">
                    ...
                    <th className="text-left py-3 px-3 text-gold-light font-semibold">{(locale !== 'hi' && String(locale) !== 'sa') ? '2nd Lord (Maraka)' : locale === 'hi' ? '2रे भाव स्वामी' : 'द्वितीयभावस्वामी'}</th>
                    <th className="text-left py-3 px-3 text-gold-light font-semibold">{(locale !== 'hi' && String(locale) !== 'sa') ? '7th Lord (Maraka)' : locale === 'hi' ? '7वें भाव स्वामी' : 'सप्तमभावस्वामी'}</th>
                  </tr>
                </thead>
                <tbody>
