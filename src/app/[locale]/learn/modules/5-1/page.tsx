  ...
  return (
    <div className="space-y-6">
      ...
      <section className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-xl p-5 border border-blue-500/15">
        ...
        <p className="text-text-secondary text-xs leading-relaxed">
          {tl({ en: 'Tithi remains the most consulted element of the Panchang in modern India. Wedding dates, housewarming ceremonies, business launches, and religious observances are all planned according to tithi. Our application computes tithis with Swiss Ephemeris (based on NASA JPL DE ephemerides — sub-arcsecond Sun/Moon positions; Meeus is the documented fallback), achieving accuracy within one minute of professional ephemeris values.', hi: 'आधुनिक भारत में तिथि पंचांग का सर्वाधिक परामर्शित अंग बनी हुई है। विवाह तिथि, गृह प्रवेश, व्यापार आरम्भ और धार्मिक अनुष्ठान सभी तिथि के अनुसार नियोजित किये जाते हैं। हमारा अनुप्रयोग तिथि की गणना स्विस एफेमेरिस (NASA JPL DE एफेमेरिस पर आधारित — उप-आर्क-सेकंड सूर्य/चन्द्र स्थितियाँ; मीयस दस्तावेज़ीकृत फ़ॉलबैक) से करता है, जो व्यावसायिक पंचांग मूल्यों से एक मिनट के भीतर सटीक है।', sa: 'आधुनिक भारत में तिथि पंचांग का सर्वाधिक परामर्शित अंग बनी हुई है। विवाह तिथि, गृह प्रवेश, व्यापार आरम्भ और धार्मिक अनुष्ठान सभी तिथि के अनुसार नियोजित किये जाते हैं। हमारा अनुप्रयोग तिथि की गणना स्विस एफेमेरिस (NASA JPL DE आधारेण — उप-आर्क-सेकंड सूर्य/चन्द्र स्थितयः; मीयस दस्तावेज़ीकृत फ़ॉलबैक) से करता है, जो व्यावसायिक पंचांग मूल्यों से एक मिनट के भीतर सटीक है।' }, locale)}
        </p>
      </section>
    </div>
  );
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-xl p-5 border border-blue-500/15">
        <h4 className="text-blue-300 text-xs uppercase tracking-widest font-bold mb-3">{tl({ en: 'Modern Relevance', hi: 'आधुनिक प्रासंगिकता', sa: 'आधुनिकी प्रासङ्गिकता' }, locale)}</h4>
        <p className="text-text-secondary text-xs leading-relaxed">
          {tl({ en: 'Accurate tithi computation is essential for any digital Panchang. Our application uses Swiss Ephemeris (sub-arcsecond Sun/Moon positions; Meeus is the documented fallback) to compute precise Sun and Moon longitudes, then derives tithis using the elongation formula described above. The dwi-tithi rule is programmatically implemented to correctly assign festivals to the right Gregorian date, matching leading panchang sources to within one minute.', hi: 'किसी भी डिजिटल पंचांग के लिए सटीक तिथि गणना अनिवार्य है। हमारा अनुप्रयोग स्विस एफेमेरिस (उप-आर्क-सेकंड सूर्य/चन्द्र स्थितियाँ; मीयस दस्तावेज़ीकृत फ़ॉलबैक) से सूर्य और चन्द्रमा के सटीक भोगांश की गणना करता है, फिर ऊपर वर्णित कोणीय दूरी सूत्र से तिथि निकालता है। द्वि-तिथि नियम प्रोग्रामेटिक रूप से लागू किया गया है ताकि त्योहार सही ग्रेगोरियन तारीख पर निर्धारित हों, जो प्रमुख पंचांग स्रोतों से एक मिनट के भीतर मेल खाता है।', sa: 'किसी भी डिजिटल पंचांग के लिए सटीक तिथि गणना अनिवार्य है। हमारा अनुप्रयोग स्विस एफेमेरिस (उप-आर्क-सेकंड सूर्य/चन्द्र स्थितयः; मीयस दस्तावेज़ीकृत फ़ॉलबैक) से सूर्य और चन्द्रमा के सटीक भोगांश की गणना करता है, फिर ऊपर वर्णित कोणीय दूरी सूत्र से तिथि निकालता है। द्वि-तिथि नियम प्रोग्रामेटिक रूप से लागू किया गया है ताकि त्योहार सही ग्रेगोरियन तारीख पर निर्धारित हों, जो प्रमुख पंचांग स्रोतों से एक मिनट के भीतर मेल खाता है।' }, locale)}
        </p>
      </section>
