        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
          {sthira.map((k, i) => {
            ...
            const positions: Record<string, { pos: string; tithi: Record<string, string> }> = {
              ...
              Naga: { pos: '60', tithi: { en: 'Amavasya, 2nd half', hi: 'अमावस्या, द्वितीय भाग', sa: 'अमावस्या, द्वितीय भाग', mai: 'अमावस्या, द्वितीय भाग', mr: 'अमावस्या, द्वितीय भाग', ta: 'அமாவாசை, இரண்டாம் பாதி', te: 'అమావాస్య, రెండవ భాగం', bn: 'অমাবস্যা, দ্বিতীয় অর্ধ', kn: 'ಅಮಾವಾಸ್ಯೆ, ಎರಡನೇ ಅರ್ಧ', gu: 'અમાવાસ્યા, દ્વિતીય ભાગ' } },
            };
      ...
      <LessonSection number={9} title={t('crossRefTitle')}>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          {[
            ...
            { href: '/learn/yoga' as const, label: t('crossRefYoga') },
