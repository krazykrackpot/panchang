...
*Code: `src/lib/constants/d60-deities.ts` in [dekhopanchang.com](https://dekhopanchang.com?utm_source=devto&utm_medium=article&utm_campaign=d60-deities). 244 lines. Header citations to BPHS 6.33-41 and the two Phaladeepika translations.*
