    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          The Sun&apos;s Apparent Motion / सूर्य की दृश्य गति
        </h3>
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Equation of Center / केन्द्र समीकरण
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          The Equation of Center converts the mean anomaly (where Earth &quot;should be&quot; if moving uniformly) to the true anomaly (where it actually is). For the Sun, the correction C is expressed as three sine terms: C = 1.915° x sin(M) + 0.020° x sin(2M) + 0.000289° x sin(3M). The dominant first term (1.915°) alone accounts for 99% of the correction. The second term (0.020°) adds the effect of the orbit&apos;s slight asymmetry. The third term is negligible but included for completeness. The true longitude is then: True Longitude = L₀ + C.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          केन्द्र समीकरण माध्य विलम्बिका (यदि समान रूप से चलती तो पृथ्वी &quot;कहाँ होती&quot;) को सत्य विलम्बिका (वास्तव में कहाँ है) में बदलता है। सूर्य के लिए सुधार C तीन ज्या पदों में व्यक्त होता है: C = 1.915° × sin(M) + 0.020° × sin(2M) + 0.000289° × sin(3M)। प्रमुख प्रथम पद (1.915°) अकेला सुधार का 99% वहन करता है। द्वितीय पद (0.020°) कक्षा की मामूली विषमता का प्रभाव जोड़ता है। तृतीय पद नगण्य है किन्तु पूर्णता हेतु सम्मिलित है। सत्य भोगांश तब: सत्य भोगांश = L₀ + C।
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          Next, we apply two small corrections to get the apparent longitude — the position as actually observed. First, nutation: the Moon&apos;s gravitational pull causes Earth&apos;s rotation axis to wobble with a primary period of 18.6 years. The longitude of the Moon&apos;s ascending node Ω = 125.04° - 1934.136° x T drives this correction. Second, aberration: because light from the Sun takes about 8.3 minutes to reach Earth, and Earth is moving, the Sun appears slightly displaced in the direction of Earth&apos;s motion.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed">
          फिर हम दृश्य भोगांश — वास्तव में प्रेक्षित स्थिति — प्राप्त करने हेतु दो छोटे सुधार लगाते हैं। पहला, अयन-चलन: चन्द्रमा का गुरुत्वाकर्षण पृथ्वी के घूर्णन अक्ष को 18.6 वर्ष की प्रमुख अवधि से डोलाता है। चन्द्र आरोही पात का भोगांश Ω = 125.04° - 1934.136° × T यह सुधार चलाता है। दूसरा, विपथन: सूर्य से प्रकाश पृथ्वी तक लगभग 8.3 मिनट लेता है, और पृथ्वी गतिमान है, अतः सूर्य पृथ्वी की गति की दिशा में थोड़ा विस्थापित दिखता है।
        </p>
      </section>
      ...
      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        ...
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          The -0.00569° term is the aberration constant (20.5 arcseconds). The -0.00478° x sin(Ω) term is the nutation in longitude, which oscillates between approximately ±0.00478° with the 18.6-year nodal cycle. Combined, these corrections shift the Sun&apos;s position by up to 0.01° — small, but important for sub-degree accuracy.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          -0.00569° पद विपथन स्थिरांक (20.5 कला-सेकण्ड) है। -0.00478° × sin(Ω) पद भोगांश में अयन-चलन है, जो 18.6 वर्ष के पात चक्र के साथ लगभग ±0.00478° के बीच दोलन करता है। संयुक्त रूप से ये सुधार सूर्य की स्थिति को 0.01° तक खिसकाते हैं — छोटा, किन्तु उप-अंश सटीकता के लिए महत्त्वपूर्ण।
        </p>
      </section>
    </div>
  );
...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Accuracy and Sidereal Conversion / सटीकता और निरयन रूपान्तरण
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
        ...
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          हमारी सूर्य स्थिति कितनी सटीक है? मीयस निम्न-सटीकता एल्गोरिदम लगभग 0.01° (36 कला-सेकण्ड) प्राप्त करता है। समय के सन्दर्भ में, सूर्य ~1°/दिन चलता है, अतः 0.01° त्रुटि लगभग 1 मिनट समय में बदलती है। इसका अर्थ है कि हमारी सूर्योदय/सूर्यास्त गणनाओं में केवल सौर भोगांश से ~1 मिनट की अन्तर्निहित अनिश्चितता है। इसकी तुलना स्विस एफेमेरिस (~0.001°, अधिकांश व्यावसायिक ज्योतिष सॉफ़्टवेयर द्वारा प्रयुक्त) और JPL DE440 (~0.0001°, नासा द्वारा प्रयुक्त) से करें। पंचांग प्रयोजनों के लिए जहाँ सबसे छोटी सार्थक इकाई तिथि सीमा (~12° चन्द्र-सूर्य पृथक्करण) है, हमारी 0.01° सूर्य सटीकता पर्याप्त से अधिक है।
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          The final step for Vedic astrology: converting from tropical to sidereal. The Meeus algorithm gives us the Sun&apos;s tropical (Western) longitude — measured from the vernal equinox. Indian astrology uses the sidereal (nirayana) zodiac — measured from a fixed star reference. The difference is the ayanamsha, which increases by about 50.3 arcseconds per year due to precession. Using the Lahiri ayanamsha (the Indian government standard): Sidereal Longitude = Tropical Longitude - 24.22° (for 2026). Our app computes this for every planet to determine rashi placements, house positions, and dasha calculations.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed">
          वैदिक ज्योतिष के लिए अन्तिम चरण: सायन से निरयन रूपान्तरण। मीयस एल्गोरिदम हमें सूर्य का सायन (पश्चिमी) भोगांश देता है — वसन्त विषुव से मापा। भारतीय ज्योतिष निरयन राशिचक्र का उपयोग करता है — एक स्थिर तारा सन्दर्भ से मापा। अन्तर अयनांश है, जो पुरस्सरण के कारण प्रतिवर्ष लगभग 50.3 कला-सेकण्ड बढ़ता है। लाहिरी अयनांश (भारत सरकार का मानक) का उपयोग करते हुए: निरयन भोगांश = सायन भोगांश - 24.22° (2026 के लिए)। हमारा ऐप राशि स्थान, भाव स्थिति और दशा गणना निर्धारित करने हेतु प्रत्येक ग्रह के लिए यह गणित करता है।
        </p>
      </section>
