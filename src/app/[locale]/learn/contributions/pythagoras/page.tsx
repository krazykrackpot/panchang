    ...
    <div className="space-y-10">
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          {[
            { label: { en: 'Baudhayana stated it', hi: 'बौधायन ने कहा', sa: 'बौधायन ने कहा', mai: 'बौधायन ने कहा', mr: 'बौधायन ने कहा', ta: 'பௌதாயனர் கூறினார்', te: 'బౌధాయన దీనిని చెప్పారు', bn: 'বৌধায়ন এটি বলেছিলেন', kn: 'ಬೌಧಾಯನ ಇದನ್ನು ಹೇಳಿದರು', gu: 'બૌધાયને તે જણાવ્યું' }, date: '~800 BCE', color: '#f0d48a', note: { en: 'General theorem + triples + √2', hi: 'सामान्य प्रमेय + त्रिक + √2', sa: 'सामान्य प्रमेय + त्रिक + √2', mai: 'सामान्य प्रमेय + त्रिक + √2', mr: 'सामान्य प्रमेय + त्रिक + √2', ta: 'General theorem + triples + √2', te: 'General theorem + triples + √2', bn: 'General theorem + triples + √2', kn: 'General theorem + triples + √2', gu: 'General theorem + triples + √2' } },
