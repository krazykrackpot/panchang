// src/lib/kundali/health-diagnosis/__tests__/elements/respiratory.test.ts
//
// Task B5 — respiratory element scorer tests.
//
...
import { scoreRespiratory } from '../../elements/respiratory';
...
const result = scoreRespiratory(kundali, strength, signatures, 'en');

describe('scoreRespiratory', () => {
  ...
  it('returns correct metadata matching ELEMENT_CATALOG[respiratory]', () => {
    const meta = ELEMENT_CATALOG['respiratory'];
    expect(result.id).toBe('respiratory');
