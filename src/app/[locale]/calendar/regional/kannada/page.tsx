...
const MYSORE_DASARA_DAYS: Array<{ day: LocaleText; tithi: LocaleText; observance: LocaleText }> = [
  { day: { en: 'Day 1', hi: 'दिन 1', kn: 'ದಿನ 1' }, tithi: { en: 'Shukla Pratipada', hi: 'शुक्ल प्रतिपदा', kn: 'ಶುಕ್ಲ ಪ್ರತಿಪದ' }, observance: { en: 'Ghatasthapana — installation of the kalasha and family deity puja inside the palace.', hi: 'घटस्थापना - महल के अंदर कलश की स्थापना और पारिवारिक देवता की पूजा।', kn: 'ಘಟಸ್ಥಾಪನೆ - ಅರಮನೆಯೊಳಗೆ ಕಲಶ ಮತ್ತು ಕುಟುಂಬ ದೇವತೆಯ ಪೂಜೆ.' } },
  { day: { en: 'Days 2–3', hi: 'दिन 2-3', kn: 'ದಿನಗಳು 2-3' }, tithi: { en: 'Shukla Dvitiya–Tritiya', hi: 'शुक्ल द्वितीया-तृतीया', kn: 'ಶುಕ್ಲ ದ್ವಿತೀಯ-ತೃತೀಯಾ' }, observance: { en: 'Continuation of Devi Mahatmyam recitation; nightly palace illumination (~100,000 light bulbs).', hi: 'देवी महात्म्यम पाठ का सिलसिला जारी; रात्रिकालीन महल की रोशनी (~100,000 प्रकाश बल्ब)।', kn: 'ದೇವಿ ಮಾಹಾತ್ಮ್ಯ ಪಠಣದ ಮುಂದುವರಿಕೆ; ರಾತ್ರಿಯ ಅರಮನೆಯ ಬೆಳಕು (~100,000 ಬೆಳಕಿನ ಬಲ್ಬ್‌ಗಳು).' } },
  { day: { en: 'Days 4–6', hi: 'दिन 4-6', kn: 'ದಿನಗಳು 4–6' }, tithi: { en: 'Shukla Chaturthi–Shashthi', hi: 'शुक्ल चतुर्थी-षष्ठी', kn: 'ಶುಕ್ಲ ಚತುರ್ಥಿ–ಷಷ್ಠಿ' }, observance: { en: 'Cultural programmes — Carnatic music, classical dance, wrestling at the palace grounds.', hi: 'सांस्कृतिक कार्यक्रम - कर्नाटक संगीत, शास्त्रीय नृत्य, महल के मैदान में कुश्ती।', kn: 'ಸಾಂಸ್ಕೃತಿಕ ಕಾರ್ಯಕ್ರಮಗಳು - ಕರ್ನಾಟಕ ಸಂಗೀತ, ಶಾಸ್ತ್ರೀಯ ನೃತ್ಯ, ಅರಮನೆ ಮೈದಾನದಲ್ಲಿ ಕುಸ್ತಿ.' } },
  { day: { en: 'Day 7', hi: 'दिन 7', kn: 'ದಿನ 7' }, tithi: { en: 'Shukla Saptami', hi: 'शुक्ल सप्तमी', kn: 'ಶುಕ್ಲ ಸಪ್ತಮಿ' }, observance: { en: 'Saraswati Puja — the Maharaja venerates Saraswati and Mahishasuramardhini.', hi: 'सरस्वती पूजा - महाराजा सरस्वती और महिषासुरमर्दिनी की पूजा करते हैं।', kn: 'ಸರಸ್ವತಿ ಪೂಜೆ - ಮಹಾರಾಜರು ಸರಸ್ವತಿ ಮತ್ತು ಮಹಿಷಾಸುರಮರ್ಧಿನಿಯನ್ನು ಪೂಜಿಸುತ್ತಾರೆ.' } },
  { day: { en: 'Day 8', hi: 'दिन 8', kn: 'ದಿನ 8' }, tithi: { en: 'Shukla Ashtami', hi: 'शुक्ल अष्टमी', kn: 'ಶುಕ್ಲ ಅಷ್ಟಮಿ' }, observance: { en: 'Durga Ashtami.', hi: 'दुर्गा अष्टमी.', kn: 'ದುರ್ಗಾ ಅಷ್ಟಮಿ.' } },
  { day: { en: 'Day 9', hi: 'दिन 9', kn: 'ದಿನ 9' }, tithi: { en: 'Mahanavami', hi: 'महानवमी', kn: 'ಮಹಾನವಮಿ' }, observance: { en: 'Ayudha Puja — the royal sword is worshipped and taken out in procession.', hi: 'आयुध पूजा - शाही तलवार की पूजा की जाती है और जुलूस निकाला जाता है।', kn: 'ಆಯುಧಪೂಜೆ - ರಾಜ ಖಡ್ಗವನ್ನು ಪೂಜಿಸಲಾಗುತ್ತದೆ ಮತ್ತು ಮೆರವಣಿಗೆಯಲ್ಲಿ ಹೊರತೆಗೆಯಲಾಗುತ್ತದೆ.' } },
  { day: { en: 'Day 10', hi: 'दिन 10', kn: 'ದಿನ 10' }, tithi: { en: 'Vijayadashami', hi: 'Vijayadashami', kn: 'ವಿಜಯದಶಮಿ' }, observance: { en: 'Jamboo Savari — the great procession from the palace to Bannimantap; the Chamundeshwari idol travels in a ~750 kg golden mantapa on the back of a lead elephant; Banni mara puja at Bannimantap recalls the Pandavas’ Shami-tree concealment.', hi: 'जम्बू सावरी - महल से बन्नीमंतप तक भव्य जुलूस; चामुंडेश्वरी की मूर्ति एक सीसे के हाथी की पीठ पर ~750 किलोग्राम के सुनहरे मंडप में यात्रा करती है; बन्नीमंतप में बन्नी मारा पूजा पांडवों के शमी-वृक्ष को छुपाने की याद दिलाती है।', kn: 'ಜಂಬೂ ಸವಾರಿ - ಅರಮನೆಯಿಂದ ಬನ್ನಿಮಂಟಪಕ್ಕೆ ದೊಡ್ಡ ಮೆರವಣಿಗೆ; ಚಾಮುಂಡೇಶ್ವರಿ ವಿಗ್ರಹವು ಸೀಸದ ಆನೆಯ ಹಿಂಭಾಗದಲ್ಲಿ ~750 ಕೆಜಿ ಚಿನ್ನದ ಮಂಟಪದಲ್ಲಿ ಪ್ರಯಾಣಿಸುತ್ತದೆ; ಬನ್ನಿಮಂಟಪದಲ್ಲಿ ಬನ್ನಿ ಮಾರ ಪೂಜೆಯು ಪಾಂಡವರ ಶಮಿ-ವೃಕ್ಷದ ಮರೆಮಾಚುವಿಕೆಯನ್ನು ನೆನಪಿಸುತ್ತದೆ.' } },
];
...
const KANNADA_SAMPRADAYAS: Array<{ name: LocaleText; founder: LocaleText; centre: LocaleText; signature: LocaleText; almanacs: LocaleText }> = [
  { name: { en: 'Madhva (Dvaita)', hi: 'माधव (द्वैत)', kn: 'ಮಾಧ್ವ (ದ್ವೈತ)' }, founder: { en: 'Madhvacharya, 13th c.', hi: 'माधवाचार्य, 13वीं सदी।', kn: 'ಮಧ್ವಾಚಾರ್ಯ, 13ನೇ ಸಿ.' }, centre: { en: 'Vishnu / Narayana with consort Lakshmi', hi: 'विष्णु/नारायण पत्नी लक्ष्मी के साथ', kn: 'ವಿಷ್ಣು / ನಾರಾಯಣ ಪತ್ನಿ ಲಕ್ಷ್ಮಿ ಜೊತೆ' }, signature: { en: 'Madhva Navami (Magha Shukla Navami), Krishna Janmashtami, Sri Krishna Paryaya at Udupi, Madhva Jayanti.', hi: 'माधव नवमी (माघ शुक्ल नवमी), कृष्ण जन्माष्टमी, उडुपी में श्रीकृष्ण पर्याय, माधव जयंती।', kn: 'ಮಧ್ವ ನವಮಿ (ಮಾಘ ಶುಕ್ಲ ನವಮಿ), ಕೃಷ್ಣ ಜನ್ಮಾಷ್ಟಮಿ, ಉಡುಪಿಯಲ್ಲಿ ಶ್ರೀ ಕೃಷ್ಣ ಪರ್ಯಾಯ, ಮಧ್ವ ಜಯಂತಿ.' }, almanacs: { en: 'Uttaradi Matha, Sri Vyasaraja Matha, Sri Raghavendra Matha', hi: 'उत्तरादि मठ, श्री व्यासराज मठ, श्री राघवेंद्र मठ', kn: 'ಉತ್ತರಾದಿ ಮಠ, ಶ್ರೀ ವ್ಯಾಸರಾಜ ಮಠ, ಶ್ರೀ ರಾಘವೇಂದ್ರ ಮಠ' } },
  { name: { en: 'Smarta (Pancayatana)', hi: 'स्मार्त (पंचायतन)', kn: 'ಸ್ಮಾರ್ತ (ಪಂಚಾಯತನ)' }, founder: { en: 'Adi Shankara codification', hi: 'आदि शंकराचार्य संहिताकरण', kn: 'ಆದಿ ಶಂಕರ ಕ್ರೋಡೀಕರಣ' }, centre: { en: 'Five deities — Vishnu, Shiva, Durga, Surya, Ganesha — as expressions of one Brahman', hi: 'पाँच देवता - विष्णु, शिव, दुर्गा, सूर्य, गणेश - एक ब्रह्म की अभिव्यक्ति के रूप में', kn: 'ಐದು ದೇವತೆಗಳು - ವಿಷ್ಣು, ಶಿವ, ದುರ್ಗಾ, ಸೂರ್ಯ, ಗಣೇಶ - ಒಬ್ಬ ಬ್ರಹ್ಮನ ಅಭಿವ್ಯಕ್ತಿಯಾಗಿ' }, signature: { en: 'Ganesha Chaturthi, Maha Shivaratri, Navaratri / Vijayadashami, Krishna Janmashtami, Deepavali.', hi: 'गणेश चतुर्थी, महा शिवरात्रि, नवरात्रि/विजयदशमी, कृष्ण जन्माष्टमी, दीपावली।', kn: 'ಗಣೇಶ ಚತುರ್ಥಿ, ಮಹಾ ಶಿವರಾತ್ರಿ, ನವರಾತ್ರಿ / ವಿಜಯದಶಮಿ, ಕೃಷ್ಣ ಜನ್ಮಾಷ್ಟಮಿ, ದೀಪಾವಳಿ.' }, almanacs: { en: 'Sringeri Panchanga', hi: 'श्रृंगेरी पंचांग', kn: 'ಶೃಂಗೇರಿ ಪಂಚಾಂಗ' } },
  { name: { en: 'Veerashaiva (Lingayata)', hi: 'वीरशैव (लिंगायत)', kn: 'ವೀರಶೈವ (ಲಿಂಗಾಯತ)' }, founder: { en: '12th-century vachana movement (Basavanna)', hi: '12वीं सदी का वचन आंदोलन (बसवन्ना)', kn: '12 ನೇ ಶತಮಾನದ ವಚನ ಚಳುವಳಿ (ಬಸವಣ್ಣ)' }, centre: { en: 'Shiva, mediated through the ishtalinga', hi: 'इष्टलिंग के माध्यम से शिव की मध्यस्थता की गई', kn: 'ಶಿವ, ಇಷ್ಟಲಿಂಗದ ಮೂಲಕ ಮಧ್ಯಸ್ಥಿಕೆ ವಹಿಸಿದರು' }, signature: { en: 'Maha Shivaratri, Basava Jayanti (Vaishakha Shukla Tritiya), Allamaprabhu Jayanti, Jangama-aradhane.', hi: 'महा शिवरात्रि, बसव जयंती (वैशाख शुक्ल तृतीया), अल्लमप्रभु जयंती, जंगम-आराधने।', kn: 'ಮಹಾ ಶಿವರಾತ್ರಿ, ಬಸವ ಜಯಂತಿ (ವೈಶಾಖ ಶುಕ್ಲ ತೃತೀಯ), ಅಲ್ಲಮಪ್ರಭು ಜಯಂತಿ, ಜಂಗಮ-ಆರಾಧನೆ.' }, almanacs: { en: 'Various Veerashaiva matha calendars', hi: 'विभिन्न वीरशैव मठ कैलेंडर', kn: 'ವಿವಿಧ ವೀರಶೈವ ಮಠದ ಕ್ಯಾಲೆಂಡರ್‌ಗಳು' } },
];
...
const KANNADA_YEARS: Array<{ year: number; samvatsara: string; shaka: string; yugadiNote: LocaleText }> = [
  { year: 2026, samvatsara: 'Parabhava', shaka: '1948', yugadiNote: { en: '19 March 2026 — current year', hi: '19 मार्च 2026 - चालू वर्ष', kn: '19 ಮಾರ್ಚ್ 2026 - ಪ್ರಸ್ತುತ ವರ್ಷ' } },
  { year: 2027, samvatsara: 'Plavanga', shaka: '1949', yugadiNote: { en: 'Yugadi early April 2027', hi: 'युगादि अप्रैल 2027 की शुरुआत में', kn: 'ಏಪ್ರಿಲ್ 2027 ರ ಆರಂಭದಲ್ಲಿ ಯುಗಾದಿ' } },
  { year: 2028, samvatsara: 'Kilaka', shaka: '1950', yugadiNote: { en: 'late March 2028', hi: 'मार्च 2028 के अंत में', kn: 'ಮಾರ್ಚ್ 2028 ರ ಕೊನೆಯಲ್ಲಿ' } },
  { year: 2029, samvatsara: 'Saumya', shaka: '1951', yugadiNote: { en: 'mid-April 2029', hi: 'मध्य अप्रैल 2029', kn: 'ಮಧ್ಯ ಏಪ್ರಿಲ್ 2029' } },
  { year: 2030, samvatsara: 'Sadharana', shaka: '1952', yugadiNote: { en: 'early April 2030', hi: 'अप्रैल 2030 की शुरुआत में', kn: 'ಏಪ್ರಿಲ್ 2030 ರ ಆರಂಭದಲ್ಲಿ' } },
];

// ── Famous Kannada calendrical scholars ──
const KANNADA_SCHOLARS: Array<{ name: LocaleText; dates: string; bio: LocaleText }> = [
  { name: { en: 'Madhvacharya', hi: 'माधवाचार्य', kn: 'ಮಧ್ವಾಚಾರ್ಯ' }, dates: 'c. 1238–1317 CE', bio: { en: 'Founder of the Dvaita Vedanta school and the architect of the Karnataka Vaishnava festival calendar. He established the eight Udupi mathas (the Ashta Mathas) whose worship procedures and festival timings he codified in his Tantrasara. The annual Sri Krishna Paryaya rotation among the eight mathas is one of the longest-running festival institutions in India.', hi: 'द्वैत वेदांत स्कूल के संस्थापक और कर्नाटक वैष्णव त्योहार कैलेंडर के वास्तुकार। उन्होंने आठ उडुपी मठों (अष्ट मठों) की स्थापना की, जिनकी पूजा प्रक्रियाओं और त्योहार के समय को उन्होंने अपने तंत्रसार में संहिताबद्ध किया। आठ मठों के बीच वार्षिक श्रीकृष्ण पर्याय रोटेशन भारत में सबसे लंबे समय तक चलने वाले त्योहार संस्थानों में से एक है।', kn: 'ದ್ವೈತ ವೇದಾಂತ ಪಾಠಶಾಲೆಯ ಸ್ಥಾಪಕರು ಮತ್ತು ಕರ್ನಾಟಕ ವೈಷ್ಣವ ಉತ್ಸವದ ಕ್ಯಾಲೆಂಡರ್‌ನ ವಾಸ್ತುಶಿಲ್ಪಿ. ಅವರು ಎಂಟು ಉಡುಪಿ ಮಠಗಳನ್ನು (ಅಷ್ಟ ಮಠಗಳು) ಸ್ಥಾಪಿಸಿದರು, ಅವರ ಪೂಜಾ ವಿಧಾನಗಳು ಮತ್ತು ಹಬ್ಬದ ಸಮಯಗಳನ್ನು ಅವರು ತಮ್ಮ ತಂತ್ರಸಾರದಲ್ಲಿ ಕ್ರೋಡೀಕರಿಸಿದರು. ಎಂಟು ಮಠಗಳ ನಡುವೆ ವಾರ್ಷಿಕ ಶ್ರೀಕೃಷ್ಣ ಪರ್ಯಾಯ ಸರದಿ ಭಾರತದಲ್ಲಿ ದೀರ್ಘಕಾಲ ನಡೆಯುವ ಉತ್ಸವ ಸಂಸ್ಥೆಗಳಲ್ಲಿ ಒಂದಾಗಿದೆ.' } },
  { name: { en: 'Vyasatirtha (Vyasaraja)', hi: 'व्यासतीर्थ (व्यासराज)', kn: 'ವ್ಯಾಸತೀರ್ಥ (ವ್ಯಾಸರಾಜ)' }, dates: '1460–1539 CE', bio: { en: 'The pivotal figure for Karnataka panchanga production. Patron saint of the Vijayanagara Empire and a great Madhva polymath, he founded the Sri Vyasaraja Matha, whose annual Kannada Panchanga remains in continuous circulation. His three principal works — Nyayamruta, Tatparya Chandrika and Tarka Tandava — were credited by the Advaita scholar Appayya Dikshita with “securing the melon of Madhvaism with three bands.” His samadhi at Navabrindavana, an island in the Tungabhadra near Anegundi, remains an active pilgrimage site.', hi: 'कर्नाटक पंचांग उत्पादन के लिए निर्णायक आंकड़ा। विजयनगर साम्राज्य के संरक्षक संत और एक महान माधव बहुश्रुत, उन्होंने श्री व्यासराज मठ की स्थापना की, जिसका वार्षिक कन्नड़ पंचांग निरंतर प्रचलन में रहता है। उनके तीन प्रमुख कार्य - न्यायमृत, तत्पर्य चंद्रिका और तर्क तांडव - को अद्वैत विद्वान अप्पय्या दीक्षित ने "तीन बैंड के साथ माधववाद के तरबूज को सुरक्षित करने" का श्रेय दिया। अनेगुंडी के पास तुंगभद्रा में एक द्वीप नवबृंदावन में उनकी समाधि एक सक्रिय तीर्थ स्थल बनी हुई है।', kn: 'ಕರ್ನಾಟಕದ ಪಂಚಾಂಗ ಉತ್ಪಾದನೆಯ ಪ್ರಮುಖ ವ್ಯಕ್ತಿ. ವಿಜಯನಗರ ಸಾಮ್ರಾಜ್ಯದ ಪೋಷಕ ಸಂತ ಮತ್ತು ಮಹಾನ್ ಮಾಧ್ವ ಬಹುಸಂಖ್ಯಾತ, ಅವರು ಶ್ರೀ ವ್ಯಾಸರಾಜ ಮಠವನ್ನು ಸ್ಥಾಪಿಸಿದರು, ಅವರ ವಾರ್ಷಿಕ ಕನ್ನಡ ಪಂಚಾಂಗವು ನಿರಂತರ ಚಲಾವಣೆಯಲ್ಲಿದೆ. ಅವರ ಮೂರು ಪ್ರಮುಖ ಕೃತಿಗಳು - ನ್ಯಾಯಮೃತ, ತಾತ್ಪರ್ಯ ಚಂದ್ರಿಕಾ ಮತ್ತು ತರ್ಕ ತಾಂಡವ - ಅದ್ವೈತ ವಿದ್ವಾಂಸ ಅಪ್ಪಯ್ಯ ದೀಕ್ಷಿತರಿಂದ "ಮಧ್ವಧರ್ಮದ ಕಲ್ಲಂಗಡಿಯನ್ನು ಮೂರು ಬ್ಯಾಂಡ್‌ಗಳೊಂದಿಗೆ ಭದ್ರಪಡಿಸಿದ" ಕೀರ್ತಿಗೆ ಪಾತ್ರರಾಗಿದ್ದಾರೆ. ಆನೆಗುಂಡಿ ಬಳಿಯ ತುಂಗಭದ್ರಾ ದ್ವೀಪವಾದ ನವಬೃಂದಾವನದಲ್ಲಿನ ಅವರ ಸಮಾಧಿಯು ಸಕ್ರಿಯ ಯಾತ್ರಾ ಸ್ಥಳವಾಗಿ ಉಳಿದಿದೆ.' } },
  { name: { en: 'Bhaskara II (Bhaskaracharya)', hi: 'भास्कर द्वितीय (भास्कराचार्य)', kn: 'ಭಾಸ್ಕರ II (ಭಾಸ್ಕರಾಚಾರ್ಯ)' }, dates: '1114–1185 CE', bio: { en: 'Born in Bijapur, Karnataka. His Siddhanta Shiromani is one of the foundational Sanskrit astronomical treatises that subsequent Karnataka almanac-makers built on. The Lilavati and Bijaganita portions of the work also encode the mathematical machinery — including treatment of zero, equations and the chakravala cyclic method — that the panchanga-makers of later centuries relied on for planetary mean motions.', hi: 'कर्नाटक के बीजापुर में जन्म। उनका सिद्धांत शिरोमणि मूलभूत संस्कृत खगोलीय ग्रंथों में से एक है जिसे बाद के कर्नाटक पंचांग निर्माताओं ने बनाया। कार्य के लीलावती और बीजागनिता भाग गणितीय मशीनरी को भी कूटबद्ध करते हैं - जिसमें शून्य का उपचार, समीकरण और चक्रवाला चक्रीय विधि शामिल है - जिस पर बाद की शताब्दियों के पंचांग-निर्माताओं ने ग्रहों की औसत गति के लिए भरोसा किया।', kn: 'ಹುಟ್ಟಿದ್ದು ಕರ್ನಾಟಕದ ಬಿಜಾಪುರದಲ್ಲಿ. ಅವರ ಸಿದ್ಧಾಂತ ಶಿರೋಮಣಿಯು ನಂತರದ ಕರ್ನಾಟಕ ಪಂಚಾಂಗ ತಯಾರಕರು ನಿರ್ಮಿಸಿದ ಅಡಿಪಾಯದ ಸಂಸ್ಕೃತ ಖಗೋಳಶಾಸ್ತ್ರದ ಗ್ರಂಥಗಳಲ್ಲಿ ಒಂದಾಗಿದೆ. ಕೃತಿಯ ಲೀಲಾವತಿ ಮತ್ತು ಬಿಜಗಣಿತ ಭಾಗಗಳು ಗಣಿತದ ಯಂತ್ರೋಪಕರಣಗಳನ್ನು ಸಹ ಎನ್ಕೋಡ್ ಮಾಡುತ್ತವೆ - ಶೂನ್ಯ ಚಿಕಿತ್ಸೆ, ಸಮೀಕರಣಗಳು ಮತ್ತು ಚಕ್ರವಾಲಾ ಆವರ್ತಕ ವಿಧಾನವನ್ನು ಒಳಗೊಂಡಂತೆ - ನಂತರದ ಶತಮಾನಗಳ ಪಂಚಾಂಗ-ತಯಾರಕರು ಗ್ರಹಗಳ ಸರಾಸರಿ ಚಲನೆಯನ್ನು ಅವಲಂಬಿಸಿದ್ದರು.' } },
  { name: { en: 'Basavanna and Allamaprabhu', hi: 'बसवन्ना और अल्लमप्रभु', kn: 'ಬಸವಣ್ಣ ಮತ್ತು ಅಲ್ಲಮಪ್ರಭು' }, dates: '12th c.', bio: { en: 'The Veerashaiva calendrical tradition draws on their vachana literature; the festival days Basava Jayanti (Vaishakha Shukla Tritiya) and Allamaprabhu Jayanti are integrated into the Karnataka chandramana calendar. Together they ground the Lingayata sampradaya’s liturgical year independently of any matha-issued almanac.', hi: 'वीरशैव पंचांग परंपरा उनके वचन साहित्य पर आधारित है; त्योहार के दिन बसव जयंती (वैशाख शुक्ल तृतीया) और अल्लामप्रभु जयंती को कर्नाटक चंद्रमण कैलेंडर में एकीकृत किया गया है। साथ में, उन्होंने लिंगायत संप्रदाय के धार्मिक वर्ष को किसी भी मठ-जारी पंचांग से स्वतंत्र रूप से आधार बनाया।', kn: 'ವೀರಶೈವ ಪಂಚಾಂಗದ ಸಂಪ್ರದಾಯವು ಅವರ ವಚನ ಸಾಹಿತ್ಯವನ್ನು ಸೆಳೆಯುತ್ತದೆ; ಉತ್ಸವದ ದಿನಗಳಾದ ಬಸವ ಜಯಂತಿ (ವೈಶಾಖ ಶುಕ್ಲ ತೃತೀಯ) ಮತ್ತು ಅಲ್ಲಮಪ್ರಭು ಜಯಂತಿಗಳನ್ನು ಕರ್ನಾಟಕ ಚಂದ್ರಮಾನ ಕ್ಯಾಲೆಂಡರ್‌ನಲ್ಲಿ ಸಂಯೋಜಿಸಲಾಗಿದೆ. ಅವರು ಒಟ್ಟಾಗಿ ಯಾವುದೇ ಮಠ ನೀಡಿದ ಪಂಚಾಂಗದಿಂದ ಸ್ವತಂತ್ರವಾಗಿ ಲಿಂಗಾಯತ ಸಂಪ್ರದಾಯದ ಪ್ರಾರ್ಥನಾ ವರ್ಷವನ್ನು ಸ್ಥಾಪಿಸಿದರು.' } },
];
