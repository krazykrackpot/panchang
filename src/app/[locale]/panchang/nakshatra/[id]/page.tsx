...
export default function NakshatraDetailPage() {
  ...
  const sections = [
    ...
    { title: tl({ en: 'Significance', hi: 'महत्व', sa: 'महत्त्वम्', ta: 'முக்கியத்துவம்', te: 'ప్రాముఖ్యత', bn: 'তাৎপর্য', kn: 'ಮಹತ್ವ', gu: 'મહત્ત્વ', mai: 'महत्त्व', mr: 'महत्त्व' }, locale), content: detail.significance[locale], color: 'emerald-400' },
