...
const META: ModuleMeta = {
  id: 'mod_3_3', phase: 2, topic: 'Nakshatra', moduleNumber: '3.3',
...
const QUESTIONS: ModuleQuestion[] = [
  { id: 'q3_3_01', type: 'mcq', question: { en: "Span?", hi: '' }, options: [{ en: "30d", hi: '' }, { en: "13d20m", hi: '' }, { en: "12d", hi: '' }, { en: "27d", hi: '' }], correctAnswer: 1, explanation: { en: "360/27=13d20m", hi: '' } },
  { id: 'q3_3_02', type: 'true_false', question: { en: "Moon ~1 day per nakshatra", hi: '' }, correctAnswer: true, explanation: { en: "Sidereal ~27.3 days", hi: '' } },
];
