...
const AK_THEMES: Record<string, AKTheme> = {
  ...
  Mars: {
    ...
    karma: { en: 'A warrior soul returning to learn when to draw the sword and when to sheathe it. The karma involves protection and service — guarding, building, or healing. Courage must become compassion.', hi: 'एक योद्धा आत्मा जो सीखने आई है कब तलवार उठानी है। साहस को करुणा बनना है।', sa: 'एक योद्धा आत्मा जो सीखने आई है कब तलवार उठानी है। साहस को करुणा बनना है।', mai: 'एक योद्धा आत्मा जो सीखने आई है कब तलवार उठानी है। साहस को करुणा बनना है।', mr: 'एक योद्धा आत्मा जो सीखने आई है कब तलवार उठानी है। साहस को करुणा बनना है।', ta: 'எப்போது வாளை உருவ வேண்டும் எப்போது அடக்க வேண்டும் என்பதைக் கற்றுக்கொள்ள திரும்பும் போர்வீர ஆன்மா. கர்மம் பாதுகாப்பு மற்றும் சேவையை உள்ளடக்கியது. தைரியம் கருணையாக மாற வேண்டும்.', te: 'ఖడ్గం ఎప్పుడు దూయాలి ఎప్పుడు ఒరలో పెట్టాలి అని నేర్చుకోవడానికి తిరిగి వస్తున్న యోధ ఆత్మ. కర్మ రక్షణ మరియు సేవను కలిగి ఉంటుంది. ధైర్యం కరుణగా మారాలి.', bn: 'কখন তলোয়ার তুলতে হবে ও কখন খাপে রাখতে হবে তা শিখতে ফিরে আসা যোদ্ধা আত্মা। কর্ম রক্ষা ও সেবা জড়িত। সাহস করুণায় পরিণত হতে হবে।', kn: 'ಖಡ್ಗ ಯಾವಾಗ ಹಿರಿಯಬೇಕು ಯಾವಾಗ ಒರೆಗೆ ಹಾಕಬೇಕು ಎಂದು ಕಲಿಯಲು ಮರಳುತ್ತಿರುವ ಯೋಧ ಆತ್ಮ. ಕರ್ಮ ರಕ್ಷಣೆ ಮತ್ತು ಸೇವೆ ಒಳಗೊಂಡಿದೆ. ಧೈರ್ಯ ಕರುಣೆಯಾಗಬೇಕು.', gu: 'ક્યારે તલવાર ખેંચવી ક્યારે મ્યાન કરવી તે શીખવા પાછી આવતી યોદ્ધા આત્મા. કર્મ રક્ષણ અને સેવા સાથે સંકળાયેલું. સાહસ કરુણા બનવું જોઈએ.' },
  },
  Mercury: {
