...
export default function LearnAvasthasPage() {
  ...
  const BALADI_STATES = [
    { name: { en: 'Bala (Infant)', hi: 'बाल (शिशु)', sa: 'बाल (शिशु)', mai: 'बाल (शिशु)', mr: 'बाल (शिशु)', ta: 'பால (சிசு)', te: 'బాల (శిశువు)', bn: 'বাল (শিশু)', kn: 'ಬಾಲ (ಶಿಶು)', gu: 'બાલ (શિશુ)' }, condition: { en: '0-6° (odd sign) / 24-30° (even sign)', hi: '0-6° (विषम राशि) / 24-30° (सम राशि)', sa: '0-6° (विषम राशि) / 24-30° (सम राशि)', mai: '0-6° (विषम राशि) / 24-30° (सम राशि)', mr: '0-6° (विषम राशि) / 24-30° (सम राशि)', ta: '0-6° (ஒற்றை ராசி) / 24-30° (இரட்டை ராசி)', te: '0-6° (బేసి రాశి) / 24-30° (సరి రాశి)', bn: '0-6° (বিষম রাশি) / 24-30° (সম রাশি)', kn: '0-6° (ಬೆಸ ರಾಶಿ) / 24-30° (ಸಮ ರಾಶಿ)', gu: '0-6° (વિષમ રાશિ) / 24-30° (સમ રાશિ)' }, result: { en: 'Planet is immature — gives results but erratically, like a child.', hi: 'ग्रह अपरिपक्व — फल देता है परन्तु अनियमित।', sa: 'ग्रह अपरिपक्व — फल देता है परन्तु अनियमित।', mai: 'ग्रह अपरिपक्व — फल देता है परन्तु अनियमित।', mr: 'ग्रह अपरिपक्व — फल देता है परन्तु अनियमित।', ta: 'கிரகம் முதிர்ச்சியற்றது — குழந்தை போல ஒழுங்கற்ற முறையில் பலன்கள் தருகிறது.', te: 'గ్రహం అపరిపక్వం — పిల్లవాడిలా అస్థిరంగా ఫలితాలు ఇస్తుంది.', bn: 'গ্রহ অপরিণত — শিশুর মতো অনিয়মিতভাবে ফল দেয়।', kn: 'ಗ್ರಹ ಅಪಕ್ವ — ಮಗುವಿನಂತೆ ಅನಿಯಮಿತವಾಗಿ ಫಲ ನೀಡುತ್ತದೆ.', gu: 'ગ્રહ અપરિપક્વ — બાળકની જેમ અનિયમિત રીતે ફળ આપે છે.' }, color: 'text-cyan-400', tier: 'mixed', stateKey: null },
    { name: { en: 'Kumara (Youth)', hi: 'कुमार (युवा)', sa: 'कुमार (युवा)', mai: 'कुमार (युवा)', mr: 'कुमार (युवा)', ta: 'குமார (யுவன்)', te: 'కుమార (యువకుడు)', bn: 'কুমার (যুবক)', kn: 'ಕುಮಾರ (ಯುವಕ)', gu: 'કુમાર (યુવાન)' }, condition: { en: '6-12° (odd) / 18-24° (even)', hi: '6-12° (विषम) / 18-24° (सम)', sa: '6-12° (विषम) / 18-24° (सम)', mai: '6-12° (विषम) / 18-24° (सम)', mr: '6-12° (विषम) / 18-24° (सम)', ta: '6-12° (ஒற்றை) / 18-24° (இரட்டை)', te: '6-12° (బేసి) / 18-24° (సరి)', bn: '6-12° (বিষম) / 18-24° (সম)', kn: '6-12° (ಬೆಸ) / 18-24° (ಸಮ)', gu: '6-12° (વિષમ) / 18-24° (સમ)' }, result: { en: 'Planet is growing — gives results with increasing strength.', hi: 'ग्रह बढ़ रहा है — बढ़ती शक्ति से फल देता है।', sa: 'ग्रह बढ़ रहा है — बढ़ती शक्ति से फल देता है।', mai: 'ग्रह बढ़ रहा है — बढ़ती शक्ति से फल देता है।', mr: 'ग्रह बढ़ रहा है — बढ़ती शक्ति से फल देता है।', ta: 'கிரகம் வளர்ந்து கொண்டிருக்கிறது — அதிகரிக்கும் வலிமையுடன் பலன்கள் தருகிறது.', te: 'గ్రహం పెరుగుతోంది — పెరుగుతున్న బలంతో ఫలితాలు ఇస్తుంది.', bn: 'গ্রহ বাড়ছে — ক্রমবর্ধমান শক্তি সহ ফল দেয়।', kn: 'ಗ್ರಹ ಬೆಳೆಯುತ್ತಿದೆ — ಹೆಚ್ಚುತ್ತಿರುವ ಶಕ್ತಿಯೊಂದಿಗೆ ಫಲ ನೀಡುತ್ತದೆ.', gu: 'ગ્રહ વિકસી રહ્યો છે — વધતી તાકાત સાથે ફળ આપે છે.' }, color: 'text-emerald-400', tier: 'good', stateKey: null },
    { name: { en: 'Yuva (Prime)', hi: 'युवा (पूर्ण)', sa: 'युवा (पूर्ण)', mai: 'युवा (पूर्ण)', mr: 'युवा (पूर्ण)', ta: 'யுவ (முழுமை)', te: 'యువ (యువకుడు)', bn: 'যুব (পূর্ণ)', kn: 'ಯುವ (ಪ್ರೌಢ)', gu: 'યુવ (પૂર્ણ)' }, condition: { en: '12-18° (odd) / 12-18° (even)', hi: '12-18° (विषम) / 12-18° (सम)', sa: '12-18° (विषम) / 12-18° (सम)', mai: '12-18° (विषम) / 12-18° (सम)', mr: '12-18° (विषम) / 12-18° (सम)', ta: '12-18° (ஒற்றை) / 12-18° (இரட்டை)', te: '12-18° (బేసి) / 12-18° (సరి)', bn: '12-18° (বিষম) / 12-18° (সম)', kn: '12-18° (ಬೆಸ) / 12-18° (ಸಮ)', gu: '12-18° (વિષમ) / 12-18° (સમ)' }, result: { en: 'Planet at peak — gives full, powerful results. The best Baladi state.', hi: 'ग्रह चरम पर — पूर्ण, शक्तिशाली फल। सर्वश्रेष्ठ बालादि अवस्था।', sa: 'ग्रह चरम पर — पूर्ण, शक्तिशाली फल। सर्वश्रेष्ठ बालादि अवस्था।', mai: 'ग्रह चरम पर — पूर्ण, शक्तिशाली फल। सर्वश्रेष्ठ बालादि अवस्था।', mr: 'ग्रह चरम पर — पूर्ण, शक्तिशाली फल। सर्वश्रेष्ठ बालादि अवस्था।', ta: 'கிரகம் உச்சத்தில் — முழு, சக்திவாய்ந்த பலன்கள் தருகிறது. சிறந்த பாலாதி நிலை.', te: 'గ్రహం శిఖరంలో — పూర్తి, శక్తివంతమైన ఫలితాలు ఇస్తుంది. అత్యుత్తమ బాలాది స్థితి.', bn: 'গ্রহ শীর্ষে — পূর্ণ, শক্তিশালী ফল দেয়। সেরা বালাদি অবস্থা।', kn: 'ಗ್ರಹ ಉತ್ತುಂಗದಲ್ಲಿ — ಪೂರ್ಣ, ಶಕ್ತಿಶಾಲಿ ಫಲ ನೀಡುತ್ತದೆ. ಅತ್ಯುತ್ತಮ ಬಾಲಾದಿ ಸ್ಥಿತಿ.', gu: 'ગ્રહ ટોચ પર — પૂર્ણ, શક્તિશાળી ફળ આપે છે. શ્રેષ્ઠ બાલાદિ સ્થિતિ.' }, color: 'text-amber-400', tier: 'excellent', stateKey: 'yuva' },
    { name: { en: 'Vriddha (Old)', hi: 'वृद्ध (प्रौढ़)', sa: 'वृद्ध (प्रौढ़)', mai: 'वृद्ध (प्रौढ़)', mr: 'वृद्ध (प्रौढ़)', ta: 'வ்ருத்த (வயோதிகம்)', te: 'వృద్ధ (వృద్ధుడు)', bn: 'বৃদ্ধ (বৃদ্ধ)', kn: 'ವೃದ್ಧ (ವೃದ್ಧ)', gu: 'વૃદ્ધ (વૃદ્ધ)' }, condition: { en: '18-24° (odd) / 6-12° (even)', hi: '18-24° (विषम) / 6-12° (सम)', sa: '18-24° (विषम) / 6-12° (सम)', mai: '18-24° (विषम) / 6-12° (सम)', mr: '18-24° (विषम) / 6-12° (सम)', ta: '18-24° (ஒற்றை) / 6-12° (இரட்டை)', te: '18-24° (బేసి) / 6-12° (సరి)', bn: '18-24° (বিষম) / 6-12° (সম)', kn: '18-24° (ಬೆಸ) / 6-12° (ಸಮ)', gu: '18-24° (વિષમ) / 6-12° (સમ)' }, result: { en: 'Planet declining — gives results with decreasing enthusiasm.', hi: 'ग्रह क्षीण — घटते उत्साह से फल देता है।', sa: 'ग्रह क्षीण — घटते उत्साह से फल देता है।', mai: 'ग्रह क्षीण — घटते उत्साह से फल देता है।', mr: 'ग्रह क्षीण — घटते उत्साह से फल देता है।', ta: 'கிரகம் வீழ்ச்சியடைகிறது — குறையும் உற்சாகத்துடன் பலன்கள் தருகிறது.', te: 'గ్రహం క్షీణిస్తోంది — తగ్గుతున్న ఉత్సాహంతో ఫలితాలు ఇస్తుంది.', bn: 'গ্রহ ক্ষীয়মান — হ্রাসমান উৎসাহ সহ ফল দেয়।', kn: 'ಗ್ರಹ ಕ್ಷೀಣಿಸುತ್ತಿದೆ — ಕಡಿಮೆಯಾಗುತ್ತಿರುವ ಉತ್ಸಾಹದೊಂದಿಗೆ ಫಲ ನೀಡುತ್ತದೆ.', gu: 'ગ્રહ ઘટી રહ્યો છે — ઘટતા ઉત્સાહ સાથે ફળ આપે છે.' }, color: 'text-violet-400', tier: 'mixed', stateKey: null },
    { name: { en: 'Mrita (Dead)', hi: 'मृत', sa: 'मृत', mai: 'मृत', mr: 'मृत', ta: 'ம்ருத (மரணம்)', te: 'మృత (మరణం)', bn: 'মৃত (মৃত)', kn: 'ಮೃತ (ಮೃತ)', gu: 'મૃત (મૃત)' }, condition: { en: '24-30° (odd) / 0-6° (even)', hi: '24-30° (विषम) / 0-6° (सम)', sa: '24-30° (विषम) / 0-6° (सम)', mai: '24-30° (विषम) / 0-6° (सम)', mr: '24-30° (विषम) / 0-6° (सम)', ta: '24-30° (ஒற்றை) / 0-6° (இரட்டை)', te: '24-30° (బేసి) / 0-6° (సరి)', bn: '24-30° (বিষম) / 0-6° (সম)', kn: '24-30° (ಬೆಸ) / 0-6° (ಸಮ)', gu: '24-30° (વિષમ) / 0-6° (સમ)' }, result: { en: 'Planet at minimum power — gives weak or denied results in its significations.', hi: 'ग्रह न्यूनतम शक्ति पर — अपने कारकत्वों में कमजोर या अस्वीकृत फल।', sa: 'ग्रह न्यूनतम शक्ति पर — अपने कारकत्वों में कमजोर या अस्वीकृत फल।', mai: 'ग्रह न्यूनतम शक्ति पर — अपने कारकत्वों में कमजोर या अस्वीकृत फल।', mr: 'ग्रह न्यूनतम शक्ति पर — अपने कारकत्वों में कमजोर या अस्वीकृत फल।', ta: 'கிரகம் குறைந்தபட்ச சக்தியில் — அதன் காரகத்துவங்களில் பலவீனமான அல்லது மறுக்கப்பட்ட பலன்கள் தருகிறது.', te: 'గ్రహం కనిష్ట శక్తిలో — దాని కారకత్వాలలో బలహీనమైన లేదా నిరాకరించబడిన ఫలితాలు ఇస్తుంది.', bn: 'গ্রহ ন্যূনতম শক্তিতে — এর কারকত্বে দুর্বল বা প্রত্যাখ্যাত ফল দেয়।', kn: 'ಗ್ರಹ ಕನಿಷ್ಠ ಶಕ್ತಿಯಲ್ಲಿ — ಅದರ ಕಾರಕತ್ವಗಳಲ್ಲಿ ದುರ್ಬಲ ಅಥವಾ ನಿರಾಕರಿಸಿದ ಫಲ ನೀಡುತ್ತದೆ.', gu: 'ગ્રહ ન્યૂનતમ શક્તિમાં — તેના કારકત્વોમાં નબળા અથવા નકારેલા ફળ આપે છે.' }, color: 'text-red-400', tier: 'denied', stateKey: 'mrita' },
  ];

  const JAGRA_STATES = [
    { name: { en: 'Jagrat (Awake)', hi: 'जाग्रत', sa: 'जाग्रत', mai: 'जाग्रत', mr: 'जाग्रत', ta: 'ஜாக்ரத் (விழிப்பு)', te: 'జాగ్రత్ (మెలకువ)', bn: 'জাগ্রত (জাগ্রত)', kn: 'ಜಾಗ್ರತ್ (ಎಚ್ಚರ)', gu: 'જાગ્રત (જાગૃત)' }, condition: { en: 'Planet in own sign or exaltation', hi: 'ग्रह स्वराशि या उच्च में', sa: 'ग्रह स्वराशि या उच्च में', mai: 'ग्रह स्वराशि या उच्च में', mr: 'ग्रह स्वराशि या उच्च में', ta: 'சொந்த ராசி அல்லது உச்ச ராசியில் கிரகம்', te: 'స్వగృహం లేదా ఉచ్చ రాశిలో గ్రహం', bn: 'স্বরাশি বা উচ্চ রাশিতে গ্রহ', kn: 'ಸ್ವರಾಶಿ ಅಥವಾ ಉಚ್ಚ ರಾಶಿಯಲ್ಲಿ ಗ್ರಹ', gu: 'સ્વરાશિ અથવા ઉચ્ચ રાશિમાં ગ્રહ' }, result: { en: 'Fully awake and delivering 100% results. The planet is in its most comfortable position.', hi: 'पूर्ण जागृत और 100% फल। ग्रह अपनी सबसे आरामदायक स्थिति में।', sa: 'पूर्ण जागृत और 100% फल। ग्रह अपनी सबसे आरामदायक स्थिति में।', mai: 'पूर्ण जागृत और 100% फल। ग्रह अपनी सबसे आरामदायक स्थिति में।', mr: 'पूर्ण जागृत और 100% फल। ग्रह अपनी सबसे आरामदायक स्थिति में।', ta: 'முழு விழிப்புடன் 100% பலன்களை வழங்குகிறது. கிரகம் மிகவும் வசதியான நிலையில் உள்ளது.', te: 'పూర్తిగా మేల్కొని 100% ఫలితాలను ఇస్తోంది. గ్రహం అత్యంత సౌకర్యవంతమైన స్థానంలో ఉంది.', bn: 'সম্পূর্ণ জাগ্রত এবং 100% ফল প্রদান করছে। গ্রহটি সবচেয়ে আরামদায়ক অবস্থানে।', kn: 'ಸಂಪೂರ್ಣ ಎಚ್ಚರವಾಗಿ 100% ಫಲಿತಾಂಶ ನೀಡುತ್ತಿದೆ. ಗ್ರಹವು ಅತ್ಯಂತ ಆರಾಮದಾಯಕ ಸ್ಥಾನದಲ್ಲಿದೆ.', gu: 'સંપૂર્ણ જાગૃત અને 100% પરિણામો આપે છે. ગ્રહ સૌથી આરામદાયક સ્થિતિમાં છે.' }, color: 'text-emerald-400', tier: 'excellent', stateKey: 'jagrat' },
    { name: { en: 'Swapna (Dreaming)', hi: 'स्वप्न', sa: 'स्वप्न', mai: 'स्वप्न', mr: 'स्वप्न', ta: 'ஸ்வப்ன (கனவு)', te: 'స్వప్న (కల)', bn: 'স্বপ্ন (স্বপ্ন)', kn: 'ಸ್ವಪ್ನ (ಕನಸು)', gu: 'સ્વપ્ન (સ્વપ્ન)' }, condition: { en: 'Planet in friendly sign', hi: 'ग्रह मित्र राशि में', sa: 'ग्रह मित्र राशि में', mai: 'ग्रह मित्र राशि में', mr: 'ग्रह मित्र राशि में', ta: 'நட்பு ராசியில் கிரகம்', te: 'మిత్ర రాశిలో గ్రహం', bn: 'মিত্র রাশিতে গ্রহ', kn: 'ಮಿತ್ರ ರಾಶಿಯಲ್ಲಿ ಗ್ರಹ', gu: 'મિત્ર રાશિમાં ગ્રહ' }, result: { en: 'Moderately active — delivers results but not at full capacity. Like working in a comfortable guest room.', hi: 'मध्यम सक्रिय — फल देता है परन्तु पूर्ण क्षमता से नहीं।', sa: 'मध्यम सक्रिय — फल देता है परन्तु पूर्ण क्षमता से नहीं।', mai: 'मध्यम सक्रिय — फल देता है परन्तु पूर्ण क्षमता से नहीं।', mr: 'मध्यम सक्रिय — फल देता है परन्तु पूर्ण क्षमता से नहीं।', ta: 'மிதமாக செயலில் — பலன்கள் தருகிறது ஆனால் முழு திறனில் அல்ல. வசதியான விருந்தினர் அறையில் வேலை செய்வது போல.', te: 'మధ్యస్థంగా సక్రియం — ఫలితాలు ఇస్తుంది కానీ పూర్తి సామర్థ్యంతో కాదు. సౌకర్యవంతమైన అతిథి గదిలో పనిచేయడం వంటిది.', bn: 'মাঝারিভাবে সক্রিয় — ফল দেয় কিন্তু পূর্ণ ক্ষমতায় নয়। আরামদায়ক অতিথি কক্ষে কাজ করার মতো।', kn: 'ಮಧ್ಯಮವಾಗಿ ಸಕ್ರಿಯ — ಫಲ ನೀಡುತ್ತದೆ ಆದರೆ ಪೂರ್ಣ ಸಾಮರ್ಥ್ಯದಲ್ಲಿ ಅಲ್ಲ. ಆರಾಮದಾಯಕ ಅತಿಥಿ ಕೊಠಡಿಯಲ್ಲಿ ಕೆಲಸ ಮಾಡಿದಂತೆ.', gu: 'મધ્યમ રીતે સક્રિય — ફળ આપે છે પણ પૂર્ણ ક્ષમતાએ નહીં. આરામદાયક મહેમાન ઓરડામાં કામ કરવા જેવું.' }, color: 'text-amber-400', tier: 'good', stateKey: 'swapna' },
    { name: { en: 'Sushupti (Deep Sleep)', hi: 'सुषुप्ति', sa: 'सुषुप्ति', mai: 'सुषुप्ति', mr: 'सुषुप्ति', ta: 'சுஷுப்தி (ஆழ்நிலை)', te: 'సుషుప్తి (గాఢనిద్ర)', bn: 'সুষুপ্তি (গভীর নিদ্রা)', kn: 'ಸುಷುಪ್ತಿ (ಗಾಢ ನಿದ್ರೆ)', gu: 'સુષુપ્તિ (ગાઢ નિદ્રા)' }, condition: { en: 'Planet in enemy sign or debilitation', hi: 'ग्रह शत्रु राशि या नीच में', sa: 'ग्रह शत्रु राशि या नीच में', mai: 'ग्रह शत्रु राशि या नीच में', mr: 'ग्रह शत्रु राशि या नीच में', ta: 'பகை ராசி அல்லது நீச ராசியில் கிரகம்', te: 'శత్రు రాశి లేదా నీచ రాశిలో గ్రహం', bn: 'শত্রু রাশি বা নীচ রাশিতে গ্রহ', kn: 'ಶತ್ರು ರಾಶಿ ಅಥವಾ ನೀಚ ರಾಶಿಯಲ್ಲಿ ಗ್ರಹ', gu: 'શત્રુ રાશિ અથવા નીચ રાશિમાં ગ્રહ' }, result: { en: 'Dormant — significations suppressed, results blocked or severely delayed. The planet struggles to express itself.', hi: 'सुप्त — कारकत्व दबे, फल अवरुद्ध या अत्यधिक विलम्बित।', sa: 'सुप्त — कारकत्व दबे, फल अवरुद्ध या अत्यधिक विलम्बित।', mai: 'सुप्त — कारकत्व दबे, फल अवरुद्ध या अत्यधिक विलम्बित।', mr: 'सुप्त — कारकत्व दबे, फल अवरुद्ध या अत्यधिक विलम्बित।', ta: 'உறக்க நிலை — காரகத்துவங்கள் அடக்கப்பட்டன, பலன்கள் தடுக்கப்பட்டன அல்லது கடுமையாக தாமதமாகின்றன. கிரகம் தன்னை வெளிப்படுத்த போராடுகிறது.', te: 'నిద్రాణం — కారకత్వాలు అణచివేయబడ్డాయి, ఫలితాలు నిరోధించబడ్డాయి లేదా తీవ్రంగా ఆలస్యమయ్యాయి. గ్రహం తనను తాను వ్యక్తపరచడానికి కష్టపడుతుంది.', bn: 'সুপ্ত — কারকত্ব দমিত, ফল অবরুদ্ধ বা গুরুতরভাবে বিলম্বিত। গ্রহ নিজেকে প্রকাশ করতে সংগ্রাম করে।', kn: 'ಸುಪ್ತ — ಕಾರಕತ್ವಗಳು ಅಡಗಿಸಲ್ಪಟ್ಟಿವೆ, ಫಲಗಳು ತಡೆಯಲ್ಪಟ್ಟಿವೆ ಅಥವಾ ತೀವ್ರವಾಗಿ ವಿಳಂಬವಾಗಿವೆ. ಗ್ರಹ ತನ್ನನ್ನು ತಾನು ವ್ಯಕ್ತಪಡಿಸಲು ಹೆಣಗಾಡುತ್ತದೆ.', gu: 'નિષ્ક્રિય — કારકત્વો દબાયેલા, ફળ અવરોધિત અથવા ગંભીર રીતે વિલંબિત. ગ્રહ પોતાને વ્યક્ત કરવા સંઘર્ષ કરે છે.' }, color: 'text-red-400', tier: 'denied', stateKey: 'sushupti' },
  ];

  const DEEPTA_STATES = [
    { name: { en: 'Deepta (Exalted)', hi: 'दीप्त (उच्च)', sa: 'दीप्त (उच्च)', mai: 'दीप्त (उच्च)', mr: 'दीप्त (उच्च)', ta: 'தீப்த (உச்சம்)', te: 'దీప్త (ఉచ్చం)', bn: 'দীপ্ত (উচ্চ)', kn: 'ದೀಪ್ತ (ಉಚ್ಚ)', gu: 'દીપ્ત (ઉચ્ચ)' }, condition: { en: 'Planet in exaltation sign', hi: 'ग्रह उच्च राशि में', sa: 'ग्रह उच्च राशि में', mai: 'ग्रह उच्च राशि में', mr: 'ग्रह उच्च राशि में', ta: 'உச்ச ராசியில் கிரகம்', te: 'ఉచ్చ రాశిలో గ్రహం', bn: 'উচ্চ রাশিতে গ্রহ', kn: 'ಉಚ್ಚ ರಾಶಿಯಲ್ಲಿ ಗ್ರಹ', gu: 'ઉચ્ચ રાશિમાં ગ્રહ' }, result: { en: 'Maximum luminosity — planet shines at its absolute brightest. Results are extraordinary and effortless.', hi: 'अधिकतम दीप्ति — ग्रह अपनी पूर्ण चमक पर। फल असाधारण और सहज।', sa: 'अधिकतम दीप्ति — ग्रह अपनी पूर्ण चमक पर। फल असाधारण और सहज।', mai: 'अधिकतम दीप्ति — ग्रह अपनी पूर्ण चमक पर। फल असाधारण और सहज।', mr: 'अधिकतम दीप्ति — ग्रह अपनी पूर्ण चमक पर। फल असाधारण और सहज।', ta: 'அதிகபட்ச ஒளிர்வு — கிரகம் தன் முழு பிரகாசத்தில் ஒளிர்கிறது. பலன்கள் அசாதாரணமானவை மற்றும் சிரமற்றவை.', te: 'గరిష్ట ప్రకాశం — గ్రహం తన అత్యుత్తమ ప్రకాశంతో మెరుస్తుంది. ఫలితాలు అసాధారణమైనవి మరియు అనాయాసమైనవి.', bn: 'সর্বোচ্চ উজ্জ্বলতা — গ্রহ তার পরম উজ্জ্বলতায় জ্বলে। ফল অসাধারণ এবং অনায়াস।', kn: 'ಗರಿಷ್ಠ ಪ್ರಕಾಶ — ಗ್ರಹ ತನ್ನ ಅತ್ಯುತ್ತಮ ಪ್ರಕಾಶದಲ್ಲಿ ಹೊಳೆಯುತ್ತದೆ. ಫಲಗಳು ಅಸಾಧಾರಣ ಮತ್ತು ಅನಾಯಾಸ.', gu: 'મહત્તમ તેજસ્વિતા — ગ્રહ પોતાની સંપૂર્ણ ચમક સાથે ચમકે છે. ફળ અસાધારણ અને સહેલા છે.' }, color: 'text-amber-400', tier: 'excellent', stateKey: 'deepta' },
    { name: { en: 'Swastha (Own sign)', hi: 'स्वस्थ (स्वराशि)', sa: 'स्वस्थ (स्वराशि)', mai: 'स्वस्थ (स्वराशि)', mr: 'स्वस्थ (स्वराशि)', ta: 'ஸ்வஸ்த (சொந்த ராசி)', te: 'స్వస్థ (స్వరాశి)', bn: 'স্বস্থ (স্বরাশি)', kn: 'ಸ್ವಸ್ಥ (ಸ್ವರಾಶಿ)', gu: 'સ્વસ્થ (સ્વરાશિ)' }, condition: { en: 'Planet in own sign', hi: 'ग्रह स्वराशि में', sa: 'ग्रह स्वराशि में', mai: 'ग्रह स्वराशि में', mr: 'ग्रह स्वराशि में', ta: 'சொந்த ராசியில் கிரகம்', te: 'స్వగృహంలో గ్రహం', bn: 'স্বরাশিতে গ্রহ', kn: 'ಸ್ವರಾಶಿಯಲ್ಲಿ ಗ್ರಹ', gu: 'સ્વરાશિમાં ગ્રહ' }, result: { en: 'Healthy and comfortable — delivers strong, reliable results. At home.', hi: 'स्वस्थ और सहज — मजबूत, विश्वसनीय फल। अपने घर में।', sa: 'स्वस्थ और सहज — मजबूत, विश्वसनीय फल। अपने घर में।', mai: 'स्वस्थ और सहज — मजबूत, विश्वसनीय फल। अपने घर में।', mr: 'स्वस्थ और सहज — मजबूत, विश्वसनीय फल। अपने घर में।', ta: 'ஆரோக்கியமான மற்றும் வசதியான — வலுவான, நம்பகமான பலன்கள் தருகிறது. வீட்டில் உள்ளது போல.', te: 'ఆరోగ్యకరం మరియు సౌకర్యవంతం — బలమైన, నమ్మదగిన ఫలితాలు ఇస్తుంది. ఇంట్లో ఉన్నట్లు.', bn: 'সুস্থ ও আরামদায়ক — শক্তিশালী, নির্ভরযোগ্য ফল দেয়। নিজ গৃহে।', kn: 'ಆರೋಗ್ಯಕರ ಮತ್ತು ಆರಾಮದಾಯಕ — ಬಲವಾದ, ವಿಶ್ವಾಸಾರ್ಹ ಫಲ ನೀಡುತ್ತದೆ. ಮನೆಯಲ್ಲಿರುವಂತೆ.', gu: 'સ્વસ્થ અને આરામદાયક — મજબૂત, વિશ્વસનીય ફળ આપે છે. ઘરમાં હોય તેમ.' }, color: 'text-emerald-400', tier: 'excellent', stateKey: null },
    { name: { en: 'Mudita (Friendly sign)', hi: 'मुदित (मित्र राशि)', sa: 'मुदित (मित्र राशि)', mai: 'मुदित (मित्र राशि)', mr: 'मुदित (मित्र राशि)', ta: 'முதித (நட்பு ராசி)', te: 'ముదిత (మిత్రరాశి)', bn: 'মুদিত (মিত্ররাশি)', kn: 'ಮುದಿತ (ಮಿತ್ರರಾಶಿ)', gu: 'મુદિત (મિત્રરાશિ)' }, condition: { en: 'Planet in friendly sign', hi: 'ग्रह मित्र राशि में', sa: 'ग्रह मित्र राशि में', mai: 'ग्रह मित्र राशि में', mr: 'ग्रह मित्र राशि में', ta: 'நட்பு ராசியில் கிரகம்', te: 'మిత్ర రాశిలో గ్రహం', bn: 'মিত্র রাশিতে গ্রহ', kn: 'ಮಿತ್ರ ರಾಶಿಯಲ್ಲಿ ಗ್ರಹ', gu: 'મિત્ર રાશિમાં ગ્રહ' }, result: { en: 'Happy and willing — good results, cooperative energy.', hi: 'प्रसन्न और सहायक — अच्छे फल, सहयोगी ऊर्जा।', sa: 'प्रसन्न और सहायक — अच्छे फल, सहयोगी ऊर्जा।', mai: 'प्रसन्न और सहायक — अच्छे फल, सहयोगी ऊर्जा।', mr: 'प्रसन्न और सहायक — अच्छे फल, सहयोगी ऊर्जा।', ta: 'மகிழ்ச்சியான மற்றும் விருப்பமான — நல்ல பலன்கள், ஒத்துழைப்பு ஆற்றல்.', te: 'సంతోషంగా మరియు సుముఖంగా — మంచి ఫలితాలు, సహకార శక్తి.', bn: 'সুখী ও ইচ্ছুক — ভালো ফল, সহযোগী শক্তি।', kn: 'ಸಂತೋಷ ಮತ್ತು ಸುಮುಖ — ಒಳ್ಳೆಯ ಫಲ, ಸಹಕಾರಿ ಶಕ್ತಿ.', gu: 'ખુશ અને તૈયાર — સારા ફળ, સહકારી ઊર્જા.' }, color: 'text-blue-300', tier: 'good', stateKey: null },
    { name: { en: 'Shanta (Neutral)', hi: 'शान्त (सम)', sa: 'शान्त (सम)', mai: 'शान्त (सम)', mr: 'शान्त (सम)', ta: 'சாந்த (நடுநிலை)', te: 'శాంత (సమరాశి)', bn: 'শান্ত (সমরাশি)', kn: 'ಶಾಂತ (ಸಮರಾಶಿ)', gu: 'શાંત (સમરાશિ)' }, condition: { en: 'Planet in neutral sign', hi: 'ग्रह सम राशि में', sa: 'ग्रह सम राशि में', mai: 'ग्रह सम राशि में', mr: 'ग्रह सम राशि में', ta: 'நடுநிலை ராசியில் கிரகம்', te: 'సమ రాశిలో గ్రహం', bn: 'নিরপেক্ষ রাশিতে গ্রহ', kn: 'ಸಮ ರಾಶಿಯಲ್ಲಿ ಗ್ರಹ', gu: 'સમ રાશિમાં ગ્રહ' }, result: { en: 'Calm but uninspired — average results, neither helped nor hindered.', hi: 'शांत पर प्रेरणाहीन — औसत फल, न सहायक न बाधक।', sa: 'शांत पर प्रेरणाहीन — औसत फल, न सहायक न बाधक।', mai: 'शांत पर प्रेरणाहीन — औसत फल, न सहायक न बाधक।', mr: 'शांत पर प्रेरणाहीन — औसत फल, न सहायक न बाधक।', ta: 'அமைதியான ஆனால் ஊக்கமற்ற — சராசரி பலன்கள், உதவியும் இல்லை தடையும் இல்லை.', te: 'ప్రశాంతం కానీ ప్రేరణ లేదు — సగటు ఫలితాలు, సహాయం లేదు అడ్డంకి లేదు.', bn: 'শান্ত কিন্তু অনুপ্রাণিত নয় — গড় ফল, সাহায্যও নেই বাধাও নেই।', kn: 'ಶಾಂತ ಆದರೆ ಪ್ರೇರಣೆಯಿಲ್ಲ — ಸರಾಸರಿ ಫಲ, ಸಹಾಯವೂ ಇಲ್ಲ ಅಡ್ಡಿಯೂ ಇಲ್ಲ.', gu: 'શાંત પણ પ્રેરણા વિનાનું — સરેરાશ ફળ, ન મદદ ન અવરોધ.' }, color: 'text-text-secondary', tier: 'mixed', stateKey: null },
    { name: { en: 'Khala (Debilitated)', hi: 'खल (नीच)', sa: 'खल (नीच)', mai: 'खल (नीच)', mr: 'खल (नीच)', ta: 'கல (நீசம்)', te: 'ఖల (నీచం)', bn: 'খল (নীচ)', kn: 'ಖಲ (ನೀಚ)', gu: 'ખલ (નીચ)' }, condition: { en: 'Planet in debilitation sign', hi: 'ग्रह नीच राशि में', sa: 'ग्रह नीच राशि में', mai: 'ग्रह नीच राशि में', mr: 'ग्रह नीच राशि में', ta: 'நீச ராசியில் கிரகம்', te: 'నీచ రాశిలో గ్రహం', bn: 'নীচ রাশিতে গ্রহ', kn: 'ನೀಚ ರಾಶಿಯಲ್ಲಿ ಗ್ರಹ', gu: 'નીચ રાશિમાં ગ્રહ' }, result: { en: 'Minimum luminosity — planet at its weakest. Results severely compromised unless Neecha Bhanga applies.', hi: 'न्यूनतम दीप्ति — ग्रह सबसे कमजोर। फल गम्भीर रूप से प्रभावित जब तक नीच भंग न हो।', sa: 'न्यूनतम दीप्ति — ग्रह सबसे कमजोर। फल गम्भीर रूप से प्रभावित जब तक नीच भंग न हो।', mai: 'न्यूनतम दीप्ति — ग्रह सबसे कमजोर। फल गम्भीर रूप से प्रभावित जब तक नीच भंग न हो।', mr: 'न्यूनतम दीप्ति — ग्रह सबसे कमजोर। फल गम्भीर रूप से प्रभावित जब तक नीच भंग न हो।', ta: 'குறைந்தபட்ச ஒளிர்வு — கிரகம் மிகவும் பலவீனமான நிலையில். நீச பங்கம் பொருந்தாவிட்டால் பலன்கள் கடுமையாக பாதிக்கப்படும்.', te: 'కనిష్ట ప్రకాశం — గ్రహం అత్యంత బలహీనంగా. నీచ భంగం వర్తించకపోతే ఫలితాలు తీవ్రంగా రాజీపడతాయి.', bn: 'ন্যূনতম উজ্জ্বলতা — গ্রহ সবচেয়ে দুর্বল। নীচ ভঙ্গ প্রযোজ্য না হলে ফল গুরুতরভাবে ক্ষতিগ্রস্ত।', kn: 'ಕನಿಷ್ಠ ಪ್ರಕಾಶ — ಗ್ರಹ ಅತ್ಯಂತ ದುರ್ಬಲದಲ್ಲಿ. ನೀಚ ಭಂಗ ಅನ್ವಯವಾಗದಿದ್ದರೆ ಫಲಗಳು ತೀವ್ರವಾಗಿ ಹಾನಿಗೊಳಗಾಗುತ್ತವೆ.', gu: 'ન્યૂનતમ તેજસ્વિતા — ગ્રહ સૌથી નબળી સ્થિતિમાં. નીચ ભંગ લાગુ ન પડે તો ફળ ગંભીર રીતે નબળા પડે છે.' }, color: 'text-red-400', tier: 'denied', stateKey: 'khala' },
    { name: { en: 'Vikala (Combust)', hi: 'विकल (अस्त)', sa: 'विकल (अस्त)', mai: 'विकल (अस्त)', mr: 'विकल (अस्त)', ta: 'விகல (அஸ்தமனம்)', te: 'వికల (అస్తంగతం)', bn: 'বিকল (অস্তঙ্গত)', kn: 'ವಿಕಲ (ಅಸ್ತಂಗತ)', gu: 'વિકલ (અસ્તંગત)' }, condition: { en: 'Planet within combustion range of Sun', hi: 'ग्रह सूर्य से अस्त सीमा में', sa: 'ग्रह सूर्य से अस्त सीमा में', mai: 'ग्रह सूर्य से अस्त सीमा में', mr: 'ग्रह सूर्य से अस्त सीमा में', ta: 'சூரியனின் அஸ்தமன வரம்பில் கிரகம்', te: 'సూర్యుడి అస్తంగత పరిధిలో గ్రహం', bn: 'সূর্যের অস্তঙ্গত পরিসীমায় গ্রহ', kn: 'ಸೂರ್ಯನ ಅಸ್ತಂಗತ ವ್ಯಾಪ್ತಿಯಲ್ಲಿ ಗ್ರಹ', gu: 'સૂર્યની અસ્તંગત સીમામાં ગ્રહ' }, result: { en: 'Burnt by Sun\'s rays — significations overshadowed by ego, authority, or father figure.', hi: 'सूर्य की किरणों से दग्ध — कारकत्व अहंकार, सत्ता या पितृ आकृति से आच्छादित।' }, color: 'text-orange-400', tier: 'weak', stateKey: 'vikala' },
    { name: { en: 'Shakta (Retrograde)', hi: 'शक्त (वक्री)', sa: 'शक्त (वक्री)', mai: 'शक्त (वक्री)', mr: 'शक्त (वक्री)', ta: 'சக்த (வக்கிரம்)', te: 'శక్త (వక్రం)', bn: 'শক্ত (বক্র)', kn: 'ಶಕ್ತ (ವಕ್ರ)', gu: 'શક્ત (વક્ર)' }, condition: { en: 'Planet in retrograde motion', hi: 'ग्रह वक्री गति में', sa: 'ग्रह वक्री गति में', mai: 'ग्रह वक्री गति में', mr: 'ग्रह वक्री गति में', ta: 'வக்ர கதியில் கிரகம்', te: 'వక్ర గతిలో గ్రహం', bn: 'বক্রগতিতে গ্রহ', kn: 'ವಕ್ರ ಗತಿಯಲ್ಲಿ ಗ್ರಹ', gu: 'વક્ર ગતિમાં ગ્રહ' }, result: { en: 'Powerful but internalized — energy directed inward. Past-life themes surface. Closer to Earth = stronger.', hi: 'शक्तिशाली पर आन्तरिक — ऊर्जा अन्दर निर्देशित। पूर्वजन्म विषय उभरते हैं।', sa: 'शक्तिशाली पर आन्तरिक — ऊर्जा अन्दर निर्देशित। पूर्वजन्म विषय उभरते हैं।', mai: 'शक्तिशाली पर आन्तरिक — ऊर्जा अन्दर निर्देशित। पूर्वजन्म विषय उभरते हैं।', mr: 'शक्तिशाली पर आन्तरिक — ऊर्जा अन्दर निर्देशित। पूर्वजन्म विषय उभरते हैं।', ta: 'சக்திவாய்ந்த ஆனால் உள்முகமான — ஆற்றல் உள்நோக்கி செலுத்தப்படுகிறது. முற்பிறவி கருப்பொருள்கள் வெளிப்படுகின்றன. பூமிக்கு நெருக்கமான = வலிமையான.', te: 'శక్తివంతం కానీ అంతర్గతం — శక్తి లోపలికి మళ్ళించబడింది. పూర్వజన్మ ఇతివృత్తాలు బయటపడతాయి. భూమికి దగ్గరగా = బలంగా.', bn: 'শক্তিশালী কিন্তু অন্তর্মুখী — শক্তি অভ্যন্তরে পরিচালিত। পূর্বজন্মের থিম প্রকাশ পায়। পৃথিবীর কাছে = শক্তিশালী।', kn: 'ಶಕ್ತಿಶಾಲಿ ಆದರೆ ಆಂತರಿಕ — ಶಕ್ತಿ ಒಳಮುಖವಾಗಿ ನಿರ್ದೇಶಿಸಲ್ಪಟ್ಟಿದೆ. ಪೂರ್ವಜನ್ಮ ವಿಷಯಗಳು ಮೇಲ್ಮೈಗೆ ಬರುತ್ತವೆ. ಭೂಮಿಗೆ ಹತ್ತಿರ = ಬಲವಾದ.', gu: 'શક્તિશાળી પણ આંતરિક — ઊર્જા અંદર તરફ નિર્દેશિત. પૂર્વજન્મની થીમ્સ ઉભરે છે. પૃથ્વીની નજીક = મજબૂત.' }, color: 'text-violet-400', tier: 'good', stateKey: 'shakta' },
  ];

  const LAJJITA_STATES = [
    { name: { en: 'Lajjita (Ashamed)', hi: 'लज्जित', sa: 'लज्जित', mai: 'लज्जित', mr: 'लज्जित', ta: 'லஜ்ஜித (வெட்கம்)', te: 'లజ్జిత (సిగ్గు)', bn: 'লজ্জিত (লজ্জা)', kn: 'ಲಜ್ಜಿತ (ನಾಚಿಕೆ)', gu: 'લજ્જિત (લજ્જા)' }, condition: { en: 'Planet in 5th house conjunct Rahu/Ketu/Saturn/Mars', hi: 'ग्रह 5वें भाव में राहु/केतु/शनि/मंगल से युत', sa: 'ग्रह 5वें भाव में राहु/केतु/शनि/मंगल से युत', mai: 'ग्रह 5वें भाव में राहु/केतु/शनि/मंगल से युत', mr: 'ग्रह 5वें भाव में राहु/केतु/शनि/मंगल से युत', ta: '5வது வீட்டில் ராகு/கேது/சனி/செவ்வாய் உடன் கிரகம்', te: '5వ భావంలో రాహు/కేతు/శని/కుజుడితో గ్రహం', bn: '5ম ভাবে রাহু/কেতু/শনি/মঙ্গলের সাথে গ্রহ', kn: '5ನೇ ಭಾವದಲ್ಲಿ ರಾಹು/ಕೇತು/ಶನಿ/ಕುಜನೊಂದಿಗೆ ಗ್ರಹ', gu: '5મા ભાવમાં રાહુ/કેતુ/શનિ/મંગળ સાથે ગ્રહ' }, effect: { en: 'Shame, embarrassment in the planet\'s significations. Social judgment themes.', hi: 'ग्रह के कारकत्वों में लज्जा, शर्मिंदगी। सामाजिक निर्णय।' }, color: 'text-pink-400', stateKey: 'lajjita' },
    { name: { en: 'Garvita (Proud)', hi: 'गर्वित', sa: 'गर्वित', mai: 'गर्वित', mr: 'गर्वित', ta: 'கர்வித (கர்வம்)', te: 'గర్విత (గర్వం)', bn: 'গর্বিত (গর্ব)', kn: 'ಗರ್ವಿತ (ಗರ್ವ)', gu: 'ગર્વિત (ગર્વ)' }, condition: { en: 'Planet in exaltation or own moolatrikona', hi: 'ग्रह उच्च या स्वमूलत्रिकोण में', sa: 'ग्रह उच्च या स्वमूलत्रिकोण में', mai: 'ग्रह उच्च या स्वमूलत्रिकोण में', mr: 'ग्रह उच्च या स्वमूलत्रिकोण में', ta: 'உச்ச அல்லது சொந்த மூலத்திரிகோணத்தில் கிரகம்', te: 'ఉచ్చ లేదా స్వ మూలత్రికోణంలో గ్రహం', bn: 'উচ্চ বা স্ব মূলত্রিকোণে গ্রহ', kn: 'ಉಚ್ಚ ಅಥವಾ ಸ್ವ ಮೂಲತ್ರಿಕೋಣದಲ್ಲಿ ಗ್ರಹ', gu: 'ઉચ્ચ અથવા સ્વ મૂળત્રિકોણમાં ગ્રહ' }, effect: { en: 'Pride and confidence in the planet\'s domain. Can tip into arrogance.', hi: 'ग्रह के क्षेत्र में गर्व और आत्मविश्वास। अहंकार में बदल सकता है।' }, color: 'text-amber-400', stateKey: 'garvita' },
    { name: { en: 'Kshudhita (Hungry)', hi: 'क्षुधित', sa: 'क्षुधित', mai: 'क्षुधित', mr: 'क्षुधित', ta: 'க்ஷுதித (பசி)', te: 'క్షుధిత (ఆకలి)', bn: 'ক্ষুধিত (ক্ষুধার্ত)', kn: 'ಕ್ಷುಧಿತ (ಹಸಿವು)', gu: 'ક્ષુધિત (ભૂખ)' }, condition: { en: 'Planet in enemy sign or conjunct enemy planet', hi: 'ग्रह शत्रु राशि में या शत्रु ग्रह से युत', sa: 'ग्रह शत्रु राशि में या शत्रु ग्रह से युत', mai: 'ग्रह शत्रु राशि में या शत्रु ग्रह से युत', mr: 'ग्रह शत्रु राशि में या शत्रु ग्रह से युत', ta: 'பகை ராசியில் அல்லது பகை கிரகத்துடன் சேர்ந்து கிரகம்', te: 'శత్రు రాశిలో లేదా శత్రు గ్రహంతో కలిసి గ్రహం', bn: 'শত্রু রাশিতে বা শত্রু গ্রহের সাথে যুক্ত গ্রহ', kn: 'ಶತ್ರು ರಾಶಿಯಲ್ಲಿ ಅಥವಾ ಶತ್ರು ಗ್ರಹದೊಂದಿಗೆ ಯುತ ಗ್ರಹ', gu: 'શત્રુ રાશિમાં અથવા શત્રુ ગ્રહ સાથે યુક્ત ગ્રહ' }, effect: { en: 'Insatiable hunger for the planet\'s significations. Never enough.', hi: 'ग्रह के कारकत्वों की अतृप्त भूख। कभी पर्याप्त नहीं।' }, color: 'text-orange-400', stateKey: 'kshudhita' },
    { name: { en: 'Trushita (Thirsty)', hi: 'तृषित', sa: 'तृषित', mai: 'तृषित', mr: 'तृषित', ta: 'த்ருஷித (தாகம்)', te: 'తృషిత (దాహం)', bn: 'তৃষিত (তৃষ্ণার্ত)', kn: 'ತೃಷಿತ (ಬಾಯಾರಿಕೆ)', gu: 'તૃષિત (તરસ)' }, condition: { en: 'Planet in watery sign aspected by enemy or in 6th/12th', hi: 'ग्रह जल राशि में शत्रु दृष्टि या 6/12 में', sa: 'ग्रह जल राशि में शत्रु दृष्टि या 6/12 में', mai: 'ग्रह जल राशि में शत्रु दृष्टि या 6/12 में', mr: 'ग्रह जल राशि में शत्रु दृष्टि या 6/12 में', ta: 'நீர் ராசியில் பகை பார்வையில் அல்லது 6/12 வீட்டில் கிரகம்', te: 'జల రాశిలో శత్రు దృష్టిలో లేదా 6/12 భావంలో గ్రహం', bn: 'জল রাশিতে শত্রু দৃষ্টিতে বা 6/12 ভাবে গ্রহ', kn: 'ಜಲ ರಾಶಿಯಲ್ಲಿ ಶತ್ರು ದೃಷ್ಟಿಯಲ್ಲಿ ಅಥವಾ 6/12 ಭಾವದಲ್ಲಿ ಗ್ರಹ', gu: 'જળ રાશિમાં શત્રુ દૃષ્ટિમાં અથવા 6/12 ભાવમાં ગ્રહ' }, effect: { en: 'Emotional depletion despite having resources. Inner emptiness.', hi: 'संसाधन होने के बावजूद भावनात्मक रिक्तता। आन्तरिक शून्यता।', sa: 'संसाधन होने के बावजूद भावनात्मक रिक्तता। आन्तरिक शून्यता।', mai: 'संसाधन होने के बावजूद भावनात्मक रिक्तता। आन्तरिक शून्यता।', mr: 'संसाधन होने के बावजूद भावनात्मक रिक्तता। आन्तरिक शून्यता।', ta: 'வளங்கள் இருந்தும் உணர்ச்சி வறட்சி. உள்ளார்ந்த வெறுமை.', te: 'వనరులు ఉన్నా భావోద్వేగ క్షీణత. అంతర్గత శూన్యత.', bn: 'সম্পদ থাকা সত্ত্বেও আবেগ ক্ষয়। অভ্যন্তরীণ শূন্যতা।', kn: 'ಸಂಪನ್ಮೂಲಗಳಿದ್ದರೂ ಭಾವನಾತ್ಮಕ ಕ್ಷೀಣತೆ. ಆಂತರಿಕ ಶೂನ್ಯತೆ.', gu: 'સંસાધનો હોવા છતાં ભાવનાત્મક ખાલીપો. આંતરિક ખાલીપો.' }, color: 'text-blue-400', stateKey: 'trushita' },
    { name: { en: 'Mudita (Delighted)', hi: 'मुदित', sa: 'मुदित', mai: 'मुदित', mr: 'मुदित', ta: 'முதித (மகிழ்ச்சி)', te: 'ముదిత (ఆనందం)', bn: 'মুদিত (আনন্দ)', kn: 'ಮುದಿತ (ಆನಂದ)', gu: 'મુદિત (આનંદ)' }, condition: { en: 'Planet in friendly sign aspected by Jupiter', hi: 'ग्रह मित्र राशि में गुरु दृष्टि', sa: 'ग्रह मित्र राशि में गुरु दृष्टि', mai: 'ग्रह मित्र राशि में गुरु दृष्टि', mr: 'ग्रह मित्र राशि में गुरु दृष्टि', ta: 'நட்பு ராசியில் குரு பார்வையில் கிரகம்', te: 'మిత్ర రాశిలో గురు దృష్టిలో గ్రహం', bn: 'মিত্র রাশিতে বৃহস্পতির দৃষ্টিতে গ্রহ', kn: 'ಮಿತ್ರ ರಾಶಿಯಲ್ಲಿ ಗುರು ದೃಷ್ಟಿಯಲ್ಲಿ ಗ್ರಹ', gu: 'મિત્ર રાશિમાં ગુરુ દૃષ્ટિમાં ગ્રહ' }, effect: { en: 'Joy and delight in the planet\'s significations. Grace and ease.', hi: 'ग्रह के कारकत्वों में आनन्द। कृपा और सहजता।' }, color: 'text-emerald-400', stateKey: 'mudita_l' },
    { name: { en: 'Kshobhita (Agitated)', hi: 'क्षोभित', sa: 'क्षोभित', mai: 'क्षोभित', mr: 'क्षोभित', ta: 'க்ஷோபித (கலக்கம்)', te: 'క్షోభిత (కలత)', bn: 'ক্ষোভিত (ক্ষুব্ধ)', kn: 'ಕ್ಷೋಭಿತ (ಕಲಕಿ)', gu: 'ક્ષોભિત (ક્ષુબ્ધ)' }, condition: { en: 'Planet conjunct Sun and aspected by malefic', hi: 'ग्रह सूर्य से युत और पापी दृष्टि', sa: 'ग्रह सूर्य से युत और पापी दृष्टि', mai: 'ग्रह सूर्य से युत और पापी दृष्टि', mr: 'ग्रह सूर्य से युत और पापी दृष्टि', ta: 'சூரியனுடன் சேர்ந்து பாபகிரக பார்வையில் கிரகம்', te: 'సూర్యుడితో కలిసి పాపగ్రహ దృష్టిలో గ్రహం', bn: 'সূর্যের সাথে যুক্ত এবং পাপগ্রহের দৃষ্টিতে গ্রহ', kn: 'ಸೂರ್ಯನೊಂದಿಗೆ ಯುತ ಮತ್ತು ಪಾಪಗ್ರಹ ದೃಷ್ಟಿಯಲ್ಲಿ ಗ್ರಹ', gu: 'સૂર્ય સાથે યુક્ત અને પાપગ્રહની દૃષ્ટિમાં ગ્રહ' }, effect: { en: 'Severe agitation, anxiety, and volatility. Double affliction.', hi: 'तीव्र क्षोभ, चिन्ता और अस्थिरता। दोहरा कष्ट।', sa: 'तीव्र क्षोभ, चिन्ता और अस्थिरता। दोहरा कष्ट।', mai: 'तीव्र क्षोभ, चिन्ता और अस्थिरता। दोहरा कष्ट।', mr: 'तीव्र क्षोभ, चिन्ता और अस्थिरता। दोहरा कष्ट।', ta: 'கடுமையான கிளர்ச்சி, பதற்றம் மற்றும் நிலையற்ற தன்மை. இரட்டை பாதிப்பு.', te: 'తీవ్ర ఆందోళన, ఆవేదన మరియు అస్థిరత. ద్విగుణ బాధ.', bn: 'তীব্র উত্তেজনা, উদ্বেগ এবং অস্থিরতা। দ্বিগুণ পীড়া।', kn: 'ತೀವ್ರ ಕ್ಷೋಭೆ, ಆತಂಕ ಮತ್ತು ಅಸ್ಥಿರತೆ. ದ್ವಿಗುಣ ಪೀಡೆ.', gu: 'ગંભીર ઉશ્કેરાટ, ચિંતા અને અસ્થિરતા. બેવડી પીડા.' }, color: 'text-red-400', stateKey: 'kshobhita' },
  ];

  const SHAYANA_STATES = [
    { name: { en: 'Shayana (Sleeping)', hi: 'शयन', sa: 'शयन', mai: 'शयन', mr: 'शयन', ta: 'சயன (உறக்கம்)', te: 'శయన (నిద్ర)', bn: 'শয়ন (শয়ন)', kn: 'ಶಯನ (ನಿದ್ರೆ)', gu: 'શયન (નિદ્રા)' }, desc: { en: 'Planet dormant — results delayed, internal processing. Like a seed underground.', hi: 'ग्रह सुप्त — फल विलम्बित, आन्तरिक प्रसंस्करण। भूमिगत बीज जैसा।', sa: 'ग्रह सुप्त — फल विलम्बित, आन्तरिक प्रसंस्करण। भूमिगत बीज जैसा।', mai: 'ग्रह सुप्त — फल विलम्बित, आन्तरिक प्रसंस्करण। भूमिगत बीज जैसा।', mr: 'ग्रह सुप्त — फल विलम्बित, आन्तरिक प्रसंस्करण। भूमिगत बीज जैसा।', ta: 'கிரகம் உறக்கத்தில் — பலன்கள் தாமதமாகின்றன, உள்ளார்ந்த செயலாக்கம். நிலத்தடியில் விதை போல.', te: 'గ్రహం నిద్రాణం — ఫలితాలు ఆలస్యం, అంతర్గత ప్రాసెసింగ్. భూమిలోని విత్తనం వలె.', bn: 'গ্রহ সুপ্ত — ফল বিলম্বিত, অভ্যন্তরীণ প্রক্রিয়াকরণ। মাটির নিচে বীজের মতো।', kn: 'ಗ್ರಹ ಸುಪ್ತ — ಫಲ ವಿಳಂಬ, ಆಂತರಿಕ ಸಂಸ್ಕರಣೆ. ಭೂಮಿಯೊಳಗಿನ ಬೀಜದಂತೆ.', gu: 'ગ્રહ નિષ્ક્રિય — ફળ વિલંબિત, આંતરિક પ્રક્રિયા. જમીનની અંદરના બીજ જેવું.' }, color: 'text-blue-400', stateKey: 'shayana' },
    { name: { en: 'Upavesha (Sitting)', hi: 'उपवेश', sa: 'उपवेश', mai: 'उपवेश', mr: 'उपवेश', ta: 'உபவேச (அமர்வு)', te: 'ఉపవేశ (కూర్చునిన)', bn: 'উপবেশ (উপবিষ্ট)', kn: 'ಉಪವೇಶ (ಕುಳಿತ)', gu: 'ઉપવેશ (બેઠેલું)' }, desc: { en: 'Planet aware but not yet moving — preparation phase. Ready to act but waiting for the signal.', hi: 'ग्रह जागरूक पर अभी गतिशील नहीं — तैयारी चरण। कार्य के लिए तैयार पर संकेत की प्रतीक्षा।', sa: 'ग्रह जागरूक पर अभी गतिशील नहीं — तैयारी चरण। कार्य के लिए तैयार पर संकेत की प्रतीक्षा।', mai: 'ग्रह जागरूक पर अभी गतिशील नहीं — तैयारी चरण। कार्य के लिए तैयार पर संकेत की प्रतीक्षा।', mr: 'ग्रह जागरूक पर अभी गतिशील नहीं — तैयारी चरण। कार्य के लिए तैयार पर संकेत की प्रतीक्षा।', ta: 'கிரகம் விழிப்புடன் ஆனால் இன்னும் நகரவில்லை — தயாரிப்பு நிலை. செயல்படத் தயாராக உள்ளது ஆனால் சமிக்ஞைக்காக காத்திருக்கிறது.', te: 'గ్రహం అవగాహనలో ఉంది కానీ ఇంకా కదలలేదు — సిద్ధం దశ. చర్యకు సిద్ధం కానీ సంకేతం కోసం ఎదురుచూస్తోంది.', bn: 'গ্রহ সচেতন কিন্তু এখনও নড়ছে না — প্রস্তুতি পর্যায়। কাজ করতে প্রস্তুত কিন্তু সংকেতের জন্য অপেক্ষা করছে।', kn: 'ಗ್ರಹ ಜಾಗೃತ ಆದರೆ ಇನ್ನೂ ಚಲಿಸಿಲ್ಲ — ಸಿದ್ಧತಾ ಹಂತ. ಕ್ರಿಯೆಗೆ ಸಿದ್ಧ ಆದರೆ ಸಂಕೇತಕ್ಕಾಗಿ ಕಾಯುತ್ತಿದೆ.', gu: 'ગ્રહ જાગૃત પણ હજુ ગતિમાં નથી — તૈયારીનો તબક્કો. કાર્ય માટે તૈયાર પણ સંકેતની રાહ જોઈ રહ્યો છે.' }, color: 'text-cyan-400', stateKey: null },
    { name: { en: 'Netrapani (Alert)', hi: 'नेत्रपाणि', sa: 'नेत्रपाणि', mai: 'नेत्रपाणि', mr: 'नेत्रपाणि', ta: 'நேத்ரபாணி (விழிப்பு)', te: 'నేత్రపాణి (అప్రమత్తం)', bn: 'নেত্রপাণি (সতর্ক)', kn: 'ನೇತ್ರಪಾಣಿ (ಎಚ್ಚರ)', gu: 'નેત્રપાણિ (સજાગ)' }, desc: { en: 'Planet actively scanning — watchful, receptive, gathering information before acting.', hi: 'ग्रह सक्रिय रूप से देखता है — सतर्क, ग्रहणशील, कार्य से पूर्व सूचना एकत्र।', sa: 'ग्रह सक्रिय रूप से देखता है — सतर्क, ग्रहणशील, कार्य से पूर्व सूचना एकत्र।', mai: 'ग्रह सक्रिय रूप से देखता है — सतर्क, ग्रहणशील, कार्य से पूर्व सूचना एकत्र।', mr: 'ग्रह सक्रिय रूप से देखता है — सतर्क, ग्रहणशील, कार्य से पूर्व सूचना एकत्र।', ta: 'கிரகம் தீவிரமாக ஆய்வு செய்கிறது — கவனமான, ஏற்றுக்கொள்ளும், செயல்படும் முன் தகவல் சேகரிக்கிறது.', te: 'గ్రహం చురుకుగా పరిశీలిస్తోంది — జాగ్రత్తగా, స్వీకరిస్తూ, చర్య తీసుకునే ముందు సమాచారం సేకరిస్తోంది.', bn: 'গ্রহ সক্রিয়ভাবে পর্যবেক্ষণ করছে — সতর্ক, গ্রহণশীল, কাজ করার আগে তথ্য সংগ্রহ করছে।', kn: 'ಗ್ರಹ ಸಕ್ರಿಯವಾಗಿ ಪರಿಶೀಲಿಸುತ್ತಿದೆ — ಜಾಗರೂಕ, ಸ್ವೀಕಾರಶೀಲ, ಕ್ರಿಯೆಗೆ ಮೊದಲು ಮಾಹಿತಿ ಸಂಗ್ರಹಿಸುತ್ತಿದೆ.', gu: 'ગ્રહ સક્રિયપણે તપાસ કરી રહ્યો છે — સાવધ, ગ્રહણશીલ, કાર્ય કરતા પહેલા માહિતી એકત્ર કરી રહ્યો છે.' }, color: 'text-emerald-400', stateKey: null },
    { name: { en: 'Prakasha (Illuminating)', hi: 'प्रकाश', sa: 'प्रकाश', mai: 'प्रकाश', mr: 'प्रकाश', ta: 'பிரகாச (ஒளிர்வு)', te: 'ప్రకాశ (ప్రకాశవంతం)', bn: 'প্রকাশ (প্রদীপ্ত)', kn: 'ಪ್ರಕಾಶ (ಪ್ರಕಾಶಮಾನ)', gu: 'પ્રકાશ (પ્રકાશિત)' }, desc: { en: 'Planet shining — results becoming visible, influence radiating outward.', hi: 'ग्रह प्रकाशमान — फल दृश्य, प्रभाव बाहर विकिरित।', sa: 'ग्रह प्रकाशमान — फल दृश्य, प्रभाव बाहर विकिरित।', mai: 'ग्रह प्रकाशमान — फल दृश्य, प्रभाव बाहर विकिरित।', mr: 'ग्रह प्रकाशमान — फल दृश्य, प्रभाव बाहर विकिरित।', ta: 'கிரகம் ஒளிர்கிறது — பலன்கள் தெரியத் தொடங்குகின்றன, செல்வாக்கு வெளிப்புறமாக பரவுகிறது.', te: 'గ్రహం మెరుస్తోంది — ఫలితాలు కనిపించడం మొదలవుతోంది, ప్రభావం బాహ్యంగా వ్యాపిస్తోంది.', bn: 'গ্রহ জ্বলছে — ফল দৃশ্যমান হচ্ছে, প্রভাব বাইরে ছড়িয়ে পড়ছে।', kn: 'ಗ್ರಹ ಹೊಳೆಯುತ್ತಿದೆ — ಫಲಗಳು ಗೋಚರಿಸುತ್ತಿವೆ, ಪ್ರಭಾವ ಹೊರಕ್ಕೆ ವಿಕಿರಣಗೊಳ್ಳುತ್ತಿದೆ.', gu: 'ગ્રહ ચમકી રહ્યો છે — ફળ દૃશ્યમાન થઈ રહ્યા છે, પ્રભાવ બહાર તરફ ફેલાઈ રહ્યો છે.' }, color: 'text-amber-400', stateKey: null },
    { name: { en: 'Gaman (Moving)', hi: 'गमन', sa: 'गमन', mai: 'गमन', mr: 'गमन', ta: 'கமன (இயக்கம்)', te: 'గమన (చలనం)', bn: 'গমন (গতিশীল)', kn: 'ಗಮನ (ಚಲನೆ)', gu: 'ગમન (ગતિશીલ)' }, desc: { en: 'Planet at peak activity — results delivered swiftly and strongly. Maximum output.', hi: 'ग्रह चरम सक्रियता पर — फल शीघ्र और प्रबल। अधिकतम उत्पादन।', sa: 'ग्रह चरम सक्रियता पर — फल शीघ्र और प्रबल। अधिकतम उत्पादन।', mai: 'ग्रह चरम सक्रियता पर — फल शीघ्र और प्रबल। अधिकतम उत्पादन।', mr: 'ग्रह चरम सक्रियता पर — फल शीघ्र और प्रबल। अधिकतम उत्पादन।', ta: 'கிரகம் உச்ச செயல்பாட்டில் — பலன்கள் விரைவாகவும் வலிமையாகவும் வழங்கப்படுகின்றன. அதிகபட்ச வெளியீடு.', te: 'గ్రహం అత్యధిక చర్యలో — ఫలితాలు వేగంగా మరియు బలంగా అందజేయబడతాయి. గరిష్ట ఉత్పత్తి.', bn: 'গ্রহ শীর্ষ কার্যকলাপে — ফল দ্রুত ও শক্তিশালীভাবে দেওয়া হয়। সর্বোচ্চ আউটপুট।', kn: 'ಗ್ರಹ ಉತ್ತುಂಗ ಚಟುವಟಿಕೆಯಲ್ಲಿ — ಫಲಗಳು ಶೀಘ್ರವಾಗಿ ಮತ್ತು ಬಲವಾಗಿ ವಿತರಿಸಲ್ಪಡುತ್ತವೆ. ಗರಿಷ್ಠ ಉತ್ಪಾದನೆ.', gu: 'ગ્રહ ટોચની સક્રિયતામાં — ફળ ઝડપથી અને મજબૂત રીતે આપવામાં આવે છે. મહત્તમ ઉત્પાદન.' }, color: 'text-amber-400', stateKey: 'gaman' },
    { name: { en: 'Agaman (Returning)', hi: 'आगमन', sa: 'आगमन', mai: 'आगमन', mr: 'आगमन', ta: 'ஆகமன (மீள்வு)', te: 'ఆగమన (తిరిగి వచ్చుట)', bn: 'আগমন (প্রত্যাবর্তন)', kn: 'ಆಗಮನ (ಮರಳುವಿಕೆ)', gu: 'આગમન (પરત આવવું)' }, desc: { en: 'Planet revisiting — completing unfinished business, second chances, reworking past themes.', hi: 'ग्रह पुनरागमन — अधूरे कार्य पूर्ण, दूसरा अवसर, पुराने विषयों का पुनर्कार्य।', sa: 'ग्रह पुनरागमन — अधूरे कार्य पूर्ण, दूसरा अवसर, पुराने विषयों का पुनर्कार्य।', mai: 'ग्रह पुनरागमन — अधूरे कार्य पूर्ण, दूसरा अवसर, पुराने विषयों का पुनर्कार्य।', mr: 'ग्रह पुनरागमन — अधूरे कार्य पूर्ण, दूसरा अवसर, पुराने विषयों का पुनर्कार्य।', ta: 'கிரகம் மறுபரிசீலனை — முடிக்கப்படாத காரியங்களை நிறைவு செய்கிறது, இரண்டாவது வாய்ப்புகள், கடந்தகால கருப்பொருள்களை மறுவடிவமைப்பு.', te: 'గ్రహం పునఃపరిశీలన — అసంపూర్ణ పనులు పూర్తి చేస్తోంది, రెండవ అవకాశాలు, గత ఇతివృత్తాల పునర్నిర్మాణం.', bn: 'গ্রহ পুনর্বিবেচনা — অসমাপ্ত কাজ সম্পন্ন করছে, দ্বিতীয় সুযোগ, অতীত থিম পুনর্গঠন।', kn: 'ಗ್ರಹ ಪುನರ್ಪರಿಶೀಲನೆ — ಅಪೂರ್ಣ ಕಾರ್ಯಗಳನ್ನು ಪೂರ್ಣಗೊಳಿಸುತ್ತಿದೆ, ಎರಡನೇ ಅವಕಾಶಗಳು, ಹಿಂದಿನ ವಿಷಯಗಳ ಪುನರ್ರಚನೆ.', gu: 'ગ્રહ પુનરાવલોકન — અધૂરા કામ પૂર્ણ કરી રહ્યો છે, બીજી તકો, ભૂતકાળની થીમ્સનું પુનર્ગઠન.' }, color: 'text-violet-400', stateKey: null },
  ];
    ...
    <div className="max-w-4xl mx-auto px-4 py-10 space-y-10">
      ...
      <motion.section initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="space-y-4">
        ...
        <p className="text-text-secondary text-sm leading-relaxed max-w-3xl">
          {tl({ en: 'Most avasthas are fixed in the natal chart. But three forces can shift them: transits (where planets are moving now), Neecha Bhanga (debilitation cancellation), and position-bound temporary states (combustion, retrograde, planetary war).', hi: 'जन्म कुण्डली में अधिकांश अवस्थाएं स्थायी हैं। लेकिन तीन कारकों से वे बदल सकती हैं: गोचर (ग्रहों का वर्तमान भ्रमण), नीच भंग (नीचता रद्दीकरण), और स्थिति-बद्ध अस्थायी दशाएं (अस्त, वक्री, ग्रहयुद्ध)।', sa: 'जन्म कुण्डली में अधिकांश अवस्थाएं स्थायी हैं। लेकिन तीन कारकों से वे बदल सकती हैं: गोचर (ग्रहों का वर्तमान भ्रमण), नीच भंग (नीचता रद्दीकरण), और स्थिति-बद्ध अस्थायी दशाएं (अस्त, वक्री, ग्रहयुद्ध)।' }, locale)}
        </p>
      ...
      <motion.section initial={{ opacity: 0, y: 15 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
        ...
        <div className="space-y-3">
          {[
            { tier: { en: 'Excellent', hi: 'उत्कृष्ट', sa: 'उत्कृष्ट', mai: 'उत्कृष्ट', mr: 'उत्कृष्ट', ta: 'மிகச்சிறந்த', te: 'అద్భుతం', bn: 'চমৎকার', kn: 'ಅತ್ಯುತ್ತಮ', gu: 'ઉત્તમ' }, pct: '80-100%', examples: { en: 'Yuva + Jagrat + Deepta + Mudita + Gaman', hi: 'युवा + जाग्रत + दीप्त + मुदित + गमन', sa: 'युवा + जाग्रत + दीप्त + मुदित + गमन', mai: 'युवा + जाग्रत + दीप्त + मुदित + गमन', mr: 'युवा + जाग्रत + दीप्त + मुदित + गमन', ta: 'யுவ + ஜாக்ரத் + தீப்த + முதித + கமன', te: 'యువ + జాగ్రత్ + దీప్త + ముదిత + గమన', bn: 'যুব + জাগ্রত + দীপ্ত + মুদিত + গমন', kn: 'ಯುವ + ಜಾಗ್ರತ + ದೀಪ್ತ + ಮುದಿತ + ಗಮನ', gu: 'યુવ + જાગ્રત + દીપ્ત + મુદિત + ગમન' }, desc: { en: 'The planet delivers its best results effortlessly. Life areas it governs flourish naturally.', hi: 'ग्रह अपने सर्वोत्तम फल सहज रूप से देता है। जिन जीवन क्षेत्रों पर शासन करता है वे स्वाभाविक रूप से फलते-फूलते हैं।', sa: 'ग्रह अपने सर्वोत्तम फल सहज रूप से देता है। जिन जीवन क्षेत्रों पर शासन करता है वे स्वाभाविक रूप से फलते-फूलते हैं।', mai: 'ग्रह अपने सर्वोत्तम फल सहज रूप से देता है। जिन जीवन क्षेत्रों पर शासन करता है वे स्वाभाविक रूप से फलते-फूलते हैं।', mr: 'ग्रह अपने सर्वोत्तम फल सहज रूप से देता है। जिन जीवन क्षेत्रों पर शासन करता है वे स्वाभाविक रूप से फलते-फूलते हैं।', ta: 'கிரகம் சிரமம் இல்லாமல் சிறந்த பலன்களை வழங்குகிறது. அது ஆளும் வாழ்க்கை பகுதிகள் இயற்கையாகவே செழிக்கின்றன.', te: 'గ్రహం అప్రయత్నంగా ఉత్తమ ఫలితాలను ఇస్తుంది. అది పాలించే జీవిత రంగాలు సహజంగా వర్ధిల్లుతాయి.', bn: 'গ্রহটি অনায়াসে সেরা ফল দেয়। এটি যে জীবন ক্ষেত্রগুলি শাসন করে তা স্বাভাবিকভাবে সমৃদ্ধ হয়।', kn: 'ಗ್ರಹವು ಅನಾಯಾಸವಾಗಿ ಅತ್ಯುತ್ತಮ ಫಲಿತಾಂಶ ನೀಡುತ್ತದೆ. ಅದು ಆಳುವ ಜೀವನ ಕ್ಷೇತ್ರಗಳು ಸಹಜವಾಗಿ ಸಮೃದ್ಧವಾಗುತ್ತವೆ.', gu: 'ગ્રહ સહેલાઈથી શ્રેષ્ઠ પરિણામો આપે છે. તે જે જીવન ક્ષેત્રો પર શાસન કરે છે તે કુદરતી રીતે ખીલે છે.' }, color: 'border-emerald-500/20' },
            { tier: { en: 'Good', hi: 'अच्छा', sa: 'अच्छा', mai: 'अच्छा', mr: 'अच्छा', ta: 'நல்லது', te: 'మంచిది', bn: 'ভালো', kn: 'ಒಳ್ಳೆಯದು', gu: 'સારું' }, pct: '60-79%', examples: { en: 'Kumara + Swapna + Swastha + Garvita + Prakasha', hi: 'कुमार + स्वप्न + स्वस्थ + गर्वित + प्रकाश', sa: 'कुमार + स्वप्न + स्वस्थ + गर्वित + प्रकाश', mai: 'कुमार + स्वप्न + स्वस्थ + गर्वित + प्रकाश', mr: 'कुमार + स्वप्न + स्वस्थ + गर्वित + प्रकाश', ta: 'குமார + ஸ்வப்ன + ஸ்வஸ்த + கர்வித + பிரகாச', te: 'కుమార + స్వప్న + స్వస్థ + గర్విత + ప్రకాశ', bn: 'কুমার + স্বপ্ন + স্বস্থ + গর্বিত + প্রকাশ', kn: 'ಕುಮಾರ + ಸ್ವಪ್ನ + ಸ್ವಸ್ಥ + ಗರ್ವಿತ + ಪ್ರಕಾಶ', gu: 'કુમાર + સ્વપ્ન + સ્વસ્થ + ગર્વિત + પ્રકાશ' }, desc: { en: 'Strong results with some effort required. The planet is well-positioned but not at its absolute peak.', hi: 'कुछ प्रयास से मजबूत फल। ग्रह अच्छी स्थिति में पर पूर्ण चरम पर नहीं।', sa: 'कुछ प्रयास से मजबूत फल। ग्रह अच्छी स्थिति में पर पूर्ण चरम पर नहीं।', mai: 'कुछ प्रयास से मजबूत फल। ग्रह अच्छी स्थिति में पर पूर्ण चरम पर नहीं।', mr: 'कुछ प्रयास से मजबूत फल। ग्रह अच्छी स्थिति में पर पूर्ण चरम पर नहीं।', ta: 'சில முயற்சிகளுடன் வலுவான பலன்கள். கிரகம் நன்கு நிலைபெற்றுள்ளது ஆனால் உச்ச நிலையில் இல்லை.', te: 'కొంత ప్రయత్నంతో బలమైన ఫలితాలు. గ్రహం బాగా ఉంది కానీ శిఖరంలో లేదు.', bn: 'কিছু প্রচেষ্টায় শক্তিশালী ফল। গ্রহটি ভালো অবস্থানে কিন্তু শীর্ষে নয়।', kn: 'ಕೆಲವು ಪ್ರಯತ್ನದಿಂದ ಬಲವಾದ ಫಲಿತಾಂಶ. ಗ್ರಹ ಉತ್ತಮ ಸ್ಥಾನದಲ್ಲಿದೆ ಆದರೆ ಶಿಖರದಲ್ಲಿಲ್ಲ.', gu: 'કેટલાક પ્રયત્નથી મજબૂત પરિણામો. ગ્રહ સારી સ્થિતિમાં છે પણ શિખર પર નથી.' }, color: 'border-blue-500/20' },
            { tier: { en: 'Mixed', hi: 'मिश्रित', sa: 'मिश्रित', mai: 'मिश्रित', mr: 'मिश्रित', ta: 'கலப்பு', te: 'మిశ్రమం', bn: 'মিশ্র', kn: 'ಮಿಶ್ರ', gu: 'મિશ્ર' }, pct: '40-59%', examples: { en: 'Bala/Vriddha + Shanta + Upavesha/Netrapani', hi: 'बाल/वृद्ध + शान्त + उपवेश/नेत्रपाणि', sa: 'बाल/वृद्ध + शान्त + उपवेश/नेत्रपाणि', mai: 'बाल/वृद्ध + शान्त + उपवेश/नेत्रपाणि', mr: 'बाल/वृद्ध + शान्त + उपवेश/नेत्रपाणि', ta: 'பால/விருத்த + சாந்த + உபவேச/நேத்ரபாணி', te: 'బాల/వృద్ధ + శాంత + ఉపవేశ/నేత్రపాణి', bn: 'বাল/বৃদ্ধ + শান্ত + উপবেশ/নেত্রপাণী', kn: 'ಬಾಲ/ವೃದ್ಧ + ಶಾಂತ + ಉಪವೇಶ/ನೇತ್ರಪಾಣಿ', gu: 'બાલ/વૃદ્ધ + શાંત + ઉપવેશ/નેત્રપાણી' }, desc: { en: 'Average results — the planet functions but without distinction. Some areas work, others don\'t.', hi: 'औसत फल — ग्रह कार्य करता है पर बिना विशिष्टता। कुछ क्षेत्र काम करते हैं, कुछ नहीं।' }, color: 'border-amber-500/20' },
            { tier: { en: 'Weak', hi: 'दुर्बल', sa: 'दुर्बल', mai: 'दुर्बल', mr: 'दुर्बल', ta: 'பலவீனம்', te: 'బలహీనం', bn: 'দুর্বল', kn: 'ದುರ್ಬಲ', gu: 'નબળું' }, pct: '20-39%', examples: { en: 'Vikala + Kshudhita/Trushita + Shayana', hi: 'विकल + क्षुधित/तृषित + शयन', sa: 'विकल + क्षुधित/तृषित + शयन', mai: 'विकल + क्षुधित/तृषित + शयन', mr: 'विकल + क्षुधित/तृषित + शयन', ta: 'விகல + க்ஷுதித/த்ருஷித + சயன', te: 'వికల + క్షుధిత/తృషిత + శయన', bn: 'বিকল + ক্ষুধিত/তৃষিত + শয়ন', kn: 'ವಿಕಲ + ಕ್ಷುಧಿತ/ತೃಷಿತ + ಶಯನ', gu: 'વિકલ + ક્ષુધિત/તૃષિત + શયન' }, desc: { en: 'Compromised results — the planet struggles to deliver. Remedies strongly recommended.', hi: 'प्रभावित फल — ग्रह फल देने में संघर्ष। उपचार दृढ़ता से अनुशंसित।', sa: 'प्रभावित फल — ग्रह फल देने में संघर्ष। उपचार दृढ़ता से अनुशंसित।', mai: 'प्रभावित फल — ग्रह फल देने में संघर्ष। उपचार दृढ़ता से अनुशंसित।', mr: 'प्रभावित फल — ग्रह फल देने में संघर्ष। उपचार दृढ़ता से अनुशंसित।', ta: 'பாதிக்கப்பட்ட பலன்கள் — கிரகம் வழங்குவதில் போராடுகிறது. பரிகாரங்கள் மிகவும் பரிந்துரைக்கப்படுகின்றன.', te: 'రాజీపడిన ఫలితాలు — గ్రహం అందించడానికి కష్టపడుతోంది. పరిహారాలు గట్టిగా సిఫార్సు చేయబడతాయి.', bn: 'ক্ষতিগ্রস্ত ফল — গ্রহ প্রদান করতে সংগ্রাম করে। প্রতিকার দৃঢ়ভাবে সুপারিশ করা হয়।', kn: 'ಹಾನಿಗೊಳಗಾದ ಫಲಗಳು — ಗ್ರಹ ನೀಡಲು ಹೆಣಗಾಡುತ್ತದೆ. ಪರಿಹಾರಗಳನ್ನು ಬಲವಾಗಿ ಶಿಫಾರಸು ಮಾಡಲಾಗಿದೆ.', gu: 'નબળા ફળ — ગ્રહ આપવામાં સંઘર્ષ કરે છે. ઉપાયોની ખૂબ ભલામણ કરવામાં આવે છે.' }, color: 'border-red-500/20' },
            { tier: { en: 'Denied', hi: 'निषेध', sa: 'निषेध', mai: 'निषेध', mr: 'निषेध', ta: 'மறுக்கப்பட்டது', te: 'నిరాకరించబడింది', bn: 'প্রত্যাখ্যাত', kn: 'ನಿರಾಕರಿಸಲಾಗಿದೆ', gu: 'નકારવામાં' }, pct: '0-19%', examples: { en: 'Mrita + Sushupti + Khala + Kshobhita', hi: 'मृत + सुषुप्ति + खल + क्षोभित', sa: 'मृत + सुषुप्ति + खल + क्षोभित', mai: 'मृत + सुषुप्ति + खल + क्षोभित', mr: 'मृत + सुषुप्ति + खल + क्षोभित', ta: 'மிருத + சுஷுப்தி + கல + க்ஷோபித', te: 'మృత + సుషుప్తి + ఖల + క్షోభిత', bn: 'মৃত + সুষুপ্তি + খল + ক্ষোভিত', kn: 'ಮೃತ + ಸುಷುಪ್ತಿ + ಖಲ + ಕ್ಷೋಭಿತ', gu: 'મૃત + સુષુપ્તિ + ખલ + ક્ષોભિત' }, desc: { en: 'Severely blocked — the planet\'s significations are suppressed or reversed. Intense remedies and patience required.', hi: 'गम्भीर रूप से अवरुद्ध — ग्रह के कारकत्व दबे या विपरीत। तीव्र उपचार और धैर्य आवश्यक।' }, color: 'border-red-500/30' },
          ].map((tier, i) => (
