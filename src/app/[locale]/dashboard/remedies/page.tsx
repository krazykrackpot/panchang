...
const LABELS = {
  ...
  ta: {
    title: 'உங்கள் தனிப்பயனாக்கப்பட்ட பரிகாரங்கள்',
    subtitle: 'உங்கள் ஜாதகத்திற்கு ஏற்ற வேத பரிகாரங்கள்',
    loading: 'உங்கள் பரிகாரங்கள் கணக்கிடப்படுகின்றன...',
    notSignedIn: 'உங்கள் தனிப்பயனாக்கப்பட்ட பரிகாரங்களைக் காண உள்நுழையவும்',
    signIn: 'உள்நுழை',
    noBirthData: 'தனிப்பயனாக்கப்பட்ட பரிகாரங்களுக்கு உங்கள் பிறப்பு விவரங்களை அமைக்கவும்',
    ...
    donation: 'தானம்',
    bestDay: 'சிறந்த நாள்',
    noRemedies: 'இப்போது குறிப்பிட்ட பரிகாரங்கள் தேவையில்லை. உங்கள் ஜாதகம் சமநிலையில் உள்ளது.',
  },
  te: {
    title: 'మీ వ్యక్తిగత పరిహారాలు',
    subtitle: 'మీ జన్మ చార్ట్‌కు అనుగుణమైన వేద పరిహారాలు',
    loading: 'మీ పరిహారాలు గణించబడుతున్నాయి...',
    notSignedIn: 'మీ వ్యక్తిగత పరిహారాలను చూడటానికి సైన్ ఇన్ చేయండి',
    signIn: 'సైన్ ఇన్',
    noBirthData: 'వ్యక్తిగత పరిహారాల కోసం మీ జన్మ వివరాలను సెట్ చేయండి',
    ...
    donation: 'దానం',
    bestDay: 'శుభ దినం',
    noRemedies: 'ప్రస్తుతం ప్రత్యేక పరిహారాలు అవసరం లేదు. మీ చార్ట్ సమతుల్యంగా ఉంది.',
  },
  bn: {
    title: 'আপনার ব্যক্তিগত প্রতিকার',
    subtitle: 'আপনার জন্ম কুণ্ডলী অনুসারে বৈদিক প্রতিকার',
    loading: 'আপনার প্রতিকার গণনা হচ্ছে...',
    notSignedIn: 'আপনার ব্যক্তিগত প্রতিকার দেখতে সাইন ইন করুন',
    signIn: 'সাইন ইন',
    noBirthData: 'ব্যক্তিগত প্রতিকারের জন্য আপনার জন্ম বিবরণ সেট করুন',
    setupProfile: 'প্রোফাইল সেট করুন',
    back: 'ড্যাশবোর্ড',
    highPriority: 'উচ্চ অগ্রাধিকার',
    mediumPriority: 'মধ্যম অগ্রাধিকার',
    lowPriority: 'নিম্ন অগ্রাধিকার',
    mantra: 'মন্ত্র',
    gemstone: 'রত্ন',
    donation: 'দান',
    bestDay: 'শুভ দিন',
    noRemedies: 'এই মুহূর্তে বিশেষ প্রতিকারের প্রয়োজন নেই। আপনার কুণ্ডলী সুষম।',
  },
  kn: {
    title: 'ನಿಮ್ಮ ವೈಯಕ್ತಿಕ ಪರಿಹಾರಗಳು',
    subtitle: 'ನಿಮ್ಮ ಜನ್ಮ ಜಾತಕಕ್ಕೆ ಅನುಗುಣವಾದ ವೈದಿಕ ಪರಿಹಾರಗಳು',
    loading: 'ನಿಮ್ಮ ಪರಿಹಾರಗಳನ್ನು ಲೆಕ್ಕ ಹಾಕಲಾಗುತ್ತಿದೆ...',
    notSignedIn: 'ನಿಮ್ಮ ವೈಯಕ್ತಿಕ ಪರಿಹಾರಗಳನ್ನು ನೋಡಲು ಸೈನ್ ಇನ್ ಮಾಡಿ',
    signIn: 'ಸೈನ್ ಇನ್',
    noBirthData: 'ವೈಯಕ್ತಿಕ ಪರಿಹಾರಗಳಿಗಾಗಿ ನಿಮ್ಮ ಜನ್ಮ ವಿವರಗಳನ್ನು ಹೊಂದಿಸಿ',
    ...
    donation: 'ದಾನ',
    bestDay: 'ಶುಭ ದಿನ',
    noRemedies: 'ಪ್ರಸ್ತುತ ವಿಶೇಷ ಪರಿಹಾರಗಳ ಅಗತ್ಯವಿಲ್ಲ. ನಿಮ್ಮ ಜಾತಕ ಸಮತೋಲಿತವಾಗಿದೆ.',
  },
  mr: {
    title: 'आपले वैयक्तिक उपाय',
    subtitle: 'आपल्या जन्म कुंडलीनुसार वैदिक उपाय',
    loading: 'आपले उपाय गणना होत आहे...',
    notSignedIn: 'आपले वैयक्तिक उपाय पाहण्यासाठी साइन इन करा',
    signIn: 'साइन इन',
    noBirthData: 'वैयक्तिक उपायांसाठी आपले जन्म तपशील सेट करा',
    ...
    donation: 'दान',
    bestDay: 'शुभ दिवस',
    noRemedies: 'सध्या विशेष उपायांची गरज नाही. आपली कुंडली संतुलित आहे.',
  },
  gu: {
    title: 'તમારા વ્યક્તિગત ઉપાયો',
    subtitle: 'તમારી જન્મ કુંડળી અનુસાર વૈદિક ઉપાયો',
    loading: 'તમારા ઉપાયોની ગણતરી થઈ રહી છે...',
    notSignedIn: 'તમારા વ્યક્તિગત ઉપાયો જોવા સાઇન ઇન કરો',
    signIn: 'સાઇન ઇન',
    noBirthData: 'વ્યક્તિગત ઉપાયો માટે તમારી જન્મ વિગતો સેટ કરો',
    ...
    donation: 'દાન',
    bestDay: 'શુભ દિવસ',
    noRemedies: 'હાલમાં વિશેષ ઉપાયોની જરૂર નથી. તમારી કુંડળી સંતુલિત છે.',
  },
  mai: {
    title: 'अहाँक व्यक्तिगत उपाय',
    subtitle: 'अहाँक जन्म कुंडलीक अनुसार वैदिक उपाय',
    loading: 'अहाँक उपाय गणना भऽ रहल अछि...',
    notSignedIn: 'अपन व्यक्तिगत उपाय देखबाक लेल साइन इन करू',
    signIn: 'साइन इन',
    noBirthData: 'व्यक्तिगत उपायक लेल अपन जन्म विवरण सेट करू',
    ...
    donation: 'दान',
    bestDay: 'शुभ दिन',
    noRemedies: 'एहि समय विशेष उपायक आवश्यकता नहि अछि। अहाँक कुंडली संतुलित अछि।',
  },
};
