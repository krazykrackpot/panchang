  ...
  return (
    <div className="space-y-6">
      ...
      <section className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-xl p-5 border border-blue-500/15">
        ...
        <p className="text-text-secondary text-xs leading-relaxed">
          The Surya Siddhanta, Meeus (which we ship as our documented fallback), and Swiss Ephemeris (our primary engine, based on NASA JPL DE ephemerides) are all links in the same intellectual chain. The fundamental approach  –  compute mean position, apply periodic corrections, convert to geocentric coordinates  –  runs through every generation. What changed is the number and precision of correction terms. The Surya Siddhanta uses one epicycle per planet. Meeus uses dozens of Fourier terms. Swiss Ephemeris fits sub-arcsecond polynomials to numerically integrated ephemerides. But the architecture is recognisably the same. When you check today&rsquo;s Panchang in our app, you are using a computational tradition that is at least 1,500 years old.
        </p>
      </section>
