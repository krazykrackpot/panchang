  ...
  return [
    {
      ...
      cards: [
        ...
        { href: '/tarabalam', title: loc('Tarabalam', 'ताराबल', 'தாரபலம்', 'তারাবল'), subtitle: loc('Star Strength', 'तारा बल', 'நட்சத்திர வலிமை', 'তারা বল'), description: loc('27-nakshatra tara cycle', '27 नक्षत्र तारा चक्र', '27 நட்சத்திர தாரா சுழற்சி', '২৭ নক্ষত্র তারা চக্র'), glowColor: '#a855f7', svg: <TarabalamSVG /> },
    ...
    },
    {
      ...
      cards: [
        ...
        { href: '/varshaphal', title: loc('Varshaphal', 'वर्षफल', 'வருடப் பலன்', 'বর্ষফল'), subtitle: loc('Annual Solar Return', 'वार्षिक सौर वापसी', 'வருடாந்திர சூரியன் திரும்பல்', 'বার্ষিক সৌর প্রত্যাবর্তন'), description: loc('Tajika system year ahead', 'ताजिक प्रणाली वर्ष पूर्वानुमान', 'தஜிக முறை வருடம் முன்னறிவு', 'তাজিক বছরের পূর্বাভাস'), glowColor: '#fbbf24', svg: <SadeSatiSVG /> },
