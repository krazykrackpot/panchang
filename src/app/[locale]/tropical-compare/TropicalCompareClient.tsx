...
export default function TropicalCompareClient() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
      {/* Page header (h1 + subtitle + description) is server-rendered in
          page.tsx so Bingbot sees it — moving it client-side trapped it
          behind the useSearchParams Suspense boundary. See page.tsx
