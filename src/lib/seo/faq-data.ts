...
export const FAQ_DATA: Record<string, FAQEntry[]> = {
  ...
  '/muhurta-ai': [
    ...
    },
    {
      ...
      answer: {
        en: 'Our Muhurta engine applies 33 discrete rules from 7 classical texts (Muhurta Chintamani, Dharma Sindhu, BPHS, Brihat Samhita, Prashna Marga, B.V. Raman, Kalaprakashika) organised into a 5-tier authority hierarchy. Tier 1 rules (absolute vetoes like Venus combustion or Chaturmas) reject windows outright. Tier 2 rules (overrides) can elevate a window — for example, Godhuli Lagna (sunset ±24 min) overrides all defects for marriage per Brihat Samhita Ch.103, and benefics in the ascendant cancel all flaws per MC Ch.7. Tiers 3-5 handle standard scoring and cancellation: a strong lagna genuinely removes weak karana defects rather than merely offsetting them numerically. When you provide birth data, the engine adds personalised dimensions — Tara Bala, Chandra Bala, and Dasha Harmony — and presents pandit-style reasoning with chapter-level citations for each scored window.',
        hi: 'हमारा मुहूर्त इंजन 7 शास्त्रीय ग्रन्थों (मुहूर्त चिन्तामणि, धर्मसिन्धु, BPHS, बृहत् संहिता, प्रश्न मार्ग, बी.वी. रमन, कालप्रकाशिका) से 33 विशिष्ट नियम लागू करता है जो 5-स्तरीय प्राधिकार क्रम में संगठित हैं। स्तर 1 (पूर्ण निषेध — शुक्र अस्त, चातुर्मास) खिड़कियों को सीधे अस्वीकार करता है। स्तर 2 (अधिभावी) खिड़की को उन्नत कर सकता है — गोधूलि लग्न (सूर्यास्त ±24 मिनट) बृहत् संहिता अध्याय 103 अनुसार विवाह में सभी दोष दूर करता है। स्तर 3-5 सामान्य स्कोरिंग और निवारण संभालते हैं: बलवान लग्न दुर्बल करण दोष का वास्तविक निवारण करता है। जन्म डेटा देने पर तारा बल, चन्द्र बल और दशा सामंजस्य जुड़ते हैं।',
        sa: 'अस्माकं मुहूर्तयन्त्रं सप्तशास्त्रग्रन्थेभ्यः त्रयस्त्रिंशत्नियमान् पञ्चस्तरीयप्राधिकारक्रमे अनुप्रयुनक्ति। बलवल्लग्नं सर्वदोषान् निवारयति — केवलं सङ्ख्यात्मकसमायोजनं नास्ति।',
      },
    },
    {
      question: {
