      ...
      {loading ? (
        ...
        <>
                  ...
                  <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.08 }}
                    ...
                    <div className="flex items-start justify-between mb-3">
                      <div className="text-indigo-400 text-xs uppercase tracking-widest font-bold">
                        {_tl({ en: 'Shiva Vaas', hi: 'शिव वास', sa: 'शिववासः', ta: 'சிவ வாசம்', te: 'శివ వాసము', bn: 'শিব বাস', kn: 'ಶಿವ ವಾಸ', gu: 'શિવ વાસ', mai: 'शिव वास', mr: 'शिव वास' } as LocaleText, locale)}
                      </div>
                    ...
                    {tithiList.length > 0 && (
                      <div className="text-text-tertiary text-xs mb-2">{_tl({ en: 'Tithis', hi: 'तिथियाँ', sa: 'तिथयः', ta: 'திதிகள்', te: 'తిథులు', bn: 'তিথিসমূহ', kn: 'ತಿಥಿಗಳು', gu: 'તિથિઓ', mai: 'तिथियाँ', mr: 'तिथी' }, locale)}: {tithiList.join(', ')}</div>
                    )}
              ...
              {panchang.agniVaas && (() => {
                ...
                return (
                  <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.12 }}
                    ...
                    <div className="flex items-start justify-between mb-3">
                      <div className="text-red-400 text-xs uppercase tracking-widest font-bold">
                        {_tl({ en: 'Agni Vaas', hi: 'अग्नि वास', sa: 'अग्निवासः', ta: 'அக்னி வாசம்', te: 'అగ్ని వాసము', bn: 'অগ্নি বাস', kn: 'ಅಗ್ನಿ ವಾಸ', gu: 'અગ્નિ વાસ', mai: 'अग्नि वास', mr: 'अग्नि वास' } as LocaleText, locale)}
                      </div>
                      <span className={`text-xs font-medium px-2 py-0.5 rounded-full ${d.nColor} bg-black/20 border ${d.border}`}>{_tl({en: natureLabel, hi: natureLabelHi} as LocaleText, locale)}</span>
                    </div>
                    ...
                    <div className="text-text-secondary text-xs leading-relaxed mb-3">{_tl(d.desc, locale)}</div>
                    <div className={`p-2.5 rounded-lg bg-black/20 border ${d.border}`}>
                      <div className="text-text-tertiary text-xs uppercase tracking-wider mb-0.5">{_tl({ en: 'Fire Ritual Impact', hi: 'अग्नि कर्म प्रभाव', sa: 'अग्निकर्मप्रभावः', ta: 'அக்னி கர்ம தாக்கம்', te: 'అగ్ని కర్మ ప్రభావము', bn: 'অগ্নি কর্মের প্রভাব', kn: 'ಅಗ್ನಿ ಕರ್ಮದ ಪ್ರಭಾವ', gu: 'અગ્નિ કર્મ પ્રભાવ', mai: 'अग्नि कर्मक प्रभाव', mr: 'अग्नी कर्माचा प्रभाव' }, locale)}</div>
          ...
          <InfoBlock
            ...
            defaultOpen={false}
          >
            {_tl({ en: 'Choghadiya divides the day (sunrise to sunset) and night (sunset to sunrise) into 8 slots each. Each slot is ruled by a planet and classified as Auspicious (Amrit, Shubh, Labh, Char — good for starting new work), or Inauspicious (Rog, Kaal, Udveg — avoid new ventures). Use this to quickly check if NOW is a good time to start something important.', hi: 'चोघड़िया दिन (सूर्योदय से सूर्यास्त) और रात (सूर्यास्त से सूर्योदय) को 8-8 भागों में बाँटता है। प्रत्येक भाग एक ग्रह द्वारा शासित होता है — शुभ (अमृत, शुभ, लाभ, चर — नए कार्य के लिए उत्तम) या अशुभ (रोग, काल, उद्वेग — नए कार्य टालें)। अभी का समय शुभ है या नहीं, यह शीघ्र जाँचने के लिए उपयोगी है।', sa: 'चोघडिया दिवसम् (सूर्योदयात् सूर्यास्तपर्यन्तम्) रात्रिञ्च (सूर्यास्तात् सूर्योदयपर्यन्तम्) अष्टधा विभजति। प्रत्येकं खण्डं केनचित् ग्रहेण शासितम् — शुभम् (अमृत, शुभ, लाभ, चर — नूतनकार्यारम्भे श्रेष्ठम्) वा अशुभम् (रोग, काल, उद्वेग — नूतनकार्यं वर्जयेत्)। अधुना शुभः कालः अस्ति वा न इति शीघ्रं ज्ञातुम् एतत् उपयुज्यते।', ta: 'சோகடியா நாளை (சூரிய உதயம் முதல் சூரிய அஸ்தமனம் வரை) மற்றும் இரவை (சூரிய அஸ்தமனம் முதல் சூரிய உதயம் வரை) தலா 8 பகுதிகளாக பிரிக்கிறது. ஒவ்வொரு பகுதியும் ஒரு கிரகத்தால் ஆளப்படுகிறது — சுபம் (அமிர்த, சுப, லாப, சர — புதிய பணிகளுக்கு நல்லது) அல்லது அசுபம் (ரோக, கால, உத்வேக — புதிய முயற்சிகளை தவிர்க்கவும்). இப்போது நல்ல நேரமா என்பதை விரைவாக சரிபார்க்க இதை பயன்படுத்துங்கள்.', te: 'చోఘడియా పగలు (సూర్యోదయం నుండి సూర్యాస్తమయం వరకు) మరియు రాత్రి (సూర్యాస్తమయం నుండి సూర్యోదయం వరకు) ను చెరో 8 భాగాలుగా విభజిస్తుంది. ప్రతి భాగం ఒక గ్రహం చేత పాలించబడుతుంది — శుభం (అమృత, శుభ, లాభ, చర — కొత్త పని ప్రారంభించడానికి మంచిది) లేదా అశుభం (రోగ, కాల, ఉద్వేగ — కొత్త పనులు మానుకోండి). ఇప్పుడు మంచి సమయమా అని త్వరగా తనిఖీ చేయడానికి దీన్ని ఉపయోగించండి.', bn: 'চোঘাড়িয়া দিন (সূর্যোদয় থেকে সূর্যাস্ত) এবং রাত (সূর্যাস্ত থেকে সূর্যোদয়) কে প্রতিটি ৮টি ভাগে বিভক্ত করে। প্রতিটি ভাগ একটি গ্রহ দ্বারা শাসিত — শুভ (অমৃত, শুভ, লাভ, চর — নতুন কাজ শুরুর জন্য ভালো) বা অশুভ (রোগ, কাল, উদ্বেগ — নতুন উদ্যোগ এড়িয়ে চলুন)। এখন কি ভালো সময় তা দ্রুত যাচাই করতে এটি ব্যবহার করুন।', kn: 'ಚೋಘಡಿಯಾ ಹಗಲನ್ನು (ಸೂರ್ಯೋದಯದಿಂದ ಸೂರ್ಯಾಸ್ತದವರೆಗೆ) ಮತ್ತು ರಾತ್ರಿಯನ್ನು (ಸೂರ್ಯಾಸ್ತದಿಂದ ಸೂರ್ಯೋದಯದವರೆಗೆ) ತಲಾ 8 ಭಾಗಗಳಾಗಿ ವಿಭಜಿಸುತ್ತದೆ. ಪ್ರತಿ ಭಾಗವು ಒಂದು ಗ್ರಹದಿಂದ ಆಳಲ್ಪಡುತ್ತದೆ — ಶುಭ (ಅಮೃತ, ಶುಭ, ಲಾಭ, ಚರ — ಹೊಸ ಕೆಲಸ ಆರಂಭಿಸಲು ಉತ್ತಮ) ಅಥವಾ ಅಶುಭ (ರೋಗ, ಕಾಲ, ಉದ್ವೇಗ — ಹೊಸ ಉದ್ಯಮಗಳನ್ನು ತಪ್ಪಿಸಿ). ಈಗ ಒಳ್ಳೆಯ ಸಮಯವೇ ಎಂದು ತ್ವರಿತವಾಗಿ ಪರಿಶೀಲಿಸಲು ಇದನ್ನು ಬಳಸಿ.', gu: 'ચોઘડિયા દિવસ (સૂર્યોદયથી સૂર્યાસ્ત) અને રાત (સૂર્યાસ્તથી સૂર્યોદય) ને દરેકે 8 ભાગોમાં વહેંચે છે. દરેક ભાગ એક ગ્રહ દ્વારા શાસિત છે — શુભ (અમૃત, શુભ, લાભ, ચર — નવું કામ શરૂ કરવા માટે ઉત્તમ) અથવા અશુભ (રોગ, કાળ, ઉદ્વેગ — નવા ઉપક્રમ ટાળો). અત્યારે સારો સમય છે કે નહીં તે ઝડપથી તપાસવા માટે આ ઉપયોગી છે.', mai: 'चोघड़िया दिन (सूर्योदयसँ सूर्यास्त) आ रात (सूर्यास्तसँ सूर्योदय) केँ 8-8 भागमे बाँटैत अछि। प्रत्येक भाग एकटा ग्रह द्वारा शासित होइत अछि — शुभ (अमृत, शुभ, लाभ, चर — नव काजक लेल उत्तम) वा अशुभ (रोग, काल, उद्वेग — नव काज टारू)। एखन समय शुभ अछि कि नहि, से जल्दी जाँचबाक लेल उपयोगी अछि।', mr: 'चोघडिया दिवस (सूर्योदय ते सूर्यास्त) आणि रात्र (सूर्यास्त ते सूर्योदय) यांना प्रत्येकी 8 भागांमध्ये विभागतो. प्रत्येक भाग एका ग्रहाने शासित असतो — शुभ (अमृत, शुभ, लाभ, चर — नवीन कामासाठी उत्तम) किंवा अशुभ (रोग, काल, उद्वेग — नवीन उपक्रम टाळा). आत्ता चांगली वेळ आहे का हे तपासण्यासाठी हे उपयुक्त आहे.' }, locale)}
          </InfoBlock>
          ...
          <InfoBlock
            ...
            defaultOpen={false}
          >
            {_tl({ en: 'Each hour of the day is ruled by a planet. Match your activity to the ruling planet for best results: Sun hora → authority, government work. Moon hora → travel, public dealings. Mars hora → courage, property. Mercury hora → business, communication. Jupiter hora → education, spirituality. Venus hora → arts, romance, luxury. Saturn hora → labor, construction, discipline.', hi: 'दिन का प्रत्येक घंटा एक ग्रह द्वारा शासित होता है। अपने कार्य को शासक ग्रह से मिलाएँ: सूर्य होरा → सरकारी कार्य, अधिकार। चंद्र होरा → यात्रा, जन-व्यवहार। मंगल होरा → साहस, संपत्ति। बुध होरा → व्यापार, संचार। बृहस्पति होरा → शिक्षा, अध्यात्म। शुक्र होरा → कला, प्रेम, विलास। शनि होरा → श्रम, निर्माण, अनुशासन।', sa: 'दिवसस्य प्रत्येकं होरा केनचित् ग्रहेण शासिता अस्ति। स्वकीयं कर्म शासकग्रहेण सह मेलयत् — सूर्यहोरा → अधिकारः, राजकीयकार्यम्। चन्द्रहोरा → यात्रा, जनव्यवहारः। मङ्गलहोरा → शौर्यम्, सम्पत्तिः। बुधहोरा → वाणिज्यम्, संचारः। बृहस्पतिहोरा → शिक्षा, अध्यात्मम्। शुक्रहोरा → कला, प्रणयः, विलासः। शनिहोरा → श्रमः, निर्माणम्, अनुशासनम्।', ta: 'நாளின் ஒவ்வொரு மணி நேரமும் ஒரு கிரகத்தால் ஆளப்படுகிறது. சிறந்த முடிவுகளுக்கு உங்கள் செயலை ஆளும் கிரகத்துடன் பொருத்துங்கள்: சூரிய ஹோரா → அதிகாரம், அரசு வேலை. சந்திர ஹோரா → பயணம், பொது விவகாரங்கள். செவ்வாய் ஹோரா → தைரியம், சொத்து. புதன் ஹோரா → வணிகம், தகவல் தொடர்பு. குரு ஹோரா → கல்வி, ஆன்மீகம். சுக்ர ஹோரா → கலை, காதல், ஆடம்பரம். சனி ஹோரா → உழைப்பு, கட்டுமானம், ஒழுக்கம்.', te: 'రోజులోని ప్రతి గంటను ఒక గ్రహం పాలిస్తుంది. ఉత్తమ ఫలితాలకు మీ కార్యకలాపాన్ని పాలక గ్రహంతో సరిపోల్చండి: సూర్య హోరా → అధికారం, ప్రభుత్వ పని. చంద్ర హోరా → ప్రయాణం, సార్వజనిక వ్యవహారాలు. కుజ హోరా → సాహసం, ఆస్తి. బుధ హోరా → వ్యాపారం, సంభాషణ. గురు హోరా → విద్య, ఆధ్యాత్మికత. శుక్ర హోరా → కళలు, ప్రేమ, విలాసం. శని హోరా → శ్రమ, నిర్మాణం, క్రమశిక్షణ.', bn: 'দিনের প্রতিটি ঘণ্টা একটি গ্রহ দ্বারা শাসিত। সেরা ফলাফলের জন্য আপনার কার্যকলাপ শাসক গ্রহের সাথে মেলান: সূর্য হোরা → কর্তৃত্ব, সরকারি কাজ। চন্দ্র হোরা → ভ্রমণ, জনসাধারণের কাজ। মঙ্গল হোরা → সাহস, সম্পত্তি। বুধ হোরা → ব্যবসা, যোগাযোগ। বৃহস্পতি হোরা → শিক্ষা, আধ্যাত্মিকতা। শুক্র হোরা → শিল্প, প্রেম, বিলাসিতা। শনি হোরা → শ্রম, নির্মাণ, শৃঙ্খলা।', kn: 'ದಿನದ ಪ್ರತಿ ಗಂಟೆಯನ್ನು ಒಂದು ಗ್ರಹ ಆಳುತ್ತದೆ. ಉತ್ತಮ ಫಲಿತಾಂಶಕ್ಕಾಗಿ ನಿಮ್ಮ ಚಟುವಟಿಕೆಯನ್ನು ಆಳುವ ಗ್ರಹಕ್ಕೆ ಹೊಂದಿಸಿ: ಸೂರ್ಯ ಹೋರಾ → ಅಧಿಕಾರ, ಸರ್ಕಾರಿ ಕೆಲಸ. ಚಂದ್ರ ಹೋರಾ → ಪ್ರಯಾಣ, ಸಾರ್ವಜನಿಕ ವ್ಯವಹಾರ. ಮಂಗಳ ಹೋರಾ → ಧೈರ್ಯ, ಆಸ್ತಿ. ಬುಧ ಹೋರಾ → ವ್ಯಾಪಾರ, ಸಂವಹನ. ಗುರು ಹೋರಾ → ಶಿಕ್ಷಣ, ಅಧ್ಯಾತ್ಮ. ಶುಕ್ರ ಹೋರಾ → ಕಲೆ, ಪ್ರೇಮ, ಐಷಾರಾಮ. ಶನಿ ಹೋರಾ → ಶ್ರಮ, ನಿರ್ಮಾಣ, ಶಿಸ್ತು.', gu: 'દિવસના દરેક કલાક એક ગ્રહ દ્વારા શાસિત છે. શ્રેષ્ઠ પરિણામ માટે તમારી પ્રવૃત્તિ શાસક ગ્રહ સાથે મેળવો: સૂર્ય હોરા → અધિકાર, સરકારી કામ. ચંદ્ર હોરા → પ્રવાસ, જાહેર વ્યવહાર. મંગળ હોરા → સાહસ, મિલકત. બુધ હોરા → વ્યવસાય, સંચાર. ગુરુ હોરા → શિક્ષણ, આધ્યાત્મ. શુક્ર હોરા → કળા, પ્રેમ, વૈભવ. શનિ હોરા → શ્રમ, બાંધકામ, શિસ્ત.', mai: 'दिनक प्रत्येक घंटा एकटा ग्रह द्वारा शासित होइत अछि। अपन काज केँ शासक ग्रहसँ मिलाउ — सूर्य होरा → अधिकार, सरकारी काज। चंद्र होरा → यात्रा, जन-व्यवहार। मंगल होरा → साहस, संपत्ति। बुध होरा → व्यापार, संचार। बृहस्पति होरा → शिक्षा, अध्यात्म। शुक्र होरा → कला, प्रेम, विलास। शनि होरा → श्रम, निर्माण, अनुशासन।', mr: 'दिवसाचा प्रत्येक तास एका ग्रहाने शासित असतो. सर्वोत्तम परिणामासाठी तुमची कृती शासक ग्रहाशी जुळवा: सूर्य होरा → अधिकार, सरकारी काम. चंद्र होरा → प्रवास, सार्वजनिक व्यवहार. मंगळ होरा → धाडस, मालमत्ता. बुध होरा → व्यापार, संवाद. गुरू होरा → शिक्षण, अध्यात्म. शुक्र होरा → कला, प्रेम, विलास. शनि होरा → श्रम, बांधकाम, शिस्त.' }, locale)}
          </InfoBlock>
          {panchang.hora && panchang.hora.length > 0 && (
            <div className="my-14">
              <h2 className="text-3xl font-bold text-gold-gradient mb-2 text-center" style={headingFont}>
          ...
          <InfoBlock
            ...
            defaultOpen={false}
          >
            {_tl({ en: 'The day is divided into 30 muhurtas (each ~48 minutes), running from sunrise to next sunrise. Each muhurta has a traditional name and is classified as good (green), bad (red), or mixed (amber). The most universally auspicious is Abhijit Muhurta — the midday period around solar noon. Use this timeline to find the best window for important activities today.', hi: 'दिन को 30 मुहूर्तों में बाँटा जाता है (प्रत्येक ~48 मिनट), जो सूर्योदय से अगले सूर्योदय तक चलते हैं। प्रत्येक मुहूर्त का एक पारंपरिक नाम है और इसे शुभ (हरा), अशुभ (लाल) या मिश्रित (पीला) वर्गीकृत किया जाता है। सर्वाधिक शुभ है अभिजित् मुहूर्त — दोपहर के आसपास का सूर्यमध्य काल। आज के महत्वपूर्ण कार्यों के लिए सर्वोत्तम समय खोजने हेतु इस समयरेखा का उपयोग करें।', sa: 'दिवसः त्रिंशत् मुहूर्तेषु विभक्तः अस्ति (प्रत्येकं ~48 निमेषाः), सूर्योदयात् आरभ्य अग्रिमसूर्योदयपर्यन्तं प्रचलति। प्रत्येकस्य मुहूर्तस्य परम्परागतं नाम अस्ति, शुभः (हरितः), अशुभः (रक्तः) वा मिश्रितः (पीतः) इति वर्गीकृतः। सर्वाधिकं शुभः अभिजित्मुहूर्तः — मध्याह्नसूर्यस्य समीपे मध्यकालः। अद्य महत्त्वपूर्णकार्यार्थं श्रेष्ठं काले विन्दुं ज्ञातुम् एतां कालरेखाम् उपयुञ्जीत।', ta: 'நாள் 30 முகூர்த்தங்களாக (ஒவ்வொன்றும் ~48 நிமிடங்கள்) பிரிக்கப்படுகிறது, சூரிய உதயம் முதல் அடுத்த சூரிய உதயம் வரை. ஒவ்வொரு முகூர்த்தத்திற்கும் ஒரு பாரம்பரிய பெயர் உள்ளது மற்றும் நல்லது (பச்சை), கெட்டது (சிவப்பு) அல்லது கலப்பு (அம்பர்) என வகைப்படுத்தப்படுகிறது. மிகவும் சுபமானது அபிஜித் முகூர்த்தம் — சூரிய மத்தியானத்தைச் சுற்றிய நடுப்பகல் நேரம். இன்று முக்கியமான செயல்களுக்கு சிறந்த நேரத்தை கண்டறிய இந்த காலரேகையை பயன்படுத்துங்கள்.', te: 'రోజు 30 ముహూర్తాలుగా (~48 నిమిషాలు చొప్పున) విభజించబడింది, సూర్యోదయం నుండి తదుపరి సూర్యోదయం వరకు నడుస్తుంది. ప్రతి ముహూర్తానికి సంప్రదాయ పేరు ఉంది మరియు శుభం (ఆకుపచ్చ), అశుభం (ఎరుపు) లేదా మిశ్రమం (అంబర్) గా వర్గీకరించబడింది. అత్యంత శుభకరమైనది అభిజిత్ ముహూర్తం — సౌర మధ్యాహ్నం చుట్టూ ఉన్న మధ్యాహ్న కాలం. ఈ రోజు ముఖ్యమైన కార్యకలాపాలకు ఉత్తమ సమయాన్ని కనుగొనడానికి ఈ కాలరేఖను ఉపయోగించండి.', bn: 'দিনটি ৩০টি মুহূর্তে বিভক্ত (প্রতিটি ~৪৮ মিনিট), সূর্যোদয় থেকে পরবর্তী সূর্যোদয় পর্যন্ত চলে। প্রতিটি মুহূর্তের একটি ঐতিহ্যবাহী নাম আছে এবং এটিকে শুভ (সবুজ), অশুভ (লাল) বা মিশ্র (অ্যাম্বার) হিসেবে শ্রেণীবদ্ধ করা হয়। সর্বাধিক শুভ হল অভিজিৎ মুহূর্ত — সৌর মধ্যাহ্নের আশেপাশে মধ্যদিনের সময়। আজ গুরুত্বপূর্ণ কাজের জন্য সেরা সময় খুঁজে পেতে এই সময়রেখা ব্যবহার করুন।', kn: 'ದಿನವನ್ನು 30 ಮುಹೂರ್ತಗಳಾಗಿ (~48 ನಿಮಿಷಗಳು ತಲಾ) ವಿಭಜಿಸಲಾಗಿದೆ, ಸೂರ್ಯೋದಯದಿಂದ ಮುಂದಿನ ಸೂರ್ಯೋದಯದವರೆಗೆ ನಡೆಯುತ್ತದೆ. ಪ್ರತಿ ಮುಹೂರ್ತಕ್ಕೆ ಸಾಂಪ್ರದಾಯಿಕ ಹೆಸರಿದೆ ಮತ್ತು ಶುಭ (ಹಸಿರು), ಅಶುಭ (ಕೆಂಪು) ಅಥವಾ ಮಿಶ್ರಿತ (ಅಂಬರ್) ಎಂದು ವರ್ಗೀಕರಿಸಲಾಗಿದೆ. ಅತ್ಯಂತ ಶುಭಕರವಾದದ್ದು ಅಭಿಜಿತ್ ಮುಹೂರ್ತ — ಸೌರ ಮಧ್ಯಾಹ್ನದ ಸುತ್ತಲಿನ ಮಧ್ಯಾಹ್ನ ಕಾಲ. ಇಂದು ಮಹತ್ವದ ಚಟುವಟಿಕೆಗಳಿಗೆ ಉತ್ತಮ ಸಮಯ ಕಂಡುಹಿಡಿಯಲು ಈ ಕಾಲರೇಖೆ ಬಳಸಿ.', gu: 'દિવસ 30 મુહૂર્તોમાં (~48 મિનિટ પ્રત્યેક) વહેંચાયેલ છે, સૂર્યોદયથી આગળના સૂર્યોદય સુધી ચાલે છે. દરેક મુહૂર્તનું એક પારંપારિક નામ છે અને તેને શુભ (લીલો), અશુભ (લાલ) અથવા મિશ્ર (એમ્બર) તરીકે વર્ગીકૃત કરવામાં આવ્યું છે. સૌથી વ્યાપક શુભ અભિજિત મુહૂર્ત છે — સૌર મધ્યાહ્ન આસપાસ નો મધ્ય દિવસ કાળ. આજે મહત્ત્વની પ્રવૃત્તિઓ માટે શ્રેષ્ઠ સમય શોધવા આ કાલ-રેખા ઉપયોગ કરો.', mai: 'दिनकेँ 30 मुहूर्तमे बाँटल जाइत अछि (प्रत्येक ~48 मिनट), जे सूर्योदयसँ अगिला सूर्योदय धरि चलैत अछि। प्रत्येक मुहूर्तक एकटा पारंपरिक नाम अछि आ एकरा शुभ (हरियर), अशुभ (लाल) वा मिश्रित (पीयर) रूपमे वर्गीकृत कयल जाइत अछि। सर्वाधिक शुभ अभिजित् मुहूर्त अछि — दोपहरक सूर्यमध्यक समीपक समय। आइक महत्वपूर्ण काजक लेल उत्तम समय खोजबाक हेतु एहि समयरेखाक उपयोग करू।', mr: 'दिवस 30 मुहूर्तांमध्ये विभागला जातो (प्रत्येक ~48 मिनिटे), सूर्योदयापासून पुढील सूर्योदयापर्यंत चालतो. प्रत्येक मुहूर्ताचे एक पारंपारिक नाव आहे आणि त्याला शुभ (हिरवा), अशुभ (लाल) किंवा मिश्र (पिवळा) म्हणून वर्गीकृत केले जाते. सर्वात शुभ अभिजित मुहूर्त आहे — सौर मध्यान्हाच्या आसपासचा मध्यान्हकाळ. आज महत्त्वाच्या कामांसाठी सर्वोत्तम वेळ शोधण्यासाठी ही वेळरेषा वापरा.' }, locale)}
          </InfoBlock>
          <div className="my-14">
                  ...
                  >
                    <div className={`rounded-xl p-4 border text-center ${
                      ...
                      <div className={`text-2xl font-bold ${
                        ...
                        {balamResult.chandrabalam.favorable
                          ? (_tl({ en: 'Strong', hi: 'बलवान्', sa: 'बलवान्', ta: 'வலிமையானது', te: 'బలవంతమైన', bn: 'শক্তিশালী', kn: 'ಬಲಿಷ್ಠ', gu: 'બળવાન', mai: 'बलगर', mr: 'बलवान' }, locale))
                          : (_tl({ en: 'Weak', hi: 'दुर्बल', sa: 'दुर्बलः', ta: 'பலவீனமானது', te: 'బలహీనమైన', bn: 'দুর্বল', kn: 'ದುರ್ಬಲ', gu: 'નિર્બળ', mai: 'दुर्बल', mr: 'दुर्बल' }, locale))}
                      </div>
                      <div className="text-text-secondary text-xs mt-2">
              ...
              <p className="text-gold-light text-sm font-bold">
                ...
                <span className={`ml-2 text-xs ${personalDay.taraBala.isFavorable ? 'text-emerald-400' : 'text-red-400'}`}>
                  {personalDay.taraBala.isFavorable
                    ? (_tl({ en: 'Favorable', hi: 'शुभ', sa: 'अनुकूलः', ta: 'சாதகமானது', te: 'అనుకూలమైన', bn: 'অনুকূল', kn: 'ಅನುಕೂಲ', gu: 'અનુકૂળ', mai: 'अनुकूल', mr: 'अनुकूल' }, locale))
                    : (_tl({ en: 'Caution', hi: 'सावधान', sa: 'सावधानम्', ta: 'எச்சரிக்கை', te: 'జాగ్రత్త', bn: 'সতর্কতা', kn: 'ಎಚ್ಚರಿಕೆ', gu: 'સાવધાન', mai: 'सावधान', mr: 'सावधान' }, locale))}
                </span>
              </p>
