...
const FESTIVAL_DATES_2026 = [
  { en: 'Makara Sankranti', hi: 'मकर संक्रान्ति', te: 'మకర సంక్రాంతి', date: 'Wed, 14 Jan 2026', tithi: 'Paush Krishna Pratipada', nakshatra: 'Uttara Ashadha' },
  { en: 'Maha Shivaratri', hi: 'महा शिवरात्रि', te: 'మహా శివరాత్రి', date: 'Sat, 14 Feb 2026', tithi: 'Magha Krishna Chaturdashi', nakshatra: 'Shatabisha' },
  { en: 'Ugadi (Telugu New Year)', hi: 'उगादि (तेलुगु नव वर्ष)', te: 'ఉగాది (తెలుగు నూతన సంవత్సరం)', date: 'Sat, 28 Mar 2026', tithi: 'Chaitra Shukla Pratipada', nakshatra: 'Uttara Bhadrapada' },
  { en: 'Sri Rama Navami', hi: 'श्री राम नवमी', te: 'శ్రీ రామ నవమి', date: 'Mon, 6 Apr 2026', tithi: 'Chaitra Shukla Navami', nakshatra: 'Punarvasu' },
  { en: 'Varalakshmi Vratam', hi: 'वरलक्ष्मी व्रतम्', te: 'వరలక్ష్మీ వ్రతం', date: 'Fri, 7 Aug 2026', tithi: 'Shravana Shukla Dwadashi', nakshatra: 'Uttara Phalguni' },
  { en: 'Vinayaka Chaturthi', hi: 'विनायक चतुर्थी', te: 'వినాయక చవితి', date: 'Fri, 4 Sep 2026', tithi: 'Bhadrapada Shukla Chaturthi', nakshatra: 'Chitra' },
  { en: 'Dasara / Vijayadashami', hi: 'दशहरा / विजयदशमी', te: 'దసరా / విజయదశమి', date: 'Sat, 17 Oct 2026', tithi: 'Ashvija Shukla Dashami', nakshatra: 'Vishakha' },
  { en: 'Deepavali', hi: 'दीपावली', te: 'దీపావళి', date: 'Sun, 8 Nov 2026', tithi: 'Kartika Krishna Amavasya', nakshatra: 'Swati' },
  { en: 'Kartika Purnima', hi: 'कार्तिक पूर्णिमा', te: 'కార్తీక పూర్ణిమ', date: 'Mon, 23 Nov 2026', tithi: 'Kartika Purnima', nakshatra: 'Krittika' },
  { en: 'Subramanya Shashti', hi: 'सुब्रह्मण्य षष्ठी', te: 'సుబ్రహ్మణ్య షష్ఠి', date: 'Sat, 28 Nov 2026', tithi: 'Margashira Shukla Shashthi', nakshatra: 'Pushya' },
];

const FESTIVAL_DATES_2027 = [
  { en: 'Makara Sankranti', hi: 'मकर संक्रान्ति', te: 'మకర సంక్రాంతి', date: 'Thu, 14 Jan 2027', tithi: 'Paush Shukla Dashami', nakshatra: 'Shravana' },
  { en: 'Maha Shivaratri', hi: 'महा शिवरात्रि', te: 'మహా శివరాత్రి', date: 'Thu, 4 Feb 2027', tithi: 'Magha Krishna Chaturdashi', nakshatra: 'Shatabisha' },
  { en: 'Ugadi (Telugu New Year)', hi: 'उगादि (तेलुगु नव वर्ष)', te: 'ఉగాది (తెలుగు నూతన సంవత్సరం)', date: 'Wed, 17 Mar 2027', tithi: 'Chaitra Shukla Pratipada', nakshatra: 'Uttara Bhadrapada' },
  { en: 'Sri Rama Navami', hi: 'श्री राम नवमी', te: 'శ్రీ రామ నవమి', date: 'Thu, 25 Mar 2027', tithi: 'Chaitra Shukla Navami', nakshatra: 'Punarvasu' },
  { en: 'Varalakshmi Vratam', hi: 'वरलक्ष्मी व्रतम्', te: 'వరలక్ష్మీ వ్రతం', date: 'Fri, 30 Jul 2027', tithi: 'Shravana Shukla Trayodashi', nakshatra: 'Hasta' },
  { en: 'Vinayaka Chaturthi', hi: 'विनायक चतुर्थी', te: 'వినాయక చవితి', date: 'Wed, 25 Aug 2027', tithi: 'Bhadrapada Shukla Chaturthi', nakshatra: 'Chitra' },
  { en: 'Dasara / Vijayadashami', hi: 'दशहरा / विजयदशमी', te: 'దసరా / విజయదశమి', date: 'Wed, 6 Oct 2027', tithi: 'Ashvija Shukla Dashami', nakshatra: 'Vishakha' },
  { en: 'Deepavali', hi: 'दीपावली', te: 'దీపావళి', date: 'Thu, 28 Oct 2027', tithi: 'Kartika Krishna Amavasya', nakshatra: 'Chitra' },
  { en: 'Kartika Purnima', hi: 'कार्तिक पूर्णिमा', te: 'కార్తీక పూర్ణిమ', date: 'Fri, 12 Nov 2027', tithi: 'Kartika Purnima', nakshatra: 'Krittika' },
  { en: 'Subramanya Shashti', hi: 'सुब्रह्मण्य षष्ठी', te: 'సుబ్రహ్మణ్య షష్ఠి', date: 'Wed, 17 Nov 2027', tithi: 'Margashira Shukla Shashthi', nakshatra: 'Pushya' },
];
...
const MONTH_CONVERSION_2026 = [
  { telugu: 'Chaitra', te: 'చైత్రం', hi: 'चैत्र', start: '29 Mar 2026', end: '26 Apr 2026' },
  { telugu: 'Vaishakha', te: 'వైశాఖం', hi: 'वैशाख', start: '27 Apr 2026', end: '25 May 2026' },
  { telugu: 'Jyeshtha', te: 'జ్యేష్ఠం', hi: 'ज्येष्ठ', start: '26 May 2026', end: '24 Jun 2026' },
  { telugu: 'Ashadha', te: 'ఆషాఢం', hi: 'आषाढ', start: '25 Jun 2026', end: '23 Jul 2026' },
  { telugu: 'Shravana', te: 'శ్రావణం', hi: 'श्रावण', start: '24 Jul 2026', end: '22 Aug 2026' },
  { telugu: 'Bhadrapada', te: 'భాద్రపదం', hi: 'भाद्रपद', start: '23 Aug 2026', end: '20 Sep 2026' },
  { telugu: 'Ashvija', te: 'ఆశ్వయుజం', hi: 'आश्विन', start: '21 Sep 2026', end: '20 Oct 2026' },
  { telugu: 'Kartika', te: 'కార్తీకం', hi: 'कार्तिक', start: '21 Oct 2026', end: '19 Nov 2026' },
  { telugu: 'Margashira', te: 'మార్గశిరం', hi: 'मार्गशीर्ष', start: '20 Nov 2026', end: '18 Dec 2026' },
  { telugu: 'Pushya', te: 'పుష్యం', hi: 'पौष', start: '19 Dec 2026', end: '17 Jan 2027' },
  { telugu: 'Magha', te: 'మాఘం', hi: 'माघ', start: '18 Jan 2027', end: '15 Feb 2027' },
  { telugu: 'Phalguna', te: 'ఫాల్గుణం', hi: 'फाल्गुन', start: '16 Feb 2027', end: '17 Mar 2027' },
];

const MONTH_CONVERSION_2027 = [
  { telugu: 'Chaitra', te: 'చైత్రం', hi: 'चैत्र', start: '18 Mar 2027', end: '15 Apr 2027' },
  { telugu: 'Vaishakha', te: 'వైశాఖం', hi: 'वैशाख', start: '16 Apr 2027', end: '15 May 2027' },
  { telugu: 'Jyeshtha', te: 'జ్యేష్ఠం', hi: 'ज्येष्ठ', start: '16 May 2027', end: '13 Jun 2027' },
  { telugu: 'Ashadha', te: 'ఆషాఢం', hi: 'आषाढ', start: '14 Jun 2027', end: '13 Jul 2027' },
  { telugu: 'Shravana', te: 'శ్రావణం', hi: 'श्रावण', start: '14 Jul 2027', end: '11 Aug 2027' },
  { telugu: 'Bhadrapada', te: 'భాద్రపదం', hi: 'भाद्रपद', start: '12 Aug 2027', end: '10 Sep 2027' },
  { telugu: 'Ashvija', te: 'ఆశ్వయుజం', hi: 'आश्विन', start: '11 Sep 2027', end: '9 Oct 2027' },
  { telugu: 'Kartika', te: 'కార్తీకం', hi: 'कार्तिक', start: '10 Oct 2027', end: '8 Nov 2027' },
  { telugu: 'Margashira', te: 'మార్గశిరం', hi: 'मार्गशीर्ष', start: '9 Nov 2027', end: '8 Dec 2027' },
  { telugu: 'Pushya', te: 'పుష్యం', hi: 'पौष', start: '9 Dec 2027', end: '6 Jan 2028' },
  { telugu: 'Magha', te: 'మాఘం', hi: 'माघ', start: '7 Jan 2028', end: '5 Feb 2028' },
  { telugu: 'Phalguna', te: 'ఫాల్గుణం', hi: 'फाल्गुन', start: '6 Feb 2028', end: '7 Mar 2028' },
];

// FAQ data for structured data and visible FAQ section
const FAQ_DATA = [
  {
    q: { en: 'When is Ugadi 2026?', hi: 'उगादि 2026 कब है?', te: 'ఉగాది 2026 ఎప్పుడు?' },
    a: {
  ...
  {
    q: { en: 'What is Telugu Panchangam?', hi: 'तेलुगु पंचांगम् क्या है?', te: 'తెలుగు పంచాంగం అంటే ఏమిటి?' },
    a: {
  ...
  {
    q: { en: 'When is Vinayaka Chaturthi 2026?', hi: 'विनायक चतुर्थी 2026 कब है?', te: 'వినాయక చవితి 2026 ఎప్పుడు?' },
    a: {
  ...
  {
    q: { en: 'How does the Telugu calendar differ from the Tamil calendar?', hi: 'तेलुगु कैलेंडर तमिल कैलेंडर से कैसे भिन्न है?', te: 'తెలుగు పంచాంగం తమిళ పంచాంగానికి ఎలా భిన్నంగా ఉంటుంది?' },
    a: {
  ...
  {
    q: { en: 'What is the current Telugu year name?', hi: 'वर्तमान तेलुगु वर्ष का नाम क्या है?', te: 'ప్రస్తుత తెలుగు సంవత్సరం పేరు ఏమిటి?' },
    a: {
  ...
  {
    q: { en: 'When is Deepavali 2026 in the Telugu calendar?', hi: 'तेलुगु कैलेंडर में दीपावली 2026 कब है?', te: 'తెలుగు పంచాంగంలో దీపావళి 2026 ఎప్పుడు?' },
    a: {
...
export default async function TeluguCalendarPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const fLang = (f: { en: string; hi: string; te: string }) => isTe ? f.te : isHi ? f.hi : f.en;
  ...
  return (
    <main className="min-h-screen bg-bg-primary">
      <div className="max-w-4xl mx-auto px-4 py-12 space-y-10">
          ...
          <div className="space-y-4 text-text-secondary text-sm leading-relaxed">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mt-3">
              <div className="bg-bg-primary/40 border border-gold-primary/8 rounded-xl p-4">
                <div className="text-gold-light font-semibold text-lg mb-1">{isTe ? 'శోభకృత్' : isHi ? 'शोभकृत्' : 'Shobhakrit'}</div>
                <div className="text-amber-400/80 text-sm mb-1">{isTe ? '37వ సంవత్సరం' : isHi ? '37वां वर्ष' : '37th Year in Cycle'}</div>
                <div className="text-text-secondary text-xs">{isTe ? '28 మార్చి 2026 – మార్చి 2027' : isHi ? '28 मार्च 2026 – मार्च 2027' : '28 Mar 2026 – Mar 2027'}</div>
              </div>
              <div className="bg-bg-primary/40 border border-gold-primary/8 rounded-xl p-4">
                <div className="text-gold-light font-semibold text-lg mb-1">{isTe ? 'క్రోధి' : isHi ? 'क्रोधी' : 'Krodhi'}</div>
                <div className="text-amber-400/80 text-sm mb-1">{isTe ? '38వ సంవత్సరం' : isHi ? '38वां वर्ष' : '38th Year in Cycle'}</div>
                <div className="text-text-secondary text-xs">{isTe ? 'మార్చి 2027 – మార్చి 2028' : isHi ? 'मार्च 2027 – मार्च 2028' : 'Mar 2027 – Mar 2028'}</div>
              </div>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <div className="overflow-x-auto rounded-2xl border border-gold-primary/12 mb-6">
            <div className="text-gold-light font-semibold text-sm px-4 py-2 bg-bg-secondary/60 border-b border-gold-primary/12">
              {isTe ? 'శోభకృత్ సంవత్సరం (2026–27)' : isHi ? 'शोभकृत् संवत्सर (2026–27)' : 'Shobhakrit Year (2026–27)'}
            </div>
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-bg-secondary/40 border-b border-gold-primary/12">
                  <th className="text-left px-4 py-2 text-gold-light font-semibold">{isTe ? 'నెల' : isHi ? 'मास' : 'Month'}</th>
                  <th className="text-left px-4 py-2 text-gold-light font-semibold">{isTe ? 'తెలుగు' : 'Telugu'}</th>
                  <th className="text-left px-4 py-2 text-gold-light font-semibold">{isTe ? 'ప్రారంభం' : isHi ? 'प्रारम्भ' : 'Start'}</th>
                  <th className="text-left px-4 py-2 text-gold-light font-semibold">{isTe ? 'ముగింపు' : isHi ? 'समाप्ति' : 'End'}</th>
                </tr>
              </thead>
              <tbody>
                {MONTH_CONVERSION_2026.map((m, i) => (
                  <tr key={m.telugu + '2026'} className={i % 2 === 0 ? 'bg-bg-secondary/20' : 'bg-bg-secondary/40'}>
                    <td className="px-4 py-2.5 text-text-primary font-medium">{isTe ? m.te : isHi ? m.hi : m.telugu}</td>
                    <td className="px-4 py-2.5 text-amber-400/80">{m.te}</td>
                    <td className="px-4 py-2.5 text-text-secondary text-xs">{m.start}</td>
                    <td className="px-4 py-2.5 text-text-secondary text-xs">{m.end}</td>
                  </tr>
                ))}
              </tbody>
            </table>
          ...
          <div className="overflow-x-auto rounded-2xl border border-gold-primary/12">
            <div className="text-gold-light font-semibold text-sm px-4 py-2 bg-bg-secondary/60 border-b border-gold-primary/12">
              {isTe ? 'క్రోధి సంవత్సరం (2027–28)' : isHi ? 'क्रोधी संवत्सर (2027–28)' : 'Krodhi Year (2027–28)'}
            </div>
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-bg-secondary/40 border-b border-gold-primary/12">
              ...
              <tbody>
                {MONTH_CONVERSION_2027.map((m, i) => (
                  <tr key={m.telugu + '2027'} className={i % 2 === 0 ? 'bg-bg-secondary/20' : 'bg-bg-secondary/40'}>
                    <td className="px-4 py-2.5 text-text-primary font-medium">{isTe ? m.te : isHi ? m.hi : m.telugu}</td>
                    <td className="px-4 py-2.5 text-amber-400/80">{m.te}</td>
                    <td className="px-4 py-2.5 text-text-secondary text-xs">{m.start}</td>
                    <td className="px-4 py-2.5 text-text-secondary text-xs">{m.end}</td>
        ...
        <section>
          <h2 className="text-2xl font-bold text-gold-light mb-3" style={hf}>
            {isTe ? 'తెలుగు పండుగల తేదీలు 2026 — తిథి, నక్షత్రం & ఖచ్చితమైన తేదీలు' : isHi ? 'तेलुगु त्योहार 2026 — तिथि, नक्षत्र और दिनांक' : 'Telugu Festival Dates 2026 — Tithi, Nakshatra & Exact Dates'}
          </h2>
          <p className="text-text-secondary text-sm leading-relaxed mb-5">
            {isTe
          ...
          <div className="overflow-x-auto rounded-2xl border border-gold-primary/12">
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-bg-secondary/60 border-b border-gold-primary/12">
                  <th className="text-left px-4 py-3 text-gold-light font-semibold">{isTe ? 'పండుగ' : isHi ? 'त्योहार' : 'Festival'}</th>
                  <th className="text-left px-4 py-3 text-gold-light font-semibold">{isTe ? 'తేదీ' : isHi ? 'दिनांक' : 'Date'}</th>
                  <th className="text-left px-4 py-3 text-gold-light font-semibold">{isTe ? 'తిథి' : isHi ? 'तिथि' : 'Tithi'}</th>
                  <th className="text-left px-4 py-3 text-gold-light font-semibold">{isTe ? 'నక్షత్రం' : isHi ? 'नक्षत्र' : 'Nakshatra'}</th>
                </tr>
              </thead>
              <tbody>
        ...
        <section>
          <h2 className="text-2xl font-bold text-gold-light mb-3" style={hf}>
            {isTe ? 'తెలుగు పండుగల తేదీలు 2027 — తిథి, నక్షత్రం & ఖచ్చితమైన తేదీలు' : isHi ? 'तेलुगु त्योहार 2027 — तिथि, नक्षत्र और दिनांक' : 'Telugu Festival Dates 2027 — Tithi, Nakshatra & Exact Dates'}
          </h2>
          <p className="text-text-secondary text-sm leading-relaxed mb-5">
            {isTe
        ...
        <section className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-2xl p-6">
          <h2 className="text-2xl font-bold text-gold-light mb-3" style={hf}>
            {isTe ? 'తెలుగు పంచాంగం చరిత్ర మరియు ప్రాముఖ్యత' : isHi ? 'तेलुगु पंचांगम् का इतिहास और महत्व' : 'History & Significance of the Telugu Panchangam'}
          </h2>
          <div className="space-y-4 text-text-secondary text-sm leading-relaxed">
            <p>
              {isTe
        ...
        <section>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {[
              ...
              { href: `/${locale}/calendar/regional/bengali`, label: { en: 'Bengali Calendar (Panjika)', hi: 'बंगाली कैलेंडर', te: 'బెంగాలీ పంచాంగం' } },
              { href: `/${locale}/calendar`, label: { en: 'Festival Calendar 2026', hi: 'त्योहार कैलेंडर 2026', te: 'పండుగల పంచాంగం 2026' } },
              { href: `/${locale}/panchang`, label: { en: 'Daily Panchangam', hi: 'दैनिक पंचांग', te: 'దైనిక పంచాంగం' } },
            ].map((link) => (
              <a
                key={link.href}
                href={link.href}
