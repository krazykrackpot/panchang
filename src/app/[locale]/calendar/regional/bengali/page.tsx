...
const BANGABDA_YEARS: Array<{ bs: string; span: string; anchor: LocaleText }> = [
  ...
  { bs: '1438 BS', span: '14 Apr 2031 – 13 Apr 2032', anchor: { en: 'Falls in the 75-year window of the Indian Republic (formed 26 January 1950).', hi: 'भारतीय गणतंत्र (26 जनवरी 1950 को गठित) की 75 वर्ष की खिड़की में पड़ता है।', bn: 'ভারতীয় প্রজাতন্ত্রের 75 বছরের সময়কালে পড়ে (26 জানুয়ারী 1950 সালে গঠিত)।' } },
