    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Jaimini&apos;s Variable Significators / जैमिनी के परिवर्तनशील कारक
        </h3>
      ...
      <section className="glass-card rounded-xl p-5 border border-gold-primary/10">
        <h4 className="text-gold-dark text-[10px] uppercase tracking-widest font-bold mb-2">Rahu&apos;s Special Treatment / राहु का विशेष नियम</h4>
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Computing Chara Karakas / चर कारक गणना
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          The Atmakaraka&apos;s Supreme Significance / आत्मकारक का सर्वोच्च महत्त्व
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Karakamsha — The AK in D9 / कारकांश — D9 में AK
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section className="glass-card rounded-xl p-5 border border-gold-primary/10">
        <h4 className="text-gold-dark text-[10px] uppercase tracking-widest font-bold mb-2">Why AK Can Surpass the Lagna Lord / AK लग्नेश से ऊपर क्यों</h4>
        <p className="text-text-secondary text-sm leading-relaxed mb-2">
