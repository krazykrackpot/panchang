...
export const DUSSEHRA_PUJA: PujaVidhi = {
  ...
  samagri: [
    { name: { en: 'Shami tree leaves', hi: 'शमी के पत्ते', sa: 'शमीपत्राणि' }, note: { en: 'The most important item — exchange with neighbours for prosperity', hi: 'सबसे महत्वपूर्ण सामग्री — समृद्धि के लिए पड़ोसियों से आदान-प्रदान करें', sa: 'सर्वप्रधानं द्रव्यम् — समृद्ध्यर्थं प्रतिवासिभिः सह आदानप्रदानं कुर्यात्' } },
    { name: { en: 'Aparajita flowers (blue butterfly pea)', hi: 'अपराजिता के फूल', sa: 'अपराजितापुष्पाणि' } },
    { name: { en: 'Akshat (unbroken rice)', hi: 'अक्षत (साबुत चावल)', sa: 'अक्षताः' } },
    { name: { en: 'Weapons/tools for Shastra Puja', hi: 'शस्त्र/उपकरण शस्त्र पूजा के लिए', sa: 'शस्त्राणि/उपकरणानि शस्त्रपूजार्थम्' }, note: { en: 'Vehicles, instruments of livelihood, books, computers — anything that represents your work', hi: 'वाहन, जीविका के साधन, पुस्तकें, कम्प्यूटर — कुछ भी जो आपके कार्य का प्रतिनिधित्व करे', sa: 'वाहनानि, जीवनोपायसाधनानि, पुस्तकानि, सङ्गणकानि — किमपि यत् कार्यस्य प्रतिनिधित्वं करोति' } },
    { name: { en: 'Ramayana (book)', hi: 'रामायण (पुस्तक)', sa: 'रामायणम् (ग्रन्थः)' } },
    { name: { en: 'Blue flowers', hi: 'नीले फूल', sa: 'नीलपुष्पाणि' } },
    ...
    { name: { en: 'Flowers (marigold, red)', hi: 'फूल (गेंदा, लाल)', sa: 'पुष्पाणि (स्थलपद्मम्, रक्तम्)' } },
    { name: { en: 'Sweets (jalebi, pedha)', hi: 'मिठाई (जलेबी, पेड़ा)', sa: 'मिष्टान्नानि (जलेबी, पेदकम्)' } },
  ],
