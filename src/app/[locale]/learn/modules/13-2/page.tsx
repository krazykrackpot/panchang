    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Dhana Yogas — Wealth Combinations / धन योग — सम्पत्ति संयोग
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          Dhana Yogas are specific planetary combinations that indicate wealth accumulation, financial prosperity, and material abundance. They are formed primarily by the interaction of lords of the wealth axis — the 2nd (stored wealth, family resources), 5th (speculative gains, past-life merit, intellect), 9th (fortune, divine grace, father&apos;s wealth), and 11th (income, gains, fulfillment) houses. When these lords form conjunctions, mutual aspects, or sign exchanges, they create pipelines for wealth to flow into the native&apos;s life.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section className="glass-card rounded-xl p-5 border border-gold-primary/10">
        <h4 className="text-gold-dark text-[10px] uppercase tracking-widest font-bold mb-3">Key Dhana Yogas / प्रमुख धन योग</h4>
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">Cancellation & Mitigation / निरसन एवं शमन</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Arishta Yogas — Health & Danger / अरिष्ट योग — स्वास्थ्य एवं संकट
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          Arishta Yogas indicate vulnerabilities in health, physical safety, or life longevity. They are formed when malefic planets afflict sensitive chart points — particularly the Moon (mind, nurturing), Lagna (body, vitality), and the 8th house (longevity, chronic conditions). Arishta assessment is essential for both predictive and remedial astrology, as identifying vulnerabilities allows for preventive measures.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          अरिष्ट योग स्वास्थ्य, शारीरिक सुरक्षा या जीवन आयु में सम्वेदनशीलता इंगित करते हैं। ये तब बनते हैं जब पापी ग्रह कुण्डली के संवेदनशील बिन्दुओं को पीड़ित करते हैं — विशेषकर चन्द्रमा (मन, पोषण), लग्न (शरीर, जीवनशक्ति) और 8वाँ भाव (आयु, जीर्ण स्थिति)। अरिष्ट मूल्यांकन फलित और उपचारात्मक ज्योतिष दोनों के लिए आवश्यक है, क्योंकि सम्वेदनशीलता पहचानना निवारक उपायों की अनुमति देता है।
        </p>
      </section>

      <section className="glass-card rounded-xl p-5 border border-red-500/15">
        <h4 className="text-red-400 text-[10px] uppercase tracking-widest font-bold mb-3">Key Arishta Configurations / प्रमुख अरिष्ट विन्यास</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
      ...
      <section className="glass-card rounded-xl p-5 border border-blue-500/15">
        <h4 className="text-blue-300 text-[10px] uppercase tracking-widest font-bold mb-3">Severity Assessment / तीव्रता मूल्यांकन</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          Arishta severity depends on: (1) How many malefics are involved — one malefic is manageable, two or more is serious. (2) Benefic counterbalance — Jupiter or Venus aspecting the afflicted point reduces severity dramatically. (3) Lagna lord strength — a strong Lagna lord gives physical resilience to withstand afflictions. (4) Dasha timing — Arishta Yogas activate only during the dasha of involved planets.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          अरिष्ट तीव्रता निर्भर करती है: (1) कितने पापी ग्रह सम्मिलित हैं — एक सम्भालने योग्य है, दो या अधिक गम्भीर। (2) शुभ प्रतिसन्तुलन — गुरु या शुक्र की दृष्टि पीड़ित बिन्दु पर तीव्रता नाटकीय रूप से कम करती है। (3) लग्न स्वामी बल — बलवान लग्न स्वामी पीड़ाओं को सहने की शारीरिक सहनशक्ति देता है। (4) दशा समय — अरिष्ट योग केवल सम्बन्धित ग्रहों की दशा में सक्रिय होते हैं।
        </p>
      </section>

      <section className="glass-card rounded-xl p-5 border border-amber-500/15">
        <h4 className="text-amber-400 text-[10px] uppercase tracking-widest font-bold mb-3">Remedial Perspective / उपचारात्मक दृष्टिकोण</h4>
        <p className="text-text-secondary text-xs leading-relaxed">
