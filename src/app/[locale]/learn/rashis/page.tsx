...
const INTERP_RULES = [
  {
    category: { en: 'Planets in Fire Signs', hi: 'अग्नि राशि में ग्रह', sa: 'अग्नि राशि में ग्रह', mai: 'अग्नि राशि में ग्रह', mr: 'अग्नि राशि में ग्रह', ta: 'அக்னி ராசிகளில் கிரகங்கள்', te: 'అగ్ని రాశులలో గ్రహాలు', bn: 'অগ্নি রাশিতে গ্রহ', kn: 'ಅಗ್ನಿ ರಾಶಿಗಳಲ್ಲಿ ಗ್ರಹಗಳು', gu: 'અગ્નિ રાશિઓમાં ગ્રહો' },
    color: 'text-red-400',
  ...
  {
    category: { en: 'Planets in Earth Signs', hi: 'पृथ्वी राशि में ग्रह', sa: 'पृथ्वी राशि में ग्रह', mai: 'पृथ्वी राशि में ग्रह', mr: 'पृथ्वी राशि में ग्रह', ta: 'பூமி ராசிகளில் கிரகங்கள்', te: 'భూమి రాశులలో గ్రహాలు', bn: 'পৃথিবী রাশিতে গ্রহ', kn: 'ಭೂಮಿ ರಾಶಿಗಳಲ್ಲಿ ಗ್ರಹಗಳು', gu: 'પૃથ્વી રાશિઓમાં ગ્રહો' },
    color: 'text-emerald-400',
    border: 'border-emerald-400/20 bg-emerald-400/5',
    rules: {
  ...
  {
    category: { en: 'Planets in Air Signs', hi: 'वायु राशि में ग्रह', sa: 'वायु राशि में ग्रह', mai: 'वायु राशि में ग्रह', mr: 'वायु राशि में ग्रह', ta: 'வாயு ராசிகளில் கிரகங்கள்', te: 'వాయు రాశులలో గ్రహాలు', bn: 'বায়ু রাশিতে গ্রহ', kn: 'ವಾಯು ರಾಶಿಗಳಲ್ಲಿ ಗ್ರಹಗಳು', gu: 'વાયુ રાશિઓમાં ગ્રહો' },
    color: 'text-sky-400',
  ...
  {
    category: { en: 'Planets in Water Signs', hi: 'जल राशि में ग्रह', sa: 'जल राशि में ग्रह', mai: 'जल राशि में ग्रह', mr: 'जल राशि में ग्रह', ta: 'நீர் ராசிகளில் கிரகங்கள்', te: 'జల రాశులలో గ్రహాలు', bn: 'জল রাশিতে গ্রহ', kn: 'ಜಲ ರಾಶಿಗಳಲ್ಲಿ ಗ್ರಹಗಳು', gu: 'જળ રાશિઓમાં ગ્રહો' },
    color: 'text-blue-400',
...
const RASHI_CHARS: Record<number, { traits: Record<string, string>; keywords: Record<string, string> }> = {
  1: { traits: { en: 'Courageous, pioneering, impatient, independent. Natural leader with fiery temperament. First sign — represents new beginnings, the self, and raw initiative.', hi: 'साहसी, अग्रणी, अधीर, स्वतन्त्र। अग्नि स्वभाव का प्राकृतिक नेता। प्रथम राशि — नई शुरुआत, आत्मा और कच्ची पहल का प्रतिनिधित्व।', sa: 'साहसी, अग्रणी, अधीर, स्वतन्त्र। अग्नि स्वभाव का प्राकृतिक नेता। प्रथम राशि — नई शुरुआत, आत्मा और कच्ची पहल का प्रतिनिधित्व।', mai: 'साहसी, अग्रणी, अधीर, स्वतन्त्र। अग्नि स्वभाव का प्राकृतिक नेता। प्रथम राशि — नई शुरुआत, आत्मा और कच्ची पहल का प्रतिनिधित्व।', mr: 'साहसी, अग्रणी, अधीर, स्वतन्त्र। अग्नि स्वभाव का प्राकृतिक नेता। प्रथम राशि — नई शुरुआत, आत्मा और कच्ची पहल का प्रतिनिधित्व।', ta: 'தைரியமான, முன்னோடி, பொறுமையற்ற, சுதந்திரமான. அக்னி குணமுள்ள இயல்பான தலைவர். முதல் ராசி — புதிய தொடக்கங்கள், சுயம் மற்றும் மூல முன்னெடுப்பைக் குறிக்கிறது.', te: 'ధైర్యశాలి, ప్రవర్తకుడు, అసహనం, స్వతంత్రుడు. అగ్ని స్వభావం గల సహజ నాయకుడు. మొదటి రాశి — నూతన ప్రారంభాలు, ఆత్మ మరియు ముడి చొరవను సూచిస్తుంది.', bn: 'সাহসী, পথিকৃৎ, অধৈর্য, স্বাধীন। অগ্নি স্বভাবের স্বাভাবিক নেতা। প্রথম রাশি — নতুন শুরু, আত্মা এবং কাঁচা উদ্যমের প্রতিনিধিত্ব করে।', kn: 'ಧೈರ್ಯಶಾಲಿ, ಮಾರ್ಗದರ್ಶಕ, ಅಸಹನೆ, ಸ್ವತಂತ್ರ. ಅಗ್ನಿ ಸ್ವಭಾವದ ನೈಸರ್ಗಿಕ ನಾಯಕ. ಮೊದಲ ರಾಶಿ — ಹೊಸ ಆರಂಭ, ಆತ್ಮ ಮತ್ತು ಮೂಲ ಉಪಕ್ರಮವನ್ನು ಪ್ರತಿನಿಧಿಸುತ್ತದೆ.', gu: 'સાહસિક, અગ્રણી, અધીર, સ્વતંત્ર. અગ્નિ સ્વભાવનો કુદરતી નેતા. પ્રથમ રાશિ — નવી શરૂઆત, સ્વયં અને કાચી પહેલનું પ્રતિનિધિત્વ.' }, keywords: { en: 'Initiative, energy, self', hi: 'पहल, ऊर्जा, स्व', sa: 'पहल, ऊर्जा, स्व', mai: 'पहल, ऊर्जा, स्व', mr: 'पहल, ऊर्जा, स्व', ta: 'முன்னெடுப்பு, ஆற்றல், சுயம்', te: 'చొరవ, శక్తి, ఆత్మ', bn: 'উদ্যম, শক্তি, স্বয়ং', kn: 'ಉಪಕ್ರಮ, ಶಕ್ತಿ, ಸ್ವಯಂ', gu: 'પહેલ, શક્તિ, સ્વયં' } },
  2: { traits: { en: 'Stable, sensual, possessive, artistic. Values material comfort and beauty. Strongest earth sign — represents wealth, family, and sensory pleasure.', hi: 'स्थिर, इन्द्रियप्रिय, अधिकारशील, कलात्मक। भौतिक सुख और सौन्दर्य को महत्व देता है। सबसे मजबूत पृथ्वी राशि — धन, परिवार और संवेदी सुख।', sa: 'स्थिर, इन्द्रियप्रिय, अधिकारशील, कलात्मक। भौतिक सुख और सौन्दर्य को महत्व देता है। सबसे मजबूत पृथ्वी राशि — धन, परिवार और संवेदी सुख।', mai: 'स्थिर, इन्द्रियप्रिय, अधिकारशील, कलात्मक। भौतिक सुख और सौन्दर्य को महत्व देता है। सबसे मजबूत पृथ्वी राशि — धन, परिवार और संवेदी सुख।', mr: 'स्थिर, इन्द्रियप्रिय, अधिकारशील, कलात्मक। भौतिक सुख और सौन्दर्य को महत्व देता है। सबसे मजबूत पृथ्वी राशि — धन, परिवार और संवेदी सुख।', ta: 'நிலையான, புலன்சார்ந்த, உடைமைப்பிடிப்பு, கலை. பொருள் வசதி மற்றும் அழகை மதிக்கிறது. வலிமையான பூமி ராசி — செல்வம், குடும்பம் மற்றும் புலன் இன்பத்தைக் குறிக்கிறது.', te: 'స్థిరమైన, ఇంద్రియ ప్రియ, స్వాధీన, కళాత్మక. భౌతిక సౌకర్యం మరియు అందాన్ని విలువైనదిగా భావిస్తుంది. బలమైన భూమి రాశి — సంపద, కుటుంబం మరియు ఇంద్రియ సుఖాన్ని సూచిస్తుంది.', bn: 'স্থিতিশীল, ইন্দ্রিয়পরায়ণ, অধিকারী, শৈল্পিক। বৈষয়িক স্বাচ্ছন্দ্য ও সৌন্দর্যকে মূল্যায়ন করে। সবচেয়ে শক্তিশালী পৃথিবী রাশি — সম্পদ, পরিবার ও ইন্দ্রিয় সুখের প্রতিনিধিত্ব করে।', kn: 'ಸ್ಥಿರ, ಇಂದ್ರಿಯಪ್ರಿಯ, ಸ್ವಾಮ್ಯ, ಕಲಾತ್ಮಕ. ಭೌತಿಕ ಸೌಕರ್ಯ ಮತ್ತು ಸೌಂದರ್ಯವನ್ನು ಮೌಲ್ಯೀಕರಿಸುತ್ತದೆ. ಪ್ರಬಲ ಭೂಮಿ ರಾಶಿ — ಸಂಪತ್ತು, ಕುಟುಂಬ ಮತ್ತು ಇಂದ್ರಿಯ ಸುಖವನ್ನು ಪ್ರತಿನಿಧಿಸುತ್ತದೆ.', gu: 'સ્થિર, ઇન્દ્રિયપ્રિય, માલિકીભાવ, કલાત્મક. ભૌતિક આરામ અને સૌંદર્યને મૂલ્ય આપે છે. સૌથી મજબૂત પૃથ્વી રાશિ — સંપત્તિ, કુટુંબ અને ઇન્દ્રિય સુખનું પ્રતિનિધિત્વ.' }, keywords: { en: 'Wealth, beauty, stability', hi: 'धन, सौन्दर्य, स्थिरता', sa: 'धन, सौन्दर्य, स्थिरता', mai: 'धन, सौन्दर्य, स्थिरता', mr: 'धन, सौन्दर्य, स्थिरता', ta: 'செல்வம், அழகு, நிலைப்பு', te: 'సంపద, అందం, స్థిరత్వం', bn: 'সম্পদ, সৌন্দর্য, স্থিরতা', kn: 'ಸಂಪತ್ತು, ಸೌಂದರ್ಯ, ಸ್ಥಿರತೆ', gu: 'સંપત્તિ, સૌંદર્ય, સ્થિરતા' } },
  3: { traits: { en: 'Curious, communicative, versatile, restless. Twin-natured sign of intellect and duality. Masters of language, trade, and information exchange.', hi: 'जिज्ञासु, संवादी, बहुमुखी, बेचैन। बुद्धि और द्वैत की जुड़वाँ प्रकृति वाली राशि। भाषा, व्यापार और सूचना विनिमय के स्वामी।', sa: 'जिज्ञासु, संवादी, बहुमुखी, बेचैन। बुद्धि और द्वैत की जुड़वाँ प्रकृति वाली राशि। भाषा, व्यापार और सूचना विनिमय के स्वामी।', mai: 'जिज्ञासु, संवादी, बहुमुखी, बेचैन। बुद्धि और द्वैत की जुड़वाँ प्रकृति वाली राशि। भाषा, व्यापार और सूचना विनिमय के स्वामी।', mr: 'जिज्ञासु, संवादी, बहुमुखी, बेचैन। बुद्धि और द्वैत की जुड़वाँ प्रकृति वाली राशि। भाषा, व्यापार और सूचना विनिमय के स्वामी।', ta: 'ஆர்வமுள்ள, தொடர்பாடல் திறன், பல்திறன், அமைதியற்ற. புத்தி மற்றும் இருமையின் இரட்டை இயல்புடைய ராசி. மொழி, வணிகம் மற்றும் தகவல் பரிமாற்றத்தின் நிபுணர்கள்.', te: 'ఉత్సుకమైన, సంభాషణాత్మక, బహుముఖ, అశాంతమైన. మేధస్సు మరియు ద్వంద్వత్వం యొక్క జంట-స్వభావ రాశి. భాష, వాణిజ్యం మరియు సమాచార మార్పిడిలో నిపుణులు.', bn: 'কৌতূহলী, যোগাযোগপ্রবণ, বহুমুখী, অস্থির। বুদ্ধি ও দ্বৈততার যুগ্ম-প্রকৃতির রাশি। ভাষা, ব্যবসা ও তথ্য বিনিময়ে দক্ষ।', kn: 'ಕುತೂಹಲಕಾರಿ, ಸಂವಹನ, ಬಹುಮುಖ, ಅಶಾಂತ. ಬುದ್ಧಿ ಮತ್ತು ದ್ವೈತದ ಅವಳಿ-ಸ್ವಭಾವದ ರಾಶಿ. ಭಾಷೆ, ವ್ಯಾಪಾರ ಮತ್ತು ಮಾಹಿತಿ ವಿನಿಮಯದ ಪ್ರಭುಗಳು.', gu: 'જિજ્ઞાસુ, સંવાદી, બહુમુખી, બેચેન. બુદ્ધિ અને દ્વૈતનો જોડિયા-સ્વભાવ રાશિ. ભાષા, વ્યાપાર અને માહિતી વિનિમયના નિષ્ણાતો.' }, keywords: { en: 'Communication, duality, intellect', hi: 'संवाद, द्वैत, बुद्धि', sa: 'संवाद, द्वैत, बुद्धि', mai: 'संवाद, द्वैत, बुद्धि', mr: 'संवाद, द्वैत, बुद्धि', ta: 'தொடர்பு, இருமை, புத்தி', te: 'సంభాషణ, ద్వైతం, బుద్ధి', bn: 'যোগাযোগ, দ্বৈত, বুদ্ধি', kn: 'ಸಂವಹನ, ದ್ವೈತ, ಬುದ್ಧಿ', gu: 'સંવાદ, દ્વૈત, બુદ્ધિ' } },
