...
const QUESTIONS: ModuleQuestion[] = [
  ...
  },
  {
    ...
    options: [
      { en: '~1° (3600 arcseconds)', hi: '~1° (3600 कला-सेकण्ड)', sa: '~1° (3600 कलासेकण्डानि)', mai: '~1° (3600 कला-सेकण्ड)', mr: '~1° (3600 कलासेकंद)', ta: '~1° (3600 arcseconds)', te: '~1° (3600 arcseconds)', bn: '~1° (3600 arcseconds)', kn: '~1° (3600 arcseconds)', gu: '~1° (3600 arcseconds)' },
      { en: '~0.01° (36 arcseconds)', hi: '~0.01° (36 कला-सेकण्ड)', sa: '~0.01° (36 कलासेकण्डानि)', mai: '~0.01° (36 कला-सेकण्ड)', mr: '~0.01° (36 कलासेकंद)', ta: '~0.01° (36 arcseconds)', te: '~0.01° (36 arcseconds)', bn: '~0.01° (36 arcseconds)', kn: '~0.01° (36 arcseconds)', gu: '~0.01° (36 arcseconds)' },
      { en: '~0.001° (3.6 arcseconds)', hi: '~0.001° (3.6 कला-सेकण्ड)', sa: '~0.001° (3.6 कलासेकण्डानि)', mai: '~0.001° (3.6 कला-सेकण्ड)', mr: '~0.001° (3.6 कलासेकंद)', ta: '~0.001° (3.6 arcseconds)', te: '~0.001° (3.6 arcseconds)', bn: '~0.001° (3.6 arcseconds)', kn: '~0.001° (3.6 arcseconds)', gu: '~0.001° (3.6 arcseconds)' },
      { en: '~0.0001° (0.36 arcseconds)', hi: '~0.0001° (0.36 कला-सेकण्ड)', sa: '~0.0001° (0.36 कलासेकण्डानि)', mai: '~0.0001° (0.36 कला-सेकण्ड)', mr: '~0.0001° (0.36 कलासेकंद)', ta: '~0.0001° (0.36 arcseconds)', te: '~0.0001° (0.36 arcseconds)', bn: '~0.0001° (0.36 arcseconds)', kn: '~0.0001° (0.36 arcseconds)', gu: '~0.0001° (0.36 arcseconds)' },
    ],
    correctAnswer: 1,
    explanation: {
