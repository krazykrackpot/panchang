...
export const GAURI_NAMES: Record<GauriType, LocaleText & {
  ...
  // The 8 Gauri period names are tatsama Sanskrit terms (अमृत, सिद्ध,
  // मरण, रोग, लाभ, धन, सुगम, शोक). All Indo-Aryan locales (hi/mai/mr/
  // gu/bn) borrow the Sanskrit form unchanged; only the script differs.
  // Dravidian forms keep the existing transliterations.
  amritha: {
    en: 'Amritha',
    hi: 'अमृत',
    sa: 'अमृतम्',
