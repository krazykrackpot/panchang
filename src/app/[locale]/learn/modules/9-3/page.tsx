        ...
        <div className="overflow-x-auto">
          <table className="w-full text-xs border-collapse">
            ...
            <tbody className="text-text-secondary">
              ...
              <tr className="border-b border-white/5"><td className="p-2">{tl({ en: 'Venus', hi: 'शुक्र', sa: 'शुक्रः' }, locale)}</td><td className="p-2">{tl({ en: 'Pisces', hi: 'मीन', sa: 'मीनः' }, locale)}</td><td className="p-2">27°</td><td className="p-2">Spiritual love = highest beauty</td></tr>
              ...
              <tr className="border-b border-white/5"><td className="p-2">{tl({ en: 'Rahu', hi: 'राहु', sa: 'राहुः' }, locale)}</td><td className="p-2">{tl({ en: 'Taurus', hi: 'वृषभ*', sa: 'वृषभ*' }, locale)}</td><td className="p-2">20°</td><td className="p-2">Material mastery (per BPHS)</td></tr>
              <tr><td className="p-2">{tl({ en: 'Ketu', hi: 'केतु', sa: 'केतुः' }, locale)}</td><td className="p-2">{tl({ en: 'Scorpio', hi: 'वृश्चिक*', sa: 'वृश्चिकः' }, locale)}</td><td className="p-2">20°</td><td className="p-2">Occult depth (per BPHS)</td></tr>
            </tbody>
          </table>
