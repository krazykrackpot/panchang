  ...
  return (
    <div className="space-y-6">
      <section>
        ...
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          वैदिक ज्योतिष में &quot;योग&quot; (शाब्दिक अर्थ &quot;संयोग&quot; या &quot;मिलन&quot;) एक विशिष्ट ग्रह विन्यास है जो निश्चित, पूर्वानुमेय फल उत्पन्न करता है। पश्चिमी ज्योतिष के विपरीत जो मुख्यतः व्यक्तिगत दृष्टियों (ग्रहों के बीच कोण) का विश्लेषण करता है, वैदिक योग ग्रहों के भाव स्वामित्व पर विचार करते हैं — लग्न के अनुसार ग्रह किन भावों का स्वामी है — जिससे समान ग्रह कोण भिन्न लग्नों के लिए पूर्णतः भिन्न फल देते हैं।
        </p>
      </section>

      <section className="glass-card rounded-xl p-5 border border-gold-primary/10">
        <h4 className="text-gold-dark text-[10px] uppercase tracking-widest font-bold mb-3">Major Yoga Categories / प्रमुख योग श्रेणियाँ</h4>
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Pancha Mahapurusha Yogas / पञ्च महापुरुष योग
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          The five &quot;Great Person&quot; yogas are among the most celebrated in Vedic astrology. Each is formed when one of the five true planets (Mars, Mercury, Jupiter, Venus, Saturn) occupies its own sign or exaltation sign in a Kendra house (1st, 4th, 7th, or 10th) from the Lagna or Moon. The Sun and Moon, being luminaries, do not form Mahapurusha Yogas. Rahu and Ketu, being shadow planets, are also excluded.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          पाँच &quot;महान व्यक्ति&quot; योग वैदिक ज्योतिष में सर्वाधिक प्रसिद्ध हैं। प्रत्येक तब बनता है जब पाँच सत्य ग्रहों (मंगल, बुध, गुरु, शुक्र, शनि) में से एक अपनी स्वराशि या उच्च राशि में लग्न या चन्द्र से केन्द्र भाव (1, 4, 7 या 10वें) में हो। सूर्य और चन्द्रमा ज्योति होने से महापुरुष योग नहीं बनाते। राहु और केतु छाया ग्रह होने से भी बहिष्कृत हैं।
        </p>
      </section>

      <section className="glass-card rounded-xl p-5 border border-red-500/15">
        <h4 className="text-red-400 text-[10px] uppercase tracking-widest font-bold mb-3">The Five Yogas / पाँच योग</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
      ...
      <section className="glass-card rounded-xl p-5 border border-amber-500/15">
        <h4 className="text-amber-400 text-[10px] uppercase tracking-widest font-bold mb-3">Conditions for Full Strength / पूर्ण बल की शर्तें</h4>
        <p className="text-text-secondary text-xs leading-relaxed">
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="glass-card rounded-xl p-5 border border-blue-500/15">
        <h4 className="text-blue-300 text-[10px] uppercase tracking-widest font-bold mb-3">Activation Principle / सक्रियण सिद्धान्त</h4>
        <p className="text-text-secondary text-xs leading-relaxed">
