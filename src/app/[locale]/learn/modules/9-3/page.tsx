          ...
          <table className="w-full text-xs border-collapse">
            <thead>
              <tr className="border-b border-white/10">
                <th className="text-gold-light text-left p-2">Planet / ग्रह</th>
                <th className="text-gold-light text-left p-2">Exalted In / उच्च</th>
                <th className="text-gold-light text-left p-2">Deep Exaltation / परम उच्च</th>
                <th className="text-gold-light text-left p-2">Why / कारण</th>
              </tr>
            </thead>
            <tbody className="text-text-secondary">
              <tr className="border-b border-white/5"><td className="p-2">Sun / सूर्य</td><td className="p-2">Aries / मेष</td><td className="p-2">10°</td><td className="p-2">Fire + initiative = peak authority</td></tr>
              <tr className="border-b border-white/5"><td className="p-2">Moon / चन्द्र</td><td className="p-2">Taurus / वृषभ</td><td className="p-2">3°</td><td className="p-2">Earth stability nourishes emotions</td></tr>
              <tr className="border-b border-white/5"><td className="p-2">Mars / मंगल</td><td className="p-2">Capricorn / मकर</td><td className="p-2">28°</td><td className="p-2">Discipline channels raw courage</td></tr>
              <tr className="border-b border-white/5"><td className="p-2">Mercury / बुध</td><td className="p-2">Virgo / कन्या</td><td className="p-2">15°</td><td className="p-2">Analytical sign perfects intellect</td></tr>
              <tr className="border-b border-white/5"><td className="p-2">Jupiter / बृहस्पति</td><td className="p-2">Cancer / कर्क</td><td className="p-2">5°</td><td className="p-2">Nurturing amplifies wisdom</td></tr>
              <tr className="border-b border-white/5"><td className="p-2">Venus / शुक्र</td><td className="p-2">Pisces / मीन</td><td className="p-2">27°</td><td className="p-2">Spiritual love = highest beauty</td></tr>
              <tr className="border-b border-white/5"><td className="p-2">Saturn / शनि</td><td className="p-2">Libra / तुला</td><td className="p-2">20°</td><td className="p-2">Justice + balance = ideal discipline</td></tr>
              <tr className="border-b border-white/5"><td className="p-2">Rahu / राहु</td><td className="p-2">Taurus / वृषभ*</td><td className="p-2">20°</td><td className="p-2">Material mastery (per BPHS)</td></tr>
              <tr><td className="p-2">Ketu / केतु</td><td className="p-2">Scorpio / वृश्चिक*</td><td className="p-2">20°</td><td className="p-2">Occult depth (per BPHS)</td></tr>
            </tbody>
          </table>
          <p className="text-text-tertiary text-[10px] mt-1">* Rahu/Ketu exaltation varies by tradition. Some use Gemini/Sagittarius. BPHS supports Taurus/Scorpio.</p>
          <p className="text-text-tertiary text-[10px]" style={{ fontFamily: 'var(--font-devanagari-body)' }}>* राहु/केतु का उच्च परम्परा अनुसार भिन्न है। कुछ मिथुन/धनु मानते हैं। BPHS वृषभ/वृश्चिक का समर्थन करता है।</p>
        </div>
      </section>

      <section className="glass-card rounded-xl p-5 border border-gold-primary/10">
        <h4 className="text-gold-dark text-[10px] uppercase tracking-widest font-bold mb-2">Classical Origin / शास्त्रीय उत्पत्ति</h4>
        <p className="text-text-secondary text-sm leading-relaxed mb-2">
          Exaltation degrees are listed in BPHS Chapter 3 (Shloka 51) and Phaladeepika Chapter 2. These specific sign-degree combinations have remained unchanged for over 2000 years across all Jyotish traditions. The deep exaltation degree is where the planet reaches absolute maximum potency — a planet at exactly 10° Aries Sun or 5° Cancer Jupiter is at its peak.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed" style={{ fontFamily: 'var(--font-devanagari-body)' }}>
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Debilitation (Neecha) and Its Cancellation / नीच और उसका भंग
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          The debilitation sign is exactly opposite (180°) from exaltation. Here the planet is weakened — it struggles to express its natural qualities. Sun debilitated in Libra loses its decisive authority in the sign of compromise. Mars debilitated in Cancer cannot channel aggression productively in the emotional, nurturing environment.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3" style={{ fontFamily: 'var(--font-devanagari-body)' }}>
          नीच राशि उच्च से ठीक विपरीत (180°) होती है। यहाँ ग्रह दुर्बल होता है — अपने स्वाभाविक गुणों को व्यक्त करने में संघर्ष करता है। तुला में नीच सूर्य समझौते की राशि में अपना निर्णायक अधिकार खो देता है। कर्क में नीच मंगल भावनात्मक, पोषण वातावरण में आक्रामकता को उत्पादक रूप से प्रवाहित नहीं कर पाता।
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
        ...
        <div className="space-y-1.5 text-xs text-text-secondary mb-3">
          <p>1. The lord of the debilitation sign is in a Kendra from Lagna or Moon</p>
          ...
          <p>5. The debilitated planet is conjoined with an exalted planet</p>
        </div>
        <div className="space-y-1.5 text-xs text-text-secondary" style={{ fontFamily: 'var(--font-devanagari-body)' }}>
          <p>1. नीच राशि का स्वामी लग्न या चन्द्र से केन्द्र में हो</p>
          ...
          <p>5. नीच ग्रह किसी उच्च ग्रह से युक्त हो</p>
        </div>
      </section>

      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">Worked Example: Neecha Bhanga / कार्यान्वित उदाहरण: नीचभंग</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Example:</span> Jupiter is debilitated in Capricorn in the 7th house. Capricorn is ruled by Saturn. If Saturn is placed in a Kendra (say, the 10th house in Aries), condition 1 is met — Neecha Bhanga occurs. The initially weak Jupiter transforms into a powerful force. The native may initially face relationship challenges (debilitated 7th house Jupiter), but ultimately achieves an exceptionally meaningful partnership after overcoming early obstacles.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed" style={{ fontFamily: 'var(--font-devanagari-body)' }}>
          <span className="text-gold-light font-medium">उदाहरण:</span> बृहस्पति मकर में नीच, सप्तम भाव में। मकर का स्वामी शनि है। यदि शनि केन्द्र में हो (मान लें, दशम भाव में मेष में), तो शर्त 1 पूरी होती है — नीचभंग होता है। प्रारम्भ में दुर्बल बृहस्पति शक्तिशाली बल में बदल जाता है। जातक को प्रारम्भ में संबंधों में चुनौतियाँ हो सकती हैं (नीच सप्तम भाव बृहस्पति), लेकिन अंततः प्रारम्भिक बाधाओं को पार करके एक असाधारण अर्थपूर्ण साझेदारी प्राप्त करता है।
        </p>
      </section>
...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Own Sign, Moolatrikona, and the Full Hierarchy / स्वराशि, मूलत्रिकोण, और पूर्ण क्रम
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          Between the extremes of exaltation and debilitation lie five intermediate dignity levels. A planet in its <strong className="text-gold-light">own sign (Swakshetra)</strong> is like being at home — comfortable, productive, self-sufficient. Mars in Aries or Scorpio, Venus in Taurus or Libra, Jupiter in Sagittarius or Pisces are all in their own signs. A planet in its <strong className="text-gold-light">Moolatrikona</strong> sign is at its &quot;office&quot; — the sign where it performs its most essential function with focused efficiency. This is slightly stronger than own sign.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3" style={{ fontFamily: 'var(--font-devanagari-body)' }}>
          उच्च और नीच के चरम बिन्दुओं के बीच पाँच मध्यवर्ती गरिमा स्तर हैं। <strong className="text-gold-light">स्वराशि (स्वक्षेत्र)</strong> में ग्रह घर पर होने जैसा है — सुविधाजनक, उत्पादक, आत्मनिर्भर। मेष या वृश्चिक में मंगल, वृषभ या तुला में शुक्र, धनु या मीन में बृहस्पति सभी स्वराशि में हैं। <strong className="text-gold-light">मूलत्रिकोण</strong> राशि में ग्रह अपने &quot;कार्यालय&quot; में है — वह राशि जहाँ वह अपना सबसे आवश्यक कार्य केन्द्रित दक्षता से करता है। यह स्वराशि से थोड़ा अधिक शक्तिशाली है।
        </p>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-xs border-collapse">
            <thead>
              <tr className="border-b border-white/10">
                <th className="text-gold-light text-left p-2">Planet / ग्रह</th>
                <th className="text-gold-light text-left p-2">Moolatrikona / मूलत्रिकोण</th>
                <th className="text-gold-light text-left p-2">Own Signs / स्वराशि</th>
              </tr>
            </thead>
            <tbody className="text-text-secondary">
              <tr className="border-b border-white/5"><td className="p-2">Sun / सूर्य</td><td className="p-2">Leo 0°-20°</td><td className="p-2">Leo / सिंह</td></tr>
              <tr className="border-b border-white/5"><td className="p-2">Moon / चन्द्र</td><td className="p-2">Taurus 4°-20°</td><td className="p-2">Cancer / कर्क</td></tr>
              <tr className="border-b border-white/5"><td className="p-2">Mars / मंगल</td><td className="p-2">Aries 0°-12°</td><td className="p-2">Aries, Scorpio / मेष, वृश्चिक</td></tr>
              <tr className="border-b border-white/5"><td className="p-2">Mercury / बुध</td><td className="p-2">Virgo 16°-20°</td><td className="p-2">Gemini, Virgo / मिथुन, कन्या</td></tr>
              <tr className="border-b border-white/5"><td className="p-2">Jupiter / बृहस्पति</td><td className="p-2">Sagittarius 0°-10°</td><td className="p-2">Sagittarius, Pisces / धनु, मीन</td></tr>
              <tr className="border-b border-white/5"><td className="p-2">Venus / शुक्र</td><td className="p-2">Libra 0°-15°</td><td className="p-2">Taurus, Libra / वृषभ, तुला</td></tr>
              <tr><td className="p-2">Saturn / शनि</td><td className="p-2">Aquarius 0°-20°</td><td className="p-2">Capricorn, Aquarius / मकर, कुम्भ</td></tr>
            </tbody>
          </table>
        </div>
      </section>
      ...
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3 mt-4" style={{ fontFamily: 'var(--font-heading)' }}>
          Friend and Enemy Signs / मित्र और शत्रु राशियाँ
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          Planets have natural friendships and enmities. Jupiter and Sun are friends — Jupiter in Leo (Sun&apos;s sign) is comfortable. Venus and Sun are enemies — Venus in Leo is uneasy. The <strong className="text-gold-light">Panchadha Maitri</strong> (five-fold relationship) system from BPHS defines: intimate friend, friend, neutral, enemy, bitter enemy. These modify the dignity: a planet in a friendly sign is more effective than in an enemy sign, even if neither is exalted or debilitated.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed" style={{ fontFamily: 'var(--font-devanagari-body)' }}>
          ग्रहों की प्राकृतिक मित्रता और शत्रुता होती है। बृहस्पति और सूर्य मित्र हैं — सिंह (सूर्य की राशि) में बृहस्पति सुविधाजनक है। शुक्र और सूर्य शत्रु हैं — सिंह में शुक्र असहज है। BPHS का <strong className="text-gold-light">पंचधा मैत्री</strong> (पाँच-स्तरीय संबंध) प्रणाली परिभाषित करती है: अधि मित्र, मित्र, सम, शत्रु, अधि शत्रु। ये गरिमा को संशोधित करती हैं: मित्र राशि में ग्रह शत्रु राशि की तुलना में अधिक प्रभावी होता है, भले ही कोई भी उच्च या नीच न हो।
        </p>
      </section>

      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">The Complete Hierarchy / पूर्ण गरिमा क्रम</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          From strongest to weakest: <strong className="text-gold-light">Exalted</strong> (planet at peak power) &gt; <strong className="text-gold-light">Moolatrikona</strong> (focused duty) &gt; <strong className="text-gold-light">Own Sign</strong> (comfortable) &gt; <strong className="text-gold-light">Friend&apos;s Sign</strong> (welcome guest) &gt; <strong className="text-gold-light">Neutral Sign</strong> (indifferent) &gt; <strong className="text-gold-light">Enemy&apos;s Sign</strong> (unwelcome guest) &gt; <strong className="text-gold-light">Debilitated</strong> (planet at weakest).
        </p>
        <p className="text-text-secondary text-xs leading-relaxed" style={{ fontFamily: 'var(--font-devanagari-body)' }}>
          शक्तिशाली से कमजोर: <strong className="text-gold-light">उच्च</strong> (ग्रह शिखर शक्ति पर) &gt; <strong className="text-gold-light">मूलत्रिकोण</strong> (केन्द्रित कर्तव्य) &gt; <strong className="text-gold-light">स्वराशि</strong> (सुविधाजनक) &gt; <strong className="text-gold-light">मित्र राशि</strong> (स्वागत अतिथि) &gt; <strong className="text-gold-light">सम राशि</strong> (उदासीन) &gt; <strong className="text-gold-light">शत्रु राशि</strong> (अस्वागत अतिथि) &gt; <strong className="text-gold-light">नीच</strong> (ग्रह सबसे कमजोर)।
        </p>
      </section>
      ...
      <section className="glass-card rounded-xl p-5 border border-blue-500/15">
        ...
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          Our Kundali engine automatically evaluates every planet&apos;s dignity in your chart. The tippanni commentary identifies exalted and debilitated planets, checks for Neecha Bhanga conditions, and explains how dignity affects each planet&apos;s ability to deliver results in its house. This is integrated into the Shadbala strength assessment for a complete picture of planetary power.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed" style={{ fontFamily: 'var(--font-devanagari-body)' }}>
          हमारा कुण्डली इंजन स्वचालित रूप से आपकी कुण्डली में प्रत्येक ग्रह की गरिमा का मूल्यांकन करता है। टिप्पणी उच्च और नीच ग्रहों की पहचान करती है, नीचभंग शर्तों की जाँच करती है, और समझाती है कि गरिमा प्रत्येक ग्रह की अपने भाव में फल देने की क्षमता को कैसे प्रभावित करती है। यह षड्बल शक्ति मूल्यांकन में एकीकृत है।
        </p>
      </section>
    </div>
  );
