...
export const alt = 'Generate Your Vedic Birth Chart — Dekho Panchang';
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        {/* Title */}
        <div style={{ fontSize: 56, fontWeight: 800, color: '#f0d48a', letterSpacing: -1, marginBottom: 16, display: 'flex' }}>
          Generate Your Vedic Birth Chart
        </div>

        {/* Subtitle */}
        <div style={{ fontSize: 26, color: '#8a8478', letterSpacing: 1, display: 'flex' }}>
          Free Kundali with Dashas, Yogas &amp; AI Reading
        </div>
