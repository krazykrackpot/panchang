    ...
    <div className="space-y-6">
      <section>
        ...
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          Mangal Dosha (also called Kuja Dosha or Manglik) is the most commonly discussed dosha in Indian marriage astrology. It forms when Mars (Mangal) is placed in the 1st, 2nd, 4th, 7th, 8th, or 12th house from the Lagna, Moon sign, or Venus. These six houses directly relate to marriage and domestic life — self (1st), family (2nd), domestic peace (4th), spouse (7th), marital longevity (8th), and bed pleasures (12th). Mars&apos;s fiery, aggressive energy in these sensitive houses can create conflict, dominance issues, or physical dangers in marriage.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          मंगल दोष (कुज दोष या माँगलिक भी कहा जाता है) भारतीय विवाह ज्योतिष में सर्वाधिक चर्चित दोष है। यह तब बनता है जब मंगल लग्न, चन्द्र राशि या शुक्र से 1ले, 2रे, 4थे, 7वें, 8वें या 12वें भाव में हो। ये छह भाव विवाह और गृहस्थ जीवन से सीधे सम्बन्धित हैं — स्वयं (1ला), परिवार (2रा), गृह शान्ति (4था), जीवनसाथी (7वाँ), वैवाहिक आयु (8वाँ) और शय्या सुख (12वाँ)। इन संवेदनशील भावों में मंगल की अग्नि, आक्रामक ऊर्जा विवाह में संघर्ष, प्रभुत्व समस्याएँ या शारीरिक खतरे बना सकती है।
        </p>
      </section>

      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">6 Cancellation Conditions / 6 निवारण शर्तें</h4>
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Kala Sarpa Dosha / काल सर्प दोष
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          Kala Sarpa Dosha (literally &quot;serpent of time&quot;) forms when all seven visible planets (Sun, Moon, Mars, Mercury, Jupiter, Venus, Saturn) are contained on one side of the Rahu-Ketu axis. Imagine the birth chart as a circle divided by the Rahu-Ketu line — if all planets fall on one half, the other half is completely empty. This creates an intense concentration of energy and a corresponding void, producing a life of extremes — periods of remarkable achievement alternating with inexplicable setbacks.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          काल सर्प दोष (शाब्दिक &quot;काल का सर्प&quot;) तब बनता है जब सभी सात दृश्य ग्रह (सूर्य, चन्द्र, मंगल, बुध, गुरु, शुक्र, शनि) राहु-केतु अक्ष के एक ओर हों। कल्पना करें कि जन्म कुण्डली राहु-केतु रेखा द्वारा विभाजित वृत्त है — यदि सभी ग्रह एक आधे में हों तो दूसरा आधा पूर्णतः खाली है। इससे ऊर्जा का तीव्र केन्द्रीकरण और तदनुरूपी शून्य बनता है, जो चरम का जीवन उत्पन्न करता है — उल्लेखनीय उपलब्धियों और अकथनीय विपत्तियों का आवर्तन।
        </p>
      </section>

      <section className="glass-card rounded-xl p-5 border border-gold-primary/10">
        <h4 className="text-gold-dark text-[10px] uppercase tracking-widest font-bold mb-3">Partial vs Complete / आंशिक बनाम पूर्ण</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Complete Kala Sarpa:</span> All 7 planets strictly between Rahu and Ketu with no planet conjunct either node. This is the full-strength dosha. Effects include career-relationship imbalance, sudden reversals of fortune, and a feeling of being caught in a karmic loop.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">पूर्ण काल सर्प:</span> सभी 7 ग्रह राहु और केतु के बीच सख्ती से हों, कोई ग्रह किसी पात के साथ संयुक्त न हो। यह पूर्ण बल का दोष है। प्रभावों में करियर-सम्बन्ध असन्तुलन, भाग्य का अचानक पलटना और कार्मिक चक्र में फँसे होने का अनुभव सम्मिलित है।
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
      ...
      <section className="glass-card rounded-xl p-5 border border-purple-500/15">
        <h4 className="text-purple-300 text-[10px] uppercase tracking-widest font-bold mb-3">Effects on Life / जीवन पर प्रभाव</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="glass-card rounded-xl p-5 border border-red-500/15">
        <h4 className="text-red-400 text-[10px] uppercase tracking-widest font-bold mb-3">Guru Chandal & Shrapit / गुरु चाण्डाल एवं शापित</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Guru Chandal (Jupiter + Rahu):</span> Corrupts wisdom and dharmic sense. The native may follow false gurus, hold unorthodox or misguided beliefs, or face problems with teachers and mentors. Remedies: strengthen Jupiter with yellow sapphire, recite Guru (Brihaspati) mantras, and donate to educational institutions.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">गुरु चाण्डाल (गुरु + राहु):</span> ज्ञान और धार्मिक बोध को दूषित करता है। जातक गलत गुरुओं का अनुसरण कर सकता है, अपरम्परागत या भ्रामक मान्यताएँ रख सकता है, या शिक्षकों और मार्गदर्शकों से समस्याएँ झेल सकता है।
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Shrapit Dosha (Saturn + Rahu):</span> Creates inexplicable blocks and delays. The native may feel cursed or chronically unlucky in the house where this conjunction falls. Past-life debts create present-life obstacles. Remedies: Saturn mantras, Rahu pacification, feeding the poor on Saturdays, and Hanuman worship.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">शापित दोष (शनि + राहु):</span> अकथनीय अवरोध और विलम्ब बनाता है। जातक को जिस भाव में यह संयोग हो वहाँ शापित या दीर्घकालिक दुर्भाग्यशाली अनुभव हो सकता है। पूर्वजन्म ऋण वर्तमान जीवन में बाधाएँ बनाते हैं।
        </p>
      </section>

      <section className="glass-card rounded-xl p-5 border border-amber-500/15">
        <h4 className="text-amber-400 text-[10px] uppercase tracking-widest font-bold mb-3">The Remedial Principle / उपचार सिद्धान्त</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          Doshas reveal karmic patterns — not punishments. The principle behind remedies is threefold: (1) <span className="text-gold-light font-medium">Strengthen the weak:</span> Gemstones and mantras for benefic planets that can counteract the dosha. (2) <span className="text-gold-light font-medium">Pacify the afflicting:</span> Charity, fasting, and mantras for the malefic planet causing the dosha. (3) <span className="text-gold-light font-medium">Conscious awareness:</span> Understanding the pattern allows you to make different choices — the chart is a map, not a prison.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          दोष कार्मिक प्रतिमान प्रकट करते हैं — दण्ड नहीं। उपचार सिद्धान्त त्रिविध है: (1) <span className="text-gold-light font-medium">कमजोर को मजबूत करें:</span> दोष प्रतिकार करने वाले शुभ ग्रहों के लिए रत्न और मन्त्र। (2) <span className="text-gold-light font-medium">पीड़ित को शान्त करें:</span> दोष कारक पापी ग्रह के लिए दान, उपवास और मन्त्र। (3) <span className="text-gold-light font-medium">सचेत जागरूकता:</span> प्रतिमान समझना भिन्न चयन करने देता है — कुण्डली मानचित्र है, बन्दीगृह नहीं।
        </p>
      </section>
    </div>
  );
