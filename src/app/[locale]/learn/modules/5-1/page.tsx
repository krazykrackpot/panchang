...
function Page1() {
  return (
    <div className="space-y-6">
      ...
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Why Tithis Vary in Length / तिथियों की अवधि भिन्न क्यों होती है
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Tithi Deities, Natures & Auspiciousness / तिथि देवता, स्वभाव एवं शुभत्व
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        ...
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Example 1:</span> A couple wishes to choose a wedding date. Dwitiya (Bhadra group, ruled by Brahma the creator) and Panchami (Purna group) are excellent choices. If both fall in Shukla Paksha with a favorable nakshatra, the muhurta is exceptionally strong. Rikta tithis like Chaturthi or Navami would be avoided entirely for marriage.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">उदाहरण 1:</span> एक दम्पति विवाह तिथि चुनना चाहता है। द्वितीया (भद्रा समूह, ब्रह्मा शासित) और पंचमी (पूर्णा समूह) उत्तम विकल्प हैं। यदि दोनों शुक्ल पक्ष में अनुकूल नक्षत्र के साथ आएँ तो मुहूर्त अत्यन्त बलवान होता है। चतुर्थी या नवमी जैसी रिक्ता तिथियाँ विवाह हेतु पूर्णतया वर्जित हैं।
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Example 2:</span> Ekadashi (11th, Nanda group, ruled by Vishnu) is the premier fasting tithi. Devotees observe Nirjala (waterless) Ekadashi in Jyeshtha month. Since Ekadashi occurs in both pakshas, there are 24 Ekadashis per year, each with unique significance and name.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">उदाहरण 2:</span> एकादशी (11वीं, नन्दा समूह, विष्णु शासित) प्रमुख उपवास तिथि है। भक्त ज्येष्ठ मास में निर्जला (जलरहित) एकादशी का पालन करते हैं। चूँकि एकादशी दोनों पक्षों में आती है, वर्ष में 24 एकादशियाँ होती हैं, प्रत्येक का अपना विशिष्ट महत्त्व और नाम है।
        </p>
      </section>
      ...
      <section className="glass-card rounded-xl p-5 border border-red-500/15">
        ...
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">भ्रान्ति:</span> "अमावस्या सदैव अशुभ और पूर्णिमा सदैव शुभ होती है।" वास्तव में अमावस्या पितृ कर्म, तान्त्रिक साधना और गहन ध्यान के लिए अत्यन्त शुभ मानी जाती है। दीपावली जैसे अनेक शक्तिशाली त्योहार अमावस्या पर पड़ते हैं। इसी प्रकार पूर्णिमा सर्वत्र शुभ नहीं — गोपनीयता या एकान्तवास चाहने वाले कार्यों के लिए अमावस्या अधिक उपयुक्त है।
        </p>
      </section>
...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Tithi Calculation Method / तिथि गणना विधि
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Tithi at Sunrise & the Dwi-Tithi Rule / सूर्योदय की तिथि एवं द्वि-तिथि नियम
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
      ...
      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">Worked Examples / कार्यान्वित उदाहरण</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Calculation:</span> At sunrise, Moon = 220.5 degrees, Sun = 15.3 degrees. Elongation = 220.5 - 15.3 = 205.2 degrees. Tithi = floor(205.2 / 12) + 1 = floor(17.1) + 1 = 17 + 1 = 18. This is Krishna Paksha Tritiya (the 3rd tithi of the dark half: 15 + 3 = 18th overall).
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">गणना:</span> सूर्योदय पर चन्द्र = 220.5 अंश, सूर्य = 15.3 अंश। कोणीय दूरी = 220.5 - 15.3 = 205.2 अंश। तिथि = floor(205.2 / 12) + 1 = floor(17.1) + 1 = 17 + 1 = 18। यह कृष्ण पक्ष तृतीया है (कृष्ण पक्ष की 3री तिथि: 15 + 3 = कुल 18वीं)।
        </p>
      </section>
      ...
      <section className="glass-card rounded-xl p-5 border border-red-500/15">
        ...
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">भ्रान्ति:</span> "क्षय तिथि का अर्थ है कि वह तिथि अस्तित्व में ही नहीं आई।" क्षय का अर्थ मात्र इतना है कि वह तिथि दो सूर्योदयों के बीच आरम्भ और समाप्त हो गई, अतः कोई भी दिन उसके नाम पर नहीं रखा जाता। खगोलीय रूप से वह तिथि अवश्य घटित हुई — वह इतनी लघु थी कि किसी सूर्योदय पर उपस्थित न रह सकी। क्षय तिथियाँ दुर्लभ (वर्ष में कुछ ही) होती हैं और उनके त्योहार दायित्व सामान्यतः निकटवर्ती तिथि पर स्थानान्तरित हो जाते हैं।
        </p>
      </section>
