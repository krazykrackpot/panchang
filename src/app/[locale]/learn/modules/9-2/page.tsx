    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          The 12 Houses: A Map of Life / 12 भाव: जीवन का नक्शा
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          The 12 houses (Bhavas) divide the sky into 12 sectors, each governing a specific domain of human experience. From birth to death, from wealth to liberation, every aspect of life finds its place in one of these houses. Understanding the houses is the first step in reading any chart.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3" style={{ fontFamily: 'var(--font-devanagari-body)' }}>
          12 भाव आकाश को 12 खण्डों में विभाजित करते हैं, प्रत्येक मानव अनुभव के एक विशिष्ट क्षेत्र पर शासन करता है। जन्म से मृत्यु तक, धन से मोक्ष तक, जीवन का हर पहलू इन भावों में से किसी एक में अपना स्थान पाता है। भावों को समझना किसी भी कुण्डली पढ़ने का पहला कदम है।
        </p>
        ...
        <div className="grid grid-cols-2 gap-2 text-xs">
          {[
            ...
            <div key={h.n} className="glass-card rounded-lg p-2.5 border border-white/5">
              <span className="text-gold-light font-bold">{h.n}</span> <span className="text-gold-dark">({h.name})</span>
              <span className="text-text-tertiary ml-1" style={{ fontFamily: 'var(--font-devanagari-body)' }}>{h.hi}</span>
              <p className="text-text-tertiary mt-0.5">{h.desc}</p>
              <p className="text-text-tertiary mt-0.5" style={{ fontFamily: 'var(--font-devanagari-body)' }}>{h.hiDesc}</p>
            </div>
          ))}
        </div>
      </section>
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          House Classifications / भाव वर्गीकरण
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          Houses are grouped into functional categories that determine how their lords behave in the chart. This classification is crucial — a planet ruling a Trikona house is inherently auspicious, while a planet ruling a Dusthana house carries challenges. These groupings form the foundation of yogas (planetary combinations).
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3" style={{ fontFamily: 'var(--font-devanagari-body)' }}>
          भावों को कार्यात्मक श्रेणियों में बाँटा जाता है जो निर्धारित करती हैं कि उनके स्वामी कुण्डली में कैसा व्यवहार करते हैं। यह वर्गीकरण अत्यंत महत्वपूर्ण है — त्रिकोण भाव का स्वामी स्वभावतः शुभ होता है, जबकि दुःस्थान भाव का स्वामी चुनौतियाँ लाता है। ये समूह योगों (ग्रह संयोजन) का आधार बनाते हैं।
        </p>
        ...
        <div className="space-y-3">
          <div className="glass-card rounded-lg p-3 border border-gold-primary/10">
            ...
            <p className="text-text-secondary text-xs mt-1">The four angular houses form the structural backbone. They represent the four pillars of life: self, home, relationships, career. Planets in Kendras gain Kendra Bala (angular strength). Benefics in Kendras uplift the entire chart.</p>
            <p className="text-text-secondary text-xs mt-1" style={{ fontFamily: 'var(--font-devanagari-body)' }}>चार कोणीय भाव संरचनात्मक रीढ़ हैं। ये जीवन के चार स्तम्भ दर्शाते हैं: आत्म, गृह, संबंध, कर्म। केन्द्र में ग्रह केन्द्र बल प्राप्त करते हैं। केन्द्र में शुभ ग्रह पूरी कुण्डली को उन्नत करते हैं।</p>
          </div>
          ...
          <div className="glass-card rounded-lg p-3 border border-red-500/10">
            ...
            <p className="text-text-secondary text-xs mt-1">These houses deal with obstacles, but also transformation. The 6th gives the ability to overcome enemies and disease through effort. The 8th transforms through crisis and grants hidden knowledge. The 12th dissolves ego and opens the path to moksha. Natural malefics can actually thrive here.</p>
            <p className="text-text-secondary text-xs mt-1" style={{ fontFamily: 'var(--font-devanagari-body)' }}>ये भाव बाधाओं से जुड़े हैं, लेकिन परिवर्तन से भी। षष्ठ प्रयास से शत्रुओं और रोग पर विजय देता है। अष्टम संकट से परिवर्तित करता है और गुप्त ज्ञान प्रदान करता है। द्वादश अहंकार को विलीन करके मोक्ष का मार्ग खोलता है। प्राकृतिक पापग्रह यहाँ वास्तव में अच्छा प्रदर्शन कर सकते हैं।</p>
          </div>
          <div className="glass-card rounded-lg p-3 border border-blue-500/10">
            ...
            <p className="text-text-secondary text-xs mt-1">Results in these houses improve with age and effort. Malefic planets (Sun, Mars, Saturn, Rahu) placed here become productive — they channel their aggressive energy into courage (3rd), defeating competition (6th), career ambition (10th), and material gains (11th).</p>
            <p className="text-text-secondary text-xs mt-1" style={{ fontFamily: 'var(--font-devanagari-body)' }}>इन भावों में परिणाम आयु और प्रयास के साथ सुधरते हैं। पापग्रह (सूर्य, मंगल, शनि, राहु) यहाँ स्थित होकर उत्पादक बनते हैं — वे अपनी आक्रामक ऊर्जा को साहस (तृतीय), प्रतिस्पर्धा पर विजय (षष्ठ), कर्म महत्वाकांक्षा (दशम), और भौतिक लाभ (एकादश) में प्रवाहित करते हैं।</p>
          </div>
        </div>
      </section>

      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">Why Kendra + Trikona = Raja Yoga / केन्द्र + त्रिकोण = राजयोग क्यों</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          Kendras represent Vishnu (sustaining power) and Trikonas represent Lakshmi (fortune, grace). When their lords come together — by conjunction, mutual aspect, or sign exchange — the union of power and fortune creates Raja Yoga, literally &quot;royal combination.&quot; This is the single most important yoga principle in Parashari Jyotish.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed" style={{ fontFamily: 'var(--font-devanagari-body)' }}>
          केन्द्र विष्णु (धारण शक्ति) और त्रिकोण लक्ष्मी (भाग्य, कृपा) का प्रतिनिधित्व करते हैं। जब उनके स्वामी एक साथ आते हैं — युति, परस्पर दृष्टि, या राशि परिवर्तन से — शक्ति और भाग्य का मिलन राजयोग बनाता है, अर्थात &quot;राजसी संयोजन।&quot; यह पाराशरी ज्योतिष का सबसे महत्वपूर्ण योग सिद्धांत है।
        </p>
      </section>
    </div>
  );
...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          House Lords — Who Owns Which House? / भाव स्वामी — किस भाव का मालिक कौन?
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          Every house is &quot;owned&quot; by the planet that rules the sign occupying it. For example, if Aries falls in the 5th house, Mars rules the 5th house. If Libra falls in the 11th house, Venus rules the 11th. The house lord carries the house&apos;s significations wherever it goes — if the 5th lord goes to the 10th house, children/creativity (5th) merges with career (10th), perhaps indicating a career in education, entertainment, or work involving children.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3" style={{ fontFamily: 'var(--font-devanagari-body)' }}>
          प्रत्येक भाव का &quot;स्वामी&quot; वह ग्रह है जो उसमें स्थित राशि का शासक है। उदाहरण के लिए, यदि मेष पंचम भाव में है, तो मंगल पंचम भाव का स्वामी है। यदि तुला एकादश भाव में है, तो शुक्र एकादश का स्वामी है। भाव स्वामी जहाँ भी जाता है वहाँ भाव की सूचकताएँ ले जाता है — यदि पंचम स्वामी दशम भाव में जाता है, तो संतान/रचनात्मकता (पंचम) कर्म (दशम) से मिलता है, शायद शिक्षा, मनोरंजन, या बच्चों से जुड़े कार्य में कैरियर।
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          Key principle: <strong className="text-gold-light">The lord of the 1st house placed in the 10th house</strong> = the self (1st) directed toward career and public life (10th) — a natural leader. <strong className="text-gold-light">The lord of the 7th in the 12th</strong> = marriage (7th) connecting to foreign lands (12th) — often a foreign spouse or settling abroad after marriage. <strong className="text-gold-light">The lord of the 9th in the 5th</strong> = father&apos;s fortune (9th) flowing to children/education (5th) — privileged upbringing, strong higher education.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed" style={{ fontFamily: 'var(--font-devanagari-body)' }}>
          मुख्य सिद्धांत: <strong className="text-gold-light">प्रथम भाव स्वामी दशम में</strong> = आत्म (प्रथम) कर्म और सार्वजनिक जीवन (दशम) की ओर — स्वाभाविक नेता। <strong className="text-gold-light">सप्तम स्वामी द्वादश में</strong> = विवाह (सप्तम) का विदेश (द्वादश) से संबंध — अक्सर विदेशी जीवनसाथी या विवाह के बाद विदेश बसना। <strong className="text-gold-light">नवम स्वामी पंचम में</strong> = पिता का भाग्य (नवम) संतान/शिक्षा (पंचम) की ओर — सौभाग्यशाली पालन-पोषण, सशक्त उच्च शिक्षा।
        </p>
      </section>

      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">Worked Examples / कार्यान्वित उदाहरण</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Aries Lagna:</span> Mars owns both the 1st (Aries) and 8th (Scorpio). Venus owns the 2nd (Taurus) and 7th (Libra). Jupiter owns the 9th (Sagittarius) and 12th (Pisces). Here, Jupiter as 9th lord is the most benefic planet — if it aspects the Lagna or sits in a Kendra, it uplifts the entire chart.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed mb-2" style={{ fontFamily: 'var(--font-devanagari-body)' }}>
          <span className="text-gold-light font-medium">मेष लग्न:</span> मंगल प्रथम (मेष) और अष्टम (वृश्चिक) दोनों का स्वामी है। शुक्र द्वितीय (वृषभ) और सप्तम (तुला) का स्वामी है। बृहस्पति नवम (धनु) और द्वादश (मीन) का स्वामी है। यहाँ बृहस्पति नवम स्वामी के रूप में सर्वाधिक शुभ ग्रह है — यदि यह लग्न पर दृष्टि डाले या केन्द्र में बैठे, तो पूरी कुण्डली उन्नत होती है।
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">Cancer Lagna:</span> Moon rules the 1st, Sun rules the 2nd, Mars rules the 5th and 10th (hence Mars forms Raja Yoga for Cancer Lagna as it rules both a Trikona and a Kendra). Jupiter rules the 6th and 9th. Saturn rules the 7th and 8th (a Maraka planet — potential harm).
        </p>
        <p className="text-text-secondary text-xs leading-relaxed" style={{ fontFamily: 'var(--font-devanagari-body)' }}>
          <span className="text-gold-light font-medium">कर्क लग्न:</span> चन्द्र प्रथम, सूर्य द्वितीय, मंगल पंचम और दशम का स्वामी है (अतः मंगल कर्क लग्न के लिए राजयोगकारक है क्योंकि यह त्रिकोण और केन्द्र दोनों का स्वामी है)। बृहस्पति षष्ठ और नवम का स्वामी है। शनि सप्तम और अष्टम का स्वामी है (मारक ग्रह — संभावित हानि)।
        </p>
      </section>
      ...
      <section className="glass-card rounded-xl p-5 border border-blue-500/15">
        ...
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          Our Kundali engine automatically calculates house lords for every chart based on the Lagna sign and the Equal House system. The tippanni (interpretive commentary) analyzes each house lord&apos;s placement, identifying yogas, evaluating strength, and providing life-area predictions. You can generate your chart and see exactly which planet rules each house in your life.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed" style={{ fontFamily: 'var(--font-devanagari-body)' }}>
          हमारा कुण्डली इंजन लग्न राशि और समभाव पद्धति के आधार पर प्रत्येक कुण्डली के भाव स्वामियों की स्वचालित गणना करता है। टिप्पणी (व्याख्यात्मक भाष्य) प्रत्येक भाव स्वामी की स्थिति का विश्लेषण करती है, योगों की पहचान करती है, शक्ति का मूल्यांकन करती है, और जीवन-क्षेत्र भविष्यवाणियाँ प्रदान करती है।
        </p>
      </section>
    </div>
  );
