...
const ASTRONOMERS: Astronomer[] = [
  {
    ...
    achievements: [
      { en: 'Declared Earth rotates on its axis — 1,044 years before Copernicus', hi: 'घोषणा की कि पृथ्वी अपनी धुरी पर घूमती है — कॉपरनिकस से 1,044 वर्ष पूर्व', sa: 'घोषणा की कि पृथ्वी अपनी धुरी पर घूमती है — कॉपरनिकस से 1,044 वर्ष पूर्व', mai: 'घोषणा की कि पृथ्वी अपनी धुरी पर घूमती है — कॉपरनिकस से 1,044 वर्ष पूर्व', mr: 'घोषणा की कि पृथ्वी अपनी धुरी पर घूमती है — कॉपरनिकस से 1,044 वर्ष पूर्व', ta: 'பூமி தன் அச்சில் சுழல்கிறது என்று அறிவித்தார் — கோபர்நிக்கசுக்கு 1,044 ஆண்டுகளுக்கு முன்பு', te: 'భూమి తన అక్షం చుట్టూ తిరుగుతుందని ప్రకటించారు — కోపర్నికస్ కంటే 1,044 సంవత్సరాల ముందు', bn: 'পৃথিবী নিজ অক্ষে ঘোরে বলে ঘোষণা করেন — কোপার্নিকাসের ১,০৪৪ বছর আগে', kn: 'ಭೂಮಿ ತನ್ನ ಅಕ್ಷದ ಮೇಲೆ ತಿರುಗುತ್ತದೆ ಎಂದು ಘೋಷಿಸಿದರು — ಕೋಪರ್ನಿಕಸ್‌ಗಿಂತ 1,044 ವರ್ಷ ಮೊದಲು', gu: 'પૃથ્વી પોતાની ધરી પર ફરે છે તેવું જાહેર કર્યું — કોપરનિકસના 1,044 વર્ષ પહેલાં' },
      ...
      { en: 'Created the first sine tables (ardha-jya) — the word "sine" IS Sanskrit', hi: 'प्रथम ज्या सारणी बनाई (अर्ध-ज्या) — "sine" शब्द संस्कृत से ही आया है', sa: 'प्रथम ज्या सारणी बनाई (अर्ध-ज्या) — "sine" शब्द संस्कृत से ही आया है', mai: 'प्रथम ज्या सारणी बनाई (अर्ध-ज्या) — "sine" शब्द संस्कृत से ही आया है', mr: 'प्रथम ज्या सारणी बनाई (अर्ध-ज्या) — "sine" शब्द संस्कृत से ही आया है', ta: 'முதல் சைன் அட்டவணைகளை (அர்த்த-ஜ்யா) உருவாக்கினார் — "sine" என்ற சொல் சமஸ்கிருதமே', te: 'మొదటి సైన్ పట్టికలను (అర్ధ-జ్యా) సృష్టించారు — "sine" అనే పదం సంస్కృతమే', bn: 'প্রথম সাইন টেবিল (অর্ধ-জ্যা) তৈরি করেন — "sine" শব্দটি সংস্কৃত থেকেই এসেছে', kn: 'ಮೊದಲ ಸೈನ್ ಕೋಷ್ಟಕಗಳನ್ನು (ಅರ್ಧ-ಜ್ಯಾ) ರಚಿಸಿದರು — "sine" ಪದವು ಸಂಸ್ಕೃತವೇ', gu: 'પ્રથમ સાઈન ટેબલ (અર્ધ-જ્યા) બનાવ્યા — "sine" શબ્દ સંસ્કૃત જ છે' },
      { en: 'Pi = 3.1416 — most accurate ancient value. Wrote Aryabhatiya at age 23.', hi: 'पाई = 3.1416 — प्राचीन विश्व का सबसे सटीक मान। 23 वर्ष की आयु में आर्यभटीय लिखी।', sa: 'पाई = 3.1416 — प्राचीन विश्व का सबसे सटीक मान। 23 वर्ष की आयु में आर्यभटीय लिखी।', mai: 'पाई = 3.1416 — प्राचीन विश्व का सबसे सटीक मान। 23 वर्ष की आयु में आर्यभटीय लिखी।', mr: 'पाई = 3.1416 — प्राचीन विश्व का सबसे सटीक मान। 23 वर्ष की आयु में आर्यभटीय लिखी।', ta: 'π = 3.1416 — பழங்காலத்தின் மிகத் துல்லியமான மதிப்பு. 23 வயதில் ஆர்யபடீயம் எழுதினார்.', te: 'π = 3.1416 — ప్రాచీన కాలపు అత్యంత ఖచ్చితమైన విలువ. 23 ఏళ్ల వయసులో ఆర్యభటీయం రాశారు.', bn: 'π = ৩.১৪১৬ — প্রাচীনকালের সবচেয়ে সঠিক মান। ২৩ বছর বয়সে আর্যভটীয় লিখেছিলেন।', kn: 'π = 3.1416 — ಪ್ರಾಚೀನ ಕಾಲದ ಅತ್ಯಂತ ನಿಖರ ಮೌಲ್ಯ. 23ನೇ ವಯಸ್ಸಿನಲ್ಲಿ ಆರ್ಯಭಟೀಯ ಬರೆದರು.', gu: 'π = 3.1416 — પ્રાચીન સમયનું સૌથી ચોક્કસ મૂલ્ય. 23 વર્ષની ઉંમરે આર્યભટીય લખ્યું.' },
  ...
  },
  {
    ...
    achievements: [
      { en: 'Pancha Siddhantika — compared and synthesized 5 astronomical systems', hi: 'पञ्चसिद्धान्तिका — 5 खगोलीय प्रणालियों की तुलना और संश्लेषण', sa: 'पञ्चसिद्धान्तिका — 5 खगोलीय प्रणालियों की तुलना और संश्लेषण', mai: 'पञ्चसिद्धान्तिका — 5 खगोलीय प्रणालियों की तुलना और संश्लेषण', mr: 'पञ्चसिद्धान्तिका — 5 खगोलीय प्रणालियों की तुलना और संश्लेषण', ta: 'பஞ்ச சித்தாந்திகா — 5 வானியல் அமைப்புகளை ஒப்பிட்டு ஒருங்கிணைத்தார்', te: 'పంచ సిద్ధాంతిక — 5 ఖగోళ వ్యవస్థలను పోల్చి సంశ్లేషించారు', bn: 'পঞ্চ সিদ্ধান্তিকা — ৫টি জ্যোতির্বিদ্যা পদ্ধতির তুলনা ও সংশ্লেষণ', kn: 'ಪಂಚ ಸಿದ್ಧಾಂತಿಕಾ — 5 ಖಗೋಳ ವ್ಯವಸ್ಥೆಗಳನ್ನು ಹೋಲಿಸಿ ಸಂಶ್ಲೇಷಿಸಿದರು', gu: 'પંચ સિદ્ધાંતિકા — 5 ખગોળીય પદ્ધતિઓની સરખામણી અને સંશ્લેષણ' },
      { en: 'Brihat Samhita — an encyclopedia covering astronomy, weather, architecture, gems, agriculture', hi: 'बृहत्संहिता — खगोल, मौसम, वास्तु, रत्न, कृषि का विश्वकोश', sa: 'बृहत्संहिता — खगोल, मौसम, वास्तु, रत्न, कृषि का विश्वकोश', mai: 'बृहत्संहिता — खगोल, मौसम, वास्तु, रत्न, कृषि का विश्वकोश', mr: 'बृहत्संहिता — खगोल, मौसम, वास्तु, रत्न, कृषि का विश्वकोश', ta: 'பிருஹத் சம்ஹிதா — வானியல், வானிலை, கட்டிடக்கலை, ரத்தினங்கள், விவசாயம் உள்ளிட்ட கலைக்களஞ்சியம்', te: 'బృహత్ సంహిత — ఖగోళశాస్త్రం, వాతావరణం, వాస్తుశిల్పం, రత్నాలు, వ్యవసాయం కవర్ చేసే విజ్ఞానసర్వస్వం', bn: 'বৃহৎ সংহিতা — জ্যোতির্বিদ্যা, আবহাওয়া, স্থাপত্য, রত্ন, কৃষি সম্পর্কিত বিশ্বকোষ', kn: 'ಬೃಹತ್ ಸಂಹಿತಾ — ಖಗೋಳ, ಹವಾಮಾನ, ವಾಸ್ತುಶಿಲ್ಪ, ರತ್ನ, ಕೃಷಿ ಒಳಗೊಂಡ ವಿಶ್ವಕೋಶ', gu: 'બૃહત્ સંહિતા — ખગોળવિદ્યા, હવામાન, સ્થાપત્ય, રત્ન, કૃષિ સમાવતો જ્ઞાનકોશ' },
      { en: 'Brihat Jataka — the foundational text of predictive Jyotish still studied today', hi: 'बृहज्जातक — भविष्यवाणी ज्योतिष का मूल ग्रन्थ जो आज भी अध्ययन किया जाता है', sa: 'बृहज्जातक — भविष्यवाणी ज्योतिष का मूल ग्रन्थ जो आज भी अध्ययन किया जाता है', mai: 'बृहज्जातक — भविष्यवाणी ज्योतिष का मूल ग्रन्थ जो आज भी अध्ययन किया जाता है', mr: 'बृहज्जातक — भविष्यवाणी ज्योतिष का मूल ग्रन्थ जो आज भी अध्ययन किया जाता है', ta: 'பிருஹத் ஜாதகம் — இன்றும் படிக்கப்படும் ஜோதிட கணிப்பின் அடிப்படை நூல்', te: 'బృహజ్జాతకం — నేటికీ అధ్యయనం చేయబడే ఫలిత జ్యోతిషం యొక్క మూల గ్రంథం', bn: 'বৃহৎ জাতক — ফলিত জ্যোতিষের ভিত্তি গ্রন্থ যা আজও অধ্যয়ন করা হয়', kn: 'ಬೃಹಜ್ಜಾತಕ — ಇಂದಿಗೂ ಅಧ್ಯಯನ ಮಾಡಲಾಗುತ್ತಿರುವ ಫಲಿತ ಜ್ಯೋತಿಷದ ಮೂಲ ಗ್ರಂಥ', gu: 'બૃહજ્જાતક — ફલિત જ્યોતિષનો આધારભૂત ગ્રંથ જે આજે પણ અભ્યાસ થાય છે' },
  ...
  },
  {
    ...
    achievements: [
      ...
      { en: 'Brahmasphutasiddhanta (628 CE) — calculated lunar and solar eclipse durations', hi: 'ब्राह्मस्फुटसिद्धान्त (628 ई.) — चन्द्र और सूर्य ग्रहण की अवधि गणना', sa: 'ब्राह्मस्फुटसिद्धान्त (628 ई.) — चन्द्र और सूर्य ग्रहण की अवधि गणना', mai: 'ब्राह्मस्फुटसिद्धान्त (628 ई.) — चन्द्र और सूर्य ग्रहण की अवधि गणना', mr: 'ब्राह्मस्फुटसिद्धान्त (628 ई.) — चन्द्र और सूर्य ग्रहण की अवधि गणना', ta: 'பிரம்மஸ்புடசித்தாந்தம் (கி.பி. 628) — சந்திர மற்றும் சூரிய கிரகண காலங்களைக் கணக்கிட்டார்', te: 'బ్రహ్మస్ఫుటసిద్ధాంతం (క్రీ.శ. 628) — చంద్ర మరియు సూర్య గ్రహణ కాలాలను లెక్కించారు', bn: 'ব্রহ্মস্ফুটসিদ্ধান্ত (৬২৮ খ্রি.) — চন্দ্র ও সূর্যগ্রহণের সময়কাল গণনা করেন', kn: 'ಬ್ರಹ್ಮಸ್ಫುಟಸಿದ್ಧಾಂತ (ಕ್ರಿ.ಶ. 628) — ಚಂದ್ರ ಮತ್ತು ಸೂರ್ಯಗ್ರಹಣ ಅವಧಿಗಳನ್ನು ಲೆಕ್ಕ ಹಾಕಿದರು', gu: 'બ્રહ્મસ્ફુટસિદ્ધાંત (ઈ.સ. 628) — ચંદ્ર અને સૂર્યગ્રહણની અવધિ ગણતરી કરી' },
  ...
  },
  {
    ...
    achievements: [
      { en: 'Siddhanta Shiromani — contained calculus-like concepts (derivatives, differentials) 500 years before Newton', hi: 'सिद्धान्त शिरोमणि — न्यूटन से 500 वर्ष पहले कलनशास्त्र जैसी अवधारणाएँ', sa: 'सिद्धान्त शिरोमणि — न्यूटन से 500 वर्ष पहले कलनशास्त्र जैसी अवधारणाएँ', mai: 'सिद्धान्त शिरोमणि — न्यूटन से 500 वर्ष पहले कलनशास्त्र जैसी अवधारणाएँ', mr: 'सिद्धान्त शिरोमणि — न्यूटन से 500 वर्ष पहले कलनशास्त्र जैसी अवधारणाएँ', ta: 'சித்தாந்த சிரோமணி — நியூட்டனுக்கு 500 ஆண்டுகளுக்கு முன்பே கால்குலஸ் போன்ற கருத்துகளை (வகையீடுகள், வேறுபாடுகள்) உள்ளடக்கியது', te: 'సిద్ధాంత శిరోమణి — న్యూటన్ కంటే 500 సంవత్సరాల ముందే కాలిక్యులస్ వంటి భావనలు (అవకలనాలు, భేదాలు) కలిగి ఉంది', bn: 'সিদ্ধান্ত শিরোমণি — নিউটনের ৫০০ বছর আগেই ক্যালকুলাসের ধারণা (ডেরিভেটিভ, ডিফারেনশিয়াল) ধারণ করেছিল', kn: 'ಸಿದ್ಧಾಂತ ಶಿರೋಮಣಿ — ನ್ಯೂಟನ್‌ಗಿಂತ 500 ವರ್ಷ ಮೊದಲೇ ಕ್ಯಾಲ್ಕುಲಸ್ ತರಹದ ಪರಿಕಲ್ಪನೆಗಳನ್ನು (ಉತ್ಪನ್ನ, ವ್ಯತ್ಯಾಸ) ಒಳಗೊಂಡಿತ್ತು', gu: 'સિદ્ધાંત શિરોમણિ — ન્યૂટન કરતાં 500 વર્ષ પહેલાં કેલ્ક્યુલસ જેવી વિભાવનાઓ (ડેરિવેટિવ, ડિફરન્શિયલ) ધરાવતો' },
      { en: 'Calculated the sidereal year as 365.2588 days — accurate to 3.5 minutes', hi: 'नाक्षत्रिक वर्ष 365.2588 दिन आँका — 3.5 मिनट तक सटीक', sa: 'नाक्षत्रिक वर्ष 365.2588 दिन आँका — 3.5 मिनट तक सटीक', mai: 'नाक्षत्रिक वर्ष 365.2588 दिन आँका — 3.5 मिनट तक सटीक', mr: 'नाक्षत्रिक वर्ष 365.2588 दिन आँका — 3.5 मिनट तक सटीक', ta: 'நாட்சத்திர வருடத்தை 365.2588 நாட்களாகக் கணக்கிட்டார் — 3.5 நிமிடங்களுக்குத் துல்லியம்', te: 'నాక్షత్ర సంవత్సరాన్ని 365.2588 రోజులుగా లెక్కించారు — 3.5 నిమిషాల ఖచ్చితత్వం', bn: 'নাক্ষত্র বর্ষ ৩৬৫.২৫৮৮ দিন হিসাবে গণনা করেন — ৩.৫ মিনিট নির্ভুল', kn: 'ನಾಕ್ಷತ್ರಿಕ ವರ್ಷವನ್ನು 365.2588 ದಿನಗಳೆಂದು ಲೆಕ್ಕ ಹಾಕಿದರು — 3.5 ನಿಮಿಷಗಳ ನಿಖರತೆ', gu: 'નાક્ષત્ર વર્ષ 365.2588 દિવસ ગણતરી કર્યું — 3.5 મિનિટ ચોક્કસ' },
      ...
      { en: 'His Lilavati (mathematics) and Bijaganita (algebra) — named after his daughter', hi: 'लीलावती (गणित) और बीजगणित — अपनी पुत्री के नाम पर', sa: 'लीलावती (गणित) और बीजगणित — अपनी पुत्री के नाम पर', mai: 'लीलावती (गणित) और बीजगणित — अपनी पुत्री के नाम पर', mr: 'लीलावती (गणित) और बीजगणित — अपनी पुत्री के नाम पर', ta: 'அவரது லீலாவதி (கணிதம்) மற்றும் பீஜகணிதம் (இயற்கணிதம்) — அவரது மகளின் பெயரில் பெயரிடப்பட்டது', te: 'అతని లీలావతి (గణితం) మరియు బీజగణితం (ఆల్జీబ్రా) — అతని కుమార్తె పేరు మీద', bn: 'তাঁর লীলাবতী (গণিত) ও বীজগণিত (অ্যালজেব্রা) — তাঁর কন্যার নামে নামকরণ', kn: 'ಅವರ ಲೀಲಾವತಿ (ಗಣಿತ) ಮತ್ತು ಬೀಜಗಣಿತ (ಆಲ್ಜೀಬ್ರಾ) — ಅವರ ಮಗಳ ಹೆಸರಿನಲ್ಲಿ', gu: 'તેમની લીલાવતી (ગણિત) અને બીજગણિત (આલ્જેબ્રા) — તેમની પુત્રીના નામ પરથી' },
    ],
  },
  {
    ...
    achievements: [
      { en: 'Founded the Kerala School of mathematics — 300 years before European calculus', hi: 'केरल गणित सम्प्रदाय की स्थापना — यूरोपीय कलनशास्त्र से 300 वर्ष पूर्व', sa: 'केरल गणित सम्प्रदाय की स्थापना — यूरोपीय कलनशास्त्र से 300 वर्ष पूर्व', mai: 'केरल गणित सम्प्रदाय की स्थापना — यूरोपीय कलनशास्त्र से 300 वर्ष पूर्व', mr: 'केरल गणित सम्प्रदाय की स्थापना — यूरोपीय कलनशास्त्र से 300 वर्ष पूर्व', ta: 'கேரள கணிதப் பள்ளியை நிறுவினார் — ஐரோப்பிய கால்குலஸுக்கு 300 ஆண்டுகளுக்கு முன்பு', te: 'కేరళ గణిత పాఠశాలను స్థాపించారు — యూరోపియన్ కాలిక్యులస్ కంటే 300 సంవత్సరాల ముందు', bn: 'কেরল গণিত বিদ্যালয় প্রতিষ্ঠা করেন — ইউরোপীয় ক্যালকুলাসের ৩০০ বছর আগে', kn: 'ಕೇರಳ ಗಣಿತ ಶಾಲೆಯನ್ನು ಸ್ಥಾಪಿಸಿದರು — ಯುರೋಪಿಯನ್ ಕ್ಯಾಲ್ಕುಲಸ್‌ಗಿಂತ 300 ವರ್ಷ ಮೊದಲು', gu: 'કેરળ ગણિત શાળાની સ્થાપના કરી — યુરોપિયન કેલ્ક્યુલસના 300 વર્ષ પહેલાં' },
      ...
      { en: 'Taylor series expansions — three centuries before Brook Taylor', hi: 'टेलर श्रेणी प्रसार — ब्रुक टेलर से तीन शताब्दी पहले', sa: 'टेलर श्रेणी प्रसार — ब्रुक टेलर से तीन शताब्दी पहले', mai: 'टेलर श्रेणी प्रसार — ब्रुक टेलर से तीन शताब्दी पहले', mr: 'टेलर श्रेणी प्रसार — ब्रुक टेलर से तीन शताब्दी पहले', ta: 'டெய்லர் தொடர் விரிவாக்கங்கள் — புரூக் டெய்லருக்கு மூன்று நூற்றாண்டுகளுக்கு முன்பு', te: 'టేలర్ శ్రేణి విస్తరణలు — బ్రూక్ టేలర్ కంటే మూడు శతాబ్దాల ముందు', bn: 'টেলর সিরিজ সম্প্রসারণ — ব্রুক টেলরের তিন শতাব্দী আগে', kn: 'ಟೇಲರ್ ಸರಣಿ ವಿಸ್ತರಣೆಗಳು — ಬ್ರೂಕ್ ಟೇಲರ್‌ಗಿಂತ ಮೂರು ಶತಮಾನ ಮೊದಲು', gu: 'ટેલર શ્રેણી વિસ્તરણ — બ્રૂક ટેલરના ત્રણ સદી પહેલાં' },
    ],
  },
  {
    ...
    achievements: [
      { en: 'Tantrasangraha (1501 CE) — semi-heliocentric model: all planets orbit the Sun, Sun orbits Earth', hi: 'तन्त्रसंग्रह (1501 ई.) — अर्ध-सूर्यकेन्द्रित मॉडल: सभी ग्रह सूर्य की, सूर्य पृथ्वी की परिक्रमा', sa: 'तन्त्रसंग्रह (1501 ई.) — अर्ध-सूर्यकेन्द्रित मॉडल: सभी ग्रह सूर्य की, सूर्य पृथ्वी की परिक्रमा', mai: 'तन्त्रसंग्रह (1501 ई.) — अर्ध-सूर्यकेन्द्रित मॉडल: सभी ग्रह सूर्य की, सूर्य पृथ्वी की परिक्रमा', mr: 'तन्त्रसंग्रह (1501 ई.) — अर्ध-सूर्यकेन्द्रित मॉडल: सभी ग्रह सूर्य की, सूर्य पृथ्वी की परिक्रमा', ta: 'தந்திரசங்கிரகம் (கி.பி. 1501) — அரை சூரிய மைய மாதிரி: அனைத்து கிரகங்களும் சூரியனைச் சுற்றுகின்றன, சூரியன் பூமியைச் சுற்றுகிறது', te: 'తంత్రసంగ్రహం (క్రీ.శ. 1501) — అర్ధ సూర్యకేంద్ర నమూనా: అన్ని గ్రహాలు సూర్యుని చుట్టూ, సూర్యుడు భూమి చుట్టూ తిరుగుతాడు', bn: 'তন্ত্রসংগ্রহ (১৫০১ খ্রি.) — আংশিক সূর্যকেন্দ্রিক মডেল: সব গ্রহ সূর্যকে প্রদক্ষিণ করে, সূর্য পৃথিবীকে প্রদক্ষিণ করে', kn: 'ತಂತ್ರಸಂಗ್ರಹ (ಕ್ರಿ.ಶ. 1501) — ಅರ್ಧ ಸೂರ್ಯಕೇಂದ್ರ ಮಾದರಿ: ಎಲ್ಲ ಗ್ರಹಗಳು ಸೂರ್ಯನ ಸುತ್ತ, ಸೂರ್ಯ ಭೂಮಿಯ ಸುತ್ತ ಸುತ್ತುತ್ತಾನೆ', gu: 'તંત્રસંગ્રહ (ઈ.સ. 1501) — અર્ધ સૂર્યકેન્દ્રી મોડેલ: બધા ગ્રહો સૂર્યની ફરતે, સૂર્ય પૃથ્વીની ફરતે ફરે છે' },
            ...
            {[
              {
                ...
                detail: { en: 'Aryabhata, Brahmagupta, Bhaskara — decimal system, zero, algebra, trigonometry, astronomy', hi: 'आर्यभट, ब्रह्मगुप्त, भास्कर — दशमलव, शून्य, बीजगणित, त्रिकोणमिति, खगोल', sa: 'आर्यभट, ब्रह्मगुप्त, भास्कर — दशमलव, शून्य, बीजगणित, त्रिकोणमिति, खगोल', mai: 'आर्यभट, ब्रह्मगुप्त, भास्कर — दशमलव, शून्य, बीजगणित, त्रिकोणमिति, खगोल', mr: 'आर्यभट, ब्रह्मगुप्त, भास्कर — दशमलव, शून्य, बीजगणित, त्रिकोणमिति, खगोल', ta: 'ஆர்யபடர், பிரம்மகுப்தர், பாஸ்கரர் — தசம முறை, பூஜ்ஜியம், இயற்கணிதம், முக்கோணமிதி, வானியல்', te: 'ఆర్యభట, బ్రహ్మగుప్తుడు, భాస్కరుడు — దశాంశ పద్ధతి, సున్నా, బీజగణితం, త్రికోణమితి, ఖగోళశాస్త్రం', bn: 'আর্যভট, ব্রহ্মগুপ্ত, ভাস্কর — দশমিক পদ্ধতি, শূন্য, বীজগণিত, ত্রিকোণমিতি, জ্যোতির্বিদ্যা', kn: 'ಆರ್ಯಭಟ, ಬ್ರಹ್ಮಗುಪ್ತ, ಭಾಸ್ಕರ — ದಶಮಾಂಶ ಪದ್ಧತಿ, ಶೂನ್ಯ, ಬೀಜಗಣಿತ, ತ್ರಿಕೋಣಮಿತಿ, ಖಗೋಳಶಾಸ್ತ್ರ', gu: 'આર્યભટ, બ્રહ્મગુપ્ત, ભાસ્કર — દશાંશ પદ્ધતિ, શૂન્ય, બીજગણિત, ત્રિકોણમિતિ, ખગોળવિદ્યા' },
              ...
              },
              {
                ...
                detail: { en: 'Al-Khwarizmi learned from Indian texts — his name gave us "algorithm." Al-Biruni (1030 CE) traveled to India, wrote Tarikh al-Hind.', hi: 'अल-ख़्वारिज़्मी ने भारतीय ग्रन्थों से सीखा — उनके नाम से "algorithm" बना। अल-बिरूनी (1030 ई.) ने भारत यात्रा की, तारीख़-उल-हिन्द लिखी।', sa: 'अल-ख़्वारिज़्मी ने भारतीय ग्रन्थों से सीखा — उनके नाम से "algorithm" बना। अल-बिरूनी (1030 ई.) ने भारत यात्रा की, तारीख़-उल-हिन्द लिखी।', mai: 'अल-ख़्वारिज़्मी ने भारतीय ग्रन्थों से सीखा — उनके नाम से "algorithm" बना। अल-बिरूनी (1030 ई.) ने भारत यात्रा की, तारीख़-उल-हिन्द लिखी।', mr: 'अल-ख़्वारिज़्मी ने भारतीय ग्रन्थों से सीखा — उनके नाम से "algorithm" बना। अल-बिरूनी (1030 ई.) ने भारत यात्रा की, तारीख़-उल-हिन्द लिखी।', ta: 'அல்-குவாரிஸ்மி இந்திய நூல்களிலிருந்து கற்றார் — அவரது பெயரே "algorithm" என்ற சொல்லைத் தந்தது. அல்-பிரூனி (கி.பி. 1030) இந்தியா பயணித்து தாரிக் அல்-ஹிந்த் எழுதினார்.', te: 'అల్-ఖ్వారిజ్మీ భారతీయ గ్రంథాల నుండి నేర్చుకున్నాడు — అతని పేరే "algorithm" పదాన్ని ఇచ్చింది. అల్-బిరూనీ (క్రీ.శ. 1030) భారతదేశం ప్రయాణించి తారీఖ్ అల్-హింద్ రాశాడు.', bn: 'আল-খোয়ারিজমি ভারতীয় গ্রন্থ থেকে শিখেছিলেন — তাঁর নাম "algorithm" শব্দ দিয়েছে। আল-বিরুনি (১০৩০ খ্রি.) ভারতে এসে তারিখ আল-হিন্দ লিখেছিলেন।', kn: 'ಅಲ್-ಖ್ವಾರಿಜ್ಮಿ ಭಾರತೀಯ ಗ್ರಂಥಗಳಿಂದ ಕಲಿತರು — ಅವರ ಹೆಸರೇ "algorithm" ಪದವನ್ನು ನೀಡಿತು. ಅಲ್-ಬಿರೂನಿ (ಕ್ರಿ.ಶ. 1030) ಭಾರತಕ್ಕೆ ಪ್ರಯಾಣಿಸಿ ತಾರೀಖ್ ಅಲ್-ಹಿಂದ್ ಬರೆದರು.', gu: 'અલ-ખ્વારિઝ્મીએ ભારતીય ગ્રંથોમાંથી શીખ્યા — તેમના નામે "algorithm" શબ્દ આપ્યો. અલ-બિરૂની (ઈ.સ. 1030) ભારત પ્રવાસ કરી તારીખ અલ-હિંદ લખ્યું.' },
