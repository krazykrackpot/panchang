// src/lib/kundali/health-diagnosis/__tests__/elements/nervous.test.ts
//
// Task B6 — nervous element scorer tests.
//
...
import { scoreNervous } from '../../elements/nervous';
...
const result = scoreNervous(kundali, strength, signatures, 'en');

describe('scoreNervous', () => {
  ...
  it('returns correct metadata matching ELEMENT_CATALOG[nervous]', () => {
    const meta = ELEMENT_CATALOG['nervous'];
    expect(result.id).toBe('nervous');
