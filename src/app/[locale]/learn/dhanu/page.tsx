  ...
  return (
    <main className="max-w-4xl mx-auto px-4 sm:px-6 pt-28 pb-16">
      ...
      <LessonSection number={next()} title={ml({ en: 'Health & Body', hi: 'स्वास्थ्य एवं शरीर' })}>
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-bg-primary/50 rounded-lg border border-gold-primary/10 p-3">
            ...
            <p className="text-text-primary text-sm mt-1" style={bf}>{ml({ en: 'Hips, thighs, liver, gallbladder, sciatic nerve, arterial system (lower body), hip joints', hi: 'कूल्हे, जाँघें, यकृत, पित्ताशय, कटि स्नायु, धमनी तन्त्र (निचला शरीर), कूल्हे जोड़' })}</p>
          </div>
          <div className="bg-bg-primary/50 rounded-lg border border-gold-primary/10 p-3">
            <span className="text-gold-dark text-xs uppercase tracking-wider">{ml({ en: 'Ayurvedic Constitution', hi: 'आयुर्वेदिक प्रकृति' })}</span>
            <p className="text-text-primary text-sm mt-1" style={bf}>{ml({ en: 'Pitta-Kapha combination. Moderation is key — favour bitter liver-supporting foods. Avoid excess fats, sweets, and alcohol. Outdoor expansive exercise ideal. Regular fasting recommended.', hi: 'पित्त-कफ संयोजन। संयम कुंजी — कड़वे यकृत-सहायक आहार अनुकूल। अतिरिक्त वसा, मिठाई और मद्य वर्जित। बाहरी विस्तृत व्यायाम आदर्श। नियमित उपवास अनुशंसित।' })}</p>
          </div>
        </div>
      </LessonSection>
      ...
      <LessonSection number={next()} title={ml({ en: 'Practical Application', hi: 'व्यावहारिक अनुप्रयोग' })}>
        ...
        <WhyItMatters locale={locale}>
          {ml({ en: 'Reading Dhanu in a chart reveals where the native seeks meaning, growth, and higher truth. The house where Sagittarius falls is where you need freedom to explore, where optimism is your greatest asset, and where you must learn that the deepest wisdom is sometimes found not by travelling further but by going deeper where you already stand.', hi: 'कुण्डली में धनु पढ़ना बताता है कि जातक कहाँ अर्थ, विकास और उच्च सत्य खोजता है। जिस भाव में धनु पड़ता है वहाँ अन्वेषण की स्वतन्त्रता चाहिए, आशावाद सबसे बड़ी सम्पत्ति है, और सीखना है कि गहनतम ज्ञान कभी-कभी आगे यात्रा से नहीं बल्कि जहाँ खड़े हैं वहीं गहरे जाने से मिलता है।' })}
        </WhyItMatters>
      </LessonSection>

      {/* ── 12. Dhanu as House Cusp ── */}
      <LessonSection number={next()} title={ml({ en: 'Dhanu as House Cusp', hi: 'भाव शिखर के रूप में धनु' })}>
        <p style={bf} className="mb-3">{ml({ en: 'When Dhanu falls on different house cusps, it brings Jupiter\'s expansive, philosophical, and dharma-oriented energy to that life domain. Here is how Sagittarius colours each house:', hi: 'जब धनु विभिन्न भाव शिखरों पर पड़ता है, तो वह उस जीवन क्षेत्र में गुरु की विस्तारशील, दार्शनिक और धर्म-उन्मुख ऊर्जा लाता है। यहाँ धनु प्रत्येक भाव को कैसे रंगता है:' })}</p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {[
            { house: '1st', effect: { en: 'Jupiter-ruled personality — optimistic, philosophical, large-framed, generous. Natural teacher and guide. Restless desire for growth and exploration defines the life path.', hi: 'गुरु शासित व्यक्तित्व — आशावादी, दार्शनिक, बड़ी काया, उदार। स्वाभाविक शिक्षक और मार्गदर्शक। विकास और अन्वेषण की बेचैन इच्छा जीवन पथ परिभाषित।' } },
            { house: '2nd', effect: { en: 'Wealth through teaching, law, religion, and wisdom professions. Generous and philosophical speech. Family values centred on education and dharma. Expansive attitude toward money — earns well but spends freely.', hi: 'शिक्षण, कानून, धर्म और ज्ञान व्यवसायों से धन। उदार और दार्शनिक वाणी। शिक्षा और धर्म केन्द्रित पारिवारिक मूल्य। धन के प्रति विस्तारशील दृष्टिकोण।' } },
            { house: '3rd', effect: { en: 'Philosophical and inspiring communication. Writing about higher knowledge, law, or spirituality. Adventurous short travels. Siblings may be in education or spiritual fields.', hi: 'दार्शनिक और प्रेरक संवाद। उच्च ज्ञान, कानून या अध्यात्म पर लेखन। साहसिक लघु यात्राएँ। भाई-बहन शिक्षा या आध्यात्मिक क्षेत्रों में।' } },
            { house: '4th', effect: { en: 'Spacious, library-filled home. Mother is wise and philosophical. Property in expansive locations. Emotional security from connection to dharma and higher learning.', hi: 'विशाल, पुस्तकालय-युक्त गृह। माता ज्ञानी और दार्शनिक। विस्तृत स्थानों पर सम्पत्ति। धर्म और उच्च शिक्षा से भावनात्मक सुरक्षा।' } },
            { house: '5th', effect: { en: 'Creative expression through teaching and philosophical writing. Romantic idealism — seeking the perfect partner. Children are wise beyond their years. Speculation favours bold, faith-based moves.', hi: 'शिक्षण और दार्शनिक लेखन से सृजनात्मक अभिव्यक्ति। रोमांटिक आदर्शवाद। सन्तान उम्र से अधिक बुद्धिमान। सट्टा विश्वास-आधारित साहसिक कदमों का पक्षधर।' } },
            { house: '6th', effect: { en: 'Liver and hip health concerns. Enemies are foreign or from different philosophical backgrounds. Service in education, law, or religious institutions. Overcomes obstacles through faith and optimism.', hi: 'यकृत और कूल्हे स्वास्थ्य चिन्ताएँ। शत्रु विदेशी या भिन्न दार्शनिक पृष्ठभूमि। शिक्षा, कानून या धार्मिक संस्थानों में सेवा। विश्वास और आशावाद से बाधाएँ दूर।' } },
            { house: '7th', effect: { en: 'Spouse is philosophical, optimistic, possibly foreign. Marriage expands worldview and brings wisdom. Business partnerships in education, law, or international trade. Partner brings cultural richness.', hi: 'जीवनसाथी दार्शनिक, आशावादी, सम्भवतः विदेशी। विवाह विश्वदृष्टि विस्तारित करता है। शिक्षा, कानून या अन्तरराष्ट्रीय व्यापार में साझेदारी। साथी सांस्कृतिक समृद्धि लाता है।' } },
            { house: '8th', effect: { en: 'Transformation through philosophical crisis and spiritual awakening. Inheritance from teachers or religious institutions. Interest in comparative religion and life after death. Long life through faith and optimism.', hi: 'दार्शनिक संकट और आध्यात्मिक जागरण से रूपान्तरण। शिक्षकों या धार्मिक संस्थानों से विरासत। तुलनात्मक धर्म और मृत्यु के बाद जीवन में रुचि। विश्वास से दीर्घायु।' } },
            { house: '9th', effect: { en: 'Sagittarius in its natural house — exceptional dharmic strength. Born teacher, philosopher, and spiritual guide. Fortune through wisdom and higher education. Long foreign pilgrimages. Father is a guiding light.', hi: 'धनु अपने स्वाभाविक भाव में — असाधारण धार्मिक शक्ति। जन्मजात शिक्षक, दार्शनिक और आध्यात्मिक मार्गदर्शक। ज्ञान और उच्च शिक्षा से भाग्य। लम्बी विदेशी तीर्थयात्राएँ। पिता मार्गदर्शक प्रकाश।' } },
            { house: '10th', effect: { en: 'Career in education, law, publishing, religion, international relations, or philosophy. Public reputation for wisdom and moral authority. Career involves expanding horizons and teaching others.', hi: 'शिक्षा, कानून, प्रकाशन, धर्म, अन्तरराष्ट्रीय सम्बन्ध या दर्शन में करियर। ज्ञान और नैतिक अधिकार की सार्वजनिक प्रतिष्ठा। करियर क्षितिज विस्तार और दूसरों को पढ़ाना।' } },
            { house: '11th', effect: { en: 'Gains through philosophical, educational, and international networks. Friends are wise, multicultural, and inspiring. Aspirations involve large-scale educational and dharmic projects.', hi: 'दार्शनिक, शैक्षिक और अन्तरराष्ट्रीय नेटवर्क से लाभ। मित्र ज्ञानी, बहुसांस्कृतिक और प्रेरक। बड़े पैमाने पर शैक्षिक और धार्मिक परियोजनाओं की आकांक्षाएँ।' } },
            { house: '12th', effect: { en: 'Expenditure on pilgrimages, education, and foreign travel. Foreign residence in spiritual or educational centres. Spiritual growth through surrender to higher knowledge. Moksha potential when Jupiter is strong.', hi: 'तीर्थयात्रा, शिक्षा और विदेश यात्रा पर व्यय। आध्यात्मिक या शैक्षिक केन्द्रों पर विदेशी निवास। उच्च ज्ञान के समर्पण से आध्यात्मिक विकास। बली गुरु में मोक्ष सम्भावना।' } },
          ].map((item, i) => (
