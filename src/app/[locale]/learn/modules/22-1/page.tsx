...
const QUESTIONS: ModuleQuestion[] = [
  {
    ...
    options: [
      { en: 'January 1, 1 CE', hi: '1 जनवरी, 1 ई.', sa: '1 जनवरी, 1 ई.', mai: '1 जनवरी, 1 ई.', mr: '1 जनवरी, 1 ई.', ta: '1 ஜநவரீ, 1 ஈ.', te: '1 జనవరీ, 1 ఈ.', bn: '1 জনবরী, 1 ঈ.', kn: '1 ಜನವರೀ, 1 ಈ.', gu: '1 જનવરી, 1 ઈ.' },
      { en: 'January 1, 4713 BCE (noon UT)', hi: '1 जनवरी, 4713 ई.पू. (मध्याह्न UT)', sa: '1 जनवरी, 4713 ई.पू. (मध्याह्न UT)', mai: '1 जनवरी, 4713 ई.पू. (मध्याह्न UT)', mr: '1 जनवरी, 4713 ई.पू. (मध्याह्न UT)', ta: '1 ஜநவரீ, 4713 ஈ.பூ. (மध்யாஹ்ந UT)', te: '1 జనవరీ, 4713 ఈ.పూ. (మధ్యాహ్న UT)', bn: '1 জনবরী, 4713 ঈ.পূ. (মধ্যাহ্ন UT)', kn: '1 ಜನವರೀ, 4713 ಈ.ಪೂ. (ಮಧ್ಯಾಹ್ನ UT)', gu: '1 જનવરી, 4713 ઈ.પૂ. (મધ્યાહ્ન UT)' },
      { en: 'January 1, 2000 CE', hi: '1 जनवरी, 2000 ई.', sa: '1 जनवरी, 2000 ई.', mai: '1 जनवरी, 2000 ई.', mr: '1 जनवरी, 2000 ई.', ta: '1 ஜநவரீ, 2000 ஈ.', te: '1 జనవరీ, 2000 ఈ.', bn: '1 জনবরী, 2000 ঈ.', kn: '1 ಜನವರೀ, 2000 ಈ.', gu: '1 જનવરી, 2000 ઈ.' },
      { en: 'March 21, 0 CE (vernal equinox)', hi: '21 मार्च, 0 ई. (वसन्त विषुव)', sa: '21 मार्च, 0 ई. (वसन्त विषुव)', mai: '21 मार्च, 0 ई. (वसन्त विषुव)', mr: '21 मार्च, 0 ई. (वसन्त विषुव)', ta: '21 மார்ச, 0 ஈ. (வஸந்த விஷுவ)', te: '21 మార్చ, 0 ఈ. (వసన్త విషువ)', bn: '21 মার্চ, 0 ঈ. (বসন্ত বিষুব)', kn: '21 ಮಾರ್ಚ, 0 ಈ. (ವಸನ್ತ ವಿಷುವ)', gu: '21 માર્ચ, 0 ઈ. (વસન્ત વિષુવ)' },
    ],
    correctAnswer: 1,
    explanation: {
  ...
  },
  {
    ...
    options: [
      { en: 'To account for the Gregorian leap year correction', hi: 'ग्रेगोरियन अधिवर्ष सुधार के लिए', sa: 'ग्रेगोरियन अधिवर्ष सुधार के लिए', mai: 'ग्रेगोरियन अधिवर्ष सुधार के लिए', mr: 'ग्रेगोरियन अधिवर्ष सुधार के लिए', ta: 'க்ரேகோரியந அधிவர்ஷ ஸுधார கே லிஎ', te: 'గ్రేగోరియన అధివర్ష సుధార కే లిఏ', bn: 'গ্রেগোরিযন অধিবর্ষ সুধার কে লিএ', kn: 'ಗ್ರೇಗೋರಿಯನ ಅಧಿವರ್ಷ ಸುಧಾರ ಕೇ ಲಿಏ', gu: 'ગ્રેગોરિયન અધિવર્ષ સુધાર કે લિએ' },
      { en: 'Because the Roman calendar originally started in March', hi: 'क्योंकि रोमन कैलेण्डर मूलतः मार्च से आरम्भ होता था', sa: 'क्योंकि रोमन कैलेण्डर मूलतः मार्च से आरम्भ होता था', mai: 'क्योंकि रोमन कैलेण्डर मूलतः मार्च से आरम्भ होता था', mr: 'क्योंकि रोमन कैलेण्डर मूलतः मार्च से आरम्भ होता था', ta: 'க்யோம்கி ரோமந கைலேண்டர மூலதஃ மார்ச ஸே ஆரம்भ ஹோதா थா', te: 'క్యోంకి రోమన కైలేణ్డర మూలతః మార్చ సే ఆరమ్భ హోతా థా', bn: 'ক্যোংকি রোমন কৈলেণ্ডর মূলতঃ মার্চ সে আরম্ভ হোতা থা', kn: 'ಕ್ಯೋಂಕಿ ರೋಮನ ಕೈಲೇಣ್ಡರ ಮೂಲತಃ ಮಾರ್ಚ ಸೇ ಆರಮ್ಭ ಹೋತಾ ಥಾ', gu: 'ક્યોંકિ રોમન કૈલેણ્ડર મૂલતઃ માર્ચ સે આરમ્ભ હોતા થા' },
      { en: 'To simplify the floor(30.6001 x (M+1)) term', hi: 'floor(30.6001 × (M+1)) पद को सरल बनाने के लिए', sa: 'floor(30.6001 × (M+1)) पद को सरल बनाने के लिए', mai: 'floor(30.6001 × (M+1)) पद को सरल बनाने के लिए', mr: 'floor(30.6001 × (M+1)) पद को सरल बनाने के लिए', ta: 'floor(30.6001 × (M+1)) பத கோ ஸரல பநாநே கே லிஎ', te: 'floor(30.6001 × (M+1)) పద కో సరల బనానే కే లిఏ', bn: 'floor(30.6001 × (M+1)) পদ কো সরল বনানে কে লিএ', kn: 'floor(30.6001 × (M+1)) ಪದ ಕೋ ಸರಲ ಬನಾನೇ ಕೇ ಲಿಏ', gu: 'floor(30.6001 × (M+1)) પદ કો સરલ બનાને કે લિએ' },
      { en: 'Both B and C are correct', hi: 'B और C दोनों सही हैं', sa: 'B और C दोनों सही हैं', mai: 'B और C दोनों सही हैं', mr: 'B और C दोनों सही हैं', ta: 'B ஔர C தோநோம் ஸஹீ ஹைம்', te: 'B ఔర C దోనోం సహీ హైం', bn: 'B ঔর C দোনোং সহী হৈং', kn: 'B ಔರ C ದೋನೋಂ ಸಹೀ ಹೈಂ', gu: 'B ઔર C દોનોં સહી હૈં' },
    ],
    correctAnswer: 3,
    explanation: {
  ...
  },
  {
    ...
    options: [
      { en: 'The precession of equinoxes', hi: 'अयनांश गति', sa: 'अयनांश गति', mai: 'अयनांश गति', mr: 'अयनांश गति', ta: 'அயநாம்ஶ கதி', te: 'అయనాంశ గతి', bn: 'অযনাংশ গতি', kn: 'ಅಯನಾಂಶ ಗತಿ', gu: 'અયનાંશ ગતિ' },
      { en: 'The difference between the Julian and Gregorian calendars (dropped leap days)', hi: 'जूलियन और ग्रेगोरियन कैलेण्डर के बीच अन्तर (हटाए गए अधिवर्ष दिन)', sa: 'जूलियन और ग्रेगोरियन कैलेण्डर के बीच अन्तर (हटाए गए अधिवर्ष दिन)', mai: 'जूलियन और ग्रेगोरियन कैलेण्डर के बीच अन्तर (हटाए गए अधिवर्ष दिन)', mr: 'जूलियन और ग्रेगोरियन कैलेण्डर के बीच अन्तर (हटाए गए अधिवर्ष दिन)', ta: 'ஜூலியந ஔர க்ரேகோரியந கைலேண்டர கே பீச அந்தர (ஹடாஎ கஎ அधிவர்ஷ திந)', te: 'జూలియన ఔర గ్రేగోరియన కైలేణ్డర కే బీచ అన్తర (హటాఏ గఏ అధివర్ష దిన)', bn: 'জূলিযন ঔর গ্রেগোরিযন কৈলেণ্ডর কে বীচ অন্তর (হটাএ গএ অধিবর্ষ দিন)', kn: 'ಜೂಲಿಯನ ಔರ ಗ್ರೇಗೋರಿಯನ ಕೈಲೇಣ್ಡರ ಕೇ ಬೀಚ ಅನ್ತರ (ಹಟಾಏ ಗಏ ಅಧಿವರ್ಷ ದಿನ)', gu: 'જૂલિયન ઔર ગ્રેગોરિયન કૈલેણ્ડર કે બીચ અન્તર (હટાએ ગએ અધિવર્ષ દિન)' },
      { en: 'Nutation corrections', hi: 'अयन-चलन सुधार', sa: 'अयन-चलन सुधार', mai: 'अयन-चलन सुधार', mr: 'अयन-चलन सुधार', ta: 'அயந-சலந ஸுधார', te: 'అయన-చలన సుధార', bn: 'অযন-চলন সুধার', kn: 'ಅಯನ-ಚಲನ ಸುಧಾರ', gu: 'અયન-ચલન સુધાર' },
      { en: 'The equation of time', hi: 'समय का समीकरण', sa: 'समय का समीकरण', mai: 'समय का समीकरण', mr: 'समय का समीकरण', ta: 'ஸமய கா ஸமீகரண', te: 'సమయ కా సమీకరణ', bn: 'সময কা সমীকরণ', kn: 'ಸಮಯ ಕಾ ಸಮೀಕರಣ', gu: 'સમય કા સમીકરણ' },
    ],
    correctAnswer: 1,
    explanation: {
  ...
  },
  {
    ...
    options: [
      { en: 'It marks a total solar eclipse visible from Greenwich', hi: 'यह ग्रीनविच से दृश्य पूर्ण सूर्यग्रहण चिह्नित करता है', sa: 'यह ग्रीनविच से दृश्य पूर्ण सूर्यग्रहण चिह्नित करता है', mai: 'यह ग्रीनविच से दृश्य पूर्ण सूर्यग्रहण चिह्नित करता है', mr: 'यह ग्रीनविच से दृश्य पूर्ण सूर्यग्रहण चिह्नित करता है', ta: 'யஹ க்ரீநவிச ஸே திருஶ்ய பூர்ண ஸூர்யக்ரஹண சிஹ்நித கரதா ஹை', te: 'యహ గ్రీనవిచ సే దృశ్య పూర్ణ సూర్యగ్రహణ చిహ్నిత కరతా హై', bn: 'যহ গ্রীনবিচ সে দৃশ্য পূর্ণ সূর্যগ্রহণ চিহ্নিত করতা হৈ', kn: 'ಯಹ ಗ್ರೀನವಿಚ ಸೇ ದೃಶ್ಯ ಪೂರ್ಣ ಸೂರ್ಯಗ್ರಹಣ ಚಿಹ್ನಿತ ಕರತಾ ಹೈ', gu: 'યહ ગ્રીનવિચ સે દૃશ્ય પૂર્ણ સૂર્યગ્રહણ ચિહ્નિત કરતા હૈ' },
      { en: 'It is the start of a Mayan calendar cycle', hi: 'यह माया कैलेण्डर चक्र का आरम्भ है', sa: 'यह माया कैलेण्डर चक्र का आरम्भ है', mai: 'यह माया कैलेण्डर चक्र का आरम्भ है', mr: 'यह माया कैलेण्डर चक्र का आरम्भ है', ta: 'யஹ மாயா கைலேண்டர சக்ர கா ஆரம்भ ஹை', te: 'యహ మాయా కైలేణ్డర చక్ర కా ఆరమ్భ హై', bn: 'যহ মাযা কৈলেণ্ডর চক্র কা আরম্ভ হৈ', kn: 'ಯಹ ಮಾಯಾ ಕೈಲೇಣ್ಡರ ಚಕ್ರ ಕಾ ಆರಮ್ಭ ಹೈ', gu: 'યહ માયા કૈલેણ્ડર ચક્ર કા આરમ્ભ હૈ' },
      { en: 'It is a round date near the present with well-determined star positions and precession', hi: 'यह वर्तमान के निकट एक सुविधाजनक तिथि है जिसके तारा-स्थान और अयनांश सटीक रूप से ज्ञात हैं', sa: 'यह वर्तमान के निकट एक सुविधाजनक तिथि है जिसके तारा-स्थान और अयनांश सटीक रूप से ज्ञात हैं', mai: 'यह वर्तमान के निकट एक सुविधाजनक तिथि है जिसके तारा-स्थान और अयनांश सटीक रूप से ज्ञात हैं', mr: 'यह वर्तमान के निकट एक सुविधाजनक तिथि है जिसके तारा-स्थान और अयनांश सटीक रूप से ज्ञात हैं', ta: 'யஹ வர்தமாந கே நிகட எக ஸுவிधாஜநக திथி ஹை ஜிஸகே தாரா-ஸ்थாந ஔர அயநாம்ஶ ஸடீக ரூப ஸே ஜ்ஞாத ஹைம்', te: 'యహ వర్తమాన కే నికట ఏక సువిధాజనక తిథి హై జిసకే తారా-స్థాన ఔర అయనాంశ సటీక రూప సే జ్ఞాత హైం', bn: 'যহ বর্তমান কে নিকট এক সুবিধাজনক তিথি হৈ জিসকে তারা-স্থান ঔর অযনাংশ সটীক রূপ সে জ্ঞাত হৈং', kn: 'ಯಹ ವರ್ತಮಾನ ಕೇ ನಿಕಟ ಏಕ ಸುವಿಧಾಜನಕ ತಿಥಿ ಹೈ ಜಿಸಕೇ ತಾರಾ-ಸ್ಥಾನ ಔರ ಅಯನಾಂಶ ಸಟೀಕ ರೂಪ ಸೇ ಜ್ಞಾತ ಹೈಂ', gu: 'યહ વર્તમાન કે નિકટ એક સુવિધાજનક તિથિ હૈ જિસકે તારા-સ્થાન ઔર અયનાંશ સટીક રૂપ સે જ્ઞાત હૈં' },
      { en: 'It is when the ayanamsha equals exactly zero', hi: 'यह वह समय है जब अयनांश ठीक शून्य होता है', sa: 'यह वह समय है जब अयनांश ठीक शून्य होता है', mai: 'यह वह समय है जब अयनांश ठीक शून्य होता है', mr: 'यह वह समय है जब अयनांश ठीक शून्य होता है', ta: 'யஹ வஹ ஸமய ஹை ஜப அயநாம்ஶ ठீக ஶூந்ய ஹோதா ஹை', te: 'యహ వహ సమయ హై జబ అయనాంశ ఠీక శూన్య హోతా హై', bn: 'যহ বহ সময হৈ জব অযনাংশ ঠীক শূন্য হোতা হৈ', kn: 'ಯಹ ವಹ ಸಮಯ ಹೈ ಜಬ ಅಯನಾಂಶ ಠೀಕ ಶೂನ್ಯ ಹೋತಾ ಹೈ', gu: 'યહ વહ સમય હૈ જબ અયનાંશ ઠીક શૂન્ય હોતા હૈ' },
    ],
    correctAnswer: 2,
    explanation: {
    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          {isHi ? 'खगोलविदों को निरन्तर दिन-गणना क्यों चाहिए' : 'Why Astronomers Need a Continuous Day Count'}
        </h3>
...
function Page2() {
  ...
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          {isHi ? 'एल्गोरिदम चरणबद्ध' : 'The Algorithm Step by Step'}
        </h3>
...
function Page3() {
  ...
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          {isHi ? 'जूलियन शताब्दियाँ और T चर' : 'Julian Centuries and the T Variable'}
        </h3>
