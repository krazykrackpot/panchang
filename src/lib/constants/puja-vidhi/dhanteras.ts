...
export const DHANTERAS_PUJA: PujaVidhi = {
  ...
  samagri: [
    { name: { en: 'New gold/silver item or metal utensil', hi: 'नया सोना/चाँदी का सामान या धातु का बर्तन', sa: 'नवसुवर्णरजतवस्तु अथवा धातुपात्रम्' }, note: { en: 'Buying metals on Dhanteras is highly auspicious', hi: 'धनतेरस पर धातु खरीदना अत्यन्त शुभ है', sa: 'धनत्रयोदश्यां धातुक्रयणम् अत्यन्तशुभम्' } },
    { name: { en: 'Diyas (earthen lamps)', hi: 'दीपक (मिट्टी के)', sa: 'दीपाः (मृत्तिकानिर्मिताः)' }, quantity: '13', note: { en: '13 Yama Deepa for warding off untimely death', hi: 'अकाल मृत्यु निवारण हेतु 13 यम दीपक', sa: 'अकालमृत्युनिवारणार्थं त्रयोदश यमदीपाः' } },
    { name: { en: 'Dhatura flowers and fruits', hi: 'धतूरे के फूल और फल', sa: 'धत्तूरपुष्पफलानि' } },
    { name: { en: 'Coins (old and new)', hi: 'सिक्के (पुराने और नए)', sa: 'मुद्राः (पुरातनाः नवाश्च)' } },
    { name: { en: 'Kumkum (vermilion)', hi: 'कुमकुम (सिन्दूर)', sa: 'कुङ्कुमम्' } },
    { name: { en: 'Akshat (unbroken rice)', hi: 'अक्षत (साबुत चावल)', sa: 'अक्षताः' } },
    { name: { en: 'Flowers (marigold, lotus)', hi: 'फूल (गेंदा, कमल)', sa: 'पुष्पाणि (स्थलपद्मम्, कमलम्)' } },
    { name: { en: 'Incense sticks', hi: 'अगरबत्ती', sa: 'धूपम्' } },
    { name: { en: 'Camphor', hi: 'कपूर', sa: 'कर्पूरम्' } },
    { name: { en: 'Ghee', hi: 'घी', sa: 'घृतम्' } },
    { name: { en: 'Turmeric', hi: 'हल्दी', sa: 'हरिद्रा' } },
    { name: { en: 'Sweets', hi: 'मिठाई', sa: 'मिष्टान्नानि' } },
    { name: { en: 'Dhaniya (coriander seeds)', hi: 'धनिया', sa: 'धान्यकम्' }, note: { en: 'Symbol of prosperity (Dhan)', hi: 'धन का प्रतीक', sa: 'धनस्य प्रतीकम्' } },
  ],
