  ...
  return (
    <div className="space-y-6">
      <section>
        ...
        <div className="space-y-3">
          <div className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-lg p-3">
            <p className="text-gold-light font-bold text-sm">{tl({ en: 'Calculation Formula', hi: 'गणना सूत्र', sa: 'गणनासूत्रम्' }, locale)}</p>
          ...
          <div className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-lg p-3">
            <p className="text-gold-light font-bold text-sm">{tl({ en: 'Yogi Planet Significance', hi: 'योगी ग्रह का महत्व', sa: 'योगिग्रहस्य महत्त्वम्' }, locale)}</p>
          ...
          <div className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-lg p-3">
            <p className="text-gold-light font-bold text-sm">{tl({ en: 'Duplicate Yogi', hi: 'द्वैत योगी', sa: 'द्वैतयोगी' }, locale)}</p>
      ...
      <section className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-300 text-xs uppercase tracking-widest font-bold mb-3">{tl({ en: 'Practical Example', hi: 'व्यावहारिक उदाहरण', sa: 'व्यावहारिकोदाहरणम्' }, locale)}</h4>
  ...
  return (
    <div className="space-y-6">
      <section>
        ...
        <div className="space-y-3">
          <div className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-lg p-3 border border-red-500/10">
            <p className="text-red-400 font-bold text-sm">{tl({ en: 'Avayogi Calculation', hi: 'अवयोगी गणना', sa: 'अवयोगिगणनम्' }, locale)}</p>
          ...
          <div className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-lg p-3 border border-red-500/10">
            <p className="text-red-400 font-bold text-sm">{tl({ en: 'Compounded Challenge', hi: 'मिश्रित चुनौती', sa: 'मिश्रिता कठिनता' }, locale)}</p>
          ...
          <div className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-lg p-3">
            <p className="text-gold-light font-bold text-sm">{tl({ en: 'Yogi-Avayogi Balance', hi: 'योगी-अवयोगी सन्तुलन', sa: 'योगी-अवयोगिसाम्यम्' }, locale)}</p>
      ...
      <section className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-xl p-5">
        <h4 className="text-gold-light text-xs uppercase tracking-widest font-bold mb-3">{tl({ en: 'Timing Strategy', hi: 'समय रणनीति', sa: 'कालनिर्धारणरणनीतिः' }, locale)}</h4>
  ...
  return (
    <div className="space-y-6">
      <section>
        ...
        <div className="space-y-3">
          ...
          <div className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-lg p-3 border border-emerald-500/10">
            <p className="text-emerald-300 font-bold text-sm">{tl({ en: 'Jupiter Transit = Positive Event', hi: 'बृहस्पति गोचर = सकारात्मक घटना', sa: 'गुरुगोचरः = शुभघटना' }, locale)}</p>
          ...
          <div className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-lg p-3 border border-red-500/10">
            <p className="text-red-400 font-bold text-sm">{tl({ en: 'Saturn Transit = Major Challenge', hi: 'शनि गोचर = बड़ी चुनौती', sa: 'शनिगोचरः = महती कठिनता' }, locale)}</p>
      ...
      <section className="bg-gradient-to-br from-[#2d1b69]/40 via-[#1a1040]/50 to-[#0a0e27] border border-gold-primary/12 rounded-xl p-5 border border-blue-500/15">
        <h4 className="text-blue-300 text-xs uppercase tracking-widest font-bold mb-3">{tl({ en: 'Our Engine Computes All', hi: 'हमारा इंजन सब गणना करता है', sa: 'अस्माकं यन्त्रं सर्वं गणयति' }, locale)}</h4>
