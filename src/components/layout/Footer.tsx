...
const SECTIONS = [
  {
    ...
    links: [
      ...
      { href: '/matching', label: { en: 'Matching', hi: 'गुण मिलान', ta: 'பொருத்தம்', bn: 'গুণ মিলন', te: 'గుణ మిలాన్', gu: 'ગુણ મેળાપ', kn: 'ಗುಣ ಮಿಲನ', mr: 'गुण जुळवणी', mai: 'गुण मिलान केर' } },
      ...
      { href: '/tropical-compare', label: { en: 'Vedic vs Tropical', hi: 'वैदिक vs उष्णकटिबंधीय', ta: 'வேதம் vs வெப்பமண்டலம்', bn: 'বৈদিক vs ট্রপিক্যাল', te: 'వేద vs ఉష్ణ', gu: 'વૈદિક vs ઉષ્ણ', kn: 'ವೈದಿಕ vs ಉಷ್ಣ', mr: 'वैदिक विरुद्ध उष्ण', mai: 'वैदिक बनाम उष्ण' } },
  ...
  },
  {
    ...
    links: [
      ...
      { href: '/panchang/nakshatra', label: { en: 'Nakshatra', hi: 'नक्षत्र', ta: 'நட்சத்திரம்', bn: 'নক্ষত্র', te: 'నక్షత్రం', gu: 'નક્ષત્ર', kn: 'ನಕ್ಷತ್ರ', mr: 'नक्षत्र राशि', mai: 'नक्षत्र विवरण' } },
      { href: '/panchang/yoga', label: { en: 'Yoga', hi: 'योग', ta: 'யோகம்', bn: 'যোগ', te: 'యోగం', gu: 'યોગ', kn: 'ಯೋಗ', mr: 'पंचांग योग', mai: 'पंचांग योगक' } },
