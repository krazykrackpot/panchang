...
const GUJARATI_DIWALI_DAYS: Array<{ day: LocaleText; tithi: LocaleText; desc: LocaleText }> = [
  { day: { en: 'Day 1 — Dhanteras / Dhan Trayodashi', hi: 'दिन 1 - धनतेरस / धन त्रयोदशी', gu: 'દિવસ 1 - ધનતેરસ / ધન ત્રયોદશી' }, tithi: { en: 'Kartik Krishna Trayodashi', hi: 'कार्तिक कृष्ण त्रयोदशी', gu: 'કારતક કૃષ્ણ ત્રયોદશી' }, desc: { en: 'Households purchase new utensils, silver coins, or gold. The literal meaning “wealth-thirteenth” reflects Dhanvantari’s emergence from the cosmic ocean (Samudra Manthan) on this tithi.', hi: 'परिवार नए बर्तन, चांदी के सिक्के या सोना खरीदते हैं। शाब्दिक अर्थ "धन-तेरहवां" इस तिथि पर धन्वंतरि के ब्रह्मांड महासागर (समुद्र मंथन) से उद्भव को दर्शाता है।', gu: 'ઘરના લોકો નવા વાસણો, ચાંદીના સિક્કા અથવા સોનાની ખરીદી કરે છે. શાબ્દિક અર્થ "સંપત્તિ-તેરમી" આ તિથિ પર બ્રહ્માંડ મહાસાગર (સમુદ્ર મંથન) માંથી ધન્વંતરીના ઉદ્ભવને દર્શાવે છે.' } },
  { day: { en: 'Day 2 — Kali Chaudas / Roop Chaudas', hi: 'दिन 2 - काली चौदस / रूप चौदस', gu: 'દિવસ 2 - કાલી ચૌદસ / રૂપ ચૌદસ' }, tithi: { en: 'Kartik Krishna Chaturdashi', hi: 'कार्तिक कृष्ण चतुर्दशी', gu: 'કારતક કૃષ્ણ ચતુર્દશી' }, desc: { en: 'Gujarat-specific naming. Pre-dawn Abhyanga snana (oil bath with til-oil and ubtan) is the central ritual.', hi: 'गुजरात-विशिष्ट नामकरण. भोर से पहले अभ्यंग स्नान (तिल-तेल और उबटन के साथ तेल स्नान) केंद्रीय अनुष्ठान है।', gu: 'ગુજરાત-વિશિષ્ટ નામકરણ. સવાર પહેલા અભ્યંગ સ્નાન (તિલ-તેલ અને ઉબતાન સાથે તેલ સ્નાન) એ કેન્દ્રીય વિધિ છે.' } },
  { day: { en: 'Day 3 — Diwali / Lakshmi Puja / Chopda Pujan', hi: 'दिन 3 - दिवाली / लक्ष्मी पूजा / चोपड़ा पूजन', gu: 'દિવસ 3 — દિવાળી / લક્ષ્મી પૂજન / ચોપડા પૂજન' }, tithi: { en: 'Kartik Amavasya', hi: 'कार्तिक अमावस्या', gu: 'કારતક અમાવસ્યા' }, desc: { en: 'The principal Diwali night. Gujarati merchants, traders, and family businesses perform Chopda Pujan — the worship of new account books. Fresh chopda are inscribed with the auspicious salutation “Shubh Labh” — Shubh (auspiciousness) on the left page, Labh (profit) on the right.', hi: 'मुख्य दिवाली की रात. गुजराती व्यापारी, व्यापारी और पारिवारिक व्यवसाय चोपड़ा पूजन करते हैं - नई खाता बही की पूजा। ताजा चोपडा पर शुभ अभिवादन "शुभ लाभ" अंकित है - बाएं पृष्ठ पर शुभ (शुभ), दाहिनी ओर लाभ (लाभ)।', gu: 'મુખ્ય દિવાળીની રાત. ગુજરાતી વેપારીઓ, વેપારીઓ અને કૌટુંબિક વ્યવસાયો ચોપડા પૂજન કરે છે - નવા હિસાબ પુસ્તકોની પૂજા. તાજા ચોપડા પર “શુભ લાભ” - શુભ (શુભ) ડાબા પાના પર, લાભ (લાભ) જમણી બાજુએ લખેલા છે.' } },
  { day: { en: 'Day 4 — Bestu Varas / Gujarati New Year', hi: 'दिन 4 - बेस्टु वरस / गुजराती नव वर्ष', gu: 'દિવસ 4 — બેસ્ટુ વારસ / ગુજરાતી નવું વર્ષ' }, tithi: { en: 'Kartik Shukla Pratipada', hi: 'कार्तिक शुक्ल प्रतिपदा', gu: 'કાર્તિક શુક્લ પ્રતિપદા' }, desc: { en: 'The new Vikram Samvat year formally begins at sunrise. Gujarati families wear new clothes, exchange “Saal Mubarak” greetings, and visit family elders. Businesses open their new chopda for the first transaction of the year. Govardhan Puja is observed in parallel.', hi: 'नए विक्रम संवत वर्ष की औपचारिक शुरुआत सूर्योदय से होती है। गुजराती परिवार नए कपड़े पहनते हैं, "साल मुबारक" की शुभकामनाएं देते हैं और परिवार के बुजुर्गों से मिलते हैं। व्यवसाय वर्ष के पहले लेन-देन के लिए अपना नया चोपडा खोलते हैं। गोवर्धन पूजा समानांतर रूप से मनाई जाती है।', gu: 'નવું વિક્રમ સંવત વર્ષ ઔપચારિક રીતે સૂર્યોદયથી શરૂ થાય છે. ગુજરાતી પરિવારો નવા કપડાં પહેરે છે, "સાલ મુબારક" શુભેચ્છાઓનું આદાનપ્રદાન કરે છે અને કુટુંબના વડીલોની મુલાકાત લે છે. વર્ષના પ્રથમ વ્યવહાર માટે વ્યવસાયો તેમના નવા ચોપડા ખોલે છે. ગોવર્ધન પૂજા સમાંતર મનાવવામાં આવે છે.' } },
  { day: { en: 'Day 5 — Bhai Bij', hi: 'दिन 5 - भाई बिज', gu: 'દિવસ 5 - ભાઈ બીજ' }, tithi: { en: 'Kartik Shukla Dwitiya', hi: 'कार्तिक शुक्ल द्वितीया', gu: 'કાર્તિક શુક્લ દ્વિતિયા' }, desc: { en: 'The Diwali cycle closes with Bhai Bij — sisters apply tilak to their brothers’ foreheads, perform aarti, and feed them sweets; brothers offer gifts and a promise of lifelong protection. The myth ties to Yama and Yamuna.', hi: 'दिवाली चक्र भाई बिज के साथ समाप्त होता है - बहनें अपने भाइयों के माथे पर तिलक लगाती हैं, आरती करती हैं और उन्हें मिठाई खिलाती हैं; भाई उपहार देते हैं और आजीवन सुरक्षा का वादा करते हैं। यह मिथक यम और यमुना से जुड़ा है।', gu: 'દિવાળીનું ચક્ર ભાઈબીજ સાથે બંધ થાય છે - બહેનો તેમના ભાઈઓના કપાળે તિલક કરે છે, આરતી કરે છે અને તેમને મીઠાઈ ખવડાવે છે; ભાઈઓ ભેટ આપે છે અને આજીવન રક્ષણનું વચન આપે છે. દંતકથા યમ અને યમુના સાથે જોડાયેલી છે.' } },
];
