  ...
  return (
    <div className="space-y-6">
      <section>
        ...
        <p className="text-text-secondary text-sm leading-relaxed mb-3">This module covers Beyond Kuta — a core concept in Compatibility within Vedic Jyotish. Understanding this topic is essential for reading birth charts, making predictions, and applying the wisdom of classical texts like BPHS and Phaladeepika.</p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">Chart analysis needed beyond Kuta. This concept has been practiced for over 2000 years and remains the foundation of modern Jyotish practice. Every chart reading, dasha interpretation, and transit analysis relies on this knowledge.</p>
        <p className="text-text-secondary text-sm leading-relaxed">As we explore Beyond Kuta, pay attention to the underlying mathematical structure — Jyotish is built on precise astronomical observations encoded into systematic frameworks. The beauty of this system is that the same rules apply whether you are reading a chart from 500 BCE or 2026 CE.</p>
      </section>
