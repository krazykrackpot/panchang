...
const GANDA_MULA = [
  {
    id: 1, name: { en: 'Ashwini', hi: 'अश्विनी', sa: 'अश्विनी', mai: 'अश्विनी', mr: 'अश्विनी', ta: 'Ashwini', te: 'Ashwini', bn: 'Ashwini', kn: 'Ashwini', gu: 'Ashwini' }, sign: { en: 'Aries (Mesha)', hi: 'मेष', sa: 'मेष', mai: 'मेष', mr: 'मेष', ta: 'Aries (Mesha)', te: 'Aries (Mesha)', bn: 'Aries (Mesha)', kn: 'Aries (Mesha)', gu: 'Aries (Mesha)' },
    ruler: { en: 'Ketu', hi: 'केतु', sa: 'केतु', mai: 'केतु', mr: 'केतु', ta: 'Ketu', te: 'Ketu', bn: 'Ketu', kn: 'Ketu', gu: 'Ketu' }, deity: { en: 'Ashwini Kumaras (Divine Physicians)', hi: 'अश्विनी कुमार (दैवीय चिकित्सक)', sa: 'अश्विनी कुमार (दैवीय चिकित्सक)', mai: 'अश्विनी कुमार (दैवीय चिकित्सक)', mr: 'अश्विनी कुमार (दैवीय चिकित्सक)', ta: 'Ashwini Kumaras (Divine Physicians)', te: 'Ashwini Kumaras (Divine Physicians)', bn: 'Ashwini Kumaras (Divine Physicians)', kn: 'Ashwini Kumaras (Divine Physicians)', gu: 'Ashwini Kumaras (Divine Physicians)' },
    junction: { en: 'Pisces → Aries (Water → Fire)', hi: 'मीन → मेष (जल → अग्नि)', sa: 'मीन → मेष (जल → अग्नि)', mai: 'मीन → मेष (जल → अग्नि)', mr: 'मीन → मेष (जल → अग्नि)', ta: 'Pisces → Aries (Water → Fire)', te: 'Pisces → Aries (Water → Fire)', bn: 'Pisces → Aries (Water → Fire)', kn: 'Pisces → Aries (Water → Fire)', gu: 'Pisces → Aries (Water → Fire)' },
    affected: { en: 'Father', hi: 'पिता', sa: 'पिता', mai: 'पिता', mr: 'पिता', ta: 'Father', te: 'Father', bn: 'Father', kn: 'Father', gu: 'Father' },
    criticalPadas: '1, 2',
    nature: { en: 'Swift, healing, energetic', hi: 'तीव्र, उपचारक, ऊर्जावान', sa: 'तीव्र, उपचारक, ऊर्जावान', mai: 'तीव्र, उपचारक, ऊर्जावान', mr: 'तीव्र, उपचारक, ऊर्जावान', ta: 'Swift, healing, energetic', te: 'Swift, healing, energetic', bn: 'Swift, healing, energetic', kn: 'Swift, healing, energetic', gu: 'Swift, healing, energetic' },
    effects: {
  ...
  {
    id: 9, name: { en: 'Ashlesha', hi: 'आश्लेषा', sa: 'आश्लेषा', mai: 'आश्लेषा', mr: 'आश्लेषा', ta: 'Ashlesha', te: 'Ashlesha', bn: 'Ashlesha', kn: 'Ashlesha', gu: 'Ashlesha' }, sign: { en: 'Cancer (Karka)', hi: 'कर्क', sa: 'कर्क', mai: 'कर्क', mr: 'कर्क', ta: 'Cancer (Karka)', te: 'Cancer (Karka)', bn: 'Cancer (Karka)', kn: 'Cancer (Karka)', gu: 'Cancer (Karka)' },
    ruler: { en: 'Mercury', hi: 'बुध', sa: 'बुध', mai: 'बुध', mr: 'बुध', ta: 'Mercury', te: 'Mercury', bn: 'Mercury', kn: 'Mercury', gu: 'Mercury' }, deity: { en: 'Naga (Serpent deities)', hi: 'नाग (सर्प देवता)', sa: 'नाग (सर्प देवता)', mai: 'नाग (सर्प देवता)', mr: 'नाग (सर्प देवता)', ta: 'Naga (Serpent deities)', te: 'Naga (Serpent deities)', bn: 'Naga (Serpent deities)', kn: 'Naga (Serpent deities)', gu: 'Naga (Serpent deities)' },
    junction: { en: 'Cancer → Leo (Water → Fire)', hi: 'कर्क → सिंह (जल → अग्नि)', sa: 'कर्क → सिंह (जल → अग्नि)', mai: 'कर्क → सिंह (जल → अग्नि)', mr: 'कर्क → सिंह (जल → अग्नि)', ta: 'Cancer → Leo (Water → Fire)', te: 'Cancer → Leo (Water → Fire)', bn: 'Cancer → Leo (Water → Fire)', kn: 'Cancer → Leo (Water → Fire)', gu: 'Cancer → Leo (Water → Fire)' },
    affected: { en: 'Mother-in-law', hi: 'सास', sa: 'सास', mai: 'सास', mr: 'सास', ta: 'Mother-in-law', te: 'Mother-in-law', bn: 'Mother-in-law', kn: 'Mother-in-law', gu: 'Mother-in-law' },
    criticalPadas: '3, 4',
    nature: { en: 'Mystical, penetrating, coiling', hi: 'रहस्यमय, भेदक, कुण्डलित', sa: 'रहस्यमय, भेदक, कुण्डलित', mai: 'रहस्यमय, भेदक, कुण्डलित', mr: 'रहस्यमय, भेदक, कुण्डलित', ta: 'Mystical, penetrating, coiling', te: 'Mystical, penetrating, coiling', bn: 'Mystical, penetrating, coiling', kn: 'Mystical, penetrating, coiling', gu: 'Mystical, penetrating, coiling' },
    effects: {
  ...
  {
    id: 10, name: { en: 'Magha', hi: 'मघा', sa: 'मघा', mai: 'मघा', mr: 'मघा', ta: 'Magha', te: 'Magha', bn: 'Magha', kn: 'Magha', gu: 'Magha' }, sign: { en: 'Leo (Simha)', hi: 'सिंह', sa: 'सिंह', mai: 'सिंह', mr: 'सिंह', ta: 'Leo (Simha)', te: 'Leo (Simha)', bn: 'Leo (Simha)', kn: 'Leo (Simha)', gu: 'Leo (Simha)' },
    ruler: { en: 'Ketu', hi: 'केतु', sa: 'केतु', mai: 'केतु', mr: 'केतु', ta: 'Ketu', te: 'Ketu', bn: 'Ketu', kn: 'Ketu', gu: 'Ketu' }, deity: { en: 'Pitris (Ancestors)', hi: 'पितृ (पूर्वज)', sa: 'पितृ (पूर्वज)', mai: 'पितृ (पूर्वज)', mr: 'पितृ (पूर्वज)', ta: 'Pitris (Ancestors)', te: 'Pitris (Ancestors)', bn: 'Pitris (Ancestors)', kn: 'Pitris (Ancestors)', gu: 'Pitris (Ancestors)' },
    junction: { en: 'Cancer → Leo (Water → Fire)', hi: 'कर्क → सिंह (जल → अग्नि)', sa: 'कर्क → सिंह (जल → अग्नि)', mai: 'कर्क → सिंह (जल → अग्नि)', mr: 'कर्क → सिंह (जल → अग्नि)', ta: 'Cancer → Leo (Water → Fire)', te: 'Cancer → Leo (Water → Fire)', bn: 'Cancer → Leo (Water → Fire)', kn: 'Cancer → Leo (Water → Fire)', gu: 'Cancer → Leo (Water → Fire)' },
    affected: { en: 'Mother', hi: 'माता', sa: 'माता', mai: 'माता', mr: 'माता', ta: 'Mother', te: 'Mother', bn: 'Mother', kn: 'Mother', gu: 'Mother' },
    criticalPadas: '1, 2',
    nature: { en: 'Royal, ancestral, authoritative', hi: 'राजसी, पैतृक, अधिकारपूर्ण', sa: 'राजसी, पैतृक, अधिकारपूर्ण', mai: 'राजसी, पैतृक, अधिकारपूर्ण', mr: 'राजसी, पैतृक, अधिकारपूर्ण', ta: 'Royal, ancestral, authoritative', te: 'Royal, ancestral, authoritative', bn: 'Royal, ancestral, authoritative', kn: 'Royal, ancestral, authoritative', gu: 'Royal, ancestral, authoritative' },
    effects: {
  ...
  {
    id: 18, name: { en: 'Jyeshtha', hi: 'ज्येष्ठा', sa: 'ज्येष्ठा', mai: 'ज्येष्ठा', mr: 'ज्येष्ठा', ta: 'Jyeshtha', te: 'Jyeshtha', bn: 'Jyeshtha', kn: 'Jyeshtha', gu: 'Jyeshtha' }, sign: { en: 'Scorpio (Vrishchika)', hi: 'वृश्चिक', sa: 'वृश्चिक', mai: 'वृश्चिक', mr: 'वृश्चिक', ta: 'Scorpio (Vrishchika)', te: 'Scorpio (Vrishchika)', bn: 'Scorpio (Vrishchika)', kn: 'Scorpio (Vrishchika)', gu: 'Scorpio (Vrishchika)' },
    ruler: { en: 'Mercury', hi: 'बुध', sa: 'बुध', mai: 'बुध', mr: 'बुध', ta: 'Mercury', te: 'Mercury', bn: 'Mercury', kn: 'Mercury', gu: 'Mercury' }, deity: { en: 'Indra (King of Gods)', hi: 'इन्द्र (देवराज)', sa: 'इन्द्र (देवराज)', mai: 'इन्द्र (देवराज)', mr: 'इन्द्र (देवराज)', ta: 'Indra (King of Gods)', te: 'Indra (King of Gods)', bn: 'Indra (King of Gods)', kn: 'Indra (King of Gods)', gu: 'Indra (King of Gods)' },
    junction: { en: 'Scorpio → Sagittarius (Water → Fire)', hi: 'वृश्चिक → धनु (जल → अग्नि)', sa: 'वृश्चिक → धनु (जल → अग्नि)', mai: 'वृश्चिक → धनु (जल → अग्नि)', mr: 'वृश्चिक → धनु (जल → अग्नि)', ta: 'Scorpio → Sagittarius (Water → Fire)', te: 'Scorpio → Sagittarius (Water → Fire)', bn: 'Scorpio → Sagittarius (Water → Fire)', kn: 'Scorpio → Sagittarius (Water → Fire)', gu: 'Scorpio → Sagittarius (Water → Fire)' },
    affected: { en: 'Elder brother/sister', hi: 'बड़ा भाई/बहन', sa: 'बड़ा भाई/बहन', mai: 'बड़ा भाई/बहन', mr: 'बड़ा भाई/बहन', ta: 'Elder brother/sister', te: 'Elder brother/sister', bn: 'Elder brother/sister', kn: 'Elder brother/sister', gu: 'Elder brother/sister' },
    criticalPadas: '3, 4',
    nature: { en: 'Protective, senior, fierce', hi: 'रक्षात्मक, ज्येष्ठ, उग्र', sa: 'रक्षात्मक, ज्येष्ठ, उग्र', mai: 'रक्षात्मक, ज्येष्ठ, उग्र', mr: 'रक्षात्मक, ज्येष्ठ, उग्र', ta: 'Protective, senior, fierce', te: 'Protective, senior, fierce', bn: 'Protective, senior, fierce', kn: 'Protective, senior, fierce', gu: 'Protective, senior, fierce' },
    effects: {
  ...
  {
    id: 19, name: { en: 'Moola', hi: 'मूल', sa: 'मूल', mai: 'मूल', mr: 'मूल', ta: 'Moola', te: 'Moola', bn: 'Moola', kn: 'Moola', gu: 'Moola' }, sign: { en: 'Sagittarius (Dhanu)', hi: 'धनु', sa: 'धनु', mai: 'धनु', mr: 'धनु', ta: 'Sagittarius (Dhanu)', te: 'Sagittarius (Dhanu)', bn: 'Sagittarius (Dhanu)', kn: 'Sagittarius (Dhanu)', gu: 'Sagittarius (Dhanu)' },
    ruler: { en: 'Ketu', hi: 'केतु', sa: 'केतु', mai: 'केतु', mr: 'केतु', ta: 'Ketu', te: 'Ketu', bn: 'Ketu', kn: 'Ketu', gu: 'Ketu' }, deity: { en: 'Nirriti (Goddess of Destruction)', hi: 'निर्ऋति (विनाश की देवी)', sa: 'निर्ऋति (विनाश की देवी)', mai: 'निर्ऋति (विनाश की देवी)', mr: 'निर्ऋति (विनाश की देवी)', ta: 'Nirriti (Goddess of Destruction)', te: 'Nirriti (Goddess of Destruction)', bn: 'Nirriti (Goddess of Destruction)', kn: 'Nirriti (Goddess of Destruction)', gu: 'Nirriti (Goddess of Destruction)' },
    junction: { en: 'Scorpio → Sagittarius (Water → Fire)', hi: 'वृश्चिक → धनु (जल → अग्नि)', sa: 'वृश्चिक → धनु (जल → अग्नि)', mai: 'वृश्चिक → धनु (जल → अग्नि)', mr: 'वृश्चिक → धनु (जल → अग्नि)', ta: 'Scorpio → Sagittarius (Water → Fire)', te: 'Scorpio → Sagittarius (Water → Fire)', bn: 'Scorpio → Sagittarius (Water → Fire)', kn: 'Scorpio → Sagittarius (Water → Fire)', gu: 'Scorpio → Sagittarius (Water → Fire)' },
    affected: { en: 'Father / family wealth', hi: 'पिता / पारिवारिक सम्पत्ति', sa: 'पिता / पारिवारिक सम्पत्ति', mai: 'पिता / पारिवारिक सम्पत्ति', mr: 'पिता / पारिवारिक सम्पत्ति', ta: 'Father / family wealth', te: 'Father / family wealth', bn: 'Father / family wealth', kn: 'Father / family wealth', gu: 'Father / family wealth' },
    criticalPadas: '1',
    nature: { en: 'Uprooting, foundational, destructive-creative', hi: 'उन्मूलक, मूलभूत, विनाशात्मक-सृजनात्मक', sa: 'उन्मूलक, मूलभूत, विनाशात्मक-सृजनात्मक', mai: 'उन्मूलक, मूलभूत, विनाशात्मक-सृजनात्मक', mr: 'उन्मूलक, मूलभूत, विनाशात्मक-सृजनात्मक', ta: 'Uprooting, foundational, destructive-creative', te: 'Uprooting, foundational, destructive-creative', bn: 'Uprooting, foundational, destructive-creative', kn: 'Uprooting, foundational, destructive-creative', gu: 'Uprooting, foundational, destructive-creative' },
    effects: {
  ...
  {
    id: 27, name: { en: 'Revati', hi: 'रेवती', sa: 'रेवती', mai: 'रेवती', mr: 'रेवती', ta: 'Revati', te: 'Revati', bn: 'Revati', kn: 'Revati', gu: 'Revati' }, sign: { en: 'Pisces (Meena)', hi: 'मीन', sa: 'मीन', mai: 'मीन', mr: 'मीन', ta: 'Pisces (Meena)', te: 'Pisces (Meena)', bn: 'Pisces (Meena)', kn: 'Pisces (Meena)', gu: 'Pisces (Meena)' },
    ruler: { en: 'Mercury', hi: 'बुध', sa: 'बुध', mai: 'बुध', mr: 'बुध', ta: 'Mercury', te: 'Mercury', bn: 'Mercury', kn: 'Mercury', gu: 'Mercury' }, deity: { en: 'Pushan (Nourisher, Protector of journeys)', hi: 'पूषन (पोषक, यात्रा रक्षक)', sa: 'पूषन (पोषक, यात्रा रक्षक)', mai: 'पूषन (पोषक, यात्रा रक्षक)', mr: 'पूषन (पोषक, यात्रा रक्षक)', ta: 'Pushan (Nourisher, Protector of journeys)', te: 'Pushan (Nourisher, Protector of journeys)', bn: 'Pushan (Nourisher, Protector of journeys)', kn: 'Pushan (Nourisher, Protector of journeys)', gu: 'Pushan (Nourisher, Protector of journeys)' },
    junction: { en: 'Pisces → Aries (Water → Fire)', hi: 'मीन → मेष (जल → अग्नि)', sa: 'मीन → मेष (जल → अग्नि)', mai: 'मीन → मेष (जल → अग्नि)', mr: 'मीन → मेष (जल → अग्नि)', ta: 'Pisces → Aries (Water → Fire)', te: 'Pisces → Aries (Water → Fire)', bn: 'Pisces → Aries (Water → Fire)', kn: 'Pisces → Aries (Water → Fire)', gu: 'Pisces → Aries (Water → Fire)' },
    affected: { en: 'Younger siblings', hi: 'छोटे भाई/बहन', sa: 'छोटे भाई/बहन', mai: 'छोटे भाई/बहन', mr: 'छोटे भाई/बहन', ta: 'Younger siblings', te: 'Younger siblings', bn: 'Younger siblings', kn: 'Younger siblings', gu: 'Younger siblings' },
    criticalPadas: '4',
    nature: { en: 'Gentle, nourishing, concluding', hi: 'सौम्य, पोषक, समापन', sa: 'सौम्य, पोषक, समापन', mai: 'सौम्य, पोषक, समापन', mr: 'सौम्य, पोषक, समापन', ta: 'Gentle, nourishing, concluding', te: 'Gentle, nourishing, concluding', bn: 'Gentle, nourishing, concluding', kn: 'Gentle, nourishing, concluding', gu: 'Gentle, nourishing, concluding' },
    effects: {
        ...
        return (
          <g key={`j-${i}`}>
            ...
            <text x={pos.labelX} y={pos.labelY} textAnchor={anchor} dominantBaseline="central"
              ...
              {!isDevanagariLocale(locale) ? j.naksEn : j.naksHi}
            </text>
          </g>
        );
      })}
