...
export function detectExtendedYogas(
  ...
  if (daridraPresent) {
    yogas.push({
      ...
      present: true, type: 'Arishta',
      description: t(locale,
        'Lord of 11th house (gains) placed in a dusthana (6/8/12). Gains come with obstacles, delays, or through unconventional means. Effort required for income.',
        '11वें भाव (लाभ) का स्वामी दुःस्थान (6/8/12) में। लाभ बाधाओं, विलम्ब या अपरम्परागत साधनों से। आय के लिए प्रयास आवश्यक।'),
      implications: t(locale,
