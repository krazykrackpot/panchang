...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    modules: [
      ...
      { id: 'ref:zero', title: { en: 'Zero — The Most Dangerous Idea', hi: 'शून्य — सबसे खतरनाक विचार', sa: 'शून्यम्' }, href: '/learn/contributions/zero' },
      { id: 'ref:sine', title: { en: "Sine Is Sanskrit — Jya to Sine", hi: 'Sine संस्कृत है', sa: 'ज्या' }, href: '/learn/contributions/sine' },
      { id: 'ref:pi', title: { en: 'π = 3.1416 — Aryabhata', hi: 'π = 3.1416 — आर्यभट', sa: 'π' }, href: '/learn/contributions/pi' },
      { id: 'ref:binary', title: { en: 'Binary — 1,800 Years Before Computers', hi: 'द्विआधारी', sa: 'द्विआधारी' }, href: '/learn/contributions/binary' },
      { id: 'ref:fibonacci', title: { en: 'Fibonacci Started With Indian Music', hi: 'फिबोनाची भारतीय संगीत से', sa: 'फिबोनाची' }, href: '/learn/contributions/fibonacci' },
      { id: 'ref:calculus', title: { en: 'Calculus — Kerala, Not Cambridge', hi: 'कैलकुलस — केरल', sa: 'कैलकुलस' }, href: '/learn/contributions/calculus' },
      { id: 'ref:earth', title: { en: 'Earth Rotates — 1,000 Years Before Europe', hi: 'पृथ्वी घूमती है', sa: 'पृथिवी भ्रमति' }, href: '/learn/contributions/earth-rotation' },
      { id: 'ref:gravity', title: { en: 'Gravity — 500 Years Before Newton', hi: 'गुरुत्वाकर्षण', sa: 'गुरुत्वाकर्षणम्' }, href: '/learn/contributions/gravity' },
      { id: 'ref:light', title: { en: 'Speed of Light — 14th Century', hi: 'प्रकाश गति', sa: 'प्रकाशगतिः' }, href: '/learn/contributions/speed-of-light' },
      { id: 'ref:cosmic', title: { en: '4.32 Billion Years', hi: '4.32 अरब वर्ष', sa: 'कल्पः' }, href: '/learn/contributions/cosmic-time' },
      { id: 'ref:negative', title: { en: 'Negative Numbers', hi: 'ऋणात्मक संख्याएँ', sa: 'ऋणसंख्याः' }, href: '/learn/contributions/negative-numbers' },
    ],
    refs: [],
  },
  {
