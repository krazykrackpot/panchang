...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Char Dasha (Jaimini) — Sign-Based Timing / चर दशा (जैमिनी) — राशि-आधारित समय-निर्धारण
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          Maharishi Jaimini developed an entirely different approach to timing. Instead of assigning periods to planets, Char Dasha assigns periods to signs (rashis). All 12 signs get a dasha turn, and the duration of each sign&apos;s period depends on the distance between the sign and its lord. For odd signs, count forward from the sign to its lord; for even signs, count backward. The resulting number (1-12) gives the dasha years for that sign. This creates a unique timeline for every chart.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          महर्षि जैमिनी ने समय-निर्धारण का पूर्णतया भिन्न दृष्टिकोण विकसित किया। ग्रहों को काल निर्दिष्ट करने के बजाय, चर दशा राशियों को काल निर्दिष्ट करती है। सभी 12 राशियों को दशा की बारी मिलती है, और प्रत्येक राशि के काल की अवधि राशि और उसके स्वामी के बीच की दूरी पर निर्भर करती है। विषम राशियों के लिए राशि से स्वामी तक आगे गिनें; सम राशियों के लिए पीछे गिनें। परिणामी संख्या (1-12) उस राशि के दशा वर्ष देती है। यह प्रत्येक कुण्डली के लिए एक अद्वितीय समय-रेखा बनाता है।
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          When a particular sign&apos;s Char Dasha is running, the entire sign activates — every planet sitting in that sign, every house that sign represents, and every Jaimini karaka connected to it. This makes Char Dasha especially powerful for event prediction. Jaimini uses Chara Karakas (variable significators) determined by planetary degree: the planet at the highest degree in the chart becomes Atmakaraka (soul), the next is Amatyakaraka (career), then Bhratrikaraka (siblings), Matrikaraka (mother), Putrakaraka (children), Gnatikaraka (enemies/relatives), and Darakaraka (spouse) — the planet at the lowest degree.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed">
          जब किसी विशेष राशि की चर दशा चल रही हो, पूरी राशि सक्रिय होती है — उस राशि में बैठा प्रत्येक ग्रह, वह राशि जिन भावों का प्रतिनिधित्व करती है, और उससे जुड़ा प्रत्येक जैमिनी कारक। यह चर दशा को घटना भविष्यवाणी में विशेष रूप से शक्तिशाली बनाता है। जैमिनी चर कारक (परिवर्तनशील कारक) का उपयोग करते हैं जो ग्रह अंश से निर्धारित होते हैं: कुण्डली में सर्वोच्च अंश वाला ग्रह आत्मकारक (आत्मा) बनता है, अगला अमात्यकारक (कैरियर), फिर भ्रातृकारक (भाई-बहन), मातृकारक (माता), पुत्रकारक (सन्तान), ज्ञातिकारक (शत्रु/सम्बन्धी), और दारकारक (पति/पत्नी) — न्यूनतम अंश वाला ग्रह।
        </p>
      </section>

      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">Rashi Drishti — Jaimini Aspects / राशि दृष्टि — जैमिनी दृष्टि</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          Unlike Parashara&apos;s planetary aspects (where Saturn aspects the 3rd, 7th, and 10th), Jaimini uses sign-based aspects. The rules are elegant: Movable signs (Aries, Cancer, Libra, Capricorn) aspect all Fixed signs except the one next to them. Fixed signs (Taurus, Leo, Scorpio, Aquarius) aspect all Movable signs except the one next to them. Dual signs (Gemini, Virgo, Sagittarius, Pisces) aspect each other.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          पराशर की ग्रह दृष्टि (जहाँ शनि 3, 7 और 10वें को देखता है) के विपरीत, जैमिनी राशि-आधारित दृष्टि प्रयोग करते हैं। नियम सुन्दर हैं: चर राशियाँ (मेष, कर्क, तुला, मकर) सभी स्थिर राशियों को देखती हैं सिवाय निकटवर्ती के। स्थिर राशियाँ (वृषभ, सिंह, वृश्चिक, कुम्भ) सभी चर राशियों को देखती हैं सिवाय निकटवर्ती के। द्विस्वभाव राशियाँ (मिथुन, कन्या, धनु, मीन) एक-दूसरे को देखती हैं।
        </p>
      </section>
    </div>
  );
...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          When to Use Which System / कौन-सी पद्धति कब प्रयोग करें
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          The three dasha systems serve different purposes and work best in combination. Vimshottari Dasha is the master system for general life predictions — career trajectories, relationship patterns, health trends, and spiritual evolution over the full lifespan. It excels at answering &quot;what kind of period is this?&quot; because planetary themes are richly described in classical literature. Use Vimshottari as your primary predictive tool for all chart readings.
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          तीन दशा पद्धतियाँ भिन्न उद्देश्यों की पूर्ति करती हैं और संयोजन में सर्वोत्तम कार्य करती हैं। विंशोत्तरी दशा सामान्य जीवन भविष्यवाणी की प्रधान पद्धति है — कैरियर प्रक्षेपवक्र, सम्बन्ध प्रतिरूप, स्वास्थ्य प्रवृत्तियाँ और पूर्ण जीवनकाल में आध्यात्मिक विकास। यह &quot;यह कैसा काल है?&quot; का उत्तर देने में उत्कृष्ट है क्योंकि ग्रह विषय शास्त्रीय साहित्य में समृद्ध रूप से वर्णित हैं। सभी कुण्डली पठन के लिए विंशोत्तरी को प्राथमिक भविष्यवाणी उपकरण के रूप में प्रयोग करें।
        </p>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
        ...
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
          योगिनी दशा शीघ्र पुष्टि का कार्य करती है। इसके 36-वर्षीय चक्र का अर्थ है काल छोटे और अधिक तत्काल हैं। जब विंशोत्तरी कहे &quot;शुक्र काल — अगले 2 वर्षों में विवाह सम्भव&quot; और योगिनी की सिद्धा (शुक्र) अवधि भी उसी खिड़की में आती है, तो विश्वास नाटकीय रूप से बढ़ जाता है। योगिनी उत्तर भारतीय परम्पराओं में विशेष रूप से महत्त्वपूर्ण है और कभी-कभी अपनी कसी हुई समय-सीमाओं के कारण अल्पकालिक भविष्यवाणियों के लिए अधिक सटीक मानी जाती है।
        </p>
        <p className="text-text-secondary text-sm leading-relaxed">
      ...
      <section className="glass-card rounded-xl p-5 border border-red-500/15">
        <h4 className="text-red-400 text-[10px] uppercase tracking-widest font-bold mb-3">Common Misconceptions / सामान्य भ्रान्तियाँ</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Misconception:</span> &quot;Only Vimshottari is authentic; other dasha systems are modern inventions.&quot; This is completely false. Jaimini Sutras (attributed to Maharishi Jaimini, a disciple of Vyasa) predate many Parashari commentaries. Yogini Dasha appears in Tantric literature from medieval India and has deep roots in the Shakta tradition. All three systems have ancient pedigrees and are mutually complementary, not competing.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">भ्रान्ति:</span> &quot;केवल विंशोत्तरी प्रामाणिक है; अन्य दशा पद्धतियाँ आधुनिक आविष्कार हैं।&quot; यह पूर्णतया असत्य है। जैमिनी सूत्र (महर्षि जैमिनी, व्यास के शिष्य को समर्पित) अनेक पाराशरी टीकाओं से पूर्ववर्ती हैं। योगिनी दशा मध्यकालीन भारत के तान्त्रिक साहित्य में प्रकट होती है और शाक्त परम्परा में इसकी गहरी जड़ें हैं। तीनों पद्धतियों का प्राचीन वंशक्रम है और ये परस्पर पूरक हैं, प्रतिस्पर्धी नहीं।
        </p>
      </section>

      <section className="glass-card rounded-xl p-5 border border-blue-500/15">
        <h4 className="text-blue-300 text-[10px] uppercase tracking-widest font-bold mb-3">Convergent Validation in Practice / व्यवहार में अभिसारी प्रमाणीकरण</h4>
        <p className="text-text-secondary text-xs leading-relaxed mb-2">
          <span className="text-gold-light font-medium">Scenario:</span> A client asks &quot;When will I get married?&quot; You check: Vimshottari shows Venus Antardasha in Jupiter Mahadasha starting June 2027. Yogini shows Siddha (Venus) period running 2026-2033. Char Dasha shows 7th sign from lagna getting activated in 2027-2029. All three systems converge on 2027-2028 as the marriage window. This is high-confidence prediction.
        </p>
        <p className="text-text-secondary text-xs leading-relaxed">
          <span className="text-gold-light font-medium">परिदृश्य:</span> एक जातक पूछता है &quot;मेरा विवाह कब होगा?&quot; आप जाँचते हैं: विंशोत्तरी गुरु महादशा में शुक्र अन्तर्दशा जून 2027 से दिखाती है। योगिनी सिद्धा (शुक्र) काल 2026-2033 चल रहा दिखाती है। चर दशा लग्न से 7वीं राशि 2027-2029 में सक्रिय दिखाती है। तीनों पद्धतियाँ 2027-2028 पर विवाह खिड़की के रूप में अभिसरित होती हैं। यह उच्च-विश्वास भविष्यवाणी है।
        </p>
      </section>
    </div>
  );
