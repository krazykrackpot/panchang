    ...
    <div className="min-h-screen bg-bg-primary">
      <div className="max-w-5xl mx-auto px-4 pt-20 pb-16">
        ...
        <section className="mb-10">
          ...
          {(() => { if (typeof window !== 'undefined') { const d = memberStatuses.map(ms => `${ms.name}: asc=${ms.ascendantSign} moon=${ms.moonSign} tithi=${ms.birthTithi} masa=${ms.birthMasa} year=${ms.birthYear}`); console.log('[DEBUG COSMIC]', d.join(' | ')); } return null; })()}
