...
export const PLANET_HOUSE_DEPTH: Record<number, Record<number, HouseImplication>> = {
  ...
  0: {
    ...
    6: { implications: 'Victory over competition through authority. Service career in government or leadership. Health recovers through willpower.', prognosis: 'Enemies defeated by 35. Health challenges in 40s require attention. Service brings recognition and authority.' },
  ...
  2: {
    ...
    6: { implications: 'Powerful placement for defeating enemies and overcoming obstacles. Excellent for military, surgery, or competitive careers.', prognosis: 'Enemies completely defeated by 35. Career success in competitive fields. Health improves through vigorous exercise.' },
