...
- Name: core-flows.spec.ts >> Navigation >> navbar has logo
- Location: e2e/core-flows.spec.ts:103:7
...
Locator: locator('text=Dekho Panchang')
Expected: visible
Error: strict mode violation: locator('text=Dekho Panchang') resolved to 2 elements:
    ...
    2) <span class="text-gold-primary/60 text-sm font-semibold">Dekho Panchang</span> aka getByRole('contentinfo').getByText('Dekho Panchang')

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for locator('text=Dekho Panchang')
