...
const STRENGTH_EXPLANATIONS_EN: { name: string; key: string; desc: string }[] = [
  ...
  { name: 'Drik Bala', key: 'aspectual', desc: 'Benefic aspects (Moon, Mercury, Jupiter, Venus) add strength; malefic aspects (Sun, Mars, Saturn, Rahu, Ketu) reduce it. Mars (4/8), Jupiter (5/9), and Saturn (3/10) cast special aspects; nodes use the 7th only (traditional reading).' },
];
...
const STRENGTH_EXPLANATIONS_HI: { name: string; key: string; desc: string }[] = [
  ...
  { name: 'दृक्बल', key: 'aspectual', desc: 'शुभ ग्रहों (चन्द्र, बुध, बृहस्पति, शुक्र) की दृष्टि बल बढ़ाती है; पाप ग्रहों (सूर्य, मंगल, शनि, राहु, केतु) की दृष्टि घटाती है। मंगल (4/8), बृहस्पति (5/9), शनि (3/10) विशेष दृष्टि डालते हैं; राहु-केतु केवल सप्तम दृष्टि डालते हैं (पारम्परिक पाराशरीय व्याख्या)।' },
];
