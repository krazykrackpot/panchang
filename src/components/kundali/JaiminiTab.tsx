...
const KARAKA_INFO: Record<string, { full: LocaleText; meaning: LocaleText; governs: LocaleText }> = {
  AK: { full: { en: 'Atmakaraka', hi: 'आत्मकारक', sa: 'आत्मकारक', mai: 'आत्मकारक', mr: 'आत्मकारक', ta: 'Atmakaraka', te: 'Atmakaraka', bn: 'Atmakaraka', kn: 'Atmakaraka', gu: 'Atmakaraka' }, meaning: { en: 'Soul Significator', hi: 'आत्मा का कारक', sa: 'आत्मा का कारक', mai: 'आत्मा का कारक', mr: 'आत्मा का कारक', ta: 'Soul Significator', te: 'Soul Significator', bn: 'Soul Significator', kn: 'Soul Significator', gu: 'Soul Significator' }, governs: { en: 'Your soul\'s deepest desire and life purpose. The king of your chart — all other karakas serve this planet\'s agenda.', hi: 'आत्मा की गहनतम इच्छा और जीवन उद्देश्य। कुण्डली का राजा — सभी अन्य कारक इस ग्रह की सेवा करते हैं।' } },
  AmK: { full: { en: 'Amatyakaraka', hi: 'अमात्यकारक', sa: 'अमात्यकारक', mai: 'अमात्यकारक', mr: 'अमात्यकारक', ta: 'Amatyakaraka', te: 'Amatyakaraka', bn: 'Amatyakaraka', kn: 'Amatyakaraka', gu: 'Amatyakaraka' }, meaning: { en: 'Minister/Career', hi: 'मन्त्री/कैरियर', sa: 'मन्त्री/कैरियर', mai: 'मन्त्री/कैरियर', mr: 'मन्त्री/कैरियर', ta: 'Minister/Career', te: 'Minister/Career', bn: 'Minister/Career', kn: 'Minister/Career', gu: 'Minister/Career' }, governs: { en: 'Career direction, profession, how you serve society. The minister who executes the soul\'s purpose through worldly work.', hi: 'कैरियर दिशा, पेशा, समाज सेवा। मन्त्री जो सांसारिक कार्य से आत्मा के उद्देश्य को पूर्ण करता है।' } },
...
const HOUSE_LABELS: Record<number, LocaleText> = {
  1: { en: 'Lagna', hi: 'लग्न', sa: 'लग्न', mai: 'लग्न', mr: 'लग्न', ta: 'Lagna', te: 'Lagna', bn: 'Lagna', kn: 'Lagna', gu: 'Lagna' }, 2: { en: 'Dhana', hi: 'धन', sa: 'धन', mai: 'धन', mr: 'धन', ta: 'Dhana', te: 'Dhana', bn: 'Dhana', kn: 'Dhana', gu: 'Dhana' }, 3: { en: 'Sahaja', hi: 'सहज', sa: 'सहज', mai: 'सहज', mr: 'सहज', ta: 'Sahaja', te: 'Sahaja', bn: 'Sahaja', kn: 'Sahaja', gu: 'Sahaja' },
  4: { en: 'Sukha', hi: 'सुख', sa: 'सुख', mai: 'सुख', mr: 'सुख', ta: 'Sukha', te: 'Sukha', bn: 'Sukha', kn: 'Sukha', gu: 'Sukha' }, 5: { en: 'Putra', hi: 'पुत्र', sa: 'पुत्र', mai: 'पुत्र', mr: 'पुत्र', ta: 'Putra', te: 'Putra', bn: 'Putra', kn: 'Putra', gu: 'Putra' }, 6: { en: 'Ari', hi: 'अरि', sa: 'अरि', mai: 'अरि', mr: 'अरि', ta: 'Ari', te: 'Ari', bn: 'Ari', kn: 'Ari', gu: 'Ari' },
  7: { en: 'Kalatra', hi: 'कलत्र', sa: 'कलत्र', mai: 'कलत्र', mr: 'कलत्र', ta: 'Kalatra', te: 'Kalatra', bn: 'Kalatra', kn: 'Kalatra', gu: 'Kalatra' }, 8: { en: 'Randhra', hi: 'रन्ध्र', sa: 'रन्ध्र', mai: 'रन्ध्र', mr: 'रन्ध्र', ta: 'Randhra', te: 'Randhra', bn: 'Randhra', kn: 'Randhra', gu: 'Randhra' }, 9: { en: 'Dharma', hi: 'धर्म', sa: 'धर्म', mai: 'धर्म', mr: 'धर्म', ta: 'Dharma', te: 'Dharma', bn: 'Dharma', kn: 'Dharma', gu: 'Dharma' },
  10: { en: 'Karma', hi: 'कर्म', sa: 'कर्म', mai: 'कर्म', mr: 'कर्म', ta: 'Karma', te: 'Karma', bn: 'Karma', kn: 'Karma', gu: 'Karma' }, 11: { en: 'Labha', hi: 'लाभ', sa: 'लाभ', mai: 'लाभ', mr: 'लाभ', ta: 'Labha', te: 'Labha', bn: 'Labha', kn: 'Labha', gu: 'Labha' }, 12: { en: 'Vyaya', hi: 'व्यय', sa: 'व्यय', mai: 'व्यय', mr: 'व्यय', ta: 'Vyaya', te: 'Vyaya', bn: 'Vyaya', kn: 'Vyaya', gu: 'Vyaya' },
};
