...
import MSG from '@/messages/pages/panchang-grahan.json';
...
export default function GrahanPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="prose prose-invert max-w-none text-text-secondary">
            <p className="text-lg leading-relaxed">
              {locale === 'en'
                ...
                : msg('grahanDescription', locale)}
            </p>
            <div className="mt-6 p-4 bg-bg-primary/50 rounded-lg border border-gold-primary/10">
              <p className="text-gold-light font-mono text-sm">
                {msg('conditionLabel', locale)} |Moon_lat_node_distance| &lt; 18.5\u00B0 (Solar) or
                &lt; 12.5\u00B0 (Lunar)
              </p>
      ...
      <section className="my-12">
        <h2 className="text-2xl font-bold text-gold-gradient mb-6" style={headingFont}>
          {msg('eclipseGeometryTitle', locale)}
        </h2>
