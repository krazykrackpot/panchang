    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Tajika: The Perso-Arabic Layer of Indian Astrology / ताजिक: भारतीय ज्योतिष की फारसी-अरबी परत
        </h3>
...
function Page2() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          The Five Tajika Yogas / पाँच ताजिक योग
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Applying Tajika in Varshaphal Analysis / वर्षफल विश्लेषण में ताजिक का अनुप्रयोग
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
