    ...
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          House Strength vs. Planet Strength / भाव शक्ति बनाम ग्रह शक्ति
        </h3>
  ...
  return (
    <div className="space-y-6">
      ...
      <section className="glass-card rounded-xl p-5 border border-emerald-500/15">
        <h4 className="text-emerald-400 text-[10px] uppercase tracking-widest font-bold mb-3">Worked Example: 7th House for Marriage / कार्यरत उदाहरण: विवाह हेतु सप्तम भाव</h4>
        ...
        <p className="text-text-secondary text-xs leading-relaxed mb-2 font-medium">Total 7th Bhavabala: ~120 shashtiamsas. Moderate-to-good. Marriage is supported by the strong lord, but Saturn&apos;s aspect may cause some delays despite Jupiter&apos;s protection.</p>
...
function Page3() {
  return (
    <div className="space-y-6">
      <section>
        <h3 className="text-gold-light font-bold text-lg mb-3" style={{ fontFamily: 'var(--font-heading)' }}>
          Practical Interpretation / व्यावहारिक व्याख्या
        </h3>
        <p className="text-text-secondary text-sm leading-relaxed mb-3">
