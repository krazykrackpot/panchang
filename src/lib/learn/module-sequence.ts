...
export const MODULE_SEQUENCE: ModuleRef[] = [
  ...
  { id: '29-1', phase: 13, topic: 'Medical Jyotish', title: { en: 'Medical Jyotish — Body & Planets', hi: 'चिकित्सा ज्योतिष — शरीर और ग्रह', sa: 'चिकित्साज्योतिषम् — शरीरं ग्रहाश्च', mai: 'चिकित्सा ज्योतिष — शरीर और ग्रह', mr: 'वैद्यकीय ज्योतिष — शरीर आणि ग्रह', ta: 'மருத்துவ ஜோதிடம் — உடல் & கிரகங்கள்', te: 'వైద్య జ్యోతిష్యం — శరీరం & గ్రహాలు', bn: 'চিকিৎসা জ্যোতিষ — শরীর ও গ্রহ', kn: 'ವೈದ್ಯ ಜ್ಯೋತಿಷ್ಯ — ದೇಹ ಮತ್ತು ಗ್ರಹ', gu: 'ચિકિત્સા જ્યોતિષ — શરીર અને ગ્રહ' } },
  { id: '29-2', phase: 13, topic: 'Medical Jyotish', title: { en: 'Ayurvedic Timing — Dosha & Dinacharya', hi: 'आयुर्वेदिक समय — दोष और दिनचर्या', sa: 'आयुर्वेदकालः — दोषदिनचर्या', mai: 'आयुर्वेदिक समय — दोष और दिनचर्या', mr: 'आयुर्वेदिक वेळ — दोष आणि दिनचर्या', ta: 'ஆயுர்வேத நேரம் — தோஷம் & தினசரி', te: 'ఆయుర్వేద సమయం — దోషం & దినచర్య', bn: 'আয়ুর্বেদিক সময় — দোষ ও দিনচর্যা', kn: 'ಆಯುರ್ವೇದ ಸಮಯ — ದೋಷ ಮತ್ತು ದಿನಚರ್ಯೆ', gu: 'આયુર્વેદિક સમય — દોષ અને દિનચર્યા' } },

  // ── Phase 14: Classical Texts & Muhurta Mastery ────────────────────────────
  { id: '30-1', phase: 14, topic: 'Classical Texts', title: { en: 'Reading BPHS — Structure & Method', hi: 'BPHS पढ़ना — संरचना और पद्धति', sa: 'बृहत्पाराशरहोराशास्त्रपठनम्', mai: 'BPHS पढ़ना — संरचना और पद्धति', mr: 'BPHS वाचन — रचना आणि पद्धती', ta: 'BPHS படித்தல் — அமைப்பு & முறை', te: 'BPHS చదవడం — నిర్మాణం & పద్ధతి', bn: 'BPHS পড়া — গঠন ও পদ্ধতি', kn: 'BPHS ಓದುವಿಕೆ — ರಚನೆ ಮತ್ತು ವಿಧಾನ', gu: 'BPHS વાંચન — રચના અને પદ્ધતિ' } },
  { id: '30-2', phase: 14, topic: 'Classical Texts', title: { en: 'Phaladeepika — The Lamp of Results', hi: 'फलदीपिका — फलों का दीप', sa: 'फलदीपिका — फलप्रदीपः', mai: 'फलदीपिका — फलों का दीप', mr: 'फलदीपिका — फलांचा दीप', ta: 'பலதீபிகா — பலன்களின் தீபம்', te: 'ఫలదీపిక — ఫలాల దీపం', bn: 'ফলদীপিকা — ফলের দীপ', kn: 'ಫಲದೀಪಿಕಾ — ಫಲಗಳ ದೀಪ', gu: 'ફળદીપિકા — ફળનો દીપ' } },
  { id: '30-3', phase: 14, topic: 'Classical Texts', title: { en: 'Saravali & Jataka Parijata', hi: 'सारावली और जातक पारिजात', sa: 'सारावली जातकपारिजातं च', mai: 'सारावली और जातक पारिजात', mr: 'सारावली आणि जातक पारिजात', ta: 'சாராவளி & ஜாதக பாரிஜாதம்', te: 'సారావళి & జాతక పారిజాతం', bn: 'সারাবলী ও জাতক পারিজাত', kn: 'ಸಾರಾವಳಿ ಮತ್ತು ಜಾತಕ ಪಾರಿಜಾತ', gu: 'સારાવલી અને જાતક પારિજાત' } },
  ...
  { id: '32-1', phase: 4, topic: 'Yogas & Doshas', title: { en: 'Kaal Sarpa Dosha — The Serpent\'s Embrace', hi: 'काल सर्प दोष — सर्प का आलिंगन', sa: 'कालसर्पदोषः — सर्पालिंगनम्', mai: 'काल सर्प दोष — सर्प का आलिंगन', mr: 'काल सर्प दोष — सर्पाचे आलिंगन', ta: 'கால சர்ப்ப தோஷம் — பாம்பின் அணைப்பு', te: 'కాల సర్ప దోషం — సర్పం ఆలింగనం', bn: 'কাল সর্প দোষ — সর্পের আলিঙ্গন', kn: 'ಕಾಲ ಸರ್ಪ ದೋಷ — ಸರ್ಪದ ಆಲಿಂಗನ', gu: 'કાળ સર્પ દોષ — સર્પનું આલિંગન' } },
  { id: '33-1', phase: 4, topic: 'Yogas & Doshas', title: { en: 'Manglik Dosha — Mars and Marriage', hi: 'मांगलिक दोष — मंगल और विवाह', sa: 'माङ्गलिकदोषः — मङ्गलविवाहौ', mai: 'मांगलिक दोष — मंगल और विवाह', mr: 'मांगलिक दोष — मंगळ आणि विवाह', ta: 'மாங்கலிக தோஷம் — செவ்வாயும் திருமணமும்', te: 'మాంగళిక దోషం — కుజుడు మరియు వివాహం', bn: 'মাঙ্গলিক দোষ — মঙ্গল ও বিবাহ', kn: 'ಮಾಂಗಲಿಕ ದೋಷ — ಕುಜ ಮತ್ತು ವಿವಾಹ', gu: 'માંગલિક દોષ — મંગળ અને લગ્ન' } },
];
